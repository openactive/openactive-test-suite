...
describe('user-facing endpoints', () => {
  ...
  // TODO2 Implement /status after everything else works
  describe.skip('GET /status', () => {
  ...
  describe('GET /sample-opportunities', () => {
    it('should get a random opportunity matching a criteria, and then lock it', async () => {
      ...
      await store.setOpportunityMatchesCriteria2('id1', {
        criteriaName: 'TestOpportunityBookable',
        bookingFlow: 'OpenBookingSimpleFlow',
        opportunityType: 'ScheduledSession',
        sellerId: 'seller1',
      ...
      await store.setOpportunityDoesNotMatchCriteria2('id1', ['does not have one space'], {
        criteriaName: 'TestOpportunityBookableOneSpace',
        bookingFlow: 'OpenBookingSimpleFlow',
        opportunityType: 'ScheduledSession',
        sellerId: 'seller1',
      });
      await store.setOpportunityMatchesCriteria2('id2', {
        criteriaName: 'TestOpportunityBookable',
        bookingFlow: 'OpenBookingSimpleFlow',
        opportunityType: 'ScheduledSession',
        sellerId: 'seller1',
      });
      await store.setOpportunityDoesNotMatchCriteria2('id2', ['is not free'], {
        criteriaName: 'TestOpportunityBookableFree',
        bookingFlow: 'OpenBookingSimpleFlow',
        opportunityType: 'ScheduledSession',
        sellerId: 'seller1',
