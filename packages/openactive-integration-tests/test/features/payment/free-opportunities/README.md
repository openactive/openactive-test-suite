...
| [opportunity-free-without-checkpoints](./implemented/opportunity-free-without-checkpoints-test.js) | Successful booking without Checkpoints | Free Opportunities, as they need no tax calculation, and, if they do not require additional details, should be bookable without using Checkpoints C1 & C2 | [TestOpportunityBookableFree](https://openactive.io/test-interface#TestOpportunityBookableFree) x4 |
