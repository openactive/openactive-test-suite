  ...
  describe('Open ID Connect Authentication', function () {
    (new OpenIDConnectFlow({
      ...
      .authorizeAuthorizationCodeFlow({
        ...
        assertFlowRequiredConsent: false, // TODO: Add a test interface Action that resets consent for the specified user, and call it before this flow starts. Then this flow should assert consent.
