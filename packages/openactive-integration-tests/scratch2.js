    ...
    before("Initialize a new dweet thing for the tests", function () {
        ...
        namedDweetPost = chakram.post("https://localhost:44307/api/openbooking/"+specifiedThingName, initialDweetData);
    });
    ...
    it("should allow retrieval of the last data point", function () {
        var dataRetrieval = chakram.get("https://localhost:44307/api/openbooking/"+specifiedThingName);
    ...
    describe("anonymous thing name", function () {
        ...
        before(function () {
            anonymousDweetPost = chakram.put("https://localhost:44307/api/openbooking/orders/1234", c1req);
        ...
        it("should allow data retrieval using the generated thing name", function () {
            var data = chakram.get("https://localhost:44307/api/openbooking/"+generatedThingName);
