...
---
Response status code: 200 OK. Responded in 265.868025ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2093/facility-use-slots/20093"
}
```
...
---
Response status code: 200 OK. Responded in 179.288551ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2092/facility-use-slots/20092"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2093%2Ffacility-use-slots%2F20093?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1632.3068899999998ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2093/facility-use-slots/20093",
  "modified": 1625164903801,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2093",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2093/facility-use-slots/20093#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:41:40+00:00",
    "endDate": "2021-07-02T19:41:40+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2092%2Ffacility-use-slots%2F20092?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1629.953045ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2092/facility-use-slots/20092",
  "modified": 1625164903800,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2092",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2092/facility-use-slots/20092#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7b5176d4-fc08-47f4-84b2-50e08a369d7f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2093/facility-use-slots/20093#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2093/facility-use-slots/20093"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2092/facility-use-slots/20092#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2092/facility-use-slots/20092"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 126.599214ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7b5176d4-fc08-47f4-84b2-50e08a369d7f",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:43+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2093"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:41:40+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2092"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:41:40+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7b5176d4-fc08-47f4-84b2-50e08a369d7f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Maybell_Schmitt@gmail.com",
    "telephone": "1-536-394-9392 x558",
    "givenName": "Schmitt",
    "familyName": "Samantha",
    "identifier": "dac7edb9-ea19-49e6-8fd9-c6809fe3b583"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 96.942494ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7b5176d4-fc08-47f4-84b2-50e08a369d7f
...
---
Response status code: 409 Conflict. Responded in 99.740905ms.
```json
{
  "@context": "https://openactive.io/",
