...
---
Response status code: 200 OK. Responded in 30.563384ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2186/facility-use-slots/20186"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2186%2Ffacility-use-slots%2F20186?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1663.574661ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2186/facility-use-slots/20186",
  "modified": 1625165110509,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2186",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2186/facility-use-slots/20186#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3cf3d01d-8470-4254-b53a-a108c48d2025
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2186/facility-use-slots/20186#/offers/0"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 84.937114ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3cf3d01d-8470-4254-b53a-a108c48d2025",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3cf3d01d-8470-4254-b53a-a108c48d2025
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Donnie_Gusikowski65@gmail.com",
    "telephone": "334.418.7016",
    "givenName": "Keebler",
    "familyName": "Erik",
    "identifier": "3c0d78d7-e39a-4234-8e3a-70abdd221a5e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 58.144252ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/3cf3d01d-8470-4254-b53a-a108c48d2025
...
---
Response status code: 409 Conflict. Responded in 19.408617ms.
```json
{
  "@context": "https://openactive.io/",
