...
---
Response status code: 200 OK. Responded in 21.426714ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2491/facility-use-slots/20491"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2491%2Ffacility-use-slots%2F20491?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 545.45499ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2491/facility-use-slots/20491",
  "modified": 1625165848963,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2491/facility-use-slots/20491#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:57:27+00:00",
    "endDate": "2021-07-02T19:57:27+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3bd30d78-24ed-40ac-bead-5f17746d56d6
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2491/facility-use-slots/20491#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2491/facility-use-slots/20491"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 804.633163ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3bd30d78-24ed-40ac-bead-5f17746d56d6",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:28+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3bd30d78-24ed-40ac-bead-5f17746d56d6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jessyca_Hermann82@hotmail.com",
    "telephone": "886-880-2937 x81399",
    "givenName": "Beier",
    "familyName": "Maybelle",
    "identifier": "0a7fa8c1-e149-4441-90db-e57cfe8d6fdf"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 387.678755ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:29+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3bd30d78-24ed-40ac-bead-5f17746d56d6
...
---
Response status code: 400 Bad Request. Responded in 41.943822ms.
```json
{
  "@context": "https://openactive.io/",
