[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:44:52 GMT+0000 (Coordinated Universal Time)

# common-error-conditions >> incomplete-order-item-no-opportunity (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 29 passed with 0 failures, 116 warnings and 30 suggestions 
...
---
Response status code: 200 OK. Responded in 523.860868ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2194/events/20194"
}
```
...
---
Response status code: 200 OK. Responded in 440.267263ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2193/events/20193"
}
```
...
---
Response status code: 200 OK. Responded in 360.41448ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2187/facility-use-slots/20187"
}
```
...
---
Response status code: 200 OK. Responded in 446.789602ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2188/facility-use-slots/20188"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2194%2Fevents%2F20194?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1770.567508ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2194/events/20194",
  "modified": 1625165113195,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2194/events/20194",
    "startDate": "2021-07-02T18:45:09+00:00",
    "endDate": "2021-07-02T19:45:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2194",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2194#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2193%2Fevents%2F20193?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1765.6228780000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2193/events/20193",
  "modified": 1625165113193,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2193",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2193#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2187%2Ffacility-use-slots%2F20187?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3196.040285ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2187/facility-use-slots/20187",
  "modified": 1625165114624,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2187",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2187/facility-use-slots/20187#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2188%2Ffacility-use-slots%2F20188?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3200.409303ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2188/facility-use-slots/20188",
  "modified": 1625165114635,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2188",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2188/facility-use-slots/20188#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4f22e173-5962-4e10-9033-bedc2ec6a121
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2194#/offers/0"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2193#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2193/events/20193"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2187/facility-use-slots/20187#/offers/0"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2188/facility-use-slots/20188#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2188/facility-use-slots/20188"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 413.666979ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4f22e173-5962-4e10-9033-bedc2ec6a121",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2193"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2188"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:45:09+00:00",
...
* ✅ OrderItem at position 1 - should include an IncompleteOrderItemError
* ✅ OrderItem at position 2 - should not include an IncompleteOrderItemError
* ✅ OrderItem at position 3 - should include an IncompleteOrderItemError
* ✅ OrderItem at position 4 - should include an IncompleteOrderItemError
* ✅ OrderItem at position 5 - should not include an IncompleteOrderItemError

## C2

### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4f22e173-5962-4e10-9033-bedc2ec6a121
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Meta46@yahoo.com",
    "telephone": "368-930-9210 x1877",
    "givenName": "Weimann",
    "familyName": "Consuelo",
    "identifier": "9216aec5-0d1d-40bb-8220-ccfdbcfe22e6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 455.233399ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/4f22e173-5962-4e10-9033-bedc2ec6a121
...
---
Response status code: 409 Conflict. Responded in 70.893973ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 409,
  "description": "There is a missing 'acceptedOffer' or 'orderedItem' property on the 'OrderItem'.: orderedItem @id was not provided, There is a missing 'acceptedOffer' or 'orderedItem' property on the 'OrderItem'.: orderedItem @id was not provided, There is a missing 'acceptedOffer' or 'orderedItem' property on the 'OrderItem'.: orderedItem @id was not provided, There is a missing 'acceptedOffer' or 'orderedItem' property on the 'OrderItem'.: orderedItem @id was not provided"
}
```
### Specs
