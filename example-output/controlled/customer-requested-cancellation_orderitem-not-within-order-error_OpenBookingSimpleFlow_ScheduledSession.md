...
---
Response status code: 200 OK. Responded in 123.506414ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2292/events/20292"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2292%2Fevents%2F20292?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1153.328762ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2292/events/20292",
  "modified": 1625165251077,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2292/events/20292",
    "startDate": "2021-07-02T18:47:28+00:00",
    "endDate": "2021-07-02T19:47:28+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2292",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2292#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6f6de650-f0b7-49a3-bfbd-6461687c9877
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2292#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2292/events/20292"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 191.520418ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6f6de650-f0b7-49a3-bfbd-6461687c9877",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6f6de650-f0b7-49a3-bfbd-6461687c9877
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lyric.Jaskolski@yahoo.com",
    "telephone": "1-337-308-8061",
    "givenName": "Jacobson",
    "familyName": "Cristal",
    "identifier": "3dedd97c-6321-4ef1-a4b2-b5a65779363c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 147.493938ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6f6de650-f0b7-49a3-bfbd-6461687c9877
...
---
Response status code: 201 Created. Responded in 99.00003ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6f6de650-f0b7-49a3-bfbd-6461687c9877",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6f6de650-f0b7-49a3-bfbd-6461687c9877#/orderedItems/1301",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2292#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/477ef256-142a-4a0e-99d3-4efedef6802b
...
---
Response status code: 500 Internal Server Error. Responded in 60.324083ms.
```json
{
  "@context": "https://openactive.io/",
