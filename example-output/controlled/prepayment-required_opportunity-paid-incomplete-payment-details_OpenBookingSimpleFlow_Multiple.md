[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:56:04 GMT+0000 (Coordinated Universal Time)

# prepayment-required >> opportunity-paid-incomplete-payment-details (OpenBookingSimpleFlow >> Multiple)
...
**Test:**  IncompletePaymentDetailsError must be returned in the case that payment details are not supplied
...
```bash
npm start -- --runInBand test/features/payment/prepayment-required/implemented/opportunity-paid-incomplete-payment-details-test.js
```

---

⚠️ 9 passed with 0 failures, 100 warnings and 26 suggestions 
...
---
Response status code: 200 OK. Responded in 53.325937ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2474/events/20474"
}
```
...
---
Response status code: 200 OK. Responded in 34.454918ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2461/facility-use-slots/20461"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2474%2Fevents%2F20474?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 756.504784ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2474/events/20474",
  "modified": 1625165772618,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2474/events/20474",
    "startDate": "2021-07-02T18:56:10+00:00",
    "endDate": "2021-07-02T19:56:10+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2474",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2474#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2461%2Ffacility-use-slots%2F20461?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 854.360603ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2461/facility-use-slots/20461",
  "modified": 1625165772717,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2461",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2461/facility-use-slots/20461#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 14.99,
        "priceCurrency": "GBP"
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/32867e4e-76de-410b-b398-a036772f3227
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2474#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2474/events/20474"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2461/facility-use-slots/20461#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2461/facility-use-slots/20461"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 750.185044ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/32867e4e-76de-410b-b398-a036772f3227",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2474"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/32867e4e-76de-410b-b398-a036772f3227
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nannie59@gmail.com",
    "telephone": "1-237-209-4827 x65228",
    "givenName": "Wintheiser",
    "familyName": "Frederick",
    "identifier": "6b5f0cc1-0fda-4b71-9e19-a97d75dbcdd0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1137.934296ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:13+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/32867e4e-76de-410b-b398-a036772f3227
...
---
Response status code: 400 Bad Request. Responded in 100.408735ms.
```json
{
  "@context": "https://openactive.io/",
