...
# prepayment-optional >> payment-mismatch (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 258.356646ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2485/facility-use-slots/20485"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2485%2Ffacility-use-slots%2F20485?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1174.116723ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2485/facility-use-slots/20485",
  "modified": 1625165834059,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2485",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2485/facility-use-slots/20485#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:57:11+00:00",
    "endDate": "2021-07-02T19:57:11+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e51e9444-7991-41da-9aa0-e6967305a9ab
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2485/facility-use-slots/20485#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2485/facility-use-slots/20485"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1120.930204ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e51e9444-7991-41da-9aa0-e6967305a9ab",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:13+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e51e9444-7991-41da-9aa0-e6967305a9ab
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dina46@gmail.com",
    "telephone": "(956) 565-4001",
    "givenName": "Bailey",
    "familyName": "Gino",
    "identifier": "e631eb5f-481d-4bda-af27-b5b2c05c4946"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1332.258269ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e51e9444-7991-41da-9aa0-e6967305a9ab
...
---
Response status code: 400 Bad Request. Responded in 141.600247ms.
```json
{
  "@context": "https://openactive.io/",
