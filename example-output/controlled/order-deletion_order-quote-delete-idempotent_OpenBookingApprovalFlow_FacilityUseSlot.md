...
# order-deletion >> order-quote-delete-idempotent (OpenBookingApprovalFlow >> FacilityUseSlot)
...
⚠️ 6 passed with 0 failures, 52 warnings and 6 suggestions 
...
---
Response status code: 200 OK. Responded in 160.544842ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2289/facility-use-slots/20289"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2289%2Ffacility-use-slots%2F20289?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1447.586193ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2289/facility-use-slots/20289",
  "modified": 1625165268523,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2289",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2289/facility-use-slots/20289#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:47:45+00:00",
    "endDate": "2021-07-02T19:47:45+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ce102fb4-e851-45c2-af81-b45aa019b014
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2289/facility-use-slots/20289#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2289/facility-use-slots/20289"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 209.943401ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ce102fb4-e851-45c2-af81-b45aa019b014",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:47+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ce102fb4-e851-45c2-af81-b45aa019b014
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Vesta.Leannon50@yahoo.com",
    "telephone": "(212) 290-5648 x9640",
    "givenName": "Marvin",
    "familyName": "Lori",
    "identifier": "776a188b-7bba-410c-97a3-50b4673a5c43"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 217.108939ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:48+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
DELETE https://localhost:5001/api/openbooking/order-quotes/ce102fb4-e851-45c2-af81-b45aa019b014
...
---
Response status code: 204 No Content. Responded in 284.06899ms.
...
---
Response status code: 204 No Content. Responded in 115.091104ms.
### Specs
