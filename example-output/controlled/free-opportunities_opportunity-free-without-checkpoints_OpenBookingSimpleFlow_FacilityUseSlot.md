...
# free-opportunities >> opportunity-free-without-checkpoints (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 27.28206ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2391/facility-use-slots/20391"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2391%2Ffacility-use-slots%2F20391?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2572.005305ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2391/facility-use-slots/20391",
  "modified": 1625165554176,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2391",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2391/facility-use-slots/20391#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:52:30+00:00",
    "endDate": "2021-07-02T19:52:30+00:00"
  }
}
```
### Specs
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5edd4d87-d004-455f-96fe-b8d4f572a2dc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Marcelo52@gmail.com",
    "telephone": "385.402.4415 x43449",
    "givenName": "McCullough",
    "familyName": "Jules",
    "identifier": "8f81fd6e-639e-4f8d-b383-cc494ccb5415"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2391/facility-use-slots/20391#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2391/facility-use-slots/20391"
    }
  ],
  "totalPaymentDue": {
...
---
Response status code: 201 Created. Responded in 280.231146ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5edd4d87-d004-455f-96fe-b8d4f572a2dc",
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5edd4d87-d004-455f-96fe-b8d4f572a2dc#/orderedItems/2065",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2391/facility-use-slots/20391#/offers/0",
        "allowCustomerCancellationFullRefund": true,
