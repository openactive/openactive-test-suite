...
⚠️ 9 passed with 0 failures, 73 warnings and 26 suggestions 
...
---
Response status code: 200 OK. Responded in 7124.144225ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2599/events/20599"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2599%2Fevents%2F20599?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 502.534201ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2599/events/20599",
  "modified": 1625166052590,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2599/events/20599",
    "startDate": "2021-07-02T19:00:44+00:00",
    "endDate": "2021-07-02T20:00:44+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2599",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2599#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/55142c30-6dc0-4356-a765-f63136dcaee1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2599#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2599/events/20599"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 304.97344ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/55142c30-6dc0-4356-a765-f63136dcaee1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:05:51+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2599"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/55142c30-6dc0-4356-a765-f63136dcaee1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Gianni26@hotmail.com",
    "telephone": "974-679-0010",
    "givenName": "Davis",
    "familyName": "Bettie",
    "identifier": "a247ca07-694b-448a-b7c3-1755ea0931f6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 537.781698ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:05:52+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/55142c30-6dc0-4356-a765-f63136dcaee1
...
---
Response status code: 201 Created. Responded in 349.409484ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/55142c30-6dc0-4356-a765-f63136dcaee1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/55142c30-6dc0-4356-a765-f63136dcaee1#/orderedItems/3235",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2599#/offers/0",
        "allowCustomerCancellationFullRefund": true,
