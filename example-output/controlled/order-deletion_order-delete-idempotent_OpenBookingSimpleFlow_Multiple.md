[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:52:20 GMT+0000 (Coordinated Universal Time)
...
⚠️ 17 passed with 0 failures, 378 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 169.899502ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2410/events/20410"
}
```
...
---
Response status code: 200 OK. Responded in 2502.470064ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2411/events/20411"
}
```
...
---
Response status code: 200 OK. Responded in 3872.057044ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2399/facility-use-slots/20399"
}
```
...
---
Response status code: 200 OK. Responded in 156.071421ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2398/facility-use-slots/20398"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2410%2Fevents%2F20410?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 261.432142ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2410/events/20410",
    "startDate": "2021-07-02T18:52:37+00:00",
    "endDate": "2021-07-02T19:52:37+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2410",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2410#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2411%2Fevents%2F20411?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 260.418137ms.
```json
{
  "data": {
    "@context": [
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2411",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2411#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2399%2Ffacility-use-slots%2F20399?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2018.558163ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2399/facility-use-slots/20399",
  "modified": 1625165564197,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2399",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2399/facility-use-slots/20399#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 14.99,
        "priceCurrency": "GBP"
      }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2398%2Ffacility-use-slots%2F20398?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 256.935416ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2398",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2398/facility-use-slots/20398#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6d635ea8-ebe1-43e5-977a-aa515a08ef41
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2410#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2410/events/20410"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2411#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2411/events/20411"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2399/facility-use-slots/20399#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2399/facility-use-slots/20399"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2398/facility-use-slots/20398#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2398/facility-use-slots/20398"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1291.823375ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6d635ea8-ebe1-43e5-977a-aa515a08ef41",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:44+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6d635ea8-ebe1-43e5-977a-aa515a08ef41
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Misty_Denesik@yahoo.com",
    "telephone": "470-802-0548",
    "givenName": "Kessler",
    "familyName": "Mariano",
    "identifier": "3c3a9e10-e4fa-4d9f-bd0a-2e77283dea02"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1851.575401ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:47+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6d635ea8-ebe1-43e5-977a-aa515a08ef41
...
---
Response status code: 201 Created. Responded in 1706.56879ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6d635ea8-ebe1-43e5-977a-aa515a08ef41",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6d635ea8-ebe1-43e5-977a-aa515a08ef41#/orderedItems/2107",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2410#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6d635ea8-ebe1-43e5-977a-aa515a08ef41#/orderedItems/2108",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2410#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6d635ea8-ebe1-43e5-977a-aa515a08ef41#/orderedItems/2109",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2411#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6d635ea8-ebe1-43e5-977a-aa515a08ef41#/orderedItems/2110",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2399/facility-use-slots/20399#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6d635ea8-ebe1-43e5-977a-aa515a08ef41#/orderedItems/2111",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2399/facility-use-slots/20399#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6d635ea8-ebe1-43e5-977a-aa515a08ef41#/orderedItems/2112",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2398/facility-use-slots/20398#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
DELETE https://localhost:5001/api/openbooking/orders/6d635ea8-ebe1-43e5-977a-aa515a08ef41
...
---
Response status code: 204 No Content. Responded in 1753.7518599999999ms.
...
---
Response status code: 204 No Content. Responded in 29.944477ms.
### Specs
