[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:59:18 GMT+0000 (Coordinated Universal Time)

# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-incorrect-details-no-payment-required (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 14 passed with 0 failures, 119 warnings and 30 suggestions 
...
---
Response status code: 200 OK. Responded in 139.188296ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2553/events/20553"
}
```
...
---
Response status code: 200 OK. Responded in 1074.036844ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2555/events/20555"
}
```
...
---
Response status code: 200 OK. Responded in 73.09325ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2541/facility-use-slots/20541"
}
```
...
---
Response status code: 200 OK. Responded in 97.334067ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2542/facility-use-slots/20542"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2553%2Fevents%2F20553?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 696.919084ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2553/events/20553",
  "modified": 1625165965526,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2553/events/20553",
    "startDate": "2021-07-02T18:59:22+00:00",
    "endDate": "2021-07-02T19:59:22+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2553",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2553#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2555%2Fevents%2F20555?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1447.074603ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2555/events/20555",
  "modified": 1625165966290,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2555",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Free Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2555#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2541%2Ffacility-use-slots%2F20541?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 753.101322ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2541/facility-use-slots/20541",
  "modified": 1625165965557,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2541",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2541/facility-use-slots/20541#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2542%2Ffacility-use-slots%2F20542?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 761.776228ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2542/facility-use-slots/20542",
  "modified": 1625165965559,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2542",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Free Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2542/facility-use-slots/20542#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4d9c45ba-acfd-46c4-b7f5-9396bb27ad46
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2553#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2553/events/20553"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2555#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2555/events/20555"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2541/facility-use-slots/20541#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2541/facility-use-slots/20541"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2542/facility-use-slots/20542#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2542/facility-use-slots/20542"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-kHGMUb338n",
    "accountId": "invalid-BdQ5nZn3T",
    "paymentProviderId": "invalid-Aessa-S5cT"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 447.96601ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4d9c45ba-acfd-46c4-b7f5-9396bb27ad46
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "June.Beer@gmail.com",
    "telephone": "(317) 802-0844 x36052",
    "givenName": "Towne",
    "familyName": "Enrico",
    "identifier": "5f2ab608-bb79-4ef5-80ed-9680ab2d90d1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-5U4jd5xYG4",
    "accountId": "invalid-K-gKI-geje",
    "paymentProviderId": "invalid-7gLu0PTXIS"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 158.36351ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
