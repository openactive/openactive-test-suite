[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:57:23 GMT+0000 (Coordinated Universal Time)

# prepayment-optional >> opportunity-paid-incomplete-payment-details (OpenBookingSimpleFlow >> Multiple)
...
---
Response status code: 200 OK. Responded in 28.709953ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2506/events/20506"
}
```
...
---
Response status code: 200 OK. Responded in 100.11373ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2494/facility-use-slots/20494"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2506%2Fevents%2F20506?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 769.962371ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2506/events/20506",
  "modified": 1625165851580,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2506/events/20506",
    "startDate": "2021-07-02T18:57:29+00:00",
    "endDate": "2021-07-02T19:57:29+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2506",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2506#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2494%2Ffacility-use-slots%2F20494?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1954.985681ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2494/facility-use-slots/20494",
  "modified": 1625165852767,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2494",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2494/facility-use-slots/20494#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 14.99,
        "priceCurrency": "GBP"
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e067f40b-6656-47cd-bc87-d0b41d377377
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2506#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2506/events/20506"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2494/facility-use-slots/20494#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2494/facility-use-slots/20494"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1770.774975ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e067f40b-6656-47cd-bc87-d0b41d377377",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:32+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2506"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e067f40b-6656-47cd-bc87-d0b41d377377
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Toni.Hermann93@gmail.com",
    "telephone": "303.744.8499 x55681",
    "givenName": "Welch",
    "familyName": "Rhea",
    "identifier": "ea6cab63-63d8-4f09-976d-9d8d872b707e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1338.123262ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:34+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e067f40b-6656-47cd-bc87-d0b41d377377
...
---
Response status code: 400 Bad Request. Responded in 83.750667ms.
```json
{
  "@context": "https://openactive.io/",
