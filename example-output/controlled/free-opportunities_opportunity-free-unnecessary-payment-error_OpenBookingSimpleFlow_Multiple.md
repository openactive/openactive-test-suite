[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:54:40 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 1343.510343ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2447/events/20447"
}
```
...
---
Response status code: 200 OK. Responded in 1370.805598ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2434/facility-use-slots/20434"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2447%2Fevents%2F20447?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1055.140103ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2447/events/20447",
  "modified": 1625165695734,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2447/events/20447",
    "startDate": "2021-07-02T18:54:52+00:00",
    "endDate": "2021-07-02T19:54:52+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2447",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2447#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2434%2Ffacility-use-slots%2F20434?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2758.222592ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2434/facility-use-slots/20434",
  "modified": 1625165697456,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2434",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2434/facility-use-slots/20434#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/dbcd3edf-7284-4956-afa0-3134cba742bd
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2447#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2447/events/20447"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2434/facility-use-slots/20434#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2434/facility-use-slots/20434"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 987.255217ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/dbcd3edf-7284-4956-afa0-3134cba742bd",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:56+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2447"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2434"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:54:52+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/dbcd3edf-7284-4956-afa0-3134cba742bd
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Evalyn.Roberts@gmail.com",
    "telephone": "523.537.9739",
    "givenName": "Schneider",
    "familyName": "Vicente",
    "identifier": "edd1dbca-508a-4d24-859b-87d7b726a0be"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 691.367115ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:58+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/dbcd3edf-7284-4956-afa0-3134cba742bd
...
---
Response status code: 400 Bad Request. Responded in 80.197154ms.
```json
{
  "@context": "https://openactive.io/",
