...
# access-pass-image >> access-pass-image (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 24.191438ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2306/facility-use-slots/20306"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2306%2Ffacility-use-slots%2F20306?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2334.879589ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2306/facility-use-slots/20306",
  "modified": 1625165299247,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2306",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2306/facility-use-slots/20306#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:48:15+00:00",
    "endDate": "2021-07-02T19:48:15+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2b0b4cbd-f615-4fa2-a466-7fe9c31af271
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2306/facility-use-slots/20306#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2306/facility-use-slots/20306"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 198.922719ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2b0b4cbd-f615-4fa2-a466-7fe9c31af271",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2b0b4cbd-f615-4fa2-a466-7fe9c31af271
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Khalid17@gmail.com",
    "telephone": "1-347-330-2169 x152",
    "givenName": "Bayer",
    "familyName": "Unique",
    "identifier": "834334bd-bd96-4276-b861-2b10e59528ed"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 209.619084ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2b0b4cbd-f615-4fa2-a466-7fe9c31af271
...
---
Response status code: 201 Created. Responded in 719.524907ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/2b0b4cbd-f615-4fa2-a466-7fe9c31af271",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2b0b4cbd-f615-4fa2-a466-7fe9c31af271#/orderedItems/1464",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2306/facility-use-slots/20306#/offers/0",
        "allowCustomerCancellationFullRefund": true,
