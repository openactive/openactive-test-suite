...
⚠️ 23 passed with 0 failures, 475 warnings and 126 suggestions 
...
---
Response status code: 200 OK. Responded in 76.006869ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2603/events/20603"
}
```
...
---
Response status code: 200 OK. Responded in 122.443095ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2604/events/20604"
}
```
...
---
Response status code: 200 OK. Responded in 97.515374ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2592/facility-use-slots/20592"
}
```
...
---
Response status code: 200 OK. Responded in 61.898901ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2591/facility-use-slots/20591"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2603%2Fevents%2F20603?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 440.764342ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2603/events/20603",
  "modified": 1625166088383,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2603/events/20603",
    "startDate": "2021-07-02T19:01:26+00:00",
    "endDate": "2021-07-02T20:01:26+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2603",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2603#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2604%2Fevents%2F20604?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 439.498536ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2604/events/20604",
  "modified": 1625166088385,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2604",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2604#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2592%2Ffacility-use-slots%2F20592?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 945.175794ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2592/facility-use-slots/20592",
  "modified": 1625166088891,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2592",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2592/facility-use-slots/20592#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2591%2Ffacility-use-slots%2F20591?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 942.32678ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2591/facility-use-slots/20591",
  "modified": 1625166088887,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2591",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2591/facility-use-slots/20591#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a33357a0-7d1b-45e7-9497-562eaba4be83
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2603#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2603/events/20603"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2604#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2604/events/20604"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2592/facility-use-slots/20592#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2592/facility-use-slots/20592"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2591/facility-use-slots/20591#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2591/facility-use-slots/20591"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1043.871974ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a33357a0-7d1b-45e7-9497-562eaba4be83",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:06:28+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2603"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2604"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2592"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T19:01:26+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2591"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T19:01:26+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a33357a0-7d1b-45e7-9497-562eaba4be83
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Destiney_Morissette@yahoo.com",
    "telephone": "1-826-774-6995 x790",
    "givenName": "Doyle",
    "familyName": "Beau",
    "identifier": "c43901bc-24dd-4952-8225-0537e503c532"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1135.83644ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:06:29+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a33357a0-7d1b-45e7-9497-562eaba4be83
...
---
Response status code: 201 Created. Responded in 1293.154283ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a33357a0-7d1b-45e7-9497-562eaba4be83",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a33357a0-7d1b-45e7-9497-562eaba4be83#/orderedItems/3275",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2603#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a33357a0-7d1b-45e7-9497-562eaba4be83#/orderedItems/3276",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2603#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a33357a0-7d1b-45e7-9497-562eaba4be83#/orderedItems/3277",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2604#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a33357a0-7d1b-45e7-9497-562eaba4be83#/orderedItems/3278",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2592/facility-use-slots/20592#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a33357a0-7d1b-45e7-9497-562eaba4be83#/orderedItems/3279",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2592/facility-use-slots/20592#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a33357a0-7d1b-45e7-9497-562eaba4be83#/orderedItems/3280",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2591/facility-use-slots/20591#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a33357a0-7d1b-45e7-9497-562eaba4be83/versions/c5234ecb-0227-4ddb-90d9-5a269877c3ac",
  "payment": {
    "@type": "Payment",
    "identifier": "TPVLoYZeC",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;a33357a0-7d1b-45e7-9497-562eaba4be83&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/a33357a0-7d1b-45e7-9497-562eaba4be83


---
Response status code: 200 OK. Responded in 11.774258ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607628847032899&afterId=c7ed07cb-c232-44f6-8e07-d0aca0c91d5a",
  "message": "Listening for UUID: 'a33357a0-7d1b-45e7-9497-562eaba4be83' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 28.946843ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;a33357a0-7d1b-45e7-9497-562eaba4be83&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/a33357a0-7d1b-45e7-9497-562eaba4be83


---
Response status code: 200 OK. Responded in 2209.233303ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a33357a0-7d1b-45e7-9497-562eaba4be83",
  "modified": 637607628927357000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/a33357a0-7d1b-45e7-9497-562eaba4be83",
    "identifier": "a33357a0-7d1b-45e7-9497-562eaba4be83",
...
---
Response status code: 200 OK. Responded in 13.972469ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607628927357102&afterId=a33357a0-7d1b-45e7-9497-562eaba4be83",
  "message": "Listening for UUID: 'a33357a0-7d1b-45e7-9497-562eaba4be83' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/a33357a0-7d1b-45e7-9497-562eaba4be83
...
---
Response status code: 201 Created. Responded in 498.731762ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a33357a0-7d1b-45e7-9497-562eaba4be83",
  "identifier": "a33357a0-7d1b-45e7-9497-562eaba4be83",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 236.559368ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a33357a0-7d1b-45e7-9497-562eaba4be83",
  "modified": 637607628950822400
}
```
### Specs
* ✅ should return 200 on success
