...
---
Response status code: 200 OK. Responded in 124.106898ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2444/events/20444"
}
```
...
---
Response status code: 200 OK. Responded in 239.486646ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2445/events/20445"
}
```
...
---
Response status code: 200 OK. Responded in 146.556923ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2430/facility-use-slots/20430"
}
```
...
---
Response status code: 200 OK. Responded in 167.398041ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2444%2Fevents%2F20444?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1098.983381ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2444/events/20444",
  "modified": 1625165683179,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2444",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2444#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2445%2Fevents%2F20445?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1099.275482ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2445/events/20445",
  "modified": 1625165683181,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2445",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2445#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2430%2Ffacility-use-slots%2F20430?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2443.027212ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2430/facility-use-slots/20430",
  "modified": 1625165684526,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2430",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2430/facility-use-slots/20430#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
---
Response status code: 200 OK. Responded in 2448.508244ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2431/facility-use-slots/20431",
  "modified": 1625165684532,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2444#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2444/events/20444"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2445#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2445/events/20445"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2430/facility-use-slots/20430#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2430/facility-use-slots/20430"
    },
    {
      "@type": "OrderItem",
      "position": 4,
...
---
Response status code: 200 OK. Responded in 1684.302664ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2430"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:54:40+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lenore_Hodkiewicz77@hotmail.com",
    "telephone": "(996) 825-1728",
    "givenName": "Hilll",
    "familyName": "Ryan",
    "identifier": "91d39795-8c1f-4053-8cdf-3a46ae899c4a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2045.310214ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e
...
---
Response status code: 201 Created. Responded in 1964.5535770000001ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e#/orderedItems/2317",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2444#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e#/orderedItems/2318",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2444#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e#/orderedItems/2319",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2445#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e#/orderedItems/2320",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2430/facility-use-slots/20430#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e#/orderedItems/2321",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2430/facility-use-slots/20430#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e#/orderedItems/2322",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2431/facility-use-slots/20431#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e/versions/b2fea98e-afaf-4229-99cd-f56b1cdbe606",
  "payment": {
    "@type": "Payment",
    "identifier": "sUB1PBg38",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;7a2dba7b-ad5f-4e93-9385-c0b39c40c19e&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e


---
Response status code: 200 OK. Responded in 77.32014ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607624810665442&afterId=7327a914-93f1-401b-bb06-82379e4c9187",
  "message": "Listening for UUID: '7a2dba7b-ad5f-4e93-9385-c0b39c40c19e' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 404.837103ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;7a2dba7b-ad5f-4e93-9385-c0b39c40c19e&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e


---
Response status code: 200 OK. Responded in 2071.227884ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "7a2dba7b-ad5f-4e93-9385-c0b39c40c19e",
  "modified": 637607624948366000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e",
    "identifier": "7a2dba7b-ad5f-4e93-9385-c0b39c40c19e",
...
---
Response status code: 200 OK. Responded in 36.696608ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607624951204914&afterId=64f713b0-3df9-4b26-9413-ad4229502ec2",
  "message": "Listening for UUID: '7a2dba7b-ad5f-4e93-9385-c0b39c40c19e' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e
...
---
Response status code: 201 Created. Responded in 1939.546998ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/7a2dba7b-ad5f-4e93-9385-c0b39c40c19e",
  "identifier": "7a2dba7b-ad5f-4e93-9385-c0b39c40c19e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 5.475431ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "7a2dba7b-ad5f-4e93-9385-c0b39c40c19e",
  "modified": 637607624979796500
}
```
### Specs
* ✅ should return 200 on success
