[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:49:34 GMT+0000 (Coordinated Universal Time)

# opportunity-attendance-updates >> opportunity-attendance-update-customer-attended (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 37.714323ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2342/facility-use-slots/20342"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2342%2Ffacility-use-slots%2F20342?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2896.162141ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2342/facility-use-slots/20342",
  "modified": 1625165390928,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2342",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2342/facility-use-slots/20342#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:49:47+00:00",
    "endDate": "2021-07-02T19:49:47+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2342/facility-use-slots/20342#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2342/facility-use-slots/20342"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 450.742268ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:50+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2342"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:49:47+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Taurean.Wunsch@gmail.com",
    "telephone": "361.570.2749",
    "givenName": "Harber",
    "familyName": "Elvis",
    "identifier": "91866fe4-ecee-47de-bab7-23192989a0c8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 282.317371ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7
...
---
Response status code: 201 Created. Responded in 347.235655ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7#/orderedItems/1720",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2342/facility-use-slots/20342#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Orders (orders) Feed listen for &#x27;578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7


---
Response status code: 200 OK. Responded in 164.471973ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607621848775645&afterId=1505ebb0-90d2-4e51-a280-35552edb93ea",
  "message": "Listening for UUID: '578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 52.121909ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AttendeeAttendedSimulateAction)

### Orders (orders) Feed collect for &#x27;578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7


---
Response status code: 200 OK. Responded in 2275.8513709999997ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7",
  "modified": 637607621931583100,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7",
    "identifier": "578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/578fa4f1-fdd3-449b-b4b0-bf5ade0fd5b7#/orderedItems/1720",
