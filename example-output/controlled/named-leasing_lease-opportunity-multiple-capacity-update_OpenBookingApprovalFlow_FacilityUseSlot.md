...
---
Response status code: 200 OK. Responded in 525.918435ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2459/facility-use-slots/20459"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2459%2Ffacility-use-slots%2F20459?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 933.579819ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2459/facility-use-slots/20459",
  "modified": 1625165766001,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2459",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2459/facility-use-slots/20459#/offers/0",
    ...
    "remainingUses": 5,
    "startDate": "2021-07-02T18:56:03+00:00",
    "endDate": "2021-07-02T19:56:03+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fe24842d-ba72-4f93-b736-9c7ee96b80e4
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2459/facility-use-slots/20459#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2459/facility-use-slots/20459"
    },
    {
      "@type": "OrderItem",
      "position": 1,
...
---
Response status code: 200 OK. Responded in 2487.732474ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fe24842d-ba72-4f93-b736-9c7ee96b80e4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:07+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2459"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-02T18:56:03+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fe24842d-ba72-4f93-b736-9c7ee96b80e4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Annamarie_Bernhard52@gmail.com",
    "telephone": "1-281-470-7086",
    "givenName": "Greenfelder",
    "familyName": "Kira",
    "identifier": "c7bc1f6a-2797-49dc-b391-3b05d58f2902"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 263.606372ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 443.13711ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/80fb6ee7-edb5-4e78-bd59-67eabaf735c2
...
---
Response status code: 409 Conflict. Responded in 1123.288922ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/80fb6ee7-edb5-4e78-bd59-67eabaf735c2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:10+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/80fb6ee7-edb5-4e78-bd59-67eabaf735c2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jeanie92@yahoo.com",
    "telephone": "447.793.3158",
    "givenName": "Mann",
    "familyName": "Cody",
    "identifier": "d5819de2-254a-490b-9098-700e8446f3f6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 451.420755ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:11+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8b1223d0-9d68-4d79-97e6-d03cc05b8470
...
---
Response status code: 200 OK. Responded in 660.345976ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8b1223d0-9d68-4d79-97e6-d03cc05b8470",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:12+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8b1223d0-9d68-4d79-97e6-d03cc05b8470
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ruthie4@hotmail.com",
    "telephone": "1-863-232-2603 x14350",
    "givenName": "Schowalter",
    "familyName": "Lauretta",
    "identifier": "eb4f26cb-79e2-4599-9a78-fae44f6b27f4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 958.818763ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:14+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5a1a8b0a-2da0-4026-879d-fa1e6096fefc
...
---
Response status code: 409 Conflict. Responded in 128.801114ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5a1a8b0a-2da0-4026-879d-fa1e6096fefc",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:14+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5a1a8b0a-2da0-4026-879d-fa1e6096fefc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Greg.Herman@gmail.com",
    "telephone": "316.955.3557 x055",
    "givenName": "O'Hara",
    "familyName": "Esta",
    "identifier": "cf98a129-b5ac-48d7-b909-b25612058e51"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 297.35788ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:15+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
