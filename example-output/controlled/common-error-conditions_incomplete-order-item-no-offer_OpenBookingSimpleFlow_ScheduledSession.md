...
# common-error-conditions >> incomplete-order-item-no-offer (OpenBookingSimpleFlow >> ScheduledSession)
...
⚠️ 9 passed with 0 failures, 22 warnings and 8 suggestions 
...
---
Response status code: 200 OK. Responded in 86.749506ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2173/events/20173"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2173%2Fevents%2F20173?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1163.799991ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2173/events/20173",
  "modified": 1625165084565,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2173/events/20173",
    "startDate": "2021-07-02T18:44:42+00:00",
    "endDate": "2021-07-02T19:44:42+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2173",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2173#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0b5699b3-99ac-445d-b40c-1eb79f8ba28f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2173/events/20173"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 119.567998ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0b5699b3-99ac-445d-b40c-1eb79f8ba28f",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0b5699b3-99ac-445d-b40c-1eb79f8ba28f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ernie.Johns@hotmail.com",
    "telephone": "615-917-5215 x16734",
    "givenName": "Schmidt",
    "familyName": "Selmer",
    "identifier": "6c07ac1b-02bf-49c8-9eca-75b99564088f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 38.424924ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0b5699b3-99ac-445d-b40c-1eb79f8ba28f
...
---
Response status code: 409 Conflict. Responded in 22.079829ms.
```json
{
  "@context": "https://openactive.io/",
