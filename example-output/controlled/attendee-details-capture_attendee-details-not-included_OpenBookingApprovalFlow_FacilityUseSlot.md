...
# attendee-details-capture >> attendee-details-not-included (OpenBookingApprovalFlow >> FacilityUseSlot)
...
⚠️ 5 passed with 0 failures, 55 warnings and 6 suggestions 
...
---
Response status code: 200 OK. Responded in 21.845771ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2272/facility-use-slots/20272"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2272%2Ffacility-use-slots%2F20272?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2073.183789ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2272/facility-use-slots/20272",
  "modified": 1625165238122,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2272",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2272/facility-use-slots/20272#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:47:15+00:00",
    "endDate": "2021-07-02T19:47:15+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/072a2c07-54cb-45d1-8022-e13217e8c561
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2272/facility-use-slots/20272#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2272/facility-use-slots/20272"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 152.979495ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/072a2c07-54cb-45d1-8022-e13217e8c561",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:17+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/072a2c07-54cb-45d1-8022-e13217e8c561
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Macy_Satterfield66@hotmail.com",
    "telephone": "739.577.9532 x912",
    "givenName": "Stiedemann",
    "familyName": "Stephany",
    "identifier": "0e61d4f5-118d-4783-885c-ba86ad102f4d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 104.496316ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/072a2c07-54cb-45d1-8022-e13217e8c561
...
---
Response status code: 409 Conflict. Responded in 708.632134ms.
```json
{
  "@context": "https://openactive.io/",
