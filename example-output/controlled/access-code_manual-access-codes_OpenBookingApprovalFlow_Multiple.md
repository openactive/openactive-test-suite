[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:45:54 GMT+0000 (Coordinated Universal Time)

# access-code >> manual-access-codes (OpenBookingApprovalFlow >> Multiple)
...
---
Response status code: 200 OK. Responded in 233.142496ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2260/events/20260"
}
```
...
---
Response status code: 200 OK. Responded in 346.257931ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2261/events/20261"
}
```
...
---
Response status code: 200 OK. Responded in 223.560959ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2246/facility-use-slots/20246"
}
```
...
---
Response status code: 200 OK. Responded in 190.299332ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2245/facility-use-slots/20245"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2260%2Fevents%2F20260?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 740.113245ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2260/events/20260",
  "modified": 1625165199591,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2260/events/20260",
    "startDate": "2021-07-02T18:46:37+00:00",
    "endDate": "2021-07-02T19:46:37+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2260",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2260#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2261%2Fevents%2F20261?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2027.271193ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2261/events/20261",
  "modified": 1625165200880,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2261",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2261#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2246%2Ffacility-use-slots%2F20246?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1325.850396ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2246/facility-use-slots/20246",
  "modified": 1625165200175,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2246",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2246/facility-use-slots/20246#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2245%2Ffacility-use-slots%2F20245?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1314.871255ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2245/facility-use-slots/20245",
  "modified": 1625165200174,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2245",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2245/facility-use-slots/20245#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a2574bc5-231e-496c-b4bc-541bca8af4fe
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2260#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2260/events/20260"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2261#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2261/events/20261"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2246/facility-use-slots/20246#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2246/facility-use-slots/20246"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2245/facility-use-slots/20245#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2245/facility-use-slots/20245"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 649.654397ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a2574bc5-231e-496c-b4bc-541bca8af4fe",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:40+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2260"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2261"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2246"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:46:37+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2245"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:46:37+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a2574bc5-231e-496c-b4bc-541bca8af4fe
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dennis70@gmail.com",
    "telephone": "807-268-6054",
    "givenName": "Champlin",
    "familyName": "Gonzalo",
    "identifier": "4a3cbaf4-7ecc-4b4e-9856-9034a8fbe20c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 728.994685ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:42+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a2574bc5-231e-496c-b4bc-541bca8af4fe
...
---
Response status code: 201 Created. Responded in 753.396386ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a2574bc5-231e-496c-b4bc-541bca8af4fe",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2574bc5-231e-496c-b4bc-541bca8af4fe#/orderedItems/1157",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2260#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2574bc5-231e-496c-b4bc-541bca8af4fe#/orderedItems/1158",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2260#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2574bc5-231e-496c-b4bc-541bca8af4fe#/orderedItems/1159",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2261#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2574bc5-231e-496c-b4bc-541bca8af4fe#/orderedItems/1160",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2246/facility-use-slots/20246#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2574bc5-231e-496c-b4bc-541bca8af4fe#/orderedItems/1161",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2246/facility-use-slots/20246#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a2574bc5-231e-496c-b4bc-541bca8af4fe#/orderedItems/1162",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2245/facility-use-slots/20245#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a2574bc5-231e-496c-b4bc-541bca8af4fe/versions/954e994b-9ac4-470d-abe3-1d60322081b1",
  "payment": {
    "@type": "Payment",
    "identifier": "JRTnb05Ep",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;a2574bc5-231e-496c-b4bc-541bca8af4fe&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/a2574bc5-231e-496c-b4bc-541bca8af4fe


---
Response status code: 200 OK. Responded in 326.863538ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619944902140&afterId=bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b",
  "message": "Listening for UUID: 'a2574bc5-231e-496c-b4bc-541bca8af4fe' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 68.39498ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;a2574bc5-231e-496c-b4bc-541bca8af4fe&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/a2574bc5-231e-496c-b4bc-541bca8af4fe


---
Response status code: 200 OK. Responded in 2222.884704ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a2574bc5-231e-496c-b4bc-541bca8af4fe",
  "modified": 637607620059738200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/a2574bc5-231e-496c-b4bc-541bca8af4fe",
    "identifier": "a2574bc5-231e-496c-b4bc-541bca8af4fe",
...
---
Response status code: 200 OK. Responded in 148.135407ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a2574bc5-231e-496c-b4bc-541bca8af4fe
...
---
Response status code: 201 Created. Responded in 466.863112ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a2574bc5-231e-496c-b4bc-541bca8af4fe",
  "identifier": "a2574bc5-231e-496c-b4bc-541bca8af4fe",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 355.192156ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a2574bc5-231e-496c-b4bc-541bca8af4fe",
  "modified": 637607620086830100
}
```
### Specs
* ✅ should return 200 on success
