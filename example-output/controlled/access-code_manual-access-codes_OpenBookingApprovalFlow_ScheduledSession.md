...
# access-code >> manual-access-codes (OpenBookingApprovalFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 70.955609ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2246/events/20246"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2246%2Fevents%2F20246?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 855.261406ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2246/events/20246",
  "modified": 1625165178513,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2246",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2246#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2246#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2246/events/20246"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 197.774369ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Odessa_Batz@yahoo.com",
    "telephone": "(209) 594-7770 x326",
    "givenName": "Kiehn",
    "familyName": "Ethan",
    "identifier": "0abbbe5c-2453-4eed-a76c-7e2ba66135e6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 320.167783ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13
...
---
Response status code: 201 Created. Responded in 1733.025166ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13#/orderedItems/1092",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2246#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13/versions/8b9db491-5d1c-4b7e-bb2c-d8adb66c80a3",
  "payment": {
    "@type": "Payment",
    "identifier": "ywpYoCkd7",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13


---
Response status code: 200 OK. Responded in 172.868821ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 28.006492ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13


---
Response status code: 200 OK. Responded in 2228.665807ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13",
  "modified": 637607619811844900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13",
    "identifier": "e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13",
...
---
Response status code: 200 OK. Responded in 284.23418ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13
...
---
Response status code: 201 Created. Responded in 737.551528ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13",
  "identifier": "e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1261.2391830000001ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13",
  "modified": 637607619838256600
}
```
### Specs
* ✅ should return 200 on success
