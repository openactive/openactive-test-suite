...
# attendee-details-capture >> attendee-details-not-included (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 15 passed with 0 failures, 292 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 87.211281ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2289/events/20289"
}
```
...
---
Response status code: 200 OK. Responded in 248.244838ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2291/events/20291"
}
```
...
---
Response status code: 200 OK. Responded in 125.380279ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2275/facility-use-slots/20275"
}
```
...
---
Response status code: 200 OK. Responded in 213.492967ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2276/facility-use-slots/20276"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2289%2Fevents%2F20289?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 591.52272ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2289/events/20289",
  "modified": 1625165240568,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2289/events/20289",
    "startDate": "2021-07-02T18:47:18+00:00",
    "endDate": "2021-07-02T19:47:18+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2289",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2289#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2291%2Fevents%2F20291?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1264.317773ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2291/events/20291",
  "modified": 1625165241242,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2291",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2291#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2275%2Ffacility-use-slots%2F20275?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1688.371885ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2275/facility-use-slots/20275",
  "modified": 1625165241667,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2275",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2275/facility-use-slots/20275#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingAttendeeDetails"
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2276%2Ffacility-use-slots%2F20276?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1682.59784ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2276/facility-use-slots/20276",
  "modified": 1625165241668,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2276",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2276/facility-use-slots/20276#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7ac658f3-b85f-479a-aa99-fba6b1c728dc
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2289#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2289/events/20289"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2291#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2291/events/20291"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2275/facility-use-slots/20275#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2275/facility-use-slots/20275"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2276/facility-use-slots/20276#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2276/facility-use-slots/20276"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1100.938054ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7ac658f3-b85f-479a-aa99-fba6b1c728dc",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2289"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2275"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:47:18+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2276"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:47:18+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7ac658f3-b85f-479a-aa99-fba6b1c728dc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lawson.Fay67@hotmail.com",
    "telephone": "575.402.3945",
    "givenName": "Cummings",
    "familyName": "Colten",
    "identifier": "25f8fa4c-f7ec-4c58-b91d-226ac5cc31c5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 387.02495ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:23+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/7ac658f3-b85f-479a-aa99-fba6b1c728dc
...
---
Response status code: 409 Conflict. Responded in 265.52595ms.
```json
{
  "@context": "https://openactive.io/",
