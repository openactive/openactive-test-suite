...
# access-pass-image >> access-pass-image (OpenBookingApprovalFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 19.123011ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2331/events/20331"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2331%2Fevents%2F20331?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1088.334331ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2331/events/20331",
  "modified": 1625165314952,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2331/events/20331",
    "startDate": "2021-07-02T18:48:32+00:00",
    "endDate": "2021-07-02T19:48:32+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2331",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2331#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9bfa9498-fcba-496b-b935-5fb4c7fdf6b3
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2331#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2331/events/20331"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 217.535694ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9bfa9498-fcba-496b-b935-5fb4c7fdf6b3",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9bfa9498-fcba-496b-b935-5fb4c7fdf6b3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dominic84@yahoo.com",
    "telephone": "(992) 711-8758",
    "givenName": "Legros",
    "familyName": "Maida",
    "identifier": "50d70460-0898-4828-bc3c-47c8ab5760a0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1018.781225ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/9bfa9498-fcba-496b-b935-5fb4c7fdf6b3
...
---
Response status code: 201 Created. Responded in 350.131361ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/9bfa9498-fcba-496b-b935-5fb4c7fdf6b3",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9bfa9498-fcba-496b-b935-5fb4c7fdf6b3#/orderedItems/1512",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2331#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/9bfa9498-fcba-496b-b935-5fb4c7fdf6b3/versions/47847558-4cb7-47f8-9634-deae84da0449",
  "payment": {
    "@type": "Payment",
    "identifier": "VO5xbJHmJ",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;9bfa9498-fcba-496b-b935-5fb4c7fdf6b3&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/9bfa9498-fcba-496b-b935-5fb4c7fdf6b3


---
Response status code: 200 OK. Responded in 332.08807ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621038605721&afterId=0d028192-8bb5-4c72-a244-972c0a740c06",
  "message": "Listening for UUID: '9bfa9498-fcba-496b-b935-5fb4c7fdf6b3' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 330.277861ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;9bfa9498-fcba-496b-b935-5fb4c7fdf6b3&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/9bfa9498-fcba-496b-b935-5fb4c7fdf6b3


---
Response status code: 200 OK. Responded in 1898.148749ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "9bfa9498-fcba-496b-b935-5fb4c7fdf6b3",
  "modified": 637607621168356700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/9bfa9498-fcba-496b-b935-5fb4c7fdf6b3",
    "identifier": "9bfa9498-fcba-496b-b935-5fb4c7fdf6b3",
...
---
Response status code: 200 OK. Responded in 162.049315ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9bfa9498-fcba-496b-b935-5fb4c7fdf6b3
...
---
Response status code: 201 Created. Responded in 194.271377ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9bfa9498-fcba-496b-b935-5fb4c7fdf6b3",
  "identifier": "9bfa9498-fcba-496b-b935-5fb4c7fdf6b3",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1722.4131149999998ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "9bfa9498-fcba-496b-b935-5fb4c7fdf6b3",
  "modified": 637607621192878200
}
```
### Specs
* ✅ should return 200 on success
