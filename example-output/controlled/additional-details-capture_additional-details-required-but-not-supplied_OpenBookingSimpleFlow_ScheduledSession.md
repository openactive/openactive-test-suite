...
# additional-details-capture >> additional-details-required-but-not-supplied (OpenBookingSimpleFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 72.212822ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2309/events/20309"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2309%2Fevents%2F20309?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 763.269961ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2309/events/20309",
  "modified": 1625165282281,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2309",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2309#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b90154e2-9c68-408b-96fd-d4a8d37004ef
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2309#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2309/events/20309"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 226.350518ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b90154e2-9c68-408b-96fd-d4a8d37004ef",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:01+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2309"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b90154e2-9c68-408b-96fd-d4a8d37004ef
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jerrod95@gmail.com",
    "telephone": "(806) 260-2053 x113",
    "givenName": "Block",
    "familyName": "Deangelo",
    "identifier": "12a90b27-f593-4570-8db0-2c079a20df1d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 191.704647ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b90154e2-9c68-408b-96fd-d4a8d37004ef
...
---
Response status code: 409 Conflict. Responded in 69.719045ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 409,
  "description": "The 'orderItemIntakeFormResponse' is missing fields that are specified as 'valueRequired' within the 'orderItemIntakeForm'.: Incomplete additional details supplied"
}
```
### Specs
