...
---
Response status code: 200 OK. Responded in 45.053501ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1749.068876ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2221/facility-use-slots/20221",
  "modified": 1625165154282,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2021-06-30T18:45:51+00:00",
    "endDate": "2021-06-30T19:45:51+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b6bad54e-5dba-41df-b1e8-383a95af8d37
...
---
Response status code: 409 Conflict. Responded in 101.650379ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b6bad54e-5dba-41df-b1e8-383a95af8d37",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b6bad54e-5dba-41df-b1e8-383a95af8d37
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lindsay_Streich95@gmail.com",
    "telephone": "267-942-2772",
    "givenName": "Wilderman",
    "familyName": "Roma",
    "identifier": "33b943b7-3fa2-4cdb-9cb7-0b40ef0e7581"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 87.273513ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b6bad54e-5dba-41df-b1e8-383a95af8d37
...
---
Response status code: 409 Conflict. Responded in 136.14228ms.
```json
{
  "@context": "https://openactive.io/",
