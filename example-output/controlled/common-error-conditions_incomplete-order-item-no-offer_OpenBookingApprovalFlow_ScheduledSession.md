...
# common-error-conditions >> incomplete-order-item-no-offer (OpenBookingApprovalFlow >> ScheduledSession)
...
⚠️ 9 passed with 0 failures, 24 warnings and 8 suggestions 
...
---
Response status code: 200 OK. Responded in 83.853166ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2177/events/20177"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2177%2Fevents%2F20177?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1316.668268ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2177/events/20177",
  "modified": 1625165092196,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2177/events/20177",
    "startDate": "2021-07-02T18:44:49+00:00",
    "endDate": "2021-07-02T19:44:49+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2177",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2177#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8dfc8b63-4471-4373-82d0-e06cc15a8b5a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2177/events/20177"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 134.867053ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8dfc8b63-4471-4373-82d0-e06cc15a8b5a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:51+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8dfc8b63-4471-4373-82d0-e06cc15a8b5a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Gardner75@yahoo.com",
    "telephone": "(804) 256-3276 x460",
    "givenName": "Tromp",
    "familyName": "Dayton",
    "identifier": "58bc4076-8f21-4eab-aeed-88d3380ba57a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 109.456261ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/8dfc8b63-4471-4373-82d0-e06cc15a8b5a
...
---
Response status code: 409 Conflict. Responded in 24.997988ms.
```json
{
  "@context": "https://openactive.io/",
