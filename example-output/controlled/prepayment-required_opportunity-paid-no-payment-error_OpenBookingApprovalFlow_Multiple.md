...
---
Response status code: 200 OK. Responded in 102.827315ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2495/events/20495"
}
```
...
---
Response status code: 200 OK. Responded in 176.374254ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2480/facility-use-slots/20480"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2495%2Fevents%2F20495?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 866.509982ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2495/events/20495",
  "modified": 1625165822288,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2495/events/20495",
    "startDate": "2021-07-02T18:57:00+00:00",
    "endDate": "2021-07-02T19:57:00+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2495",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2495#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2480%2Ffacility-use-slots%2F20480?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1357.559918ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2480/facility-use-slots/20480",
  "modified": 1625165822779,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2480",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2480/facility-use-slots/20480#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/80e5991b-1a73-4fbc-bdd7-ed8538bc3787
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2495#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2495/events/20495"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2480/facility-use-slots/20480#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2480/facility-use-slots/20480"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 632.963385ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/80e5991b-1a73-4fbc-bdd7-ed8538bc3787",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2495"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/80e5991b-1a73-4fbc-bdd7-ed8538bc3787
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "885.390.6015 x39567",
    "givenName": "Fisher",
    "familyName": "Katherine",
    "identifier": "486305f1-3488-46d5-bbe6-81ecda60fbee"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 978.611352ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/80e5991b-1a73-4fbc-bdd7-ed8538bc3787
...
---
Response status code: 400 Bad Request. Responded in 82.237592ms.
```json
{
  "@context": "https://openactive.io/",
