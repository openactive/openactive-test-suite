...
# reseller-broker >> customer-included-resellerbroker-mode (OpenBookingApprovalFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 230.929062ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2448/facility-use-slots/20448"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2448%2Ffacility-use-slots%2F20448?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2006.758137ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2448/facility-use-slots/20448",
  "modified": 1625165731807,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2448",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2448/facility-use-slots/20448#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:55:28+00:00",
    "endDate": "2021-07-02T19:55:28+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b65357c5-e7ad-40c6-afd7-7c67168bce82
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2448/facility-use-slots/20448#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2448/facility-use-slots/20448"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1143.249119ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b65357c5-e7ad-40c6-afd7-7c67168bce82",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:00:31+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b65357c5-e7ad-40c6-afd7-7c67168bce82
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sydnie_Gorczany73@yahoo.com",
    "telephone": "852.284.1249",
    "givenName": "Lynch",
    "familyName": "Ivah",
    "identifier": "3c8b2342-db58-4341-8825-14f750554d6f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 441.789746ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:00:32+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b65357c5-e7ad-40c6-afd7-7c67168bce82
...
---
Response status code: 201 Created. Responded in 1005.881647ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b65357c5-e7ad-40c6-afd7-7c67168bce82",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b65357c5-e7ad-40c6-afd7-7c67168bce82#/orderedItems/2440",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2448/facility-use-slots/20448#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b65357c5-e7ad-40c6-afd7-7c67168bce82/versions/0189b95d-7e44-4c22-8441-c2c114b75ffe",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;b65357c5-e7ad-40c6-afd7-7c67168bce82&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/b65357c5-e7ad-40c6-afd7-7c67168bce82


---
Response status code: 200 OK. Responded in 36.076182ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607625265050238&afterId=f8e4e5cd-95d8-4173-b516-ff652ff57a3c",
  "message": "Listening for UUID: 'b65357c5-e7ad-40c6-afd7-7c67168bce82' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 52.59951ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;b65357c5-e7ad-40c6-afd7-7c67168bce82&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/b65357c5-e7ad-40c6-afd7-7c67168bce82


---
Response status code: 200 OK. Responded in 2416.14545ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b65357c5-e7ad-40c6-afd7-7c67168bce82",
  "modified": 637607625340215800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/b65357c5-e7ad-40c6-afd7-7c67168bce82",
    "identifier": "b65357c5-e7ad-40c6-afd7-7c67168bce82",
...
---
Response status code: 200 OK. Responded in 4.774737ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607625340215855&afterId=b65357c5-e7ad-40c6-afd7-7c67168bce82",
  "message": "Listening for UUID: 'b65357c5-e7ad-40c6-afd7-7c67168bce82' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/b65357c5-e7ad-40c6-afd7-7c67168bce82
...
---
Response status code: 201 Created. Responded in 248.086636ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b65357c5-e7ad-40c6-afd7-7c67168bce82",
  "identifier": "b65357c5-e7ad-40c6-afd7-7c67168bce82",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1371.304995ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "b65357c5-e7ad-40c6-afd7-7c67168bce82",
  "modified": 637607625365146100
}
```
### Specs
* ✅ should return 200 on success
