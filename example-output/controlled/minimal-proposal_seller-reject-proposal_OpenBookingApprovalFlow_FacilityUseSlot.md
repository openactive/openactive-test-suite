...
---
Response status code: 200 OK. Responded in 162.436754ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2001/facility-use-slots/20001"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2001%2Ffacility-use-slots%2F20001?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2415.310185ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2001/facility-use-slots/20001",
  "modified": 1625164722909,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2001",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2001/facility-use-slots/20001#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:38:39+00:00",
    "endDate": "2021-07-02T19:38:39+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/32e5b2d8-c2b7-4ced-b5a4-f23d52995d45
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2001/facility-use-slots/20001#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2001/facility-use-slots/20001"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 317.553564ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/32e5b2d8-c2b7-4ced-b5a4-f23d52995d45",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:42+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/32e5b2d8-c2b7-4ced-b5a4-f23d52995d45
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Annetta92@hotmail.com",
    "telephone": "1-639-769-9031 x1550",
    "givenName": "Skiles",
    "familyName": "Carrie",
    "identifier": "2efeb63f-2bdd-4712-9e01-04b2a97280bd"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 85.1494ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/32e5b2d8-c2b7-4ced-b5a4-f23d52995d45
...
---
Response status code: 201 Created. Responded in 133.751386ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/32e5b2d8-c2b7-4ced-b5a4-f23d52995d45",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/32e5b2d8-c2b7-4ced-b5a4-f23d52995d45#/orderedItems/24",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2001/facility-use-slots/20001#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/32e5b2d8-c2b7-4ced-b5a4-f23d52995d45/versions/ace0a6c5-fd88-47b1-8a4f-c18b67dadd62",
  "payment": {
    "@type": "Payment",
    "identifier": "2VHcILiKR",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;32e5b2d8-c2b7-4ced-b5a4-f23d52995d45&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/32e5b2d8-c2b7-4ced-b5a4-f23d52995d45


---
Response status code: 200 OK. Responded in 390.578493ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607615161342349&afterId=512b7f72-eb41-4323-b869-531234c74281",
  "message": "Listening for UUID: '32e5b2d8-c2b7-4ced-b5a4-f23d52995d45' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 64.64258ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:SellerRejectOrderProposalSimulateAction)

### Orders (order-proposals) Feed collect for &#x27;32e5b2d8-c2b7-4ced-b5a4-f23d52995d45&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/32e5b2d8-c2b7-4ced-b5a4-f23d52995d45


---
Response status code: 200 OK. Responded in 2523.854516ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "32e5b2d8-c2b7-4ced-b5a4-f23d52995d45",
  "modified": 637607615237807700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/32e5b2d8-c2b7-4ced-b5a4-f23d52995d45",
    "identifier": "32e5b2d8-c2b7-4ced-b5a4-f23d52995d45",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/32e5b2d8-c2b7-4ced-b5a4-f23d52995d45
...
---
Response status code: 500 Internal Server Error. Responded in 76.958451ms.
```json
{
  "@context": "https://openactive.io/",
