[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:57:35 GMT+0000 (Coordinated Universal Time)

# free-opportunities >> opportunity-free (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 15 passed with 0 failures, 171 warnings and 42 suggestions 
...
---
Response status code: 200 OK. Responded in 853.382633ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2526/events/20526"
}
```
...
---
Response status code: 200 OK. Responded in 866.422957ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2514/facility-use-slots/20514"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2526%2Fevents%2F20526?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1155.2103769999999ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2526/events/20526",
  "modified": 1625165898215,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2526/events/20526",
    "startDate": "2021-07-02T18:58:15+00:00",
    "endDate": "2021-07-02T19:58:15+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2526",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2526#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2514%2Ffacility-use-slots%2F20514?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 632.265237ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2514/facility-use-slots/20514",
  "modified": 1625165897696,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2514",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2514/facility-use-slots/20514#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2526#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2526/events/20526"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2514/facility-use-slots/20514#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2514/facility-use-slots/20514"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2417.975847ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:03:19+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2526"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2514"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:58:15+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Yessenia_Koelpin@hotmail.com",
    "telephone": "(713) 994-2357 x61068",
    "givenName": "Witting",
    "familyName": "Victoria",
    "identifier": "366bfcfc-b51d-4741-b016-bc9e98a31b44"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2355.57204ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:03:22+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124
...
---
Response status code: 201 Created. Responded in 946.343279ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124#/orderedItems/2896",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2526#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124#/orderedItems/2897",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2514/facility-use-slots/20514#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124/versions/2a2823ef-ddb5-45ea-9a1b-3f32b9ae0378",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;3ba07ea3-ca5a-4b57-a8a1-b96f1e673124&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124


---
Response status code: 200 OK. Responded in 56.754253ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607626992383130&afterId=da5b5159-b624-400f-bd71-b8e0de5e5663",
  "message": "Listening for UUID: '3ba07ea3-ca5a-4b57-a8a1-b96f1e673124' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 70.886666ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;3ba07ea3-ca5a-4b57-a8a1-b96f1e673124&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124


---
Response status code: 200 OK. Responded in 2318.770053ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "3ba07ea3-ca5a-4b57-a8a1-b96f1e673124",
  "modified": 637607627043115000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124",
    "identifier": "3ba07ea3-ca5a-4b57-a8a1-b96f1e673124",
...
---
Response status code: 200 OK. Responded in 4.140657ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607627043115030&afterId=3ba07ea3-ca5a-4b57-a8a1-b96f1e673124",
  "message": "Listening for UUID: '3ba07ea3-ca5a-4b57-a8a1-b96f1e673124' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124
...
---
Response status code: 201 Created. Responded in 3951.529192ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/3ba07ea3-ca5a-4b57-a8a1-b96f1e673124",
  "identifier": "3ba07ea3-ca5a-4b57-a8a1-b96f1e673124",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 18.108649ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "3ba07ea3-ca5a-4b57-a8a1-b96f1e673124",
  "modified": 637607627068990800
}
```
### Specs
* ✅ should return 200 on success
