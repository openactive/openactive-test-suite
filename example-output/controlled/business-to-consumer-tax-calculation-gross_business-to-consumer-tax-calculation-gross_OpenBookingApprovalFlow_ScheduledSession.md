...
---
Response status code: 200 OK. Responded in 202.35484ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2554/events/20554"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2554%2Fevents%2F20554?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1522.640255ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2554/events/20554",
  "modified": 1625165966288,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2554/events/20554",
    "startDate": "2021-07-02T18:59:23+00:00",
    "endDate": "2021-07-02T19:59:23+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2554",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2554#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3c6392d6-4569-4d81-8f55-d6811eb530c2
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2554#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2554/events/20554"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 655.992055ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3c6392d6-4569-4d81-8f55-d6811eb530c2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:04:25+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3c6392d6-4569-4d81-8f55-d6811eb530c2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Carole.Price@yahoo.com",
    "telephone": "948-748-0326",
    "givenName": "Greenholt",
    "familyName": "Van",
    "identifier": "f5f66b6e-2cc8-4608-b4c8-4977960a88eb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 439.704505ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:04:26+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/3c6392d6-4569-4d81-8f55-d6811eb530c2
...
---
Response status code: 201 Created. Responded in 693.22888ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/3c6392d6-4569-4d81-8f55-d6811eb530c2",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3c6392d6-4569-4d81-8f55-d6811eb530c2#/orderedItems/3049",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2554#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/3c6392d6-4569-4d81-8f55-d6811eb530c2/versions/9200a779-a784-4d96-b813-232fac683c2e",
  "payment": {
    "@type": "Payment",
    "identifier": "rKlW0hK0a",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;3c6392d6-4569-4d81-8f55-d6811eb530c2&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/3c6392d6-4569-4d81-8f55-d6811eb530c2


---
Response status code: 200 OK. Responded in 25.264918ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '3c6392d6-4569-4d81-8f55-d6811eb530c2' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 31.238222ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;3c6392d6-4569-4d81-8f55-d6811eb530c2&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/3c6392d6-4569-4d81-8f55-d6811eb530c2


---
Response status code: 200 OK. Responded in 2446.046818ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "3c6392d6-4569-4d81-8f55-d6811eb530c2",
  "modified": 637607627679869600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/3c6392d6-4569-4d81-8f55-d6811eb530c2",
    "identifier": "3c6392d6-4569-4d81-8f55-d6811eb530c2",
...
---
Response status code: 200 OK. Responded in 4.900569ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607627679869628&afterId=3c6392d6-4569-4d81-8f55-d6811eb530c2",
  "message": "Listening for UUID: '3c6392d6-4569-4d81-8f55-d6811eb530c2' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/3c6392d6-4569-4d81-8f55-d6811eb530c2
...
---
Response status code: 201 Created. Responded in 227.182368ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/3c6392d6-4569-4d81-8f55-d6811eb530c2",
  "identifier": "3c6392d6-4569-4d81-8f55-d6811eb530c2",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 774.023219ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "3c6392d6-4569-4d81-8f55-d6811eb530c2",
  "modified": 637607627704843100
}
```
### Specs
* ✅ should return 200 on success
