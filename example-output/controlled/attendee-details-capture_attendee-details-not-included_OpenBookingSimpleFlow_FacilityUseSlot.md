...
---
Response status code: 200 OK. Responded in 53.914393ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2264/facility-use-slots/20264"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2264%2Ffacility-use-slots%2F20264?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1426.095918ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2264/facility-use-slots/20264",
  "modified": 1625165226476,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2264",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2264/facility-use-slots/20264#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:47:04+00:00",
    "endDate": "2021-07-02T19:47:04+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ad5a1354-a583-4c06-8ce4-6693f6d1efb2
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2264/facility-use-slots/20264#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2264/facility-use-slots/20264"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 177.461639ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ad5a1354-a583-4c06-8ce4-6693f6d1efb2",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ad5a1354-a583-4c06-8ce4-6693f6d1efb2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Clara.Upton@yahoo.com",
    "telephone": "1-209-667-0040 x0676",
    "givenName": "Krajcik",
    "familyName": "Kirstin",
    "identifier": "2d11d2fb-7472-460c-b3e0-2f21bcb32ddc"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 512.996159ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ad5a1354-a583-4c06-8ce4-6693f6d1efb2
...
---
Response status code: 409 Conflict. Responded in 150.47852ms.
```json
{
  "@context": "https://openactive.io/",
