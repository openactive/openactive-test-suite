...
# reseller-broker >> customer-included-resellerbroker-mode (OpenBookingApprovalFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 119.767854ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2456/events/20456"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2456%2Fevents%2F20456?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 843.200274ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2456/events/20456",
  "modified": 1625165723113,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2456",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2456#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f8e4e5cd-95d8-4173-b516-ff652ff57a3c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2456#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2456/events/20456"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 200.914534ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f8e4e5cd-95d8-4173-b516-ff652ff57a3c",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f8e4e5cd-95d8-4173-b516-ff652ff57a3c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Eldred99@hotmail.com",
    "telephone": "(793) 818-3471 x98013",
    "givenName": "Hodkiewicz",
    "familyName": "Alec",
    "identifier": "181060ae-c197-45ca-aade-0076f82148b7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 332.226736ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/f8e4e5cd-95d8-4173-b516-ff652ff57a3c
...
---
Response status code: 201 Created. Responded in 333.552546ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/f8e4e5cd-95d8-4173-b516-ff652ff57a3c",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f8e4e5cd-95d8-4173-b516-ff652ff57a3c#/orderedItems/2396",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2456#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/f8e4e5cd-95d8-4173-b516-ff652ff57a3c/versions/d9fa52c9-bfbb-457d-9df4-3f9d3691794f",
  "payment": {
    "@type": "Payment",
    "identifier": "qN3xxzTk9",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;f8e4e5cd-95d8-4173-b516-ff652ff57a3c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/f8e4e5cd-95d8-4173-b516-ff652ff57a3c


---
Response status code: 200 OK. Responded in 4.551835ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607625118306245&afterId=3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc",
  "message": "Listening for UUID: 'f8e4e5cd-95d8-4173-b516-ff652ff57a3c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 131.623405ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;f8e4e5cd-95d8-4173-b516-ff652ff57a3c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/f8e4e5cd-95d8-4173-b516-ff652ff57a3c


---
Response status code: 200 OK. Responded in 2241.23481ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "f8e4e5cd-95d8-4173-b516-ff652ff57a3c",
  "modified": 637607625238206800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/f8e4e5cd-95d8-4173-b516-ff652ff57a3c",
    "identifier": "f8e4e5cd-95d8-4173-b516-ff652ff57a3c",
...
---
Response status code: 200 OK. Responded in 17.03333ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607625238206877&afterId=f8e4e5cd-95d8-4173-b516-ff652ff57a3c",
  "message": "Listening for UUID: 'f8e4e5cd-95d8-4173-b516-ff652ff57a3c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/f8e4e5cd-95d8-4173-b516-ff652ff57a3c
...
---
Response status code: 201 Created. Responded in 755.282766ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f8e4e5cd-95d8-4173-b516-ff652ff57a3c",
  "identifier": "f8e4e5cd-95d8-4173-b516-ff652ff57a3c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1117.542831ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "f8e4e5cd-95d8-4173-b516-ff652ff57a3c",
  "modified": 637607625265050200
}
```
### Specs
* ✅ should return 200 on success
