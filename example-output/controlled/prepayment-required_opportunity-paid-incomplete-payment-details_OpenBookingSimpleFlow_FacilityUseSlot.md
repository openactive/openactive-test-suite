...
# prepayment-required >> opportunity-paid-incomplete-payment-details (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 23.58495ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2460/facility-use-slots/20460"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2460%2Ffacility-use-slots%2F20460?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 866.538894ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2460/facility-use-slots/20460",
  "modified": 1625165770069,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2460",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2460/facility-use-slots/20460#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:56:08+00:00",
    "endDate": "2021-07-02T19:56:08+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a998eb5e-c3a8-4e35-a18e-3c3e49fc8b71
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2460/facility-use-slots/20460#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2460/facility-use-slots/20460"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 529.740459ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a998eb5e-c3a8-4e35-a18e-3c3e49fc8b71",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a998eb5e-c3a8-4e35-a18e-3c3e49fc8b71
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Vesta71@gmail.com",
    "telephone": "443.923.2470 x7561",
    "givenName": "Miller",
    "familyName": "Gabriella",
    "identifier": "e963f93b-4d5f-47d5-8720-464588c00d48"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 591.754045ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a998eb5e-c3a8-4e35-a18e-3c3e49fc8b71
...
---
Response status code: 400 Bad Request. Responded in 35.440725ms.
```json
{
  "@context": "https://openactive.io/",
