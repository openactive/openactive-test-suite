...
---
Response status code: 200 OK. Responded in 30.471351ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2297/facility-use-slots/20297"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2297%2Ffacility-use-slots%2F20297?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1865.150813ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2297/facility-use-slots/20297",
  "modified": 1625165285857,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2297",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2297/facility-use-slots/20297#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:48:02+00:00",
    "endDate": "2021-07-02T19:48:02+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b4a739f5-12e5-4014-a223-6e5a8ef60003
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2297/facility-use-slots/20297#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2297/facility-use-slots/20297"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 229.314033ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b4a739f5-12e5-4014-a223-6e5a8ef60003",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b4a739f5-12e5-4014-a223-6e5a8ef60003
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Royce99@yahoo.com",
    "telephone": "(590) 384-5188 x3281",
    "givenName": "Howell",
    "familyName": "Audie",
    "identifier": "808cb45c-5179-4eba-92ec-f97e4ceb6494"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 95.214971ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b4a739f5-12e5-4014-a223-6e5a8ef60003
...
---
Response status code: 409 Conflict. Responded in 68.272637ms.
```json
{
  "@context": "https://openactive.io/",
