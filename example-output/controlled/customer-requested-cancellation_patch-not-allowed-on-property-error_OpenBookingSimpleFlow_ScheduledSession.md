...
# customer-requested-cancellation >> patch-not-allowed-on-property-error (OpenBookingSimpleFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 291.717167ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2332/events/20332"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2332%2Fevents%2F20332?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1359.358339ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2332/events/20332",
  "modified": 1625165316457,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2332/events/20332",
    "startDate": "2021-07-02T18:48:33+00:00",
    "endDate": "2021-07-02T19:48:33+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2332",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2332#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0d241594-6c19-4625-8381-02533f28f024
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2332#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2332/events/20332"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 408.816357ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0d241594-6c19-4625-8381-02533f28f024",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:36+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2332"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0d241594-6c19-4625-8381-02533f28f024
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Moriah.Beatty58@hotmail.com",
    "telephone": "793.750.8895 x28807",
    "givenName": "Jones",
    "familyName": "Jocelyn",
    "identifier": "7d8cc852-9167-4789-91d1-4d674e2e2bc8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 365.79254ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0d241594-6c19-4625-8381-02533f28f024
...
---
Response status code: 201 Created. Responded in 707.60356ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/0d241594-6c19-4625-8381-02533f28f024",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0d241594-6c19-4625-8381-02533f28f024#/orderedItems/1521",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2332#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/0d241594-6c19-4625-8381-02533f28f024
...
---
Response status code: 400 Bad Request. Responded in 93.181636ms.
```json
{
  "@context": "https://openactive.io/",
