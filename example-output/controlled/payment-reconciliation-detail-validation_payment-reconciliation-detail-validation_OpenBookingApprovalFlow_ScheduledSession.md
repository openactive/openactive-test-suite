...
---
Response status code: 200 OK. Responded in 24.136025ms.
```json
{
...
---
Response status code: 200 OK. Responded in 997.660291ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2602/events/20602",
  "modified": 1625166073884,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2602/events/20602",
    "startDate": "2021-07-02T19:01:11+00:00",
    "endDate": "2021-07-02T20:01:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9f64eee1-5946-4c85-a087-1acf72dfdd7f
...
---
Response status code: 200 OK. Responded in 279.631455ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9f64eee1-5946-4c85-a087-1acf72dfdd7f",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:06:13+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9f64eee1-5946-4c85-a087-1acf72dfdd7f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Brook3@hotmail.com",
    "telephone": "1-596-786-8535",
    "givenName": "Ratke",
    "familyName": "Junior",
    "identifier": "02cdc59b-fed9-4470-b471-62ed9187e7b9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 259.669652ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/9f64eee1-5946-4c85-a087-1acf72dfdd7f
...
---
Response status code: 201 Created. Responded in 263.051869ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/9f64eee1-5946-4c85-a087-1acf72dfdd7f",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9f64eee1-5946-4c85-a087-1acf72dfdd7f#/orderedItems/3259",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2602#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/9f64eee1-5946-4c85-a087-1acf72dfdd7f/versions/6cc93da7-9d4a-4e1f-8392-fef685609bdf",
  "payment": {
    "@type": "Payment",
    "identifier": "xLzhSAYnl",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;9f64eee1-5946-4c85-a087-1acf72dfdd7f&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/9f64eee1-5946-4c85-a087-1acf72dfdd7f


---
Response status code: 200 OK. Responded in 9.838752ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607628537881873&afterId=30c79e2a-8042-4221-8653-e721d8037ff0",
  "message": "Listening for UUID: '9f64eee1-5946-4c85-a087-1acf72dfdd7f' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 17.958393ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;9f64eee1-5946-4c85-a087-1acf72dfdd7f&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/9f64eee1-5946-4c85-a087-1acf72dfdd7f


---
Response status code: 200 OK. Responded in 2474.945319ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "9f64eee1-5946-4c85-a087-1acf72dfdd7f",
  "modified": 637607628741945600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/9f64eee1-5946-4c85-a087-1acf72dfdd7f",
    "identifier": "9f64eee1-5946-4c85-a087-1acf72dfdd7f",
...
---
Response status code: 200 OK. Responded in 4.527424ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607628741945548&afterId=9f64eee1-5946-4c85-a087-1acf72dfdd7f",
  "message": "Listening for UUID: '9f64eee1-5946-4c85-a087-1acf72dfdd7f' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/9f64eee1-5946-4c85-a087-1acf72dfdd7f
...
---
Response status code: 201 Created. Responded in 186.663292ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9f64eee1-5946-4c85-a087-1acf72dfdd7f",
  "identifier": "9f64eee1-5946-4c85-a087-1acf72dfdd7f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1649.222966ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "9f64eee1-5946-4c85-a087-1acf72dfdd7f",
  "modified": 637607628767180000
}
```
### Specs
* ✅ should return 200 on success
