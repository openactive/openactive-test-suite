...
# customer-requested-cancellation >> patch-contains-excessive-properties-error (OpenBookingSimpleFlow >> ScheduledSession)
...
⚠️ 6 passed with 0 failures, 73 warnings and 26 suggestions 
...
---
Response status code: 200 OK. Responded in 93.338242ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2328/events/20328"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2328%2Fevents%2F20328?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1172.092011ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2328/events/20328",
  "modified": 1625165313833,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2328/events/20328",
    "startDate": "2021-07-02T18:48:31+00:00",
    "endDate": "2021-07-02T19:48:31+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2328",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2328#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/08fd7eb3-5038-4cb0-b46b-8ed079fbc59a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2328#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2328/events/20328"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 195.125633ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/08fd7eb3-5038-4cb0-b46b-8ed079fbc59a",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2328"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/08fd7eb3-5038-4cb0-b46b-8ed079fbc59a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jillian67@hotmail.com",
    "telephone": "631.400.9292",
    "givenName": "Denesik",
    "familyName": "Nettie",
    "identifier": "3d7de91e-175c-44f6-83cc-7b68535cf526"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 224.231028ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/08fd7eb3-5038-4cb0-b46b-8ed079fbc59a
...
---
Response status code: 201 Created. Responded in 993.895ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/08fd7eb3-5038-4cb0-b46b-8ed079fbc59a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/08fd7eb3-5038-4cb0-b46b-8ed079fbc59a#/orderedItems/1504",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2328#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/08fd7eb3-5038-4cb0-b46b-8ed079fbc59a
...
---
Response status code: 400 Bad Request. Responded in 36.579384ms.
```json
{
  "@context": "https://openactive.io/",
