[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:41:09 GMT+0000 (Coordinated Universal Time)

# availability-check >> opportunity-full (OpenBookingSimpleFlow >> Multiple)
...
**Test:**  OpportunityIsFullError returned for full OrderItems
...
```bash
npm start -- --runInBand test/features/core/availability-check/implemented/opportunity-full-test.js
```

---

⚠️ 28 passed with 0 failures, 297 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 106.865674ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2076/events/20076"
}
```
...
---
Response status code: 200 OK. Responded in 192.933514ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2077/events/20077"
}
```
...
---
Response status code: 200 OK. Responded in 48.432179ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2074/facility-use-slots/20074"
}
```
...
---
Response status code: 200 OK. Responded in 123.941103ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2075/facility-use-slots/20075"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2076%2Fevents%2F20076?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1225.568599ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2076/events/20076",
  "modified": 1625164878380,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2076/events/20076",
    "startDate": "2021-07-02T18:41:15+00:00",
    "endDate": "2021-07-02T19:41:15+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2076",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Free Event No Spaces",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2076#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2077%2Fevents%2F20077?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1224.791998ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2077/events/20077",
  ...
  "data": {
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2077/events/20077",
    "startDate": "2021-07-02T18:41:16+00:00",
    "endDate": "2021-07-02T19:41:16+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2077",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2077#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 14.99,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2074%2Ffacility-use-slots%2F20074?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 924.479508ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2074/facility-use-slots/20074",
  "modified": 1625164878081,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2074",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Free Facility No Spaces",
      "activity": [
        {
          "@type": "Concept",
          "@id": "https://openactive.io/activity-list#c07d63a0-8eb9-4602-8bcc-23be6deb8f83",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2074/facility-use-slots/20074#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 14.99,
        "priceCurrency": "GBP"
      }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2075%2Ffacility-use-slots%2F20075?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 929.587316ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2075/facility-use-slots/20075",
  "modified": 1625164878087,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2075",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2075/facility-use-slots/20075#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ea98cc1e-25f3-4db6-86f7-3a914c6f6acf
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2076#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2076/events/20076"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2077#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2077/events/20077"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2074/facility-use-slots/20074#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2074/facility-use-slots/20074"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2075/facility-use-slots/20075#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2075/facility-use-slots/20075"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 312.155109ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ea98cc1e-25f3-4db6-86f7-3a914c6f6acf",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:18+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2076"
        },
        "maximumAttendeeCapacity": 0,
        "remainingAttendeeCapacity": 0
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2077"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2074"
        },
        "maximumUses": 0,
        "remainingUses": 0,
        "startDate": "2021-07-02T18:41:16+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2075"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:41:16+00:00",
...
* ✅ OrderItem at position 1 - should include an OpportunityIsFullError
* ✅ OrderItem at position 2 - should not include an OpportunityIsFullError
* ✅ OrderItem at position 3 - should include an OpportunityIsFullError
* ✅ OrderItem at position 4 - should include an OpportunityIsFullError
* ✅ OrderItem at position 5 - should not include an OpportunityIsFullError
 ...
 * ⚠️ $.orderedItem[1].error[0].description: Recommended property `description` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[1].error[0].instance: Recommended property `instance` is missing from `OpportunityIsFullError`.
 ...
 * ⚠️ $.orderedItem[3].error[0].description: Recommended property `description` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[3].error[0].instance: Recommended property `instance` is missing from `OpportunityIsFullError`.
 ...
 * ⚠️ $.orderedItem[4].error[0].description: Recommended property `description` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[4].error[0].instance: Recommended property `instance` is missing from `OpportunityIsFullError`.
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ea98cc1e-25f3-4db6-86f7-3a914c6f6acf
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Trisha22@gmail.com",
    "telephone": "1-353-379-5063 x4694",
    "givenName": "Turcotte",
    "familyName": "Garry",
    "identifier": "d19a2dc5-a189-4b8f-8149-4799ffe092e9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 246.800102ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:19+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
