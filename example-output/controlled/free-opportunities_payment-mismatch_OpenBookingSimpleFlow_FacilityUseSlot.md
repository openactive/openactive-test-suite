...
# free-opportunities >> payment-mismatch (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 1009.397693ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2420/facility-use-slots/20420"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2420%2Ffacility-use-slots%2F20420?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2242.322969ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2420/facility-use-slots/20420",
  "modified": 1625165639566,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2420",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2420/facility-use-slots/20420#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:53:55+00:00",
    "endDate": "2021-07-02T19:53:55+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6b92e652-d614-4f5b-ae93-a1daf15bd0cc
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2420/facility-use-slots/20420#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2420/facility-use-slots/20420"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2252.1623250000002ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6b92e652-d614-4f5b-ae93-a1daf15bd0cc",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:00+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2420"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:53:55+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6b92e652-d614-4f5b-ae93-a1daf15bd0cc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Felipe_Quitzon@gmail.com",
    "telephone": "393.863.2618",
    "givenName": "Fay",
    "familyName": "Elwin",
    "identifier": "184b437f-30d0-43a4-9c96-8869b1e8571d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1126.082056ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:02+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6b92e652-d614-4f5b-ae93-a1daf15bd0cc
...
---
Response status code: 400 Bad Request. Responded in 260.08889ms.
```json
{
  "@context": "https://openactive.io/",
