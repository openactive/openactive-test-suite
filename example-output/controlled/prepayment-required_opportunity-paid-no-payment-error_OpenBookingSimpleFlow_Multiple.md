[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:56:41 GMT+0000 (Coordinated Universal Time)

# prepayment-required >> opportunity-paid-no-payment-error (OpenBookingSimpleFlow >> Multiple)
...
---
Response status code: 200 OK. Responded in 184.517904ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2488/events/20488"
}
```
...
---
Response status code: 200 OK. Responded in 170.347018ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2476/facility-use-slots/20476"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2488%2Fevents%2F20488?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 862.315155ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2488/events/20488",
  "modified": 1625165813124,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2488",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2488#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2476%2Ffacility-use-slots%2F20476?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1400.810574ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2476/facility-use-slots/20476",
  "modified": 1625165813664,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2476",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2476/facility-use-slots/20476#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 14.99,
        "priceCurrency": "GBP"
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b4480a09-59eb-4986-8df4-2c0aa3fbf56d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2488#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2488/events/20488"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2476/facility-use-slots/20476#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2476/facility-use-slots/20476"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 491.667839ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b4480a09-59eb-4986-8df4-2c0aa3fbf56d",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2488"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b4480a09-59eb-4986-8df4-2c0aa3fbf56d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Doyle19@gmail.com",
    "telephone": "1-593-496-2634 x351",
    "givenName": "Walker",
    "familyName": "Bethel",
    "identifier": "b33d08da-a1af-4e0e-a4d3-752cc25a6c3c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1321.3867ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:54+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b4480a09-59eb-4986-8df4-2c0aa3fbf56d
...
---
Response status code: 400 Bad Request. Responded in 61.634468ms.
```json
{
  "@context": "https://openactive.io/",
