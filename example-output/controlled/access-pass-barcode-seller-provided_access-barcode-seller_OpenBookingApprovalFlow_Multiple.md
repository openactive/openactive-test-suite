...
---
Response status code: 200 OK. Responded in 218.833891ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2296/events/20296"
}
```
...
---
Response status code: 200 OK. Responded in 189.540805ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2295/events/20295"
}
```
...
---
Response status code: 200 OK. Responded in 81.78622ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2280/facility-use-slots/20280"
}
```
...
---
Response status code: 200 OK. Responded in 286.757223ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2281/facility-use-slots/20281"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2296%2Fevents%2F20296?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 730.179541ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2296/events/20296",
  "modified": 1625165254618,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2296/events/20296",
    "startDate": "2021-07-02T18:47:32+00:00",
    "endDate": "2021-07-02T19:47:32+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2296",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2296#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2295%2Fevents%2F20295?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 728.203829ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2295/events/20295",
  "modified": 1625165254617,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2295",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2295#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2280%2Ffacility-use-slots%2F20280?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1316.489568ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2280/facility-use-slots/20280",
  "modified": 1625165255206,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2280",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2280/facility-use-slots/20280#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2281%2Ffacility-use-slots%2F20281?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1316.8593700000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2281/facility-use-slots/20281",
  "modified": 1625165255208,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2281",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2281/facility-use-slots/20281#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2296#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2296/events/20296"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2295#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2295/events/20295"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2280/facility-use-slots/20280#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2280/facility-use-slots/20280"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2281/facility-use-slots/20281#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2281/facility-use-slots/20281"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 609.481474ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2295"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2280"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:47:32+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kody44@yahoo.com",
    "telephone": "361-541-7299 x5804",
    "givenName": "Stanton",
    "familyName": "Aric",
    "identifier": "7c8c95c4-06f3-4138-b0ec-7d5c84b66de3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 632.241218ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a
...
---
Response status code: 201 Created. Responded in 940.935005ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a#/orderedItems/1324",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2296#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a#/orderedItems/1325",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2296#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a#/orderedItems/1326",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2295#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a#/orderedItems/1327",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2280/facility-use-slots/20280#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a#/orderedItems/1328",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2280/facility-use-slots/20280#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a#/orderedItems/1329",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2281/facility-use-slots/20281#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a/versions/b5c59bf9-190e-4e8c-b236-bca9e1e591b0",
  "payment": {
    "@type": "Payment",
    "identifier": "c3VtAYpL0",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;ae5fa3d4-9363-4f4d-8324-3d6c73103c5a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a


---
Response status code: 200 OK. Responded in 220.941481ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607620554621242&afterId=b1f26da1-8d9c-4f82-b24e-477ef887c117",
  "message": "Listening for UUID: 'ae5fa3d4-9363-4f4d-8324-3d6c73103c5a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 68.063326ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;ae5fa3d4-9363-4f4d-8324-3d6c73103c5a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a


---
Response status code: 200 OK. Responded in 2397.265991ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "ae5fa3d4-9363-4f4d-8324-3d6c73103c5a",
  "modified": 637607620590875500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a",
    "identifier": "ae5fa3d4-9363-4f4d-8324-3d6c73103c5a",
...
---
Response status code: 200 OK. Responded in 132.658829ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a
...
---
Response status code: 201 Created. Responded in 952.674158ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ae5fa3d4-9363-4f4d-8324-3d6c73103c5a",
  "identifier": "ae5fa3d4-9363-4f4d-8324-3d6c73103c5a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 168.212782ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "ae5fa3d4-9363-4f4d-8324-3d6c73103c5a",
  "modified": 637607620619838200
}
```
### Specs
* ✅ should return 200 on success
