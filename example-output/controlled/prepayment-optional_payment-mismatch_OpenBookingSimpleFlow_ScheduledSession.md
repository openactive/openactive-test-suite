...
# prepayment-optional >> payment-mismatch (OpenBookingSimpleFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 2052.116874ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2496/events/20496"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2496%2Fevents%2F20496?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1213.696859ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2496/events/20496",
  "modified": 1625165830825,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2496/events/20496",
    "startDate": "2021-07-02T18:57:06+00:00",
    "endDate": "2021-07-02T19:57:06+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2496",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2496#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/58102fd9-8f73-4f1d-989b-a821cd6e2f58
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2496#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2496/events/20496"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 360.496056ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/58102fd9-8f73-4f1d-989b-a821cd6e2f58",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/58102fd9-8f73-4f1d-989b-a821cd6e2f58
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sheridan_Schumm83@gmail.com",
    "telephone": "219-596-8783",
    "givenName": "Becker",
    "familyName": "Sean",
    "identifier": "b382827e-cb6d-497d-9c68-47102448d601"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 561.580458ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/58102fd9-8f73-4f1d-989b-a821cd6e2f58
...
---
Response status code: 400 Bad Request. Responded in 205.284228ms.
```json
{
  "@context": "https://openactive.io/",
