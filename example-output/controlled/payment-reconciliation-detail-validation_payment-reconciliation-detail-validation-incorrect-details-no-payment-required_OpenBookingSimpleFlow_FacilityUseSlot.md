...
---
Response status code: 200 OK. Responded in 60.92908ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1014.702725ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2540/facility-use-slots/20540",
  "modified": 1625165963083,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:59:21+00:00",
    "endDate": "2021-07-02T19:59:21+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c57e1fa8-7d96-4602-b3bb-519bc5962d6c
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-doWF9t0mtj",
    "accountId": "invalid-EySOu8Xiw",
    "paymentProviderId": "invalid-ZN2bHi4mg8"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 375.646433ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c57e1fa8-7d96-4602-b3bb-519bc5962d6c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tressie.Predovic10@hotmail.com",
    "telephone": "599.349.7527 x3001",
    "givenName": "Cummerata",
    "familyName": "Buddy",
    "identifier": "fdfe2ad3-0acc-4144-82a7-0a89e3e03f9a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-iiJT7xIq00",
    "accountId": "invalid-jP6FiHWIkp",
    "paymentProviderId": "invalid-NxvgCHj13V"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 86.24556ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
