[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:48:31 GMT+0000 (Coordinated Universal Time)

# customer-requested-cancellation >> patch-contains-excessive-properties-error (OpenBookingApprovalFlow >> Multiple)
...
**Test:**  Successful booking and unsuccessful cancellation due to PatchContainsExcessivePropertiesError

PatchContainsExcessivePropertiesError returned because patch request includes other properties than @type, @context, orderProposalStatus and orderCustomerNote

### Running only this test

```bash
npm start -- --runInBand test/features/cancellation/customer-requested-cancellation/implemented/patch-contains-excessive-properties-error-test.js
```

---

⚠️ 20 passed with 0 failures, 475 warnings and 126 suggestions 
...
---
Response status code: 200 OK. Responded in 97.865037ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2346/events/20346"
}
```
...
---
Response status code: 200 OK. Responded in 237.440305ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2347/events/20347"
}
```
...
---
Response status code: 200 OK. Responded in 301.597158ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2334/facility-use-slots/20334"
}
```
...
---
Response status code: 200 OK. Responded in 292.97231ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2333/facility-use-slots/20333"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2346%2Fevents%2F20346?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1148.130111ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2346/events/20346",
  "modified": 1625165358371,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2346/events/20346",
    "startDate": "2021-07-02T18:49:16+00:00",
    "endDate": "2021-07-02T19:49:16+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2346",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2346#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2347%2Fevents%2F20347?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1148.190911ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2347/events/20347",
  "modified": 1625165358373,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2347",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2347#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2334%2Ffacility-use-slots%2F20334?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1357.795564ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2334/facility-use-slots/20334",
  "modified": 1625165358583,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2334",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2334/facility-use-slots/20334#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2333%2Ffacility-use-slots%2F20333?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1356.553457ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2333/facility-use-slots/20333",
  "modified": 1625165358582,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2333",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2333/facility-use-slots/20333#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2346#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2346/events/20346"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2347#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2347/events/20347"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2334/facility-use-slots/20334#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2334/facility-use-slots/20334"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2333/facility-use-slots/20333#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2333/facility-use-slots/20333"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 736.036246ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:18+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2346"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2347"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2334"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:49:16+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2333"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:49:16+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Verla.McLaughlin87@hotmail.com",
    "telephone": "(632) 629-1276 x44063",
    "givenName": "Bins",
    "familyName": "Odell",
    "identifier": "1eec342a-31c9-4fb1-b773-a6223ef8da6e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 902.733763ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:20+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1
...
---
Response status code: 201 Created. Responded in 890.104529ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1#/orderedItems/1654",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2346#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1#/orderedItems/1655",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2346#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1#/orderedItems/1656",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2347#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1#/orderedItems/1657",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2334/facility-use-slots/20334#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1#/orderedItems/1658",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2334/facility-use-slots/20334#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1#/orderedItems/1659",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2333/facility-use-slots/20333#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1/versions/919124d6-a0a7-402e-971a-136a20e848ef",
  "payment": {
    "@type": "Payment",
    "identifier": "eQIZ5Y8nJ",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;05a353ae-2cc2-48ad-bfa1-07574dbcfdb1&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1


---
Response status code: 200 OK. Responded in 153.591095ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621599175485&afterId=6c7bdb3e-2921-4950-a345-221add231d5c",
  "message": "Listening for UUID: '05a353ae-2cc2-48ad-bfa1-07574dbcfdb1' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 368.505088ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;05a353ae-2cc2-48ad-bfa1-07574dbcfdb1&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1


---
Response status code: 200 OK. Responded in 1974.0082889999999ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "05a353ae-2cc2-48ad-bfa1-07574dbcfdb1",
  "modified": 637607621635619800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1",
    "identifier": "05a353ae-2cc2-48ad-bfa1-07574dbcfdb1",
...
---
Response status code: 200 OK. Responded in 153.093992ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1
...
---
Response status code: 201 Created. Responded in 1046.49618ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1",
  "identifier": "05a353ae-2cc2-48ad-bfa1-07574dbcfdb1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 149.001881ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "05a353ae-2cc2-48ad-bfa1-07574dbcfdb1",
  "modified": 637607621661787300
}
```
### Specs
* ✅ should return 200 on success
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/05a353ae-2cc2-48ad-bfa1-07574dbcfdb1
...
---
Response status code: 400 Bad Request. Responded in 20.553421ms.
```json
{
  "@context": "https://openactive.io/",
...
```
### Specs
* ✅ should return a response containing `"@type": "PatchContainsExcessivePropertiesError"` with status code `400`
