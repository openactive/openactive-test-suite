...
# order-deletion >> order-quote-delete-idempotent (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 63.835606ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2282/facility-use-slots/20282"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2282%2Ffacility-use-slots%2F20282?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1581.7926539999999ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2282/facility-use-slots/20282",
  "modified": 1625165256509,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2282",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2282/facility-use-slots/20282#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:47:33+00:00",
    "endDate": "2021-07-02T19:47:33+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5993d59f-71ac-40e7-9687-1d53565d9801
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2282/facility-use-slots/20282#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2282/facility-use-slots/20282"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 196.009146ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5993d59f-71ac-40e7-9687-1d53565d9801",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:35+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2282"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:47:33+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5993d59f-71ac-40e7-9687-1d53565d9801
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Maurice.Wisoky@hotmail.com",
    "telephone": "543.664.1329",
    "givenName": "Lesch",
    "familyName": "Cleveland",
    "identifier": "70cc8eae-78e0-4f93-bd91-466783434ec4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 629.666802ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:36+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
DELETE https://localhost:5001/api/openbooking/order-quotes/5993d59f-71ac-40e7-9687-1d53565d9801
...
---
Response status code: 204 No Content. Responded in 119.773462ms.
...
---
Response status code: 204 No Content. Responded in 19.201622ms.
### Specs
