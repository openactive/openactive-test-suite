[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:47:30 GMT+0000 (Coordinated Universal Time)

# order-deletion >> order-quote-delete-idempotent (OpenBookingApprovalFlow >> Multiple)
...
**Test:**  Order quote successfully deleted, second delete does not change the state of the first delete

Order Delete is idempotent - run C1, C2 then Order Delete twice - the Order Delete must return 204 in both cases

### Running only this test

```bash
npm start -- --runInBand test/features/core/order-deletion/implemented/order-quote-delete-idempotent-test.js
```

---

⚠️ 16 passed with 0 failures, 281 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 352.100946ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2305/events/20305"
}
```
...
---
Response status code: 200 OK. Responded in 276.119048ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2304/events/20304"
}
```
...
---
Response status code: 200 OK. Responded in 207.79979ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2291/facility-use-slots/20291"
}
```
...
---
Response status code: 200 OK. Responded in 304.232496ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2293/facility-use-slots/20293"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2305%2Fevents%2F20305?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1053.413425ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2305/events/20305",
  "modified": 1625165271394,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2305",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2305#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2304%2Fevents%2F20304?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1046.310288ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2304/events/20304",
  ...
  "data": {
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2304",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2304#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2291%2Ffacility-use-slots%2F20291?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 996.439926ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2291/facility-use-slots/20291",
  "modified": 1625165271344,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2291",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2291/facility-use-slots/20291#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2293%2Ffacility-use-slots%2F20293?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 998.175936ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2293/facility-use-slots/20293",
  "modified": 1625165271347,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2293",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2293/facility-use-slots/20293#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/64506b66-e425-4c24-aa68-f464a0f94a0a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2305#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2305/events/20305"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2304#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2304/events/20304"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2291/facility-use-slots/20291#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2291/facility-use-slots/20291"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2293/facility-use-slots/20293#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2293/facility-use-slots/20293"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 639.353454ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/64506b66-e425-4c24-aa68-f464a0f94a0a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:51+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2305"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2304"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2291"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:47:49+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2293"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:47:49+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/64506b66-e425-4c24-aa68-f464a0f94a0a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Aric97@hotmail.com",
    "telephone": "585-619-5813 x878",
    "givenName": "Ebert",
    "familyName": "Euna",
    "identifier": "36e32d4b-a05b-4dc1-ba82-6507eecc1390"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 733.180071ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### delete-order-quote Request
DELETE https://localhost:5001/api/openbooking/order-quotes/64506b66-e425-4c24-aa68-f464a0f94a0a
...
---
Response status code: 204 No Content. Responded in 658.785145ms.
...
---
Response status code: 204 No Content. Responded in 23.558062ms.
### Specs
