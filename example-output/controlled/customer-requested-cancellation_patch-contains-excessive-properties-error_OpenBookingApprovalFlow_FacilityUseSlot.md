...
# customer-requested-cancellation >> patch-contains-excessive-properties-error (OpenBookingApprovalFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 38.077838ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2330/facility-use-slots/20330"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2330%2Ffacility-use-slots%2F20330?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1570.684931ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2330/facility-use-slots/20330",
  "modified": 1625165349394,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2330",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2330/facility-use-slots/20330#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:49:06+00:00",
    "endDate": "2021-07-02T19:49:06+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2330/facility-use-slots/20330#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2330/facility-use-slots/20330"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 182.674043ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:08+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2330"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:49:06+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Duncan86@yahoo.com",
    "telephone": "1-390-784-0142 x86412",
    "givenName": "Gaylord",
    "familyName": "Angelina",
    "identifier": "a2d49d60-267f-40ac-9201-c94829536786"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 250.209566ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:09+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe
...
---
Response status code: 201 Created. Responded in 326.519144ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe#/orderedItems/1620",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2330/facility-use-slots/20330#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe/versions/f005cf2f-73a3-4dd2-b75e-0a5d996f4acf",
  "payment": {
    "@type": "Payment",
    "identifier": "FlRpGomU7",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;5e36be11-b4d5-475a-bb93-c4d8ef4de8fe&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe


---
Response status code: 200 OK. Responded in 242.253016ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621455295620&afterId=499ad7eb-8f88-475a-b509-b39e87208351",
  "message": "Listening for UUID: '5e36be11-b4d5-475a-bb93-c4d8ef4de8fe' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 160.209202ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;5e36be11-b4d5-475a-bb93-c4d8ef4de8fe&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe


---
Response status code: 200 OK. Responded in 2128.546323ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "5e36be11-b4d5-475a-bb93-c4d8ef4de8fe",
  "modified": 637607621502506100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe",
    "identifier": "5e36be11-b4d5-475a-bb93-c4d8ef4de8fe",
...
---
Response status code: 200 OK. Responded in 117.422235ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621500021894&afterId=53f9fb1b-fde9-4930-9fa1-1826d5398d7f",
  "message": "Listening for UUID: '5e36be11-b4d5-475a-bb93-c4d8ef4de8fe' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe
...
---
Response status code: 201 Created. Responded in 217.614962ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe",
  "identifier": "5e36be11-b4d5-475a-bb93-c4d8ef4de8fe",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 2157.673061ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "5e36be11-b4d5-475a-bb93-c4d8ef4de8fe",
  "modified": 637607621527235700
}
```
### Specs
* ✅ should return 200 on success
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/5e36be11-b4d5-475a-bb93-c4d8ef4de8fe
...
---
Response status code: 400 Bad Request. Responded in 19.085405ms.
```json
{
  "@context": "https://openactive.io/",
