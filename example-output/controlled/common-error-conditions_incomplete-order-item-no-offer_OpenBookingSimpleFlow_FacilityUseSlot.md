...
# common-error-conditions >> incomplete-order-item-no-offer (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 42.107846ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2165/facility-use-slots/20165"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2165%2Ffacility-use-slots%2F20165?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1719.633634ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2165/facility-use-slots/20165",
  "modified": 1625165086949,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2165",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2165/facility-use-slots/20165#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:44:44+00:00",
    "endDate": "2021-07-02T19:44:44+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/128e4c12-36c2-47e1-aac5-ffa38b55e0ca
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2165/facility-use-slots/20165"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 32.393689ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/128e4c12-36c2-47e1-aac5-ffa38b55e0ca",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/128e4c12-36c2-47e1-aac5-ffa38b55e0ca
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Liliane.Reilly@gmail.com",
    "telephone": "419.953.5446",
    "givenName": "Huels",
    "familyName": "Frederik",
    "identifier": "592debc0-ac99-4875-88a6-df955b9aded9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 26.157052ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/128e4c12-36c2-47e1-aac5-ffa38b55e0ca
...
---
Response status code: 409 Conflict. Responded in 24.938345ms.
```json
{
  "@context": "https://openactive.io/",
