[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:40:43 GMT+0000 (Coordinated Universal Time)

# minimal-proposal >> not-accept-proposal-book (OpenBookingApprovalFlow >> Multiple)
...
**Test:**  OrderProposal not yet accepted by the Seller
...
```bash
npm start -- --runInBand test/features/approval/minimal-proposal/implemented/not-accept-proposal-book-test.js
```

---

⚠️ 19 passed with 0 failures, 371 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 92.051304ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2068/events/20068"
}
```
...
---
Response status code: 200 OK. Responded in 305.011616ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2069/events/20069"
}
```
...
---
Response status code: 200 OK. Responded in 233.076712ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2069/facility-use-slots/20069"
}
```
...
---
Response status code: 200 OK. Responded in 199.78531ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2068/facility-use-slots/20068"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2068%2Fevents%2F20068?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2613.768349ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2068/events/20068",
  "modified": 1625164855992,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2068/events/20068",
    "startDate": "2021-07-02T18:40:52+00:00",
    "endDate": "2021-07-02T19:40:52+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2068",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2068#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2069%2Fevents%2F20069?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2613.152752ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2069/events/20069",
  "modified": 1625164855993,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2069",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2069#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2069%2Ffacility-use-slots%2F20069?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2841.494327ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2069/facility-use-slots/20069",
  "modified": 1625164856222,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2069",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2069/facility-use-slots/20069#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2068%2Ffacility-use-slots%2F20068?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2840.098024ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2068/facility-use-slots/20068",
  ...
  "data": {
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2068",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2068/facility-use-slots/20068#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9fc06c3b-b688-4bb6-a11a-23ba67ac0604
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2068#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2068/events/20068"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2069#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2069/events/20069"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2069/facility-use-slots/20069#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2069/facility-use-slots/20069"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2068/facility-use-slots/20068#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2068/facility-use-slots/20068"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 314.780452ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9fc06c3b-b688-4bb6-a11a-23ba67ac0604",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:45:56+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2068"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2069"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9fc06c3b-b688-4bb6-a11a-23ba67ac0604
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Enid.Beer4@hotmail.com",
    "telephone": "1-326-842-4417 x38869",
    "givenName": "Johns",
    "familyName": "Dan",
    "identifier": "2d482192-8c0b-49bd-abb8-1b738a77d6af"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 427.682752ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:45:57+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/9fc06c3b-b688-4bb6-a11a-23ba67ac0604
...
---
Response status code: 201 Created. Responded in 396.735396ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/9fc06c3b-b688-4bb6-a11a-23ba67ac0604",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9fc06c3b-b688-4bb6-a11a-23ba67ac0604#/orderedItems/408",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2068#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9fc06c3b-b688-4bb6-a11a-23ba67ac0604#/orderedItems/409",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2068#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9fc06c3b-b688-4bb6-a11a-23ba67ac0604#/orderedItems/410",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2069#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9fc06c3b-b688-4bb6-a11a-23ba67ac0604#/orderedItems/411",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2069/facility-use-slots/20069#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9fc06c3b-b688-4bb6-a11a-23ba67ac0604#/orderedItems/412",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2069/facility-use-slots/20069#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9fc06c3b-b688-4bb6-a11a-23ba67ac0604#/orderedItems/413",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2068/facility-use-slots/20068#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/9fc06c3b-b688-4bb6-a11a-23ba67ac0604/versions/3b4288db-2088-4283-ab08-4add4dd46cfd",
  "payment": {
    "@type": "Payment",
    "identifier": "phiR-5mQq",
    "name": "AcmeBroker Points",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9fc06c3b-b688-4bb6-a11a-23ba67ac0604
...
---
Response status code: 500 Internal Server Error. Responded in 91.282306ms.
```json
{
  "@context": "https://openactive.io/",
