[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:57:06 GMT+0000 (Coordinated Universal Time)

# prepayment-optional >> payment-mismatch (OpenBookingSimpleFlow >> Multiple)
...
---
Response status code: 200 OK. Responded in 214.533383ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2500/events/20500"
}
```
...
---
Response status code: 200 OK. Responded in 156.522436ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2488/facility-use-slots/20488"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2500%2Fevents%2F20500?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 858.700336ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2500/events/20500",
  "modified": 1625165838185,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2500/events/20500",
    "startDate": "2021-07-02T18:57:16+00:00",
    "endDate": "2021-07-02T19:57:16+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2500",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2500#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2488%2Ffacility-use-slots%2F20488?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 999.355578ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2488/facility-use-slots/20488",
  "modified": 1625165838327,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2488",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2488/facility-use-slots/20488#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 14.99,
        "priceCurrency": "GBP"
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/36a08a3c-639e-4791-9ee2-3892971a8178
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2500#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2500/events/20500"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2488/facility-use-slots/20488#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2488/facility-use-slots/20488"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 851.262191ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/36a08a3c-639e-4791-9ee2-3892971a8178",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:17+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2500"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/36a08a3c-639e-4791-9ee2-3892971a8178
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Everette0@hotmail.com",
    "telephone": "234.530.2203 x20378",
    "givenName": "Schimmel",
    "familyName": "Harry",
    "identifier": "4462becc-ac63-40b5-9037-3400ffc71174"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2555.648286ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:20+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/36a08a3c-639e-4791-9ee2-3892971a8178
...
---
Response status code: 400 Bad Request. Responded in 147.891574ms.
```json
{
  "@context": "https://openactive.io/",
