...
---
Response status code: 200 OK. Responded in 264.312119ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2325/events/20325"
}
```
...
---
Response status code: 200 OK. Responded in 117.048917ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2322/events/20322"
}
```
...
---
Response status code: 200 OK. Responded in 192.215577ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2309/facility-use-slots/20309"
}
```
...
---
Response status code: 200 OK. Responded in 184.189528ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2310/facility-use-slots/20310"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2325%2Fevents%2F20325?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 849.357603ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2325/events/20325",
  "modified": 1625165302945,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2325",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2325#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2322%2Fevents%2F20322?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 834.630512ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2322/events/20322",
  "modified": 1625165302930,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2322",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2322#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2309%2Ffacility-use-slots%2F20309?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1322.108998ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2309/facility-use-slots/20309",
  "modified": 1625165303419,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2309",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2309/facility-use-slots/20309#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingIntakeForm"
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2310%2Ffacility-use-slots%2F20310?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1318.597677ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2310/facility-use-slots/20310",
  "modified": 1625165303421,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2310",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2310/facility-use-slots/20310#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0d816897-847a-45d5-a11e-795c73fe3e0a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2325#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2325/events/20325"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2322#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2322/events/20322"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2309/facility-use-slots/20309#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2309/facility-use-slots/20309"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2310/facility-use-slots/20310#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2310/facility-use-slots/20310"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1228.615226ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0d816897-847a-45d5-a11e-795c73fe3e0a",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0d816897-847a-45d5-a11e-795c73fe3e0a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Fausto_Barrows76@hotmail.com",
    "telephone": "612.511.5659",
    "givenName": "Jacobs",
    "familyName": "Emilia",
    "identifier": "d488740e-4a08-4f71-9412-bbba4cde97b3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 875.065767ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/0d816897-847a-45d5-a11e-795c73fe3e0a
...
---
Response status code: 409 Conflict. Responded in 178.164936ms.
```json
{
  "@context": "https://openactive.io/",
