...
---
Response status code: 200 OK. Responded in 83.388712ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2166/events/20166"
}
```
...
---
Response status code: 200 OK. Responded in 158.835085ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2167/events/20167"
}
```
...
---
Response status code: 200 OK. Responded in 123.838012ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2161/facility-use-slots/20161"
}
```
...
---
Response status code: 200 OK. Responded in 84.581518ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2160/facility-use-slots/20160"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2166%2Fevents%2F20166?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1447.414952ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2166/events/20166",
  "modified": 1625165061553,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2166/events/20166",
    "startDate": "2021-07-02T18:44:19+00:00",
    "endDate": "2021-07-02T19:44:19+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2166",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2166#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2167%2Fevents%2F20167?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1446.643648ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2167/events/20167",
  "modified": 1625165061555,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2167",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2167#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2161%2Ffacility-use-slots%2F20161?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1770.5213469999999ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2161/facility-use-slots/20161",
  "modified": 1625165061882,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2161",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2161/facility-use-slots/20161#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2160%2Ffacility-use-slots%2F20160?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1769.043741ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2160/facility-use-slots/20160",
  ...
  "data": {
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2160",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2160/facility-use-slots/20160#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2166#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2166/events/20166"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2167#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2167/events/20167"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2161/facility-use-slots/20161#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2161/facility-use-slots/20161"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2160/facility-use-slots/20160#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2160/facility-use-slots/20160"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 565.678995ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:21+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2166"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Luis_Weimann@yahoo.com",
    "telephone": "1-621-651-9248 x7175",
    "givenName": "Douglas",
    "familyName": "Randi",
    "identifier": "441a62e0-d927-4b91-9f9c-4f8a7f82d476"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 418.460168ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:23+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3
...
---
Response status code: 201 Created. Responded in 715.834236ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3#/orderedItems/864",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2166#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3#/orderedItems/865",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2166#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3#/orderedItems/866",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2167#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3#/orderedItems/867",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2161/facility-use-slots/20161#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3#/orderedItems/868",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2161/facility-use-slots/20161#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3#/orderedItems/869",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2160/facility-use-slots/20160#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3/versions/61063e0c-e899-44db-b3ce-02df779fc573",
  "payment": {
    "@type": "Payment",
    "identifier": "3tz86M1fx",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;8aceb83f-ec96-4d4d-bb94-5a5b944c49f3&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3


---
Response status code: 200 OK. Responded in 257.481488ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607618616594585&afterId=9c1e5979-f024-45e3-883c-28fdd38bd964",
  "message": "Listening for UUID: '8aceb83f-ec96-4d4d-bb94-5a5b944c49f3' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 23.169625ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;8aceb83f-ec96-4d4d-bb94-5a5b944c49f3&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3


---
Response status code: 200 OK. Responded in 3204.906587ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "8aceb83f-ec96-4d4d-bb94-5a5b944c49f3",
  "modified": 637607618664255400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3",
    "identifier": "8aceb83f-ec96-4d4d-bb94-5a5b944c49f3",
...
---
Response status code: 200 OK. Responded in 315.1329ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607618639887358&afterId=3ac23a3e-2439-42f2-9eaf-2328c90d87f2",
  "message": "Listening for UUID: '8aceb83f-ec96-4d4d-bb94-5a5b944c49f3' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3
...
---
Response status code: 201 Created. Responded in 1518.547791ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/8aceb83f-ec96-4d4d-bb94-5a5b944c49f3",
  "identifier": "8aceb83f-ec96-4d4d-bb94-5a5b944c49f3",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 523.510259ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "8aceb83f-ec96-4d4d-bb94-5a5b944c49f3",
  "modified": 637607618708995800
}
```
### Specs
* ✅ should return 200 on success
