[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:53:53 GMT+0000 (Coordinated Universal Time)

# business-to-business-tax-calculation-net >> business-to-business-tax-calculation-net (OpenBookingApprovalFlow >> Multiple)

**Booking Flow:** OpenBookingApprovalFlow

**Opportunity Type:** Multiple

**Feature:** Tax / Business-to-business Tax Calculation (TaxNet) (Implemented) 
...
```bash
npm start -- --runInBand test/features/tax/business-to-business-tax-calculation-net/implemented/business-to-business-tax-calculation-net-test.js
```
...
---
Response status code: 200 OK. Responded in 569.46694ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2449/events/20449"
}
```
...
---
Response status code: 200 OK. Responded in 560.663389ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2448/events/20448"
}
```
...
---
Response status code: 200 OK. Responded in 558.96628ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2436/facility-use-slots/20436"
}
```
...
---
Response status code: 200 OK. Responded in 492.198901ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2435/facility-use-slots/20435"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2449%2Fevents%2F20449?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1885.367383ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2449/events/20449",
  "modified": 1625165700737,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2449/events/20449",
    "startDate": "2021-07-02T18:54:57+00:00",
    "endDate": "2021-07-02T19:54:57+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2449",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2449#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2448%2Fevents%2F20448?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1884.034775ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2448/events/20448",
  "modified": 1625165700736,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2448",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event Tax Net",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2448#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2436%2Ffacility-use-slots%2F20436?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1543.9089490000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2436/facility-use-slots/20436",
  "modified": 1625165700403,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2436",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2436/facility-use-slots/20436#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2435%2Ffacility-use-slots%2F20435?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1542.771143ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2435/facility-use-slots/20435",
  "modified": 1625165700402,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2435",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Facility Tax Net",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2435/facility-use-slots/20435#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2449#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2449/events/20449"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2448#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2448/events/20448"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2436/facility-use-slots/20436#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2436/facility-use-slots/20436"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2435/facility-use-slots/20435#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2435/facility-use-slots/20435"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1178.004072ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:00:00+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2449"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2448"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2436"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:54:57+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2435"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:54:57+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "527bd951-f237-4cc3-80e0-caffda7c6196",
...
---
Response status code: 200 OK. Responded in 1608.53531ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:00:02+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc
...
---
Response status code: 201 Created. Responded in 3322.68561ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc#/orderedItems/2347",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2449#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc#/orderedItems/2348",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2449#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc#/orderedItems/2349",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2448#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc#/orderedItems/2350",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2436/facility-use-slots/20436#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc#/orderedItems/2351",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2436/facility-use-slots/20436#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc#/orderedItems/2352",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2435/facility-use-slots/20435#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc/versions/ac87dd60-1480-4ed1-b05c-6fcfce2a3b49",
  "payment": {
    "@type": "Payment",
    "identifier": "_twNXe_9l",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc


---
Response status code: 200 OK. Responded in 3.917749ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607624979796452&afterId=7a2dba7b-ad5f-4e93-9385-c0b39c40c19e",
  "message": "Listening for UUID: '3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 118.794658ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc


---
Response status code: 200 OK. Responded in 2417.049958ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc",
  "modified": 637607625086778900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc",
    "identifier": "3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc",
...
---
Response status code: 200 OK. Responded in 16.435294ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607625086778898&afterId=3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc",
  "message": "Listening for UUID: '3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc
...
---
Response status code: 201 Created. Responded in 3595.3018270000002ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc",
  "identifier": "3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 22.223552ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "3ccc8c4c-1286-4a9f-8488-f8353ba1e8bc",
  "modified": 637607625118306300
}
```
### Specs
* ✅ should return 200 on success
