[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:57:25 GMT+0000 (Coordinated Universal Time)

# test-interface >> create-opportunity (OpenBookingSimpleFlow >> FacilityUseSlot)

**Booking Flow:** OpenBookingSimpleFlow

**Opportunity Type:** FacilityUseSlot

**Feature:** Core / Test interface (Implemented) 

**Test:**  Create opportunity

Creates an opportunity using the booking system's test interface, and validates the resulting feed item matches the criteria.
...
⚠️ 2 passed with 0 failures, 16 warnings and 2 suggestions 
...
---
Response status code: 200 OK. Responded in 113.946304ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2489/facility-use-slots/20489"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2489%2Ffacility-use-slots%2F20489?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 770.874285ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2489/facility-use-slots/20489",
  "modified": 1625165848954,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2489",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2489/facility-use-slots/20489#/offers/0",
