[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:55:22 GMT+0000 (Coordinated Universal Time)

# prepayment-required >> payment-mismatch (OpenBookingApprovalFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 379.540161ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2450/facility-use-slots/20450"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2450%2Ffacility-use-slots%2F20450?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1340.931161ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2450/facility-use-slots/20450",
  "modified": 1625165738520,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2450",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2450/facility-use-slots/20450#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:55:35+00:00",
    "endDate": "2021-07-02T19:55:35+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d2d389d1-c775-4b8e-b2b0-3fa625102eb1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2450/facility-use-slots/20450#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2450/facility-use-slots/20450"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 682.376434ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d2d389d1-c775-4b8e-b2b0-3fa625102eb1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:00:38+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d2d389d1-c775-4b8e-b2b0-3fa625102eb1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Meghan17@gmail.com",
    "telephone": "1-614-575-7560 x6864",
    "givenName": "Friesen",
    "familyName": "Rhea",
    "identifier": "4f5f3c3e-38ae-4cf0-871f-f766cd93328f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 517.389728ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/d2d389d1-c775-4b8e-b2b0-3fa625102eb1
...
---
Response status code: 400 Bad Request. Responded in 135.186522ms.
```json
{
  "@context": "https://openactive.io/",
