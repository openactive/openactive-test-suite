...
---
Response status code: 200 OK. Responded in 57.251509ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2520/events/20520"
}
```
...
---
Response status code: 200 OK. Responded in 130.776107ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2521/events/20521"
}
```
...
---
Response status code: 200 OK. Responded in 192.938881ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2508/facility-use-slots/20508"
}
```
...
---
Response status code: 200 OK. Responded in 60.615228ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2507/facility-use-slots/20507"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2520%2Fevents%2F20520?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 977.030447ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2520/events/20520",
  "modified": 1625165884302,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2520/events/20520",
    "startDate": "2021-07-02T18:58:02+00:00",
    "endDate": "2021-07-02T19:58:02+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2520",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2520#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2521%2Fevents%2F20521?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 976.246017ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2521/events/20521",
  "modified": 1625165884303,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2521",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2521#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2508%2Ffacility-use-slots%2F20508?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 493.595213ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2508/facility-use-slots/20508",
  "modified": 1625165883825,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2508",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2508/facility-use-slots/20508#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 14.99,
        "priceCurrency": "GBP"
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2507%2Ffacility-use-slots%2F20507?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 481.208536ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2507/facility-use-slots/20507",
  "modified": 1625165883813,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2507",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2507/facility-use-slots/20507#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9636e198-adab-4e1c-8a4f-a370540eb86d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2520#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2520/events/20520"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2521#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2521/events/20521"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2508/facility-use-slots/20508#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2508/facility-use-slots/20508"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2507/facility-use-slots/20507#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2507/facility-use-slots/20507"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1591.0374900000002ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9636e198-adab-4e1c-8a4f-a370540eb86d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:03:04+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2520"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2521"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2508"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:58:02+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2507"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:58:02+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9636e198-adab-4e1c-8a4f-a370540eb86d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Phyllis.Konopelski29@gmail.com",
    "telephone": "386-469-4940 x418",
    "givenName": "Mann",
    "familyName": "Royce",
    "identifier": "dd029fb4-df73-40fc-8c32-22cdd11a60bc"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1709.179513ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:03:06+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9636e198-adab-4e1c-8a4f-a370540eb86d
...
---
Response status code: 400 Bad Request. Responded in 157.877333ms.
```json
{
  "@context": "https://openactive.io/",
