...
# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-incorrect-details-no-payment-required (OpenBookingApprovalFlow >> Multiple)
...
---
Response status code: 200 OK. Responded in 66.681146ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2558/events/20558"
}
```
...
---
Response status code: 200 OK. Responded in 156.359008ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2559/events/20559"
}
```
...
---
Response status code: 200 OK. Responded in 162.253612ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2545/facility-use-slots/20545"
}
```
...
---
Response status code: 200 OK. Responded in 77.308654ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2544/facility-use-slots/20544"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2558%2Fevents%2F20558?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 960.300669ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2558/events/20558",
  "modified": 1625165971682,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2558",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2558#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2559%2Fevents%2F20559?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 969.915301ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2559/events/20559",
  "modified": 1625165971686,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2559",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Free Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2559#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2545%2Ffacility-use-slots%2F20545?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2039.269153ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2545/facility-use-slots/20545",
  "modified": 1625165972765,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2545",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2545/facility-use-slots/20545#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2544%2Ffacility-use-slots%2F20544?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2037.996655ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2544/facility-use-slots/20544",
  "modified": 1625165972764,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2544",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Free Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2544/facility-use-slots/20544#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5ee37d36-c171-4591-97fc-c766c943b9bf
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2558#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2558/events/20558"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2559#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2559/events/20559"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2545/facility-use-slots/20545#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2545/facility-use-slots/20545"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2544/facility-use-slots/20544#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2544/facility-use-slots/20544"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-uV6iP7naoi",
    "accountId": "invalid-mZO2N72J6",
    "paymentProviderId": "invalid-jnbSUKy6-Y"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 1505.746904ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5ee37d36-c171-4591-97fc-c766c943b9bf
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mae65@yahoo.com",
    "telephone": "(388) 741-3423",
    "givenName": "O'Conner",
    "familyName": "Pierce",
    "identifier": "09340377-5f73-4f63-9782-0ed19a3d4b71"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-tzoqrkJoco",
    "accountId": "invalid-vAAwjjQD4",
    "paymentProviderId": "invalid-Eeq73V156L"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 227.765064ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
