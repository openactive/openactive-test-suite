...
---
Response status code: 200 OK. Responded in 48.961507ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2331/facility-use-slots/20331"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2331%2Ffacility-use-slots%2F20331?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1773.4074ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2331/facility-use-slots/20331",
  "modified": 1625165350934,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2331",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2331/facility-use-slots/20331#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:49:08+00:00",
    "endDate": "2021-07-02T19:49:08+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cbae2887-86e4-453c-a917-5e18f30fe751
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2331/facility-use-slots/20331#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2331/facility-use-slots/20331"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 252.573681ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cbae2887-86e4-453c-a917-5e18f30fe751",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:10+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2331"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:49:08+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cbae2887-86e4-453c-a917-5e18f30fe751
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Doris65@hotmail.com",
    "telephone": "1-964-297-6672 x2725",
    "givenName": "Hoppe",
    "familyName": "Sonya",
    "identifier": "c4f48ba2-06b7-45d1-a745-6ca97c749b2a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 287.276498ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/cbae2887-86e4-453c-a917-5e18f30fe751
...
---
Response status code: 201 Created. Responded in 215.904751ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/cbae2887-86e4-453c-a917-5e18f30fe751",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cbae2887-86e4-453c-a917-5e18f30fe751#/orderedItems/1623",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2331/facility-use-slots/20331#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/cbae2887-86e4-453c-a917-5e18f30fe751/versions/9c0cf44e-2c8f-4274-991f-cfeecda1b211",
  "payment": {
    "@type": "Payment",
    "identifier": "YoGm5qmkF",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;cbae2887-86e4-453c-a917-5e18f30fe751&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/cbae2887-86e4-453c-a917-5e18f30fe751


---
Response status code: 200 OK. Responded in 42.114064ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621464970482&afterId=53f9fb1b-fde9-4930-9fa1-1826d5398d7f",
  "message": "Listening for UUID: 'cbae2887-86e4-453c-a917-5e18f30fe751' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 41.60176ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;cbae2887-86e4-453c-a917-5e18f30fe751&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/cbae2887-86e4-453c-a917-5e18f30fe751


---
Response status code: 200 OK. Responded in 2215.798123ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "cbae2887-86e4-453c-a917-5e18f30fe751",
  "modified": 637607621516896900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/cbae2887-86e4-453c-a917-5e18f30fe751",
    "identifier": "cbae2887-86e4-453c-a917-5e18f30fe751",
...
---
Response status code: 200 OK. Responded in 160.290181ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621502506100&afterId=5e36be11-b4d5-475a-bb93-c4d8ef4de8fe",
  "message": "Listening for UUID: 'cbae2887-86e4-453c-a917-5e18f30fe751' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/cbae2887-86e4-453c-a917-5e18f30fe751
...
---
Response status code: 201 Created. Responded in 286.985877ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/cbae2887-86e4-453c-a917-5e18f30fe751",
  "identifier": "cbae2887-86e4-453c-a917-5e18f30fe751",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1215.23048ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "cbae2887-86e4-453c-a917-5e18f30fe751",
  "modified": 637607621542315800
}
```
### Specs
* ✅ should return 200 on success
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/cbae2887-86e4-453c-a917-5e18f30fe751
...
---
Response status code: 400 Bad Request. Responded in 17.775897ms.
```json
{
  "@context": "https://openactive.io/",
