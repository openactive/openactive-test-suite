[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:55:15 GMT+0000 (Coordinated Universal Time)
...
⚠️ 19 passed with 0 failures, 483 warnings and 126 suggestions 
...
---
Response status code: 200 OK. Responded in 252.950916ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2469/events/20469"
}
```
...
---
Response status code: 200 OK. Responded in 327.628993ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2470/events/20470"
}
```
...
---
Response status code: 200 OK. Responded in 659.09531ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2457/facility-use-slots/20457"
}
```
...
---
Response status code: 200 OK. Responded in 267.582209ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2456/facility-use-slots/20456"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2469%2Fevents%2F20469?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 539.320345ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2469/events/20469",
  "modified": 1625165760283,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2469/events/20469",
    "startDate": "2021-07-02T18:55:58+00:00",
    "endDate": "2021-07-02T19:55:58+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2469",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2469#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2470%2Fevents%2F20470?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 539.123944ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2470/events/20470",
  "modified": 1625165760285,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2470",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2470#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2457%2Ffacility-use-slots%2F20457?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1901.311445ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2457/facility-use-slots/20457",
  "modified": 1625165761648,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2457",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility That Requires Attendee Details",
      "activity": [
        {
          "@type": "Concept",
          "@id": "https://openactive.io/activity-list#c07d63a0-8eb9-4602-8bcc-23be6deb8f83",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2457/facility-use-slots/20457#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingAttendeeDetails"
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2456%2Ffacility-use-slots%2F20456?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1898.774229ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2456/facility-use-slots/20456",
  "modified": 1625165761646,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2456",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2456/facility-use-slots/20456#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2469#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2469/events/20469",
      "attendee": {
        "@type": "Person",
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2470#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2470/events/20470",
      "attendee": {
        "@type": "Person",
        "telephone": "07712345678",
        "givenName": "Fred",
    ...
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2457/facility-use-slots/20457#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2457/facility-use-slots/20457",
      "attendee": {
        "@type": "Person",
        "telephone": "07712345678",
        "givenName": "Fred",
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2456/facility-use-slots/20456#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2456/facility-use-slots/20456",
      "attendee": {
        "@type": "Person",
        "telephone": "07712345678",
        "givenName": "Fred",
...
---
Response status code: 200 OK. Responded in 1446.770098ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:02+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2469"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2470"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2457"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:55:58+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2456"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:55:58+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sanford69@hotmail.com",
    "telephone": "(972) 368-0274 x824",
    "givenName": "Baumbach",
    "familyName": "Lauryn",
    "identifier": "1ad71fe2-912f-4905-b0d7-f773107827b5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1383.484972ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:04+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1
...
---
Response status code: 201 Created. Responded in 1285.8229529999999ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1#/orderedItems/2536",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2469#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1#/orderedItems/2537",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2469#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1#/orderedItems/2538",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2470#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1#/orderedItems/2539",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2457/facility-use-slots/20457#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1#/orderedItems/2540",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2457/facility-use-slots/20457#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1#/orderedItems/2541",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2456/facility-use-slots/20456#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1/versions/4d2da006-c2f0-4ff2-81c7-edf7db9ab501",
  "payment": {
    "@type": "Payment",
    "identifier": "u-MIFUNBW",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;3f74affd-edd5-43d2-9cf7-a9eb9bceccf1&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1


---
Response status code: 200 OK. Responded in 4.807831ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607625556315052&afterId=90a39ef1-f2f0-4ee6-8045-028344b91e43",
  "message": "Listening for UUID: '3f74affd-edd5-43d2-9cf7-a9eb9bceccf1' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 214.49496ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;3f74affd-edd5-43d2-9cf7-a9eb9bceccf1&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1


---
Response status code: 200 OK. Responded in 2077.968976ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "3f74affd-edd5-43d2-9cf7-a9eb9bceccf1",
  "modified": 637607625676601600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1",
    "identifier": "3f74affd-edd5-43d2-9cf7-a9eb9bceccf1",
...
---
Response status code: 200 OK. Responded in 7.441747ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1
...
---
Response status code: 201 Created. Responded in 1251.917019ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/3f74affd-edd5-43d2-9cf7-a9eb9bceccf1",
  "identifier": "3f74affd-edd5-43d2-9cf7-a9eb9bceccf1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 14.047789ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "3f74affd-edd5-43d2-9cf7-a9eb9bceccf1",
  "modified": 637607625702431200
}
```
### Specs
* ✅ should return 200 on success
