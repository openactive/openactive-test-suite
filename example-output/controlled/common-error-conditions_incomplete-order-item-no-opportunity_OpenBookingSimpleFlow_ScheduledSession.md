...
# common-error-conditions >> incomplete-order-item-no-opportunity (OpenBookingSimpleFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 49.000465ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2180/events/20180"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2180%2Fevents%2F20180?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1515.453058ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2180/events/20180",
  "modified": 1625165095366,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2180/events/20180",
    "startDate": "2021-07-02T18:44:52+00:00",
    "endDate": "2021-07-02T19:44:52+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2180",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2180#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d1d83d07-8275-477d-9278-46a5dfaa0567
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2180#/offers/0"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 2061.621649ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d1d83d07-8275-477d-9278-46a5dfaa0567",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:56+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d1d83d07-8275-477d-9278-46a5dfaa0567
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sasha_Schaefer91@yahoo.com",
    "telephone": "632-718-6041 x877",
    "givenName": "Strosin",
    "familyName": "Rex",
    "identifier": "7cf22287-7343-4760-96fa-853619de154b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 52.011199ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d1d83d07-8275-477d-9278-46a5dfaa0567
...
---
Response status code: 409 Conflict. Responded in 46.348234ms.
```json
{
  "@context": "https://openactive.io/",
