...
# amending-order-quote >> amend-c1-and-c2 (OpenBookingApprovalFlow >> ScheduledSession)
...
⚠️ 15 passed with 0 failures, 152 warnings and 52 suggestions 
...
---
Response status code: 200 OK. Responded in 42.40794ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2044/events/20044"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2044%2Fevents%2F20044?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2759.9827880000003ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2044/events/20044",
  "modified": 1625164804113,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2044/events/20044",
    "startDate": "2021-07-02T18:40:00+00:00",
    "endDate": "2021-07-02T19:40:00+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2044",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2044#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/13fc8e53-75e1-4c33-9c44-8c5508a09cba
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2044#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2044/events/20044"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 112.842943ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/13fc8e53-75e1-4c33-9c44-8c5508a09cba",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:45:03+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/13fc8e53-75e1-4c33-9c44-8c5508a09cba
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nyah65@yahoo.com",
    "telephone": "1-904-532-3544 x455",
    "givenName": "Flatley",
    "familyName": "Maiya",
    "identifier": "e4e1f281-846d-4172-949f-c11f8a7e9674"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 130.966045ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:45:04+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 975.645752ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2048/events/20048"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2048%2Fevents%2F20048?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1141.547896ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2048/events/20048",
  "modified": 1625164807457,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2048/events/20048",
    "startDate": "2021-07-02T18:40:05+00:00",
    "endDate": "2021-07-02T19:40:05+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2048",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2048#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2048#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2048/events/20048"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 116.806365ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:45:06+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 128.153129ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:45:07+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/13fc8e53-75e1-4c33-9c44-8c5508a09cba
...
---
Response status code: 201 Created. Responded in 167.273352ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/13fc8e53-75e1-4c33-9c44-8c5508a09cba",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/13fc8e53-75e1-4c33-9c44-8c5508a09cba#/orderedItems/248",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2048#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/13fc8e53-75e1-4c33-9c44-8c5508a09cba/versions/8ecfce52-e45d-4da6-94d3-d89b6df9410b",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;13fc8e53-75e1-4c33-9c44-8c5508a09cba&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/13fc8e53-75e1-4c33-9c44-8c5508a09cba


---
Response status code: 200 OK. Responded in 536.501753ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607616033908387&afterId=cee463bd-4ff9-4c90-a5e7-703184ec34ff",
  "message": "Listening for UUID: '13fc8e53-75e1-4c33-9c44-8c5508a09cba' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 58.844436ms.
### Specs
* ✅ should return 204 on success

## Second Attempt - C1 -> B >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;13fc8e53-75e1-4c33-9c44-8c5508a09cba&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/13fc8e53-75e1-4c33-9c44-8c5508a09cba


---
Response status code: 200 OK. Responded in 2442.699415ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "13fc8e53-75e1-4c33-9c44-8c5508a09cba",
  "modified": 637607616090054300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/13fc8e53-75e1-4c33-9c44-8c5508a09cba",
    "identifier": "13fc8e53-75e1-4c33-9c44-8c5508a09cba",
...
---
Response status code: 200 OK. Responded in 288.616644ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607616058721466&afterId=cee463bd-4ff9-4c90-a5e7-703184ec34ff",
  "message": "Listening for UUID: '13fc8e53-75e1-4c33-9c44-8c5508a09cba' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/13fc8e53-75e1-4c33-9c44-8c5508a09cba
...
---
Response status code: 201 Created. Responded in 151.426063ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/13fc8e53-75e1-4c33-9c44-8c5508a09cba",
  "identifier": "13fc8e53-75e1-4c33-9c44-8c5508a09cba",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 2907.689664ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "13fc8e53-75e1-4c33-9c44-8c5508a09cba",
  "modified": 637607616118809100
}
```
### Specs
* ✅ should return 200 on success
