...
# booking-window >> opportunity-in-range-c1-c2 (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 14 passed with 0 failures, 283 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 195.909198ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2512/events/20512"
}
```
...
---
Response status code: 200 OK. Responded in 1561.856758ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2516/events/20516"
}
```
...
---
Response status code: 200 OK. Responded in 801.412194ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2503/facility-use-slots/20503"
}
```
...
---
Response status code: 200 OK. Responded in 196.957504ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2500/facility-use-slots/20500"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2512%2Fevents%2F20512?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 34.788095ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2512/events/20512",
    "startDate": "2021-07-02T18:57:46+00:00",
    "endDate": "2021-07-02T19:57:46+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2512",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2512#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2516%2Fevents%2F20516?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 963.497003ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2516/events/20516",
  "modified": 1625165869860,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2516",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2516#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2503%2Ffacility-use-slots%2F20503?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 34.815795ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2503",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2503/facility-use-slots/20503#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 14.99,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2D"
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2500%2Ffacility-use-slots%2F20500?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 34.420293ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2500",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2500/facility-use-slots/20500#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8b072359-8114-4d9a-b8e9-4cbe6de8e21d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2512#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2512/events/20512"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2516#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2516/events/20516"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2503/facility-use-slots/20503#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2503/facility-use-slots/20503"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2500/facility-use-slots/20500#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2500/facility-use-slots/20500"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2525.426362ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8b072359-8114-4d9a-b8e9-4cbe6de8e21d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:50+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2512"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2503"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:57:46+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8b072359-8114-4d9a-b8e9-4cbe6de8e21d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Flavio.Weber@hotmail.com",
    "telephone": "1-321-276-4782 x77610",
    "givenName": "Frami",
    "familyName": "Demario",
    "identifier": "99d5380c-aacf-4c42-aa12-2cda341dceb9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2952.506405ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:54+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
