...
# order-deletion >> orders-updated-then-deleted (OpenBookingSimpleFlow >> FacilityUseSlot)
...
⚠️ 11 passed with 0 failures, 75 warnings and 8 suggestions 
...
---
Response status code: 200 OK. Responded in 47.029238ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2070/facility-use-slots/20070"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2070%2Ffacility-use-slots%2F20070?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1493.558411ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2070/facility-use-slots/20070",
  "modified": 1625164874086,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2070",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2070/facility-use-slots/20070#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f337d7be-b5dd-496d-b909-5b9ee3b05e48
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2070/facility-use-slots/20070#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2070/facility-use-slots/20070"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 148.593924ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f337d7be-b5dd-496d-b909-5b9ee3b05e48",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2070"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:41:11+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f337d7be-b5dd-496d-b909-5b9ee3b05e48
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jaleel79@gmail.com",
    "telephone": "(455) 290-8489 x73322",
    "givenName": "Leffler",
    "familyName": "Estell",
    "identifier": "ee774ca8-01a0-4533-89dc-bcf51f3e5e75"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 109.427719ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f337d7be-b5dd-496d-b909-5b9ee3b05e48
...
---
Response status code: 201 Created. Responded in 143.900784ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f337d7be-b5dd-496d-b909-5b9ee3b05e48",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f337d7be-b5dd-496d-b909-5b9ee3b05e48#/orderedItems/423",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2070/facility-use-slots/20070#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Orders (orders) Feed listen for &#x27;f337d7be-b5dd-496d-b909-5b9ee3b05e48&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/f337d7be-b5dd-496d-b909-5b9ee3b05e48


---
Response status code: 200 OK. Responded in 185.549758ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607616688634971&afterId=8fbc291c-0680-47e9-b73c-8c51f46d8702",
  "message": "Listening for UUID: 'f337d7be-b5dd-496d-b909-5b9ee3b05e48' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 82.018865ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation)

### Orders (orders) Feed collect for &#x27;f337d7be-b5dd-496d-b909-5b9ee3b05e48&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/f337d7be-b5dd-496d-b909-5b9ee3b05e48


---
Response status code: 200 OK. Responded in 2729.127556ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "f337d7be-b5dd-496d-b909-5b9ee3b05e48",
  "modified": 637607616751967500,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/f337d7be-b5dd-496d-b909-5b9ee3b05e48",
    "identifier": "f337d7be-b5dd-496d-b909-5b9ee3b05e48",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/f337d7be-b5dd-496d-b909-5b9ee3b05e48#/orderedItems/423",
...
---
Response status code: 200 OK. Responded in 463.852257ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
DELETE https://localhost:5001/api/openbooking/orders/f337d7be-b5dd-496d-b909-5b9ee3b05e48
...
---
Response status code: 204 No Content. Responded in 51.196884ms.
### Specs
* ✅ should return 204 on success
...
---
Response status code: 200 OK. Responded in 2650.539874ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "f337d7be-b5dd-496d-b909-5b9ee3b05e48",
  "modified": 637607616791207400
}
```
### Specs
* ✅ should return 200 on success
