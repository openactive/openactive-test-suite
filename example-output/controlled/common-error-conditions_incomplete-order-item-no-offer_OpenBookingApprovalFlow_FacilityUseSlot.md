...
# common-error-conditions >> incomplete-order-item-no-offer (OpenBookingApprovalFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 33.144082ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2173/facility-use-slots/20173"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2173%2Ffacility-use-slots%2F20173?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1902.240613ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2173/facility-use-slots/20173",
  "modified": 1625165094563,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2173",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2173/facility-use-slots/20173#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6f838c29-fff6-40d4-9ae4-137937c86b39
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2173/facility-use-slots/20173"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 83.392861ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6f838c29-fff6-40d4-9ae4-137937c86b39",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6f838c29-fff6-40d4-9ae4-137937c86b39
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kristy73@gmail.com",
    "telephone": "536.815.2042",
    "givenName": "Schuppe",
    "familyName": "Tamia",
    "identifier": "5867236d-10da-4749-afd2-09a0ce1e78d8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 220.943045ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6f838c29-fff6-40d4-9ae4-137937c86b39
...
---
Response status code: 409 Conflict. Responded in 27.986022ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 409,
  "description": "There is a missing 'acceptedOffer' or 'orderedItem' property on the 'OrderItem'.: acceptedOffer @id was not provided"
}
```
### Specs
