...
---
Response status code: 200 OK. Responded in 164.102381ms.
```json
{
...
---
Response status code: 200 OK. Responded in 674.113631ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2478/facility-use-slots/20478",
  "modified": 1625165820094,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:56:58+00:00",
    "endDate": "2021-07-02T19:56:58+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/20a2a93d-66b8-4c31-a386-b9e7fa676cbe
...
---
Response status code: 200 OK. Responded in 289.727332ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/20a2a93d-66b8-4c31-a386-b9e7fa676cbe",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:59+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/20a2a93d-66b8-4c31-a386-b9e7fa676cbe
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lindsay.Flatley@yahoo.com",
    "telephone": "634.207.7770 x1927",
    "givenName": "Kreiger",
    "familyName": "Herta",
    "identifier": "066c1a88-f22b-4aaa-8fb0-6b4885c377d5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 527.253453ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/20a2a93d-66b8-4c31-a386-b9e7fa676cbe
...
---
Response status code: 400 Bad Request. Responded in 32.976698ms.
```json
{
  "@context": "https://openactive.io/",
