...
# prepayment-required >> payment-mismatch (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 100.526767ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2444/facility-use-slots/20444"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2444%2Ffacility-use-slots%2F20444?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1048.742806ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2444/facility-use-slots/20444",
  "modified": 1625165726301,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2444",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2444/facility-use-slots/20444#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:55:24+00:00",
    "endDate": "2021-07-02T19:55:24+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/78dfc1b7-af5f-4b4e-a7a6-a1b3b946b2df
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2444/facility-use-slots/20444#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2444/facility-use-slots/20444"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 788.511419ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/78dfc1b7-af5f-4b4e-a7a6-a1b3b946b2df",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2444"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:55:24+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/78dfc1b7-af5f-4b4e-a7a6-a1b3b946b2df
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Rhoda_Botsford27@gmail.com",
    "telephone": "639.626.0010 x1024",
    "givenName": "Schoen",
    "familyName": "Laney",
    "identifier": "6a800c3f-3250-4ea4-8bff-3d78efb8cb51"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 349.977972ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/78dfc1b7-af5f-4b4e-a7a6-a1b3b946b2df
...
---
Response status code: 400 Bad Request. Responded in 92.682907ms.
```json
{
  "@context": "https://openactive.io/",
