...
---
Response status code: 200 OK. Responded in 176.029889ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2443/events/20443"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2443%2Fevents%2F20443?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1244.592598ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2443/events/20443",
  "modified": 1625165683170,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2443/events/20443",
    "startDate": "2021-07-02T18:54:40+00:00",
    "endDate": "2021-07-02T19:54:40+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2443",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2443#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ad662b6b-7aa4-4a87-81a8-723ce5d7606c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2443#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2443/events/20443"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 456.433091ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ad662b6b-7aa4-4a87-81a8-723ce5d7606c",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ad662b6b-7aa4-4a87-81a8-723ce5d7606c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jerrod92@yahoo.com",
    "telephone": "(201) 303-4230 x139",
    "givenName": "Considine",
    "familyName": "Walter",
    "identifier": "774f84b1-9d91-43db-b01b-62c2a7d74f74"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 573.148754ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:43+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ad662b6b-7aa4-4a87-81a8-723ce5d7606c
...
---
Response status code: 400 Bad Request. Responded in 98.891161ms.
```json
{
  "@context": "https://openactive.io/",
