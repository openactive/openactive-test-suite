[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:45:03 GMT+0000 (Coordinated Universal Time)

# booking-window >> opportunity-outside-range-c1-c2 (OpenBookingApprovalFlow >> Multiple)

**Booking Flow:** OpenBookingApprovalFlow

**Opportunity Type:** Multiple

**Feature:** Restrictions / validFromBeforeStartDate booking window (Implemented) 

**Test:**  Running C1 and C2 for opportunity outside range should fail

Booking an opportunity outside the specified booking window

### Running only this test

```bash
npm start -- --runInBand test/features/restrictions/booking-window/implemented/opportunity-outside-range-c1-c2-test.js
```

---

⚠️ 28 passed with 0 failures, 291 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 97.10129ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2204/events/20204"
}
```
...
---
Response status code: 200 OK. Responded in 127.915179ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2205/events/20205"
}
```
...
---
Response status code: 200 OK. Responded in 94.386435ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2197/facility-use-slots/20197"
}
```
...
---
Response status code: 200 OK. Responded in 93.555149ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2196/facility-use-slots/20196"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2204%2Fevents%2F20204?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1401.940748ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2204/events/20204",
  "modified": 1625165127072,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2204/events/20204",
    "startDate": "2021-07-02T18:45:24+00:00",
    "endDate": "2021-07-02T19:45:24+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2204",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event Outside Window",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2204#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2205%2Fevents%2F20205?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1401.194275ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2205/events/20205",
  "modified": 1625165127078,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2205",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2205#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2197%2Ffacility-use-slots%2F20197?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2371.218105ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2197/facility-use-slots/20197",
  "modified": 1625165128047,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2197",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Facility Outside Window",
      "activity": [
        {
          "@type": "Concept",
          "@id": "https://openactive.io/activity-list#c07d63a0-8eb9-4602-8bcc-23be6deb8f83",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2197/facility-use-slots/20197#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2196%2Ffacility-use-slots%2F20196?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2363.793177ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2196/facility-use-slots/20196",
  "modified": 1625165128042,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2196",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2196/facility-use-slots/20196#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
* ✅ matches the criteria 'TestOpportunityBookableOutsideValidFromBeforeStartDate' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b633e316-ee23-42fe-91d4-2289567646b5
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2204#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2204/events/20204"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2205#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2205/events/20205"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2197/facility-use-slots/20197#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2197/facility-use-slots/20197"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2196/facility-use-slots/20196#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2196/facility-use-slots/20196"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 355.920832ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b633e316-ee23-42fe-91d4-2289567646b5",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:27+00:00"
  },
      ...
      "error": [
        {
          ...
          "statusCode": 409,
          "description": "Opportunity is not yet within its booking window"
        }
      ],
      "orderedItem": {
        "@type": "ScheduledSession",
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2204"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2205"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2197"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:45:24+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2196"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:45:24+00:00",
...
* ✅ OrderItem at position 0 - should include an OpportunityOfferPairNotBookableError
* ✅ OrderItem at position 1 - should include an OpportunityOfferPairNotBookableError
* ✅ OrderItem at position 2 - should not include an OpportunityOfferPairNotBookableError
* ✅ OrderItem at position 3 - should include an OpportunityOfferPairNotBookableError
* ✅ OrderItem at position 4 - should include an OpportunityOfferPairNotBookableError
* ✅ OrderItem at position 5 - should not include an OpportunityOfferPairNotBookableError
 ...
 * ⚠️ $.orderedItem[0].error[0].instance: Recommended property `instance` is missing from `OpportunityOfferPairNotBookableError`.
 ...
 * ⚠️ $.orderedItem[1].error[0].instance: Recommended property `instance` is missing from `OpportunityOfferPairNotBookableError`.
 ...
 * ⚠️ $.orderedItem[3].error[0].instance: Recommended property `instance` is missing from `OpportunityOfferPairNotBookableError`.
 ...
 * ⚠️ $.orderedItem[4].error[0].instance: Recommended property `instance` is missing from `OpportunityOfferPairNotBookableError`.
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b633e316-ee23-42fe-91d4-2289567646b5
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Madaline.Zemlak65@yahoo.com",
    "telephone": "1-409-861-6785 x2353",
    "givenName": "Romaguera",
    "familyName": "Chadd",
    "identifier": "067f0836-cb49-472b-997d-9865c98fc516"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 286.425693ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:29+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
