...
# named-leasing >> lease-opportunity-unit-capacity-update (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 18 passed with 0 failures, 200 warnings and 50 suggestions 
...
---
Response status code: 200 OK. Responded in 23.125538ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2497/events/20497"
}
```
...
---
Response status code: 200 OK. Responded in 94.698166ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2484/facility-use-slots/20484"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2497%2Fevents%2F20497?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 510.152051ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2497/events/20497",
  "modified": 1625165830826,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2497/events/20497",
    "startDate": "2021-07-02T18:57:09+00:00",
    "endDate": "2021-07-02T19:57:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2497",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2497#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2484%2Ffacility-use-slots%2F20484?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 849.940984ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2484/facility-use-slots/20484",
  "modified": 1625165831167,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2484",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2484/facility-use-slots/20484#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
* ✅ matches the criteria 'TestOpportunityBookableOneSpace' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/63df4872-e989-4580-b485-b8d7737760c7
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2497#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2497/events/20497"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2484/facility-use-slots/20484#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2484/facility-use-slots/20484"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 694.329153ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/63df4872-e989-4580-b485-b8d7737760c7",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:10+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2484"
        },
        "maximumUses": 1,
        "remainingUses": 1,
        "startDate": "2021-07-02T18:57:09+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/63df4872-e989-4580-b485-b8d7737760c7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Clotilde.Little78@hotmail.com",
    "telephone": "1-808-249-5836 x89218",
    "givenName": "Lynch",
    "familyName": "Lois",
    "identifier": "55665c85-86e9-4f23-bd7c-35f552981506"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 509.545748ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:11+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 1019.123196ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:12+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f741fcb0-db18-47f7-9f94-24161f554eb2
...
---
Response status code: 409 Conflict. Responded in 2256.087694ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f741fcb0-db18-47f7-9f94-24161f554eb2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:14+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f741fcb0-db18-47f7-9f94-24161f554eb2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nedra80@hotmail.com",
    "telephone": "(358) 758-6604",
    "givenName": "Kirlin",
    "familyName": "Hilbert",
    "identifier": "6a1d2786-bba8-4626-9f17-acaa66a94541"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 481.134878ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:15+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
* ✅ should include an OpportunityCapacityIsReservedByLeaseError in the OrderItems
