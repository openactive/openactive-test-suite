...
# prepayment-required >> opportunity-paid-incomplete-payment-details (OpenBookingSimpleFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 747.068037ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2472/events/20472"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2472%2Fevents%2F20472?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1019.848467ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2472/events/20472",
  "modified": 1625165767329,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2472/events/20472",
    "startDate": "2021-07-02T18:56:04+00:00",
    "endDate": "2021-07-02T19:56:04+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2472",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2472#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9b4564b2-34db-4bba-877b-c323b9bb599a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2472#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2472/events/20472"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 545.520959ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9b4564b2-34db-4bba-877b-c323b9bb599a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:06+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9b4564b2-34db-4bba-877b-c323b9bb599a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Brant.Lesch@yahoo.com",
    "telephone": "1-854-496-1183",
    "givenName": "Goodwin",
    "familyName": "Franz",
    "identifier": "2d1f0616-fd00-4dc3-82a9-894e7bfccaf8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 340.451159ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9b4564b2-34db-4bba-877b-c323b9bb599a
...
---
Response status code: 400 Bad Request. Responded in 49.673215ms.
```json
{
  "@context": "https://openactive.io/",
