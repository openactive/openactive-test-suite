...
---
Response status code: 200 OK. Responded in 41.735491ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2241/facility-use-slots/20241"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2241%2Ffacility-use-slots%2F20241?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2060.340047ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2241/facility-use-slots/20241",
  "modified": 1625165189782,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2241",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2241/facility-use-slots/20241#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:46:26+00:00",
    "endDate": "2021-07-02T19:46:26+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2241/facility-use-slots/20241#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2241/facility-use-slots/20241"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 194.028751ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2241"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:46:26+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Karlee59@yahoo.com",
    "telephone": "490.745.1456",
    "givenName": "Langosh",
    "familyName": "Webster",
    "identifier": "f5ab1ce4-7884-4d1d-867d-69cb77dd9526"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 297.834374ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b
...
---
Response status code: 201 Created. Responded in 286.574096ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b#/orderedItems/1124",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2241/facility-use-slots/20241#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b/versions/3f5f125a-0c41-463f-be5c-c87642aaf42f",
  "payment": {
    "@type": "Payment",
    "identifier": "AUyRSd_PB",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b


---
Response status code: 200 OK. Responded in 274.758613ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619838256582&afterId=e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13",
  "message": "Listening for UUID: 'bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 43.0756ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b


---
Response status code: 200 OK. Responded in 3377.809862ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b",
  "modified": 637607619907551100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b",
    "identifier": "bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b",
...
---
Response status code: 200 OK. Responded in 284.604894ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619871241466&afterId=b7a331a0-ee3e-479e-93b2-41622e73d85d",
  "message": "Listening for UUID: 'bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b
...
---
Response status code: 201 Created. Responded in 150.201977ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b",
  "identifier": "bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1972.949685ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "bbbc8ca1-abc9-4c19-ae3c-b05bb3f27d0b",
  "modified": 637607619944902100
}
```
### Specs
* ✅ should return 200 on success
