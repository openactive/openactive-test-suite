...
---
Response status code: 200 OK. Responded in 50.52051ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2525/facility-use-slots/20525"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2525%2Ffacility-use-slots%2F20525?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1118.174881ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2525/facility-use-slots/20525",
  "modified": 1625165927892,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2525",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2525/facility-use-slots/20525#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:58:45+00:00",
    "endDate": "2021-07-02T19:58:45+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f86ba71f-cc9d-4db0-bf1a-7782bfab621a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2525/facility-use-slots/20525#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2525/facility-use-slots/20525"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 424.336246ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f86ba71f-cc9d-4db0-bf1a-7782bfab621a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:03:47+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f86ba71f-cc9d-4db0-bf1a-7782bfab621a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Earlene97@yahoo.com",
    "telephone": "565-763-3614",
    "givenName": "Johns",
    "familyName": "Liana",
    "identifier": "d9d30766-4417-4ddf-bfb7-17846940f56d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 854.776142ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/f86ba71f-cc9d-4db0-bf1a-7782bfab621a
...
---
Response status code: 400 Bad Request. Responded in 52.505626ms.
```json
{
  "@context": "https://openactive.io/",
