...
# no-broker >> customer-not-included-nobroker-mode (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 51.045096ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2250/facility-use-slots/20250"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2250%2Ffacility-use-slots%2F20250?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1255.035725ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2250/facility-use-slots/20250",
  "modified": 1625165202035,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2250",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2250/facility-use-slots/20250#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a68818ec-5ad5-441c-b750-8917d9af4406
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2250/facility-use-slots/20250#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2250/facility-use-slots/20250"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 497.241475ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a68818ec-5ad5-441c-b750-8917d9af4406",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:41+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2250"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:46:39+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a68818ec-5ad5-441c-b750-8917d9af4406
...
---
Response status code: 400 Bad Request. Responded in 83.685143ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 77.939819ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2251/facility-use-slots/20251"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2251%2Ffacility-use-slots%2F20251?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3490.659696ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2251/facility-use-slots/20251",
  "modified": 1625165206633,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2251",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2251/facility-use-slots/20251#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/868fcec0-a3d9-4224-b8eb-c23213a9c1af
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2251/facility-use-slots/20251#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2251/facility-use-slots/20251"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 224.005617ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/868fcec0-a3d9-4224-b8eb-c23213a9c1af",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:45+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2251"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:46:42+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/868fcec0-a3d9-4224-b8eb-c23213a9c1af
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Itzel.Hamill32@hotmail.com",
    "telephone": "499.249.3018 x3069",
    "givenName": "Tremblay",
    "familyName": "Justus",
    "identifier": "be857d57-e5cb-4645-bffb-2a04c8678faa"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 235.042863ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:46+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/868fcec0-a3d9-4224-b8eb-c23213a9c1af
...
---
Response status code: 400 Bad Request. Responded in 67.083675ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
