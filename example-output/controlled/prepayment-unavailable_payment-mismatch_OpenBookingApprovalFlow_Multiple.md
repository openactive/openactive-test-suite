...
# prepayment-unavailable >> payment-mismatch (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 17 passed with 0 failures, 285 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 67.515122ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2527/events/20527"
}
```
...
---
Response status code: 200 OK. Responded in 88.095059ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2528/events/20528"
}
```
...
---
Response status code: 200 OK. Responded in 92.667766ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2516/facility-use-slots/20516"
}
```
...
---
Response status code: 200 OK. Responded in 69.339425ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2515/facility-use-slots/20515"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2527%2Fevents%2F20527?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 773.41049ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2527/events/20527",
  "modified": 1625165898216,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2527/events/20527",
    "startDate": "2021-07-02T18:58:16+00:00",
    "endDate": "2021-07-02T19:58:16+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2527",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2527#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2528%2Fevents%2F20528?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 772.717289ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2528/events/20528",
  ...
  "data": {
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2528",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2528#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2516%2Ffacility-use-slots%2F20516?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 625.559925ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2516/facility-use-slots/20516",
  "modified": 1625165898070,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2516",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2516/facility-use-slots/20516#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2515%2Ffacility-use-slots%2F20515?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 624.266322ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2515/facility-use-slots/20515",
  "modified": 1625165898069,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2515",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2515/facility-use-slots/20515#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8aaf70a3-5c9c-418b-8682-8a50e54c431c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2527#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2527/events/20527"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2528#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2528/events/20528"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2516/facility-use-slots/20516#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2516/facility-use-slots/20516"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2515/facility-use-slots/20515#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2515/facility-use-slots/20515"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1065.929896ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8aaf70a3-5c9c-418b-8682-8a50e54c431c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:03:18+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2516"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:58:16+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2515"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:58:16+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8aaf70a3-5c9c-418b-8682-8a50e54c431c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Adolph.Kuhlman13@gmail.com",
    "telephone": "384-642-8567 x2032",
    "givenName": "Grant",
    "familyName": "Jerel",
    "identifier": "2df033c3-953c-44c6-83a1-59448d2bebe1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2531.772978ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:03:20+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/8aaf70a3-5c9c-418b-8682-8a50e54c431c
...
---
Response status code: 400 Bad Request. Responded in 184.101095ms.
```json
{
  "@context": "https://openactive.io/",
