...
# customer-details-capture-identifier >> customer-identifier-capture (OpenBookingApprovalFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 539.376793ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2364/events/20364"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2364%2Fevents%2F20364?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 922.854463ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2364/events/20364",
  "modified": 1625165406802,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2364/events/20364",
    "startDate": "2021-07-02T18:50:04+00:00",
    "endDate": "2021-07-02T19:50:04+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2364",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2364#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bc8cf9d5-923f-42bc-9ccc-2f258bf0735e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2364#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2364/events/20364"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 326.551433ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bc8cf9d5-923f-42bc-9ccc-2f258bf0735e",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bc8cf9d5-923f-42bc-9ccc-2f258bf0735e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Allison.Kessler91@gmail.com",
    "telephone": "1-979-587-5446",
    "givenName": "Wisoky",
    "familyName": "Alexys",
    "identifier": "02b8dc75-40a4-47f0-9a17-3c9972534337"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 273.209117ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/bc8cf9d5-923f-42bc-9ccc-2f258bf0735e
...
---
Response status code: 201 Created. Responded in 510.14542ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/bc8cf9d5-923f-42bc-9ccc-2f258bf0735e",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bc8cf9d5-923f-42bc-9ccc-2f258bf0735e#/orderedItems/1783",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2364#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/bc8cf9d5-923f-42bc-9ccc-2f258bf0735e/versions/a4e0ff9d-ffa6-4f75-b5d1-1326e64c4d39",
  "payment": {
    "@type": "Payment",
    "identifier": "qaqUH1zTU",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;bc8cf9d5-923f-42bc-9ccc-2f258bf0735e&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/bc8cf9d5-923f-42bc-9ccc-2f258bf0735e


---
Response status code: 200 OK. Responded in 229.177757ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'bc8cf9d5-923f-42bc-9ccc-2f258bf0735e' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 54.04352ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;bc8cf9d5-923f-42bc-9ccc-2f258bf0735e&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/bc8cf9d5-923f-42bc-9ccc-2f258bf0735e


---
Response status code: 200 OK. Responded in 2449.744301ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "bc8cf9d5-923f-42bc-9ccc-2f258bf0735e",
  "modified": 637607622083404400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/bc8cf9d5-923f-42bc-9ccc-2f258bf0735e",
    "identifier": "bc8cf9d5-923f-42bc-9ccc-2f258bf0735e",
...
---
Response status code: 200 OK. Responded in 58.595947ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/bc8cf9d5-923f-42bc-9ccc-2f258bf0735e
...
---
Response status code: 201 Created. Responded in 161.867259ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/bc8cf9d5-923f-42bc-9ccc-2f258bf0735e",
  "identifier": "bc8cf9d5-923f-42bc-9ccc-2f258bf0735e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 2200.343325ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "bc8cf9d5-923f-42bc-9ccc-2f258bf0735e",
  "modified": 637607622109607200
}
```
### Specs
* ✅ should return 200 on success
