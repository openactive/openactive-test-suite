[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:45:33 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 91.36152ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2219/events/20219"
}
```
...
---
Response status code: 200 OK. Responded in 89.690285ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2220/events/20220"
}
```
...
---
Response status code: 200 OK. Responded in 308.191776ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2214/facility-use-slots/20214"
}
```
...
---
Response status code: 200 OK. Responded in 80.043182ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2213/facility-use-slots/20213"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2219%2Fevents%2F20219?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1865.673956ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2219/events/20219",
  "modified": 1625165144597,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2219/events/20219",
    "startDate": "2021-06-30T18:45:41+00:00",
    "endDate": "2021-06-30T19:45:41+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2219",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Sesssion in the Past",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2219#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2220%2Fevents%2F20220?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1865.856438ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2220/events/20220",
  "modified": 1625165144609,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2220/events/20220",
    "startDate": "2021-07-02T18:45:41+00:00",
    "endDate": "2021-07-02T19:45:41+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2220",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2220#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2214%2Ffacility-use-slots%2F20214?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2488.722492ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2214/facility-use-slots/20214",
  "modified": 1625165145222,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2214",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility in the Past",
      "activity": [
        {
          "@type": "Concept",
          "@id": "https://openactive.io/activity-list#c07d63a0-8eb9-4602-8bcc-23be6deb8f83",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2214/facility-use-slots/20214#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2213%2Ffacility-use-slots%2F20213?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2477.285617ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2213/facility-use-slots/20213",
  "modified": 1625165145215,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2213",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2213/facility-use-slots/20213#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
* ✅ matches the criteria 'TestOpportunityBookableInPast' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/98b34a65-f838-4d5a-8e9b-a16f877faa7b
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2219#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2219/events/20219"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2220#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2220/events/20220"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2214/facility-use-slots/20214#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2214/facility-use-slots/20214"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2213/facility-use-slots/20213#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2213/facility-use-slots/20213"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 352.636636ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/98b34a65-f838-4d5a-8e9b-a16f877faa7b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:45+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2214"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-06-30T18:45:41+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2213"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:45:41+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/98b34a65-f838-4d5a-8e9b-a16f877faa7b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Brendan16@hotmail.com",
    "telephone": "1-535-481-6132 x57354",
    "givenName": "Senger",
    "familyName": "Laney",
    "identifier": "5e75f7a3-fe5e-49e1-aaa0-f7fbe060fe7f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 434.334368ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:46+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/98b34a65-f838-4d5a-8e9b-a16f877faa7b
...
---
Response status code: 409 Conflict. Responded in 324.810593ms.
```json
{
  "@context": "https://openactive.io/",
