...
⚠️ 15 passed with 0 failures, 201 warnings and 24 suggestions 
...
---
Response status code: 200 OK. Responded in 107.690433ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2005/facility-use-slots/20005"
}
```
...
---
Response status code: 200 OK. Responded in 294.227328ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2009/facility-use-slots/20009"
}
```
...
---
Response status code: 200 OK. Responded in 124.715732ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2006/facility-use-slots/20006"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2005%2Ffacility-use-slots%2F20005?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1966.9904470000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2005/facility-use-slots/20005",
  "modified": 1625164729576,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2005",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2005/facility-use-slots/20005#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2009%2Ffacility-use-slots%2F20009?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1974.458791ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2009/facility-use-slots/20009",
  "modified": 1625164729587,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2009",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2009/facility-use-slots/20009#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 14.99,
        "priceCurrency": "GBP"
      }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2006%2Ffacility-use-slots%2F20006?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1965.661439ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2006/facility-use-slots/20006",
  "modified": 1625164729577,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2006",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility Paid That Does Not Allow Full Refund",
      "activity": [
        {
          "@type": "Concept",
          "@id": "https://openactive.io/activity-list#c07d63a0-8eb9-4602-8bcc-23be6deb8f83",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2006/facility-use-slots/20006#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a5921f04-33c3-4da6-b261-123a30320c9d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2005/facility-use-slots/20005#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2005/facility-use-slots/20005"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2009/facility-use-slots/20009#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2009/facility-use-slots/20009"
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2006/facility-use-slots/20006#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2006/facility-use-slots/20006"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 219.420588ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a5921f04-33c3-4da6-b261-123a30320c9d",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2005"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:38:46+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a5921f04-33c3-4da6-b261-123a30320c9d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Peyton.Greenfelder12@hotmail.com",
    "telephone": "762.478.2644 x0561",
    "givenName": "Walker",
    "familyName": "Tressie",
    "identifier": "f6ab6fab-e2d9-4686-88a7-ed157c9f50ab"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 289.393199ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:50+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a5921f04-33c3-4da6-b261-123a30320c9d
...
---
Response status code: 201 Created. Responded in 288.526893ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a5921f04-33c3-4da6-b261-123a30320c9d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a5921f04-33c3-4da6-b261-123a30320c9d#/orderedItems/42",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2005/facility-use-slots/20005#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a5921f04-33c3-4da6-b261-123a30320c9d#/orderedItems/43",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2009/facility-use-slots/20009#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a5921f04-33c3-4da6-b261-123a30320c9d#/orderedItems/44",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2006/facility-use-slots/20006#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/a5921f04-33c3-4da6-b261-123a30320c9d
...
---
Response status code: 400 Bad Request. Responded in 52.067406ms.
```json
{
  "@context": "https://openactive.io/",
...
### Orders (orders) Feed listen for &#x27;a5921f04-33c3-4da6-b261-123a30320c9d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/a5921f04-33c3-4da6-b261-123a30320c9d


---
Response status code: 200 OK. Responded in 672.412146ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607615208655732&afterId=ff2156ac-1959-47a8-a40d-22a3a1831581",
  "message": "Listening for UUID: 'a5921f04-33c3-4da6-b261-123a30320c9d' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 90.777333ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after successful OrderCancellation)

### Orders (orders) Feed collect for &#x27;a5921f04-33c3-4da6-b261-123a30320c9d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/a5921f04-33c3-4da6-b261-123a30320c9d


---
Response status code: 200 OK. Responded in 3442.043039ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a5921f04-33c3-4da6-b261-123a30320c9d",
  "modified": 637607615340585500,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/a5921f04-33c3-4da6-b261-123a30320c9d",
    "identifier": "a5921f04-33c3-4da6-b261-123a30320c9d",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/a5921f04-33c3-4da6-b261-123a30320c9d#/orderedItems/42",
