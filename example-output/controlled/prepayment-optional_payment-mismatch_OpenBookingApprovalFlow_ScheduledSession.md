...
---
Response status code: 200 OK. Responded in 1435.176404ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2502/events/20502"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2502%2Fevents%2F20502?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1109.274978ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2502/events/20502",
  "modified": 1625165845817,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2502/events/20502",
    "startDate": "2021-07-02T18:57:22+00:00",
    "endDate": "2021-07-02T19:57:22+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2502",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2502#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cef5b512-59c5-42db-8a25-9c540c645b02
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2502#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2502/events/20502"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 972.473853ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cef5b512-59c5-42db-8a25-9c540c645b02",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:25+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2502"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cef5b512-59c5-42db-8a25-9c540c645b02
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Norwood30@yahoo.com",
    "telephone": "(431) 592-5387 x79346",
    "givenName": "Walsh",
    "familyName": "Ocie",
    "identifier": "cf137fed-17c9-4586-86a7-550a91614a4f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 447.655772ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/cef5b512-59c5-42db-8a25-9c540c645b02
...
---
Response status code: 400 Bad Request. Responded in 51.237971ms.
```json
{
  "@context": "https://openactive.io/",
