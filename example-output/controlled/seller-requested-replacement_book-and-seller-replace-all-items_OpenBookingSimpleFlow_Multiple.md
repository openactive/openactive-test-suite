[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:49:10 GMT+0000 (Coordinated Universal Time)

# seller-requested-replacement >> book-and-seller-replace-all-items (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 18 passed with 0 failures, 400 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 72.228527ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2352/events/20352"
}
```
...
---
Response status code: 200 OK. Responded in 205.282313ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2353/events/20353"
}
```
...
---
Response status code: 200 OK. Responded in 160.298247ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2341/facility-use-slots/20341"
}
```
...
---
Response status code: 200 OK. Responded in 57.936342ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2340/facility-use-slots/20340"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2352%2Fevents%2F20352?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1104.64553ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2352/events/20352",
  "modified": 1625165371906,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2352/events/20352",
    "startDate": "2021-07-02T18:49:29+00:00",
    "endDate": "2021-07-02T19:49:29+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2352",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2352#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2353%2Fevents%2F20353?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1105.220934ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2353/events/20353",
  "modified": 1625165371908,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2353",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2353#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 14.99,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2341%2Ffacility-use-slots%2F20341?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1866.394133ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2341/facility-use-slots/20341",
  "modified": 1625165372670,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2341",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2341/facility-use-slots/20341#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2340%2Ffacility-use-slots%2F20340?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1864.2405199999998ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2340/facility-use-slots/20340",
  "modified": 1625165372668,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2340",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2340/facility-use-slots/20340#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bf130a84-8f0f-417b-bb6b-0f71fde8b794
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2352#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2352/events/20352"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2353#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2353/events/20353"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2341/facility-use-slots/20341#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2341/facility-use-slots/20341"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2340/facility-use-slots/20340#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2340/facility-use-slots/20340"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1224.252337ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bf130a84-8f0f-417b-bb6b-0f71fde8b794",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:33+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2353"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2341"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:49:29+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2340"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:49:29+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bf130a84-8f0f-417b-bb6b-0f71fde8b794
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Rozella_Krajcik66@gmail.com",
    "telephone": "1-209-741-9405 x84103",
    "givenName": "Nienow",
    "familyName": "Patricia",
    "identifier": "97b4020a-f698-4c4d-bfdc-05955e7fc0c7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1152.525612ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:35+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/bf130a84-8f0f-417b-bb6b-0f71fde8b794
...
---
Response status code: 201 Created. Responded in 1137.356625ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/bf130a84-8f0f-417b-bb6b-0f71fde8b794",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bf130a84-8f0f-417b-bb6b-0f71fde8b794#/orderedItems/1699",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2352#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bf130a84-8f0f-417b-bb6b-0f71fde8b794#/orderedItems/1700",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2352#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bf130a84-8f0f-417b-bb6b-0f71fde8b794#/orderedItems/1701",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2353#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bf130a84-8f0f-417b-bb6b-0f71fde8b794#/orderedItems/1702",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2341/facility-use-slots/20341#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bf130a84-8f0f-417b-bb6b-0f71fde8b794#/orderedItems/1703",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2341/facility-use-slots/20341#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bf130a84-8f0f-417b-bb6b-0f71fde8b794#/orderedItems/1704",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2340/facility-use-slots/20340#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Orders (orders) Feed listen for &#x27;bf130a84-8f0f-417b-bb6b-0f71fde8b794&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/bf130a84-8f0f-417b-bb6b-0f71fde8b794


---
Response status code: 200 OK. Responded in 115.270482ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607621657877481&afterId=0f75162a-90c1-4bad-a60a-78848a0ec632",
  "message": "Listening for UUID: 'bf130a84-8f0f-417b-bb6b-0f71fde8b794' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 362.941348ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:ReplacementSimulateAction)

### Orders (orders) Feed collect for &#x27;bf130a84-8f0f-417b-bb6b-0f71fde8b794&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/bf130a84-8f0f-417b-bb6b-0f71fde8b794


---
Response status code: 200 OK. Responded in 2658.188328ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "bf130a84-8f0f-417b-bb6b-0f71fde8b794",
  "modified": 637607621833146900,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/bf130a84-8f0f-417b-bb6b-0f71fde8b794",
    "identifier": "bf130a84-8f0f-417b-bb6b-0f71fde8b794",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/bf130a84-8f0f-417b-bb6b-0f71fde8b794#/orderedItems/1704",
