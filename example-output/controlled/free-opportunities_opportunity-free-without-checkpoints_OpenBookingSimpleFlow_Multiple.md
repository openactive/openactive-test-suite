...
⚠️ 13 passed with 0 failures, 208 warnings and 54 suggestions 
...
---
Response status code: 200 OK. Responded in 205.465913ms.
```json
{
...
---
Response status code: 200 OK. Responded in 182.348375ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2407/events/20407"
}
```
...
---
Response status code: 200 OK. Responded in 264.54016ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2395/facility-use-slots/20395"
}
```
...
---
Response status code: 200 OK. Responded in 223.68812ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2394/facility-use-slots/20394"
}
```
...
---
Response status code: 200 OK. Responded in 1119.906107ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2408/events/20408",
  "modified": 1625165556871,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2408/events/20408",
    "startDate": "2021-07-02T18:52:34+00:00",
    "endDate": "2021-07-02T19:52:34+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2407%2Fevents%2F20407?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1105.711523ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2407/events/20407",
  "modified": 1625165556870,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2407",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Free Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2407#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2395%2Ffacility-use-slots%2F20395?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1721.925659ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2395/facility-use-slots/20395",
  "modified": 1625165557487,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2395",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2395/facility-use-slots/20395#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2394%2Ffacility-use-slots%2F20394?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1706.346767ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2394/facility-use-slots/20394",
  "modified": 1625165557486,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2394",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Free Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2394/facility-use-slots/20394#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ba69d0c8-ba80-4eda-959e-9ca3b1128356
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Leslie.Skiles@hotmail.com",
    "telephone": "(415) 675-0636",
    "givenName": "Cole",
    "familyName": "Green",
    "identifier": "8c05e7e3-1df7-4f46-b0d9-83d813c75de2"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2407#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2407/events/20407"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2395/facility-use-slots/20395#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2395/facility-use-slots/20395"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2394/facility-use-slots/20394#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2394/facility-use-slots/20394"
    }
  ],
  "totalPaymentDue": {
...
---
Response status code: 201 Created. Responded in 1347.804252ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ba69d0c8-ba80-4eda-959e-9ca3b1128356",
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ba69d0c8-ba80-4eda-959e-9ca3b1128356#/orderedItems/2070",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2408#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ba69d0c8-ba80-4eda-959e-9ca3b1128356#/orderedItems/2071",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2408#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ba69d0c8-ba80-4eda-959e-9ca3b1128356#/orderedItems/2072",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2407#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ba69d0c8-ba80-4eda-959e-9ca3b1128356#/orderedItems/2073",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2395/facility-use-slots/20395#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ba69d0c8-ba80-4eda-959e-9ca3b1128356#/orderedItems/2074",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2395/facility-use-slots/20395#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ba69d0c8-ba80-4eda-959e-9ca3b1128356#/orderedItems/2075",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2394/facility-use-slots/20394#/offers/0",
        "allowCustomerCancellationFullRefund": true,
