...
# additional-details-capture >> additional-details-required-invalid-details-supplied (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 19.613976ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2247/facility-use-slots/20247"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2247%2Ffacility-use-slots%2F20247?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2551.5631080000003ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2247/facility-use-slots/20247",
  "modified": 1625165202012,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2247",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2247/facility-use-slots/20247#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:46:38+00:00",
    "endDate": "2021-07-02T19:46:38+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4d986afd-f71d-453b-8b49-dbdb9b02d3a2
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2247/facility-use-slots/20247#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2247/facility-use-slots/20247"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 344.261454ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4d986afd-f71d-453b-8b49-dbdb9b02d3a2",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4d986afd-f71d-453b-8b49-dbdb9b02d3a2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Joannie_Considine74@yahoo.com",
    "telephone": "(460) 700-5090 x59285",
    "givenName": "Marquardt",
    "familyName": "Hadley",
    "identifier": "fc528d15-968f-4bb9-8f7f-4be97a9d2aa4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 97.929301ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4d986afd-f71d-453b-8b49-dbdb9b02d3a2
...
---
Response status code: 409 Conflict. Responded in 244.473101ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 409,
  "description": "The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.: Value provided is not a boolean, The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.: Value provided is not a Url"
}
```
### Specs
