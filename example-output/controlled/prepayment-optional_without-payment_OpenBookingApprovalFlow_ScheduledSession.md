...
⚠️ 13 passed with 0 failures, 93 warnings and 32 suggestions 
...
---
Response status code: 200 OK. Responded in 406.551641ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2537/events/20537"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2537%2Fevents%2F20537?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1139.012123ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2537/events/20537",
  "modified": 1625165919631,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2537/events/20537",
    "startDate": "2021-07-02T18:58:37+00:00",
    "endDate": "2021-07-02T19:58:37+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2537",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2537#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d3366d64-9888-4fa4-b88e-60eb92ba580e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2537#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2537/events/20537"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 476.007202ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d3366d64-9888-4fa4-b88e-60eb92ba580e",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:03:38+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d3366d64-9888-4fa4-b88e-60eb92ba580e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Chauncey4@yahoo.com",
    "telephone": "1-809-295-0494 x4832",
    "givenName": "Shields",
    "familyName": "Nyah",
    "identifier": "1b50dbad-ed4b-46ee-b302-ac274897ed23"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2379.697606ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:03:41+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/d3366d64-9888-4fa4-b88e-60eb92ba580e
...
---
Response status code: 201 Created. Responded in 525.160953ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/d3366d64-9888-4fa4-b88e-60eb92ba580e",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d3366d64-9888-4fa4-b88e-60eb92ba580e#/orderedItems/2946",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2537#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/d3366d64-9888-4fa4-b88e-60eb92ba580e/versions/c2ad7265-457a-4385-87e5-0d48d9bd266f",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;d3366d64-9888-4fa4-b88e-60eb92ba580e&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/d3366d64-9888-4fa4-b88e-60eb92ba580e


---
Response status code: 200 OK. Responded in 4.386336ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607627168618260&afterId=d070a2d9-2f18-4954-8042-c5b57248a810",
  "message": "Listening for UUID: 'd3366d64-9888-4fa4-b88e-60eb92ba580e' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 27.950927ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;d3366d64-9888-4fa4-b88e-60eb92ba580e&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/d3366d64-9888-4fa4-b88e-60eb92ba580e


---
Response status code: 200 OK. Responded in 2507.484264ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "d3366d64-9888-4fa4-b88e-60eb92ba580e",
  "modified": 637607627228010200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/d3366d64-9888-4fa4-b88e-60eb92ba580e",
    "identifier": "d3366d64-9888-4fa4-b88e-60eb92ba580e",
...
---
Response status code: 200 OK. Responded in 26.151113ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607627228010177&afterId=d3366d64-9888-4fa4-b88e-60eb92ba580e",
  "message": "Listening for UUID: 'd3366d64-9888-4fa4-b88e-60eb92ba580e' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/d3366d64-9888-4fa4-b88e-60eb92ba580e
...
---
Response status code: 201 Created. Responded in 640.047598ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d3366d64-9888-4fa4-b88e-60eb92ba580e",
  "identifier": "d3366d64-9888-4fa4-b88e-60eb92ba580e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1708.170772ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "d3366d64-9888-4fa4-b88e-60eb92ba580e",
  "modified": 637607627257425700
}
```
### Specs
* ✅ should return 200 on success
