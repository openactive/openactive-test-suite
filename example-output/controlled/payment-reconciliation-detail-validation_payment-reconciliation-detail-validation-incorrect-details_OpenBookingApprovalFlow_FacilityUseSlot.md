...
---
Response status code: 200 OK. Responded in 39.926213ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2570/facility-use-slots/20570"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2570%2Ffacility-use-slots%2F20570?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1475.7163620000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2570/facility-use-slots/20570",
  "modified": 1625166025980,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2570",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2570/facility-use-slots/20570#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T19:00:23+00:00",
    "endDate": "2021-07-02T20:00:23+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a78cd6bd-0fad-43ef-ab3e-0880c0148de6
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2570/facility-use-slots/20570#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2570/facility-use-slots/20570"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-xT5M9ZUfFw",
    "accountId": "invalid-sX-MAfZ4M",
    "paymentProviderId": "invalid-ae21O8NNPJ"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 77.679114ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a78cd6bd-0fad-43ef-ab3e-0880c0148de6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Pablo_Buckridge@gmail.com",
    "telephone": "949.610.3930",
    "givenName": "Erdman",
    "familyName": "Ruben",
    "identifier": "f5d3d06e-068f-4d05-a64b-00a706c116bc"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-9dNpHTEt6i",
    "accountId": "invalid-t3j8rOou_2",
    "paymentProviderId": "invalid-LbUijpyh29"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 152.718813ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
