...
---
Response status code: 200 OK. Responded in 60.392384ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2283/facility-use-slots/20283"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2283%2Ffacility-use-slots%2F20283?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1571.69789ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2283/facility-use-slots/20283",
  "modified": 1625165256527,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2283/facility-use-slots/20283#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5264e091-22d8-4b51-9381-e75614e1a53d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2283/facility-use-slots/20283#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2283/facility-use-slots/20283"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 712.815431ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5264e091-22d8-4b51-9381-e75614e1a53d",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5264e091-22d8-4b51-9381-e75614e1a53d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bulah.Walter@hotmail.com",
    "telephone": "841-818-5727",
    "givenName": "Fadel",
    "familyName": "Rose",
    "identifier": "eb5d7d73-7a52-422c-b7cd-833a14e455f5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 266.044091ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5264e091-22d8-4b51-9381-e75614e1a53d
...
---
Response status code: 201 Created. Responded in 179.592841ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5264e091-22d8-4b51-9381-e75614e1a53d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5264e091-22d8-4b51-9381-e75614e1a53d#/orderedItems/1323",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2283/facility-use-slots/20283#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/490f88d6-1a08-4595-b617-97e123ff3ccc
...
---
Response status code: 500 Internal Server Error. Responded in 19.959125ms.
```json
{
  "@context": "https://openactive.io/",
