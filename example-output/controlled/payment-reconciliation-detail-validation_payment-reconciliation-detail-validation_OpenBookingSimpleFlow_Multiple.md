...
⚠️ 19 passed with 0 failures, 374 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 87.506807ms.
```json
{
...
---
Response status code: 200 OK. Responded in 110.516714ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 174.398412ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 97.368253ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 1239.073962ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2600/events/20600",
  "modified": 1625166064632,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2600/events/20600",
    "startDate": "2021-07-02T19:01:02+00:00",
    "endDate": "2021-07-02T20:01:02+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 1237.809956ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2601/events/20601",
  "modified": 1625166064633,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1021.074049ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2589/facility-use-slots/20589",
  "modified": 1625166064414,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1019.808443ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2588/facility-use-slots/20588",
  "modified": 1625166064413,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5a3452e2-3780-447c-a032-0ba304ad83bf
...
---
Response status code: 200 OK. Responded in 2197.566433ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5a3452e2-3780-447c-a032-0ba304ad83bf",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:06:04+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5a3452e2-3780-447c-a032-0ba304ad83bf
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Koby.Fadel60@gmail.com",
    "telephone": "235.498.6745 x159",
    "givenName": "Feeney",
    "familyName": "Alanis",
    "identifier": "5d344b62-83e0-4564-98ff-c2d6aa2dea10"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1328.810314ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:06:07+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5a3452e2-3780-447c-a032-0ba304ad83bf
...
---
Response status code: 201 Created. Responded in 1213.261513ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5a3452e2-3780-447c-a032-0ba304ad83bf",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5a3452e2-3780-447c-a032-0ba304ad83bf#/orderedItems/3251",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2600#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5a3452e2-3780-447c-a032-0ba304ad83bf#/orderedItems/3252",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2600#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5a3452e2-3780-447c-a032-0ba304ad83bf#/orderedItems/3253",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2601#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5a3452e2-3780-447c-a032-0ba304ad83bf#/orderedItems/3254",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2589/facility-use-slots/20589#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5a3452e2-3780-447c-a032-0ba304ad83bf#/orderedItems/3255",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2589/facility-use-slots/20589#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5a3452e2-3780-447c-a032-0ba304ad83bf#/orderedItems/3256",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2588/facility-use-slots/20588#/offers/0",
        "allowCustomerCancellationFullRefund": true,
