...
# test-interface >> create-opportunity (OpenBookingSimpleFlow >> ScheduledSession)
...
⚠️ 2 passed with 0 failures, 23 warnings and 8 suggestions 
...
---
Response status code: 200 OK. Responded in 204.819786ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2503/events/20503"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2503%2Fevents%2F20503?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 621.758794ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2503/events/20503",
  "modified": 1625165847740,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2503/events/20503",
    "startDate": "2021-07-02T18:57:26+00:00",
    "endDate": "2021-07-02T19:57:26+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2503",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2503#/offers/0",
