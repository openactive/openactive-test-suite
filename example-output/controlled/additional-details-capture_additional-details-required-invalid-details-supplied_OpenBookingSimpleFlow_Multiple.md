...
# additional-details-capture >> additional-details-required-invalid-details-supplied (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 15 passed with 0 failures, 282 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 533.489585ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2264/events/20264"
}
```
...
---
Response status code: 200 OK. Responded in 1015.66946ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2265/events/20265"
}
```
...
---
Response status code: 200 OK. Responded in 981.963122ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2252/facility-use-slots/20252"
}
```
...
---
Response status code: 200 OK. Responded in 1029.647617ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2253/facility-use-slots/20253"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2264%2Fevents%2F20264?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1577.761762ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2264/events/20264",
  "modified": 1625165206212,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2264/events/20264",
    "startDate": "2021-07-02T18:46:42+00:00",
    "endDate": "2021-07-02T19:46:42+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2264",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2264#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2265%2Fevents%2F20265?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1593.901128ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2265/events/20265",
  "modified": 1625165206214,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2265",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2265#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 14.99,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2252%2Ffacility-use-slots%2F20252?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2014.616051ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2252/facility-use-slots/20252",
  "modified": 1625165206651,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2252",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2252/facility-use-slots/20252#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingIntakeForm"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2253%2Ffacility-use-slots%2F20253?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2014.578951ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2253/facility-use-slots/20253",
  "modified": 1625165206652,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2253",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2253/facility-use-slots/20253#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c5c0276f-6c71-440b-b48c-058702ac62b6
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2264#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2264/events/20264"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2265#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2265/events/20265"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2252/facility-use-slots/20252#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2252/facility-use-slots/20252"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2253/facility-use-slots/20253#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2253/facility-use-slots/20253"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 792.724947ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c5c0276f-6c71-440b-b48c-058702ac62b6",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:47+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2264"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2265"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2253"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:46:42+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c5c0276f-6c71-440b-b48c-058702ac62b6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alanna_Friesen70@hotmail.com",
    "telephone": "1-392-764-6410",
    "givenName": "Walker",
    "familyName": "Ardella",
    "identifier": "5fb84a4b-6864-41fd-ab83-028d39263ab7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 435.626284ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c5c0276f-6c71-440b-b48c-058702ac62b6
...
---
Response status code: 409 Conflict. Responded in 519.141559ms.
```json
{
  "@context": "https://openactive.io/",
