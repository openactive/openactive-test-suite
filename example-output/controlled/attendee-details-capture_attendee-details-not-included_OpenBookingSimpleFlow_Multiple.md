...
---
Response status code: 200 OK. Responded in 109.79539ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2279/events/20279"
}
```
...
---
Response status code: 200 OK. Responded in 223.095409ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2280/events/20280"
}
```
...
---
Response status code: 200 OK. Responded in 162.584919ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2266/facility-use-slots/20266"
}
```
...
---
Response status code: 200 OK. Responded in 101.624424ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2265/facility-use-slots/20265"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2279%2Fevents%2F20279?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1144.567981ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2279/events/20279",
  "modified": 1625165229401,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2279/events/20279",
    "startDate": "2021-07-02T18:47:07+00:00",
    "endDate": "2021-07-02T19:47:07+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2279",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2279#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2280%2Fevents%2F20280?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1149.567822ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2280/events/20280",
  "modified": 1625165229407,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2280",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2280#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2266%2Ffacility-use-slots%2F20266?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1820.147959ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2266/facility-use-slots/20266",
  "modified": 1625165230079,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2266",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2266/facility-use-slots/20266#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingAttendeeDetails"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2265%2Ffacility-use-slots%2F20265?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1809.4811730000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2265/facility-use-slots/20265",
  "modified": 1625165230069,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2265",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2265/facility-use-slots/20265#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5e1584bc-77a7-4cc2-b3d3-162556066b70
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2279#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2279/events/20279"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2280#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2280/events/20280"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2266/facility-use-slots/20266#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2266/facility-use-slots/20266"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2265/facility-use-slots/20265#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2265/facility-use-slots/20265"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 794.831145ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5e1584bc-77a7-4cc2-b3d3-162556066b70",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2279"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5e1584bc-77a7-4cc2-b3d3-162556066b70
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bill_Corkery72@yahoo.com",
    "telephone": "1-566-216-4998 x6236",
    "givenName": "Hane",
    "familyName": "Georgianna",
    "identifier": "0ba79ff3-ece6-4c62-94f6-0556032b4bac"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 281.527783ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5e1584bc-77a7-4cc2-b3d3-162556066b70
...
---
Response status code: 409 Conflict. Responded in 168.502667ms.
```json
{
  "@context": "https://openactive.io/",
