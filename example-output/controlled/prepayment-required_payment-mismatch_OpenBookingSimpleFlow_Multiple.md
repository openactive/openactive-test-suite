[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:55:21 GMT+0000 (Coordinated Universal Time)

# prepayment-required >> payment-mismatch (OpenBookingSimpleFlow >> Multiple)
...
```bash
npm start -- --runInBand test/features/payment/prepayment-required/implemented/payment-mismatch-test.js
```

---

⚠️ 9 passed with 0 failures, 101 warnings and 26 suggestions 
...
---
Response status code: 200 OK. Responded in 40.346808ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2460/events/20460"
}
```
...
---
Response status code: 200 OK. Responded in 137.247948ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2447/facility-use-slots/20447"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2460%2Fevents%2F20460?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 583.702156ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2460/events/20460",
  "modified": 1625165728923,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2460/events/20460",
    "startDate": "2021-07-02T18:55:27+00:00",
    "endDate": "2021-07-02T19:55:27+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2460",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2460#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2447%2Ffacility-use-slots%2F20447?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1390.752017ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2447/facility-use-slots/20447",
  "modified": 1625165729730,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2447",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2447/facility-use-slots/20447#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 14.99,
        "priceCurrency": "GBP"
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/15b7eb05-0fee-42ee-a5cb-9a079bd46542
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2460#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2460/events/20460"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2447/facility-use-slots/20447#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2447/facility-use-slots/20447"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1456.793563ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/15b7eb05-0fee-42ee-a5cb-9a079bd46542",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2460"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/15b7eb05-0fee-42ee-a5cb-9a079bd46542
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Emma_Crona0@hotmail.com",
    "telephone": "662.837.2376 x2933",
    "givenName": "Hermann",
    "familyName": "Hal",
    "identifier": "878003b0-7bf0-4689-a00d-121166e3174b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1102.8419039999999ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/15b7eb05-0fee-42ee-a5cb-9a079bd46542
...
---
Response status code: 400 Bad Request. Responded in 125.046275ms.
```json
{
  "@context": "https://openactive.io/",
