[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:54:50 GMT+0000 (Coordinated Universal Time)

# reseller-broker >> customer-included-resellerbroker-mode (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 19 passed with 0 failures, 477 warnings and 126 suggestions 
...
---
Response status code: 200 OK. Responded in 254.850339ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2464/events/20464"
}
```
...
---
Response status code: 200 OK. Responded in 2491.503793ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2465/events/20465"
}
```
...
---
Response status code: 200 OK. Responded in 2547.3542740000003ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2453/facility-use-slots/20453"
}
```
...
---
Response status code: 200 OK. Responded in 226.130243ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2451/facility-use-slots/20451"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2464%2Fevents%2F20464?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.89317ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2464/events/20464",
    "startDate": "2021-07-02T18:55:38+00:00",
    "endDate": "2021-07-02T19:55:38+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2464",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2464#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2465%2Fevents%2F20465?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 762.823403ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2465/events/20465",
  "modified": 1625165743054,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2465/events/20465",
    "startDate": "2021-07-02T18:55:39+00:00",
    "endDate": "2021-07-02T19:55:39+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2465",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2465#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2453%2Ffacility-use-slots%2F20453?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 725.415348ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2453/facility-use-slots/20453",
  "modified": 1625165743013,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2453",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2453/facility-use-slots/20453#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2451%2Ffacility-use-slots%2F20451?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.481167ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2451",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2451/facility-use-slots/20451#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5231ee81-9589-4672-ad8a-88f9ca755d8c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2464#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2464/events/20464"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2465#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2465/events/20465"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2453/facility-use-slots/20453#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2453/facility-use-slots/20453"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2451/facility-use-slots/20451#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2451/facility-use-slots/20451"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1246.832903ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5231ee81-9589-4672-ad8a-88f9ca755d8c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:00:43+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2464"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2465"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2453"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:55:39+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5231ee81-9589-4672-ad8a-88f9ca755d8c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Hortense.Beatty96@gmail.com",
    "telephone": "380.402.7994 x773",
    "givenName": "Leuschke",
    "familyName": "Corine",
    "identifier": "9b586efe-5ff3-4110-a841-d658fc0a52ad"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1844.088501ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:00:44+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> P

### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/5231ee81-9589-4672-ad8a-88f9ca755d8c
...
---
Response status code: 201 Created. Responded in 1246.059245ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/5231ee81-9589-4672-ad8a-88f9ca755d8c",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5231ee81-9589-4672-ad8a-88f9ca755d8c#/orderedItems/2482",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2464#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5231ee81-9589-4672-ad8a-88f9ca755d8c#/orderedItems/2483",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2464#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5231ee81-9589-4672-ad8a-88f9ca755d8c#/orderedItems/2484",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2465#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5231ee81-9589-4672-ad8a-88f9ca755d8c#/orderedItems/2485",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2453/facility-use-slots/20453#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5231ee81-9589-4672-ad8a-88f9ca755d8c#/orderedItems/2486",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2453/facility-use-slots/20453#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5231ee81-9589-4672-ad8a-88f9ca755d8c#/orderedItems/2487",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2451/facility-use-slots/20451#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/5231ee81-9589-4672-ad8a-88f9ca755d8c/versions/692af673-8783-4052-85ca-607ec2696a8d",
  "payment": {
    "@type": "Payment",
    "identifier": "ByunEVxrF",
    "name": "AcmeBroker Points",
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> P >> validation of P
### Specs
* ✅ passes validation checks
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> Simulate Seller Approval (Test Interface Action)

### Orders (order-proposals) Feed listen for &#x27;5231ee81-9589-4672-ad8a-88f9ca755d8c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/5231ee81-9589-4672-ad8a-88f9ca755d8c


---
Response status code: 200 OK. Responded in 4.828122ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607625413491422&afterId=2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c",
  "message": "Listening for UUID: '5231ee81-9589-4672-ad8a-88f9ca755d8c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 315.81588ms.
### Specs
* ✅ should return 204 on success

## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;5231ee81-9589-4672-ad8a-88f9ca755d8c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/5231ee81-9589-4672-ad8a-88f9ca755d8c


---
Response status code: 200 OK. Responded in 1896.026486ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "5231ee81-9589-4672-ad8a-88f9ca755d8c",
  "modified": 637607625489037200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/5231ee81-9589-4672-ad8a-88f9ca755d8c",
    "identifier": "5231ee81-9589-4672-ad8a-88f9ca755d8c",
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> OrderProposal Feed Update (after Simulate Seller Approval) >> validation of OrderFeed
### Specs
* ✅ passes validation checks
...
---
Response status code: 200 OK. Responded in 44.685996ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607625489037233&afterId=5231ee81-9589-4672-ad8a-88f9ca755d8c",
  "message": "Listening for UUID: '5231ee81-9589-4672-ad8a-88f9ca755d8c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/5231ee81-9589-4672-ad8a-88f9ca755d8c
...
---
Response status code: 201 Created. Responded in 2469.451291ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5231ee81-9589-4672-ad8a-88f9ca755d8c",
  "identifier": "5231ee81-9589-4672-ad8a-88f9ca755d8c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> OrderProposal Feed Deletion (after B)
...
---
Response status code: 200 OK. Responded in 48.699711ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "5231ee81-9589-4672-ad8a-88f9ca755d8c",
  "modified": 637607625520323000
}
```
### Specs
* ✅ should return 200 on success

## Booking should succeed if Broker and Customer are included in Order, because we are in ResellerBroker mode >> OrderProposal Feed Deletion (after B) >> validation of OrderFeed
### Specs
* ✅ passes validation checks
