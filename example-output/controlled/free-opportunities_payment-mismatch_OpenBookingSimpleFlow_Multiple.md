...
---
Response status code: 200 OK. Responded in 2746.564234ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2434/events/20434"
}
```
...
---
Response status code: 200 OK. Responded in 2761.448919ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2422/facility-use-slots/20422"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2434%2Fevents%2F20434?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1732.354523ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2434/events/20434",
  "modified": 1625165648609,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2434/events/20434",
    "startDate": "2021-07-02T18:54:03+00:00",
    "endDate": "2021-07-02T19:54:03+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2434",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2434#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2422%2Ffacility-use-slots%2F20422?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3348.693583ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2422/facility-use-slots/20422",
  "modified": 1625165650227,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2422",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2422/facility-use-slots/20422#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d73d9c49-264d-46e6-abac-2fbbf0a984ee
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2434#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2434/events/20434"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2422/facility-use-slots/20422#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2422/facility-use-slots/20422"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1308.109965ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d73d9c49-264d-46e6-abac-2fbbf0a984ee",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d73d9c49-264d-46e6-abac-2fbbf0a984ee
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Nathen.Rutherford45@yahoo.com",
    "telephone": "555.408.3884 x85068",
    "givenName": "Hamill",
    "familyName": "Kattie",
    "identifier": "575a00c1-a511-45ef-b44e-08869149d32c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 3422.109125ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:13+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d73d9c49-264d-46e6-abac-2fbbf0a984ee
...
---
Response status code: 400 Bad Request. Responded in 167.255255ms.
```json
{
  "@context": "https://openactive.io/",
