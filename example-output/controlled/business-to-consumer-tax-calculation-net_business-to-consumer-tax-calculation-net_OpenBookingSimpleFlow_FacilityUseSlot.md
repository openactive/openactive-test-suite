...
# business-to-consumer-tax-calculation-net >> business-to-consumer-tax-calculation-net (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 792.545489ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2530/facility-use-slots/20530"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2530%2Ffacility-use-slots%2F20530?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1121.061418ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2530/facility-use-slots/20530",
  "modified": 1625165937246,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2530",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2530/facility-use-slots/20530#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:58:54+00:00",
    "endDate": "2021-07-02T19:58:54+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4728ff9b-bf1c-4bef-bf0c-b0a245ad6e82
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2530/facility-use-slots/20530#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2530/facility-use-slots/20530"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 676.828652ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4728ff9b-bf1c-4bef-bf0c-b0a245ad6e82",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:03:56+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2530"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:58:54+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4728ff9b-bf1c-4bef-bf0c-b0a245ad6e82
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Erica.Green32@yahoo.com",
    "telephone": "1-284-379-3581",
    "givenName": "Thompson",
    "familyName": "Bo",
    "identifier": "b02cc9e3-2d1c-47df-b7bc-a31685ea0860"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 471.001229ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:03:57+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4728ff9b-bf1c-4bef-bf0c-b0a245ad6e82
...
---
Response status code: 201 Created. Responded in 761.665222ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4728ff9b-bf1c-4bef-bf0c-b0a245ad6e82",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4728ff9b-bf1c-4bef-bf0c-b0a245ad6e82#/orderedItems/2981",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2530/facility-use-slots/20530#/offers/0",
        "allowCustomerCancellationFullRefund": true,
