[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:48:07 GMT+0000 (Coordinated Universal Time)

# access-pass-image >> access-pass-image (OpenBookingApprovalFlow >> Multiple)

**Booking Flow:** OpenBookingApprovalFlow

**Opportunity Type:** Multiple

**Feature:** Access / accessPass - Seller provided access control images  (Implemented) 

**Test:**  Successful booking with access pass image.

Access pass image returned for B request.

### Running only this test

```bash
npm start -- --runInBand test/features/access/access-pass-image/implemented/access-pass-image-test.js
```

---

⚠️ 20 passed with 0 failures, 477 warnings and 126 suggestions 
...
---
Response status code: 200 OK. Responded in 229.59099ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2339/events/20339"
}
```
...
---
Response status code: 200 OK. Responded in 167.254659ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2338/events/20338"
}
```
...
---
Response status code: 200 OK. Responded in 200.211987ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2326/facility-use-slots/20326"
}
```
...
---
Response status code: 200 OK. Responded in 230.093694ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2327/facility-use-slots/20327"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2339%2Fevents%2F20339?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1280.394071ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2339/events/20339",
  "modified": 1625165333876,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2339/events/20339",
    "startDate": "2021-07-02T18:48:51+00:00",
    "endDate": "2021-07-02T19:48:51+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2339",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2339#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2338%2Fevents%2F20338?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1243.371214ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2338/events/20338",
  "modified": 1625165333842,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2338",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2338#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2326%2Ffacility-use-slots%2F20326?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2297.464516ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2326/facility-use-slots/20326",
  "modified": 1625165334897,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2326",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2326/facility-use-slots/20326#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2327%2Ffacility-use-slots%2F20327?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2301.930348ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2327/facility-use-slots/20327",
  "modified": 1625165334899,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2327",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2327/facility-use-slots/20327#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b2daa1eb-19d3-4a91-8c05-3538822ca7a4
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2339#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2339/events/20339"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2338#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2338/events/20338"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2326/facility-use-slots/20326#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2326/facility-use-slots/20326"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2327/facility-use-slots/20327#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2327/facility-use-slots/20327"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 760.201425ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b2daa1eb-19d3-4a91-8c05-3538822ca7a4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:54+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2326"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:48:51+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2327"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:48:51+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b2daa1eb-19d3-4a91-8c05-3538822ca7a4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Elnora48@yahoo.com",
    "telephone": "317-754-2128",
    "givenName": "Runolfsdottir",
    "familyName": "Tatum",
    "identifier": "dba87bad-717e-495c-9673-4b067bf45bde"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1500.578852ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b2daa1eb-19d3-4a91-8c05-3538822ca7a4
...
---
Response status code: 201 Created. Responded in 861.285161ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b2daa1eb-19d3-4a91-8c05-3538822ca7a4",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b2daa1eb-19d3-4a91-8c05-3538822ca7a4#/orderedItems/1599",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2339#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b2daa1eb-19d3-4a91-8c05-3538822ca7a4#/orderedItems/1600",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2339#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b2daa1eb-19d3-4a91-8c05-3538822ca7a4#/orderedItems/1601",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2338#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b2daa1eb-19d3-4a91-8c05-3538822ca7a4#/orderedItems/1602",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2326/facility-use-slots/20326#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b2daa1eb-19d3-4a91-8c05-3538822ca7a4#/orderedItems/1603",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2326/facility-use-slots/20326#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b2daa1eb-19d3-4a91-8c05-3538822ca7a4#/orderedItems/1604",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2327/facility-use-slots/20327#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b2daa1eb-19d3-4a91-8c05-3538822ca7a4/versions/aa304989-2108-431d-8c55-2ce7c0537771",
  "payment": {
    "@type": "Payment",
    "identifier": "IhFEjVt95",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;b2daa1eb-19d3-4a91-8c05-3538822ca7a4&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/b2daa1eb-19d3-4a91-8c05-3538822ca7a4


---
Response status code: 200 OK. Responded in 217.86078ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621285181135&afterId=ef170df4-02d0-4b25-b3ae-fc2af9f33b00",
  "message": "Listening for UUID: 'b2daa1eb-19d3-4a91-8c05-3538822ca7a4' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 211.992646ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;b2daa1eb-19d3-4a91-8c05-3538822ca7a4&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/b2daa1eb-19d3-4a91-8c05-3538822ca7a4


---
Response status code: 200 OK. Responded in 2595.371652ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b2daa1eb-19d3-4a91-8c05-3538822ca7a4",
  "modified": 637607621410555600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/b2daa1eb-19d3-4a91-8c05-3538822ca7a4",
    "identifier": "b2daa1eb-19d3-4a91-8c05-3538822ca7a4",
...
---
Response status code: 200 OK. Responded in 173.058517ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621410555635&afterId=b2daa1eb-19d3-4a91-8c05-3538822ca7a4",
  "message": "Listening for UUID: 'b2daa1eb-19d3-4a91-8c05-3538822ca7a4' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/b2daa1eb-19d3-4a91-8c05-3538822ca7a4
...
---
Response status code: 201 Created. Responded in 540.323875ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b2daa1eb-19d3-4a91-8c05-3538822ca7a4",
  "identifier": "b2daa1eb-19d3-4a91-8c05-3538822ca7a4",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 128.277303ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "b2daa1eb-19d3-4a91-8c05-3538822ca7a4",
  "modified": 637607621441738600
}
```
### Specs
* ✅ should return 200 on success
* ✅ Response should include accessPass array with url field that includes the `https` protocol
