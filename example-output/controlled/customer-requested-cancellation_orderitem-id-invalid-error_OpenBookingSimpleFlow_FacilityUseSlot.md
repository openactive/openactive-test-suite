...
---
Response status code: 200 OK. Responded in 109.719135ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2325/facility-use-slots/20325"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2325%2Ffacility-use-slots%2F20325?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1739.427075ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2325/facility-use-slots/20325",
  "modified": 1625165331577,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2325",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2325/facility-use-slots/20325#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:48:48+00:00",
    "endDate": "2021-07-02T19:48:48+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0b593623-572c-4b64-a7d1-a0eb13ef9efe
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2325/facility-use-slots/20325#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2325/facility-use-slots/20325"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 339.968456ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0b593623-572c-4b64-a7d1-a0eb13ef9efe",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2325"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:48:48+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0b593623-572c-4b64-a7d1-a0eb13ef9efe
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Vickie15@yahoo.com",
    "telephone": "643.911.3869 x9384",
    "givenName": "Kuphal",
    "familyName": "Savannah",
    "identifier": "630f0d94-8112-49eb-8c66-2b675a37d3c8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 185.585186ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0b593623-572c-4b64-a7d1-a0eb13ef9efe
...
---
Response status code: 201 Created. Responded in 262.904121ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/0b593623-572c-4b64-a7d1-a0eb13ef9efe",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0b593623-572c-4b64-a7d1-a0eb13ef9efe#/orderedItems/1560",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2325/facility-use-slots/20325#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/0b593623-572c-4b64-a7d1-a0eb13ef9efe
...
```json
{
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0b593623-572c-4b64-a7d1-a0eb13ef9efe#/orderedItems/1560-0-",
...
---
Response status code: 500 Internal Server Error. Responded in 20.581543ms.
```json
{
  "@context": "https://openactive.io/",
