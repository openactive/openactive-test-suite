...
# customer-requested-cancellation >> patch-contains-excessive-properties-error (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 16 passed with 0 failures, 374 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 71.763915ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2334/events/20334"
}
```
...
---
Response status code: 200 OK. Responded in 62.844764ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2333/events/20333"
}
```
...
---
Response status code: 200 OK. Responded in 109.037731ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2322/facility-use-slots/20322"
}
```
...
---
Response status code: 200 OK. Responded in 99.805377ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2321/facility-use-slots/20321"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2334%2Fevents%2F20334?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1160.07661ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2334/events/20334",
  "modified": 1625165324835,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2334/events/20334",
    "startDate": "2021-07-02T18:48:42+00:00",
    "endDate": "2021-07-02T19:48:42+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2334",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2334#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2333%2Fevents%2F20333?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1156.995192ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2333/events/20333",
  "modified": 1625165324833,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2333",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2333#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2322%2Ffacility-use-slots%2F20322?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2775.778555ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2322/facility-use-slots/20322",
  "modified": 1625165326451,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2322",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2322/facility-use-slots/20322#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 14.99,
        "priceCurrency": "GBP"
      }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2321%2Ffacility-use-slots%2F20321?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2774.526748ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2321/facility-use-slots/20321",
  "modified": 1625165326450,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2321",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2321/facility-use-slots/20321#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 14.99,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c1122a2d-fb30-4253-9ef8-9c2518e74366
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2334#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2334/events/20334"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2333#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2333/events/20333"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2322/facility-use-slots/20322#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2322/facility-use-slots/20322"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2321/facility-use-slots/20321#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2321/facility-use-slots/20321"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 806.955467ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c1122a2d-fb30-4253-9ef8-9c2518e74366",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:46+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2322"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:48:42+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2321"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:48:42+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c1122a2d-fb30-4253-9ef8-9c2518e74366
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sonia.Treutel@yahoo.com",
    "telephone": "(827) 692-1316",
    "givenName": "Homenick",
    "familyName": "Hilda",
    "identifier": "9747e9f4-3201-4a9e-ba89-5f5758cefae4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 810.146186ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:47+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c1122a2d-fb30-4253-9ef8-9c2518e74366
...
---
Response status code: 201 Created. Responded in 598.051564ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c1122a2d-fb30-4253-9ef8-9c2518e74366",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1122a2d-fb30-4253-9ef8-9c2518e74366#/orderedItems/1546",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2334#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1122a2d-fb30-4253-9ef8-9c2518e74366#/orderedItems/1547",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2334#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1122a2d-fb30-4253-9ef8-9c2518e74366#/orderedItems/1548",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2333#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1122a2d-fb30-4253-9ef8-9c2518e74366#/orderedItems/1549",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2322/facility-use-slots/20322#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1122a2d-fb30-4253-9ef8-9c2518e74366#/orderedItems/1550",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2322/facility-use-slots/20322#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1122a2d-fb30-4253-9ef8-9c2518e74366#/orderedItems/1551",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2321/facility-use-slots/20321#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/c1122a2d-fb30-4253-9ef8-9c2518e74366
...
---
Response status code: 400 Bad Request. Responded in 74.890819ms.
```json
{
  "@context": "https://openactive.io/",
