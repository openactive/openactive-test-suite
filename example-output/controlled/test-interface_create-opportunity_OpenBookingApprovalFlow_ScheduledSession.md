...
# test-interface >> create-opportunity (OpenBookingApprovalFlow >> ScheduledSession)
...
⚠️ 2 passed with 0 failures, 21 warnings and 8 suggestions 
...
---
Response status code: 200 OK. Responded in 28.018148ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2504/events/20504"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2504%2Fevents%2F20504?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 606.447514ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2504/events/20504",
  "modified": 1625165849703,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2504",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2504#/offers/0",
