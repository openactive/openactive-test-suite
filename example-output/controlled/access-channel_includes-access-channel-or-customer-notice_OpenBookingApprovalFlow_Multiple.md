[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:45:47 GMT+0000 (Coordinated Universal Time)

# access-channel >> includes-access-channel-or-customer-notice (OpenBookingApprovalFlow >> Multiple)

**Booking Flow:** OpenBookingApprovalFlow

**Opportunity Type:** Multiple

**Feature:** Access / accessChannel - Seller provided remote access (Implemented) 

**Test:**  Details about virtual location included in B response.

Online opportunities include, in the B response, either: (1). The virtual location or (2). a `customerNotice` informing that the virtual location will be shared before the booked opportunity starts.

### Running only this test

```bash
npm start -- --runInBand test/features/access/access-channel/implemented/includes-access-channel-or-customer-notice-test.js
```

---

⚠️ 14 passed with 0 failures, 249 warnings and 96 suggestions 
...
---
Response status code: 200 OK. Responded in 117.045375ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2248/events/20248"
}
```
...
---
Response status code: 200 OK. Responded in 49.872888ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2247/events/20247"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2248%2Fevents%2F20248?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 792.788473ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2248/events/20248",
  "modified": 1625165178529,
  "data": {
    "@context": [
      "https://openactive.io/",
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2248/events/20248",
    "startDate": "2021-07-02T18:46:16+00:00",
    "endDate": "2021-07-02T19:46:16+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2248",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2248#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2247%2Fevents%2F20247?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 790.52805ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2247/events/20247",
  "modified": 1625165178527,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2247",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2247#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
* ✅ matches the criteria 'TestOpportunityOnlineBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b7a331a0-ee3e-479e-93b2-41622e73d85d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2248#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2248/events/20248"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2247#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2247/events/20247"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1617.57835ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b7a331a0-ee3e-479e-93b2-41622e73d85d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:20+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2248"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2247"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b7a331a0-ee3e-479e-93b2-41622e73d85d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sydni63@yahoo.com",
    "telephone": "1-883-751-3460 x761",
    "givenName": "McGlynn",
    "familyName": "Hettie",
    "identifier": "84f98a1b-3830-47eb-8dfb-f5a14deb0e45"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 310.502147ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:21+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b7a331a0-ee3e-479e-93b2-41622e73d85d
...
---
Response status code: 201 Created. Responded in 308.50472ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b7a331a0-ee3e-479e-93b2-41622e73d85d",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b7a331a0-ee3e-479e-93b2-41622e73d85d#/orderedItems/1099",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2248#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b7a331a0-ee3e-479e-93b2-41622e73d85d#/orderedItems/1100",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2248#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b7a331a0-ee3e-479e-93b2-41622e73d85d#/orderedItems/1101",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2247#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b7a331a0-ee3e-479e-93b2-41622e73d85d/versions/603e087a-eb71-4a9a-8ad6-11db47d014fc",
  "payment": {
    "@type": "Payment",
    "identifier": "fh0AHRjGU",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;b7a331a0-ee3e-479e-93b2-41622e73d85d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/b7a331a0-ee3e-479e-93b2-41622e73d85d


---
Response status code: 200 OK. Responded in 254.595065ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619729699530&afterId=ed9412a1-1bb1-4b4c-90de-d9c6087e6126",
  "message": "Listening for UUID: 'b7a331a0-ee3e-479e-93b2-41622e73d85d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 205.65598ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;b7a331a0-ee3e-479e-93b2-41622e73d85d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/b7a331a0-ee3e-479e-93b2-41622e73d85d


---
Response status code: 200 OK. Responded in 2680.698625ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b7a331a0-ee3e-479e-93b2-41622e73d85d",
  "modified": 637607619838252900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/b7a331a0-ee3e-479e-93b2-41622e73d85d",
    "identifier": "b7a331a0-ee3e-479e-93b2-41622e73d85d",
...
---
Response status code: 200 OK. Responded in 230.273104ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619811844876&afterId=e09f5d42-fa21-4e5d-a1f4-82e2ecdf2d13",
  "message": "Listening for UUID: 'b7a331a0-ee3e-479e-93b2-41622e73d85d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/b7a331a0-ee3e-479e-93b2-41622e73d85d
...
---
Response status code: 201 Created. Responded in 364.638639ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b7a331a0-ee3e-479e-93b2-41622e73d85d",
  "identifier": "b7a331a0-ee3e-479e-93b2-41622e73d85d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1428.758849ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "b7a331a0-ee3e-479e-93b2-41622e73d85d",
  "modified": 637607619871241500
}
```
### Specs
* ✅ should return 200 on success
* ✅ should include an `accessChannel` or a `customerNotice`
