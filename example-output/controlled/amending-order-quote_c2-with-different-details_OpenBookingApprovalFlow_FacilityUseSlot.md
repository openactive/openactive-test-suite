...
# amending-order-quote >> c2-with-different-details (OpenBookingApprovalFlow >> FacilityUseSlot)
...
⚠️ 15 passed with 0 failures, 108 warnings and 12 suggestions 
...
---
Response status code: 200 OK. Responded in 60.126244ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2054/facility-use-slots/20054"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2054%2Ffacility-use-slots%2F20054?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2066.538994ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2054/facility-use-slots/20054",
  "modified": 1625164832089,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2054",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2054/facility-use-slots/20054#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b1012dca-12a4-49ea-84d9-cdc6c4ea74ae
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2054/facility-use-slots/20054#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2054/facility-use-slots/20054"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 96.174649ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b1012dca-12a4-49ea-84d9-cdc6c4ea74ae",
  "lease": {
    "@type": "Lease",
...
---
Response status code: 200 OK. Responded in 39.109023ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2057/facility-use-slots/20057"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2057%2Ffacility-use-slots%2F20057?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1527.3744040000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2057/facility-use-slots/20057",
  "modified": 1625164834098,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2057",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2057/facility-use-slots/20057#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:40:31+00:00",
    "endDate": "2021-07-02T19:40:31+00:00"
  }
}
```
### Specs
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b1012dca-12a4-49ea-84d9-cdc6c4ea74ae
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Omer.Wyman72@yahoo.com",
    "telephone": "(476) 753-3884",
    "givenName": "Cummerata",
    "familyName": "Alva",
    "identifier": "4c43e99e-53d9-4a88-8fbf-8ef50e62b208"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2057/facility-use-slots/20057#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2057/facility-use-slots/20057"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 233.528713ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b1012dca-12a4-49ea-84d9-cdc6c4ea74ae
...
---
Response status code: 201 Created. Responded in 126.585212ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b1012dca-12a4-49ea-84d9-cdc6c4ea74ae",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b1012dca-12a4-49ea-84d9-cdc6c4ea74ae#/orderedItems/328",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2057/facility-use-slots/20057#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b1012dca-12a4-49ea-84d9-cdc6c4ea74ae/versions/8acc82a3-b53c-4a9e-8c51-2c4c19a6c71a",
  "payment": {
    "@type": "Payment",
    "identifier": "fbH3uc9Bv",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;b1012dca-12a4-49ea-84d9-cdc6c4ea74ae&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/b1012dca-12a4-49ea-84d9-cdc6c4ea74ae


---
Response status code: 200 OK. Responded in 505.833044ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607616295926606&afterId=76709472-af9c-4f1b-b4d7-f751304789d3",
  "message": "Listening for UUID: 'b1012dca-12a4-49ea-84d9-cdc6c4ea74ae' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 39.16102ms.
### Specs
* ✅ should return 204 on success

## Second Attempt - C2 -> B >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;b1012dca-12a4-49ea-84d9-cdc6c4ea74ae&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/b1012dca-12a4-49ea-84d9-cdc6c4ea74ae


---
Response status code: 200 OK. Responded in 2758.789612ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b1012dca-12a4-49ea-84d9-cdc6c4ea74ae",
  "modified": 637607616346351400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/b1012dca-12a4-49ea-84d9-cdc6c4ea74ae",
    "identifier": "b1012dca-12a4-49ea-84d9-cdc6c4ea74ae",
...
---
Response status code: 200 OK. Responded in 447.827318ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b1012dca-12a4-49ea-84d9-cdc6c4ea74ae
...
---
Response status code: 201 Created. Responded in 125.142604ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b1012dca-12a4-49ea-84d9-cdc6c4ea74ae",
  "identifier": "b1012dca-12a4-49ea-84d9-cdc6c4ea74ae",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 2694.912255ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "b1012dca-12a4-49ea-84d9-cdc6c4ea74ae",
  "modified": 637607616379206100
}
```
### Specs
* ✅ should return 200 on success
