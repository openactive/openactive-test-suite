[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:58:46 GMT+0000 (Coordinated Universal Time)

# business-to-consumer-tax-calculation-net >> business-to-consumer-tax-calculation-net (OpenBookingApprovalFlow >> Multiple)

**Booking Flow:** OpenBookingApprovalFlow

**Opportunity Type:** Multiple

**Feature:** Tax / Business-to-consumer Tax Calculation (TaxNet) (Implemented) 

**Test:**  Business-to-consumer tax calculation (net)

The totals of totalPaymentTax should match the sum of the unitTaxSpecification, and the totalPaymentDue.price should equal the total of all acceptedOffer.price PLUS TotalPaymentTax.price.

### Running only this test

```bash
npm start -- --runInBand test/features/tax/business-to-consumer-tax-calculation-net/implemented/business-to-consumer-tax-calculation-net-test.js
```
...
* **Authorization:** `"Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6InJrWWlDeV9OWkVDemJ5TGpyUGFTZkEiLCJ0eXAiOiJhdCtqd3QifQ..jAzPOwvIZ-Ba5bkzO1QUt4n9hJ92CNaZeglNNzatPmnO_2UlNtQp8k2rdEsdAT6fUtpJctZl-9sAvVSDdX_7Oi-ExvcKOzbnKAx7hZ7Vn9j04IBLhfwtA3TDGCHFnw7nGn4SRDfSRH-dg4EIwzxrsIksVK23H0vv84QKu62i4Y-3bcqLtPZvNtL_egD8H8s02nsaW4h6XJ25EXQmsWqvJmdWjn5VWibTZFyu_sAxy8Szl5DlcfK8Up5DJaH-CCIAs0LqBvPIL06bQn9lPVvTmkroSTjnS0G3moK5IPDK7eDyAqqgGlqRPDHPGv5VP-qltGdC3FJlrrfb2408jPbuvg"`
...
---
Response status code: 200 OK. Responded in 199.300938ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2561/events/20561"
}
```
...
---
Response status code: 200 OK. Responded in 92.270164ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2560/events/20560"
}
```
...
---
Response status code: 200 OK. Responded in 85.541859ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2546/facility-use-slots/20546"
}
```
...
---
Response status code: 200 OK. Responded in 160.533612ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2547/facility-use-slots/20547"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2561%2Fevents%2F20561?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 625.644006ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2561/events/20561",
  "modified": 1625165971703,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2561/events/20561",
    "startDate": "2021-07-02T18:59:29+00:00",
    "endDate": "2021-07-02T19:59:29+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2561",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event Tax Net",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2561#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2560%2Fevents%2F20560?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 617.700648ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2560/events/20560",
  "modified": 1625165971696,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2560",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event Tax Net",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2560#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2546%2Ffacility-use-slots%2F20546?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1689.8444749999999ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2546/facility-use-slots/20546",
  "modified": 1625165972766,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2546",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Facility Tax Net",
      "activity": [
        {
          "@type": "Concept",
          "@id": "https://openactive.io/activity-list#c07d63a0-8eb9-4602-8bcc-23be6deb8f83",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2546/facility-use-slots/20546#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2547%2Ffacility-use-slots%2F20547?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1689.453872ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2547/facility-use-slots/20547",
  "modified": 1625165972767,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2547",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Facility Tax Net",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2547/facility-use-slots/20547#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
* ✅ matches the criteria 'TestOpportunityBookableNonFreeTaxNet' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/375259bb-b612-461a-b6ad-bd7860a753b4
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2561#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2561/events/20561"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2560#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2560/events/20560"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2546/facility-use-slots/20546#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2546/facility-use-slots/20546"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2547/facility-use-slots/20547#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2547/facility-use-slots/20547"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1144.98868ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/375259bb-b612-461a-b6ad-bd7860a753b4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:04:32+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2561"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2546"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:59:29+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2547"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:59:29+00:00",
  ...
  "seller": {
    ...
    "isOpenBookingAllowed": true,
    "legalName": "Road Runner Bookcamp Ltd",
    "taxMode": "https://openactive.io/TaxNet",
    "termsOfService": [
      {
        "@type": "PrivacyPolicy",
...
* ✅ should calculate net tax correctly
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/375259bb-b612-461a-b6ad-bd7860a753b4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Camryn_Kuhn11@hotmail.com",
    "telephone": "1-265-770-2908 x818",
    "givenName": "Lynch",
    "familyName": "Rae",
    "identifier": "1a4d657b-50ef-4232-ba92-c0247a39f1d0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2177.378167ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:04:34+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/375259bb-b612-461a-b6ad-bd7860a753b4
...
---
Response status code: 201 Created. Responded in 1877.450358ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/375259bb-b612-461a-b6ad-bd7860a753b4",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/375259bb-b612-461a-b6ad-bd7860a753b4#/orderedItems/3065",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2561#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/375259bb-b612-461a-b6ad-bd7860a753b4#/orderedItems/3066",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2561#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/375259bb-b612-461a-b6ad-bd7860a753b4#/orderedItems/3067",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2560#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/375259bb-b612-461a-b6ad-bd7860a753b4#/orderedItems/3068",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2546/facility-use-slots/20546#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/375259bb-b612-461a-b6ad-bd7860a753b4#/orderedItems/3069",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2546/facility-use-slots/20546#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/375259bb-b612-461a-b6ad-bd7860a753b4#/orderedItems/3070",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2547/facility-use-slots/20547#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/375259bb-b612-461a-b6ad-bd7860a753b4/versions/ab4aede4-11a2-417f-8ab3-92ac5781977b",
  "payment": {
    "@type": "Payment",
    "identifier": "2iuwl_E6P",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;375259bb-b612-461a-b6ad-bd7860a753b4&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/375259bb-b612-461a-b6ad-bd7860a753b4


---
Response status code: 200 OK. Responded in 18.759708ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607627704843113&afterId=3c6392d6-4569-4d81-8f55-d6811eb530c2",
  "message": "Listening for UUID: '375259bb-b612-461a-b6ad-bd7860a753b4' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 17.927307ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;375259bb-b612-461a-b6ad-bd7860a753b4&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/375259bb-b612-461a-b6ad-bd7860a753b4


---
Response status code: 200 OK. Responded in 2373.317547ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "375259bb-b612-461a-b6ad-bd7860a753b4",
  "modified": 637607627799825700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/375259bb-b612-461a-b6ad-bd7860a753b4",
    "identifier": "375259bb-b612-461a-b6ad-bd7860a753b4",
...
---
Response status code: 200 OK. Responded in 17.244807ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607627803532301&afterId=7a24c7e7-7cae-40b1-a3ed-bd1538685394",
  "message": "Listening for UUID: '375259bb-b612-461a-b6ad-bd7860a753b4' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/375259bb-b612-461a-b6ad-bd7860a753b4
...
---
Response status code: 201 Created. Responded in 975.316331ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/375259bb-b612-461a-b6ad-bd7860a753b4",
  "identifier": "375259bb-b612-461a-b6ad-bd7860a753b4",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 12.492808ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "375259bb-b612-461a-b6ad-bd7860a753b4",
  "modified": 637607627827963800
}
```
### Specs
* ✅ should return 200 on success
