[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 19:00:10 GMT+0000 (Coordinated Universal Time)

# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-incorrect-details (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 23.353665ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2566/facility-use-slots/20566"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2566%2Ffacility-use-slots%2F20566?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1995.6202990000002ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2566/facility-use-slots/20566",
  "modified": 1625166019358,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2566",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2566/facility-use-slots/20566#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T19:00:16+00:00",
    "endDate": "2021-07-02T20:00:16+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8efa88a4-37df-402f-8cd0-3243b749e9ee
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2566/facility-use-slots/20566#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2566/facility-use-slots/20566"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-6wVqVTzVSE",
    "accountId": "invalid-b_4u09L1P",
    "paymentProviderId": "invalid-JHF28H-6vW"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 79.258722ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8efa88a4-37df-402f-8cd0-3243b749e9ee
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Briana.Bins46@hotmail.com",
    "telephone": "(297) 200-8145",
    "givenName": "Bechtelar",
    "familyName": "Ara",
    "identifier": "77da4f7c-6974-4bc0-8755-9a8373400517"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-xHAvZr4YTb",
    "accountId": "invalid-FylGmW-4E_",
    "paymentProviderId": "invalid-4YmBEfFVoq"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 64.351543ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
