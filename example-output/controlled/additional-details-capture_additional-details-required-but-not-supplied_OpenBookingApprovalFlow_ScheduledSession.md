...
# additional-details-capture >> additional-details-required-but-not-supplied (OpenBookingApprovalFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 42.853944ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2319/events/20319"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2319%2Fevents%2F20319?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1507.210977ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2319/events/20319",
  "modified": 1625165297833,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2319",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2319#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/644d8bda-d551-423a-a886-d636be5cf919
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2319#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2319/events/20319"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 214.045118ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/644d8bda-d551-423a-a886-d636be5cf919",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:17+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/644d8bda-d551-423a-a886-d636be5cf919
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Vivianne_Denesik20@yahoo.com",
    "telephone": "1-648-266-9466",
    "givenName": "Strosin",
    "familyName": "Cayla",
    "identifier": "e5cdc7d4-b2f2-40e0-ac8e-95749f090b17"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 156.585241ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/644d8bda-d551-423a-a886-d636be5cf919
...
---
Response status code: 409 Conflict. Responded in 77.826576ms.
```json
{
  "@context": "https://openactive.io/",
