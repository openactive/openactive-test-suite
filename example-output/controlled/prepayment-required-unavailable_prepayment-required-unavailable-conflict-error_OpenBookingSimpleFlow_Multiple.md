[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:41:37 GMT+0000 (Coordinated Universal Time)

# prepayment-required-unavailable >> prepayment-required-unavailable-conflict-error (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 29 passed with 0 failures, 292 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 2466.608494ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2096/events/20096"
}
```
...
---
Response status code: 200 OK. Responded in 2630.4711310000002ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2098/events/20098"
}
```
...
---
Response status code: 200 OK. Responded in 2618.3388569999997ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2097/events/20097"
}
```
...
---
Response status code: 200 OK. Responded in 2432.835141ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2098/facility-use-slots/20098"
}
```
...
---
Response status code: 200 OK. Responded in 2217.965952ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2097/facility-use-slots/20097"
}
```
...
---
Response status code: 200 OK. Responded in 103.652821ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2096/facility-use-slots/20096"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2096%2Fevents%2F20096?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1822.199429ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2096/events/20096",
  "modified": 1625164909569,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2096/events/20096",
    "startDate": "2021-07-02T18:41:44+00:00",
    "endDate": "2021-07-02T19:41:44+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2096",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2096#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2098%2Fevents%2F20098?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1822.6123360000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2098/events/20098",
  "modified": 1625164909571,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2098",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2098#/offers/0",
          "allowCustomerCancellationFullRefund": true,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2097%2Fevents%2F20097?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1820.8978080000002ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2097/events/20097",
  "modified": 1625164909570,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2097",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2097#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2098%2Ffacility-use-slots%2F20098?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1239.928917ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2098/facility-use-slots/20098",
  "modified": 1625164908990,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2098",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2098/facility-use-slots/20098#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 14.99,
        "priceCurrency": "GBP"
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2097%2Ffacility-use-slots%2F20097?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1237.221674ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2097/facility-use-slots/20097",
  "modified": 1625164908988,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2097",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2097/facility-use-slots/20097#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 14.99,
        "priceCurrency": "GBP"
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2096%2Ffacility-use-slots%2F20096?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1236.059755ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2096/facility-use-slots/20096",
  "modified": 1625164908987,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2096",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2096/facility-use-slots/20096#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5db86978-1ca4-449e-8547-20aa80434fda
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2096#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2096/events/20096"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2098#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2098/events/20098"
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2097#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2097/events/20097"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2098/facility-use-slots/20098#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2098/facility-use-slots/20098"
    },
    {
      "@type": "OrderItem",
      "position": 4,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2097/facility-use-slots/20097#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2097/facility-use-slots/20097"
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2096/facility-use-slots/20096#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2096/facility-use-slots/20096"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 370.473761ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5db86978-1ca4-449e-8547-20aa80434fda",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:49+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2096"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2098"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2097"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
* ✅ OrderItem at position 2 - should not include an OpportunityIsInConflictError
* ✅ OrderItem at position 3 - should include an OpportunityIsInConflictError
* ✅ OrderItem at position 4 - should include an OpportunityIsInConflictError
* ✅ OrderItem at position 5 - should not include an OpportunityIsInConflictError
 ...
 * ⚠️ $.orderedItem[3].error[0].instance: Recommended property `instance` is missing from `OpportunityIsInConflictError`.
 ...
 * ⚠️ $.orderedItem[4].error[0].instance: Recommended property `instance` is missing from `OpportunityIsInConflictError`.
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5db86978-1ca4-449e-8547-20aa80434fda
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Albin_Hyatt@yahoo.com",
    "telephone": "(336) 663-4953",
    "givenName": "Murray",
    "familyName": "Domingo",
    "identifier": "35b64a8c-2e76-4619-8158-e5bfd2a1ed4f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 288.754168ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:51+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5db86978-1ca4-449e-8547-20aa80434fda
...
---
Response status code: 409 Conflict. Responded in 153.34605ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 409,
  "description": "The specific 'OrderItem's against which this error is emitted are not able to be booked together.: A single Order cannot contain items with prepayment Unavailable, and also items with prepayment Required., The specific 'OrderItem's against which this error is emitted are not able to be booked together.: A single Order cannot contain items with prepayment Unavailable, and also items with prepayment Required., The specific 'OrderItem's against which this error is emitted are not able to be booked together.: A single Order cannot contain items with prepayment Unavailable, and also items with prepayment Required., The specific 'OrderItem's against which this error is emitted are not able to be booked together.: A single Order cannot contain items with prepayment Unavailable, and also items with prepayment Required."
}
```
### Specs
