...
# attendee-details-capture >> attendee-details-included (OpenBookingApprovalFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 30.68674ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2463/events/20463"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2463%2Fevents%2F20463?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 755.04619ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2463/events/20463",
  "modified": 1625165738482,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2463/events/20463",
    "startDate": "2021-07-02T18:55:36+00:00",
    "endDate": "2021-07-02T19:55:36+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2463",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2463#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2463#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2463/events/20463",
      "attendee": {
        "@type": "Person",
...
---
Response status code: 200 OK. Responded in 408.554487ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:00:37+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Graham12@hotmail.com",
    "telephone": "1-234-352-4606 x2296",
    "givenName": "Jacobson",
    "familyName": "Heber",
    "identifier": "1d384057-504d-4ed0-928f-b8d2f5023f7b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 461.86005ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c
...
---
Response status code: 201 Created. Responded in 2333.256013ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c#/orderedItems/2465",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2463#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c/versions/f7a7b130-ed68-4bd1-bb64-c6314d343540",
  "payment": {
    "@type": "Payment",
    "identifier": "-nIXsTAGz",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c


---
Response status code: 200 OK. Responded in 21.032744ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607625365146145&afterId=b65357c5-e7ad-40c6-afd7-7c67168bce82",
  "message": "Listening for UUID: '2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 26.996484ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c


---
Response status code: 200 OK. Responded in 2426.384149ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c",
  "modified": 637607625413491500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c",
    "identifier": "2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c",
...
---
Response status code: 200 OK. Responded in 24.388566ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c
...
---
Response status code: 201 Created. Responded in 2840.677404ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c",
  "identifier": "2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1194.339219ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "2a3c68d3-1d31-4b4e-a188-dc44ee4f3c3c",
  "modified": 637607625464218200
}
```
### Specs
* ✅ should return 200 on success
