...
---
Response status code: 200 OK. Responded in 1991.286481ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2466/events/20466"
}
```
...
---
Response status code: 200 OK. Responded in 1944.967265ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2452/facility-use-slots/20452"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2466%2Fevents%2F20466?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 775.246688ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2466/events/20466",
  "modified": 1625165743055,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2466",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2466#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2452%2Ffacility-use-slots%2F20452?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 729.615676ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2452/facility-use-slots/20452",
  "modified": 1625165743012,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2452",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2452/facility-use-slots/20452#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3a84f039-d499-43db-bab6-5ad6262134cf
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2466#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2466/events/20466"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2452/facility-use-slots/20452#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2452/facility-use-slots/20452"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 782.415936ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3a84f039-d499-43db-bab6-5ad6262134cf",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3a84f039-d499-43db-bab6-5ad6262134cf
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Russel_Howell@hotmail.com",
    "telephone": "813.609.5479",
    "givenName": "Kihn",
    "familyName": "Eugene",
    "identifier": "e119e589-8ddc-4a74-979b-6bfdd010d682"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1199.929884ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/3a84f039-d499-43db-bab6-5ad6262134cf
...
---
Response status code: 400 Bad Request. Responded in 92.879933ms.
```json
{
  "@context": "https://openactive.io/",
