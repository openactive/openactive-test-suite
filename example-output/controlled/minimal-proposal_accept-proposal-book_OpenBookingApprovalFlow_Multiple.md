...
---
Response status code: 200 OK. Responded in 224.08758ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2055/events/20055"
}
```
...
---
Response status code: 200 OK. Responded in 106.585808ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2054/events/20054"
}
```
...
---
Response status code: 200 OK. Responded in 118.848779ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2052/facility-use-slots/20052"
}
```
...
---
Response status code: 200 OK. Responded in 226.00699ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2053/facility-use-slots/20053"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2055%2Fevents%2F20055?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1650.902227ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2055/events/20055",
  "modified": 1625164824836,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2055/events/20055",
    "startDate": "2021-07-02T18:40:22+00:00",
    "endDate": "2021-07-02T19:40:22+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2055",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2055#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2054%2Fevents%2F20054?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1649.319818ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2054/events/20054",
  "modified": 1625164824835,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2054",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2054#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2052%2Ffacility-use-slots%2F20052?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1834.346675ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2052/facility-use-slots/20052",
  "modified": 1625164825023,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2052",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2052/facility-use-slots/20052#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2053%2Ffacility-use-slots%2F20053?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1837.223191ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2053/facility-use-slots/20053",
  "modified": 1625164825027,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2053",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2053/facility-use-slots/20053#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/76709472-af9c-4f1b-b4d7-f751304789d3
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2055#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2055/events/20055"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2054#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2054/events/20054"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2052/facility-use-slots/20052#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2052/facility-use-slots/20052"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2053/facility-use-slots/20053#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2053/facility-use-slots/20053"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 594.641794ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/76709472-af9c-4f1b-b4d7-f751304789d3",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2054"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2053"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:40:22+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/76709472-af9c-4f1b-b4d7-f751304789d3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Theodore52@hotmail.com",
    "telephone": "(572) 911-5476",
    "givenName": "Adams",
    "familyName": "Candice",
    "identifier": "a18f9fa1-0e8f-44be-9791-dc94952a3b5c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 332.259097ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/76709472-af9c-4f1b-b4d7-f751304789d3
...
---
Response status code: 201 Created. Responded in 193.676606ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/76709472-af9c-4f1b-b4d7-f751304789d3",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/76709472-af9c-4f1b-b4d7-f751304789d3#/orderedItems/308",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2055#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/76709472-af9c-4f1b-b4d7-f751304789d3#/orderedItems/309",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2055#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/76709472-af9c-4f1b-b4d7-f751304789d3#/orderedItems/310",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2054#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/76709472-af9c-4f1b-b4d7-f751304789d3#/orderedItems/311",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2052/facility-use-slots/20052#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/76709472-af9c-4f1b-b4d7-f751304789d3#/orderedItems/312",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2052/facility-use-slots/20052#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/76709472-af9c-4f1b-b4d7-f751304789d3#/orderedItems/313",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2053/facility-use-slots/20053#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/76709472-af9c-4f1b-b4d7-f751304789d3/versions/3c611f39-89ba-4d98-b1c0-58f377ea5082",
  "payment": {
    "@type": "Payment",
    "identifier": "I9506gzby",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;76709472-af9c-4f1b-b4d7-f751304789d3&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/76709472-af9c-4f1b-b4d7-f751304789d3


---
Response status code: 200 OK. Responded in 247.395312ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607616232750587&afterId=08aa50d2-e10e-480e-8457-71c8a2692c28",
  "message": "Listening for UUID: '76709472-af9c-4f1b-b4d7-f751304789d3' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 37.772916ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;76709472-af9c-4f1b-b4d7-f751304789d3&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/76709472-af9c-4f1b-b4d7-f751304789d3


---
Response status code: 200 OK. Responded in 3473.975515ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "76709472-af9c-4f1b-b4d7-f751304789d3",
  "modified": 637607616295926700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/76709472-af9c-4f1b-b4d7-f751304789d3",
    "identifier": "76709472-af9c-4f1b-b4d7-f751304789d3",
...
---
Response status code: 200 OK. Responded in 629.48504ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607616263355989&afterId=08aa50d2-e10e-480e-8457-71c8a2692c28",
  "message": "Listening for UUID: '76709472-af9c-4f1b-b4d7-f751304789d3' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/76709472-af9c-4f1b-b4d7-f751304789d3
...
---
Response status code: 201 Created. Responded in 381.396244ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/76709472-af9c-4f1b-b4d7-f751304789d3",
  "identifier": "76709472-af9c-4f1b-b4d7-f751304789d3",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 432.439032ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "76709472-af9c-4f1b-b4d7-f751304789d3",
  "modified": 637607616339645600
}
```
### Specs
* ✅ should return 200 on success
