...
# order-deletion >> order-delete-idempotent (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 501.477845ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2392/facility-use-slots/20392"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2392%2Ffacility-use-slots%2F20392?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1441.823068ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2392/facility-use-slots/20392",
  "modified": 1625165554184,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2392",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2392/facility-use-slots/20392#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:52:31+00:00",
    "endDate": "2021-07-02T19:52:31+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8db28ae5-cc89-4e53-8679-b7a767519551
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2392/facility-use-slots/20392#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2392/facility-use-slots/20392"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 461.521313ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8db28ae5-cc89-4e53-8679-b7a767519551",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:33+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2392"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:52:31+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8db28ae5-cc89-4e53-8679-b7a767519551
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tanner87@gmail.com",
    "telephone": "1-936-912-3608",
    "givenName": "Yundt",
    "familyName": "Onie",
    "identifier": "8a4ec0fc-4b17-47dd-abaf-d6e50fde09be"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 663.593415ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:34+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/8db28ae5-cc89-4e53-8679-b7a767519551
...
---
Response status code: 201 Created. Responded in 698.31162ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/8db28ae5-cc89-4e53-8679-b7a767519551",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8db28ae5-cc89-4e53-8679-b7a767519551#/orderedItems/2069",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2392/facility-use-slots/20392#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
DELETE https://localhost:5001/api/openbooking/orders/8db28ae5-cc89-4e53-8679-b7a767519551
...
---
Response status code: 204 No Content. Responded in 179.925962ms.
...
---
Response status code: 204 No Content. Responded in 28.76417ms.
### Specs
