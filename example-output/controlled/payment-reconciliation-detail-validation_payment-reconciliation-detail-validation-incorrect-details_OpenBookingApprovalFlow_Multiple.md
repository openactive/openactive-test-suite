[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 19:00:11 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 112.206997ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2585/events/20585"
}
```
...
---
Response status code: 200 OK. Responded in 166.869289ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2586/events/20586"
}
```
...
---
Response status code: 200 OK. Responded in 89.658878ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2571/facility-use-slots/20571"
}
```
...
---
Response status code: 200 OK. Responded in 114.954413ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2572/facility-use-slots/20572"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2585%2Fevents%2F20585?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 468.213794ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2585/events/20585",
  "modified": 1625166026975,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2585/events/20585",
    "startDate": "2021-07-02T19:00:25+00:00",
    "endDate": "2021-07-02T20:00:25+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2585",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2585#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2586%2Fevents%2F20586?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 467.907993ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2586/events/20586",
  "modified": 1625166026976,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2586",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2586#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2571%2Ffacility-use-slots%2F20571?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1151.539116ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2571/facility-use-slots/20571",
  "modified": 1625166027660,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2571",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2571/facility-use-slots/20571#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2572%2Ffacility-use-slots%2F20572?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1153.091118ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2572/facility-use-slots/20572",
  "modified": 1625166027662,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2572",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2572/facility-use-slots/20572#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f541ddb7-5578-4979-86e2-3e55052ac0d4
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2585#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2585/events/20585"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2586#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2586/events/20586"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2571/facility-use-slots/20571#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2571/facility-use-slots/20571"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2572/facility-use-slots/20572#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2572/facility-use-slots/20572"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-Y3r5KTX5nZ",
    "accountId": "invalid-D5y42esnk",
    "paymentProviderId": "invalid-m1YXRFrNsh"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 137.505795ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f541ddb7-5578-4979-86e2-3e55052ac0d4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lorenz58@yahoo.com",
    "telephone": "610.470.2300",
    "givenName": "Bruen",
    "familyName": "Leonardo",
    "identifier": "96e1839a-c03b-4d11-9ab0-2eb748a15126"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-p0twN836VI",
    "accountId": "invalid-Ou8V33S5QS",
    "paymentProviderId": "invalid-BSJKNWVs0y"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 129.918479ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
