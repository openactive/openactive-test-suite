...
---
Response status code: 200 OK. Responded in 31.058066ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2567/facility-use-slots/20567"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2567%2Ffacility-use-slots%2F20567?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1034.582513ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2567/facility-use-slots/20567",
  "modified": 1625166020675,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2567",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2567/facility-use-slots/20567#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d87bc033-f4f0-4671-a547-3784db34a886
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2567/facility-use-slots/20567#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2567/facility-use-slots/20567"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1064.660473ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d87bc033-f4f0-4671-a547-3784db34a886",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d87bc033-f4f0-4671-a547-3784db34a886
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "e928c908-842f-451e-8b68-82e18c45a4c0",
...
---
Response status code: 200 OK. Responded in 536.474958ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:05:21+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/d87bc033-f4f0-4671-a547-3784db34a886
...
---
Response status code: 201 Created. Responded in 622.542117ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/d87bc033-f4f0-4671-a547-3784db34a886",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d87bc033-f4f0-4671-a547-3784db34a886#/orderedItems/3169",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2567/facility-use-slots/20567#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/d87bc033-f4f0-4671-a547-3784db34a886/versions/72593b2e-1493-4be1-8ab8-77db07c97c27",
  "payment": {
    "@type": "Payment",
    "identifier": "MjTrfdAiK",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;d87bc033-f4f0-4671-a547-3784db34a886&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/d87bc033-f4f0-4671-a547-3784db34a886


---
Response status code: 200 OK. Responded in 5.016127ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'd87bc033-f4f0-4671-a547-3784db34a886' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 42.918828ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;d87bc033-f4f0-4671-a547-3784db34a886&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/d87bc033-f4f0-4671-a547-3784db34a886


---
Response status code: 200 OK. Responded in 2384.772307ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "d87bc033-f4f0-4671-a547-3784db34a886",
  "modified": 637607628225106700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/d87bc033-f4f0-4671-a547-3784db34a886",
    "identifier": "d87bc033-f4f0-4671-a547-3784db34a886",
...
---
Response status code: 200 OK. Responded in 4.827526ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d87bc033-f4f0-4671-a547-3784db34a886
...
---
Response status code: 201 Created. Responded in 292.920461ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d87bc033-f4f0-4671-a547-3784db34a886",
  "identifier": "d87bc033-f4f0-4671-a547-3784db34a886",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1491.96521ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "d87bc033-f4f0-4671-a547-3784db34a886",
  "modified": 637607628249915900
}
```
### Specs
* ✅ should return 200 on success
