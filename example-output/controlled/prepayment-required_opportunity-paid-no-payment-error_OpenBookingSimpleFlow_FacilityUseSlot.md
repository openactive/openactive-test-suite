...
---
Response status code: 200 OK. Responded in 912.276152ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2474/facility-use-slots/20474"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2474%2Ffacility-use-slots%2F20474?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 908.949032ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2474/facility-use-slots/20474",
  "modified": 1625165809313,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2474",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2474/facility-use-slots/20474#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3c083031-55e9-4b37-a684-2dd30d96e0e3
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2474/facility-use-slots/20474#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2474/facility-use-slots/20474"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1423.763209ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3c083031-55e9-4b37-a684-2dd30d96e0e3",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:01:49+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3c083031-55e9-4b37-a684-2dd30d96e0e3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Frederick89@yahoo.com",
    "telephone": "817.341.3291 x342",
    "givenName": "Flatley",
    "familyName": "Alana",
    "identifier": "0899ee4f-66f5-4dc9-9fee-9404472f17dc"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 705.209516ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3c083031-55e9-4b37-a684-2dd30d96e0e3
...
---
Response status code: 400 Bad Request. Responded in 58.46615ms.
```json
{
  "@context": "https://openactive.io/",
