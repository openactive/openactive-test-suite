...
---
Response status code: 200 OK. Responded in 59.353016ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2581/events/20581"
}
```
...
---
Response status code: 200 OK. Responded in 144.915672ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2582/events/20582"
}
```
...
---
Response status code: 200 OK. Responded in 97.103217ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2569/facility-use-slots/20569"
}
```
...
---
Response status code: 200 OK. Responded in 64.417743ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2568/facility-use-slots/20568"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2581%2Fevents%2F20581?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 723.658255ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2581/events/20581",
  "modified": 1625166020534,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2581/events/20581",
    "startDate": "2021-07-02T19:00:18+00:00",
    "endDate": "2021-07-02T20:00:18+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2581",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2581#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2582%2Fevents%2F20582?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 722.845251ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2582/events/20582",
  "modified": 1625166020535,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2582",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2582#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 14.99,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2569%2Ffacility-use-slots%2F20569?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 867.701924ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2569/facility-use-slots/20569",
  "modified": 1625166020683,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2569",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2569/facility-use-slots/20569#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 14.99,
        "priceCurrency": "GBP"
      }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2568%2Ffacility-use-slots%2F20568?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 860.218083ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2568/facility-use-slots/20568",
  "modified": 1625166020676,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2568",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2568/facility-use-slots/20568#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e02bb63c-eb9c-490f-a42a-1b0decf04aee
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2581#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2581/events/20581"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2582#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2582/events/20582"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2569/facility-use-slots/20569#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2569/facility-use-slots/20569"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2568/facility-use-slots/20568#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2568/facility-use-slots/20568"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-2sm49Q3f6G",
    "accountId": "invalid-a6fJHqEXs",
    "paymentProviderId": "invalid-ZeQzhZA_n2"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 1307.022764ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e02bb63c-eb9c-490f-a42a-1b0decf04aee
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Vicky_Gerlach@yahoo.com",
    "telephone": "677.866.9209",
    "givenName": "Price",
    "familyName": "Emilie",
    "identifier": "e01a77cb-ab54-4351-aba0-3d673d7f5fa7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-SUJKITRBjm",
    "accountId": "invalid-8iPZuB-b6",
    "paymentProviderId": "invalid-dDf3wHLu53"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 522.196482ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
