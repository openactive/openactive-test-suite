...
⚠️ 29 passed with 0 failures, 114 warnings and 30 suggestions 
...
---
Response status code: 200 OK. Responded in 65.819784ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2175/events/20175"
}
```
...
---
Response status code: 200 OK. Responded in 71.349417ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2176/events/20176"
}
```
...
---
Response status code: 200 OK. Responded in 94.085749ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 79.348263ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2175%2Fevents%2F20175?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1201.537411ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2175/events/20175",
  "modified": 1625165088447,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2175/events/20175",
    "startDate": "2021-07-02T18:44:46+00:00",
    "endDate": "2021-07-02T19:44:46+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2175",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2175#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2176%2Fevents%2F20176?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1201.822513ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2176/events/20176",
  "modified": 1625165088449,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2176",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2176#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
---
Response status code: 200 OK. Responded in 1704.772149ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2168/facility-use-slots/20168",
  "modified": 1625165088952,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 1702.723236ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2167/facility-use-slots/20167",
  "modified": 1625165088951,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/01e5b86b-8a17-433f-ba66-0d35e91c5bd1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2175/events/20175"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2176#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2176/events/20176"
    },
    {
      "@type": "OrderItem",
      "position": 3,
...
---
Response status code: 409 Conflict. Responded in 260.323601ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/01e5b86b-8a17-433f-ba66-0d35e91c5bd1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:49+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2176"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2167"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:44:46+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/01e5b86b-8a17-433f-ba66-0d35e91c5bd1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Olga.Koepp@yahoo.com",
    "telephone": "1-983-494-9221 x67406",
    "givenName": "Stroman",
    "familyName": "Maria",
    "identifier": "12971a77-f857-4787-88a6-f85d1ede85d6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 259.021384ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/01e5b86b-8a17-433f-ba66-0d35e91c5bd1
...
---
Response status code: 409 Conflict. Responded in 132.00172ms.
```json
{
  "@context": "https://openactive.io/",
