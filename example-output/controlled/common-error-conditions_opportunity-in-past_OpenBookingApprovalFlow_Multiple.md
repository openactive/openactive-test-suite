...
---
Response status code: 200 OK. Responded in 91.456862ms.
```json
{
...
---
Response status code: 200 OK. Responded in 150.74195ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2230/events/20230"
}
```
...
---
Response status code: 200 OK. Responded in 231.969293ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2223/facility-use-slots/20223"
}
```
...
---
Response status code: 200 OK. Responded in 99.278952ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 1085.968005ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2229/events/20229",
  "modified": 1625165156686,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2229/events/20229",
    "startDate": "2021-06-30T18:45:54+00:00",
    "endDate": "2021-06-30T19:45:54+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2230%2Fevents%2F20230?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1086.199708ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2230/events/20230",
  "modified": 1625165156688,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2230/events/20230",
    "startDate": "2021-07-02T18:45:54+00:00",
    "endDate": "2021-07-02T19:45:54+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2230",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2230#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2223%2Ffacility-use-slots%2F20223?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3792.647023ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2223/facility-use-slots/20223",
  "modified": 1625165159395,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2223",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2223/facility-use-slots/20223#/offers/0",
...
---
Response status code: 200 OK. Responded in 3791.514709ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2222/facility-use-slots/20222",
  "modified": 1625165159394,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cdf0173c-7035-4837-8a18-0d4915c49214
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2230#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2230/events/20230"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2223/facility-use-slots/20223#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2223/facility-use-slots/20223"
    },
    {
      "@type": "OrderItem",
      "position": 4,
...
---
Response status code: 409 Conflict. Responded in 554.593438ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cdf0173c-7035-4837-8a18-0d4915c49214",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2230"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2223"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-06-30T18:45:54+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cdf0173c-7035-4837-8a18-0d4915c49214
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Zola.Koss@hotmail.com",
    "telephone": "956-713-4040 x435",
    "givenName": "O'Conner",
    "familyName": "Jack",
    "identifier": "cef21cee-0bf0-4298-abb9-b2424e8dfea9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 545.784452ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:01+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/cdf0173c-7035-4837-8a18-0d4915c49214
...
---
Response status code: 409 Conflict. Responded in 156.075421ms.
```json
{
  "@context": "https://openactive.io/",
