[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:53:02 GMT+0000 (Coordinated Universal Time)

# cancellation-window >> succeed-within-window (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 16 passed with 0 failures, 372 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 516.812547ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2423/events/20423"
}
```
...
---
Response status code: 200 OK. Responded in 486.81567ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2422/events/20422"
}
```
...
---
Response status code: 200 OK. Responded in 376.341119ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2411/facility-use-slots/20411"
}
```
...
---
Response status code: 200 OK. Responded in 320.288588ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2410/facility-use-slots/20410"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2423%2Fevents%2F20423?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1529.311416ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2423/events/20423",
  "modified": 1625165598465,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2423/events/20423",
    "startDate": "2021-07-02T18:53:15+00:00",
    "endDate": "2021-07-02T19:53:15+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2423",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Event Within Cancellation Window",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2423#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "PT4H",
          "price": 14.99,
          "priceCurrency": "GBP"
        }
      ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2422%2Fevents%2F20422?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1521.6882719999999ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2422/events/20422",
  "modified": 1625165598464,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2422",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2422#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 14.99,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2411%2Ffacility-use-slots%2F20411?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2725.186068ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2411/facility-use-slots/20411",
  "modified": 1625165599665,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2411",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Paid Facility Within Cancellation Window",
      "activity": [
        {
          "@type": "Concept",
          "@id": "https://openactive.io/activity-list#c07d63a0-8eb9-4602-8bcc-23be6deb8f83",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2411/facility-use-slots/20411#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "PT4H",
        "price": 14.99,
        "priceCurrency": "GBP"
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2410%2Ffacility-use-slots%2F20410?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2718.776929ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2410/facility-use-slots/20410",
  "modified": 1625165599663,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2410",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2410/facility-use-slots/20410#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 14.99,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/557f0dc5-d8f8-467b-a200-2b5b5de10793
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2423#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2423/events/20423"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2422#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2422/events/20422"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2411/facility-use-slots/20411#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2411/facility-use-slots/20411"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2410/facility-use-slots/20410#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2410/facility-use-slots/20410"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1775.407067ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/557f0dc5-d8f8-467b-a200-2b5b5de10793",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:20+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2423"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2422"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2411"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:53:15+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2410"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:53:15+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/557f0dc5-d8f8-467b-a200-2b5b5de10793
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Korey.Swift@gmail.com",
    "telephone": "278.765.8608",
    "givenName": "Bernhard",
    "familyName": "Kaitlin",
    "identifier": "66ea9ba7-ba64-4a8f-8a67-d67ddedaaa14"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2364.543426ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:23+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/557f0dc5-d8f8-467b-a200-2b5b5de10793
...
---
Response status code: 201 Created. Responded in 8903.547727ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/557f0dc5-d8f8-467b-a200-2b5b5de10793",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/557f0dc5-d8f8-467b-a200-2b5b5de10793#/orderedItems/2195",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2423#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/557f0dc5-d8f8-467b-a200-2b5b5de10793#/orderedItems/2196",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2423#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/557f0dc5-d8f8-467b-a200-2b5b5de10793#/orderedItems/2197",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2422#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/557f0dc5-d8f8-467b-a200-2b5b5de10793#/orderedItems/2198",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2411/facility-use-slots/20411#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/557f0dc5-d8f8-467b-a200-2b5b5de10793#/orderedItems/2199",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2411/facility-use-slots/20411#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/557f0dc5-d8f8-467b-a200-2b5b5de10793#/orderedItems/2200",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2410/facility-use-slots/20410#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/557f0dc5-d8f8-467b-a200-2b5b5de10793
...
---
Response status code: 204 No Content. Responded in 229.402934ms.
### Specs
