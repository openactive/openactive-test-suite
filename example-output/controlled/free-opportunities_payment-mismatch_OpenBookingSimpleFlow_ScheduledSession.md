...
# free-opportunities >> payment-mismatch (OpenBookingSimpleFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 150.268864ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2432/events/20432"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2432%2Fevents%2F20432?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1888.9659550000001ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2432/events/20432",
  "modified": 1625165633018,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2432/events/20432",
    "startDate": "2021-07-02T18:53:50+00:00",
    "endDate": "2021-07-02T19:53:50+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2432",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2432#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/70d04bd8-a4e3-478d-9d9c-8d685f92c42a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2432#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2432/events/20432"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 695.922799ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/70d04bd8-a4e3-478d-9d9c-8d685f92c42a",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2432"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/70d04bd8-a4e3-478d-9d9c-8d685f92c42a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ima98@yahoo.com",
    "telephone": "835-242-8592 x459",
    "givenName": "Howe",
    "familyName": "Leo",
    "identifier": "66840f80-f7c7-4df0-b4f7-9320c50a6238"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 571.053878ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/70d04bd8-a4e3-478d-9d9c-8d685f92c42a
...
---
Response status code: 400 Bad Request. Responded in 74.784029ms.
```json
{
  "@context": "https://openactive.io/",
