...
# order-deletion >> order-quote-delete-idempotent (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 16 passed with 0 failures, 285 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 92.298186ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2297/events/20297"
}
```
...
---
Response status code: 200 OK. Responded in 106.196075ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2298/events/20298"
}
```
...
---
Response status code: 200 OK. Responded in 176.775124ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2284/facility-use-slots/20284"
}
```
...
---
Response status code: 200 OK. Responded in 193.191228ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2285/facility-use-slots/20285"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2297%2Fevents%2F20297?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 900.691346ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2297/events/20297",
  "modified": 1625165259260,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2297/events/20297",
    "startDate": "2021-07-02T18:47:37+00:00",
    "endDate": "2021-07-02T19:47:37+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2297",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2297#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2298%2Fevents%2F20298?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 900.554346ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2298/events/20298",
  "modified": 1625165259262,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2298",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2298#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 14.99,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2284%2Ffacility-use-slots%2F20284?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1474.083032ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2284/facility-use-slots/20284",
  "modified": 1625165259835,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2284",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2284/facility-use-slots/20284#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2285%2Ffacility-use-slots%2F20285?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1474.5930349999999ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2285/facility-use-slots/20285",
  "modified": 1625165259837,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2285",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2285/facility-use-slots/20285#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2510c8a8-f6f8-4323-ae20-d6561ff73160
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2297#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2297/events/20297"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2298#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2298/events/20298"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2284/facility-use-slots/20284#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2284/facility-use-slots/20284"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2285/facility-use-slots/20285#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2285/facility-use-slots/20285"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 367.609198ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2510c8a8-f6f8-4323-ae20-d6561ff73160",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2297"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2298"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2284"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:47:37+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2285"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:47:37+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2510c8a8-f6f8-4323-ae20-d6561ff73160
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Annamae_Brakus79@hotmail.com",
    "telephone": "590-423-0247",
    "givenName": "Larson",
    "familyName": "Bernice",
    "identifier": "1b7e3c25-21df-4c0a-b32e-c21883bbef5a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 711.878451ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:40+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
DELETE https://localhost:5001/api/openbooking/order-quotes/2510c8a8-f6f8-4323-ae20-d6561ff73160
...
---
Response status code: 204 No Content. Responded in 706.454317ms.
...
---
Response status code: 204 No Content. Responded in 46.47599ms.
### Specs
