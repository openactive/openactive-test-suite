[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 19:00:43 GMT+0000 (Coordinated Universal Time)

# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation (OpenBookingApprovalFlow >> FacilityUseSlot)
...
⚠️ 13 passed with 0 failures, 92 warnings and 10 suggestions 
...
---
Response status code: 200 OK. Responded in 37.206997ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2590/facility-use-slots/20590"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2590%2Ffacility-use-slots%2F20590?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1396.383622ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2590/facility-use-slots/20590",
  "modified": 1625166081317,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2590",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2590/facility-use-slots/20590#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T19:01:18+00:00",
    "endDate": "2021-07-02T20:01:18+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c7ed07cb-c232-44f6-8e07-d0aca0c91d5a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2590/facility-use-slots/20590#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2590/facility-use-slots/20590"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 307.647935ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c7ed07cb-c232-44f6-8e07-d0aca0c91d5a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:06:20+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2590"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T19:01:18+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c7ed07cb-c232-44f6-8e07-d0aca0c91d5a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Maud_Kemmer@yahoo.com",
    "telephone": "820-615-6464 x32169",
    "givenName": "Bergstrom",
    "familyName": "Juvenal",
    "identifier": "572dc2a4-6f97-4fd1-9fca-06375b609cc4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 551.418031ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/c7ed07cb-c232-44f6-8e07-d0aca0c91d5a
...
---
Response status code: 201 Created. Responded in 449.49709ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/c7ed07cb-c232-44f6-8e07-d0aca0c91d5a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c7ed07cb-c232-44f6-8e07-d0aca0c91d5a#/orderedItems/3262",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2590/facility-use-slots/20590#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/c7ed07cb-c232-44f6-8e07-d0aca0c91d5a/versions/aa5783a0-e124-4ffc-a66d-522c8fda1104",
  "payment": {
    "@type": "Payment",
    "identifier": "clZ7n755d",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;c7ed07cb-c232-44f6-8e07-d0aca0c91d5a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/c7ed07cb-c232-44f6-8e07-d0aca0c91d5a


---
Response status code: 200 OK. Responded in 5.419329ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607628767180064&afterId=9f64eee1-5946-4c85-a087-1acf72dfdd7f",
  "message": "Listening for UUID: 'c7ed07cb-c232-44f6-8e07-d0aca0c91d5a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 26.23564ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;c7ed07cb-c232-44f6-8e07-d0aca0c91d5a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/c7ed07cb-c232-44f6-8e07-d0aca0c91d5a


---
Response status code: 200 OK. Responded in 2224.629074ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c7ed07cb-c232-44f6-8e07-d0aca0c91d5a",
  "modified": 637607628823890200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/c7ed07cb-c232-44f6-8e07-d0aca0c91d5a",
    "identifier": "c7ed07cb-c232-44f6-8e07-d0aca0c91d5a",
...
---
Response status code: 200 OK. Responded in 17.606285ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607628823890133&afterId=c7ed07cb-c232-44f6-8e07-d0aca0c91d5a",
  "message": "Listening for UUID: 'c7ed07cb-c232-44f6-8e07-d0aca0c91d5a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/c7ed07cb-c232-44f6-8e07-d0aca0c91d5a
...
---
Response status code: 201 Created. Responded in 147.598318ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c7ed07cb-c232-44f6-8e07-d0aca0c91d5a",
  "identifier": "c7ed07cb-c232-44f6-8e07-d0aca0c91d5a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1664.704992ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "c7ed07cb-c232-44f6-8e07-d0aca0c91d5a",
  "modified": 637607628847033000
}
```
### Specs
* ✅ should return 200 on success
