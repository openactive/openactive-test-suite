...
# prepayment-required >> payment-mismatch (OpenBookingSimpleFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 52.525694ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2457/events/20457"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2457%2Fevents%2F20457?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 346.360648ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2457/events/20457",
  "modified": 1625165723443,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2457/events/20457",
    "startDate": "2021-07-02T18:55:22+00:00",
    "endDate": "2021-07-02T19:55:22+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2457",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2457#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d43d4bc5-8d0f-46e8-83ff-96071cb2e8e4
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2457#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2457/events/20457"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 488.001525ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d43d4bc5-8d0f-46e8-83ff-96071cb2e8e4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:00:22+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d43d4bc5-8d0f-46e8-83ff-96071cb2e8e4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Madeline79@hotmail.com",
    "telephone": "(493) 460-0533",
    "givenName": "Konopelski",
    "familyName": "Richmond",
    "identifier": "a16b7056-4a55-4b94-b199-61f0884feeaf"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 340.101696ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d43d4bc5-8d0f-46e8-83ff-96071cb2e8e4
...
---
Response status code: 400 Bad Request. Responded in 40.806612ms.
```json
{
  "@context": "https://openactive.io/",
