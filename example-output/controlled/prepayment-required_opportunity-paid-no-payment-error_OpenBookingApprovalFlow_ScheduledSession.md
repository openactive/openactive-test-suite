...
---
Response status code: 200 OK. Responded in 144.161062ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2491/events/20491"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2491%2Fevents%2F20491?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 811.459151ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2491/events/20491",
  "modified": 1625165817287,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2491/events/20491",
    "startDate": "2021-07-02T18:56:55+00:00",
    "endDate": "2021-07-02T19:56:55+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2491",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2491#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1e19b054-20e5-4fa5-965f-0a2b96516a6f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2491#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2491/events/20491"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 642.38004ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1e19b054-20e5-4fa5-965f-0a2b96516a6f",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1e19b054-20e5-4fa5-965f-0a2b96516a6f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bella_Wisoky@hotmail.com",
    "telephone": "1-609-433-3400 x8319",
    "givenName": "Wisozk",
    "familyName": "Aliyah",
    "identifier": "f820b0c2-f4fc-486d-abe5-c78668c52e45"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 762.71896ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/1e19b054-20e5-4fa5-965f-0a2b96516a6f
...
---
Response status code: 400 Bad Request. Responded in 79.790177ms.
```json
{
  "@context": "https://openactive.io/",
