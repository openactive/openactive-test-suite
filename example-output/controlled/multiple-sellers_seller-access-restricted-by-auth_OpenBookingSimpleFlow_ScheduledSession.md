...
⚠️ 5 passed with 0 failures, 27 warnings and 8 suggestions 
...
---
Response status code: 200 OK. Responded in 131.189596ms.
```json
{
...
---
Response status code: 200 OK. Responded in 984.908525ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2113/events/20113",
  "modified": 1625164933248,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2113/events/20113",
    "startDate": "2021-07-02T18:42:11+00:00",
    "endDate": "2021-07-02T19:42:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8f251a52-e244-40ee-b92d-d0f993d2fe9f
...
---
Response status code: 401 Unauthorized. Responded in 108.986944ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8f251a52-e244-40ee-b92d-d0f993d2fe9f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Elisa32@yahoo.com",
    "telephone": "661-519-4997 x3883",
    "givenName": "Renner",
    "familyName": "Pinkie",
    "identifier": "8caf045b-6c39-4294-a12e-1855d03e771e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 401 Unauthorized. Responded in 31.314414ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/8f251a52-e244-40ee-b92d-d0f993d2fe9f
...
---
Response status code: 401 Unauthorized. Responded in 23.096258ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
