[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:49:42 GMT+0000 (Coordinated Universal Time)
...
⚠️ 21 passed with 0 failures, 475 warnings and 126 suggestions 
...
---
Response status code: 200 OK. Responded in 226.695342ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2369/events/20369"
}
```
...
---
Response status code: 200 OK. Responded in 298.095464ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2370/events/20370"
}
```
...
---
Response status code: 200 OK. Responded in 272.434712ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2355/facility-use-slots/20355"
}
```
...
---
Response status code: 200 OK. Responded in 263.496159ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2356/facility-use-slots/20356"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2369%2Fevents%2F20369?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1152.296321ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2369/events/20369",
  "modified": 1625165425108,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2369/events/20369",
    "startDate": "2021-07-02T18:50:22+00:00",
    "endDate": "2021-07-02T19:50:22+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2369",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2369#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2370%2Fevents%2F20370?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1151.605017ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2370/events/20370",
  "modified": 1625165425109,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2370",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2370#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2355%2Ffacility-use-slots%2F20355?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2341.885262ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2355/facility-use-slots/20355",
  "modified": 1625165426300,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2355",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2355/facility-use-slots/20355#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2356%2Ffacility-use-slots%2F20356?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2341.8119619999998ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2356/facility-use-slots/20356",
  "modified": 1625165426301,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2356",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2356/facility-use-slots/20356#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cd798f64-07ef-4e1d-96b3-d19deefa919a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2369#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2369/events/20369"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2370#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2370/events/20370"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2355/facility-use-slots/20355#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2355/facility-use-slots/20355"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2356/facility-use-slots/20356#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2356/facility-use-slots/20356"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 699.776442ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cd798f64-07ef-4e1d-96b3-d19deefa919a",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2369"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2370"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2355"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:50:22+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2356"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:50:22+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cd798f64-07ef-4e1d-96b3-d19deefa919a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Priscilla39@hotmail.com",
    "telephone": "441-693-8759",
    "givenName": "Anderson",
    "familyName": "Ressie",
    "identifier": "861edaeb-fa81-475c-a864-063fa408fcb8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 764.785027ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/cd798f64-07ef-4e1d-96b3-d19deefa919a
...
---
Response status code: 201 Created. Responded in 1975.9225959999999ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/cd798f64-07ef-4e1d-96b3-d19deefa919a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cd798f64-07ef-4e1d-96b3-d19deefa919a#/orderedItems/1827",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2369#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cd798f64-07ef-4e1d-96b3-d19deefa919a#/orderedItems/1828",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2369#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cd798f64-07ef-4e1d-96b3-d19deefa919a#/orderedItems/1829",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2370#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cd798f64-07ef-4e1d-96b3-d19deefa919a#/orderedItems/1830",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2355/facility-use-slots/20355#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cd798f64-07ef-4e1d-96b3-d19deefa919a#/orderedItems/1831",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2355/facility-use-slots/20355#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cd798f64-07ef-4e1d-96b3-d19deefa919a#/orderedItems/1832",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2356/facility-use-slots/20356#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/cd798f64-07ef-4e1d-96b3-d19deefa919a/versions/630f60f5-6fbf-43e8-bf04-4174f892d29a",
  "payment": {
    "@type": "Payment",
    "identifier": "bi8jItG7D",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;cd798f64-07ef-4e1d-96b3-d19deefa919a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/cd798f64-07ef-4e1d-96b3-d19deefa919a


---
Response status code: 200 OK. Responded in 213.566165ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'cd798f64-07ef-4e1d-96b3-d19deefa919a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 30.201579ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;cd798f64-07ef-4e1d-96b3-d19deefa919a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/cd798f64-07ef-4e1d-96b3-d19deefa919a


---
Response status code: 200 OK. Responded in 2464.621788ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "cd798f64-07ef-4e1d-96b3-d19deefa919a",
  "modified": 637607622323546100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/cd798f64-07ef-4e1d-96b3-d19deefa919a",
    "identifier": "cd798f64-07ef-4e1d-96b3-d19deefa919a",
...
---
Response status code: 200 OK. Responded in 108.657443ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/cd798f64-07ef-4e1d-96b3-d19deefa919a
...
---
Response status code: 201 Created. Responded in 552.335669ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/cd798f64-07ef-4e1d-96b3-d19deefa919a",
  "identifier": "cd798f64-07ef-4e1d-96b3-d19deefa919a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 284.034381ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "cd798f64-07ef-4e1d-96b3-d19deefa919a",
  "modified": 637607622350945900
}
```
### Specs
* ✅ should return 200 on success
