...
# prepayment-unavailable >> payment-mismatch (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 1583.818066ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2505/facility-use-slots/20505"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2505%2Ffacility-use-slots%2F20505?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1033.902392ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2505/facility-use-slots/20505",
  "modified": 1625165881961,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2505",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2505/facility-use-slots/20505#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:57:58+00:00",
    "endDate": "2021-07-02T19:57:58+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3e6db39e-ba6c-49a5-bd1b-3345f8b6a1a3
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2505/facility-use-slots/20505#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2505/facility-use-slots/20505"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 351.974904ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3e6db39e-ba6c-49a5-bd1b-3345f8b6a1a3",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:03:01+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3e6db39e-ba6c-49a5-bd1b-3345f8b6a1a3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Stan_Jacobson57@gmail.com",
    "telephone": "675.341.8344",
    "givenName": "Ernser",
    "familyName": "Rebeca",
    "identifier": "59ac8557-f9b1-4149-91bd-1ee16a6afc79"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 314.364ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3e6db39e-ba6c-49a5-bd1b-3345f8b6a1a3
...
---
Response status code: 400 Bad Request. Responded in 39.043212ms.
```json
{
  "@context": "https://openactive.io/",
