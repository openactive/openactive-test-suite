...
---
Response status code: 200 OK. Responded in 250.659673ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2343/events/20343"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2343%2Fevents%2F20343?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1636.7368179999999ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2343/events/20343",
  "modified": 1625165341776,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2343/events/20343",
    "startDate": "2021-07-02T18:48:58+00:00",
    "endDate": "2021-07-02T19:48:58+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2343",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2343#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/499ad7eb-8f88-475a-b509-b39e87208351
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2343#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2343/events/20343"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 403.763773ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/499ad7eb-8f88-475a-b509-b39e87208351",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/499ad7eb-8f88-475a-b509-b39e87208351
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jerel_Connelly24@hotmail.com",
    "telephone": "1-578-614-8944 x5227",
    "givenName": "Waelchi",
    "familyName": "Myrna",
    "identifier": "59d1d5bc-8ad0-4483-978c-d25c19d5423f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 358.004603ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/499ad7eb-8f88-475a-b509-b39e87208351
...
---
Response status code: 201 Created. Responded in 202.016287ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/499ad7eb-8f88-475a-b509-b39e87208351",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/499ad7eb-8f88-475a-b509-b39e87208351#/orderedItems/1614",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2343#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/499ad7eb-8f88-475a-b509-b39e87208351/versions/cfaa8cb3-b793-4f85-8882-1bd1af0eca49",
  "payment": {
    "@type": "Payment",
    "identifier": "U5FYsmLLA",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;499ad7eb-8f88-475a-b509-b39e87208351&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/499ad7eb-8f88-475a-b509-b39e87208351


---
Response status code: 200 OK. Responded in 180.775463ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '499ad7eb-8f88-475a-b509-b39e87208351' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 25.956053ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;499ad7eb-8f88-475a-b509-b39e87208351&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/499ad7eb-8f88-475a-b509-b39e87208351


---
Response status code: 200 OK. Responded in 2347.523995ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "499ad7eb-8f88-475a-b509-b39e87208351",
  "modified": 637607621427813000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/499ad7eb-8f88-475a-b509-b39e87208351",
    "identifier": "499ad7eb-8f88-475a-b509-b39e87208351",
...
---
Response status code: 200 OK. Responded in 171.420307ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/499ad7eb-8f88-475a-b509-b39e87208351
...
---
Response status code: 201 Created. Responded in 289.982108ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/499ad7eb-8f88-475a-b509-b39e87208351",
  "identifier": "499ad7eb-8f88-475a-b509-b39e87208351",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1740.4896939999999ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "499ad7eb-8f88-475a-b509-b39e87208351",
  "modified": 637607621455295600
}
```
### Specs
* ✅ should return 200 on success
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/499ad7eb-8f88-475a-b509-b39e87208351
...
---
Response status code: 400 Bad Request. Responded in 14.843392ms.
```json
{
  "@context": "https://openactive.io/",
