...
# attendee-details-capture >> attendee-details-not-included (OpenBookingSimpleFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 1138.777703ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2273/events/20273"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2273%2Fevents%2F20273?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2568.513328ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2273/events/20273",
  "modified": 1625165223033,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2273",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2273#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/93739c5b-1bb0-461c-86ff-ebb4c11d62df
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2273#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2273/events/20273"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 733.66735ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/93739c5b-1bb0-461c-86ff-ebb4c11d62df",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/93739c5b-1bb0-461c-86ff-ebb4c11d62df
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kenny_Mann18@yahoo.com",
    "telephone": "229.849.0810 x400",
    "givenName": "Raynor",
    "familyName": "Delilah",
    "identifier": "153e3324-a2d7-4648-becb-e2c51b5623a2"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 131.787361ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:03+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/93739c5b-1bb0-461c-86ff-ebb4c11d62df
...
---
Response status code: 409 Conflict. Responded in 79.992783ms.
```json
{
  "@context": "https://openactive.io/",
