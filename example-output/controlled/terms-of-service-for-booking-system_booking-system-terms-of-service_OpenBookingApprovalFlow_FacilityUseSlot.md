...
---
Response status code: 200 OK. Responded in 146.267115ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2288/facility-use-slots/20288"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2288%2Ffacility-use-slots%2F20288?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1739.272076ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2288/facility-use-slots/20288",
  "modified": 1625165261129,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2288",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2288/facility-use-slots/20288#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/214ba3bf-5304-4aee-ab77-a74f8d087c1d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2288/facility-use-slots/20288#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2288/facility-use-slots/20288"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 234.756768ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/214ba3bf-5304-4aee-ab77-a74f8d087c1d",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/214ba3bf-5304-4aee-ab77-a74f8d087c1d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Louisa.Daniel@yahoo.com",
    "telephone": "568.547.1361 x6744",
    "givenName": "Osinski",
    "familyName": "Lucas",
    "identifier": "0852693e-74ec-4f44-920b-827990bc7a86"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 618.147065ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/214ba3bf-5304-4aee-ab77-a74f8d087c1d
...
---
Response status code: 201 Created. Responded in 529.786713ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/214ba3bf-5304-4aee-ab77-a74f8d087c1d",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/214ba3bf-5304-4aee-ab77-a74f8d087c1d#/orderedItems/1350",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2288/facility-use-slots/20288#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/214ba3bf-5304-4aee-ab77-a74f8d087c1d/versions/e6e53de9-02fb-4ec1-a64a-8a3c1920d36c",
  "payment": {
    "@type": "Payment",
    "identifier": "LmGnAc11s",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;214ba3bf-5304-4aee-ab77-a74f8d087c1d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/214ba3bf-5304-4aee-ab77-a74f8d087c1d


---
Response status code: 200 OK. Responded in 228.327928ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607620590875575&afterId=ae5fa3d4-9363-4f4d-8324-3d6c73103c5a",
  "message": "Listening for UUID: '214ba3bf-5304-4aee-ab77-a74f8d087c1d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 26.909468ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;214ba3bf-5304-4aee-ab77-a74f8d087c1d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/214ba3bf-5304-4aee-ab77-a74f8d087c1d


---
Response status code: 200 OK. Responded in 2838.217218ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "214ba3bf-5304-4aee-ab77-a74f8d087c1d",
  "modified": 637607620627966000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/214ba3bf-5304-4aee-ab77-a74f8d087c1d",
    "identifier": "214ba3bf-5304-4aee-ab77-a74f8d087c1d",
...
---
Response status code: 200 OK. Responded in 136.270915ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/214ba3bf-5304-4aee-ab77-a74f8d087c1d
...
---
Response status code: 201 Created. Responded in 253.907232ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/214ba3bf-5304-4aee-ab77-a74f8d087c1d",
  "identifier": "214ba3bf-5304-4aee-ab77-a74f8d087c1d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1771.997595ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "214ba3bf-5304-4aee-ab77-a74f8d087c1d",
  "modified": 637607620658845400
}
```
### Specs
* ✅ should return 200 on success
