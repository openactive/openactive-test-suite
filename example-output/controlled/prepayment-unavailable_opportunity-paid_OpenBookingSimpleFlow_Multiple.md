...
⚠️ 18 passed with 0 failures, 374 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 695.441163ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2575/events/20575"
}
```
...
---
Response status code: 200 OK. Responded in 622.379492ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2574/events/20574"
}
```
...
---
Response status code: 200 OK. Responded in 651.557921ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2562/facility-use-slots/20562"
}
```
...
---
Response status code: 200 OK. Responded in 647.324875ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2563/facility-use-slots/20563"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2575%2Fevents%2F20575?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1034.528754ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2575/events/20575",
  "modified": 1625166006296,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2575/events/20575",
    "startDate": "2021-07-02T19:00:03+00:00",
    "endDate": "2021-07-02T20:00:03+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2575",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2575#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2574%2Fevents%2F20574?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1028.878926ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2574/events/20574",
  "modified": 1625166006295,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2574",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2574#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2562%2Ffacility-use-slots%2F20562?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 997.630023ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2562/facility-use-slots/20562",
  "modified": 1625166006264,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2562",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2562/facility-use-slots/20562#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 14.99,
        "priceCurrency": "GBP"
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2563%2Ffacility-use-slots%2F20563?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 998.258516ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2563/facility-use-slots/20563",
  "modified": 1625166006266,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2563",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2563/facility-use-slots/20563#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3108adb6-e8ba-4c09-aa4e-ccdc1537bbd3
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2575#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2575/events/20575"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2574#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2574/events/20574"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2562/facility-use-slots/20562#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2562/facility-use-slots/20562"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2563/facility-use-slots/20563#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2563/facility-use-slots/20563"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2491.840682ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3108adb6-e8ba-4c09-aa4e-ccdc1537bbd3",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:05:07+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2562"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T19:00:03+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2563"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T19:00:03+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3108adb6-e8ba-4c09-aa4e-ccdc1537bbd3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Gene.Ritchie43@gmail.com",
    "telephone": "1-987-982-1220 x70046",
    "givenName": "Renner",
    "familyName": "Reynold",
    "identifier": "22751225-b1cc-420f-9fa0-82f17367c350"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 3644.262205ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/3108adb6-e8ba-4c09-aa4e-ccdc1537bbd3
...
---
Response status code: 201 Created. Responded in 1363.958366ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/3108adb6-e8ba-4c09-aa4e-ccdc1537bbd3",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3108adb6-e8ba-4c09-aa4e-ccdc1537bbd3#/orderedItems/3146",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2575#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3108adb6-e8ba-4c09-aa4e-ccdc1537bbd3#/orderedItems/3147",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2575#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3108adb6-e8ba-4c09-aa4e-ccdc1537bbd3#/orderedItems/3148",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2574#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3108adb6-e8ba-4c09-aa4e-ccdc1537bbd3#/orderedItems/3149",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2562/facility-use-slots/20562#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3108adb6-e8ba-4c09-aa4e-ccdc1537bbd3#/orderedItems/3150",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2562/facility-use-slots/20562#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3108adb6-e8ba-4c09-aa4e-ccdc1537bbd3#/orderedItems/3151",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2563/facility-use-slots/20563#/offers/0",
        "allowCustomerCancellationFullRefund": true,
