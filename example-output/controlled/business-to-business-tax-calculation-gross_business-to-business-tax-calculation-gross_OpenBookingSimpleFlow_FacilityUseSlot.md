...
# business-to-business-tax-calculation-gross >> business-to-business-tax-calculation-gross (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 64.499928ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2557/facility-use-slots/20557"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2557%2Ffacility-use-slots%2F20557?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 921.027707ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2557/facility-use-slots/20557",
  "modified": 1625165986129,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2557",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2557/facility-use-slots/20557#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:59:44+00:00",
    "endDate": "2021-07-02T19:59:44+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/24c25ede-e524-4a7c-82d3-4f3a1e93c6ee
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2557/facility-use-slots/20557#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2557/facility-use-slots/20557"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1632.38753ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/24c25ede-e524-4a7c-82d3-4f3a1e93c6ee",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:04:46+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2557"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:59:44+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/24c25ede-e524-4a7c-82d3-4f3a1e93c6ee
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "c6204e2b-b4b5-4c46-8fff-5fd8ce5d9d7e",
...
---
Response status code: 200 OK. Responded in 2537.132572ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:04:49+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/24c25ede-e524-4a7c-82d3-4f3a1e93c6ee
...
---
Response status code: 201 Created. Responded in 618.654808ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/24c25ede-e524-4a7c-82d3-4f3a1e93c6ee",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/24c25ede-e524-4a7c-82d3-4f3a1e93c6ee#/orderedItems/3088",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2557/facility-use-slots/20557#/offers/0",
        "allowCustomerCancellationFullRefund": true,
