[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:42:54 GMT+0000 (Coordinated Universal Time)

# terms-of-service-for-seller >> seller-terms-of-service (OpenBookingSimpleFlow >> Multiple)
...
**Test:**  Terms of service defined by seller in opportunity feed, C1, C2 and B

Terms of service defined by seller reflected in seller fields in opportunity feed, C1, C2 and B

### Running only this test

```bash
npm start -- --runInBand test/features/terms/terms-of-service-for-seller/implemented/seller-terms-of-service-test.js
```
...
## Terms of service should be part of seller in all stages >> Fetch Opportunities
...
```json
{
  ...
  "test:testOpportunityCriteria": "https://openactive.io/test-interface#TestOpportunityBookableSellerTermsOfService",
...
---
Response status code: 200 OK. Responded in 95.545823ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2141/events/20141"
}
```
...
---
Response status code: 200 OK. Responded in 202.634649ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2142/events/20142"
}
```
...
---
Response status code: 200 OK. Responded in 131.838431ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2135/facility-use-slots/20135"
}
```
...
---
Response status code: 200 OK. Responded in 105.801626ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2134/facility-use-slots/20134"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2141%2Fevents%2F20141?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2611.373727ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2141/events/20141",
  "modified": 1625164989131,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2141/events/20141",
    "startDate": "2021-07-02T18:43:05+00:00",
    "endDate": "2021-07-02T19:43:05+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2141",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event With Seller Terms Of Service",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2141#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2142%2Fevents%2F20142?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2615.907229ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2142/events/20142",
  "modified": 1625164989142,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2142",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Event With Seller Terms Of Service",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2142#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 14.99,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2135%2Ffacility-use-slots%2F20135?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1234.849496ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2135/facility-use-slots/20135",
  "modified": 1625164987761,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      ...
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility With Seller Terms Of Service",
      "activity": [
        {
          "@type": "Concept",
          "@id": "https://openactive.io/activity-list#c07d63a0-8eb9-4602-8bcc-23be6deb8f83",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2135/facility-use-slots/20135#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 14.99,
        "priceCurrency": "GBP"
      }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2134%2Ffacility-use-slots%2F20134?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1233.559296ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2134/facility-use-slots/20134",
  "modified": 1625164987760,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2134",
      "name": "[OPEN BOOKING API TEST INTERFACE] Bookable Facility With Seller Terms Of Service",
      "activity": [
        {
          "@type": "Concept",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2134/facility-use-slots/20134#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 14.99,
        "priceCurrency": "GBP"
      }
...
* ✅ Should contain terms of service in provider/organizer in OrderItem in Opportunity feed

## Terms of service should be part of seller in all stages >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookableSellerTermsOfService' required for this test
...
## Terms of service should be part of seller in all stages >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookableSellerTermsOfService' required for this test
...
## Terms of service should be part of seller in all stages >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookableSellerTermsOfService' required for this test
...
## Terms of service should be part of seller in all stages >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookableSellerTermsOfService' required for this test
...
## Terms of service should be part of seller in all stages >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookableSellerTermsOfService' required for this test
...
## Terms of service should be part of seller in all stages >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookableSellerTermsOfService' required for this test
...
## Terms of service should be part of seller in all stages >> C1

### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2e224de9-66b2-4684-9ed6-e03cd2c3bb1d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2141#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2141/events/20141"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2142#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2142/events/20142"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2135/facility-use-slots/20135#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2135/facility-use-slots/20135"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2134/facility-use-slots/20134#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2134/facility-use-slots/20134"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 410.437199ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2e224de9-66b2-4684-9ed6-e03cd2c3bb1d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:09+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2141"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2142"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2135"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:43:05+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2134"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:43:05+00:00",
...
* ✅ Should contain terms of service array in seller in response

## Terms of service should be part of seller in all stages >> C1 >> validation of C1
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of seller in all stages >> C2

### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2e224de9-66b2-4684-9ed6-e03cd2c3bb1d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lenora_Keeling@hotmail.com",
    "telephone": "510.496.7932",
    "givenName": "Bosco",
    "familyName": "Jovany",
    "identifier": "62a04bef-9214-42a7-8558-1e0b2aba9c99"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 466.318012ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:10+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
## Terms of service should be part of seller in all stages >> C2 >> validation of C2
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of seller in all stages >> B

### B Request
PUT https://localhost:5001/api/openbooking/orders/2e224de9-66b2-4684-9ed6-e03cd2c3bb1d
...
---
Response status code: 201 Created. Responded in 269.545565ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/2e224de9-66b2-4684-9ed6-e03cd2c3bb1d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2e224de9-66b2-4684-9ed6-e03cd2c3bb1d#/orderedItems/660",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2141#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2e224de9-66b2-4684-9ed6-e03cd2c3bb1d#/orderedItems/661",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2141#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2e224de9-66b2-4684-9ed6-e03cd2c3bb1d#/orderedItems/662",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2142#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2e224de9-66b2-4684-9ed6-e03cd2c3bb1d#/orderedItems/663",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2135/facility-use-slots/20135#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2e224de9-66b2-4684-9ed6-e03cd2c3bb1d#/orderedItems/664",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2135/facility-use-slots/20135#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2e224de9-66b2-4684-9ed6-e03cd2c3bb1d#/orderedItems/665",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2134/facility-use-slots/20134#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
## Terms of service should be part of seller in all stages >> B >> validation of B
### Specs
* ✅ passes validation checks
