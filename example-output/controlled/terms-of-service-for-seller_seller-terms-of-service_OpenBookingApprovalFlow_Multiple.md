...
# terms-of-service-for-seller >> seller-terms-of-service (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 18 passed with 0 failures, 366 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 89.70565ms.
```json
{
...
---
Response status code: 200 OK. Responded in 235.729718ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
...
---
Response status code: 200 OK. Responded in 89.314748ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 93.068462ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
...
---
Response status code: 200 OK. Responded in 957.943331ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2151/events/20151",
  "modified": 1625165005891,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2151/events/20151",
    "startDate": "2021-07-02T18:43:23+00:00",
    "endDate": "2021-07-02T19:43:23+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
---
Response status code: 200 OK. Responded in 956.652425ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2152/events/20152",
  "modified": 1625165005892,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 2685.163459ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2144/facility-use-slots/20144",
  "modified": 1625165007621,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
---
Response status code: 200 OK. Responded in 2685.3693590000003ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2145/facility-use-slots/20145",
  "modified": 1625165007623,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/876bb5bb-c38c-48a7-b786-4ee14064850d
...
---
Response status code: 200 OK. Responded in 655.405852ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/876bb5bb-c38c-48a7-b786-4ee14064850d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:27+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2144"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:43:23+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/876bb5bb-c38c-48a7-b786-4ee14064850d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Domenico2@hotmail.com",
    "telephone": "638.586.0425",
    "givenName": "Heller",
    "familyName": "Brisa",
    "identifier": "74d8b373-7112-4997-941f-3a80ea3c6400"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1030.447484ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
## Terms of service should be part of seller in all stages >> P

### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/876bb5bb-c38c-48a7-b786-4ee14064850d
...
---
Response status code: 201 Created. Responded in 421.330894ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/876bb5bb-c38c-48a7-b786-4ee14064850d",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/876bb5bb-c38c-48a7-b786-4ee14064850d#/orderedItems/738",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2151#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/876bb5bb-c38c-48a7-b786-4ee14064850d#/orderedItems/739",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2151#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/876bb5bb-c38c-48a7-b786-4ee14064850d#/orderedItems/740",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2152#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/876bb5bb-c38c-48a7-b786-4ee14064850d#/orderedItems/741",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2144/facility-use-slots/20144#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/876bb5bb-c38c-48a7-b786-4ee14064850d#/orderedItems/742",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2144/facility-use-slots/20144#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/876bb5bb-c38c-48a7-b786-4ee14064850d#/orderedItems/743",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2145/facility-use-slots/20145#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/876bb5bb-c38c-48a7-b786-4ee14064850d/versions/d48f88f0-b6d8-4ae1-ac90-447ffab4fbe9",
  "payment": {
    "@type": "Payment",
    "identifier": "fjLP_0Lqh",
    "name": "AcmeBroker Points",
...
## Terms of service should be part of seller in all stages >> P >> validation of P
### Specs
* ✅ passes validation checks
