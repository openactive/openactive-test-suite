...
---
Response status code: 200 OK. Responded in 32.350334ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1949.022552ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2123/events/20123",
  "modified": 1625164948062,
  "data": {
    "@context": [
      "https://openactive.io/",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed
...
---
Response status code: 200 OK. Responded in 233.837602ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alexandrine_Mann@hotmail.com",
    "telephone": "1-372-485-3032 x99153",
    "givenName": "Kling",
    "familyName": "Violette",
    "identifier": "6f0a5541-09b5-465f-aabb-1ffc794f96d5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 518.98453ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed
...
---
Response status code: 201 Created. Responded in 573.370244ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed#/orderedItems/569",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2123#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed/versions/150d22ce-e26a-407d-a24c-83afecf04e3b",
  "payment": {
    "@type": "Payment",
    "identifier": "M53uYvqH2",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;71289125-8a8c-4bf1-b5b9-c9b787ebe3ed&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed


---
Response status code: 200 OK. Responded in 331.669069ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '71289125-8a8c-4bf1-b5b9-c9b787ebe3ed' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 17.387941ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;71289125-8a8c-4bf1-b5b9-c9b787ebe3ed&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed


---
Response status code: 200 OK. Responded in 2308.5539870000002ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "71289125-8a8c-4bf1-b5b9-c9b787ebe3ed",
  "modified": 637607617509462300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed",
    "identifier": "71289125-8a8c-4bf1-b5b9-c9b787ebe3ed",
...
---
Response status code: 200 OK. Responded in 309.316804ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed
...
---
Response status code: 201 Created. Responded in 714.738496ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed",
  "identifier": "71289125-8a8c-4bf1-b5b9-c9b787ebe3ed",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 2075.916552ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "71289125-8a8c-4bf1-b5b9-c9b787ebe3ed",
  "modified": 637607617542057500
}
```
### Specs
* ✅ should return 200 on success
...
### Orders (orders) Feed listen for &#x27;71289125-8a8c-4bf1-b5b9-c9b787ebe3ed&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed


---
Response status code: 200 OK. Responded in 353.223889ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "message": "Listening for UUID: '71289125-8a8c-4bf1-b5b9-c9b787ebe3ed' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 95.739687ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AccessChannelUpdateSimulateAction)

### Orders (orders) Feed collect for &#x27;71289125-8a8c-4bf1-b5b9-c9b787ebe3ed&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/71289125-8a8c-4bf1-b5b9-c9b787ebe3ed


---
Response status code: 200 OK. Responded in 2985.762128ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "71289125-8a8c-4bf1-b5b9-c9b787ebe3ed",
  "modified": 637607617575048000,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "orderedItem": [
      {
        ...
        "accessChannel": {
          ...
          "name": "Zoom Video Chat",
          "description": "Please log into Zoom a few minutes before the event",
          "accessCode": "3568790892",
          "accessId": "7041564738",
          "url": "http://jacklyn.info/"
        },
        "accessCode": [
          {
            "@type": "PropertyValue",
