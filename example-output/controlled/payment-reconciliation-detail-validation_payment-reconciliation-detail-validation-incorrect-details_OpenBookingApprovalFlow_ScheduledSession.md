...
# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-incorrect-details (OpenBookingApprovalFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 50.806271ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2584/events/20584"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2584%2Fevents%2F20584?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 353.594284ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2584/events/20584",
  "modified": 1625166023904,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2584/events/20584",
    "startDate": "2021-07-02T19:00:22+00:00",
    "endDate": "2021-07-02T20:00:22+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2584",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2584#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/207f54fd-21f7-4be0-a9d0-528ba2902378
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2584#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2584/events/20584"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-H6WT4unhVX",
    "accountId": "invalid-1kFxJL6bw",
    "paymentProviderId": "invalid-UHXLhvRFNu"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 357.891207ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/207f54fd-21f7-4be0-a9d0-528ba2902378
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jane53@yahoo.com",
    "telephone": "845.521.4809",
    "givenName": "Streich",
    "familyName": "Marcellus",
    "identifier": "2a1a1c48-22b1-4be8-917a-11c3dbd0c905"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-JywzBkTAUr",
    "accountId": "invalid-OKbYe7OFs",
    "paymentProviderId": "invalid-RSQ-W6MuEQ"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 82.44664ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
