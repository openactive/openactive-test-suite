...
# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-incorrect-details (OpenBookingSimpleFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 2487.5101290000002ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2579/events/20579"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2579%2Fevents%2F20579?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 396.758312ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2579/events/20579",
  "modified": 1625166015034,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2579/events/20579",
    "startDate": "2021-07-02T19:00:11+00:00",
    "endDate": "2021-07-02T20:00:11+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2579",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2579#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0078e9dd-a9cd-4df0-8730-bd9336a73364
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2579#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2579/events/20579"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-aRSWEoBfga",
    "accountId": "invalid-nkvu2jnLz",
    "paymentProviderId": "invalid-liZPqM636P"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 540.213828ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0078e9dd-a9cd-4df0-8730-bd9336a73364
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Phyllis71@gmail.com",
    "telephone": "1-680-368-4515",
    "givenName": "Schumm",
    "familyName": "Diego",
    "identifier": "7fae1c81-aaa1-472a-a92d-9c19fd42c847"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-wWMxkRvwhi",
    "accountId": "invalid-Epr5Nm2K0R",
    "paymentProviderId": "invalid-z_TV4yaiAy"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 1440.0263049999999ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
