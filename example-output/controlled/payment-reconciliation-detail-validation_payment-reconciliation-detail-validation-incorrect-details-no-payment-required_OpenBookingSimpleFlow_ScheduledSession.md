...
# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-incorrect-details-no-payment-required (OpenBookingSimpleFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 680.248189ms.
```json
{
...
---
Response status code: 200 OK. Responded in 374.107589ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2552/events/20552",
  "modified": 1625165960282,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2552/events/20552",
    "startDate": "2021-07-02T18:59:18+00:00",
    "endDate": "2021-07-02T19:59:18+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e0c3f50b-ba76-4153-8438-22131340b992
...
```json
{
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-lxlwoNLX8I",
    "accountId": "invalid-DcG1WMg4u",
    "paymentProviderId": "invalid-P965bv0txe"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 1335.026243ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e0c3f50b-ba76-4153-8438-22131340b992
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Graham.Bogisich@gmail.com",
    "telephone": "(761) 833-5910 x8092",
    "givenName": "Corwin",
    "familyName": "Addison",
    "identifier": "c6a5bad6-9118-4a13-80c8-3c63b40d76e3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-yxs2W0SttF",
    "accountId": "invalid-PbStfrI9Z",
    "paymentProviderId": "invalid-qtfbD5wxAx"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 72.676194ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
