...
---
Response status code: 200 OK. Responded in 136.256371ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2498/facility-use-slots/20498"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2498%2Ffacility-use-slots%2F20498?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1022.210684ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2498/facility-use-slots/20498",
  "modified": 1625165864640,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2498",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2498/facility-use-slots/20498#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/28e47e5e-b63a-4c22-85bc-c0a7c9e047cb
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2498/facility-use-slots/20498#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2498/facility-use-slots/20498"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 835.318326ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/28e47e5e-b63a-4c22-85bc-c0a7c9e047cb",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/28e47e5e-b63a-4c22-85bc-c0a7c9e047cb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Herminia_Stokes88@gmail.com",
    "telephone": "(781) 831-6203",
    "givenName": "Cremin",
    "familyName": "Enola",
    "identifier": "31538abf-2bac-4870-b98f-1e63628a071e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 839.857952ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/28e47e5e-b63a-4c22-85bc-c0a7c9e047cb
...
---
Response status code: 201 Created. Responded in 1298.189505ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/28e47e5e-b63a-4c22-85bc-c0a7c9e047cb",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/28e47e5e-b63a-4c22-85bc-c0a7c9e047cb#/orderedItems/2790",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2498/facility-use-slots/20498#/offers/0",
        "allowCustomerCancellationFullRefund": true,
