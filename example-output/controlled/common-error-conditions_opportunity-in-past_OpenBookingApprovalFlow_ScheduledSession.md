...
# common-error-conditions >> opportunity-in-past (OpenBookingApprovalFlow >> ScheduledSession)
...
⚠️ 9 passed with 0 failures, 58 warnings and 20 suggestions 
...
---
Response status code: 200 OK. Responded in 36.768628ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1070.220131ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2226/events/20226",
  "modified": 1625165151206,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2226/events/20226",
    "startDate": "2021-06-30T18:45:49+00:00",
    "endDate": "2021-06-30T19:45:49+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/149ad8d4-4b31-476e-802f-4029d75d1c81
...
---
Response status code: 409 Conflict. Responded in 101.430803ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/149ad8d4-4b31-476e-802f-4029d75d1c81",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:50+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/149ad8d4-4b31-476e-802f-4029d75d1c81
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Eugenia.Wyman52@yahoo.com",
    "telephone": "960-802-1165 x36277",
    "givenName": "Keeling",
    "familyName": "Otilia",
    "identifier": "27bdf08f-e99b-4180-9562-74516034e4c5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 246.125792ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:51+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/149ad8d4-4b31-476e-802f-4029d75d1c81
...
---
Response status code: 409 Conflict. Responded in 54.97259ms.
```json
{
  "@context": "https://openactive.io/",
