...
---
Response status code: 200 OK. Responded in 54.579809ms.
```json
{
...
---
Response status code: 200 OK. Responded in 1042.034869ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2105/events/20105"
}
```
...
---
Response status code: 200 OK. Responded in 426.591175ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2104/events/20104",
    "startDate": "2021-07-02T18:41:52+00:00",
    "endDate": "2021-07-02T19:41:52+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2105%2Fevents%2F20105?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2064.642073ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2105/events/20105",
  "modified": 1625164916298,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2105",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2105#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4840a80c-9c8d-4073-b1f8-26feefc10a0a
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2105#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2105/events/20105"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 77.050182ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4840a80c-9c8d-4073-b1f8-26feefc10a0a",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/2104"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4840a80c-9c8d-4073-b1f8-26feefc10a0a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kaycee_Hammes@hotmail.com",
    "telephone": "233.378.0084 x1272",
    "givenName": "Stanton",
    "familyName": "Bo",
    "identifier": "ff2132ac-d3bf-4363-9bfb-8bb3db3a5472"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 73.593151ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:56+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/4840a80c-9c8d-4073-b1f8-26feefc10a0a
...
---
Response status code: 409 Conflict. Responded in 37.29283ms.
```json
{
  "@context": "https://openactive.io/",
