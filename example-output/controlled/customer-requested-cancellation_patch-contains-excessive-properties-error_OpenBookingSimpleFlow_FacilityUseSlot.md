...
# customer-requested-cancellation >> patch-contains-excessive-properties-error (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 57.441789ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2318/facility-use-slots/20318"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2318%2Ffacility-use-slots%2F20318?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1902.572872ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2318/facility-use-slots/20318",
  "modified": 1625165321164,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2318",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2318/facility-use-slots/20318#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:48:38+00:00",
    "endDate": "2021-07-02T19:48:38+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bade74f9-b40a-45e9-8f64-fae235f538ad
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2318/facility-use-slots/20318#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2318/facility-use-slots/20318"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 214.04413ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bade74f9-b40a-45e9-8f64-fae235f538ad",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:40+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2318"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:48:38+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bade74f9-b40a-45e9-8f64-fae235f538ad
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Davon84@yahoo.com",
    "telephone": "1-745-432-1358 x0648",
    "givenName": "Thompson",
    "familyName": "Kayleigh",
    "identifier": "a26c3997-03b7-4849-b44d-b49e993b4814"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 219.24456ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/bade74f9-b40a-45e9-8f64-fae235f538ad
...
---
Response status code: 201 Created. Responded in 340.02036ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/bade74f9-b40a-45e9-8f64-fae235f538ad",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bade74f9-b40a-45e9-8f64-fae235f538ad#/orderedItems/1524",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2318/facility-use-slots/20318#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/bade74f9-b40a-45e9-8f64-fae235f538ad
...
---
Response status code: 400 Bad Request. Responded in 31.666083ms.
```json
{
  "@context": "https://openactive.io/",
