...
# prepayment-unavailable >> payment-mismatch (OpenBookingSimpleFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 550.166885ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2517/events/20517"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2517%2Fevents%2F20517?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 529.939997ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2517/events/20517",
  "modified": 1625165875650,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2517/events/20517",
    "startDate": "2021-07-02T18:57:53+00:00",
    "endDate": "2021-07-02T19:57:53+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2517",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2517#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ab86fdab-43c0-4fe6-baf5-f8fdfaeaaa0c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2517#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2517/events/20517"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1984.904436ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ab86fdab-43c0-4fe6-baf5-f8fdfaeaaa0c",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ab86fdab-43c0-4fe6-baf5-f8fdfaeaaa0c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Claude.Quigley48@hotmail.com",
    "telephone": "409.822.0331 x0375",
    "givenName": "Ruecker",
    "familyName": "Jany",
    "identifier": "13d4bb82-4d44-4476-9039-fc0abf49cfbe"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 474.896268ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ab86fdab-43c0-4fe6-baf5-f8fdfaeaaa0c
...
---
Response status code: 400 Bad Request. Responded in 58.044014ms.
```json
{
  "@context": "https://openactive.io/",
