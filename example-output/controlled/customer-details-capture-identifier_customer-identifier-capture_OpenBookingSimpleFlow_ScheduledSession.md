...
# customer-details-capture-identifier >> customer-identifier-capture (OpenBookingSimpleFlow >> ScheduledSession)
...
⚠️ 7 passed with 0 failures, 73 warnings and 26 suggestions 
...
---
Response status code: 200 OK. Responded in 355.545804ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2356/events/20356"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2356%2Fevents%2F20356?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1514.660961ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2356/events/20356",
  "modified": 1625165385371,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2356/events/20356",
    "startDate": "2021-07-02T18:49:42+00:00",
    "endDate": "2021-07-02T19:49:42+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2356",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2356#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bda20a6f-5d6f-40e9-bc18-5609657c8ca7
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2356#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2356/events/20356"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 201.541893ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bda20a6f-5d6f-40e9-bc18-5609657c8ca7",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:44+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bda20a6f-5d6f-40e9-bc18-5609657c8ca7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Harvey15@yahoo.com",
    "telephone": "543-786-1883 x154",
    "givenName": "Schinner",
    "familyName": "Jackson",
    "identifier": "9f830fa3-9636-4266-b423-52d9f8a2cae2"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 319.510391ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:45+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/bda20a6f-5d6f-40e9-bc18-5609657c8ca7
...
---
Response status code: 201 Created. Responded in 198.112672ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/bda20a6f-5d6f-40e9-bc18-5609657c8ca7",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bda20a6f-5d6f-40e9-bc18-5609657c8ca7#/orderedItems/1713",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2356#/offers/0",
        "allowCustomerCancellationFullRefund": true,
