...
---
Response status code: 200 OK. Responded in 53.861797ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2258/facility-use-slots/20258"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2258%2Ffacility-use-slots%2F20258?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 1972.510262ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2258/facility-use-slots/20258",
  "modified": 1625165218192,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2258",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2258/facility-use-slots/20258#/offers/0",
    ...
    "remainingUses": 10,
    "startDate": "2021-07-02T18:46:55+00:00",
    "endDate": "2021-07-02T19:46:55+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3946c8d5-9daf-415c-86b3-25ba271b9eef
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2258/facility-use-slots/20258#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2258/facility-use-slots/20258"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 182.148281ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3946c8d5-9daf-415c-86b3-25ba271b9eef",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3946c8d5-9daf-415c-86b3-25ba271b9eef
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Paige_Jacobs@yahoo.com",
    "telephone": "(818) 344-6521",
    "givenName": "Paucek",
    "familyName": "Jerad",
    "identifier": "3a3ba239-1ada-46ac-abaf-8afc3f30c152"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 88.956448ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/3946c8d5-9daf-415c-86b3-25ba271b9eef
...
---
Response status code: 409 Conflict. Responded in 115.29034ms.
```json
{
  "@context": "https://openactive.io/",
