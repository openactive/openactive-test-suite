...
⚠️ 15 passed with 0 failures, 372 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 896.757929ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2514/events/20514"
}
```
...
---
Response status code: 200 OK. Responded in 937.410857ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2515/events/20515"
}
```
...
---
Response status code: 200 OK. Responded in 191.652975ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2501/facility-use-slots/20501"
}
```
...
---
Response status code: 200 OK. Responded in 198.634514ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2502/facility-use-slots/20502"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2514%2Fevents%2F20514?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 333.350769ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2514/events/20514",
  "modified": 1625165869204,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/2514/events/20514",
    "startDate": "2021-07-02T18:57:47+00:00",
    "endDate": "2021-07-02T19:57:47+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2514",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2514#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F2515%2Fevents%2F20515?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 990.124553ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/scheduled-sessions/2515/events/20515",
  "modified": 1625165869858,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/2515",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/2515#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 14.99,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2501%2Ffacility-use-slots%2F20501?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 49.430277ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2501",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2501/facility-use-slots/20501#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingIntakeForm"
        ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2502%2Ffacility-use-slots%2F20502?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 49.028975ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2502",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2502/facility-use-slots/20502#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 14.99,
        "priceCurrency": "GBP"
      }
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/59b269d2-29c2-4914-b86a-8bd5deff595e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2514#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2514/events/20514"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/2515#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/2515/events/20515"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2501/facility-use-slots/20501#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2501/facility-use-slots/20501"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2502/facility-use-slots/20502#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2502/facility-use-slots/20502"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 4129.249957ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/59b269d2-29c2-4914-b86a-8bd5deff595e",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:53+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/59b269d2-29c2-4914-b86a-8bd5deff595e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jacinthe77@yahoo.com",
    "telephone": "(663) 473-2568",
    "givenName": "Hessel",
    "familyName": "Rebekah",
    "identifier": "67bddffe-cbc9-498c-820e-f3bac9266a10"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1823.411862ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:02:56+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/59b269d2-29c2-4914-b86a-8bd5deff595e
...
---
Response status code: 201 Created. Responded in 1545.2649569999999ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/59b269d2-29c2-4914-b86a-8bd5deff595e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/59b269d2-29c2-4914-b86a-8bd5deff595e#/orderedItems/2826",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2514#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/59b269d2-29c2-4914-b86a-8bd5deff595e#/orderedItems/2827",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2514#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/59b269d2-29c2-4914-b86a-8bd5deff595e#/orderedItems/2828",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/2515#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/59b269d2-29c2-4914-b86a-8bd5deff595e#/orderedItems/2829",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2501/facility-use-slots/20501#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/59b269d2-29c2-4914-b86a-8bd5deff595e#/orderedItems/2830",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2501/facility-use-slots/20501#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/59b269d2-29c2-4914-b86a-8bd5deff595e#/orderedItems/2831",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2502/facility-use-slots/20502#/offers/0",
        "allowCustomerCancellationFullRefund": true,
