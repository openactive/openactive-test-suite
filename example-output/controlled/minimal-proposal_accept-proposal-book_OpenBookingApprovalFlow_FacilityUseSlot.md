[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:39:59 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 35.1736ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/2047/facility-use-slots/20047"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F2047%2Ffacility-use-slots%2F20047?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2817.020747ms.
```json
{
  "state": "updated",
  "id": "https://localhost:5001/api/identifiers/facility-uses/2047/facility-use-slots/20047",
  "modified": 1625164813939,
  "data": {
    "@context": [
      "https://openactive.io/"
    ],
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/2047",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2047/facility-use-slots/20047#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5adda8e5-27c2-4c1e-b59e-f04835f9eb0c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/2047/facility-use-slots/20047#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/2047/facility-use-slots/20047"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 99.051464ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5adda8e5-27c2-4c1e-b59e-f04835f9eb0c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:45:13+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/2047"
        },
        "maximumUses": 10,
        "remainingUses": 10,
        "startDate": "2021-07-02T18:40:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5adda8e5-27c2-4c1e-b59e-f04835f9eb0c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Thaddeus_Batz85@gmail.com",
    "telephone": "1-934-535-5147 x4939",
    "givenName": "Waelchi",
    "familyName": "Vivianne",
    "identifier": "1b719c06-5790-4628-b980-d0e47f90ffdc"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 136.667179ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/5adda8e5-27c2-4c1e-b59e-f04835f9eb0c
...
---
Response status code: 201 Created. Responded in 143.296717ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/5adda8e5-27c2-4c1e-b59e-f04835f9eb0c",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5adda8e5-27c2-4c1e-b59e-f04835f9eb0c#/orderedItems/269",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/2047/facility-use-slots/20047#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/5adda8e5-27c2-4c1e-b59e-f04835f9eb0c/versions/1dce7cb6-2a2e-49f4-9f63-06e96f7d2eb3",
  "payment": {
    "@type": "Payment",
    "identifier": "LWRUTjaLn",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;5adda8e5-27c2-4c1e-b59e-f04835f9eb0c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/5adda8e5-27c2-4c1e-b59e-f04835f9eb0c


---
Response status code: 200 OK. Responded in 456.105298ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607616090054322&afterId=13fc8e53-75e1-4c33-9c44-8c5508a09cba",
  "message": "Listening for UUID: '5adda8e5-27c2-4c1e-b59e-f04835f9eb0c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 38.371519ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;5adda8e5-27c2-4c1e-b59e-f04835f9eb0c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/5adda8e5-27c2-4c1e-b59e-f04835f9eb0c


---
Response status code: 200 OK. Responded in 3251.861846ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "5adda8e5-27c2-4c1e-b59e-f04835f9eb0c",
  "modified": 637607616151802200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/5adda8e5-27c2-4c1e-b59e-f04835f9eb0c",
    "identifier": "5adda8e5-27c2-4c1e-b59e-f04835f9eb0c",
...
---
Response status code: 200 OK. Responded in 399.081579ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5adda8e5-27c2-4c1e-b59e-f04835f9eb0c
...
---
Response status code: 201 Created. Responded in 69.474996ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5adda8e5-27c2-4c1e-b59e-f04835f9eb0c",
  "identifier": "5adda8e5-27c2-4c1e-b59e-f04835f9eb0c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 2153.9044ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "5adda8e5-27c2-4c1e-b59e-f04835f9eb0c",
  "modified": 637607616189283100
}
```
### Specs
* ✅ should return 200 on success
