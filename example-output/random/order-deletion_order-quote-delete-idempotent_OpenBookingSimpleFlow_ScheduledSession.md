[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:44:01 GMT+0000 (Coordinated Universal Time)

# order-deletion >> order-quote-delete-idempotent (OpenBookingSimpleFlow >> ScheduledSession)
...
⚠️ 6 passed with 0 failures, 55 warnings and 20 suggestions 
...
---
Response status code: 200 OK. Responded in 427.115403ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/519/events/5181"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F519%2Fevents%2F5181?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 306.933578ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/519/events/5181",
    "startDate": "2021-07-06T04:47:09+00:00",
    "endDate": "2021-07-06T06:03:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/519",
      "name": "Steel Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/519#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "price": 5.33,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT7H39M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fbfb5a2b-4031-4e6b-8f9d-1859482cfac4
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/519#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/519/events/5181"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 197.954318ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fbfb5a2b-4031-4e6b-8f9d-1859482cfac4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:03+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/519"
        },
        "maximumAttendeeCapacity": 40,
        "remainingAttendeeCapacity": 40
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fbfb5a2b-4031-4e6b-8f9d-1859482cfac4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jairo.Kirlin47@hotmail.com",
    "telephone": "416-252-3610",
    "givenName": "Lockman",
    "familyName": "Lydia",
    "identifier": "6e0743da-1929-40e6-9200-e1598f03a7a8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 529.734259ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:04+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
DELETE https://localhost:5001/api/openbooking/order-quotes/fbfb5a2b-4031-4e6b-8f9d-1859482cfac4
...
---
Response status code: 204 No Content. Responded in 207.841958ms.
...
---
Response status code: 204 No Content. Responded in 24.662745ms.
### Specs
