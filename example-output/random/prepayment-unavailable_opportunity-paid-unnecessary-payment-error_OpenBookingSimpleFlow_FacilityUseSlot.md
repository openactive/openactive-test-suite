...
---
Response status code: 200 OK. Responded in 4.978872ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/19/facility-use-slots/184"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F19%2Ffacility-use-slots%2F184?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 3.888469ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/19/facility-use-slots/184#/offers/0",
    ...
    "remainingUses": 8,
    "startDate": "2021-07-05T08:40:09+00:00",
    "endDate": "2021-07-05T14:13:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cbd69a01-aad6-4da4-82db-332ebdaf8718
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/19/facility-use-slots/184#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/19/facility-use-slots/184"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 476.71153ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cbd69a01-aad6-4da4-82db-332ebdaf8718",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cbd69a01-aad6-4da4-82db-332ebdaf8718
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kailey_Wunsch28@yahoo.com",
    "telephone": "(593) 716-8735 x9343",
    "givenName": "Terry",
    "familyName": "Chandler",
    "identifier": "afe7cdf1-c73f-4d3e-a12d-4b1c9a9dbb6e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 688.911064ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:27+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/cbd69a01-aad6-4da4-82db-332ebdaf8718
...
---
Response status code: 400 Bad Request. Responded in 107.003117ms.
```json
{
  "@context": "https://openactive.io/",
