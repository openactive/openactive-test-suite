...
---
Response status code: 200 OK. Responded in 72.540928ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/623/events/6221"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F623%2Fevents%2F6221?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.041192ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/623/events/6221",
    "startDate": "2021-07-09T12:29:09+00:00",
    "endDate": "2021-07-09T16:35:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6befb176-10f9-41d9-a751-d00f21fab9a9
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/623/events/6221"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-mOJZzNVw7s",
    "accountId": "invalid-S4asBskLU",
    "paymentProviderId": "invalid-z8jXKw2ldr"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 1403.130916ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6befb176-10f9-41d9-a751-d00f21fab9a9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Katrine_Funk0@gmail.com",
    "telephone": "(791) 868-3861",
    "givenName": "Turner",
    "familyName": "Hank",
    "identifier": "45b72262-6fce-42e8-a979-9e0caf56516e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-P3h8KO4BUp",
    "accountId": "invalid-8fyE8c07I",
    "paymentProviderId": "invalid-mxUd1syCQo"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 78.198669ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
