...
---
Response status code: 200 OK. Responded in 103.695021ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/89/events/888"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F89%2Fevents%2F888?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 158.751089ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/89/events/888",
    "startDate": "2021-07-11T02:13:09+00:00",
    "endDate": "2021-07-11T06:56:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/89",
      "name": "Metal Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/89#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ebc93c9d-124b-495e-ae83-307a59f56470
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/89#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/89/events/888"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 939.359577ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ebc93c9d-124b-495e-ae83-307a59f56470",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:51+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ebc93c9d-124b-495e-ae83-307a59f56470
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lisette42@hotmail.com",
    "telephone": "621.399.8251 x94238",
    "givenName": "Harber",
    "familyName": "Jammie",
    "identifier": "ddcdd84c-27eb-42b5-a46d-9ef7288fd46c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 717.08371ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ebc93c9d-124b-495e-ae83-307a59f56470
...
---
Response status code: 400 Bad Request. Responded in 57.566708ms.
```json
{
  "@context": "https://openactive.io/",
