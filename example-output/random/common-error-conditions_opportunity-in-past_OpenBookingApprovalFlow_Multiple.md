...
# common-error-conditions >> opportunity-in-past (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 29 passed with 0 failures, 296 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 246.999683ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1812/events/18114"
}
```
...
---
Response status code: 200 OK. Responded in 246.717456ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1367/events/13668"
}
```
...
---
Response status code: 200 OK. Responded in 246.201807ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1702/facility-use-slots/17019"
}
```
...
---
Response status code: 200 OK. Responded in 245.828271ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1127/facility-use-slots/11262"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1812%2Fevents%2F18114?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 301.98971ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1812/events/18114",
    "startDate": "2021-07-01T04:38:09+00:00",
    "endDate": "2021-07-01T08:28:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1812",
      "name": "Wooden Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1812#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "PT16H11M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1367%2Fevents%2F13668?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 311.862949ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1367/events/13668",
    "startDate": "2021-07-07T17:14:09+00:00",
    "endDate": "2021-07-07T20:13:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1367",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1367#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT1H33M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1702%2Ffacility-use-slots%2F17019?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 311.840547ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1702",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1702/facility-use-slots/17019#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P1DT1H3M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-06-30T12:35:10+00:00",
    "endDate": "2021-06-30T14:53:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1127%2Ffacility-use-slots%2F11262?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 312.237785ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1127",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1127/facility-use-slots/11262#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 2,
    "startDate": "2021-07-03T04:38:10+00:00",
    "endDate": "2021-07-03T08:11:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/53ab7fd2-b7f8-4f9b-995d-2986d3e6e764
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1812#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1812/events/18114"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1367#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1367/events/13668"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1702/facility-use-slots/17019#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1702/facility-use-slots/17019"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1127/facility-use-slots/11262#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1127/facility-use-slots/11262"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 299.157041ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/53ab7fd2-b7f8-4f9b-995d-2986d3e6e764",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:51+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1812"
        },
        "maximumAttendeeCapacity": 4,
        "remainingAttendeeCapacity": 4
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1367"
        },
        "maximumAttendeeCapacity": 16,
        "remainingAttendeeCapacity": 16
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1702"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-06-30T12:35:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/53ab7fd2-b7f8-4f9b-995d-2986d3e6e764
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "591-663-4675 x3536",
    "givenName": "Towne",
    "familyName": "Eryn",
    "identifier": "ae7b15b4-ef80-4a92-8970-262044a0fab5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 580.224363ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/53ab7fd2-b7f8-4f9b-995d-2986d3e6e764
...
---
Response status code: 409 Conflict. Responded in 159.614175ms.
```json
{
  "@context": "https://openactive.io/",
