...
---
Response status code: 200 OK. Responded in 12.838025ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/155/facility-use-slots/1545"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F155%2Ffacility-use-slots%2F1545?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.265706ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/155/facility-use-slots/1545#/offers/0",
    ...
    "remainingUses": 4,
    "startDate": "2021-07-08T17:28:10+00:00",
    "endDate": "2021-07-08T18:15:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cf7f865c-2e44-49cc-9ad6-81376de2a22a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/155/facility-use-slots/1545#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/155/facility-use-slots/1545"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 323.629375ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cf7f865c-2e44-49cc-9ad6-81376de2a22a",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cf7f865c-2e44-49cc-9ad6-81376de2a22a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kraig63@yahoo.com",
    "telephone": "(292) 409-9170",
    "givenName": "Durgan",
    "familyName": "Sean",
    "identifier": "a03e014a-0fa8-40fe-bb1b-684c06ab8fa1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 542.237731ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/cf7f865c-2e44-49cc-9ad6-81376de2a22a
...
---
Response status code: 201 Created. Responded in 526.342714ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/cf7f865c-2e44-49cc-9ad6-81376de2a22a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cf7f865c-2e44-49cc-9ad6-81376de2a22a#/orderedItems/2953",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/155/facility-use-slots/1545#/offers/0",
        "allowCustomerCancellationFullRefund": false,
