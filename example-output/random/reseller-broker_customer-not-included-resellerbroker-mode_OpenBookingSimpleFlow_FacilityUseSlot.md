...
---
Response status code: 200 OK. Responded in 138.628112ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/172/facility-use-slots/1713"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F172%2Ffacility-use-slots%2F1713?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 132.606342ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/172/facility-use-slots/1713#/offers/0",
    ...
    "remainingUses": 5,
    "startDate": "2021-07-06T01:58:10+00:00",
    "endDate": "2021-07-06T05:12:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a994a49f-ee98-41c3-af86-b4bec633b32f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/172/facility-use-slots/1713#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/172/facility-use-slots/1713"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 361.115555ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a994a49f-ee98-41c3-af86-b4bec633b32f",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a994a49f-ee98-41c3-af86-b4bec633b32f
...
---
Response status code: 200 OK. Responded in 1266.311273ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a994a49f-ee98-41c3-af86-b4bec633b32f
...
---
Response status code: 201 Created. Responded in 494.741695ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a994a49f-ee98-41c3-af86-b4bec633b32f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a994a49f-ee98-41c3-af86-b4bec633b32f#/orderedItems/2077",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/172/facility-use-slots/1713#/offers/0",
        "allowCustomerCancellationFullRefund": true,
