...
# common-error-conditions >> opportunity-in-past (OpenBookingApprovalFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 388.693053ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1676/facility-use-slots/16759"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1676%2Ffacility-use-slots%2F16759?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 319.560381ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1676",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1676/facility-use-slots/16759#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT3H32M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-06-30T21:01:10+00:00",
    "endDate": "2021-07-01T02:04:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/53953d6b-4a1a-46cc-9593-b5c47f628b8d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1676/facility-use-slots/16759#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1676/facility-use-slots/16759"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 563.426766ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/53953d6b-4a1a-46cc-9593-b5c47f628b8d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:48+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1676"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-06-30T21:01:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/53953d6b-4a1a-46cc-9593-b5c47f628b8d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Addison.Hilll@yahoo.com",
    "telephone": "693-904-9871 x3579",
    "givenName": "Dickinson",
    "familyName": "Kelly",
    "identifier": "a2f9168f-669a-4266-936e-2cf0d3cc1c8c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 57.727388ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/53953d6b-4a1a-46cc-9593-b5c47f628b8d
...
---
Response status code: 409 Conflict. Responded in 19.431947ms.
```json
{
  "@context": "https://openactive.io/",
