...
---
Response status code: 200 OK. Responded in 415.086152ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/604/facility-use-slots/6036"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F604%2Ffacility-use-slots%2F6036?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 359.343554ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/604/facility-use-slots/6036#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 12.71,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT46M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-11T10:19:10+00:00",
    "endDate": "2021-07-11T11:18:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b87751a3-f7e4-45ac-838b-2091483b15e3
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/604/facility-use-slots/6036"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 64.488729ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b87751a3-f7e4-45ac-838b-2091483b15e3",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b87751a3-f7e4-45ac-838b-2091483b15e3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Angelita.Bednar@yahoo.com",
    "telephone": "(982) 582-8211 x27007",
    "givenName": "McClure",
    "familyName": "Mya",
    "identifier": "7ce28d2f-7053-48ab-b075-0d16c9388e11"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 19.941495ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b87751a3-f7e4-45ac-838b-2091483b15e3
...
---
Response status code: 409 Conflict. Responded in 46.618131ms.
```json
{
  "@context": "https://openactive.io/",
