...
# customer-requested-cancellation >> orderitem-not-within-order-error (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 385.456977ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/646/facility-use-slots/6460"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F646%2Ffacility-use-slots%2F6460?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 326.64338ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/646",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/646/facility-use-slots/6460#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT11H49M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-10T09:16:10+00:00",
    "endDate": "2021-07-10T12:51:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/221d6b74-22a1-44d0-8431-e77ce6c2bf2c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/646/facility-use-slots/6460#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/646/facility-use-slots/6460"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 569.719711ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/221d6b74-22a1-44d0-8431-e77ce6c2bf2c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:52+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/221d6b74-22a1-44d0-8431-e77ce6c2bf2c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Graham_Graham16@gmail.com",
    "telephone": "1-584-492-9594",
    "givenName": "Funk",
    "familyName": "Ray",
    "identifier": "8306b089-a51e-40e4-840a-a3b76e04e25f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 199.615394ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:53+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/221d6b74-22a1-44d0-8431-e77ce6c2bf2c
...
---
Response status code: 201 Created. Responded in 264.657882ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/221d6b74-22a1-44d0-8431-e77ce6c2bf2c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/221d6b74-22a1-44d0-8431-e77ce6c2bf2c#/orderedItems/1293",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/646/facility-use-slots/6460#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/d00a2785-2340-4eeb-bf81-ff83273536bb
...
---
Response status code: 500 Internal Server Error. Responded in 28.871948ms.
```json
{
  "@context": "https://openactive.io/",
