...
# access-pass-image >> access-pass-image (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 16 passed with 0 failures, 373 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 343.976518ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/9/events/85"
}
```
...
---
Response status code: 200 OK. Responded in 358.379488ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/519/events/5186"
}
```
...
---
Response status code: 200 OK. Responded in 356.233683ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/230/facility-use-slots/2292"
}
```
...
---
Response status code: 200 OK. Responded in 356.877344ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/190/facility-use-slots/1893"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F9%2Fevents%2F85?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 283.256842ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/9/events/85",
    "startDate": "2021-07-02T14:22:09+00:00",
    "endDate": "2021-07-02T18:38:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F519%2Fevents%2F5186?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 284.011214ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/519/events/5186",
    "startDate": "2021-07-08T04:26:09+00:00",
    "endDate": "2021-07-08T06:29:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F230%2Ffacility-use-slots%2F2292?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 285.933597ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/230",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/230/facility-use-slots/2292#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 7,
    "startDate": "2021-07-09T09:40:10+00:00",
    "endDate": "2021-07-09T11:04:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F190%2Ffacility-use-slots%2F1893?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 286.580759ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/190/facility-use-slots/1893#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 5,
    "startDate": "2021-07-10T16:37:10+00:00",
    "endDate": "2021-07-10T17:18:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/058213ae-63ca-4a5f-b606-e5283ddae847
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/9/events/85"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/519/events/5186"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/230/facility-use-slots/2292#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/230/facility-use-slots/2292"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/190/facility-use-slots/1893#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/190/facility-use-slots/1893"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 795.153532ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/058213ae-63ca-4a5f-b606-e5283ddae847",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/230"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-09T09:40:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/058213ae-63ca-4a5f-b606-e5283ddae847
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Herbert.Bins@gmail.com",
    "telephone": "602.715.6323",
    "givenName": "Price",
    "familyName": "Barton",
    "identifier": "efa672ea-462a-4238-9b4d-2fda44c725ca"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 538.633433ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/058213ae-63ca-4a5f-b606-e5283ddae847
...
---
Response status code: 201 Created. Responded in 714.677194ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/058213ae-63ca-4a5f-b606-e5283ddae847",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/058213ae-63ca-4a5f-b606-e5283ddae847#/orderedItems/1484",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/9#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/058213ae-63ca-4a5f-b606-e5283ddae847#/orderedItems/1485",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/9#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/058213ae-63ca-4a5f-b606-e5283ddae847#/orderedItems/1486",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/519#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/058213ae-63ca-4a5f-b606-e5283ddae847#/orderedItems/1487",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/230/facility-use-slots/2292#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/058213ae-63ca-4a5f-b606-e5283ddae847#/orderedItems/1488",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/230/facility-use-slots/2292#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/058213ae-63ca-4a5f-b606-e5283ddae847#/orderedItems/1489",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/190/facility-use-slots/1893#/offers/0",
        "allowCustomerCancellationFullRefund": false,
