[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:50:46 GMT+0000 (Coordinated Universal Time)

# agent-broker >> customer-included (OpenBookingSimpleFlow >> Multiple)
...
---
Response status code: 200 OK. Responded in 149.737632ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/468/events/4674"
}
```
...
---
Response status code: 200 OK. Responded in 150.491004ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/649/events/6483"
}
```
...
---
Response status code: 200 OK. Responded in 151.000753ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/191/facility-use-slots/1905"
}
```
...
---
Response status code: 200 OK. Responded in 152.063754ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/128/facility-use-slots/1278"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F468%2Fevents%2F4674?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 219.408655ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/468/events/4674",
    "startDate": "2021-07-03T15:02:09+00:00",
    "endDate": "2021-07-03T15:35:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/468",
      "name": "Fresh Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/468#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 12.36,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT14H56M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F649%2Fevents%2F6483?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 222.562355ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/649/events/6483",
    "startDate": "2021-07-09T08:12:09+00:00",
    "endDate": "2021-07-09T13:22:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F191%2Ffacility-use-slots%2F1905?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 223.115607ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/191",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/191/facility-use-slots/1905#/offers/0",
    ...
    "remainingUses": 4,
    "startDate": "2021-07-09T02:15:10+00:00",
    "endDate": "2021-07-09T03:58:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F128%2Ffacility-use-slots%2F1278?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 223.708563ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/128/facility-use-slots/1278#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 2,
    "startDate": "2021-07-03T16:03:09+00:00",
    "endDate": "2021-07-03T20:28:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ef645166-2752-481c-a3c3-b8525ac91ce1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/468#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/468/events/4674"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/649/events/6483"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/191/facility-use-slots/1905#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/191/facility-use-slots/1905"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/128/facility-use-slots/1278#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/128/facility-use-slots/1278"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2573.997249ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ef645166-2752-481c-a3c3-b8525ac91ce1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:56:04+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/468"
        },
        "maximumAttendeeCapacity": 6,
        "remainingAttendeeCapacity": 6
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/191"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-09T02:15:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ef645166-2752-481c-a3c3-b8525ac91ce1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Danyka66@gmail.com",
    "telephone": "1-834-260-1324 x586",
    "givenName": "Wiegand",
    "familyName": "Juwan",
    "identifier": "a48c1d62-f267-4e1b-b501-5c681afb60b5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1692.370652ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:56:07+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ef645166-2752-481c-a3c3-b8525ac91ce1
...
---
Response status code: 201 Created. Responded in 2006.4016ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ef645166-2752-481c-a3c3-b8525ac91ce1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ef645166-2752-481c-a3c3-b8525ac91ce1#/orderedItems/2628",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/468#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ef645166-2752-481c-a3c3-b8525ac91ce1#/orderedItems/2629",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/468#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ef645166-2752-481c-a3c3-b8525ac91ce1#/orderedItems/2630",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/649#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ef645166-2752-481c-a3c3-b8525ac91ce1#/orderedItems/2631",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/191/facility-use-slots/1905#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ef645166-2752-481c-a3c3-b8525ac91ce1#/orderedItems/2632",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/191/facility-use-slots/1905#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ef645166-2752-481c-a3c3-b8525ac91ce1#/orderedItems/2633",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/128/facility-use-slots/1278#/offers/0",
        "allowCustomerCancellationFullRefund": false,
