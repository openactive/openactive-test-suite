[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:46:51 GMT+0000 (Coordinated Universal Time)

# cancellation-window >> fail-outside-window (OpenBookingSimpleFlow >> Multiple)
...
---
Response status code: 200 OK. Responded in 220.457736ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/336/events/3358"
}
```
...
---
Response status code: 200 OK. Responded in 219.515946ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/62/events/615"
}
```
...
---
Response status code: 200 OK. Responded in 218.81938ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/777/facility-use-slots/7765"
}
```
...
---
Response status code: 200 OK. Responded in 219.180214ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/90/facility-use-slots/894"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F336%2Fevents%2F3358?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 175.272643ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/336/events/3358",
    "startDate": "2021-07-03T04:02:09+00:00",
    "endDate": "2021-07-03T09:52:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/336",
      "name": "Cotton Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/336#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT14H34M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F62%2Fevents%2F615?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 176.934401ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/62/events/615",
    "startDate": "2021-07-05T12:02:09+00:00",
    "endDate": "2021-07-05T14:45:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/62",
      "name": "Frozen Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/62#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F777%2Ffacility-use-slots%2F7765?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 177.637768ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/777",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/777/facility-use-slots/7765#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P1DT10H40M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-02T03:35:10+00:00",
    "endDate": "2021-07-02T07:03:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F90%2Ffacility-use-slots%2F894?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 180.452635ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/90",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/90/facility-use-slots/894#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 7,
    "startDate": "2021-07-07T02:54:09+00:00",
    "endDate": "2021-07-07T07:33:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f3dc029d-adf4-472c-b22f-d3f04edf3760
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/336#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/336/events/3358"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/62#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/62/events/615"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/777/facility-use-slots/7765#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/777/facility-use-slots/7765"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/90/facility-use-slots/894#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/90/facility-use-slots/894"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 951.078111ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f3dc029d-adf4-472c-b22f-d3f04edf3760",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:05+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/336"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/62"
        },
        "maximumAttendeeCapacity": 34,
        "remainingAttendeeCapacity": 34
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/777"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-02T03:35:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/90"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-07T02:54:09+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f3dc029d-adf4-472c-b22f-d3f04edf3760
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Hassan.Daniel@yahoo.com",
    "telephone": "956-338-4013 x236",
    "givenName": "Hoppe",
    "familyName": "Jackeline",
    "identifier": "8b16e0db-1232-4b0a-8b6e-99f1ec727583"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1229.234623ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:06+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f3dc029d-adf4-472c-b22f-d3f04edf3760
...
---
Response status code: 201 Created. Responded in 973.844672ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f3dc029d-adf4-472c-b22f-d3f04edf3760",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f3dc029d-adf4-472c-b22f-d3f04edf3760#/orderedItems/1952",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/336#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f3dc029d-adf4-472c-b22f-d3f04edf3760#/orderedItems/1953",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/336#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f3dc029d-adf4-472c-b22f-d3f04edf3760#/orderedItems/1954",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/62#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f3dc029d-adf4-472c-b22f-d3f04edf3760#/orderedItems/1955",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/777/facility-use-slots/7765#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f3dc029d-adf4-472c-b22f-d3f04edf3760#/orderedItems/1956",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/777/facility-use-slots/7765#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f3dc029d-adf4-472c-b22f-d3f04edf3760#/orderedItems/1957",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/90/facility-use-slots/894#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/f3dc029d-adf4-472c-b22f-d3f04edf3760
...
---
Response status code: 400 Bad Request. Responded in 131.626507ms.
```json
{
  "@context": "https://openactive.io/",
