...
---
Response status code: 200 OK. Responded in 274.149164ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/122/events/1214"
}
```
...
---
Response status code: 200 OK. Responded in 283.35044ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/36/events/358"
}
```
...
---
Response status code: 200 OK. Responded in 283.859988ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/513/facility-use-slots/5123"
}
```
...
---
Response status code: 200 OK. Responded in 284.427342ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/573/facility-use-slots/5726"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F122%2Fevents%2F1214?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 143.424236ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/122/events/1214",
    "startDate": "2021-07-04T11:45:09+00:00",
    "endDate": "2021-07-04T15:15:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F36%2Fevents%2F358?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 143.245119ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/36/events/358",
    "startDate": "2021-07-08T05:22:09+00:00",
    "endDate": "2021-07-08T08:26:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F513%2Ffacility-use-slots%2F5123?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 143.852877ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/513",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/513/facility-use-slots/5123#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 10.99,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT20H44M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-08T22:29:10+00:00",
    "endDate": "2021-07-09T01:26:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F573%2Ffacility-use-slots%2F5726?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 147.839156ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/573",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/573/facility-use-slots/5726#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 18.8,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT32M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-05T02:29:10+00:00",
    "endDate": "2021-07-05T04:17:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d4bd22a4-3868-4e00-95df-5d95489d3786
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/122/events/1214"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/36/events/358"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/513/facility-use-slots/5123#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/513/facility-use-slots/5123"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/573/facility-use-slots/5726#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/573/facility-use-slots/5726"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 156.581787ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d4bd22a4-3868-4e00-95df-5d95489d3786",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/513"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-08T22:29:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/573"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-05T02:29:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d4bd22a4-3868-4e00-95df-5d95489d3786
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "telephone": "1-853-463-0386 x643",
    "givenName": "Brown",
    "familyName": "Aliya",
    "identifier": "343d4e67-70a4-4555-83c3-485b5b79262b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 20.622159ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 182.356022ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/120/events/1192"
}
```
...
---
Response status code: 200 OK. Responded in 170.360783ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/250/events/2492"
}
```
...
---
Response status code: 200 OK. Responded in 174.143942ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/42/facility-use-slots/416"
}
```
...
---
Response status code: 200 OK. Responded in 177.970605ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5754"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F120%2Fevents%2F1192?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 222.523438ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/120/events/1192",
    "startDate": "2021-07-09T00:45:09+00:00",
    "endDate": "2021-07-09T06:36:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F250%2Fevents%2F2492?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 223.159098ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/250/events/2492",
    "startDate": "2021-07-05T14:37:09+00:00",
    "endDate": "2021-07-05T18:13:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F42%2Ffacility-use-slots%2F416?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 223.312512ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/42",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/42/facility-use-slots/416#/offers/0",
    ...
    "remainingUses": 8,
    "startDate": "2021-07-03T04:41:09+00:00",
    "endDate": "2021-07-03T07:28:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F576%2Ffacility-use-slots%2F5754?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 223.956075ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5754#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 18.57,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT16H5M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-06T09:31:10+00:00",
    "endDate": "2021-07-06T11:26:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5e3db45c-3bd9-42cf-8d5b-cad3cb1c6a74
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/120/events/1192"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/250/events/2492"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/42/facility-use-slots/416#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/42/facility-use-slots/416"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5754#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5754"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 250.928636ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5e3db45c-3bd9-42cf-8d5b-cad3cb1c6a74",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5e3db45c-3bd9-42cf-8d5b-cad3cb1c6a74
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jordan.Cruickshank87@hotmail.com",
    "telephone": "273.460.1408 x892",
    "givenName": "Greenholt",
    "familyName": "Treva",
    "identifier": "e99fc38e-c913-4c9e-b9df-020b30d699a8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 333.998827ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5e3db45c-3bd9-42cf-8d5b-cad3cb1c6a74
...
---
Response status code: 400 Bad Request. Responded in 21.922782ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
