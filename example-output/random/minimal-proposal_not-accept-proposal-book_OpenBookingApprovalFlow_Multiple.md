[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:38:47 GMT+0000 (Coordinated Universal Time)
...
⚠️ 19 passed with 0 failures, 369 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 529.247355ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1495/events/14944"
}
```
...
---
Response status code: 200 OK. Responded in 528.547588ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1075/events/10750"
}
```
...
---
Response status code: 200 OK. Responded in 527.93013ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1057/facility-use-slots/10563"
}
```
...
---
Response status code: 200 OK. Responded in 532.183434ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1159/facility-use-slots/11589"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1495%2Fevents%2F14944?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 530.136439ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1495/events/14944",
    "startDate": "2021-07-03T07:36:09+00:00",
    "endDate": "2021-07-03T09:58:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1495",
      "name": "Rubber Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1495#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1075%2Fevents%2F10750?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 531.723991ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1075/events/10750",
    "startDate": "2021-07-11T13:22:09+00:00",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1057%2Ffacility-use-slots%2F10563?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 533.224533ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1057/facility-use-slots/10563#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2021-07-03T16:40:10+00:00",
    "endDate": "2021-07-03T22:15:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1159%2Ffacility-use-slots%2F11589?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 513.158025ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1159/facility-use-slots/11589#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 6,
    "startDate": "2021-07-06T20:49:10+00:00",
    "endDate": "2021-07-07T00:05:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a7f1282b-9de4-4b6c-8b83-519a19b8441a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1495#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1495/events/14944"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1075/events/10750"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1057/facility-use-slots/10563#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1057/facility-use-slots/10563"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1159/facility-use-slots/11589#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1159/facility-use-slots/11589"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 343.124043ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a7f1282b-9de4-4b6c-8b83-519a19b8441a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:54+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1495"
        },
        "maximumAttendeeCapacity": 47,
        "remainingAttendeeCapacity": 47
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a7f1282b-9de4-4b6c-8b83-519a19b8441a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Leonora_Corwin80@gmail.com",
    "telephone": "865-750-7979 x47291",
    "givenName": "Jakubowski",
    "familyName": "Brad",
    "identifier": "504be54c-3e0b-43e4-a9dc-75918d2eedd7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 248.692453ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:56+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a7f1282b-9de4-4b6c-8b83-519a19b8441a
...
---
Response status code: 201 Created. Responded in 225.790776ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a7f1282b-9de4-4b6c-8b83-519a19b8441a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a7f1282b-9de4-4b6c-8b83-519a19b8441a#/orderedItems/389",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1495#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a7f1282b-9de4-4b6c-8b83-519a19b8441a#/orderedItems/390",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1495#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a7f1282b-9de4-4b6c-8b83-519a19b8441a#/orderedItems/391",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1075#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a7f1282b-9de4-4b6c-8b83-519a19b8441a#/orderedItems/392",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1057/facility-use-slots/10563#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a7f1282b-9de4-4b6c-8b83-519a19b8441a#/orderedItems/393",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1057/facility-use-slots/10563#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a7f1282b-9de4-4b6c-8b83-519a19b8441a#/orderedItems/394",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1159/facility-use-slots/11589#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a7f1282b-9de4-4b6c-8b83-519a19b8441a/versions/d69fd84f-90c7-4a5e-805b-59cf49908125",
  "payment": {
    "@type": "Payment",
    "identifier": "t0iJJdFZV",
    "name": "AcmeBroker Points",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a7f1282b-9de4-4b6c-8b83-519a19b8441a
...
---
Response status code: 500 Internal Server Error. Responded in 37.521168ms.
```json
{
  "@context": "https://openactive.io/",
