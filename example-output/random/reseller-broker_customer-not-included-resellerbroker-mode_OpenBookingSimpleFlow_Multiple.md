...
# reseller-broker >> customer-not-included-resellerbroker-mode (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 15 passed with 0 failures, 378 warnings and 104 suggestions 
...
---
Response status code: 200 OK. Responded in 227.439386ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/41/events/409"
}
```
...
---
Response status code: 200 OK. Responded in 227.950234ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/669/events/6686"
}
```
...
---
Response status code: 200 OK. Responded in 228.499687ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5753"
}
```
...
---
Response status code: 200 OK. Responded in 229.152448ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4772"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F41%2Fevents%2F409?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 195.477752ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/41/events/409",
    "startDate": "2021-07-11T11:17:09+00:00",
    "endDate": "2021-07-11T15:35:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/41",
      "name": "Rubber Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/41#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F669%2Fevents%2F6686?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 196.082209ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/669/events/6686",
    "startDate": "2021-07-04T19:26:09+00:00",
    "endDate": "2021-07-05T00:33:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/669",
      "name": "Steel Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/669#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Optional",
          "price": 1.13,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P3DT5H27M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F576%2Ffacility-use-slots%2F5753?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 208.793516ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/576",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5753#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT21H58M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-09T06:43:10+00:00",
    "endDate": "2021-07-09T10:00:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F478%2Ffacility-use-slots%2F4772?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 210.807107ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/478",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4772#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT15H51M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-02T17:48:10+00:00",
    "endDate": "2021-07-02T19:03:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/82f499c2-cdc7-40a5-a166-017b7411cde0
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/41#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/41/events/409"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/669#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/669/events/6686"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5753#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5753"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4772#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4772"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 996.739997ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/82f499c2-cdc7-40a5-a166-017b7411cde0",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:02+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/41"
        },
        "maximumAttendeeCapacity": 21,
        "remainingAttendeeCapacity": 21
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/669"
        },
        "maximumAttendeeCapacity": 47,
        "remainingAttendeeCapacity": 47
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/576"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-09T06:43:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/478"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-02T17:48:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/82f499c2-cdc7-40a5-a166-017b7411cde0
...
---
Response status code: 200 OK. Responded in 1571.401337ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:04+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/82f499c2-cdc7-40a5-a166-017b7411cde0
...
---
Response status code: 201 Created. Responded in 1440.6387260000001ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/82f499c2-cdc7-40a5-a166-017b7411cde0",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/82f499c2-cdc7-40a5-a166-017b7411cde0#/orderedItems/2106",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/41#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/82f499c2-cdc7-40a5-a166-017b7411cde0#/orderedItems/2107",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/41#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/82f499c2-cdc7-40a5-a166-017b7411cde0#/orderedItems/2108",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/669#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/82f499c2-cdc7-40a5-a166-017b7411cde0#/orderedItems/2109",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5753#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/82f499c2-cdc7-40a5-a166-017b7411cde0#/orderedItems/2110",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5753#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/82f499c2-cdc7-40a5-a166-017b7411cde0#/orderedItems/2111",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4772#/offers/0",
        "allowCustomerCancellationFullRefund": true,
