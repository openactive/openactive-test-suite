[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:48:47 GMT+0000 (Coordinated Universal Time)

# free-opportunities >> payment-mismatch (OpenBookingApprovalFlow >> Multiple)
...
**Test:**  Expect a TotalPaymentDueMismatchError when the totalPaymentDue property is non-zero for free opportunities
...
```bash
npm start -- --runInBand test/features/payment/free-opportunities/implemented/payment-mismatch-test.js
```

---

⚠️ 9 passed with 0 failures, 103 warnings and 26 suggestions 
...
---
Response status code: 200 OK. Responded in 186.847351ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1627/events/16264"
}
```
...
---
Response status code: 200 OK. Responded in 189.963448ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1592/facility-use-slots/15911"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1627%2Fevents%2F16264?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 213.764709ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1627/events/16264",
    "startDate": "2021-07-03T19:37:09+00:00",
    "endDate": "2021-07-03T22:29:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1592%2Ffacility-use-slots%2F15911?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 212.838121ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1592",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1592/facility-use-slots/15911#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT6H12M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-05T09:09:10+00:00",
    "endDate": "2021-07-05T11:33:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ed77d0c1-7bf0-49ae-900c-02200a9769ad
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1627/events/16264"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1592/facility-use-slots/15911#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1592/facility-use-slots/15911"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 901.325633ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ed77d0c1-7bf0-49ae-900c-02200a9769ad",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:04+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1592"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-05T09:09:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ed77d0c1-7bf0-49ae-900c-02200a9769ad
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Raul_Towne@hotmail.com",
    "telephone": "(652) 636-0355 x1519",
    "givenName": "Langworth",
    "familyName": "Aaron",
    "identifier": "49b11257-56b0-49c0-8aa6-54b54fef96d9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1240.837889ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:06+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/ed77d0c1-7bf0-49ae-900c-02200a9769ad
...
---
Response status code: 400 Bad Request. Responded in 57.142229ms.
```json
{
  "@context": "https://openactive.io/",
