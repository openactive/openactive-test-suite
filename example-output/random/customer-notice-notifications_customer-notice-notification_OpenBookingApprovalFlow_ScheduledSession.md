...
# customer-notice-notifications >> customer-notice-notification (OpenBookingApprovalFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 125.468814ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1428/events/14275"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1428%2Fevents%2F14275?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 169.138861ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1428/events/14275",
    "startDate": "2021-07-09T14:08:09+00:00",
    "endDate": "2021-07-09T18:19:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1428",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1428#/offers/0",
          ...
          "price": 19.06,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT13H41M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b264b9fc-e0f0-415b-8212-4a9b8aabf67a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1428#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1428/events/14275"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1336.414101ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b264b9fc-e0f0-415b-8212-4a9b8aabf67a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:07+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1428"
        },
        "maximumAttendeeCapacity": 30,
        "remainingAttendeeCapacity": 30
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b264b9fc-e0f0-415b-8212-4a9b8aabf67a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Justus.Vandervort67@gmail.com",
    "telephone": "264.292.4500",
    "givenName": "Weber",
    "familyName": "Chasity",
    "identifier": "ab6ad2fd-bf74-40b9-b71c-c39cef5a34d3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 348.885329ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:08+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b264b9fc-e0f0-415b-8212-4a9b8aabf67a
...
---
Response status code: 201 Created. Responded in 386.999848ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b264b9fc-e0f0-415b-8212-4a9b8aabf67a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b264b9fc-e0f0-415b-8212-4a9b8aabf67a#/orderedItems/1951",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1428#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b264b9fc-e0f0-415b-8212-4a9b8aabf67a/versions/fe9c7a76-00b9-4736-8f73-c3c03a1ab55e",
  "payment": {
    "@type": "Payment",
    "identifier": "1PUTJXeuZ",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;b264b9fc-e0f0-415b-8212-4a9b8aabf67a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/b264b9fc-e0f0-415b-8212-4a9b8aabf67a


---
Response status code: 200 OK. Responded in 134.781198ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607620035277682&afterId=c22d5748-7ed9-4f7b-a5cc-b404eceaaa3b",
  "message": "Listening for UUID: 'b264b9fc-e0f0-415b-8212-4a9b8aabf67a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 392.277549ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;b264b9fc-e0f0-415b-8212-4a9b8aabf67a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/b264b9fc-e0f0-415b-8212-4a9b8aabf67a


---
Response status code: 200 OK. Responded in 3071.070408ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b264b9fc-e0f0-415b-8212-4a9b8aabf67a",
  "modified": 637607620294682000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/b264b9fc-e0f0-415b-8212-4a9b8aabf67a",
    "identifier": "b264b9fc-e0f0-415b-8212-4a9b8aabf67a",
...
---
Response status code: 200 OK. Responded in 161.488144ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b264b9fc-e0f0-415b-8212-4a9b8aabf67a
...
---
Response status code: 201 Created. Responded in 393.367776ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b264b9fc-e0f0-415b-8212-4a9b8aabf67a",
  "identifier": "b264b9fc-e0f0-415b-8212-4a9b8aabf67a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1503.55226ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "b264b9fc-e0f0-415b-8212-4a9b8aabf67a",
  "modified": 637607620331827800
}
```
### Specs
* ✅ should return 200 on success
...
### Orders (orders) Feed listen for &#x27;b264b9fc-e0f0-415b-8212-4a9b8aabf67a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/b264b9fc-e0f0-415b-8212-4a9b8aabf67a


---
Response status code: 200 OK. Responded in 214.994128ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607620197348588&afterId=c4fdf623-e650-4707-9ddc-4ada91330042",
  "message": "Listening for UUID: 'b264b9fc-e0f0-415b-8212-4a9b8aabf67a' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 18.437552ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:CustomerNoticeSimulateAction)

### Orders (orders) Feed collect for &#x27;b264b9fc-e0f0-415b-8212-4a9b8aabf67a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/b264b9fc-e0f0-415b-8212-4a9b8aabf67a


---
Response status code: 200 OK. Responded in 2446.880991ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b264b9fc-e0f0-415b-8212-4a9b8aabf67a",
  "modified": 637607620359235800,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "orderedItem": [
      {
        ...
        "customerNotice": "customer notice message: yruxdttfbk",
        "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1428/events/14275",
        "orderItemStatus": "https://openactive.io/OrderItemConfirmed"
      }
    ],
