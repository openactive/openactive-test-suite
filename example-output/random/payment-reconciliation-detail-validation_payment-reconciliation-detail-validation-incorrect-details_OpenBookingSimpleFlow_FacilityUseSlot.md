...
---
Response status code: 200 OK. Responded in 9.036363ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/449/facility-use-slots/4489"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F449%2Ffacility-use-slots%2F4489?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.167731ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/449",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/449/facility-use-slots/4489#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 13.72,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT7H39M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-05T07:39:10+00:00",
    "endDate": "2021-07-05T11:23:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/90d272f6-425e-4eb8-876f-15222d0616dc
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/449/facility-use-slots/4489#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/449/facility-use-slots/4489"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid--ShQCPD_Pp",
    "accountId": "invalid-T19A1arTsq",
    "paymentProviderId": "invalid-DC2Mcy2jJU"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 4951.71956ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/90d272f6-425e-4eb8-876f-15222d0616dc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Josiane.Wilkinson75@gmail.com",
    "telephone": "726-957-5732",
    "givenName": "King",
    "familyName": "Cara",
    "identifier": "14333a98-b59a-4b08-8fa3-7a406baccaeb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-dGHMLlNgR5",
    "accountId": "invalid-h0KokjQMr",
    "paymentProviderId": "invalid-EOKm1WV9Z0"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 551.669943ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
