...
---
Response status code: 200 OK. Responded in 252.655191ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1253/facility-use-slots/12528"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1253%2Ffacility-use-slots%2F12528?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 183.290204ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1253",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1253/facility-use-slots/12528#/offers/0",
    ...
    "remainingUses": 8,
    "startDate": "2021-07-03T05:45:10+00:00",
    "endDate": "2021-07-03T07:48:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1253/facility-use-slots/12528#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1253/facility-use-slots/12528"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 338.132107ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1253"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-03T05:45:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Brigitte_Schinner@gmail.com",
    "telephone": "546-942-6787 x04882",
    "givenName": "Osinski",
    "familyName": "Arlo",
    "identifier": "8ae7fc67-4b5d-40f9-80a6-d33b28fffc91"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 602.819739ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a
...
---
Response status code: 201 Created. Responded in 579.642038ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a#/orderedItems/2139",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1253/facility-use-slots/12528#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a/versions/9beb8fd0-5a4b-4c7e-b390-d7c3e80891b7",
  "payment": {
    "@type": "Payment",
    "identifier": "FvrGEhiLY",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a


---
Response status code: 200 OK. Responded in 219.78837ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 748.970725ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a


---
Response status code: 200 OK. Responded in 1499.289088ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a",
  "modified": 637607621031804300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a",
    "identifier": "f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a",
...
---
Response status code: 200 OK. Responded in 152.826814ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621028052728&afterId=ab450ffe-4f7e-4032-b68d-b9344427221e",
  "message": "Listening for UUID: 'f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a
...
---
Response status code: 201 Created. Responded in 278.886286ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a",
  "identifier": "f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1311.869989ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a",
  "modified": 637607621057019600
}
```
### Specs
* ✅ should return 200 on success
...
DELETE https://localhost:5001/api/openbooking/orders/f95dc5b8-ff20-4a05-99f2-90d03ecbcc3a
...
---
Response status code: 204 No Content. Responded in 301.484732ms.
...
---
Response status code: 204 No Content. Responded in 17.339347ms.
### Specs
* ✅ should return 204 on success
* ✅ should return 204 on success
