...
⚠️ 20 passed with 0 failures, 415 warnings and 108 suggestions 
...
---
Response status code: 200 OK. Responded in 331.310212ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/752/events/7515"
}
```
...
---
Response status code: 200 OK. Responded in 332.471823ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/48/events/472"
}
```
...
---
Response status code: 200 OK. Responded in 337.015655ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/26/facility-use-slots/253"
}
```
...
---
Response status code: 200 OK. Responded in 338.026551ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/548/facility-use-slots/5475"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F752%2Fevents%2F7515?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 590.964708ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/752/events/7515",
    "startDate": "2021-07-03T02:21:09+00:00",
    "endDate": "2021-07-03T07:49:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/752",
      "name": "Metal Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/752#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P3DT18H19M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F48%2Fevents%2F472?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 594.55875ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/48/events/472",
    "startDate": "2021-07-07T14:25:09+00:00",
    "endDate": "2021-07-07T17:37:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F26%2Ffacility-use-slots%2F253?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 595.378028ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/26/facility-use-slots/253#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 3.39,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 5,
    "startDate": "2021-07-10T11:53:09+00:00",
    "endDate": "2021-07-10T15:38:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F548%2Ffacility-use-slots%2F5475?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 599.561726ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/548",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/548/facility-use-slots/5475#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP",
    ...
    "remainingUses": 2,
    "startDate": "2021-07-10T22:12:10+00:00",
    "endDate": "2021-07-11T01:53:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a0c7b335-dea8-4814-bb12-aa2c2f36617f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/752#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/752/events/7515"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/48/events/472"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/26/facility-use-slots/253#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/26/facility-use-slots/253"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/548/facility-use-slots/5475#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/548/facility-use-slots/5475"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 333.624265ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a0c7b335-dea8-4814-bb12-aa2c2f36617f",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/752"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/548"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-10T22:12:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a0c7b335-dea8-4814-bb12-aa2c2f36617f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Velva38@hotmail.com",
    "telephone": "(754) 466-5634 x710",
    "givenName": "Tremblay",
    "familyName": "Kayden",
    "identifier": "5210556c-7047-4b69-9266-70b344590376"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 408.352157ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:44:05+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a0c7b335-dea8-4814-bb12-aa2c2f36617f
...
---
Response status code: 201 Created. Responded in 424.642503ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a0c7b335-dea8-4814-bb12-aa2c2f36617f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a0c7b335-dea8-4814-bb12-aa2c2f36617f#/orderedItems/410",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/752#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a0c7b335-dea8-4814-bb12-aa2c2f36617f#/orderedItems/411",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/752#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a0c7b335-dea8-4814-bb12-aa2c2f36617f#/orderedItems/412",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/48#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a0c7b335-dea8-4814-bb12-aa2c2f36617f#/orderedItems/413",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/26/facility-use-slots/253#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a0c7b335-dea8-4814-bb12-aa2c2f36617f#/orderedItems/414",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/26/facility-use-slots/253#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a0c7b335-dea8-4814-bb12-aa2c2f36617f#/orderedItems/415",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/548/facility-use-slots/5475#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Orders (orders) Feed listen for &#x27;a0c7b335-dea8-4814-bb12-aa2c2f36617f&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/a0c7b335-dea8-4814-bb12-aa2c2f36617f


---
Response status code: 200 OK. Responded in 266.448084ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'a0c7b335-dea8-4814-bb12-aa2c2f36617f' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```

### U Request
PATCH https://localhost:5001/api/openbooking/orders/a0c7b335-dea8-4814-bb12-aa2c2f36617f
...
---
Response status code: 204 No Content. Responded in 120.223554ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Order Cancellation)

### Orders (orders) Feed collect for &#x27;a0c7b335-dea8-4814-bb12-aa2c2f36617f&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/a0c7b335-dea8-4814-bb12-aa2c2f36617f


---
Response status code: 200 OK. Responded in 2614.471277ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a0c7b335-dea8-4814-bb12-aa2c2f36617f",
  "modified": 637607615515991900,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/a0c7b335-dea8-4814-bb12-aa2c2f36617f",
    "identifier": "a0c7b335-dea8-4814-bb12-aa2c2f36617f",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/a0c7b335-dea8-4814-bb12-aa2c2f36617f#/orderedItems/413",
...
---
Response status code: 204 No Content. Responded in 58.820004ms.
### Specs
* ✅ should return 204 on success
