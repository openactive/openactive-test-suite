...
# order-deletion >> order-delete-idempotent (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 21 passed with 0 failures, 484 warnings and 126 suggestions 
...
---
Response status code: 200 OK. Responded in 273.252251ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1448/events/14475"
}
```
...
---
Response status code: 200 OK. Responded in 283.399515ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1396/events/13951"
}
```
...
---
Response status code: 200 OK. Responded in 283.889861ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1179/facility-use-slots/11790"
}
```
...
---
Response status code: 200 OK. Responded in 285.340999ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1085/facility-use-slots/10844"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1448%2Fevents%2F14475?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 188.715222ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1448/events/14475",
    "startDate": "2021-07-08T19:14:09+00:00",
    "endDate": "2021-07-08T21:59:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1448",
      "name": "Wooden Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1448#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT9H59M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1396%2Fevents%2F13951?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 188.779229ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1396/events/13951",
    "startDate": "2021-07-09T14:55:09+00:00",
    "endDate": "2021-07-09T17:51:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1396",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1396#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT15H41M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1179%2Ffacility-use-slots%2F11790?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 188.931843ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1179",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1179/facility-use-slots/11790#/offers/0",
    ...
    "remainingUses": 6,
    "startDate": "2021-07-08T05:53:10+00:00",
    "endDate": "2021-07-08T09:47:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1085%2Ffacility-use-slots%2F10844?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 189.118361ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1085",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1085/facility-use-slots/10844#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 4,
    "startDate": "2021-07-10T20:37:10+00:00",
    "endDate": "2021-07-11T02:05:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1448#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1448/events/14475"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1396#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1396/events/13951"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1179/facility-use-slots/11790#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1179/facility-use-slots/11790"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1085/facility-use-slots/10844#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1085/facility-use-slots/10844"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2150.360988ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:32+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1448"
        },
        "maximumAttendeeCapacity": 27,
        "remainingAttendeeCapacity": 27
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1396"
        },
        "maximumAttendeeCapacity": 42,
        "remainingAttendeeCapacity": 42
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1179"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-08T05:53:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1085"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-10T20:37:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shyanne22@yahoo.com",
    "telephone": "203-824-8761 x335",
    "givenName": "Volkman",
    "familyName": "Felton",
    "identifier": "f4699e43-bd14-439b-a9ce-2be94e9e12d4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1769.027369ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:34+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c
...
---
Response status code: 201 Created. Responded in 1561.697872ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c#/orderedItems/2195",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1448#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c#/orderedItems/2196",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1448#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c#/orderedItems/2197",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1396#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c#/orderedItems/2198",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1179/facility-use-slots/11790#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c#/orderedItems/2199",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1179/facility-use-slots/11790#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c#/orderedItems/2200",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1085/facility-use-slots/10844#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c/versions/e1c8a172-5a52-4032-90fd-ab6c0917ab87",
  "payment": {
    "@type": "Payment",
    "identifier": "DSqnCJJTs",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c


---
Response status code: 200 OK. Responded in 305.256101ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 16.273745ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c


---
Response status code: 200 OK. Responded in 2541.419841ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c",
  "modified": 637607621194893400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c",
    "identifier": "5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c",
...
---
Response status code: 200 OK. Responded in 161.33212ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621183231936&afterId=a467c2cc-4a5e-472b-a866-7e008427784b",
  "message": "Listening for UUID: '5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c
...
---
Response status code: 201 Created. Responded in 916.574441ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c",
  "identifier": "5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 161.406028ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c",
  "modified": 637607621223887500
}
```
### Specs
* ✅ should return 200 on success
...
DELETE https://localhost:5001/api/openbooking/orders/5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c
...
---
Response status code: 204 No Content. Responded in 2257.242217ms.
...
---
Response status code: 204 No Content. Responded in 24.83946ms.
### Specs
* ✅ should return 204 on success
* ✅ should return 204 on success
