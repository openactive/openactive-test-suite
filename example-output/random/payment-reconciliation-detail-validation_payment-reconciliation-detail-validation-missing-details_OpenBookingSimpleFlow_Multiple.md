...
# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-missing-details (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 14 passed with 0 failures, 122 warnings and 32 suggestions 
...
---
Response status code: 200 OK. Responded in 12.026444ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/651/events/6505"
}
```
...
---
Response status code: 200 OK. Responded in 11.66711ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/388/events/3879"
}
```
...
---
Response status code: 200 OK. Responded in 11.489193ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/620/facility-use-slots/6197"
}
```
...
---
Response status code: 200 OK. Responded in 11.462791ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/476/facility-use-slots/4758"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F651%2Fevents%2F6505?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 35.596587ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/651/events/6505",
    "startDate": "2021-07-02T10:56:09+00:00",
    "endDate": "2021-07-02T13:09:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F388%2Fevents%2F3879?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 35.329561ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/388/events/3879",
    "startDate": "2021-07-08T10:26:09+00:00",
    "endDate": "2021-07-08T12:49:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F620%2Ffacility-use-slots%2F6197?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 34.176051ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/620",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/620/facility-use-slots/6197#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 15.21,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT15H13M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-06T06:04:10+00:00",
    "endDate": "2021-07-06T08:05:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F476%2Ffacility-use-slots%2F4758?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 33.628699ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/476/facility-use-slots/4758#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT23H44M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-11T10:15:10+00:00",
    "endDate": "2021-07-11T12:34:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d80044fb-c605-44cc-9dca-b5098d26922c
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/651/events/6505"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/388/events/3879"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/620/facility-use-slots/6197#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/620/facility-use-slots/6197"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/476/facility-use-slots/4758#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/476/facility-use-slots/4758"
    }
  ],
  "payment": {
    "@type": "Payment"
...
---
Response status code: 400 Bad Request. Responded in 253.518417ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d80044fb-c605-44cc-9dca-b5098d26922c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ellie.Pollich87@hotmail.com",
    "telephone": "1-974-201-0580",
    "givenName": "Schultz",
    "familyName": "Cletus",
    "identifier": "2b86e236-3b2c-44c8-bd5c-2c06fb7d348f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 80.454754ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
