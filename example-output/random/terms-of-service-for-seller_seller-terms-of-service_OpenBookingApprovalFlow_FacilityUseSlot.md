...
---
Response status code: 200 OK. Responded in 290.911253ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1677/facility-use-slots/16764"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1677%2Ffacility-use-slots%2F16764?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 376.580197ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1677/facility-use-slots/16764#/offers/0",
        ...
        "price": 16.15,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT11H51M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-02T20:05:10+00:00",
    "endDate": "2021-07-02T22:39:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/85b58dd8-ee50-49bc-9e4f-ad6d89531ce2
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1677/facility-use-slots/16764#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1677/facility-use-slots/16764"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 90.241678ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/85b58dd8-ee50-49bc-9e4f-ad6d89531ce2",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/85b58dd8-ee50-49bc-9e4f-ad6d89531ce2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Zetta_Wilderman@hotmail.com",
    "telephone": "(320) 979-5075",
    "givenName": "McClure",
    "familyName": "Rickey",
    "identifier": "fdf29fee-6666-48ca-8c3a-48e40b3b5be0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 125.573737ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/85b58dd8-ee50-49bc-9e4f-ad6d89531ce2
...
---
Response status code: 201 Created. Responded in 162.728968ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/85b58dd8-ee50-49bc-9e4f-ad6d89531ce2",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/85b58dd8-ee50-49bc-9e4f-ad6d89531ce2#/orderedItems/704",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1677/facility-use-slots/16764#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/85b58dd8-ee50-49bc-9e4f-ad6d89531ce2/versions/17065bf6-34a1-4e7b-a393-1cff441107f4",
  "payment": {
    "@type": "Payment",
    "identifier": "z2ruRuesF",
    "name": "AcmeBroker Points",
