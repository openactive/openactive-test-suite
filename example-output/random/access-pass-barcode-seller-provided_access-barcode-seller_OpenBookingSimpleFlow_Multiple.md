[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:43:24 GMT+0000 (Coordinated Universal Time)

# access-pass-barcode-seller-provided >> access-barcode-seller (OpenBookingSimpleFlow >> Multiple)

**Booking Flow:** OpenBookingSimpleFlow

**Opportunity Type:** Multiple

**Feature:** Access / accessPass - Seller provided access control barcodes  (Implemented) 

**Test:**  Successful booking with access barcode from seller.

Access pass contains barcode returned for B request from seller.

### Running only this test

```bash
npm start -- --runInBand test/features/access/access-pass-barcode-seller-provided/implemented/access-barcode-seller-test.js
```
...
---
Response status code: 200 OK. Responded in 469.70706ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/423/events/4226"
}
```
...
---
Response status code: 200 OK. Responded in 470.683852ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/84/events/838"
}
```
...
---
Response status code: 200 OK. Responded in 473.460617ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/272/facility-use-slots/2719"
}
```
...
---
Response status code: 200 OK. Responded in 473.822951ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/240/facility-use-slots/2396"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F423%2Fevents%2F4226?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 414.093272ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/423/events/4226",
    "startDate": "2021-07-06T22:23:09+00:00",
    "endDate": "2021-07-07T00:13:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 5.66,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT17H36M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F84%2Fevents%2F838?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 418.16786ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/84/events/838",
    "startDate": "2021-07-06T03:51:09+00:00",
    "endDate": "2021-07-06T07:28:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/84",
      "name": "Cotton Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/84#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F272%2Ffacility-use-slots%2F2719?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 415.74963ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/272/facility-use-slots/2719#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 2,
    "startDate": "2021-07-02T09:01:10+00:00",
    "endDate": "2021-07-02T10:32:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F240%2Ffacility-use-slots%2F2396?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 415.966551ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/240",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/240/facility-use-slots/2396#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 7,
    "startDate": "2021-07-08T18:47:10+00:00",
    "endDate": "2021-07-08T21:32:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2a6f0d4b-03ca-4284-aaf6-987fa33d0fd2
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/423#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/423/events/4226"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/84#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/84/events/838"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/272/facility-use-slots/2719#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/272/facility-use-slots/2719"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/240/facility-use-slots/2396#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/240/facility-use-slots/2396"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 477.571107ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2a6f0d4b-03ca-4284-aaf6-987fa33d0fd2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:34+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/84"
        },
        "maximumAttendeeCapacity": 35,
        "remainingAttendeeCapacity": 35
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/240"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-08T18:47:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2a6f0d4b-03ca-4284-aaf6-987fa33d0fd2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Laura.Zemlak27@hotmail.com",
    "telephone": "305.481.9322",
    "givenName": "Cruickshank",
    "familyName": "Graham",
    "identifier": "6e011659-b095-4969-a6ac-b882fb60d5d9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 749.878997ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:36+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2a6f0d4b-03ca-4284-aaf6-987fa33d0fd2
...
---
Response status code: 201 Created. Responded in 1046.786126ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/2a6f0d4b-03ca-4284-aaf6-987fa33d0fd2",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2a6f0d4b-03ca-4284-aaf6-987fa33d0fd2#/orderedItems/1231",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/423#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2a6f0d4b-03ca-4284-aaf6-987fa33d0fd2#/orderedItems/1232",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/423#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2a6f0d4b-03ca-4284-aaf6-987fa33d0fd2#/orderedItems/1233",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/84#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2a6f0d4b-03ca-4284-aaf6-987fa33d0fd2#/orderedItems/1234",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/272/facility-use-slots/2719#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2a6f0d4b-03ca-4284-aaf6-987fa33d0fd2#/orderedItems/1235",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/272/facility-use-slots/2719#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/2a6f0d4b-03ca-4284-aaf6-987fa33d0fd2#/orderedItems/1236",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/240/facility-use-slots/2396#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
* ✅ Response should include Barcode accessPass with url, text and codeType field
