...
---
Response status code: 200 OK. Responded in 253.922759ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1097/facility-use-slots/10961"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1097%2Ffacility-use-slots%2F10961?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 397.18789ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1097",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1097/facility-use-slots/10961#/offers/0",
    ...
    "endDate": "2021-07-07T21:04:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6cd392f8-1c82-41f3-a67e-41cfc4a8413f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1097/facility-use-slots/10961#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1097/facility-use-slots/10961"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 112.857738ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6cd392f8-1c82-41f3-a67e-41cfc4a8413f",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1097"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-07T18:30:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6cd392f8-1c82-41f3-a67e-41cfc4a8413f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jeffry_Casper30@gmail.com",
    "telephone": "(386) 831-6265 x09736",
    "givenName": "Kling",
    "familyName": "Kenny",
    "identifier": "5ddc75c8-fed8-4b0f-a21b-f3ccd86affec"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 249.266917ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6cd392f8-1c82-41f3-a67e-41cfc4a8413f
...
---
Response status code: 201 Created. Responded in 69.962357ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/6cd392f8-1c82-41f3-a67e-41cfc4a8413f",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6cd392f8-1c82-41f3-a67e-41cfc4a8413f#/orderedItems/349",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1097/facility-use-slots/10961#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/6cd392f8-1c82-41f3-a67e-41cfc4a8413f/versions/0fd860bb-e409-489f-bd6a-11573a25925b",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6cd392f8-1c82-41f3-a67e-41cfc4a8413f
...
---
Response status code: 500 Internal Server Error. Responded in 60.290136ms.
```json
{
  "@context": "https://openactive.io/",
