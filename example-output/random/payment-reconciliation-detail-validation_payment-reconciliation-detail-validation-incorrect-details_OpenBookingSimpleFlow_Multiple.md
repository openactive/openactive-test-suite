...
# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-incorrect-details (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 14 passed with 0 failures, 120 warnings and 32 suggestions 
...
---
Response status code: 200 OK. Responded in 38.380955ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/651/events/6501"
}
```
...
---
Response status code: 200 OK. Responded in 37.013325ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/718/events/7177"
}
```
...
---
Response status code: 200 OK. Responded in 35.858016ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/381/facility-use-slots/3804"
}
```
...
---
Response status code: 200 OK. Responded in 46.641142ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/187/facility-use-slots/1864"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F651%2Fevents%2F6501?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 30.825936ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/651/events/6501",
    "startDate": "2021-07-02T13:00:09+00:00",
    "endDate": "2021-07-02T15:05:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/651",
      "name": "Granite Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/651#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingPrepayment": "https://openactive.io/Required",
          "price": 15.71,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT15H35M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F718%2Fevents%2F7177?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 30.106068ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/718/events/7177",
    "startDate": "2021-07-03T09:59:09+00:00",
    "endDate": "2021-07-03T15:33:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/718",
      "name": "Cotton Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/718#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Required",
          "price": 12,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P3DT32M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F381%2Ffacility-use-slots%2F3804?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 29.442204ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/381/facility-use-slots/3804#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 14.8,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT14H4M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-06T15:02:10+00:00",
    "endDate": "2021-07-06T19:00:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F187%2Ffacility-use-slots%2F1864?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 28.930755ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/187",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/187/facility-use-slots/1864#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 8,
    "startDate": "2021-07-08T06:41:10+00:00",
    "endDate": "2021-07-08T11:21:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c3bb0e34-9102-44a6-8062-612951b7af7d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/651#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/651/events/6501"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/718#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/718/events/7177"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/381/facility-use-slots/3804#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/381/facility-use-slots/3804"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/187/facility-use-slots/1864#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/187/facility-use-slots/1864"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-4miJW8cLiy",
    "accountId": "invalid-pqYu4I6D1",
    "paymentProviderId": "invalid-UcIE7iQTiL"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 1852.763163ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c3bb0e34-9102-44a6-8062-612951b7af7d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Terence40@hotmail.com",
    "telephone": "558.998.4803 x392",
    "givenName": "Roob",
    "familyName": "Jennie",
    "identifier": "ef0c8deb-4656-4785-8ec4-60be9c1d2536"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-5peYF0Ch1H",
    "accountId": "invalid-hqgxcPnl-",
    "paymentProviderId": "invalid-vV_EPpSGg6"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 128.237014ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
