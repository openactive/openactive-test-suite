...
---
Response status code: 200 OK. Responded in 326.412829ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13855"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1386%2Ffacility-use-slots%2F13855?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 409.41812ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13855#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT6H23M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-08T06:16:10+00:00",
    "endDate": "2021-07-08T11:31:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/569033c8-4335-49bb-b0b6-2314b952fee7
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13855"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 53.930827ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/569033c8-4335-49bb-b0b6-2314b952fee7",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/569033c8-4335-49bb-b0b6-2314b952fee7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Allie_Mitchell58@yahoo.com",
    "telephone": "1-417-787-2517 x29005",
    "givenName": "Bradtke",
    "familyName": "Alyson",
    "identifier": "384e4230-543e-4395-9345-949dcbc7f349"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 46.982167ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/569033c8-4335-49bb-b0b6-2314b952fee7
...
---
Response status code: 409 Conflict. Responded in 30.40199ms.
```json
{
  "@context": "https://openactive.io/",
