...
---
Response status code: 200 OK. Responded in 136.076161ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/311/events/3109"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F311%2Fevents%2F3109?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 39.001615ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/311/events/3109",
    "startDate": "2021-07-09T10:45:09+00:00",
    "endDate": "2021-07-09T15:44:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5b8e749c-65d5-4dec-91e4-9f86d302ede3
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/311/events/3109"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-EO0udGOPJv",
    "accountId": "invalid-6A_xwdSNo",
    "paymentProviderId": "invalid-qu_u-T9Zev"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 425.556736ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5b8e749c-65d5-4dec-91e4-9f86d302ede3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Roma_Rempel@yahoo.com",
    "telephone": "(664) 949-3896",
    "givenName": "Sauer",
    "familyName": "Sven",
    "identifier": "53869b1f-fbde-407d-aeb6-a73b5743d144"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-yTleEZP23Q",
    "accountId": "invalid-jETPuIJP1",
    "paymentProviderId": "invalid-DGM_ZK7rX-"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 44.968583ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
