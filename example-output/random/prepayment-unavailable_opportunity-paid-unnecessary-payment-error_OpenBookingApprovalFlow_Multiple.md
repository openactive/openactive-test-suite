...
# prepayment-unavailable >> opportunity-paid-unnecessary-payment-error (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 17 passed with 0 failures, 284 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 43.751274ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1473/events/14728"
}
```
...
---
Response status code: 200 OK. Responded in 41.832591ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1524/events/15238"
}
```
...
---
Response status code: 200 OK. Responded in 39.989715ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1398/facility-use-slots/13980"
}
```
...
---
Response status code: 200 OK. Responded in 33.577604ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1491/facility-use-slots/14909"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1473%2Fevents%2F14728?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 34.239766ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1473/events/14728",
    "startDate": "2021-07-08T10:09:09+00:00",
    "endDate": "2021-07-08T10:50:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1473",
      "name": "Cotton Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1473#/offers/0",
          ...
          "price": 7.06,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT14H57M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1524%2Fevents%2F15238?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 33.164364ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1524/events/15238",
    "startDate": "2021-07-10T00:16:09+00:00",
    "endDate": "2021-07-10T05:46:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1524",
      "name": "Frozen Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1524#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT7H35M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1398%2Ffacility-use-slots%2F13980?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 32.199172ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1398/facility-use-slots/13980#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        ...
        "price": 18.43,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT11H12M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-05T11:39:10+00:00",
    "endDate": "2021-07-05T14:20:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1491%2Ffacility-use-slots%2F14909?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 31.587213ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1491",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1491/facility-use-slots/14909#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT13M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-08T08:59:10+00:00",
    "endDate": "2021-07-08T11:55:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/45792da8-a6f6-4d11-a81c-cd57ecd67ced
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1473#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1473/events/14728"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1524#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1524/events/15238"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1398/facility-use-slots/13980#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1398/facility-use-slots/13980"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1491/facility-use-slots/14909#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1491/facility-use-slots/14909"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1528.369183ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/45792da8-a6f6-4d11-a81c-cd57ecd67ced",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:45+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1473"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1524"
        },
        "maximumAttendeeCapacity": 42,
        "remainingAttendeeCapacity": 42
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1491"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-08T08:59:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/45792da8-a6f6-4d11-a81c-cd57ecd67ced
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Yolanda.Hegmann@yahoo.com",
    "telephone": "358-214-2314 x9438",
    "givenName": "Swift",
    "familyName": "Adelle",
    "identifier": "62ae03db-597a-4c53-b46d-9f50c3617b94"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 3226.132958ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:48+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/45792da8-a6f6-4d11-a81c-cd57ecd67ced
...
---
Response status code: 400 Bad Request. Responded in 55.57528ms.
```json
{
  "@context": "https://openactive.io/",
...
```
### Specs
* ✅ should return a response containing `"@type": "UnnecessaryPaymentDetailsError"` with status code `400`
...
### Validations
 * ⚠️ $.instance: Recommended property `instance` is missing from `UnnecessaryPaymentDetailsError`.
