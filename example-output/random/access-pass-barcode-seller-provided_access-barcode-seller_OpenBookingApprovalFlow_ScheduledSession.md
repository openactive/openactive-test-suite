...
# access-pass-barcode-seller-provided >> access-barcode-seller (OpenBookingApprovalFlow >> ScheduledSession)
...
⚠️ 10 passed with 0 failures, 95 warnings and 32 suggestions 
...
---
Response status code: 200 OK. Responded in 536.988233ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1146/events/11454"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1146%2Fevents%2F11454?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 192.331278ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1146/events/11454",
    "startDate": "2021-07-11T09:54:09+00:00",
    "endDate": "2021-07-11T10:50:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1146/events/11454"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 234.920426ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Felicity78@gmail.com",
    "telephone": "(424) 277-9198 x116",
    "givenName": "Maggio",
    "familyName": "Marilyne",
    "identifier": "31df907b-aa06-4e52-a823-ca279eb6c7e8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 720.034029ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c
...
---
Response status code: 201 Created. Responded in 303.120507ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c#/orderedItems/1265",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1146#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c/versions/abb5a879-5cef-44d4-bbf7-a99494d1ad2d",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c


---
Response status code: 200 OK. Responded in 569.57683ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607618097218517&afterId=e39db959-39df-4348-82b3-237e6de75916",
  "message": "Listening for UUID: '1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 29.847337ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c


---
Response status code: 200 OK. Responded in 3030.705825ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c",
  "modified": 637607618275392100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c",
    "identifier": "1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c",
...
---
Response status code: 200 OK. Responded in 280.222031ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c
...
---
Response status code: 201 Created. Responded in 167.278998ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c",
  "identifier": "1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1371.087762ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "1a42bc6c-87ed-4b37-96ed-8be4be9cfe0c",
  "modified": 637607618310036100
}
```
### Specs
* ✅ should return 200 on success
