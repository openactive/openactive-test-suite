...
---
Response status code: 200 OK. Responded in 33.044742ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/361/events/3601"
}
```
...
---
Response status code: 200 OK. Responded in 31.748319ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/728/facility-use-slots/7279"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F361%2Fevents%2F3601?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 92.148762ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/361/events/3601",
    "startDate": "2021-07-03T13:49:09+00:00",
    "endDate": "2021-07-03T16:32:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F728%2Ffacility-use-slots%2F7279?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 93.083551ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/728",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/728/facility-use-slots/7279#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 14.47,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT18H53M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-04T12:44:10+00:00",
    "endDate": "2021-07-04T13:23:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/59826ee5-0c93-4bb8-92b2-8e3482c04494
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/361/events/3601"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/728/facility-use-slots/7279#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/728/facility-use-slots/7279"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1308.565026ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/59826ee5-0c93-4bb8-92b2-8e3482c04494",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:56:55+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/728"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-04T12:44:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/59826ee5-0c93-4bb8-92b2-8e3482c04494
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Delbert_Kuhn90@hotmail.com",
    "telephone": "883-473-6323 x155",
    "givenName": "Becker",
    "familyName": "Jazmin",
    "identifier": "48cb6c59-27b7-44e6-a88c-fcd190a5b058"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1529.66175ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/59826ee5-0c93-4bb8-92b2-8e3482c04494
...
---
Response status code: 400 Bad Request. Responded in 230.825249ms.
```json
{
  "@context": "https://openactive.io/",
