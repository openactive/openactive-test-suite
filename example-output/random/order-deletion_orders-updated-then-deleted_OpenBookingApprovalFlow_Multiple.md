...
# order-deletion >> orders-updated-then-deleted (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 25 passed with 0 failures, 511 warnings and 130 suggestions 
...
---
Response status code: 200 OK. Responded in 316.320375ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1319/events/13183"
}
```
...
---
Response status code: 200 OK. Responded in 317.354873ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1499/events/14985"
}
```
...
---
Response status code: 200 OK. Responded in 322.624475ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1257/facility-use-slots/12561"
}
```
...
---
Response status code: 200 OK. Responded in 323.510158ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1410/facility-use-slots/14097"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1319%2Fevents%2F13183?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 521.038038ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1319/events/13183",
    "startDate": "2021-07-11T16:35:09+00:00",
    "endDate": "2021-07-11T17:09:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1319",
      "name": "Concrete Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1319#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1499%2Fevents%2F14985?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 522.232752ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1499/events/14985",
    "startDate": "2021-07-03T05:07:09+00:00",
    "endDate": "2021-07-03T10:18:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1499",
      "name": "Wooden Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1499#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval",
            "https://openactive.io/OpenBookingNegotiation"
          ...
          "price": 9.13,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT8H17M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1257%2Ffacility-use-slots%2F12561?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 524.31715ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1257",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1257/facility-use-slots/12561#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 6,
    "startDate": "2021-07-04T13:49:10+00:00",
    "endDate": "2021-07-04T16:00:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1410%2Ffacility-use-slots%2F14097?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 522.677595ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1410",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1410/facility-use-slots/14097#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT19H41M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-01T22:02:10+00:00",
    "endDate": "2021-07-02T03:55:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/639ec36e-d3e2-4749-89d5-874e0c80728b
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1319#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1319/events/13183"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1499#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1499/events/14985"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1257/facility-use-slots/12561#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1257/facility-use-slots/12561"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1410/facility-use-slots/14097#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1410/facility-use-slots/14097"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 283.35784ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/639ec36e-d3e2-4749-89d5-874e0c80728b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:45:17+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1319"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1499"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1257"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-04T13:49:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1410"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-01T22:02:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/639ec36e-d3e2-4749-89d5-874e0c80728b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Roberta.Senger0@hotmail.com",
    "telephone": "736.256.9416 x2425",
    "givenName": "Daniel",
    "familyName": "Reyna",
    "identifier": "f9c3f556-a54d-4ea7-93cf-cf2c55321e48"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 305.696763ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:45:18+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/639ec36e-d3e2-4749-89d5-874e0c80728b
...
---
Response status code: 201 Created. Responded in 225.947782ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/639ec36e-d3e2-4749-89d5-874e0c80728b",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/639ec36e-d3e2-4749-89d5-874e0c80728b#/orderedItems/598",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1319#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/639ec36e-d3e2-4749-89d5-874e0c80728b#/orderedItems/599",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1319#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/639ec36e-d3e2-4749-89d5-874e0c80728b#/orderedItems/600",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1499#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/639ec36e-d3e2-4749-89d5-874e0c80728b#/orderedItems/601",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1257/facility-use-slots/12561#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/639ec36e-d3e2-4749-89d5-874e0c80728b#/orderedItems/602",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1257/facility-use-slots/12561#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/639ec36e-d3e2-4749-89d5-874e0c80728b#/orderedItems/603",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1410/facility-use-slots/14097#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/639ec36e-d3e2-4749-89d5-874e0c80728b/versions/4157db01-cc22-4ed4-b2ea-e560c4e1cb06",
  "payment": {
    "@type": "Payment",
    "identifier": "Vrzw-oE__",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;639ec36e-d3e2-4749-89d5-874e0c80728b&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/639ec36e-d3e2-4749-89d5-874e0c80728b


---
Response status code: 200 OK. Responded in 335.167566ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607616160391856&afterId=028b448a-17bf-42da-ab58-83b7ac5a5227",
  "message": "Listening for UUID: '639ec36e-d3e2-4749-89d5-874e0c80728b' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 70.743226ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;639ec36e-d3e2-4749-89d5-874e0c80728b&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/639ec36e-d3e2-4749-89d5-874e0c80728b


---
Response status code: 200 OK. Responded in 3240.967561ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "639ec36e-d3e2-4749-89d5-874e0c80728b",
  "modified": 637607616205100700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/639ec36e-d3e2-4749-89d5-874e0c80728b",
    "identifier": "639ec36e-d3e2-4749-89d5-874e0c80728b",
...
---
Response status code: 200 OK. Responded in 229.346886ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607616195973827&afterId=028b448a-17bf-42da-ab58-83b7ac5a5227",
  "message": "Listening for UUID: '639ec36e-d3e2-4749-89d5-874e0c80728b' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/639ec36e-d3e2-4749-89d5-874e0c80728b
...
---
Response status code: 201 Created. Responded in 168.611617ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/639ec36e-d3e2-4749-89d5-874e0c80728b",
  "identifier": "639ec36e-d3e2-4749-89d5-874e0c80728b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 198.095917ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "639ec36e-d3e2-4749-89d5-874e0c80728b",
  "modified": 637607616241750000
}
```
### Specs
* ✅ should return 200 on success
...
### Orders (orders) Feed listen for &#x27;639ec36e-d3e2-4749-89d5-874e0c80728b&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/639ec36e-d3e2-4749-89d5-874e0c80728b


---
Response status code: 200 OK. Responded in 297.821991ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607616243214331&afterId=4242c602-0d7b-446a-b352-92a419aba8dd",
  "message": "Listening for UUID: '639ec36e-d3e2-4749-89d5-874e0c80728b' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 125.372709ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation)

### Orders (orders) Feed collect for &#x27;639ec36e-d3e2-4749-89d5-874e0c80728b&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/639ec36e-d3e2-4749-89d5-874e0c80728b


---
Response status code: 200 OK. Responded in 2828.624434ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "639ec36e-d3e2-4749-89d5-874e0c80728b",
  "modified": 637607616281912700,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
---
Response status code: 200 OK. Responded in 178.527992ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607616281912725&afterId=639ec36e-d3e2-4749-89d5-874e0c80728b",
  "message": "Listening for UUID: '639ec36e-d3e2-4749-89d5-874e0c80728b' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/639ec36e-d3e2-4749-89d5-874e0c80728b
...
---
Response status code: 204 No Content. Responded in 199.494788ms.
### Specs
* ✅ should return 204 on success
...
---
Response status code: 200 OK. Responded in 2261.184019ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "639ec36e-d3e2-4749-89d5-874e0c80728b",
  "modified": 637607616339684600
}
```
### Specs
* ✅ should return 200 on success
