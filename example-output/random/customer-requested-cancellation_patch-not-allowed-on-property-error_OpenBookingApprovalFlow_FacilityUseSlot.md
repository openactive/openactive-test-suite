...
---
Response status code: 200 OK. Responded in 175.064503ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14407"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1441%2Ffacility-use-slots%2F14407?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 160.426515ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14407#/offers/0",
        ...
        "price": 11.72,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT5H21M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-08T14:12:10+00:00",
    "endDate": "2021-07-08T16:48:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14407#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14407"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 83.518621ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:19+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jerad.Schowalter69@gmail.com",
    "telephone": "653.775.7414",
    "givenName": "King",
    "familyName": "Jaqueline",
    "identifier": "575036c4-db4c-4f22-8ffd-c81edef6c0e1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 267.637382ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:20+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3
...
---
Response status code: 201 Created. Responded in 113.34795ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3#/orderedItems/1623",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14407#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3/versions/0544cab5-a732-4c5d-a9e1-937d11ba90de",
  "payment": {
    "@type": "Payment",
    "identifier": "uLjKP_4sT",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3


---
Response status code: 200 OK. Responded in 213.159716ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 45.953458ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3


---
Response status code: 200 OK. Responded in 2670.64038ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3",
  "modified": 637607619209819600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3",
    "identifier": "06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3",
...
---
Response status code: 200 OK. Responded in 143.256886ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619194494113&afterId=dccdc761-caf6-4234-ae7d-0909e1a4ab77",
  "message": "Listening for UUID: '06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3
...
---
Response status code: 201 Created. Responded in 123.253589ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3",
  "identifier": "06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 2070.535567ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3",
  "modified": 637607619238589200
}
```
### Specs
* ✅ should return 200 on success
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3
...
---
Response status code: 400 Bad Request. Responded in 31.988433ms.
```json
{
  "@context": "https://openactive.io/",
