...
# reseller-broker >> customer-included-resellerbroker-mode (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 145.446318ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/312/facility-use-slots/3111"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F312%2Ffacility-use-slots%2F3111?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 103.060091ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/312",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/312/facility-use-slots/3111#/offers/0",
    ...
    "remainingUses": 4,
    "startDate": "2021-07-11T10:57:10+00:00",
    "endDate": "2021-07-11T16:04:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ae7e5568-a0aa-4bff-8657-f0666a1d05ff
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/312/facility-use-slots/3111#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/312/facility-use-slots/3111"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 505.210847ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ae7e5568-a0aa-4bff-8657-f0666a1d05ff",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ae7e5568-a0aa-4bff-8657-f0666a1d05ff
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Penelope_Schuster@hotmail.com",
    "telephone": "(963) 490-4774 x9360",
    "givenName": "Gutmann",
    "familyName": "Abel",
    "identifier": "e213af7e-3bbb-4215-8dfd-3dd4674aff54"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 598.720256ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:28+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ae7e5568-a0aa-4bff-8657-f0666a1d05ff
...
---
Response status code: 201 Created. Responded in 451.183922ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ae7e5568-a0aa-4bff-8657-f0666a1d05ff",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ae7e5568-a0aa-4bff-8657-f0666a1d05ff#/orderedItems/2340",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/312/facility-use-slots/3111#/offers/0",
        "allowCustomerCancellationFullRefund": true,
