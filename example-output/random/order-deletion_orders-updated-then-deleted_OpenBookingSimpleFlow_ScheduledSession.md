...
# order-deletion >> orders-updated-then-deleted (OpenBookingSimpleFlow >> ScheduledSession)
...
⚠️ 11 passed with 0 failures, 84 warnings and 28 suggestions 
...
---
Response status code: 200 OK. Responded in 670.915813ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/353/events/3529"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F353%2Fevents%2F3529?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 382.258058ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/353/events/3529",
    "startDate": "2021-07-10T18:25:09+00:00",
    "endDate": "2021-07-10T23:06:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/353",
      "name": "Steel Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/353#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT5H19M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/353#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/353/events/3529"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 131.045138ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/353"
        },
        "maximumAttendeeCapacity": 41,
        "remainingAttendeeCapacity": 41
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Wilton.Batz@gmail.com",
    "telephone": "879.886.7162",
    "givenName": "Huel",
    "familyName": "Gregoria",
    "identifier": "1004a0ad-4b97-4c30-91b2-ba2f403272dd"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 92.230653ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c
...
---
Response status code: 201 Created. Responded in 112.146744ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c#/orderedItems/397",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/353#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Orders (orders) Feed listen for &#x27;a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c


---
Response status code: 200 OK. Responded in 341.925153ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607615357378040&afterId=d373823d-ae35-484f-80a2-d5d03ca15222",
  "message": "Listening for UUID: 'a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 95.582172ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation)

### Orders (orders) Feed collect for &#x27;a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c


---
Response status code: 200 OK. Responded in 3421.513139ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c",
  "modified": 637607615473834000,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c",
    "identifier": "a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c#/orderedItems/397",
...
---
Response status code: 200 OK. Responded in 178.937647ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
DELETE https://localhost:5001/api/openbooking/orders/a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c
...
---
Response status code: 204 No Content. Responded in 164.469369ms.
### Specs
* ✅ should return 204 on success
...
---
Response status code: 200 OK. Responded in 2574.322352ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a4b2c9c4-fbde-45cf-9f7d-8ee85f48b89c",
  "modified": 637607615516765800
}
```
### Specs
* ✅ should return 200 on success
