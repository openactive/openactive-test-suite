[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:39:26 GMT+0000 (Coordinated Universal Time)

# prepayment-required-unavailable >> prepayment-required-unavailable-conflict-error (OpenBookingApprovalFlow >> Multiple)
...
---
Response status code: 200 OK. Responded in 286.739566ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1406/events/14051"
}
```
...
---
Response status code: 200 OK. Responded in 287.30642ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1473/events/14727"
}
```
...
---
Response status code: 200 OK. Responded in 288.03619ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1370/events/13696"
}
```
...
---
Response status code: 200 OK. Responded in 264.520453ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1583/facility-use-slots/15829"
}
```
...
---
Response status code: 200 OK. Responded in 267.1092ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1542/facility-use-slots/15415"
}
```
...
---
Response status code: 200 OK. Responded in 268.197104ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1274/facility-use-slots/12740"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1406%2Fevents%2F14051?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 168.764648ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1406/events/14051",
    "startDate": "2021-07-07T16:29:09+00:00",
    "endDate": "2021-07-07T19:15:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1473%2Fevents%2F14727?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 167.595637ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1473/events/14727",
    "startDate": "2021-07-11T03:44:09+00:00",
    "endDate": "2021-07-11T05:40:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1370%2Fevents%2F13696?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 166.826964ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1370/events/13696",
    "startDate": "2021-07-06T00:29:09+00:00",
    "endDate": "2021-07-06T01:19:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1583%2Ffacility-use-slots%2F15829?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 165.989484ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1583",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1583/facility-use-slots/15829#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 6.91,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT21H35M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-11T01:08:10+00:00",
    "endDate": "2021-07-11T04:37:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 4 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1542%2Ffacility-use-slots%2F15415?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 165.140003ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1542/facility-use-slots/15415#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ...
        "price": 18.05,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT22H32M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-10T07:03:10+00:00",
    "endDate": "2021-07-10T08:17:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1274%2Ffacility-use-slots%2F12740?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 164.318625ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1274",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1274/facility-use-slots/12740#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 7,
    "startDate": "2021-07-02T11:42:10+00:00",
    "endDate": "2021-07-02T16:40:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/46bad811-a033-4af7-9dc1-3b99d9ba7a78
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1406/events/14051"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1473#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1473/events/14727"
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1370#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1370/events/13696"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1583/facility-use-slots/15829#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1583/facility-use-slots/15829"
    },
    {
      "@type": "OrderItem",
      "position": 4,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1542/facility-use-slots/15415#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1542/facility-use-slots/15415"
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1274/facility-use-slots/12740#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1274/facility-use-slots/12740"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 191.3919ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/46bad811-a033-4af7-9dc1-3b99d9ba7a78",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1583"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-11T01:08:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1274"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-02T11:42:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/46bad811-a033-4af7-9dc1-3b99d9ba7a78
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Monique_Rowe7@gmail.com",
    "telephone": "1-795-570-1551 x654",
    "givenName": "Hyatt",
    "familyName": "Rachel",
    "identifier": "f245af76-592c-4c61-a028-8a05efbcc3e3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 225.648031ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/46bad811-a033-4af7-9dc1-3b99d9ba7a78
...
---
Response status code: 409 Conflict. Responded in 190.596501ms.
```json
{
  "@context": "https://openactive.io/",
