[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:53:51 GMT+0000 (Coordinated Universal Time)
...
⚠️ 18 passed with 0 failures, 375 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 46.526408ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/597/events/5969"
}
```
...
---
Response status code: 200 OK. Responded in 44.998062ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/431/events/4303"
}
```
...
---
Response status code: 200 OK. Responded in 35.046414ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5078"
}
```
...
---
Response status code: 200 OK. Responded in 33.688685ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/255/facility-use-slots/2548"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F597%2Fevents%2F5969?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 67.553195ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/597/events/5969",
    "startDate": "2021-07-11T04:45:09+00:00",
    "endDate": "2021-07-11T10:40:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/597",
      "name": "Steel Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/597#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingPrepayment": "https://openactive.io/Required",
          "price": 6.1,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT23H7M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F431%2Fevents%2F4303?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 66.598106ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/431/events/4303",
    "startDate": "2021-07-09T09:12:09+00:00",
    "endDate": "2021-07-09T11:19:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 1.03,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT16H58M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F508%2Ffacility-use-slots%2F5078?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 65.617114ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5078#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 10.37,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT20H"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-03T01:28:10+00:00",
    "endDate": "2021-07-03T07:19:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F255%2Ffacility-use-slots%2F2548?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 65.009858ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/255",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/255/facility-use-slots/2548#/offers/0",
    ...
    "remainingUses": 7,
    "startDate": "2021-07-06T12:42:10+00:00",
    "endDate": "2021-07-06T13:47:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d59678a8-9dec-44cf-9a9c-aacad7285cc4
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/597#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/597/events/5969"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/431/events/4303"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5078#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5078"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/255/facility-use-slots/2548#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/255/facility-use-slots/2548"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2427.32859ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d59678a8-9dec-44cf-9a9c-aacad7285cc4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:03+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/597"
        },
        "maximumAttendeeCapacity": 42,
        "remainingAttendeeCapacity": 42
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/255"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-06T12:42:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d59678a8-9dec-44cf-9a9c-aacad7285cc4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alana_Maggio7@yahoo.com",
    "telephone": "943.212.1213 x10864",
    "givenName": "Ullrich",
    "familyName": "Rosie",
    "identifier": "0aa7d89b-ada5-4817-b081-5e822f61975b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1642.2872360000001ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:05+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d59678a8-9dec-44cf-9a9c-aacad7285cc4
...
---
Response status code: 201 Created. Responded in 1324.467412ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d59678a8-9dec-44cf-9a9c-aacad7285cc4",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d59678a8-9dec-44cf-9a9c-aacad7285cc4#/orderedItems/3029",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/597#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d59678a8-9dec-44cf-9a9c-aacad7285cc4#/orderedItems/3030",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/597#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d59678a8-9dec-44cf-9a9c-aacad7285cc4#/orderedItems/3031",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/431#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d59678a8-9dec-44cf-9a9c-aacad7285cc4#/orderedItems/3032",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5078#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d59678a8-9dec-44cf-9a9c-aacad7285cc4#/orderedItems/3033",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5078#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d59678a8-9dec-44cf-9a9c-aacad7285cc4#/orderedItems/3034",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/255/facility-use-slots/2548#/offers/0",
        "allowCustomerCancellationFullRefund": true,
