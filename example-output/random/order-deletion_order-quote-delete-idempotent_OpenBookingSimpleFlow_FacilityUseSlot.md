...
---
Response status code: 200 OK. Responded in 239.129132ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5509"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F551%2Ffacility-use-slots%2F5509?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 214.611201ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5509#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 1.91,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT2H54M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-10T03:15:10+00:00",
    "endDate": "2021-07-10T09:12:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8ea29107-727d-4888-b6b5-5d9fbad55f5b
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5509#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5509"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 721.087849ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8ea29107-727d-4888-b6b5-5d9fbad55f5b",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8ea29107-727d-4888-b6b5-5d9fbad55f5b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Camille68@gmail.com",
    "telephone": "1-974-704-2936",
    "givenName": "O'Connell",
    "familyName": "Marguerite",
    "identifier": "0357e82f-42c5-4013-929a-c72b41235f5e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 178.377057ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
DELETE https://localhost:5001/api/openbooking/order-quotes/8ea29107-727d-4888-b6b5-5d9fbad55f5b
...
---
Response status code: 204 No Content. Responded in 718.749235ms.
...
---
Response status code: 204 No Content. Responded in 16.649283ms.
### Specs
