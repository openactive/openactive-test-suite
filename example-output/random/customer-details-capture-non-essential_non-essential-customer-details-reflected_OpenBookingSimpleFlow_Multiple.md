...
# customer-details-capture-non-essential >> non-essential-customer-details-reflected (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 17 passed with 0 failures, 374 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 465.887247ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/649/events/6484"
}
```
...
---
Response status code: 200 OK. Responded in 469.584497ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/437/events/4366"
}
```
...
---
Response status code: 200 OK. Responded in 471.812309ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/417/facility-use-slots/4162"
}
```
...
---
Response status code: 200 OK. Responded in 478.590253ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/631/facility-use-slots/6304"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F649%2Fevents%2F6484?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 334.625981ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/649/events/6484",
    "startDate": "2021-07-04T10:45:09+00:00",
    "endDate": "2021-07-04T14:57:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/649",
      "name": "Wooden Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/649#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 17.45,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT13H16M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F437%2Fevents%2F4366?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 338.388238ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/437/events/4366",
    "startDate": "2021-07-08T11:03:09+00:00",
    "endDate": "2021-07-08T13:21:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/437",
      "name": "Fresh Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/437#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingPrepayment": "https://openactive.io/Required",
          "price": 7.43,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT11H9M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F417%2Ffacility-use-slots%2F4162?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 338.885985ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/417",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/417/facility-use-slots/4162#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 8.4,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT3H3M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-09T12:26:10+00:00",
    "endDate": "2021-07-09T17:36:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F631%2Ffacility-use-slots%2F6304?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 339.381432ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/631",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/631/facility-use-slots/6304#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 8.3,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT23H34M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-07T02:59:10+00:00",
    "endDate": "2021-07-07T08:08:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/49405858-c184-40dc-9c5e-7e4d3a719bc6
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/649#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/649/events/6484"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/437#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/437/events/4366"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/417/facility-use-slots/4162#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/417/facility-use-slots/4162"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/631/facility-use-slots/6304#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/631/facility-use-slots/6304"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 358.046405ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/49405858-c184-40dc-9c5e-7e4d3a719bc6",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:09+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/649"
        },
        "maximumAttendeeCapacity": 40,
        "remainingAttendeeCapacity": 40
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/437"
        },
        "maximumAttendeeCapacity": 24,
        "remainingAttendeeCapacity": 24
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/417"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-09T12:26:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/631"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-07T02:59:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/49405858-c184-40dc-9c5e-7e4d3a719bc6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sofia_Jakubowski26@yahoo.com",
    "telephone": "1-766-946-8353",
    "givenName": "Leffler",
    "familyName": "Vickie",
    "identifier": "26a9e3f1-815a-4488-a3cd-2736963cde05"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 416.240631ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:10+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/49405858-c184-40dc-9c5e-7e4d3a719bc6
...
---
Response status code: 201 Created. Responded in 442.073644ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/49405858-c184-40dc-9c5e-7e4d3a719bc6",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/49405858-c184-40dc-9c5e-7e4d3a719bc6#/orderedItems/786",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/649#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/49405858-c184-40dc-9c5e-7e4d3a719bc6#/orderedItems/787",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/649#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/49405858-c184-40dc-9c5e-7e4d3a719bc6#/orderedItems/788",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/437#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/49405858-c184-40dc-9c5e-7e4d3a719bc6#/orderedItems/789",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/417/facility-use-slots/4162#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/49405858-c184-40dc-9c5e-7e4d3a719bc6#/orderedItems/790",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/417/facility-use-slots/4162#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/49405858-c184-40dc-9c5e-7e4d3a719bc6#/orderedItems/791",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/631/facility-use-slots/6304#/offers/0",
        "allowCustomerCancellationFullRefund": true,
