...
⚠️ 22 passed with 0 failures, 515 warnings and 130 suggestions 
...
---
Response status code: 200 OK. Responded in 402.446804ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1497/events/14970"
}
```
...
---
Response status code: 200 OK. Responded in 402.754834ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1490/events/14892"
}
```
...
---
Response status code: 200 OK. Responded in 403.034061ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1584/facility-use-slots/15831"
}
```
...
---
Response status code: 200 OK. Responded in 407.609297ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1098/facility-use-slots/10972"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1497%2Fevents%2F14970?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 453.335648ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1497/events/14970",
    "startDate": "2021-07-08T23:27:09+00:00",
    "endDate": "2021-07-09T03:01:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1490%2Fevents%2F14892?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 454.054717ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1490/events/14892",
    "startDate": "2021-07-05T06:47:09+00:00",
    "endDate": "2021-07-05T07:29:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1584%2Ffacility-use-slots%2F15831?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 454.813589ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1584",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1584/facility-use-slots/15831#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT12H42M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-02T13:08:10+00:00",
    "endDate": "2021-07-02T18:23:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1098%2Ffacility-use-slots%2F10972?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 456.936991ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1098",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1098/facility-use-slots/10972#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 3,
    "startDate": "2021-07-01T23:29:10+00:00",
    "endDate": "2021-07-02T04:32:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c1f877c8-9ef5-46aa-a7da-801199ea0a3a
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1497/events/14970"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1490/events/14892"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1584/facility-use-slots/15831#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1584/facility-use-slots/15831"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1098/facility-use-slots/10972#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1098/facility-use-slots/10972"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 467.192504ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c1f877c8-9ef5-46aa-a7da-801199ea0a3a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:45:41+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1098"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-01T23:29:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c1f877c8-9ef5-46aa-a7da-801199ea0a3a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Raquel_Metz95@yahoo.com",
    "telephone": "660.943.0859 x5866",
    "givenName": "Welch",
    "familyName": "Fabiola",
    "identifier": "9a0c2e65-509e-41cf-953a-7a11e5ab9984"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 364.990191ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/c1f877c8-9ef5-46aa-a7da-801199ea0a3a
...
---
Response status code: 201 Created. Responded in 545.184317ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/c1f877c8-9ef5-46aa-a7da-801199ea0a3a",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1f877c8-9ef5-46aa-a7da-801199ea0a3a#/orderedItems/690",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1497#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1f877c8-9ef5-46aa-a7da-801199ea0a3a#/orderedItems/691",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1497#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1f877c8-9ef5-46aa-a7da-801199ea0a3a#/orderedItems/692",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1490#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1f877c8-9ef5-46aa-a7da-801199ea0a3a#/orderedItems/693",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1584/facility-use-slots/15831#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1f877c8-9ef5-46aa-a7da-801199ea0a3a#/orderedItems/694",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1584/facility-use-slots/15831#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c1f877c8-9ef5-46aa-a7da-801199ea0a3a#/orderedItems/695",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1098/facility-use-slots/10972#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/c1f877c8-9ef5-46aa-a7da-801199ea0a3a/versions/f84935e7-b5f7-49e9-8f28-eb1bf8386da4",
  "payment": {
    "@type": "Payment",
    "identifier": "OvFSPmnQ9",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;c1f877c8-9ef5-46aa-a7da-801199ea0a3a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/c1f877c8-9ef5-46aa-a7da-801199ea0a3a


---
Response status code: 200 OK. Responded in 284.135606ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607616301608273&afterId=38096117-528a-403d-b311-6e2eed1dcf20",
  "message": "Listening for UUID: 'c1f877c8-9ef5-46aa-a7da-801199ea0a3a' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 21.584851ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;c1f877c8-9ef5-46aa-a7da-801199ea0a3a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/c1f877c8-9ef5-46aa-a7da-801199ea0a3a


---
Response status code: 200 OK. Responded in 2896.546324ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c1f877c8-9ef5-46aa-a7da-801199ea0a3a",
  "modified": 637607616458516000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/c1f877c8-9ef5-46aa-a7da-801199ea0a3a",
    "identifier": "c1f877c8-9ef5-46aa-a7da-801199ea0a3a",
...
---
Response status code: 200 OK. Responded in 399.029931ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c1f877c8-9ef5-46aa-a7da-801199ea0a3a
...
---
Response status code: 201 Created. Responded in 339.767297ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c1f877c8-9ef5-46aa-a7da-801199ea0a3a",
  "identifier": "c1f877c8-9ef5-46aa-a7da-801199ea0a3a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 194.012742ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "c1f877c8-9ef5-46aa-a7da-801199ea0a3a",
  "modified": 637607616493558300
}
```
### Specs
* ✅ should return 200 on success
...
### Orders (orders) Feed listen for &#x27;c1f877c8-9ef5-46aa-a7da-801199ea0a3a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/c1f877c8-9ef5-46aa-a7da-801199ea0a3a


---
Response status code: 200 OK. Responded in 179.127327ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "message": "Listening for UUID: 'c1f877c8-9ef5-46aa-a7da-801199ea0a3a' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 146.444621ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation)

### Orders (orders) Feed collect for &#x27;c1f877c8-9ef5-46aa-a7da-801199ea0a3a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/c1f877c8-9ef5-46aa-a7da-801199ea0a3a


---
Response status code: 200 OK. Responded in 2371.677443ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c1f877c8-9ef5-46aa-a7da-801199ea0a3a",
  "modified": 637607616534090900,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
