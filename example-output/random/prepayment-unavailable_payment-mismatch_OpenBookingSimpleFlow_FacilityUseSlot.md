...
---
Response status code: 200 OK. Responded in 10.820836ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/42/facility-use-slots/414"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F42%2Ffacility-use-slots%2F414?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.015345ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/42/facility-use-slots/414#/offers/0",
    ...
    "remainingUses": 4,
    "startDate": "2021-07-03T21:16:09+00:00",
    "endDate": "2021-07-04T02:04:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/936fb0d0-0205-46cf-9912-214aed4ba8cc
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/42/facility-use-slots/414#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/42/facility-use-slots/414"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2783.434721ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/936fb0d0-0205-46cf-9912-214aed4ba8cc",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/936fb0d0-0205-46cf-9912-214aed4ba8cc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shaniya_Hand@yahoo.com",
    "telephone": "(205) 617-5155 x84241",
    "givenName": "Roob",
    "familyName": "Lorena",
    "identifier": "3977dbb6-7635-487a-b052-8693f5c2746b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1451.362617ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/936fb0d0-0205-46cf-9912-214aed4ba8cc
...
---
Response status code: 400 Bad Request. Responded in 125.982541ms.
```json
{
  "@context": "https://openactive.io/",
