[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:39:08 GMT+0000 (Coordinated Universal Time)
...
⚠️ 28 passed with 0 failures, 324 warnings and 84 suggestions 
...
---
Response status code: 200 OK. Responded in 287.177359ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/388/events/3878"
}
```
...
---
Response status code: 200 OK. Responded in 281.426111ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/311/events/3110"
}
```
...
---
Response status code: 200 OK. Responded in 283.528111ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/766/facility-use-slots/7653"
}
```
...
---
Response status code: 200 OK. Responded in 273.353742ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/319/facility-use-slots/3188"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F388%2Fevents%2F3878?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 232.308732ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/388/events/3878",
    "startDate": "2021-07-05T18:53:09+00:00",
    "endDate": "2021-07-05T19:49:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F311%2Fevents%2F3110?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 232.753374ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/311/events/3110",
    "startDate": "2021-07-07T01:42:09+00:00",
    "endDate": "2021-07-07T04:19:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/311",
      "name": "Fresh Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/311#/offers/0",
          "allowCustomerCancellationFullRefund": false,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F766%2Ffacility-use-slots%2F7653?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 232.976096ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/766",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/766/facility-use-slots/7653#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 15.2,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT22H51M"
      }
    ],
    "remainingUses": 0,
    "startDate": "2021-07-03T08:05:10+00:00",
    "endDate": "2021-07-03T09:11:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F319%2Ffacility-use-slots%2F3188?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 233.325529ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/319/facility-use-slots/3188#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2021-07-02T07:53:10+00:00",
    "endDate": "2021-07-02T13:03:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/87501502-b819-4ab0-acba-2b0fd85ce4ef
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/388/events/3878"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/311#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/311/events/3110"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/766/facility-use-slots/7653#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/766/facility-use-slots/7653"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/319/facility-use-slots/3188#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/319/facility-use-slots/3188"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 231.397745ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/87501502-b819-4ab0-acba-2b0fd85ce4ef",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:44:14+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/311"
        },
        "maximumAttendeeCapacity": 50,
        "remainingAttendeeCapacity": 50
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/766"
        },
        "maximumUses": 0,
        "remainingUses": 0,
        "startDate": "2021-07-03T08:05:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/87501502-b819-4ab0-acba-2b0fd85ce4ef
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Trevor.Lindgren@yahoo.com",
    "telephone": "779-857-7709",
    "givenName": "Gorczany",
    "familyName": "Levi",
    "identifier": "b634c6fa-b0b8-455c-8131-116d55eb3f01"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 466.306424ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:44:16+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
