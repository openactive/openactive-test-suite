...
⚠️ 14 passed with 0 failures, 129 warnings and 34 suggestions 
...
---
Response status code: 200 OK. Responded in 20.471649ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1365/events/13645"
}
```
...
---
Response status code: 200 OK. Responded in 19.317039ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1598/events/15979"
}
```
...
---
Response status code: 200 OK. Responded in 18.237736ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1534/facility-use-slots/15331"
}
```
...
---
Response status code: 200 OK. Responded in 23.487736ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1253/facility-use-slots/12522"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1365%2Fevents%2F13645?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.957276ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1365/events/13645",
    "startDate": "2021-07-10T13:41:09+00:00",
    "endDate": "2021-07-10T16:39:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1598%2Fevents%2F15979?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.338417ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1598/events/15979",
    "startDate": "2021-07-02T12:52:09+00:00",
    "endDate": "2021-07-02T13:35:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1534%2Ffacility-use-slots%2F15331?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.748861ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1534/facility-use-slots/15331#/offers/0",
        ...
        "price": 8.9,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT2H40M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-06T13:33:10+00:00",
    "endDate": "2021-07-06T16:24:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1253%2Ffacility-use-slots%2F12522?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.230011ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1253/facility-use-slots/12522#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 8,
    "startDate": "2021-07-02T01:53:10+00:00",
    "endDate": "2021-07-02T05:03:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3309f14f-73cd-49ac-8315-7966b836f2bb
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1365/events/13645"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1598/events/15979"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1534/facility-use-slots/15331#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1534/facility-use-slots/15331"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1253/facility-use-slots/12522#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1253/facility-use-slots/12522"
    }
  ],
  "payment": {
    "@type": "Payment"
...
---
Response status code: 400 Bad Request. Responded in 816.894365ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3309f14f-73cd-49ac-8315-7966b836f2bb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mylene35@gmail.com",
    "telephone": "(684) 377-4001",
    "givenName": "Ziemann",
    "familyName": "Judd",
    "identifier": "36f12a15-0932-4e1a-8cc7-62936bf6230f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 102.901496ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
