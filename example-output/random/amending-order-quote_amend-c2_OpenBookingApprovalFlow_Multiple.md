...
# amending-order-quote >> amend-c2 (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 48 passed with 0 failures, 691 warnings and 186 suggestions 
...
---
Response status code: 200 OK. Responded in 419.765118ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1341/events/13401"
}
```
...
---
Response status code: 200 OK. Responded in 426.323648ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1436/events/14359"
}
```
...
---
Response status code: 200 OK. Responded in 426.392455ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1574/facility-use-slots/15734"
}
```
...
---
Response status code: 200 OK. Responded in 426.921105ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1439/facility-use-slots/14385"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1341%2Fevents%2F13401?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 334.72885ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1341/events/13401",
    "startDate": "2021-07-04T22:17:09+00:00",
    "endDate": "2021-07-05T02:08:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1341",
      "name": "Wooden Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1341#/offers/0",
          ...
          "price": 19.75,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT16H"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1436%2Fevents%2F14359?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 335.630536ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1436/events/14359",
    "startDate": "2021-07-09T02:26:09+00:00",
    "endDate": "2021-07-09T06:54:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1574%2Ffacility-use-slots%2F15734?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 336.2908ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1574/facility-use-slots/15734#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT16H16M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-07T20:38:10+00:00",
    "endDate": "2021-07-08T02:01:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1439%2Ffacility-use-slots%2F14385?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 337.094777ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1439",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1439/facility-use-slots/14385#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        ...
        "price": 12.52,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT6H8M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-05T02:55:10+00:00",
    "endDate": "2021-07-05T04:36:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ff04d309-a665-4978-800c-bf2401e24b4b
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1341#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1341/events/13401"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1436/events/14359"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1574/facility-use-slots/15734#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1574/facility-use-slots/15734"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1439/facility-use-slots/14385#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1439/facility-use-slots/14385"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 260.669437ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ff04d309-a665-4978-800c-bf2401e24b4b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:42:56+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1341"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1436"
        },
        "maximumAttendeeCapacity": 27,
        "remainingAttendeeCapacity": 27
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1439"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-05T02:55:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ff04d309-a665-4978-800c-bf2401e24b4b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Felipe.Collier96@yahoo.com",
    "telephone": "(393) 264-3225",
    "givenName": "Corkery",
    "familyName": "Avery",
    "identifier": "e744dd77-b8a5-4b4f-a3dc-733fdec249ab"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 434.67475ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:42:57+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 254.906205ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1339/events/13383"
}
```
...
---
Response status code: 200 OK. Responded in 261.461628ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1497/events/14965"
}
```
...
---
Response status code: 200 OK. Responded in 264.576623ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1542/facility-use-slots/15420"
}
```
...
---
Response status code: 200 OK. Responded in 264.960759ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1610/facility-use-slots/16099"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1339%2Fevents%2F13383?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 300.190705ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1339/events/13383",
    "startDate": "2021-07-08T04:58:09+00:00",
    "endDate": "2021-07-08T06:22:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1339",
      "name": "Cotton Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1339#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ...
          "price": 4.05,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT19H28M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1497%2Fevents%2F14965?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 301.032185ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1497/events/14965",
    "startDate": "2021-07-07T07:43:09+00:00",
    "endDate": "2021-07-07T08:37:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1497",
      "name": "Cotton Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1497#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT1H57M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1542%2Ffacility-use-slots%2F15420?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 301.60174ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1542",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1542/facility-use-slots/15420#/offers/0",
    ...
    "remainingUses": 4,
    "startDate": "2021-07-11T03:34:10+00:00",
    "endDate": "2021-07-11T06:33:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1610%2Ffacility-use-slots%2F16099?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 302.384414ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1610",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1610/facility-use-slots/16099#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 11.36,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT15H52M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-07T16:37:10+00:00",
    "endDate": "2021-07-07T19:39:10+00:00"
  }
}
```
### Specs
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Rebeca84@hotmail.com",
    "telephone": "(384) 917-2906 x821",
    "givenName": "Swaniawski",
    "familyName": "Reese",
    "identifier": "b6719cd3-1b18-45ed-8766-45fc68f71fed"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1339#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1339/events/13383"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1497#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1497/events/14965"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1542/facility-use-slots/15420#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1542/facility-use-slots/15420"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1610/facility-use-slots/16099#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1610/facility-use-slots/16099"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 292.536079ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1339"
        },
        "maximumAttendeeCapacity": 50,
        "remainingAttendeeCapacity": 50
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1542"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-11T03:34:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1610"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-07T16:37:10+00:00",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/ff04d309-a665-4978-800c-bf2401e24b4b
...
---
Response status code: 201 Created. Responded in 352.532676ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/ff04d309-a665-4978-800c-bf2401e24b4b",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ff04d309-a665-4978-800c-bf2401e24b4b#/orderedItems/181",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1339#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ff04d309-a665-4978-800c-bf2401e24b4b#/orderedItems/182",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1339#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ff04d309-a665-4978-800c-bf2401e24b4b#/orderedItems/183",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1497#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ff04d309-a665-4978-800c-bf2401e24b4b#/orderedItems/184",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1542/facility-use-slots/15420#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ff04d309-a665-4978-800c-bf2401e24b4b#/orderedItems/185",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1542/facility-use-slots/15420#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ff04d309-a665-4978-800c-bf2401e24b4b#/orderedItems/186",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1610/facility-use-slots/16099#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/ff04d309-a665-4978-800c-bf2401e24b4b/versions/371727cf-af71-4485-9ac3-3a1709426316",
  "payment": {
    "@type": "Payment",
    "identifier": "aVwAeDGhs",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;ff04d309-a665-4978-800c-bf2401e24b4b&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/ff04d309-a665-4978-800c-bf2401e24b4b


---
Response status code: 200 OK. Responded in 423.808444ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607614757631033&afterId=98265dc3-19f7-4ddb-aa96-c0822c2928f9",
  "message": "Listening for UUID: 'ff04d309-a665-4978-800c-bf2401e24b4b' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 38.12912ms.
### Specs
* ✅ should return 204 on success

## Second Attempt - C2 -> B >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;ff04d309-a665-4978-800c-bf2401e24b4b&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/ff04d309-a665-4978-800c-bf2401e24b4b


---
Response status code: 200 OK. Responded in 2646.865758ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "ff04d309-a665-4978-800c-bf2401e24b4b",
  "modified": 637607614841734400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/ff04d309-a665-4978-800c-bf2401e24b4b",
    "identifier": "ff04d309-a665-4978-800c-bf2401e24b4b",
...
---
Response status code: 200 OK. Responded in 256.553732ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ff04d309-a665-4978-800c-bf2401e24b4b
...
---
Response status code: 201 Created. Responded in 242.093855ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ff04d309-a665-4978-800c-bf2401e24b4b",
  "identifier": "ff04d309-a665-4978-800c-bf2401e24b4b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 546.590752ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "ff04d309-a665-4978-800c-bf2401e24b4b",
  "modified": 637607614872550000
}
```
### Specs
* ✅ should return 200 on success
