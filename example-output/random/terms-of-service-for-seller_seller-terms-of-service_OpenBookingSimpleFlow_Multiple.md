...
⚠️ 18 passed with 0 failures, 378 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 313.087799ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/62/events/620"
}
```
...
---
Response status code: 200 OK. Responded in 318.3504ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/330/events/3297"
}
```
...
---
Response status code: 200 OK. Responded in 322.805325ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/275/facility-use-slots/2750"
}
```
...
---
Response status code: 200 OK. Responded in 323.054348ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/504/facility-use-slots/5038"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F62%2Fevents%2F620?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 380.245191ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/62/events/620",
    "startDate": "2021-07-08T21:20:09+00:00",
    "endDate": "2021-07-08T22:28:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F330%2Fevents%2F3297?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 380.821446ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/330/events/3297",
    "startDate": "2021-07-05T10:28:09+00:00",
    "endDate": "2021-07-05T14:24:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F275%2Ffacility-use-slots%2F2750?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 381.188081ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/275/facility-use-slots/2750#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 3,
    "startDate": "2021-07-05T18:28:10+00:00",
    "endDate": "2021-07-05T21:53:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F504%2Ffacility-use-slots%2F5038?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 385.684309ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/504/facility-use-slots/5038#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 20,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT22H25M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-04T00:51:10+00:00",
    "endDate": "2021-07-04T02:46:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ea2425b8-b82e-4974-9f8e-30b2e02af150
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/62/events/620"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/330/events/3297"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/275/facility-use-slots/2750#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/275/facility-use-slots/2750"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/504/facility-use-slots/5038#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/504/facility-use-slots/5038"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 697.595204ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ea2425b8-b82e-4974-9f8e-30b2e02af150",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ea2425b8-b82e-4974-9f8e-30b2e02af150
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shyanne5@hotmail.com",
    "telephone": "1-644-521-1773 x07320",
    "givenName": "Schaefer",
    "familyName": "Muhammad",
    "identifier": "d0021120-9678-4ca7-b76c-1ed06201412f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 560.527275ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ea2425b8-b82e-4974-9f8e-30b2e02af150
...
---
Response status code: 201 Created. Responded in 527.210209ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ea2425b8-b82e-4974-9f8e-30b2e02af150",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ea2425b8-b82e-4974-9f8e-30b2e02af150#/orderedItems/684",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/62#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ea2425b8-b82e-4974-9f8e-30b2e02af150#/orderedItems/685",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/62#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ea2425b8-b82e-4974-9f8e-30b2e02af150#/orderedItems/686",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/330#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ea2425b8-b82e-4974-9f8e-30b2e02af150#/orderedItems/687",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/275/facility-use-slots/2750#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ea2425b8-b82e-4974-9f8e-30b2e02af150#/orderedItems/688",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/275/facility-use-slots/2750#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ea2425b8-b82e-4974-9f8e-30b2e02af150#/orderedItems/689",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/504/facility-use-slots/5038#/offers/0",
        "allowCustomerCancellationFullRefund": false,
