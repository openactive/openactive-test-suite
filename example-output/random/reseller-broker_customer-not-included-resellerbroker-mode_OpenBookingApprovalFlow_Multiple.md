[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:47:50 GMT+0000 (Coordinated Universal Time)

# reseller-broker >> customer-not-included-resellerbroker-mode (OpenBookingApprovalFlow >> Multiple)
...
**Test:**  Customer not included in Order in ResellerBroker mode

Request should succeed if customer is not included in Order in ResellerBroke mode for B request.

### Running only this test

```bash
npm start -- --runInBand test/features/broker-role/reseller-broker/implemented/customer-not-included-resellerbroker-mode-test.js
```

---

⚠️ 19 passed with 0 failures, 482 warnings and 126 suggestions 

---


## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Fetch Opportunities
...
---
Response status code: 200 OK. Responded in 178.04891ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1146/events/11452"
}
```
...
---
Response status code: 200 OK. Responded in 180.995389ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1647/events/16464"
}
```
...
---
Response status code: 200 OK. Responded in 175.52437ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1286/facility-use-slots/12858"
}
```
...
---
Response status code: 200 OK. Responded in 176.365849ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1374/facility-use-slots/13731"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1146%2Fevents%2F11452?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 145.557824ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1146/events/11452",
    "startDate": "2021-07-07T04:55:09+00:00",
    "endDate": "2021-07-07T10:27:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1647%2Fevents%2F16464?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 146.651728ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1647/events/16464",
    "startDate": "2021-07-06T04:13:09+00:00",
    "endDate": "2021-07-06T08:13:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1647",
      "name": "Cotton Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1647#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT3H40M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1286%2Ffacility-use-slots%2F12858?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 147.31719ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1286",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1286/facility-use-slots/12858#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 3,
    "startDate": "2021-07-03T00:31:10+00:00",
    "endDate": "2021-07-03T01:49:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1374%2Ffacility-use-slots%2F13731?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 147.968752ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1374/facility-use-slots/13731#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT23H43M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-07T12:17:10+00:00",
    "endDate": "2021-07-07T17:02:10+00:00"
  }
}
```
### Specs
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 0
### Specs
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> C1

### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a467c2cc-4a5e-472b-a866-7e008427784b
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1146/events/11452"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1647#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1647/events/16464"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1286/facility-use-slots/12858#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1286/facility-use-slots/12858"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1374/facility-use-slots/13731#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1374/facility-use-slots/13731"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2126.488854ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a467c2cc-4a5e-472b-a866-7e008427784b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:30+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1286"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-03T00:31:10+00:00",
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> C1 >> validation of C1
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> C2

### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a467c2cc-4a5e-472b-a866-7e008427784b
...
---
Response status code: 200 OK. Responded in 2553.760925ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:33+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> C2 >> validation of C2
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> P

### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a467c2cc-4a5e-472b-a866-7e008427784b
...
---
Response status code: 201 Created. Responded in 1635.2013550000001ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a467c2cc-4a5e-472b-a866-7e008427784b",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a467c2cc-4a5e-472b-a866-7e008427784b#/orderedItems/2189",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1146#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a467c2cc-4a5e-472b-a866-7e008427784b#/orderedItems/2190",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1146#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a467c2cc-4a5e-472b-a866-7e008427784b#/orderedItems/2191",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1647#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a467c2cc-4a5e-472b-a866-7e008427784b#/orderedItems/2192",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1286/facility-use-slots/12858#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a467c2cc-4a5e-472b-a866-7e008427784b#/orderedItems/2193",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1286/facility-use-slots/12858#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a467c2cc-4a5e-472b-a866-7e008427784b#/orderedItems/2194",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1374/facility-use-slots/13731#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a467c2cc-4a5e-472b-a866-7e008427784b/versions/8a006a1a-0b57-4d00-82f9-e3b5d57eea60",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> P >> validation of P
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> Simulate Seller Approval (Test Interface Action)

### Orders (order-proposals) Feed listen for &#x27;a467c2cc-4a5e-472b-a866-7e008427784b&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/a467c2cc-4a5e-472b-a866-7e008427784b


---
Response status code: 200 OK. Responded in 233.433377ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621077375723&afterId=8636ebce-ca4c-4506-8b66-c5e313677c2a",
  "message": "Listening for UUID: 'a467c2cc-4a5e-472b-a866-7e008427784b' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 414.596889ms.
### Specs
* ✅ should return 204 on success

## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;a467c2cc-4a5e-472b-a866-7e008427784b&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/a467c2cc-4a5e-472b-a866-7e008427784b


---
Response status code: 200 OK. Responded in 1837.003781ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a467c2cc-4a5e-472b-a866-7e008427784b",
  "modified": 637607621183232000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/a467c2cc-4a5e-472b-a866-7e008427784b",
    "identifier": "a467c2cc-4a5e-472b-a866-7e008427784b",
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> OrderProposal Feed Update (after Simulate Seller Approval) >> validation of OrderFeed
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> B
...
---
Response status code: 200 OK. Responded in 159.741169ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a467c2cc-4a5e-472b-a866-7e008427784b
...
---
Response status code: 201 Created. Responded in 676.806071ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a467c2cc-4a5e-472b-a866-7e008427784b",
  "identifier": "a467c2cc-4a5e-472b-a866-7e008427784b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> B >> validation of B
### Specs
* ✅ passes validation checks
...
## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> OrderProposal Feed Deletion (after B)
...
---
Response status code: 200 OK. Responded in 259.488042ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a467c2cc-4a5e-472b-a866-7e008427784b",
  "modified": 637607621208875000
}
```
### Specs
* ✅ should return 200 on success

## Booking should succeed even if Customer is not included in Order, because we are in ResellerBroker mode >> OrderProposal Feed Deletion (after B) >> validation of OrderFeed
### Specs
* ✅ passes validation checks
