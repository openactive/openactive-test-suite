...
---
Response status code: 200 OK. Responded in 161.583349ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/332/events/3319"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F332%2Fevents%2F3319?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 115.518445ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/332/events/3319",
    "startDate": "2021-07-10T05:43:09+00:00",
    "endDate": "2021-07-10T11:43:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/332",
      "name": "Rubber Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/332#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4e61e0f6-3da0-41fb-b5f7-89f58bf5fe45
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/332#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/332/events/3319"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 901.946736ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4e61e0f6-3da0-41fb-b5f7-89f58bf5fe45",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4e61e0f6-3da0-41fb-b5f7-89f58bf5fe45
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lewis.Fritsch@yahoo.com",
    "telephone": "655-246-1645 x3985",
    "givenName": "Murray",
    "familyName": "Taurean",
    "identifier": "326e9590-c921-4688-a621-db4530d670a0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 520.509567ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4e61e0f6-3da0-41fb-b5f7-89f58bf5fe45
...
---
Response status code: 400 Bad Request. Responded in 95.91777ms.
```json
{
  "@context": "https://openactive.io/",
