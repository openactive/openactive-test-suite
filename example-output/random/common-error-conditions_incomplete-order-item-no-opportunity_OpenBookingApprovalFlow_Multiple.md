...
⚠️ 29 passed with 0 failures, 125 warnings and 32 suggestions 
...
---
Response status code: 200 OK. Responded in 224.942384ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1421/events/14207"
}
```
...
---
Response status code: 200 OK. Responded in 227.130591ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1280/events/12795"
}
```
...
---
Response status code: 200 OK. Responded in 227.454823ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1700/facility-use-slots/16999"
}
```
...
---
Response status code: 200 OK. Responded in 228.077582ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1356/facility-use-slots/13559"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1421%2Fevents%2F14207?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 251.608518ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1421/events/14207",
    "startDate": "2021-07-03T05:04:09+00:00",
    "endDate": "2021-07-03T06:34:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1280%2Fevents%2F12795?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 251.851642ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1280/events/12795",
    "startDate": "2021-07-04T06:40:09+00:00",
    "endDate": "2021-07-04T11:18:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1280",
      "name": "Metal Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1280#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1700%2Ffacility-use-slots%2F16999?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 252.148069ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1700",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1700/facility-use-slots/16999#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 2.46,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT16H3M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-02T09:14:10+00:00",
    "endDate": "2021-07-02T14:53:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1356%2Ffacility-use-slots%2F13559?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 252.486102ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1356",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1356/facility-use-slots/13559#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT9H7M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-11T11:45:10+00:00",
    "endDate": "2021-07-11T15:47:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6d0586b9-de2a-431c-a0d1-df577ac3c09d
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1280#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1280/events/12795"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1700/facility-use-slots/16999#/offers/0"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1356/facility-use-slots/13559#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1356/facility-use-slots/13559"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 211.526409ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6d0586b9-de2a-431c-a0d1-df577ac3c09d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:16+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1280"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1356"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-11T11:45:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6d0586b9-de2a-431c-a0d1-df577ac3c09d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kathleen31@yahoo.com",
    "telephone": "513.816.9113 x3295",
    "givenName": "Wuckert",
    "familyName": "Nelda",
    "identifier": "480df6b9-40e1-4991-8aa7-78ec7219662c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 153.454688ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6d0586b9-de2a-431c-a0d1-df577ac3c09d
...
---
Response status code: 409 Conflict. Responded in 95.796607ms.
```json
{
  "@context": "https://openactive.io/",
