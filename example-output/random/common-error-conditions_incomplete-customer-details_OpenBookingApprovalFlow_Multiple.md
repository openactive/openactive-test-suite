...
⚠️ 29 passed with 0 failures, 507 warnings and 136 suggestions 
...
---
Response status code: 200 OK. Responded in 343.476392ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1220/events/12199"
}
```
...
---
Response status code: 200 OK. Responded in 343.490393ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1143/events/11423"
}
```
...
---
Response status code: 200 OK. Responded in 343.966038ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1458/facility-use-slots/14578"
}
```
...
---
Response status code: 200 OK. Responded in 344.419582ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1075/facility-use-slots/10747"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1220%2Fevents%2F12199?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 339.13758ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1220/events/12199",
    "startDate": "2021-07-03T12:23:09+00:00",
    "endDate": "2021-07-03T15:11:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1220",
      "name": "Cotton Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1220#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1143%2Fevents%2F11423?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 339.694332ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1143/events/11423",
    "startDate": "2021-07-03T16:43:09+00:00",
    "endDate": "2021-07-03T18:03:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1458%2Ffacility-use-slots%2F14578?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 339.864548ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1458/facility-use-slots/14578#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        ...
        "price": 9.5,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT41M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-02T20:02:10+00:00",
    "endDate": "2021-07-02T22:29:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1075%2Ffacility-use-slots%2F10747?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 341.210177ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1075",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1075/facility-use-slots/10747#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 5,
    "startDate": "2021-07-05T16:28:10+00:00",
    "endDate": "2021-07-05T21:35:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e3f7c47d-6999-449e-973d-8ee26e1a96b7
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1220#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1220/events/12199"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1143/events/11423"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1458/facility-use-slots/14578#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1458/facility-use-slots/14578"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1075/facility-use-slots/10747#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1075/facility-use-slots/10747"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 324.036741ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e3f7c47d-6999-449e-973d-8ee26e1a96b7",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1220"
        },
        "maximumAttendeeCapacity": 47,
        "remainingAttendeeCapacity": 47
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e3f7c47d-6999-449e-973d-8ee26e1a96b7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "telephone": "700-520-6751 x2969",
    "givenName": "Ratke",
    "familyName": "Darrin",
    "identifier": "a5c957fe-8ae0-463d-9ac1-ba37d7324103"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 46.251302ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 409.941218ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1091/events/10902"
}
```
...
---
Response status code: 200 OK. Responded in 412.249638ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1205/events/12050"
}
```
...
---
Response status code: 200 OK. Responded in 404.563006ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1054/facility-use-slots/10531"
}
```
...
---
Response status code: 200 OK. Responded in 409.786003ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1637/facility-use-slots/16362"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1091%2Fevents%2F10902?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 388.720699ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1091/events/10902",
    "startDate": "2021-07-04T15:11:09+00:00",
    "endDate": "2021-07-04T15:51:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1091",
      "name": "Frozen Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1091#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval",
            "https://openactive.io/OpenBookingNegotiation"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1205%2Fevents%2F12050?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 388.63079ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1205/events/12050",
    "startDate": "2021-07-10T15:17:09+00:00",
    "endDate": "2021-07-10T17:56:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1205",
      "name": "Granite Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1205#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1054%2Ffacility-use-slots%2F10531?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 388.622689ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1054",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1054/facility-use-slots/10531#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 2,
    "startDate": "2021-07-06T14:51:10+00:00",
    "endDate": "2021-07-06T18:15:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1637%2Ffacility-use-slots%2F16362?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 388.673993ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1637",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1637/facility-use-slots/16362#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 6.31,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT19H3M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-02T12:57:10+00:00",
    "endDate": "2021-07-02T16:08:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5f207b8e-68d7-45cb-a2df-3b721645b280
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1091#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1091/events/10902"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1205#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1205/events/12050"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1054/facility-use-slots/10531#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1054/facility-use-slots/10531"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1637/facility-use-slots/16362#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1637/facility-use-slots/16362"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 427.470829ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5f207b8e-68d7-45cb-a2df-3b721645b280",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1091"
        },
        "maximumAttendeeCapacity": 6,
        "remainingAttendeeCapacity": 6
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1054"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-06T14:51:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1637"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-02T12:57:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5f207b8e-68d7-45cb-a2df-3b721645b280
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jack.Beahan@yahoo.com",
    "telephone": "1-614-678-6369",
    "givenName": "Feest",
    "familyName": "Greg",
    "identifier": "07c7caad-29b7-4272-82f5-75ae75f3e9e6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 355.545993ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:45:42+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/5f207b8e-68d7-45cb-a2df-3b721645b280
...
---
Response status code: 400 Bad Request. Responded in 66.861355ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
