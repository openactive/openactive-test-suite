...
# prepayment-optional >> opportunity-paid-incomplete-payment-details (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 136.27473ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/157/facility-use-slots/1565"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F157%2Ffacility-use-slots%2F1565?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 85.637588ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/157",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/157/facility-use-slots/1565#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2021-07-10T19:00:10+00:00",
    "endDate": "2021-07-10T22:58:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0afff105-e2f8-4175-baf2-779346fff1b0
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/157/facility-use-slots/1565#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/157/facility-use-slots/1565"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 943.011488ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0afff105-e2f8-4175-baf2-779346fff1b0",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/157"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-10T19:00:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0afff105-e2f8-4175-baf2-779346fff1b0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bria.Armstrong@yahoo.com",
    "telephone": "240-653-8898 x33410",
    "givenName": "Pouros",
    "familyName": "Cleora",
    "identifier": "8e9262ec-23e6-42a7-9c66-d914d6297c86"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 765.843619ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:16+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0afff105-e2f8-4175-baf2-779346fff1b0
...
---
Response status code: 400 Bad Request. Responded in 129.699083ms.
```json
{
  "@context": "https://openactive.io/",
