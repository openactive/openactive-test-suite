...
---
Response status code: 200 OK. Responded in 100.116006ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/819/facility-use-slots/8181"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F819%2Ffacility-use-slots%2F8181?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 248.556501ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/819/facility-use-slots/8181#/offers/0",
    ...
    "remainingUses": 5,
    "startDate": "2021-07-04T14:25:10+00:00",
    "endDate": "2021-07-04T17:58:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/06d8d891-fbb2-49b0-8ef4-d287cacba747
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/819/facility-use-slots/8181#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/819/facility-use-slots/8181"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 387.625406ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/06d8d891-fbb2-49b0-8ef4-d287cacba747",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/06d8d891-fbb2-49b0-8ef4-d287cacba747
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Christa91@yahoo.com",
    "telephone": "512.488.9502 x795",
    "givenName": "Price",
    "familyName": "Johathan",
    "identifier": "b9f44eee-04f1-4548-a284-5cd0840798cb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1384.143828ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/06d8d891-fbb2-49b0-8ef4-d287cacba747
...
---
Response status code: 201 Created. Responded in 313.335152ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/06d8d891-fbb2-49b0-8ef4-d287cacba747",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/06d8d891-fbb2-49b0-8ef4-d287cacba747#/orderedItems/2140",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/819/facility-use-slots/8181#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/06d8d891-fbb2-49b0-8ef4-d287cacba747
...
---
Response status code: 204 No Content. Responded in 61.670257ms.
### Specs
