...
---
Response status code: 200 OK. Responded in 155.686095ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1493/events/14921"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1493%2Fevents%2F14921?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 199.991505ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1493/events/14921",
    "startDate": "2021-07-09T08:33:09+00:00",
    "endDate": "2021-07-09T11:33:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6e089495-2c15-4347-a74f-35725cdbad42
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1493/events/14921"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 772.21438ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6e089495-2c15-4347-a74f-35725cdbad42",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6e089495-2c15-4347-a74f-35725cdbad42
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ezequiel79@yahoo.com",
    "telephone": "(692) 528-3033 x771",
    "givenName": "Turner",
    "familyName": "Alexandrea",
    "identifier": "232cc02d-2ba0-4284-b632-47ac78081500"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 800.366494ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6e089495-2c15-4347-a74f-35725cdbad42
...
---
Response status code: 400 Bad Request. Responded in 62.704871ms.
```json
{
  "@context": "https://openactive.io/",
