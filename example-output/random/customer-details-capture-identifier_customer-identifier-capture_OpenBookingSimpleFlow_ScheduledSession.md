...
⚠️ 7 passed with 0 failures, 74 warnings and 26 suggestions 
...
---
Response status code: 200 OK. Responded in 381.671187ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2749"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F275%2Fevents%2F2749?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 385.796047ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2749",
    "startDate": "2021-07-05T09:39:09+00:00",
    "endDate": "2021-07-05T10:21:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1ce97227-fdf8-445a-ba2b-efd6cfdc06f7
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2749"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 716.023028ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1ce97227-fdf8-445a-ba2b-efd6cfdc06f7",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:53+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1ce97227-fdf8-445a-ba2b-efd6cfdc06f7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Paolo_Paucek14@yahoo.com",
    "telephone": "908.314.9249",
    "givenName": "Mayert",
    "familyName": "Guiseppe",
    "identifier": "7a2906a6-361d-4fd4-8742-4df442b530d3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 998.659081ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:54+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1ce97227-fdf8-445a-ba2b-efd6cfdc06f7
...
---
Response status code: 201 Created. Responded in 2816.846625ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1ce97227-fdf8-445a-ba2b-efd6cfdc06f7",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1ce97227-fdf8-445a-ba2b-efd6cfdc06f7#/orderedItems/1740",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/275#/offers/0",
        "allowCustomerCancellationFullRefund": false,
