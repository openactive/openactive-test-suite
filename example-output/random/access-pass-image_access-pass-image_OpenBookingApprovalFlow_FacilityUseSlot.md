[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:44:33 GMT+0000 (Coordinated Universal Time)

# access-pass-image >> access-pass-image (OpenBookingApprovalFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 332.145467ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1502/facility-use-slots/15019"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1502%2Ffacility-use-slots%2F15019?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 230.569897ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1502",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1502/facility-use-slots/15019#/offers/0",
        ...
        "price": 6.32,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT13H31M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-09T18:21:10+00:00",
    "endDate": "2021-07-10T00:08:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1aae9bf6-ed10-4bff-b6eb-717b3fd488ec
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1502/facility-use-slots/15019#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1502/facility-use-slots/15019"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1184.525691ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1aae9bf6-ed10-4bff-b6eb-717b3fd488ec",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1502"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-09T18:21:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1aae9bf6-ed10-4bff-b6eb-717b3fd488ec
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Valerie_Koelpin@gmail.com",
    "telephone": "1-898-995-3686 x53434",
    "givenName": "Auer",
    "familyName": "Will",
    "identifier": "bd3e7d2c-c179-4536-aa21-ccdea2e81f59"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 467.222571ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/1aae9bf6-ed10-4bff-b6eb-717b3fd488ec
...
---
Response status code: 201 Created. Responded in 262.461326ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/1aae9bf6-ed10-4bff-b6eb-717b3fd488ec",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1aae9bf6-ed10-4bff-b6eb-717b3fd488ec#/orderedItems/1559",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1502/facility-use-slots/15019#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/1aae9bf6-ed10-4bff-b6eb-717b3fd488ec/versions/4f8d651e-86f5-4518-b76e-11348401485e",
  "payment": {
    "@type": "Payment",
    "identifier": "ZRJ6RKCFo",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;1aae9bf6-ed10-4bff-b6eb-717b3fd488ec&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/1aae9bf6-ed10-4bff-b6eb-717b3fd488ec


---
Response status code: 200 OK. Responded in 260.730961ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '1aae9bf6-ed10-4bff-b6eb-717b3fd488ec' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 325.47481ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;1aae9bf6-ed10-4bff-b6eb-717b3fd488ec&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/1aae9bf6-ed10-4bff-b6eb-717b3fd488ec


---
Response status code: 200 OK. Responded in 2544.13891ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "1aae9bf6-ed10-4bff-b6eb-717b3fd488ec",
  "modified": 637607619064391400,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/1aae9bf6-ed10-4bff-b6eb-717b3fd488ec",
    "identifier": "1aae9bf6-ed10-4bff-b6eb-717b3fd488ec",
...
---
Response status code: 200 OK. Responded in 129.800827ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1aae9bf6-ed10-4bff-b6eb-717b3fd488ec
...
---
Response status code: 201 Created. Responded in 297.698771ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1aae9bf6-ed10-4bff-b6eb-717b3fd488ec",
  "identifier": "1aae9bf6-ed10-4bff-b6eb-717b3fd488ec",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1375.311947ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "1aae9bf6-ed10-4bff-b6eb-717b3fd488ec",
  "modified": 637607619094760600
}
```
### Specs
* ✅ should return 200 on success
