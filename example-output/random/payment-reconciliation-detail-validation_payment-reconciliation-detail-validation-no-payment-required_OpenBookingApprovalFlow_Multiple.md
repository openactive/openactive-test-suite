...
⚠️ 23 passed with 0 failures, 494 warnings and 130 suggestions 
...
---
Response status code: 200 OK. Responded in 54.075148ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1205/events/12045"
}
```
...
---
Response status code: 200 OK. Responded in 53.054551ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1299/events/12990"
}
```
...
---
Response status code: 200 OK. Responded in 45.393621ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1467/facility-use-slots/14669"
}
```
...
---
Response status code: 200 OK. Responded in 44.402527ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1188/facility-use-slots/11876"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1205%2Fevents%2F12045?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 32.971239ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1205/events/12045",
    "startDate": "2021-07-07T11:39:09+00:00",
    "endDate": "2021-07-07T15:51:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1299%2Fevents%2F12990?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 40.482953ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1299/events/12990",
    "startDate": "2021-07-04T16:31:09+00:00",
    "endDate": "2021-07-04T19:48:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1299",
      "name": "Concrete Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1299#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1467%2Ffacility-use-slots%2F14669?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 31.93814ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1467/facility-use-slots/14669#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT2H44M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-09T04:11:10+00:00",
    "endDate": "2021-07-09T09:03:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1188%2Ffacility-use-slots%2F11876?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 31.324782ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1188",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1188/facility-use-slots/11876#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 5,
    "startDate": "2021-07-09T14:34:10+00:00",
    "endDate": "2021-07-09T16:47:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/420c96ef-85ed-49e6-ae7f-1ab71af90cbd
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1205/events/12045"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1299#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1299/events/12990"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1467/facility-use-slots/14669#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1467/facility-use-slots/14669"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1188/facility-use-slots/11876#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1188/facility-use-slots/11876"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2083.367002ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/420c96ef-85ed-49e6-ae7f-1ab71af90cbd",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1299"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1188"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-09T14:34:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/420c96ef-85ed-49e6-ae7f-1ab71af90cbd
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Reggie_Ritchie93@hotmail.com",
    "telephone": "(335) 687-1490 x70995",
    "givenName": "Pollich",
    "familyName": "Darlene",
    "identifier": "dd10cebf-7673-46fc-a471-ac349d7398e6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2083.056125ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/420c96ef-85ed-49e6-ae7f-1ab71af90cbd
...
---
Response status code: 201 Created. Responded in 2854.096349ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/420c96ef-85ed-49e6-ae7f-1ab71af90cbd",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/420c96ef-85ed-49e6-ae7f-1ab71af90cbd#/orderedItems/3230",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1205#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/420c96ef-85ed-49e6-ae7f-1ab71af90cbd#/orderedItems/3231",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1205#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/420c96ef-85ed-49e6-ae7f-1ab71af90cbd#/orderedItems/3232",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1299#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/420c96ef-85ed-49e6-ae7f-1ab71af90cbd#/orderedItems/3233",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1467/facility-use-slots/14669#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/420c96ef-85ed-49e6-ae7f-1ab71af90cbd#/orderedItems/3234",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1467/facility-use-slots/14669#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/420c96ef-85ed-49e6-ae7f-1ab71af90cbd#/orderedItems/3235",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1188/facility-use-slots/11876#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/420c96ef-85ed-49e6-ae7f-1ab71af90cbd/versions/c0c3e3bf-fdd6-496e-aafd-ffaabd57d3d3",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;420c96ef-85ed-49e6-ae7f-1ab71af90cbd&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/420c96ef-85ed-49e6-ae7f-1ab71af90cbd


---
Response status code: 200 OK. Responded in 67.488709ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '420c96ef-85ed-49e6-ae7f-1ab71af90cbd' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 31.135557ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;420c96ef-85ed-49e6-ae7f-1ab71af90cbd&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/420c96ef-85ed-49e6-ae7f-1ab71af90cbd


---
Response status code: 200 OK. Responded in 2552.2082060000002ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "420c96ef-85ed-49e6-ae7f-1ab71af90cbd",
  "modified": 637607625271562000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/420c96ef-85ed-49e6-ae7f-1ab71af90cbd",
    "identifier": "420c96ef-85ed-49e6-ae7f-1ab71af90cbd",
...
---
Response status code: 200 OK. Responded in 18.466564ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607625277062354&afterId=c64fc588-25cf-4587-b487-ab2263ce4044",
  "message": "Listening for UUID: '420c96ef-85ed-49e6-ae7f-1ab71af90cbd' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/420c96ef-85ed-49e6-ae7f-1ab71af90cbd
...
---
Response status code: 201 Created. Responded in 3205.679626ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/420c96ef-85ed-49e6-ae7f-1ab71af90cbd",
  "identifier": "420c96ef-85ed-49e6-ae7f-1ab71af90cbd",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 122.076228ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "420c96ef-85ed-49e6-ae7f-1ab71af90cbd",
  "modified": 637607625314415900
}
```
### Specs
* ✅ should return 200 on success
