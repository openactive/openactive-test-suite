[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:42:56 GMT+0000 (Coordinated Universal Time)

# multiple-sellers >> conflicting-seller (OpenBookingApprovalFlow >> FacilityUseSlot)
...
**Test:**  SellerMismatchError for inconsistent Sellers of OrderItems
...
```bash
npm start -- --runInBand test/features/core/multiple-sellers/implemented/conflicting-seller-test.js
```

---

⚠️ 7 passed with 0 failures, 35 warnings and 4 suggestions 
...
---
Response status code: 200 OK. Responded in 248.34781ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1658/facility-use-slots/16574"
}
```
...
---
Response status code: 200 OK. Responded in 248.844158ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1307/facility-use-slots/13064"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1658%2Ffacility-use-slots%2F16574?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 274.252868ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1658",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1658/facility-use-slots/16574#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT23H42M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-08T11:12:10+00:00",
    "endDate": "2021-07-08T17:03:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1307%2Ffacility-use-slots%2F13064?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 274.950334ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1307",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1307/facility-use-slots/13064#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 2,
    "startDate": "2021-07-08T19:22:10+00:00",
    "endDate": "2021-07-08T21:46:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2aae8f09-ba7d-44e6-842b-04b7a0117640
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1658/facility-use-slots/16574#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1658/facility-use-slots/16574"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1307/facility-use-slots/13064#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1307/facility-use-slots/13064"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 500 Internal Server Error. Responded in 90.452094ms.
```json
{
  "@context": "https://openactive.io/",
...
```
### Specs
* ✅ should return a response containing `"@type": "SellerMismatchError"` with status code `500`
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2aae8f09-ba7d-44e6-842b-04b7a0117640
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cristopher62@hotmail.com",
    "telephone": "746-911-9076",
    "givenName": "Schiller",
    "familyName": "Nicolas",
    "identifier": "1293cdcf-487f-4c83-a55d-147d546d44d1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 500 Internal Server Error. Responded in 67.458109ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/2aae8f09-ba7d-44e6-842b-04b7a0117640
...
---
Response status code: 500 Internal Server Error. Responded in 119.872089ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
