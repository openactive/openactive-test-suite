...
---
Response status code: 200 OK. Responded in 6.465516ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1077/facility-use-slots/10764"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1077%2Ffacility-use-slots%2F10764?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 2.83627ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1077/facility-use-slots/10764#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2021-07-02T14:40:10+00:00",
    "endDate": "2021-07-02T18:20:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/01a1e7e6-b1ba-42e5-b819-f0935bba3bd7
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1077/facility-use-slots/10764#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1077/facility-use-slots/10764"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-j3fGnt8cFk",
    "accountId": "invalid-KA0ybS88nN",
    "paymentProviderId": "invalid-13FKxrkH7j"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 83.699372ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/01a1e7e6-b1ba-42e5-b819-f0935bba3bd7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tara_Halvorson3@gmail.com",
    "telephone": "774-341-9956 x42224",
    "givenName": "Walsh",
    "familyName": "Mathias",
    "identifier": "d6b1c517-3bf5-4e8c-a905-4e69d45daa9d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-fIt3HuT5Hm",
    "accountId": "invalid-a9hXTIQAvO",
    "paymentProviderId": "invalid-VSWOW761WN"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 52.439195ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
