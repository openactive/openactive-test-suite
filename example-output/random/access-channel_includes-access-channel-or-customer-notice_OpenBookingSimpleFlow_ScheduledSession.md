...
# access-channel >> includes-access-channel-or-customer-notice (OpenBookingSimpleFlow >> ScheduledSession)
...
⚠️ 6 passed with 0 failures, 79 warnings and 28 suggestions 
...
---
Response status code: 200 OK. Responded in 793.842099ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/797/events/7961"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F797%2Fevents%2F7961?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 355.60832ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/797/events/7961",
    "startDate": "2021-07-04T11:36:09+00:00",
    "endDate": "2021-07-04T17:22:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/797",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/797#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "price": 15.95,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P3DT1H16M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/94aa36d2-9545-4d2c-8942-c8f3f05e9e17
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/797#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/797/events/7961"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 136.178151ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/94aa36d2-9545-4d2c-8942-c8f3f05e9e17",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/797"
        },
        "maximumAttendeeCapacity": 21,
        "remainingAttendeeCapacity": 21
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/94aa36d2-9545-4d2c-8942-c8f3f05e9e17
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shea.Gorczany@gmail.com",
    "telephone": "939-712-0923 x14506",
    "givenName": "Skiles",
    "familyName": "Saige",
    "identifier": "4c6671aa-d012-43aa-bfbe-dfd4ecfb0498"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 192.789024ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:39+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/94aa36d2-9545-4d2c-8942-c8f3f05e9e17
...
---
Response status code: 201 Created. Responded in 284.391431ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/94aa36d2-9545-4d2c-8942-c8f3f05e9e17",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/94aa36d2-9545-4d2c-8942-c8f3f05e9e17#/orderedItems/1027",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/797#/offers/0",
        "allowCustomerCancellationFullRefund": false,
