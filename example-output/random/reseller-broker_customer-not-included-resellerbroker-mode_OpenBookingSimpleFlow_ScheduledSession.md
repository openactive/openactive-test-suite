...
---
Response status code: 200 OK. Responded in 589.594906ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/64/events/633"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F64%2Fevents%2F633?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 361.697758ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/64/events/633",
    "startDate": "2021-07-11T15:33:09+00:00",
    "endDate": "2021-07-11T17:50:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/64",
      "name": "Steel Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/64#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5cfcae7b-12fe-4f4a-a56b-8c2c5c24722d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/64#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/64/events/633"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 280.368318ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5cfcae7b-12fe-4f4a-a56b-8c2c5c24722d",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/64"
        },
        "maximumAttendeeCapacity": 11,
        "remainingAttendeeCapacity": 11
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5cfcae7b-12fe-4f4a-a56b-8c2c5c24722d
...
---
Response status code: 200 OK. Responded in 611.329722ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5cfcae7b-12fe-4f4a-a56b-8c2c5c24722d
...
---
Response status code: 201 Created. Responded in 437.130245ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5cfcae7b-12fe-4f4a-a56b-8c2c5c24722d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5cfcae7b-12fe-4f4a-a56b-8c2c5c24722d#/orderedItems/2064",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/64#/offers/0",
        "allowCustomerCancellationFullRefund": false,
