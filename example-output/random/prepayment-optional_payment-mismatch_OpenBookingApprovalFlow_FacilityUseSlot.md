...
# prepayment-optional >> payment-mismatch (OpenBookingApprovalFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 131.438607ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1727/facility-use-slots/17270"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1727%2Ffacility-use-slots%2F17270?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 109.928143ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1727",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1727/facility-use-slots/17270#/offers/0",
        ...
        "price": 12.28,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT16H4M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-02T04:43:10+00:00",
    "endDate": "2021-07-02T06:31:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d5534c34-c4d3-488a-a6e7-395ccb2dc5eb
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1727/facility-use-slots/17270#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1727/facility-use-slots/17270"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2112.276367ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d5534c34-c4d3-488a-a6e7-395ccb2dc5eb",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1727"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-02T04:43:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d5534c34-c4d3-488a-a6e7-395ccb2dc5eb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Aryanna_Russel@gmail.com",
    "telephone": "236-899-2421 x50279",
    "givenName": "Kris",
    "familyName": "Aliya",
    "identifier": "ec9a511b-c287-4816-a8d5-f248f9147089"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 523.083457ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:07+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/d5534c34-c4d3-488a-a6e7-395ccb2dc5eb
...
---
Response status code: 400 Bad Request. Responded in 243.651296ms.
```json
{
  "@context": "https://openactive.io/",
