...
---
Response status code: 200 OK. Responded in 447.360903ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/630/events/6300"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F630%2Fevents%2F6300?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 521.18915ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/630/events/6300",
    "startDate": "2021-07-10T01:04:09+00:00",
    "endDate": "2021-07-10T02:05:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/630",
      "name": "Metal Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/630#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 19.26,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT13H51M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/dfd2c048-180d-4b80-b425-05c9b6ac7abf
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/630#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/630/events/6300"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 184.998759ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/dfd2c048-180d-4b80-b425-05c9b6ac7abf",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:35+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/630"
        },
        "maximumAttendeeCapacity": 26,
        "remainingAttendeeCapacity": 26
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/dfd2c048-180d-4b80-b425-05c9b6ac7abf
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Flavio60@gmail.com",
    "telephone": "408-806-1195 x395",
    "givenName": "Nicolas",
    "familyName": "Ally",
    "identifier": "983dd163-9d25-4270-b1c1-f790c6e2fb8b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 162.359698ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/dfd2c048-180d-4b80-b425-05c9b6ac7abf
...
---
Response status code: 201 Created. Responded in 305.221935ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/dfd2c048-180d-4b80-b425-05c9b6ac7abf",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/dfd2c048-180d-4b80-b425-05c9b6ac7abf#/orderedItems/1437",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/630#/offers/0",
        "allowCustomerCancellationFullRefund": true,
