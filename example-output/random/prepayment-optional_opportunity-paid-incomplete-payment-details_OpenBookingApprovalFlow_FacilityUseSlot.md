...
# prepayment-optional >> opportunity-paid-incomplete-payment-details (OpenBookingApprovalFlow >> FacilityUseSlot)
...
⚠️ 7 passed with 0 failures, 53 warnings and 6 suggestions 
...
---
Response status code: 200 OK. Responded in 105.977815ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1649/facility-use-slots/16488"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1649%2Ffacility-use-slots%2F16488?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 111.736158ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1649",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1649/facility-use-slots/16488#/offers/0",
        ...
        "price": 1.61,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT16H22M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-09T12:16:10+00:00",
    "endDate": "2021-07-09T14:16:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6eaff4ec-97ea-4542-aa9d-4eb5079354e0
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1649/facility-use-slots/16488#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1649/facility-use-slots/16488"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 991.967939ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6eaff4ec-97ea-4542-aa9d-4eb5079354e0",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1649"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-09T12:16:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6eaff4ec-97ea-4542-aa9d-4eb5079354e0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Adele_Pfannerstill4@gmail.com",
    "telephone": "991.971.5350",
    "givenName": "Lehner",
    "familyName": "Henri",
    "identifier": "ffefaa22-d7bf-4b61-b2b3-5e47ff4c89cf"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1903.858604ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6eaff4ec-97ea-4542-aa9d-4eb5079354e0
...
---
Response status code: 400 Bad Request. Responded in 83.492699ms.
```json
{
  "@context": "https://openactive.io/",
