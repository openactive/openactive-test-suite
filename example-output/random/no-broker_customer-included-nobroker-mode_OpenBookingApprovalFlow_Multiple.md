...
# no-broker >> customer-included-nobroker-mode (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 19 passed with 0 failures, 483 warnings and 128 suggestions 
...
---
Response status code: 200 OK. Responded in 207.238997ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1406/events/14054"
}
```
...
---
Response status code: 200 OK. Responded in 215.087143ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1249/events/12481"
}
```
...
---
Response status code: 200 OK. Responded in 215.911021ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1221/facility-use-slots/12206"
}
```
...
---
Response status code: 200 OK. Responded in 216.691095ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1004/facility-use-slots/10037"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1406%2Fevents%2F14054?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 135.689297ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1406/events/14054",
    "startDate": "2021-07-05T03:08:09+00:00",
    "endDate": "2021-07-05T05:27:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1406",
      "name": "Cotton Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1406#/offers/0",
          ...
          "price": 15.65,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT9M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1249%2Fevents%2F12481?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 135.150245ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1249/events/12481",
    "startDate": "2021-07-04T10:47:09+00:00",
    "endDate": "2021-07-04T13:23:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1221%2Ffacility-use-slots%2F12206?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 134.78371ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1221/facility-use-slots/12206#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 4,
    "startDate": "2021-07-09T16:38:10+00:00",
    "endDate": "2021-07-09T18:37:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1004%2Ffacility-use-slots%2F10037?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 135.108842ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1004/facility-use-slots/10037#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 5,
    "startDate": "2021-07-02T06:55:10+00:00",
    "endDate": "2021-07-02T09:06:10+00:00"
  }
}
```
### Specs
...
## In NoBroker mode, booking should succeed if Broker is excluded if Customer is included in Order >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## In NoBroker mode, booking should succeed if Broker is excluded if Customer is included in Order >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## In NoBroker mode, booking should succeed if Broker is excluded if Customer is included in Order >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## In NoBroker mode, booking should succeed if Broker is excluded if Customer is included in Order >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## In NoBroker mode, booking should succeed if Broker is excluded if Customer is included in Order >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a39e9009-452a-42d6-bbaa-677b16217e5d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1406#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1406/events/14054"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1249/events/12481"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1221/facility-use-slots/12206#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1221/facility-use-slots/12206"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1004/facility-use-slots/10037#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1004/facility-use-slots/10037"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1553.809017ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a39e9009-452a-42d6-bbaa-677b16217e5d",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1406"
        },
        "maximumAttendeeCapacity": 42,
        "remainingAttendeeCapacity": 42
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a39e9009-452a-42d6-bbaa-677b16217e5d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Hildegard70@gmail.com",
    "telephone": "1-445-381-9902",
    "givenName": "Dare",
    "familyName": "Rita",
    "identifier": "8bbaad1c-86ac-4ef8-8d94-7468e8483e63"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1167.178286ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a39e9009-452a-42d6-bbaa-677b16217e5d
...
---
Response status code: 201 Created. Responded in 2118.031319ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a39e9009-452a-42d6-bbaa-677b16217e5d",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a39e9009-452a-42d6-bbaa-677b16217e5d#/orderedItems/2327",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1406#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a39e9009-452a-42d6-bbaa-677b16217e5d#/orderedItems/2328",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1406#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a39e9009-452a-42d6-bbaa-677b16217e5d#/orderedItems/2329",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1249#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a39e9009-452a-42d6-bbaa-677b16217e5d#/orderedItems/2330",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1221/facility-use-slots/12206#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a39e9009-452a-42d6-bbaa-677b16217e5d#/orderedItems/2331",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1221/facility-use-slots/12206#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a39e9009-452a-42d6-bbaa-677b16217e5d#/orderedItems/2332",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1004/facility-use-slots/10037#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a39e9009-452a-42d6-bbaa-677b16217e5d/versions/9739ca42-6829-4658-b4d7-4974218042f2",
  "payment": {
    "@type": "Payment",
    "identifier": "8Pl3KR9Yk",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;a39e9009-452a-42d6-bbaa-677b16217e5d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/a39e9009-452a-42d6-bbaa-677b16217e5d


---
Response status code: 200 OK. Responded in 131.316876ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621593506091&afterId=b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da",
  "message": "Listening for UUID: 'a39e9009-452a-42d6-bbaa-677b16217e5d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 179.587662ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;a39e9009-452a-42d6-bbaa-677b16217e5d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/a39e9009-452a-42d6-bbaa-677b16217e5d


---
Response status code: 200 OK. Responded in 2349.01486ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a39e9009-452a-42d6-bbaa-677b16217e5d",
  "modified": 637607621673531100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/a39e9009-452a-42d6-bbaa-677b16217e5d",
    "identifier": "a39e9009-452a-42d6-bbaa-677b16217e5d",
...
---
Response status code: 200 OK. Responded in 141.231435ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621672515851&afterId=3c732dd4-6acf-4008-94ff-24513e5eeb0e",
  "message": "Listening for UUID: 'a39e9009-452a-42d6-bbaa-677b16217e5d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/a39e9009-452a-42d6-bbaa-677b16217e5d
...
---
Response status code: 201 Created. Responded in 841.183322ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a39e9009-452a-42d6-bbaa-677b16217e5d",
  "identifier": "a39e9009-452a-42d6-bbaa-677b16217e5d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 178.999618ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a39e9009-452a-42d6-bbaa-677b16217e5d",
  "modified": 637607621702139300
}
```
### Specs
* ✅ should return 200 on success
