...
⚠️ 20 passed with 0 failures, 493 warnings and 130 suggestions 
...
---
Response status code: 200 OK. Responded in 120.676845ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1401/events/14001"
}
```
...
---
Response status code: 200 OK. Responded in 121.658738ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12552"
}
```
...
---
Response status code: 200 OK. Responded in 122.406709ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1635/facility-use-slots/16345"
}
```
...
---
Response status code: 200 OK. Responded in 123.564618ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1438/facility-use-slots/14376"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1401%2Fevents%2F14001?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 116.577256ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1401/events/14001",
    "startDate": "2021-07-06T19:34:09+00:00",
    "endDate": "2021-07-06T20:12:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1401",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1401#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT21H56M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1256%2Fevents%2F12552?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 126.672314ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12552",
    "startDate": "2021-07-10T09:24:09+00:00",
    "endDate": "2021-07-10T14:17:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1635%2Ffacility-use-slots%2F16345?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 126.886233ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1635/facility-use-slots/16345#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT20H28M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-08T08:17:10+00:00",
    "endDate": "2021-07-08T11:08:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1438%2Ffacility-use-slots%2F14376?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 127.392381ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1438/facility-use-slots/14376#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT5H"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-10T10:49:10+00:00",
    "endDate": "2021-07-10T15:23:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a90bf237-648f-4c43-a953-de0ce5f8b3eb
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1401#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1401/events/14001"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12552"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1635/facility-use-slots/16345#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1635/facility-use-slots/16345"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1438/facility-use-slots/14376#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1438/facility-use-slots/14376"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 500.567153ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a90bf237-648f-4c43-a953-de0ce5f8b3eb",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:28+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1401"
        },
        "maximumAttendeeCapacity": 26,
        "remainingAttendeeCapacity": 26
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a90bf237-648f-4c43-a953-de0ce5f8b3eb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Brandy_Parisian@hotmail.com",
    "telephone": "(702) 866-4444",
    "givenName": "Kirlin",
    "familyName": "Deanna",
    "identifier": "17e12a1a-e72e-47cd-8597-398af3037758"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 502.699956ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a90bf237-648f-4c43-a953-de0ce5f8b3eb
...
---
Response status code: 201 Created. Responded in 678.444452ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a90bf237-648f-4c43-a953-de0ce5f8b3eb",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a90bf237-648f-4c43-a953-de0ce5f8b3eb#/orderedItems/1660",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1401#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a90bf237-648f-4c43-a953-de0ce5f8b3eb#/orderedItems/1661",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1401#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a90bf237-648f-4c43-a953-de0ce5f8b3eb#/orderedItems/1662",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1256#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a90bf237-648f-4c43-a953-de0ce5f8b3eb#/orderedItems/1663",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1635/facility-use-slots/16345#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a90bf237-648f-4c43-a953-de0ce5f8b3eb#/orderedItems/1664",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1635/facility-use-slots/16345#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a90bf237-648f-4c43-a953-de0ce5f8b3eb#/orderedItems/1665",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1438/facility-use-slots/14376#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a90bf237-648f-4c43-a953-de0ce5f8b3eb/versions/91dce696-489f-41fe-bcf0-9f44bcfa9b31",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;a90bf237-648f-4c43-a953-de0ce5f8b3eb&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/a90bf237-648f-4c43-a953-de0ce5f8b3eb


---
Response status code: 200 OK. Responded in 201.075802ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619269177164&afterId=dd62b1ac-f713-4e00-bdfd-7e536decbcbb",
  "message": "Listening for UUID: 'a90bf237-648f-4c43-a953-de0ce5f8b3eb' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 41.443437ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;a90bf237-648f-4c43-a953-de0ce5f8b3eb&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/a90bf237-648f-4c43-a953-de0ce5f8b3eb


---
Response status code: 200 OK. Responded in 2165.277501ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a90bf237-648f-4c43-a953-de0ce5f8b3eb",
  "modified": 637607619320427000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/a90bf237-648f-4c43-a953-de0ce5f8b3eb",
    "identifier": "a90bf237-648f-4c43-a953-de0ce5f8b3eb",
...
---
Response status code: 200 OK. Responded in 383.100395ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619301835413&afterId=dd62b1ac-f713-4e00-bdfd-7e536decbcbb",
  "message": "Listening for UUID: 'a90bf237-648f-4c43-a953-de0ce5f8b3eb' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/a90bf237-648f-4c43-a953-de0ce5f8b3eb
...
---
Response status code: 201 Created. Responded in 661.769363ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a90bf237-648f-4c43-a953-de0ce5f8b3eb",
  "identifier": "a90bf237-648f-4c43-a953-de0ce5f8b3eb",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 207.031458ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a90bf237-648f-4c43-a953-de0ce5f8b3eb",
  "modified": 637607619348580100
}
```
### Specs
* ✅ should return 200 on success
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/a90bf237-648f-4c43-a953-de0ce5f8b3eb
...
---
Response status code: 400 Bad Request. Responded in 20.505147ms.
```json
{
  "@context": "https://openactive.io/",
