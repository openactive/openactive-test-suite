...
---
Response status code: 200 OK. Responded in 303.035301ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1574/facility-use-slots/15739"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1574%2Ffacility-use-slots%2F15739?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 332.916941ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1574",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1574/facility-use-slots/15739#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT19H24M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-04T03:39:10+00:00",
    "endDate": "2021-07-04T08:29:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1574/facility-use-slots/15739#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1574/facility-use-slots/15739"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 61.126909ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:44:59+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1574"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-04T03:39:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kathryne14@yahoo.com",
    "telephone": "1-853-414-0664",
    "givenName": "Powlowski",
    "familyName": "Rod",
    "identifier": "df8a9600-966f-4f45-9b83-c6f42be6a58a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 49.395595ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196
...
---
Response status code: 201 Created. Responded in 114.959926ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196#/orderedItems/548",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1574/facility-use-slots/15739#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196/versions/b50ae97f-5072-4048-b4bb-6a5b5f9c7fda",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196


---
Response status code: 200 OK. Responded in 279.021718ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607615924110598&afterId=6544ea05-e288-4158-8d30-336a28aab62b",
  "message": "Listening for UUID: 'b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 23.451729ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196


---
Response status code: 200 OK. Responded in 3218.196962ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196",
  "modified": 637607616005791900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196",
    "identifier": "b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196",
...
---
Response status code: 200 OK. Responded in 372.706822ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196
...
---
Response status code: 201 Created. Responded in 79.244231ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196",
  "identifier": "b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 2442.151422ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196",
  "modified": 637607616042457000
}
```
### Specs
* ✅ should return 200 on success
...
### Orders (orders) Feed listen for &#x27;b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196


---
Response status code: 200 OK. Responded in 391.059981ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607615988931258&afterId=6fff4dac-b3d5-49fa-9eca-ec883712380f",
  "message": "Listening for UUID: 'b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 52.768317ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation)

### Orders (orders) Feed collect for &#x27;b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196


---
Response status code: 200 OK. Responded in 2728.372709ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196",
  "modified": 637607616077695200,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
...
---
Response status code: 200 OK. Responded in 263.958796ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607616077695254&afterId=b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196",
  "message": "Listening for UUID: 'b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196
...
---
Response status code: 204 No Content. Responded in 60.724873ms.
### Specs
* ✅ should return 204 on success
...
---
Response status code: 200 OK. Responded in 2834.455595ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "b3c4f0fa-ffdb-47ba-a4a5-d5377c14d196",
  "modified": 637607616114140400
}
```
### Specs
* ✅ should return 200 on success
