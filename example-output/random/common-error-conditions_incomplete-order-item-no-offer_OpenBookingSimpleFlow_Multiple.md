...
# common-error-conditions >> incomplete-order-item-no-offer (OpenBookingSimpleFlow >> Multiple)
...
---
Response status code: 200 OK. Responded in 529.026581ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/354/events/3537"
}
```
...
---
Response status code: 200 OK. Responded in 522.256338ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/294/events/2932"
}
```
...
---
Response status code: 200 OK. Responded in 521.411958ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/216/facility-use-slots/2155"
}
```
...
---
Response status code: 200 OK. Responded in 522.284141ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/745/facility-use-slots/7446"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F354%2Fevents%2F3537?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 427.549737ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/354/events/3537",
    "startDate": "2021-07-08T20:10:09+00:00",
    "endDate": "2021-07-09T00:49:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/354",
      "name": "Frozen Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/354#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT16H38M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F294%2Fevents%2F2932?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 427.708852ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/294/events/2932",
    "startDate": "2021-07-09T04:06:09+00:00",
    "endDate": "2021-07-09T09:14:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/294",
      "name": "Frozen Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/294#/offers/0",
          "allowCustomerCancellationFullRefund": true,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F216%2Ffacility-use-slots%2F2155?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 428.052185ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/216",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/216/facility-use-slots/2155#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 6,
    "startDate": "2021-07-04T23:41:10+00:00",
    "endDate": "2021-07-05T01:12:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F745%2Ffacility-use-slots%2F7446?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 428.605337ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/745",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/745/facility-use-slots/7446#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 12.5,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT16H32M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-03T01:28:10+00:00",
    "endDate": "2021-07-03T02:37:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/843e5da0-3b80-407a-ae96-0bff9778f5bc
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/354/events/3537"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/294#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/294/events/2932"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/216/facility-use-slots/2155"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/745/facility-use-slots/7446#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/745/facility-use-slots/7446"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 254.496389ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/843e5da0-3b80-407a-ae96-0bff9778f5bc",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:04+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/294"
        },
        "maximumAttendeeCapacity": 5,
        "remainingAttendeeCapacity": 5
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/745"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-03T01:28:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/843e5da0-3b80-407a-ae96-0bff9778f5bc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Briana.Schuster30@hotmail.com",
    "telephone": "1-898-737-4386 x4908",
    "givenName": "Heathcote",
    "familyName": "Jerrold",
    "identifier": "db72fb5b-6c05-478c-abbb-c88bbcdcb98a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 140.222928ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:05+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/843e5da0-3b80-407a-ae96-0bff9778f5bc
...
---
Response status code: 409 Conflict. Responded in 66.867056ms.
```json
{
  "@context": "https://openactive.io/",
