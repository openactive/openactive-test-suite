...
⚠️ 18 passed with 0 failures, 380 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 241.549356ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/254/events/2536"
}
```
...
---
Response status code: 200 OK. Responded in 243.900579ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/513/events/5122"
}
```
...
---
Response status code: 200 OK. Responded in 244.270115ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/26/facility-use-slots/257"
}
```
...
---
Response status code: 200 OK. Responded in 249.702231ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5079"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F254%2Fevents%2F2536?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 331.812935ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/254/events/2536",
    "startDate": "2021-07-09T16:32:09+00:00",
    "endDate": "2021-07-09T20:45:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F513%2Fevents%2F5122?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 332.18937ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/513/events/5122",
    "startDate": "2021-07-10T05:13:09+00:00",
    "endDate": "2021-07-10T09:44:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/513",
      "name": "Frozen Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/513#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT10H39M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F26%2Ffacility-use-slots%2F257?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 325.778661ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/26/facility-use-slots/257#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
    ...
    "remainingUses": 6,
    "startDate": "2021-07-08T20:53:09+00:00",
    "endDate": "2021-07-09T01:32:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F508%2Ffacility-use-slots%2F5079?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 325.946276ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5079#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT20H4M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-02T07:19:10+00:00",
    "endDate": "2021-07-02T11:33:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/40443d12-5cdd-4ebf-8311-9301c81bd768
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/254/events/2536"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/513#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/513/events/5122"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/26/facility-use-slots/257#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/26/facility-use-slots/257"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5079#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5079"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 500.198337ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/40443d12-5cdd-4ebf-8311-9301c81bd768",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/40443d12-5cdd-4ebf-8311-9301c81bd768
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Daphne.Nienow@hotmail.com",
    "telephone": "1-881-839-7732",
    "givenName": "Sauer",
    "familyName": "Whitney",
    "identifier": "0af25469-2882-4439-91fc-1733010225a4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 340.065535ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/40443d12-5cdd-4ebf-8311-9301c81bd768
...
---
Response status code: 201 Created. Responded in 851.658237ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/40443d12-5cdd-4ebf-8311-9301c81bd768",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/40443d12-5cdd-4ebf-8311-9301c81bd768#/orderedItems/1285",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/254#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/40443d12-5cdd-4ebf-8311-9301c81bd768#/orderedItems/1286",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/254#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/40443d12-5cdd-4ebf-8311-9301c81bd768#/orderedItems/1287",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/513#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/40443d12-5cdd-4ebf-8311-9301c81bd768#/orderedItems/1288",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/26/facility-use-slots/257#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/40443d12-5cdd-4ebf-8311-9301c81bd768#/orderedItems/1289",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/26/facility-use-slots/257#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/40443d12-5cdd-4ebf-8311-9301c81bd768#/orderedItems/1290",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5079#/offers/0",
        "allowCustomerCancellationFullRefund": true,
