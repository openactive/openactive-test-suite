[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:52:11 GMT+0000 (Coordinated Universal Time)

# prepayment-optional >> opportunity-paid-incomplete-payment-details (OpenBookingApprovalFlow >> Multiple)
...
**Test:**  IncompletePaymentDetailsError must be returned in the case that payment `identifier` is not supplied

An unsuccessful end to end booking, because `identifier` is missing in the `payment` property in B request.

### Running only this test

```bash
npm start -- --runInBand test/features/payment/prepayment-optional/implemented/opportunity-paid-incomplete-payment-details-test.js
```

---

⚠️ 9 passed with 0 failures, 107 warnings and 28 suggestions 
...
---
Response status code: 200 OK. Responded in 21.935802ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1378/events/13776"
}
```
...
---
Response status code: 200 OK. Responded in 23.569558ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1239/facility-use-slots/12389"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1378%2Fevents%2F13776?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.045233ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1378/events/13776",
    "startDate": "2021-07-02T02:50:09+00:00",
    "endDate": "2021-07-02T05:57:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1239%2Ffacility-use-slots%2F12389?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.616788ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1239/facility-use-slots/12389#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 2,
    "startDate": "2021-07-05T00:29:10+00:00",
    "endDate": "2021-07-05T06:12:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/02761cac-8281-48c8-a574-48ebbe57c9c0
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1378/events/13776"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1239/facility-use-slots/12389#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1239/facility-use-slots/12389"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2738.650396ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/02761cac-8281-48c8-a574-48ebbe57c9c0",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:35+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/02761cac-8281-48c8-a574-48ebbe57c9c0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Savanah.Sporer63@hotmail.com",
    "telephone": "1-767-571-7022 x519",
    "givenName": "Fadel",
    "familyName": "Linwood",
    "identifier": "9e123aa5-f39d-43be-9ed1-379d28f97fdd"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 3691.064414ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:39+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/02761cac-8281-48c8-a574-48ebbe57c9c0
...
---
Response status code: 400 Bad Request. Responded in 80.015459ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "Payment must contain identifier for paid Order."
}
```
### Specs
* ✅ should return a response containing `"@type": "IncompletePaymentDetailsError"` with status code `400`
...
### Validations
 * ⚠️ $.instance: Recommended property `instance` is missing from `IncompletePaymentDetailsError`.
