[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:53:48 GMT+0000 (Coordinated Universal Time)
...
⚠️ 22 passed with 0 failures, 477 warnings and 126 suggestions 
...
---
Response status code: 200 OK. Responded in 36.421169ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1303/events/13023"
}
```
...
---
Response status code: 200 OK. Responded in 35.309563ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1073/events/10722"
}
```
...
---
Response status code: 200 OK. Responded in 25.299309ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1516/facility-use-slots/15159"
}
```
...
---
Response status code: 200 OK. Responded in 24.157901ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1541/facility-use-slots/15408"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1303%2Fevents%2F13023?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.614168ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1303/events/13023",
    "startDate": "2021-07-08T08:20:09+00:00",
    "endDate": "2021-07-08T12:56:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1303",
      "name": "Fresh Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1303#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1073%2Fevents%2F10722?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.032313ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1073/events/10722",
    "startDate": "2021-07-04T14:27:09+00:00",
    "endDate": "2021-07-04T17:55:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1073",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1073#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1516%2Ffacility-use-slots%2F15159?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.544566ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1516",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1516/facility-use-slots/15159#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 16.23,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT8H24M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-09T04:33:10+00:00",
    "endDate": "2021-07-09T09:59:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1541%2Ffacility-use-slots%2F15408?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.104424ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1541",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1541/facility-use-slots/15408#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        ...
        "price": 12.64,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT17H15M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-08T19:06:10+00:00",
    "endDate": "2021-07-08T19:52:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1303#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1303/events/13023"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1073#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1073/events/10722"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1516/facility-use-slots/15159#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1516/facility-use-slots/15159"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1541/facility-use-slots/15408#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1541/facility-use-slots/15408"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1827.21958ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:25+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1303"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1073"
        },
        "maximumAttendeeCapacity": 16,
        "remainingAttendeeCapacity": 16
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1541"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-08T19:06:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ceasar29@yahoo.com",
    "telephone": "(653) 546-9567 x847",
    "givenName": "Lowe",
    "familyName": "Tina",
    "identifier": "a335cb18-86c1-451c-bb44-6bcc1af66f32"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2481.275813ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:28+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7
...
---
Response status code: 201 Created. Responded in 1322.320216ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7#/orderedItems/3077",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1303#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7#/orderedItems/3078",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1303#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7#/orderedItems/3079",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1073#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7#/orderedItems/3080",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1516/facility-use-slots/15159#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7#/orderedItems/3081",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1516/facility-use-slots/15159#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7#/orderedItems/3082",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1541/facility-use-slots/15408#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7/versions/a8bc2eb2-8936-4adb-ac7d-b3188778cb06",
  "payment": {
    "@type": "Payment",
    "identifier": "S4aHNnXp0",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;76dbf465-a2ac-4fc6-a6be-572c0eb2aed7&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7


---
Response status code: 200 OK. Responded in 12.477087ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607624626091135&afterId=69842b29-66a3-43b7-bef1-c2c5b5e91798",
  "message": "Listening for UUID: '76dbf465-a2ac-4fc6-a6be-572c0eb2aed7' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 788.96085ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;76dbf465-a2ac-4fc6-a6be-572c0eb2aed7&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7


---
Response status code: 200 OK. Responded in 1767.597743ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "76dbf465-a2ac-4fc6-a6be-572c0eb2aed7",
  "modified": 637607624722895100,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7",
    "identifier": "76dbf465-a2ac-4fc6-a6be-572c0eb2aed7",
...
---
Response status code: 200 OK. Responded in 23.256413ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607624722895045&afterId=76dbf465-a2ac-4fc6-a6be-572c0eb2aed7",
  "message": "Listening for UUID: '76dbf465-a2ac-4fc6-a6be-572c0eb2aed7' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7
...
---
Response status code: 201 Created. Responded in 1448.812018ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/76dbf465-a2ac-4fc6-a6be-572c0eb2aed7",
  "identifier": "76dbf465-a2ac-4fc6-a6be-572c0eb2aed7",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 33.927428ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "76dbf465-a2ac-4fc6-a6be-572c0eb2aed7",
  "modified": 637607624749907100
}
```
### Specs
* ✅ should return 200 on success
