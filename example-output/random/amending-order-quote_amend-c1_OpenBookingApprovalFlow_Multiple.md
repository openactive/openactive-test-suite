...
⚠️ 39 passed with 0 failures, 691 warnings and 184 suggestions 
...
---
Response status code: 200 OK. Responded in 501.473814ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1165/events/11641"
}
```
...
---
Response status code: 200 OK. Responded in 501.766242ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1030/events/10296"
}
```
...
---
Response status code: 200 OK. Responded in 506.728114ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1304/facility-use-slots/13038"
}
```
...
---
Response status code: 200 OK. Responded in 499.382615ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14440"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1165%2Fevents%2F11641?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 434.281021ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1165/events/11641",
    "startDate": "2021-07-07T17:00:09+00:00",
    "endDate": "2021-07-07T17:52:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1165",
      "name": "Rubber Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1165#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1030%2Fevents%2F10296?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 437.577735ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1030/events/10296",
    "startDate": "2021-07-08T05:23:09+00:00",
    "endDate": "2021-07-08T11:21:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1304%2Ffacility-use-slots%2F13038?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 437.676744ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1304",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1304/facility-use-slots/13038#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 3,
    "startDate": "2021-07-07T18:08:10+00:00",
    "endDate": "2021-07-07T20:52:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1444%2Ffacility-use-slots%2F14440?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 438.128787ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14440#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        ...
        "price": 2.27,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT1H13M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-03T04:41:10+00:00",
    "endDate": "2021-07-03T07:38:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9e4183df-68e6-46a4-ac6e-a4d09670cb00
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1165#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1165/events/11641"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1030/events/10296"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1304/facility-use-slots/13038#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1304/facility-use-slots/13038"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14440#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1444/facility-use-slots/14440"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 291.496356ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9e4183df-68e6-46a4-ac6e-a4d09670cb00",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1165"
        },
        "maximumAttendeeCapacity": 41,
        "remainingAttendeeCapacity": 41
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1304"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-07T18:08:10+00:00",
...
---
Response status code: 200 OK. Responded in 567.213515ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1143/events/11426"
}
```
...
---
Response status code: 200 OK. Responded in 559.882019ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1129/events/11282"
}
```
...
---
Response status code: 200 OK. Responded in 562.116532ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1362/facility-use-slots/13619"
}
```
...
---
Response status code: 200 OK. Responded in 569.019987ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1061/facility-use-slots/10605"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1143%2Fevents%2F11426?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 469.0305ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1143/events/11426",
    "startDate": "2021-07-05T01:27:09+00:00",
    "endDate": "2021-07-05T06:15:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1143",
      "name": "Frozen Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1143#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1129%2Fevents%2F11282?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 469.136109ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1129/events/11282",
    "startDate": "2021-07-02T06:05:09+00:00",
    "endDate": "2021-07-02T09:43:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1129",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1129#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1362%2Ffacility-use-slots%2F13619?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 470.863174ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1362",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1362/facility-use-slots/13619#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ...
        "price": 14.25,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT9H34M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-02T19:53:10+00:00",
    "endDate": "2021-07-02T22:03:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1061%2Ffacility-use-slots%2F10605?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 471.182104ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1061/facility-use-slots/10605#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 5,
    "startDate": "2021-07-03T12:08:10+00:00",
    "endDate": "2021-07-03T17:12:10+00:00"
  }
}
```
### Specs
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1143#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1143/events/11426"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1129#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1129/events/11282"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1362/facility-use-slots/13619#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1362/facility-use-slots/13619"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1061/facility-use-slots/10605#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1061/facility-use-slots/10605"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 234.439142ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:29+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1129"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1362"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-02T19:53:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9e4183df-68e6-46a4-ac6e-a4d09670cb00
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Blanca_Lehner@yahoo.com",
    "telephone": "965-384-7025 x9972",
    "givenName": "Powlowski",
    "familyName": "Lambert",
    "identifier": "c0183925-ad32-411a-b35a-c570468cec22"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 239.2611ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/9e4183df-68e6-46a4-ac6e-a4d09670cb00
...
---
Response status code: 201 Created. Responded in 396.49257ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/9e4183df-68e6-46a4-ac6e-a4d09670cb00",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e4183df-68e6-46a4-ac6e-a4d09670cb00#/orderedItems/283",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1143#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e4183df-68e6-46a4-ac6e-a4d09670cb00#/orderedItems/284",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1143#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e4183df-68e6-46a4-ac6e-a4d09670cb00#/orderedItems/285",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1129#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e4183df-68e6-46a4-ac6e-a4d09670cb00#/orderedItems/286",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1362/facility-use-slots/13619#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e4183df-68e6-46a4-ac6e-a4d09670cb00#/orderedItems/287",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1362/facility-use-slots/13619#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9e4183df-68e6-46a4-ac6e-a4d09670cb00#/orderedItems/288",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1061/facility-use-slots/10605#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/9e4183df-68e6-46a4-ac6e-a4d09670cb00/versions/df296851-7584-44eb-b0c2-677c8fcc405d",
  "payment": {
    "@type": "Payment",
    "identifier": "TzcYXkrwv",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;9e4183df-68e6-46a4-ac6e-a4d09670cb00&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/9e4183df-68e6-46a4-ac6e-a4d09670cb00


---
Response status code: 200 OK. Responded in 291.734264ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607615070980921&afterId=29e03169-b5a8-4dbf-b1ce-4d214f47e66c",
  "message": "Listening for UUID: '9e4183df-68e6-46a4-ac6e-a4d09670cb00' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 48.960877ms.
### Specs
* ✅ should return 204 on success

## Second Attempt - C1 -> B >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;9e4183df-68e6-46a4-ac6e-a4d09670cb00&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/9e4183df-68e6-46a4-ac6e-a4d09670cb00


---
Response status code: 200 OK. Responded in 2578.912215ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "9e4183df-68e6-46a4-ac6e-a4d09670cb00",
  "modified": 637607615127310000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/9e4183df-68e6-46a4-ac6e-a4d09670cb00",
    "identifier": "9e4183df-68e6-46a4-ac6e-a4d09670cb00",
...
---
Response status code: 200 OK. Responded in 184.045279ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9e4183df-68e6-46a4-ac6e-a4d09670cb00
...
---
Response status code: 201 Created. Responded in 277.545309ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9e4183df-68e6-46a4-ac6e-a4d09670cb00",
  "identifier": "9e4183df-68e6-46a4-ac6e-a4d09670cb00",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 314.318065ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "9e4183df-68e6-46a4-ac6e-a4d09670cb00",
  "modified": 637607615156687600
}
```
### Specs
* ✅ should return 200 on success
