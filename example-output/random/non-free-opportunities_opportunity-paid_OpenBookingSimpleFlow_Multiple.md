...
⚠️ 15 passed with 0 failures, 375 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 126.787263ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/301/events/3004"
}
```
...
---
Response status code: 200 OK. Responded in 127.414223ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/120/events/1194"
}
```
...
---
Response status code: 200 OK. Responded in 132.103269ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/3/facility-use-slots/23"
}
```
...
---
Response status code: 200 OK. Responded in 132.712527ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/185/facility-use-slots/1844"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F301%2Fevents%2F3004?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 101.42515ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/301/events/3004",
    "startDate": "2021-07-04T01:29:09+00:00",
    "endDate": "2021-07-04T04:48:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/301",
      "name": "Frozen Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/301#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F120%2Fevents%2F1194?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 100.749785ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/120/events/1194",
    "startDate": "2021-07-10T02:10:09+00:00",
    "endDate": "2021-07-10T07:53:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F3%2Ffacility-use-slots%2F23?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 102.90009ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/3",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/3/facility-use-slots/23#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 4.71,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 7,
    "startDate": "2021-07-10T11:17:09+00:00",
    "endDate": "2021-07-10T13:18:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F185%2Ffacility-use-slots%2F1844?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 103.073407ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/185",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/185/facility-use-slots/1844#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
    ...
    "remainingUses": 4,
    "startDate": "2021-07-03T07:56:10+00:00",
    "endDate": "2021-07-03T12:05:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fb9853bf-092f-4584-9978-d7d22a001e8e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/301#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/301/events/3004"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/120#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/120/events/1194"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/3/facility-use-slots/23#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/3/facility-use-slots/23"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/185/facility-use-slots/1844#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/185/facility-use-slots/1844"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2423.289967ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fb9853bf-092f-4584-9978-d7d22a001e8e",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:56:22+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/301"
        },
        "maximumAttendeeCapacity": 41,
        "remainingAttendeeCapacity": 41
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/185"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-03T07:56:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fb9853bf-092f-4584-9978-d7d22a001e8e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lessie_Halvorson16@gmail.com",
    "telephone": "1-887-296-2310",
    "givenName": "Abbott",
    "familyName": "Naomi",
    "identifier": "f1d612f0-da7a-4691-90f9-9035b2696c4a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2048.74133ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:56:25+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/fb9853bf-092f-4584-9978-d7d22a001e8e
...
---
Response status code: 201 Created. Responded in 2271.025178ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/fb9853bf-092f-4584-9978-d7d22a001e8e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fb9853bf-092f-4584-9978-d7d22a001e8e#/orderedItems/2669",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/301#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fb9853bf-092f-4584-9978-d7d22a001e8e#/orderedItems/2670",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/301#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fb9853bf-092f-4584-9978-d7d22a001e8e#/orderedItems/2671",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/120#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fb9853bf-092f-4584-9978-d7d22a001e8e#/orderedItems/2672",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/3/facility-use-slots/23#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fb9853bf-092f-4584-9978-d7d22a001e8e#/orderedItems/2673",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/3/facility-use-slots/23#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fb9853bf-092f-4584-9978-d7d22a001e8e#/orderedItems/2674",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/185/facility-use-slots/1844#/offers/0",
        "allowCustomerCancellationFullRefund": false,
