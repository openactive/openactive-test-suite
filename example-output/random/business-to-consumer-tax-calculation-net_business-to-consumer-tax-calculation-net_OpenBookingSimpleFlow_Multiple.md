...
⚠️ 18 passed with 0 failures, 390 warnings and 108 suggestions 
...
---
Response status code: 200 OK. Responded in 32.139959ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/372/events/3713"
}
```
...
---
Response status code: 200 OK. Responded in 30.871538ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/477/events/4762"
}
```
...
---
Response status code: 200 OK. Responded in 29.938549ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/521/facility-use-slots/5207"
}
```
...
---
Response status code: 200 OK. Responded in 28.960556ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/139/facility-use-slots/1390"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F372%2Fevents%2F3713?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.7138ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/372/events/3713",
    "startDate": "2021-07-09T08:28:09+00:00",
    "endDate": "2021-07-09T09:50:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/372",
      "name": "Soft Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/372#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 3.68,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT23H24M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F477%2Fevents%2F4762?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.657895ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/477/events/4762",
    "startDate": "2021-07-03T05:21:09+00:00",
    "endDate": "2021-07-03T07:57:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/477",
      "name": "Steel Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/477#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "price": 12.94,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT14H14M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F521%2Ffacility-use-slots%2F5207?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 14.165448ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/521",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/521/facility-use-slots/5207#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 7.66,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT14H33M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-08T00:06:10+00:00",
    "endDate": "2021-07-08T05:26:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F139%2Ffacility-use-slots%2F1390?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.830217ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/139",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/139/facility-use-slots/1390#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 2,
    "startDate": "2021-07-07T18:11:10+00:00",
    "endDate": "2021-07-07T20:00:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a1dca560-c0c7-4640-92bb-384bd13f348e
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/372#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/372/events/3713"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/477#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/477/events/4762"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/521/facility-use-slots/5207#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/521/facility-use-slots/5207"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/139/facility-use-slots/1390#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/139/facility-use-slots/1390"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1687.7992709999999ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a1dca560-c0c7-4640-92bb-384bd13f348e",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/372"
        },
        "maximumAttendeeCapacity": 38,
        "remainingAttendeeCapacity": 38
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/477"
        },
        "maximumAttendeeCapacity": 15,
        "remainingAttendeeCapacity": 15
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/139"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-07T18:11:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a1dca560-c0c7-4640-92bb-384bd13f348e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Giovani54@gmail.com",
    "telephone": "(629) 393-6705",
    "givenName": "Emard",
    "familyName": "Myrtice",
    "identifier": "69b9de86-ffdf-4840-8476-2a051fd67697"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1456.2581ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a1dca560-c0c7-4640-92bb-384bd13f348e
...
---
Response status code: 201 Created. Responded in 1877.050512ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a1dca560-c0c7-4640-92bb-384bd13f348e",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a1dca560-c0c7-4640-92bb-384bd13f348e#/orderedItems/3015",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/372#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a1dca560-c0c7-4640-92bb-384bd13f348e#/orderedItems/3016",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/372#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a1dca560-c0c7-4640-92bb-384bd13f348e#/orderedItems/3017",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/477#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a1dca560-c0c7-4640-92bb-384bd13f348e#/orderedItems/3018",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/521/facility-use-slots/5207#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a1dca560-c0c7-4640-92bb-384bd13f348e#/orderedItems/3019",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/521/facility-use-slots/5207#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a1dca560-c0c7-4640-92bb-384bd13f348e#/orderedItems/3020",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/139/facility-use-slots/1390#/offers/0",
        "allowCustomerCancellationFullRefund": false,
