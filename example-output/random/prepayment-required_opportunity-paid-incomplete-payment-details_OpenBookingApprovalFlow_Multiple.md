[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:50:36 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 123.871696ms.
```json
{
...
---
Response status code: 200 OK. Responded in 124.879392ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14409"
}
```
...
---
Response status code: 200 OK. Responded in 66.486431ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1546/events/15456",
    "startDate": "2021-07-01T23:35:09+00:00",
    "endDate": "2021-07-02T02:49:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 8.57,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT20H19M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1441%2Ffacility-use-slots%2F14409?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 67.049484ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1441",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14409#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ...
        "price": 19.22,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT23H3M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-02T02:20:10+00:00",
    "endDate": "2021-07-02T05:00:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8403d842-3e13-42cd-84a1-cbe629705fe5
...
```json
{
  ...
  "orderedItem": [
    ...
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14409#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1441/facility-use-slots/14409"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 3525.168273ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8403d842-3e13-42cd-84a1-cbe629705fe5",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:55:54+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1441"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-02T02:20:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8403d842-3e13-42cd-84a1-cbe629705fe5
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Penelope4@hotmail.com",
    "telephone": "251.236.7565 x31879",
    "givenName": "Medhurst",
    "familyName": "Eloy",
    "identifier": "3ec3c9b3-5a3c-4f40-a697-ca4771610d5d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 872.013084ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:55:55+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/8403d842-3e13-42cd-84a1-cbe629705fe5
...
---
Response status code: 400 Bad Request. Responded in 104.345118ms.
```json
{
  "@context": "https://openactive.io/",
