[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:49:30 GMT+0000 (Coordinated Universal Time)
...
⚠️ 34 passed with 0 failures, 557 warnings and 220 suggestions 
...
---
Response status code: 200 OK. Responded in 184.647965ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/70/events/692"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F70%2Fevents%2F692?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 189.228402ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/70/events/692",
    "startDate": "2021-07-09T09:39:09+00:00",
    "endDate": "2021-07-09T10:44:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e9a01cbb-cfef-4717-b0ef-0ed43bf77fb5
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/70#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/70/events/692"
    },
    {
      "@type": "OrderItem",
      "position": 1,
...
---
Response status code: 200 OK. Responded in 535.914582ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e9a01cbb-cfef-4717-b0ef-0ed43bf77fb5",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e9a01cbb-cfef-4717-b0ef-0ed43bf77fb5
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bridget81@yahoo.com",
    "telephone": "1-570-272-3376",
    "givenName": "Schiller",
    "familyName": "Finn",
    "identifier": "9b507795-830a-4e32-bdc2-64aa0228dd9d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 3186.896972ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 784.289623ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cbdb84a7-806a-4084-91d8-9e481857d578
...
---
Response status code: 409 Conflict. Responded in 2582.400581ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cbdb84a7-806a-4084-91d8-9e481857d578",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cbdb84a7-806a-4084-91d8-9e481857d578
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dale.Borer@hotmail.com",
    "telephone": "1-574-540-1731 x85927",
    "givenName": "Crona",
    "familyName": "Opal",
    "identifier": "34de5072-10d1-4178-bc57-685ce8a9034f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 493.874428ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2d403004-46df-4c85-a0f7-6a66172fff31
...
---
Response status code: 200 OK. Responded in 324.052292ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2d403004-46df-4c85-a0f7-6a66172fff31",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2d403004-46df-4c85-a0f7-6a66172fff31
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Monserrate5@hotmail.com",
    "telephone": "849.508.4848 x11725",
    "givenName": "Hessel",
    "familyName": "Kianna",
    "identifier": "7690101f-cbba-4c6e-8e8a-95154239ab3e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 459.773987ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ab30fd7a-c6ec-4c25-aaaf-18c015ab6efc
...
---
Response status code: 409 Conflict. Responded in 436.957619ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ab30fd7a-c6ec-4c25-aaaf-18c015ab6efc",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ab30fd7a-c6ec-4c25-aaaf-18c015ab6efc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Judah7@gmail.com",
    "telephone": "203-989-6098",
    "givenName": "Borer",
    "familyName": "Kellen",
    "identifier": "4818c7fd-73b9-483a-b2a8-599d9ec4132d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 540.528261ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:48+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
