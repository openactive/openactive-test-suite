...
---
Response status code: 200 OK. Responded in 7.399005ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/37/facility-use-slots/370"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F37%2Ffacility-use-slots%2F370?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.680508ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/37",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/37/facility-use-slots/370#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2021-07-08T13:06:09+00:00",
    "endDate": "2021-07-08T18:27:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cb926e0e-c11d-4271-9375-719600f5edc1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/37/facility-use-slots/370#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/37/facility-use-slots/370"
    }
  ],
  "payment": {
    "@type": "Payment"
...
---
Response status code: 400 Bad Request. Responded in 71.691929ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cb926e0e-c11d-4271-9375-719600f5edc1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Roberto_Balistreri74@hotmail.com",
    "telephone": "637-323-6991 x470",
    "givenName": "Maggio",
    "familyName": "Shanon",
    "identifier": "80bc20cd-c52d-40a5-b168-6f5b5bf9ae4a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 37.751796ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
