[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:43:38 GMT+0000 (Coordinated Universal Time)

# terms-of-service-for-booking-system >> booking-system-terms-of-service (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 22 passed with 0 failures, 487 warnings and 128 suggestions 
...
---
Response status code: 200 OK. Responded in 299.082437ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1108/events/11073"
}
```
...
---
Response status code: 200 OK. Responded in 304.842084ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1307/events/13070"
}
```
...
---
Response status code: 200 OK. Responded in 306.243718ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1279/facility-use-slots/12781"
}
```
...
---
Response status code: 200 OK. Responded in 323.129123ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1360/facility-use-slots/13596"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1108%2Fevents%2F11073?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 403.477662ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1108/events/11073",
    "startDate": "2021-07-08T07:21:09+00:00",
    "endDate": "2021-07-08T10:40:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1307%2Fevents%2F13070?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 404.291139ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1307/events/13070",
    "startDate": "2021-07-09T23:23:09+00:00",
    "endDate": "2021-07-10T02:46:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1279%2Ffacility-use-slots%2F12781?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 404.414851ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1279",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1279/facility-use-slots/12781#/offers/0",
    ...
    "remainingUses": 5,
    "startDate": "2021-07-10T01:18:10+00:00",
    "endDate": "2021-07-10T02:27:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1360%2Ffacility-use-slots%2F13596?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 404.656274ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1360",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1360/facility-use-slots/13596#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        ...
        "price": 10.28,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT4H7M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-09T21:29:10+00:00",
    "endDate": "2021-07-10T01:22:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e4aac6cf-dd49-411c-922f-98dda549403f
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1108/events/11073"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1307/events/13070"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1279/facility-use-slots/12781#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1279/facility-use-slots/12781"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1360/facility-use-slots/13596#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1360/facility-use-slots/13596"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 713.31842ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e4aac6cf-dd49-411c-922f-98dda549403f",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:17+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1279"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-10T01:18:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1360"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-09T21:29:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e4aac6cf-dd49-411c-922f-98dda549403f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sonia.Harvey66@hotmail.com",
    "telephone": "553.364.0171 x2600",
    "givenName": "Shields",
    "familyName": "Arvel",
    "identifier": "83502a40-92e5-4555-9d44-199458e8cfe5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 981.754443ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:19+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
## Terms of service should be part of bookingService in all stages >> P

### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/e4aac6cf-dd49-411c-922f-98dda549403f
...
---
Response status code: 201 Created. Responded in 492.905765ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/e4aac6cf-dd49-411c-922f-98dda549403f",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e4aac6cf-dd49-411c-922f-98dda549403f#/orderedItems/1397",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1108#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e4aac6cf-dd49-411c-922f-98dda549403f#/orderedItems/1398",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1108#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e4aac6cf-dd49-411c-922f-98dda549403f#/orderedItems/1399",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1307#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e4aac6cf-dd49-411c-922f-98dda549403f#/orderedItems/1400",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1279/facility-use-slots/12781#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e4aac6cf-dd49-411c-922f-98dda549403f#/orderedItems/1401",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1279/facility-use-slots/12781#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e4aac6cf-dd49-411c-922f-98dda549403f#/orderedItems/1402",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1360/facility-use-slots/13596#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/e4aac6cf-dd49-411c-922f-98dda549403f/versions/083ee899-6971-43d9-a649-330c091ae4d7",
  "payment": {
    "@type": "Payment",
    "identifier": "oQuDrWPm6",
    "name": "AcmeBroker Points",
...
## Terms of service should be part of bookingService in all stages >> P >> validation of P
### Specs
* ✅ passes validation checks
...
## Terms of service should be part of bookingService in all stages >> Simulate Seller Approval (Test Interface Action)

### Orders (order-proposals) Feed listen for &#x27;e4aac6cf-dd49-411c-922f-98dda549403f&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/e4aac6cf-dd49-411c-922f-98dda549403f


---
Response status code: 200 OK. Responded in 286.049797ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607618552081451&afterId=88d44da1-c1cb-463d-abd7-0f5efd575a62",
  "message": "Listening for UUID: 'e4aac6cf-dd49-411c-922f-98dda549403f' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 105.333715ms.
### Specs
* ✅ should return 204 on success

## Terms of service should be part of bookingService in all stages >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;e4aac6cf-dd49-411c-922f-98dda549403f&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/e4aac6cf-dd49-411c-922f-98dda549403f


---
Response status code: 200 OK. Responded in 3296.432107ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "e4aac6cf-dd49-411c-922f-98dda549403f",
  "modified": 637607618627668700,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/e4aac6cf-dd49-411c-922f-98dda549403f",
    "identifier": "e4aac6cf-dd49-411c-922f-98dda549403f",
...
## Terms of service should be part of bookingService in all stages >> OrderProposal Feed Update (after Simulate Seller Approval) >> validation of OrderFeed
### Specs
* ✅ passes validation checks
...
---
Response status code: 200 OK. Responded in 408.934036ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607618582179645&afterId=88d44da1-c1cb-463d-abd7-0f5efd575a62",
  "message": "Listening for UUID: 'e4aac6cf-dd49-411c-922f-98dda549403f' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/e4aac6cf-dd49-411c-922f-98dda549403f
...
---
Response status code: 201 Created. Responded in 525.399225ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e4aac6cf-dd49-411c-922f-98dda549403f",
  "identifier": "e4aac6cf-dd49-411c-922f-98dda549403f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
## Terms of service should be part of bookingService in all stages >> OrderProposal Feed Deletion (after B)
...
---
Response status code: 200 OK. Responded in 413.000423ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "e4aac6cf-dd49-411c-922f-98dda549403f",
  "modified": 637607618666228200
}
```
### Specs
* ✅ should return 200 on success
...
## Terms of service should be part of bookingService in all stages >> OrderProposal Feed Deletion (after B) >> validation of OrderFeed
### Specs
* ✅ passes validation checks
