[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:48:50 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 226.172388ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/448/facility-use-slots/4472"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F448%2Ffacility-use-slots%2F4472?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 174.087239ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/448",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/448/facility-use-slots/4472#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 3.72,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT14H37M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-07T04:06:10+00:00",
    "endDate": "2021-07-07T07:58:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9a7c6b86-1e80-4bfc-8cdd-dbf94338dbff
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/448/facility-use-slots/4472#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/448/facility-use-slots/4472"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 603.616547ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9a7c6b86-1e80-4bfc-8cdd-dbf94338dbff",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:58+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9a7c6b86-1e80-4bfc-8cdd-dbf94338dbff
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "b26f5b02-8c20-4be9-9559-598bd141854e",
...
---
Response status code: 200 OK. Responded in 366.60103ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9a7c6b86-1e80-4bfc-8cdd-dbf94338dbff
...
---
Response status code: 201 Created. Responded in 2181.018409ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9a7c6b86-1e80-4bfc-8cdd-dbf94338dbff",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9a7c6b86-1e80-4bfc-8cdd-dbf94338dbff#/orderedItems/2260",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/448/facility-use-slots/4472#/offers/0",
        "allowCustomerCancellationFullRefund": false,
