...
# multiple-sellers >> conflicting-seller (OpenBookingSimpleFlow >> ScheduledSession)
...
⚠️ 7 passed with 0 failures, 49 warnings and 16 suggestions 
...
---
Response status code: 200 OK. Responded in 459.315468ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/530/events/5297"
}
```
...
---
Response status code: 200 OK. Responded in 405.955994ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/272/events/2718"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F530%2Fevents%2F5297?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 255.612401ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/530/events/5297",
    "startDate": "2021-07-09T01:14:09+00:00",
    "endDate": "2021-07-09T04:56:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/530",
      "name": "Steel Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/530#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT9H18M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F272%2Fevents%2F2718?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 256.156053ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/272/events/2718",
    "startDate": "2021-07-04T11:07:09+00:00",
    "endDate": "2021-07-04T14:55:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/272",
      "name": "Cotton Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/272#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/41160469-718a-4b9a-85fa-cd180bbe4beb
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/530#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/530/events/5297"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/272#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/272/events/2718"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 500 Internal Server Error. Responded in 124.177706ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/41160469-718a-4b9a-85fa-cd180bbe4beb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Porter_Feeney17@hotmail.com",
    "telephone": "(498) 627-2593 x495",
    "givenName": "Pfeffer",
    "familyName": "Dessie",
    "identifier": "57e0e6c9-7285-4c67-97b2-fec9edee5cde"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 500 Internal Server Error. Responded in 75.409969ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/41160469-718a-4b9a-85fa-cd180bbe4beb
...
---
Response status code: 500 Internal Server Error. Responded in 56.809201ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "SellerMismatchError",
