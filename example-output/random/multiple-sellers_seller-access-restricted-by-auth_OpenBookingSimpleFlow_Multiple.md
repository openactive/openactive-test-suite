[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:40:03 GMT+0000 (Coordinated Universal Time)

# multiple-sellers >> seller-access-restricted-by-auth (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 15 passed with 0 failures, 123 warnings and 30 suggestions 
...
---
Response status code: 200 OK. Responded in 193.516692ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/540/events/5398"
}
```
...
---
Response status code: 200 OK. Responded in 197.925111ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/43/events/421"
}
```
...
---
Response status code: 200 OK. Responded in 198.720386ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/151/facility-use-slots/1507"
}
```
...
---
Response status code: 200 OK. Responded in 184.892972ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/628/facility-use-slots/6278"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F540%2Fevents%2F5398?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 225.089093ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/540/events/5398",
    "startDate": "2021-07-04T18:09:09+00:00",
    "endDate": "2021-07-04T21:05:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT13H52M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F43%2Fevents%2F421?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 225.581239ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/43/events/421",
    "startDate": "2021-07-05T15:39:09+00:00",
    "endDate": "2021-07-05T20:09:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/43",
      "name": "Fresh Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/43#/offers/0",
          "allowCustomerCancellationFullRefund": false,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F151%2Ffacility-use-slots%2F1507?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 226.351312ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/151",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/151/facility-use-slots/1507#/offers/0",
    ...
    "remainingUses": 2,
    "startDate": "2021-07-05T23:35:10+00:00",
    "endDate": "2021-07-06T04:20:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F628%2Ffacility-use-slots%2F6278?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 226.623139ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/628",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/628/facility-use-slots/6278#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT4H23M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-04T11:55:10+00:00",
    "endDate": "2021-07-04T15:55:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/04ec6c42-d403-45a0-a536-b428bb302660
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/540#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/540/events/5398"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/43#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/43/events/421"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/151/facility-use-slots/1507#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/151/facility-use-slots/1507"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/628/facility-use-slots/6278#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/628/facility-use-slots/6278"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 401 Unauthorized. Responded in 37.453961ms.
```json
{
  "@context": "https://openactive.io/",
...
```
### Specs
* ✅ should return a response containing `"@type": "InvalidAuthorizationDetailsError"` with status code `401`
...
### Validations
 * ⚠️ $.description: Recommended property `description` is missing from `InvalidAuthorizationDetailsError`.
 * ⚠️ $.instance: Recommended property `instance` is missing from `InvalidAuthorizationDetailsError`.

## C2

### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/04ec6c42-d403-45a0-a536-b428bb302660
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Antwon8@hotmail.com",
    "telephone": "712-400-0345",
    "givenName": "Hoppe",
    "familyName": "Trisha",
    "identifier": "99e4fe2c-9e3b-4860-adfe-e00d1712b485"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 401 Unauthorized. Responded in 108.400106ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/04ec6c42-d403-45a0-a536-b428bb302660
...
---
Response status code: 401 Unauthorized. Responded in 15.760399ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidAuthorizationDetailsError",
