...
---
Response status code: 200 OK. Responded in 361.726541ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/256/events/2554"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F256%2Fevents%2F2554?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 292.219123ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/256/events/2554",
    "startDate": "2021-07-04T18:04:09+00:00",
    "endDate": "2021-07-04T23:37:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/256",
      "name": "Steel Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/256#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6e7ca4c7-6445-43cf-9b91-f0b9447712eb
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/256#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/256/events/2554"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 243.657499ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6e7ca4c7-6445-43cf-9b91-f0b9447712eb",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/256"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6e7ca4c7-6445-43cf-9b91-f0b9447712eb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Corene.Pouros53@yahoo.com",
    "telephone": "1-933-861-7374",
    "givenName": "Weissnat",
    "familyName": "Alvena",
    "identifier": "ce29d574-1ab7-445a-a9f2-9df203f3ec6f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 173.465916ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:30+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6e7ca4c7-6445-43cf-9b91-f0b9447712eb
...
---
Response status code: 409 Conflict. Responded in 48.641431ms.
```json
{
  "@context": "https://openactive.io/",
