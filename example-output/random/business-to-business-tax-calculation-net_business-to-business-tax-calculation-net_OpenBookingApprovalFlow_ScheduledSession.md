...
⚠️ 12 passed with 0 failures, 99 warnings and 34 suggestions 
...
---
Response status code: 200 OK. Responded in 114.731705ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1611/events/16101"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1611%2Fevents%2F16101?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 213.346877ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1611/events/16101",
    "startDate": "2021-07-05T18:14:09+00:00",
    "endDate": "2021-07-05T21:39:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1611",
      "name": "Cotton Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1611#/offers/0",
          ...
          "price": 10.51,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT4H35M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1611#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1611/events/16101"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 351.564315ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:14+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1611"
        },
        "maximumAttendeeCapacity": 5,
        "remainingAttendeeCapacity": 5
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "37a6fec3-68ea-49bd-8189-c7cbaf81f1e8",
...
---
Response status code: 200 OK. Responded in 487.682152ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da
...
---
Response status code: 201 Created. Responded in 535.090458ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da#/orderedItems/2301",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1611#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da/versions/09c6df38-af57-4996-94cd-872accbb799e",
  "payment": {
    "@type": "Payment",
    "identifier": "fcRgqKWca",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da


---
Response status code: 200 OK. Responded in 230.875143ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621523990980&afterId=afab5711-1ef0-43a9-982e-b0e9416d2db2",
  "message": "Listening for UUID: 'b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 17.495763ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da


---
Response status code: 200 OK. Responded in 2507.405417ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da",
  "modified": 637607621566420600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da",
    "identifier": "b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da",
...
---
Response status code: 200 OK. Responded in 127.398009ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621559888661&afterId=afab5711-1ef0-43a9-982e-b0e9416d2db2",
  "message": "Listening for UUID: 'b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da
...
---
Response status code: 201 Created. Responded in 257.875008ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da",
  "identifier": "b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1051.636009ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "b7bfa23b-98a3-4e9b-b4bb-43f1f3e7f1da",
  "modified": 637607621593506000
}
```
### Specs
* ✅ should return 200 on success
