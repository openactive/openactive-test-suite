[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:49:18 GMT+0000 (Coordinated Universal Time)
...
⚠️ 15 passed with 0 failures, 387 warnings and 106 suggestions 
...
---
Response status code: 200 OK. Responded in 267.188818ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/73/events/724"
}
```
...
---
Response status code: 200 OK. Responded in 267.502548ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/268/events/2671"
}
```
...
---
Response status code: 200 OK. Responded in 267.785575ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/706/facility-use-slots/7057"
}
```
...
---
Response status code: 200 OK. Responded in 268.239018ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/801/facility-use-slots/8005"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F73%2Fevents%2F724?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 186.756566ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/73/events/724",
    "startDate": "2021-07-04T08:33:09+00:00",
    "endDate": "2021-07-04T12:13:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/73",
      "name": "Steel Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/73#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F268%2Fevents%2F2671?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 187.094198ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/268/events/2671",
    "startDate": "2021-07-09T23:15:09+00:00",
    "endDate": "2021-07-10T00:01:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/268",
      "name": "Cotton Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/268#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F706%2Ffacility-use-slots%2F7057?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 187.465234ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/706",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/706/facility-use-slots/7057#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 1.95,
        "priceCurrency": "GBP",
    ...
    "remainingUses": 2,
    "startDate": "2021-07-04T14:53:10+00:00",
    "endDate": "2021-07-04T17:43:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F801%2Ffacility-use-slots%2F8005?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 197.879325ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/801",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/801/facility-use-slots/8005#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 2.47,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT22H36M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-04T22:54:10+00:00",
    "endDate": "2021-07-05T00:07:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d99b912b-51a4-48af-8b0b-df90e962efb9
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/73#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/73/events/724"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/268#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/268/events/2671"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/706/facility-use-slots/7057#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/706/facility-use-slots/7057"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/801/facility-use-slots/8005#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/801/facility-use-slots/8005"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2238.864677ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d99b912b-51a4-48af-8b0b-df90e962efb9",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/73"
        },
        "maximumAttendeeCapacity": 20,
        "remainingAttendeeCapacity": 20
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/268"
        },
        "maximumAttendeeCapacity": 19,
        "remainingAttendeeCapacity": 19
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/706"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-04T14:53:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/801"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-04T22:54:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d99b912b-51a4-48af-8b0b-df90e962efb9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Fred_Zulauf@gmail.com",
    "telephone": "1-267-407-8757",
    "givenName": "Smith",
    "familyName": "Juvenal",
    "identifier": "55da35dc-e55f-4b47-ae66-1ce0cb344030"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1830.039891ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:37+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d99b912b-51a4-48af-8b0b-df90e962efb9
...
---
Response status code: 201 Created. Responded in 2136.445906ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d99b912b-51a4-48af-8b0b-df90e962efb9",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d99b912b-51a4-48af-8b0b-df90e962efb9#/orderedItems/2375",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/73#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d99b912b-51a4-48af-8b0b-df90e962efb9#/orderedItems/2376",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/73#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d99b912b-51a4-48af-8b0b-df90e962efb9#/orderedItems/2377",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/268#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d99b912b-51a4-48af-8b0b-df90e962efb9#/orderedItems/2378",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/706/facility-use-slots/7057#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d99b912b-51a4-48af-8b0b-df90e962efb9#/orderedItems/2379",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/706/facility-use-slots/7057#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d99b912b-51a4-48af-8b0b-df90e962efb9#/orderedItems/2380",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/801/facility-use-slots/8005#/offers/0",
        "allowCustomerCancellationFullRefund": false,
