...
---
Response status code: 200 OK. Responded in 60.483446ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1559/events/15581"
}
```
...
---
Response status code: 200 OK. Responded in 59.05291ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1121/events/11208"
}
```
...
---
Response status code: 200 OK. Responded in 51.341978ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1538/facility-use-slots/15374"
}
```
...
---
Response status code: 200 OK. Responded in 67.883448ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1015/facility-use-slots/10146"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1559%2Fevents%2F15581?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 56.119131ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1559/events/15581",
    "startDate": "2021-07-09T14:23:09+00:00",
    "endDate": "2021-07-09T18:20:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1121%2Fevents%2F11208?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 55.099734ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1121/events/11208",
    "startDate": "2021-07-05T01:02:09+00:00",
    "endDate": "2021-07-05T06:07:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1121",
      "name": "Steel Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1121#/offers/0",
          "allowCustomerCancellationFullRefund": false,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1538%2Ffacility-use-slots%2F15374?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 54.298758ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1538",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1538/facility-use-slots/15374#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT14H12M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-04T20:11:10+00:00",
    "endDate": "2021-07-05T01:45:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1015%2Ffacility-use-slots%2F10146?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 53.694901ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1015",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1015/facility-use-slots/10146#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 5,
    "startDate": "2021-07-07T02:19:10+00:00",
    "endDate": "2021-07-07T06:14:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/503c7cf5-2622-4f44-96ab-342fcd8e85dd
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1559/events/15581"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1121#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1121/events/11208"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1538/facility-use-slots/15374#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1538/facility-use-slots/15374"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1015/facility-use-slots/10146#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1015/facility-use-slots/10146"
    }
  ],
  "payment": {
    "@type": "Payment"
...
---
Response status code: 400 Bad Request. Responded in 5565.89378ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/503c7cf5-2622-4f44-96ab-342fcd8e85dd
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Wyman_Ondricka44@gmail.com",
    "telephone": "(911) 810-0269",
    "givenName": "Jerde",
    "familyName": "Zoe",
    "identifier": "5330a167-75de-44de-9fe2-edbcbabee92d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 282.795201ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
