...
---
Response status code: 200 OK. Responded in 208.081113ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1488/facility-use-slots/14874"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1488%2Ffacility-use-slots%2F14874?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 102.928701ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1488/facility-use-slots/14874#/offers/0",
        ...
        "price": 16.42,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT13H36M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-08T19:05:10+00:00",
    "endDate": "2021-07-09T00:12:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ad08160d-2354-44fc-be99-a95dcb540ca9
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1488/facility-use-slots/14874#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1488/facility-use-slots/14874"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 769.733293ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ad08160d-2354-44fc-be99-a95dcb540ca9",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1488"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-08T19:05:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ad08160d-2354-44fc-be99-a95dcb540ca9
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dolly_Jacobi@yahoo.com",
    "telephone": "(601) 366-3587 x621",
    "givenName": "Nienow",
    "familyName": "Kurt",
    "identifier": "e8cb26f5-4cb3-438c-ac01-fab2a657d606"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1945.323031ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:55:14+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/ad08160d-2354-44fc-be99-a95dcb540ca9
...
---
Response status code: 400 Bad Request. Responded in 66.602742ms.
```json
{
  "@context": "https://openactive.io/",
