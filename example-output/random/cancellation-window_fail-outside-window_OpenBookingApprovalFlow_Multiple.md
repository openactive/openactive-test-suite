...
⚠️ 20 passed with 0 failures, 488 warnings and 130 suggestions 
...
---
Response status code: 200 OK. Responded in 296.607786ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1541/events/15407"
}
```
...
---
Response status code: 200 OK. Responded in 311.765526ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1600/events/15997"
}
```
...
---
Response status code: 200 OK. Responded in 311.949844ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1505/facility-use-slots/15043"
}
```
...
---
Response status code: 200 OK. Responded in 312.659611ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1417/facility-use-slots/14164"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1541%2Fevents%2F15407?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 167.645131ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1541/events/15407",
    "startDate": "2021-07-03T09:53:09+00:00",
    "endDate": "2021-07-03T12:54:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1541",
      "name": "Metal Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1541#/offers/0",
          ...
          "price": 4.73,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT20H2M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1600%2Fevents%2F15997?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 169.809336ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1600/events/15997",
    "startDate": "2021-07-02T15:10:09+00:00",
    "endDate": "2021-07-02T17:51:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1505%2Ffacility-use-slots%2F15043?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 171.710417ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1505",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1505/facility-use-slots/15043#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 5.25,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT18H46M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-02T21:07:10+00:00",
    "endDate": "2021-07-03T02:06:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1417%2Ffacility-use-slots%2F14164?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 171.660112ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1417",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1417/facility-use-slots/14164#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 0.73,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT23H51M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-05T15:45:10+00:00",
    "endDate": "2021-07-05T16:59:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1541#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1541/events/15407"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1600/events/15997"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1505/facility-use-slots/15043#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1505/facility-use-slots/15043"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1417/facility-use-slots/14164#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1417/facility-use-slots/14164"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1848.052615ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1505"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-02T21:07:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1417"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-05T15:45:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cyril_Toy10@hotmail.com",
    "telephone": "1-462-412-2124 x9409",
    "givenName": "Nitzsche",
    "familyName": "Walton",
    "identifier": "c1543477-e183-4263-9058-e56e54213a8e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1702.7355710000002ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8
...
---
Response status code: 201 Created. Responded in 1186.858954ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8#/orderedItems/2041",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1541#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8#/orderedItems/2042",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1541#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8#/orderedItems/2043",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1600#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8#/orderedItems/2044",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1505/facility-use-slots/15043#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8#/orderedItems/2045",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1505/facility-use-slots/15043#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8#/orderedItems/2046",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1417/facility-use-slots/14164#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8/versions/2bd59029-d8e9-47f9-aa2b-e712732a3b77",
  "payment": {
    "@type": "Payment",
    "identifier": "rAhDw0ohG",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8


---
Response status code: 200 OK. Responded in 76.647282ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 30.677515ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8


---
Response status code: 200 OK. Responded in 2180.778778ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8",
  "modified": 637607620592399000,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8",
    "identifier": "8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8",
...
---
Response status code: 200 OK. Responded in 188.472606ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8
...
---
Response status code: 201 Created. Responded in 836.560775ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8",
  "identifier": "8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 202.517537ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8",
  "modified": 637607620617566800
}
```
### Specs
* ✅ should return 200 on success
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/8fb0058e-fb59-4b8f-af7d-8304bfa5a7f8
...
---
Response status code: 400 Bad Request. Responded in 37.384851ms.
```json
{
  "@context": "https://openactive.io/",
