[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:54:44 GMT+0000 (Coordinated Universal Time)

# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-no-payment-required (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 19 passed with 0 failures, 381 warnings and 102 suggestions 
...
### Specs
* ✅ should have paymentReconciliationDetails, with at least one property
...
---
Response status code: 200 OK. Responded in 32.379984ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/258/events/2578"
}
```
...
---
Response status code: 200 OK. Responded in 38.858201ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/250/events/2500"
}
```
...
---
Response status code: 200 OK. Responded in 39.351247ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/93/facility-use-slots/924"
}
```
...
---
Response status code: 200 OK. Responded in 39.68278ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/47/facility-use-slots/463"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F258%2Fevents%2F2578?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 13.502186ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/258/events/2578",
    "startDate": "2021-07-05T21:50:09+00:00",
    "endDate": "2021-07-06T01:33:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/258",
      "name": "Wooden Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/258#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F250%2Fevents%2F2500?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.971936ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/250/events/2500",
    "startDate": "2021-07-11T06:22:09+00:00",
    "endDate": "2021-07-11T11:17:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/250",
      "name": "Plastic Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/250#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F93%2Ffacility-use-slots%2F924?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.467387ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/93",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/93/facility-use-slots/924#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 5,
    "startDate": "2021-07-10T22:19:09+00:00",
    "endDate": "2021-07-11T03:41:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F47%2Ffacility-use-slots%2F463?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.853158ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/47",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/47/facility-use-slots/463#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 0,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 5,
    "startDate": "2021-07-06T12:42:09+00:00",
    "endDate": "2021-07-06T14:19:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/edeef2b2-4031-42f9-948d-3f5743dc3b4c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/258#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/258/events/2578"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/250#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/250/events/2500"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/93/facility-use-slots/924#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/93/facility-use-slots/924"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/47/facility-use-slots/463#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/47/facility-use-slots/463"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1032.123202ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/edeef2b2-4031-42f9-948d-3f5743dc3b4c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:57+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/258"
        },
        "maximumAttendeeCapacity": 28,
        "remainingAttendeeCapacity": 28
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/250"
        },
        "maximumAttendeeCapacity": 19,
        "remainingAttendeeCapacity": 19
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/93"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-10T22:19:09+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/47"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-06T12:42:09+00:00",
...
* ✅ should return reflect back payment, as the opportunity does not require payment
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/edeef2b2-4031-42f9-948d-3f5743dc3b4c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Izabella22@yahoo.com",
    "telephone": "(275) 377-7474 x5921",
    "givenName": "Rogahn",
    "familyName": "Paul",
    "identifier": "0364e96b-a64b-4bc3-a9a3-b19d428b2019"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1764.890594ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:59+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/edeef2b2-4031-42f9-948d-3f5743dc3b4c
...
---
Response status code: 201 Created. Responded in 1219.496549ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/edeef2b2-4031-42f9-948d-3f5743dc3b4c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/edeef2b2-4031-42f9-948d-3f5743dc3b4c#/orderedItems/3159",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/258#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/edeef2b2-4031-42f9-948d-3f5743dc3b4c#/orderedItems/3160",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/258#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/edeef2b2-4031-42f9-948d-3f5743dc3b4c#/orderedItems/3161",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/250#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/edeef2b2-4031-42f9-948d-3f5743dc3b4c#/orderedItems/3162",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/93/facility-use-slots/924#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/edeef2b2-4031-42f9-948d-3f5743dc3b4c#/orderedItems/3163",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/93/facility-use-slots/924#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/edeef2b2-4031-42f9-948d-3f5743dc3b4c#/orderedItems/3164",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/47/facility-use-slots/463#/offers/0",
        "allowCustomerCancellationFullRefund": false,
