...
---
Response status code: 200 OK. Responded in 296.411465ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/770"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F77%2Fevents%2F770?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 212.359783ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/770",
    "startDate": "2021-07-07T18:24:09+00:00",
    "endDate": "2021-07-07T18:56:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/12847927-9bae-40b5-914c-056fac1d902c
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/770"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 441.250438ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/12847927-9bae-40b5-914c-056fac1d902c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:48+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/12847927-9bae-40b5-914c-056fac1d902c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jensen43@yahoo.com",
    "telephone": "847-339-2925 x313",
    "givenName": "Cronin",
    "familyName": "Kassandra",
    "identifier": "3b39c74c-b062-41c4-8052-b15f1522f2ec"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 374.291974ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:49+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/12847927-9bae-40b5-914c-056fac1d902c
...
---
Response status code: 400 Bad Request. Responded in 48.669425ms.
```json
{
  "@context": "https://openactive.io/",
