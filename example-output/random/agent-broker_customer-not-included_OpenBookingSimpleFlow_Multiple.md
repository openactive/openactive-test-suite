[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:44:18 GMT+0000 (Coordinated Universal Time)

# agent-broker >> customer-not-included (OpenBookingSimpleFlow >> Multiple)
...
**Test:**  Customer not included in Order in AgentBroker mode

If customer is not included in Order in AgentBroker mode for C2 or B request, request should fail, returning 400 status code and IncompleteCustomerDetailsError.

### Running only this test

```bash
npm start -- --runInBand test/features/core/agent-broker/implemented/customer-not-included-test.js
```

---

⚠️ 29 passed with 0 failures, 504 warnings and 138 suggestions 

---


## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Fetch Opportunities
...
---
Response status code: 200 OK. Responded in 263.30767ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3190"
}
```
...
---
Response status code: 200 OK. Responded in 270.781982ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/303/events/3024"
}
```
...
---
Response status code: 200 OK. Responded in 264.075843ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/272/facility-use-slots/2711"
}
```
...
---
Response status code: 200 OK. Responded in 278.381405ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/143/facility-use-slots/1425"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F319%2Fevents%2F3190?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 246.358457ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3190",
    "startDate": "2021-07-09T23:42:09+00:00",
    "endDate": "2021-07-10T04:42:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/319",
      "name": "Concrete Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/319#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F303%2Fevents%2F3024?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 246.790998ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/303/events/3024",
    "startDate": "2021-07-04T20:42:09+00:00",
    "endDate": "2021-07-05T02:15:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/303",
      "name": "Plastic Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/303#/offers/0",
          "allowCustomerCancellationFullRefund": false,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F272%2Ffacility-use-slots%2F2711?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 247.326048ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/272",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/272/facility-use-slots/2711#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 6.49,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 2,
    "startDate": "2021-07-02T00:28:10+00:00",
    "endDate": "2021-07-02T06:16:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F143%2Ffacility-use-slots%2F1425?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 247.909804ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/143",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/143/facility-use-slots/1425#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 5.17,
    ...
    "remainingUses": 3,
    "startDate": "2021-07-06T18:59:10+00:00",
    "endDate": "2021-07-06T21:41:10+00:00"
  }
}
```
### Specs
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 0
### Specs
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> C1

### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e4cde5fd-a667-4fa0-b56a-a9899b250453
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/319#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3190"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/303#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/303/events/3024"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/272/facility-use-slots/2711#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/272/facility-use-slots/2711"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/143/facility-use-slots/1425#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/143/facility-use-slots/1425"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 530.072598ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e4cde5fd-a667-4fa0-b56a-a9899b250453",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:31+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/303"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/272"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-02T00:28:10+00:00",
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> C1 >> validation of C1
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> C2

### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e4cde5fd-a667-4fa0-b56a-a9899b250453
...
---
Response status code: 400 Bad Request. Responded in 32.679019ms.
```json
{
  "@context": "https://openactive.io/",
...
```
### Specs
* ✅ should return a response containing `"@type": "IncompleteCustomerDetailsError"` with status code `400`

## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at C2 >> C2 >> validation of C2
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Fetch Opportunities
...
---
Response status code: 200 OK. Responded in 350.593866ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/376/events/3759"
}
```
...
---
Response status code: 200 OK. Responded in 351.394642ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/608/events/6072"
}
```
...
---
Response status code: 200 OK. Responded in 353.775069ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/657/facility-use-slots/6561"
}
```
...
---
Response status code: 200 OK. Responded in 360.556517ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/773/facility-use-slots/7727"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F376%2Fevents%2F3759?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 391.980016ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/376/events/3759",
    "startDate": "2021-07-08T01:37:09+00:00",
    "endDate": "2021-07-08T07:07:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/376",
      "name": "Metal Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/376#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Optional",
          "price": 3.9,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT21H48M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F608%2Fevents%2F6072?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 399.084095ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/608/events/6072",
    "startDate": "2021-07-06T05:20:09+00:00",
    "endDate": "2021-07-06T09:06:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/608",
      "name": "Fresh Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/608#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 0.95,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT11H24M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F657%2Ffacility-use-slots%2F6561?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 401.786052ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/657",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/657/facility-use-slots/6561#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 9.26,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT19H22M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-04T17:46:10+00:00",
    "endDate": "2021-07-04T21:26:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F773%2Ffacility-use-slots%2F7727?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 402.612132ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/773",
      "name": "Granite Running Hall",
      "activity": [
        {
          "@type": "Concept",
          "@id": "https://openactive.io/activity-list#c07d63a0-8eb9-4602-8bcc-23be6deb8f83",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/773/facility-use-slots/7727#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 11.56,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "PT10H14M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-01T22:43:10+00:00",
    "endDate": "2021-07-02T01:32:10+00:00"
  }
}
```
### Specs
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 0
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> C1

### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/863e9bca-dbae-4a56-a798-34bc53a9ba77
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/376#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/376/events/3759"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/608#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/608/events/6072"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/657/facility-use-slots/6561#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/657/facility-use-slots/6561"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/773/facility-use-slots/7727#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/773/facility-use-slots/7727"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 705.936584ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/863e9bca-dbae-4a56-a798-34bc53a9ba77",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:36+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/376"
        },
        "maximumAttendeeCapacity": 49,
        "remainingAttendeeCapacity": 49
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/608"
        },
        "maximumAttendeeCapacity": 10,
        "remainingAttendeeCapacity": 10
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/657"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-04T17:46:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/773"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-01T22:43:10+00:00",
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> C1 >> validation of C1
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> C2

### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/863e9bca-dbae-4a56-a798-34bc53a9ba77
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Barton.Funk58@gmail.com",
    "telephone": "297-807-6609",
    "givenName": "Hyatt",
    "familyName": "Katherine",
    "identifier": "726263b3-6d43-45f0-a474-8b32fb154936"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1168.882919ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:38+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> C2 >> validation of C2
### Specs
* ✅ passes validation checks
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> B

### B Request
PUT https://localhost:5001/api/openbooking/orders/863e9bca-dbae-4a56-a798-34bc53a9ba77
...
---
Response status code: 400 Bad Request. Responded in 26.39321ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
...
## Booking should fail if Customer is not included in Order, because we are in AgentBroker mode >> at B or P >> B >> validation of B
### Specs
* ✅ passes validation checks
