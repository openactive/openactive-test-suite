...
# customer-requested-cancellation >> atomic-cancel (OpenBookingSimpleFlow >> ScheduledSession)
...
⚠️ 15 passed with 0 failures, 220 warnings and 80 suggestions 
...
---
Response status code: 200 OK. Responded in 424.281889ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/61/events/605"
}
```
...
---
Response status code: 200 OK. Responded in 326.425735ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/581/events/5802"
}
```
...
---
Response status code: 200 OK. Responded in 321.073602ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/239/events/2390"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F61%2Fevents%2F605?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 351.934778ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/61/events/605",
    "startDate": "2021-07-04T05:39:09+00:00",
    "endDate": "2021-07-04T08:42:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/61",
      "name": "Frozen Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/61#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F581%2Fevents%2F5802?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 352.214205ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/581/events/5802",
    "startDate": "2021-07-04T05:40:09+00:00",
    "endDate": "2021-07-04T07:20:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/581",
      "name": "Frozen Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/581#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT9H25M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F239%2Fevents%2F2390?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 352.55584ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/239/events/2390",
    "startDate": "2021-07-05T11:29:09+00:00",
    "endDate": "2021-07-05T16:12:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/239",
      "name": "Steel Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/239#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6f561dea-f8d4-4df9-b93e-e571af56c62c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/61#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/61/events/605"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/581#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/581/events/5802"
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/239#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/239/events/2390"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 417.650928ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6f561dea-f8d4-4df9-b93e-e571af56c62c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:42:15+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/61"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/581"
        },
        "maximumAttendeeCapacity": 46,
        "remainingAttendeeCapacity": 46
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/239"
        },
        "maximumAttendeeCapacity": 13,
        "remainingAttendeeCapacity": 13
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6f561dea-f8d4-4df9-b93e-e571af56c62c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ella_Stracke@yahoo.com",
    "telephone": "538-611-8908 x976",
    "givenName": "Flatley",
    "familyName": "Sabina",
    "identifier": "696d778b-fe1f-47da-b510-16e0504f4ad1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 199.947429ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:42:16+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6f561dea-f8d4-4df9-b93e-e571af56c62c
...
---
Response status code: 201 Created. Responded in 699.062976ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6f561dea-f8d4-4df9-b93e-e571af56c62c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6f561dea-f8d4-4df9-b93e-e571af56c62c#/orderedItems/16",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/61#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6f561dea-f8d4-4df9-b93e-e571af56c62c#/orderedItems/17",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/581#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6f561dea-f8d4-4df9-b93e-e571af56c62c#/orderedItems/18",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/239#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/6f561dea-f8d4-4df9-b93e-e571af56c62c
...
---
Response status code: 400 Bad Request. Responded in 265.776948ms.
```json
{
  "@context": "https://openactive.io/",
...
### Orders (orders) Feed listen for &#x27;6f561dea-f8d4-4df9-b93e-e571af56c62c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/6f561dea-f8d4-4df9-b93e-e571af56c62c


---
Response status code: 200 OK. Responded in 262.976884ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde",
  "message": "Listening for UUID: '6f561dea-f8d4-4df9-b93e-e571af56c62c' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 195.866434ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after successful OrderCancellation)

### Orders (orders) Feed collect for &#x27;6f561dea-f8d4-4df9-b93e-e571af56c62c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/6f561dea-f8d4-4df9-b93e-e571af56c62c


---
Response status code: 200 OK. Responded in 3420.295535ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "6f561dea-f8d4-4df9-b93e-e571af56c62c",
  "modified": 637607614402780900,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/6f561dea-f8d4-4df9-b93e-e571af56c62c",
    "identifier": "6f561dea-f8d4-4df9-b93e-e571af56c62c",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/6f561dea-f8d4-4df9-b93e-e571af56c62c#/orderedItems/18",
