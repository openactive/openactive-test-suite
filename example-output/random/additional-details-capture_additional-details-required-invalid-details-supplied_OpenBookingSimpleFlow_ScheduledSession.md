...
---
Response status code: 200 OK. Responded in 320.545593ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4478"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F448%2Fevents%2F4478?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 291.476528ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4478",
    "startDate": "2021-07-05T10:43:09+00:00",
    "endDate": "2021-07-05T13:16:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/55592985-63cf-49d8-8e4c-c372bef359ef
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4478"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 306.200928ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/55592985-63cf-49d8-8e4c-c372bef359ef",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:14+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/55592985-63cf-49d8-8e4c-c372bef359ef
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ruth.Cummings53@hotmail.com",
    "telephone": "615.591.3343",
    "givenName": "Howell",
    "familyName": "Ottis",
    "identifier": "c792dfb3-a656-4188-9a3c-7ef7fdce127b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 120.579571ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/55592985-63cf-49d8-8e4c-c372bef359ef
...
---
Response status code: 409 Conflict. Responded in 39.578765ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 409,
  "description": "The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.: Value provided is not a Url, The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.: Value provided is not one of ValueOptions provided"
}
```
### Specs
