...
# free-opportunities >> opportunity-free-without-checkpoints (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 13 passed with 0 failures, 220 warnings and 58 suggestions 
...
---
Response status code: 200 OK. Responded in 340.518007ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/311/events/3101"
}
```
...
---
Response status code: 200 OK. Responded in 343.943432ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/379/events/3790"
}
```
...
---
Response status code: 200 OK. Responded in 344.428977ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/37/facility-use-slots/368"
}
```
...
---
Response status code: 200 OK. Responded in 351.388935ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/651/facility-use-slots/6506"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F311%2Fevents%2F3101?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 225.948571ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/311/events/3101",
    "startDate": "2021-07-09T14:14:09+00:00",
    "endDate": "2021-07-09T15:46:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F379%2Fevents%2F3790?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 226.781649ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/379/events/3790",
    "startDate": "2021-07-07T17:08:09+00:00",
    "endDate": "2021-07-07T22:54:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F37%2Ffacility-use-slots%2F368?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 227.441713ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/37/facility-use-slots/368#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 6,
    "startDate": "2021-07-03T02:56:09+00:00",
    "endDate": "2021-07-03T06:29:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F651%2Ffacility-use-slots%2F6506?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 228.196684ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/651",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/651/facility-use-slots/6506#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT4H12M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-08T23:00:10+00:00",
    "endDate": "2021-07-09T03:18:10+00:00"
  }
}
```
### Specs
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/79df5cda-bb6a-442d-833a-0c4aeb3d815c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Helen.Harris@gmail.com",
    "telephone": "1-411-283-6619 x8632",
    "givenName": "Lang",
    "familyName": "Linnea",
    "identifier": "68d8e938-1afa-4fb4-99dc-9c142f34af65"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/311/events/3101"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/379/events/3790"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/37/facility-use-slots/368#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/37/facility-use-slots/368"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/651/facility-use-slots/6506#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/651/facility-use-slots/6506"
    }
  ],
  "totalPaymentDue": {
...
---
Response status code: 201 Created. Responded in 1092.286313ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/79df5cda-bb6a-442d-833a-0c4aeb3d815c",
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/79df5cda-bb6a-442d-833a-0c4aeb3d815c#/orderedItems/2069",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/311#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/79df5cda-bb6a-442d-833a-0c4aeb3d815c#/orderedItems/2070",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/311#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/79df5cda-bb6a-442d-833a-0c4aeb3d815c#/orderedItems/2071",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/379#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/79df5cda-bb6a-442d-833a-0c4aeb3d815c#/orderedItems/2072",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/37/facility-use-slots/368#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/79df5cda-bb6a-442d-833a-0c4aeb3d815c#/orderedItems/2073",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/37/facility-use-slots/368#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/79df5cda-bb6a-442d-833a-0c4aeb3d815c#/orderedItems/2074",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/651/facility-use-slots/6506#/offers/0",
        "allowCustomerCancellationFullRefund": false,
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/651"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-08T23:00:10+00:00",
