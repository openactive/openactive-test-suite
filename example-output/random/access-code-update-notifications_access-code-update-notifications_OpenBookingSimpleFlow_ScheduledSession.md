...
---
Response status code: 200 OK. Responded in 309.495316ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/182/events/1816"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F182%2Fevents%2F1816?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 185.638746ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/182/events/1816",
    "startDate": "2021-07-03T23:22:09+00:00",
    "endDate": "2021-07-04T05:13:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/182",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/182#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/182#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/182/events/1816"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 115.595688ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Green.Boyer69@hotmail.com",
    "telephone": "(881) 700-4037 x512",
    "givenName": "Christiansen",
    "familyName": "Kane",
    "identifier": "471cec3b-1ea2-46b8-a505-e932c12430cd"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 196.20695ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c
...
---
Response status code: 201 Created. Responded in 105.925768ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c#/orderedItems/700",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/182#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Orders (orders) Feed listen for &#x27;ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c


---
Response status code: 200 OK. Responded in 494.24168ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 45.051883ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AccessCodeUpdateSimulateAction)

### Orders (orders) Feed collect for &#x27;ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c


---
Response status code: 200 OK. Responded in 3031.100926ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c",
  "modified": 637607616509997300,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c",
    "identifier": "ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/ac1a2ba3-76c2-4cd3-8bcc-e22e63f5616c#/orderedItems/700",
