...
# access-channel-update-notifications >> access-channel-update-notifications (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 16 passed with 0 failures, 269 warnings and 96 suggestions 
...
---
Response status code: 200 OK. Responded in 395.232678ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1627/events/16262"
}
```
...
---
Response status code: 200 OK. Responded in 395.497003ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1610/events/16091"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1627%2Fevents%2F16262?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 324.641366ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1627/events/16262",
    "startDate": "2021-07-05T15:28:09+00:00",
    "endDate": "2021-07-05T21:06:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1610%2Fevents%2F16091?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 325.018902ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1610/events/16091",
    "startDate": "2021-07-09T15:54:09+00:00",
    "endDate": "2021-07-09T19:28:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1610",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1610#/offers/0",
          ...
          "price": 7.48,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT2H42M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4242c602-0d7b-446a-b352-92a419aba8dd
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1627/events/16262"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1610#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1610/events/16091"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 162.904388ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4242c602-0d7b-446a-b352-92a419aba8dd",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4242c602-0d7b-446a-b352-92a419aba8dd
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Hailee_Reinger@hotmail.com",
    "telephone": "1-773-225-8906 x6463",
    "givenName": "Lebsack",
    "familyName": "Oral",
    "identifier": "7c667624-ec7b-4e29-ae6b-c308bc7fabf9"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 158.308551ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/4242c602-0d7b-446a-b352-92a419aba8dd
...
---
Response status code: 201 Created. Responded in 152.023653ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/4242c602-0d7b-446a-b352-92a419aba8dd",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4242c602-0d7b-446a-b352-92a419aba8dd#/orderedItems/588",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1627#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4242c602-0d7b-446a-b352-92a419aba8dd#/orderedItems/589",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1627#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4242c602-0d7b-446a-b352-92a419aba8dd#/orderedItems/590",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1610#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/4242c602-0d7b-446a-b352-92a419aba8dd/versions/e3f9710e-e2ae-4557-b6bc-4d35dab0e4cc",
  "payment": {
    "@type": "Payment",
    "identifier": "o9ssYgz2g",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;4242c602-0d7b-446a-b352-92a419aba8dd&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/4242c602-0d7b-446a-b352-92a419aba8dd


---
Response status code: 200 OK. Responded in 353.550113ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '4242c602-0d7b-446a-b352-92a419aba8dd' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 442.864805ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;4242c602-0d7b-446a-b352-92a419aba8dd&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/4242c602-0d7b-446a-b352-92a419aba8dd


---
Response status code: 200 OK. Responded in 1969.1683170000001ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "4242c602-0d7b-446a-b352-92a419aba8dd",
  "modified": 637607616187392300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/4242c602-0d7b-446a-b352-92a419aba8dd",
    "identifier": "4242c602-0d7b-446a-b352-92a419aba8dd",
...
---
Response status code: 200 OK. Responded in 273.37249ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4242c602-0d7b-446a-b352-92a419aba8dd
...
---
Response status code: 201 Created. Responded in 98.119629ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4242c602-0d7b-446a-b352-92a419aba8dd",
  "identifier": "4242c602-0d7b-446a-b352-92a419aba8dd",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1879.237394ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "4242c602-0d7b-446a-b352-92a419aba8dd",
  "modified": 637607616214883300
}
```
### Specs
* ✅ should return 200 on success
...
### Orders (orders) Feed listen for &#x27;4242c602-0d7b-446a-b352-92a419aba8dd&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/4242c602-0d7b-446a-b352-92a419aba8dd


---
Response status code: 200 OK. Responded in 347.283589ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "message": "Listening for UUID: '4242c602-0d7b-446a-b352-92a419aba8dd' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 188.303488ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AccessChannelUpdateSimulateAction)

### Orders (orders) Feed collect for &#x27;4242c602-0d7b-446a-b352-92a419aba8dd&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/4242c602-0d7b-446a-b352-92a419aba8dd


---
Response status code: 200 OK. Responded in 2874.583463ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "4242c602-0d7b-446a-b352-92a419aba8dd",
  "modified": 637607616243214300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/4242c602-0d7b-446a-b352-92a419aba8dd",
    ...
    "orderedItem": [
      {
        ...
        "accessChannel": {
          ...
          "name": "Zoom Video Chat",
          "description": "Please log into Zoom a few minutes before the event",
          "accessCode": "8713824268",
          "accessId": "8243707516",
          "url": "http://valentin.com/"
        },
        "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1610/events/16091",
        "orderItemStatus": "https://openactive.io/OrderItemConfirmed"
      },
      {
        ...
        "accessChannel": {
          ...
          "name": "Zoom Video Chat",
          "description": "Please log into Zoom a few minutes before the event",
          "accessCode": "4297271984",
          "accessId": "4523990297",
          "url": "https://alfredo.org/"
        },
        "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1627/events/16262",
        "orderItemStatus": "https://openactive.io/OrderItemConfirmed"
      },
