...
# customer-details-capture-identifier >> customer-identifier-capture (OpenBookingSimpleFlow >> FacilityUseSlot)
...
⚠️ 7 passed with 0 failures, 71 warnings and 8 suggestions 
...
---
Response status code: 200 OK. Responded in 114.777605ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/631/facility-use-slots/6310"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F631%2Ffacility-use-slots%2F6310?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 216.889306ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/631/facility-use-slots/6310#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT2H26M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-04T11:42:10+00:00",
    "endDate": "2021-07-04T13:22:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4208faba-41e0-453c-b550-3c437316caba
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/631/facility-use-slots/6310#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/631/facility-use-slots/6310"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 430.313483ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4208faba-41e0-453c-b550-3c437316caba",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4208faba-41e0-453c-b550-3c437316caba
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Sammie65@hotmail.com",
    "telephone": "387.358.4365 x4949",
    "givenName": "Cronin",
    "familyName": "Malika",
    "identifier": "9d59ccfd-c740-4fa0-b024-fdbd3e81420a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 222.862673ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4208faba-41e0-453c-b550-3c437316caba
...
---
Response status code: 201 Created. Responded in 707.826802ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4208faba-41e0-453c-b550-3c437316caba",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4208faba-41e0-453c-b550-3c437316caba#/orderedItems/1755",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/631/facility-use-slots/6310#/offers/0",
        "allowCustomerCancellationFullRefund": false,
