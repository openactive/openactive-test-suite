...
⚠️ 15 passed with 0 failures, 296 warnings and 82 suggestions 
...
---
Response status code: 200 OK. Responded in 344.741395ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/366/events/3655"
}
```
...
---
Response status code: 200 OK. Responded in 345.238542ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/247/events/2462"
}
```
...
---
Response status code: 200 OK. Responded in 340.548496ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/51/facility-use-slots/503"
}
```
...
---
Response status code: 200 OK. Responded in 342.963325ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/370/facility-use-slots/3692"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F366%2Fevents%2F3655?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 254.610821ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/366/events/3655",
    "startDate": "2021-07-06T03:31:09+00:00",
    "endDate": "2021-07-06T05:01:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/366",
      "name": "Frozen Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/366#/offers/0",
          ...
          "price": 2.62,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT22H34M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F247%2Fevents%2F2462?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 254.536314ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/247/events/2462",
    "startDate": "2021-07-04T08:52:09+00:00",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F51%2Ffacility-use-slots%2F503?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 254.559816ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/51/facility-use-slots/503#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingIntakeForm"
        ],
    ...
    "remainingUses": 5,
    "startDate": "2021-07-06T10:57:09+00:00",
    "endDate": "2021-07-06T16:08:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F370%2Ffacility-use-slots%2F3692?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 254.784237ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/370",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/370/facility-use-slots/3692#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 14.11,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT43M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-02T07:49:10+00:00",
    "endDate": "2021-07-02T11:58:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f8f6392e-81b3-4517-bd08-3a221b80b8b2
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/366#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/366/events/3655"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/247/events/2462"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/51/facility-use-slots/503#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/51/facility-use-slots/503"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/370/facility-use-slots/3692#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/370/facility-use-slots/3692"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 600.031335ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f8f6392e-81b3-4517-bd08-3a221b80b8b2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:19+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/366"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/370"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-02T07:49:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f8f6392e-81b3-4517-bd08-3a221b80b8b2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jolie96@yahoo.com",
    "telephone": "1-689-821-8107",
    "givenName": "Dicki",
    "familyName": "Lysanne",
    "identifier": "6aa4b5e9-b755-4f94-b326-f96e32b30b01"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 1071.150918ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f8f6392e-81b3-4517-bd08-3a221b80b8b2
...
---
Response status code: 409 Conflict. Responded in 166.311109ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 409,
  "description": "The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.: Value provided is not a boolean, The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.: Value provided is not a Url, The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.: Value provided is not a boolean, The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.: Value provided is not a Url, The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.: Value provided is not a boolean, The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.: Value provided is not a boolean"
}
```
### Specs
