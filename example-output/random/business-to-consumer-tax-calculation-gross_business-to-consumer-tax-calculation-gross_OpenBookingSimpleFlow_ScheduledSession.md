...
---
Response status code: 200 OK. Responded in 52.118661ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/330/events/3292"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F330%2Fevents%2F3292?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 12.799819ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/330/events/3292",
    "startDate": "2021-07-02T21:25:09+00:00",
    "endDate": "2021-07-03T01:48:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/330",
      "name": "Fresh Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/330#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d46ac8ee-0d94-4275-a2ec-40a9bfcca298
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/330#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/330/events/3292"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 389.593078ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d46ac8ee-0d94-4275-a2ec-40a9bfcca298",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d46ac8ee-0d94-4275-a2ec-40a9bfcca298
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Wilfredo16@hotmail.com",
    "telephone": "1-451-527-0403 x68790",
    "givenName": "Lockman",
    "familyName": "Tobin",
    "identifier": "a942051b-f187-4c98-92b9-e76d5d26d1ff"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1036.419837ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d46ac8ee-0d94-4275-a2ec-40a9bfcca298
...
---
Response status code: 201 Created. Responded in 1102.380814ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d46ac8ee-0d94-4275-a2ec-40a9bfcca298",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d46ac8ee-0d94-4275-a2ec-40a9bfcca298#/orderedItems/2985",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/330#/offers/0",
        "allowCustomerCancellationFullRefund": false,
