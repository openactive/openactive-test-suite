...
---
Response status code: 200 OK. Responded in 60.587455ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/86/events/855"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F86%2Fevents%2F855?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 51.532095ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/86/events/855",
    "startDate": "2021-07-11T06:46:09+00:00",
    "endDate": "2021-07-11T09:03:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/86",
      "name": "Cotton Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/86#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/79e5a202-db8e-4c6a-997a-c7183c31eb4a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/86#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/86/events/855"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1662.839857ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/79e5a202-db8e-4c6a-997a-c7183c31eb4a",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:51+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/86"
        },
        "maximumAttendeeCapacity": 34,
        "remainingAttendeeCapacity": 34
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/79e5a202-db8e-4c6a-997a-c7183c31eb4a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Johann55@yahoo.com",
    "telephone": "738-806-0866 x316",
    "givenName": "Yundt",
    "familyName": "Meredith",
    "identifier": "f09eb21d-632c-4062-bf60-bb20b958a358"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 442.35327ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/79e5a202-db8e-4c6a-997a-c7183c31eb4a
...
---
Response status code: 201 Created. Responded in 972.999001ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/79e5a202-db8e-4c6a-997a-c7183c31eb4a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/79e5a202-db8e-4c6a-997a-c7183c31eb4a#/orderedItems/2979",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/86#/offers/0",
        "allowCustomerCancellationFullRefund": true,
