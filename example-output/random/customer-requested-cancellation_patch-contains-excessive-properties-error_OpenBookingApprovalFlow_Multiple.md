...
---
Response status code: 200 OK. Responded in 183.334288ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1134/events/11334"
}
```
...
---
Response status code: 200 OK. Responded in 183.303884ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1205/events/12048"
}
```
...
---
Response status code: 200 OK. Responded in 183.229177ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1398/facility-use-slots/13971"
}
```
...
---
Response status code: 200 OK. Responded in 167.172855ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1046/facility-use-slots/10456"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1134%2Fevents%2F11334?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 157.743461ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1134/events/11334",
    "startDate": "2021-07-02T15:43:09+00:00",
    "endDate": "2021-07-02T17:50:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1205%2Fevents%2F12048?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 158.017586ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1205/events/12048",
    "startDate": "2021-07-10T05:27:09+00:00",
    "endDate": "2021-07-10T06:38:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1398%2Ffacility-use-slots%2F13971?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 163.258984ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1398/facility-use-slots/13971#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT9H41M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-06T15:01:10+00:00",
    "endDate": "2021-07-06T18:40:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1046%2Ffacility-use-slots%2F10456?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 163.74873ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1046",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1046/facility-use-slots/10456#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 2,
    "startDate": "2021-07-09T20:55:10+00:00",
    "endDate": "2021-07-10T00:51:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f515e7f2-b0bf-456c-b1fb-d80ca0adc835
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1134/events/11334"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1205/events/12048"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1398/facility-use-slots/13971#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1398/facility-use-slots/13971"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1046/facility-use-slots/10456#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1046/facility-use-slots/10456"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 557.386662ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f515e7f2-b0bf-456c-b1fb-d80ca0adc835",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f515e7f2-b0bf-456c-b1fb-d80ca0adc835
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cullen_Willms@yahoo.com",
    "telephone": "(536) 462-3012",
    "givenName": "Feeney",
    "familyName": "Amy",
    "identifier": "77828248-05e3-425d-9a12-4616cfa85b8f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 712.500173ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/f515e7f2-b0bf-456c-b1fb-d80ca0adc835
...
---
Response status code: 201 Created. Responded in 737.175512ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/f515e7f2-b0bf-456c-b1fb-d80ca0adc835",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f515e7f2-b0bf-456c-b1fb-d80ca0adc835#/orderedItems/1636",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1134#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f515e7f2-b0bf-456c-b1fb-d80ca0adc835#/orderedItems/1637",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1134#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f515e7f2-b0bf-456c-b1fb-d80ca0adc835#/orderedItems/1638",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1205#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f515e7f2-b0bf-456c-b1fb-d80ca0adc835#/orderedItems/1639",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1398/facility-use-slots/13971#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f515e7f2-b0bf-456c-b1fb-d80ca0adc835#/orderedItems/1640",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1398/facility-use-slots/13971#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f515e7f2-b0bf-456c-b1fb-d80ca0adc835#/orderedItems/1641",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1046/facility-use-slots/10456#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/f515e7f2-b0bf-456c-b1fb-d80ca0adc835/versions/24727b26-1a2a-4f84-b735-4106c1108979",
  "payment": {
    "@type": "Payment",
    "identifier": "eGvVIM9C4",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;f515e7f2-b0bf-456c-b1fb-d80ca0adc835&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/f515e7f2-b0bf-456c-b1fb-d80ca0adc835


---
Response status code: 200 OK. Responded in 131.868506ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619209819589&afterId=06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3",
  "message": "Listening for UUID: 'f515e7f2-b0bf-456c-b1fb-d80ca0adc835' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 32.546687ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;f515e7f2-b0bf-456c-b1fb-d80ca0adc835&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/f515e7f2-b0bf-456c-b1fb-d80ca0adc835


---
Response status code: 200 OK. Responded in 2485.047426ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "f515e7f2-b0bf-456c-b1fb-d80ca0adc835",
  "modified": 637607619256746200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/f515e7f2-b0bf-456c-b1fb-d80ca0adc835",
    "identifier": "f515e7f2-b0bf-456c-b1fb-d80ca0adc835",
...
---
Response status code: 200 OK. Responded in 294.660093ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619238589204&afterId=06b8cea1-7ea9-4bd7-a0a2-59e9df2eedf3",
  "message": "Listening for UUID: 'f515e7f2-b0bf-456c-b1fb-d80ca0adc835' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/f515e7f2-b0bf-456c-b1fb-d80ca0adc835
...
---
Response status code: 201 Created. Responded in 838.762882ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f515e7f2-b0bf-456c-b1fb-d80ca0adc835",
  "identifier": "f515e7f2-b0bf-456c-b1fb-d80ca0adc835",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 250.286377ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "f515e7f2-b0bf-456c-b1fb-d80ca0adc835",
  "modified": 637607619286078800
}
```
### Specs
* ✅ should return 200 on success
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/f515e7f2-b0bf-456c-b1fb-d80ca0adc835
...
---
Response status code: 400 Bad Request. Responded in 39.644666ms.
```json
{
  "@context": "https://openactive.io/",
