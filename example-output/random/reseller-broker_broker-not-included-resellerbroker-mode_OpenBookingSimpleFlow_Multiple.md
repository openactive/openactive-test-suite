...
# reseller-broker >> broker-not-included-resellerbroker-mode (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 42 passed with 0 failures, 609 warnings and 164 suggestions 
...
---
Response status code: 200 OK. Responded in 201.153231ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/332/events/3317"
}
```
...
---
Response status code: 200 OK. Responded in 229.415919ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/332/events/3314"
}
```
...
---
Response status code: 200 OK. Responded in 234.57841ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/701/facility-use-slots/7004"
}
```
...
---
Response status code: 200 OK. Responded in 234.928244ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/604/facility-use-slots/6031"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F332%2Fevents%2F3317?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 382.661593ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/332/events/3317",
    "startDate": "2021-07-09T16:31:09+00:00",
    "endDate": "2021-07-09T19:13:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F332%2Fevents%2F3314?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 388.814879ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/332/events/3314",
    "startDate": "2021-07-08T19:32:09+00:00",
    "endDate": "2021-07-08T22:03:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/332",
      "name": "Rubber Running",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F701%2Ffacility-use-slots%2F7004?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 396.121473ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/701",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/701/facility-use-slots/7004#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "PT20H11M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-01T23:48:10+00:00",
    "endDate": "2021-07-02T01:37:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F604%2Ffacility-use-slots%2F6031?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 399.335479ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/604/facility-use-slots/6031#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT31M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-03T12:27:10+00:00",
    "endDate": "2021-07-03T16:19:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cf13d653-3e39-4e10-a7d6-59962e7a4354
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/332/events/3317"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/332#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/332/events/3314"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/701/facility-use-slots/7004#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/701/facility-use-slots/7004"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/604/facility-use-slots/6031#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/604/facility-use-slots/6031"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 400 Bad Request. Responded in 30.674717ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 495.02818ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/25/events/243"
}
```
...
---
Response status code: 200 OK. Responded in 495.597734ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/79/events/783"
}
```
...
---
Response status code: 200 OK. Responded in 496.277499ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/141/facility-use-slots/1401"
}
```
...
---
Response status code: 200 OK. Responded in 497.156482ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/23/facility-use-slots/227"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F25%2Fevents%2F243?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 433.565635ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/25/events/243",
    "startDate": "2021-07-03T10:43:09+00:00",
    "endDate": "2021-07-03T15:06:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F79%2Fevents%2F783?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 444.084035ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/79/events/783",
    "startDate": "2021-07-09T07:51:09+00:00",
    "endDate": "2021-07-09T13:47:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F141%2Ffacility-use-slots%2F1401?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 444.174744ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/141",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/141/facility-use-slots/1401#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 6,
    "startDate": "2021-07-10T17:41:10+00:00",
    "endDate": "2021-07-10T21:51:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F23%2Ffacility-use-slots%2F227?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 444.914114ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/23/facility-use-slots/227#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 8.9,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 8,
    "startDate": "2021-07-06T14:30:09+00:00",
    "endDate": "2021-07-06T18:38:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ae9bee22-8cd1-4e3c-9da4-97534b64fd90
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/25#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/25/events/243"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/79/events/783"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/141/facility-use-slots/1401#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/141/facility-use-slots/1401"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/23/facility-use-slots/227#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/23/facility-use-slots/227"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 722.575421ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ae9bee22-8cd1-4e3c-9da4-97534b64fd90",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:36+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/23"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-06T14:30:09+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ae9bee22-8cd1-4e3c-9da4-97534b64fd90
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Geovanny_Gottlieb@gmail.com",
    "telephone": "667.841.2074 x515",
    "givenName": "Turner",
    "familyName": "Armani",
    "identifier": "58dc9ecf-cf4c-441d-b540-2182253c78d3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 20.835482ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
---
Response status code: 200 OK. Responded in 222.563367ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/420/events/4198"
}
```
...
---
Response status code: 200 OK. Responded in 219.325459ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/41/events/402"
}
```
...
---
Response status code: 200 OK. Responded in 220.615582ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/695/facility-use-slots/6942"
}
```
...
---
Response status code: 200 OK. Responded in 226.150908ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/48/facility-use-slots/480"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F420%2Fevents%2F4198?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 400.875826ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/420/events/4198",
    "startDate": "2021-07-03T16:17:09+00:00",
    "endDate": "2021-07-03T21:44:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/420",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/420#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT23H44M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F41%2Fevents%2F402?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 401.294766ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/41/events/402",
    "startDate": "2021-07-04T02:31:09+00:00",
    "endDate": "2021-07-04T04:56:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F695%2Ffacility-use-slots%2F6942?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 402.016935ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/695",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/695/facility-use-slots/6942#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT5H28M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-03T12:34:10+00:00",
    "endDate": "2021-07-03T15:17:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F48%2Ffacility-use-slots%2F480?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 402.515181ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/48",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/48/facility-use-slots/480#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
    ...
    "remainingUses": 5,
    "startDate": "2021-07-03T03:03:09+00:00",
    "endDate": "2021-07-03T05:00:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b47e5283-7da2-4ab0-a8e5-050587513e13
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/420#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/420/events/4198"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/41/events/402"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/695/facility-use-slots/6942#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/695/facility-use-slots/6942"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/48/facility-use-slots/480#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/48/facility-use-slots/480"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 430.142584ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b47e5283-7da2-4ab0-a8e5-050587513e13",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/420"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b47e5283-7da2-4ab0-a8e5-050587513e13
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Green50@hotmail.com",
    "telephone": "(681) 443-1065",
    "givenName": "Flatley",
    "familyName": "Matt",
    "identifier": "63c26a98-f965-4e46-b083-8138b45b3412"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 610.615638ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:41+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b47e5283-7da2-4ab0-a8e5-050587513e13
...
---
Response status code: 400 Bad Request. Responded in 26.965863ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
