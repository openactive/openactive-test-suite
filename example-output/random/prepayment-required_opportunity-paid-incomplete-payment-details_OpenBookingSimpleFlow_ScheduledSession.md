...
---
Response status code: 200 OK. Responded in 232.009166ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2750"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F275%2Fevents%2F2750?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 107.415717ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2750",
    "startDate": "2021-07-03T15:42:09+00:00",
    "endDate": "2021-07-03T19:33:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fb06b280-1772-4cb5-95e7-c2e3d9168d55
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2750"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 465.102636ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fb06b280-1772-4cb5-95e7-c2e3d9168d55",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:55:37+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fb06b280-1772-4cb5-95e7-c2e3d9168d55
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Vicenta.Veum@hotmail.com",
    "telephone": "(250) 229-1982 x7432",
    "givenName": "Koss",
    "familyName": "Cleo",
    "identifier": "bca60af4-964c-4f11-b20e-05af075742f6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 568.460266ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/fb06b280-1772-4cb5-95e7-c2e3d9168d55
...
---
Response status code: 400 Bad Request. Responded in 121.925096ms.
```json
{
  "@context": "https://openactive.io/",
