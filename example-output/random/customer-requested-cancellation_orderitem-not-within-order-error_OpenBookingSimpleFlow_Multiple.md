...
# customer-requested-cancellation >> orderitem-not-within-order-error (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 16 passed with 0 failures, 384 warnings and 104 suggestions 
...
---
Response status code: 200 OK. Responded in 392.080707ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/335/events/3349"
}
```
...
---
Response status code: 200 OK. Responded in 385.239457ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/376/events/3752"
}
```
...
---
Response status code: 200 OK. Responded in 392.564554ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/70/facility-use-slots/697"
}
```
...
---
Response status code: 200 OK. Responded in 393.47724ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3826"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F335%2Fevents%2F3349?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 252.574133ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/335/events/3349",
    "startDate": "2021-07-08T04:24:09+00:00",
    "endDate": "2021-07-08T06:00:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F376%2Fevents%2F3752?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 253.335206ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/376/events/3752",
    "startDate": "2021-07-04T17:17:09+00:00",
    "endDate": "2021-07-04T23:07:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F70%2Ffacility-use-slots%2F697?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 253.959865ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/70/facility-use-slots/697#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 6,
    "startDate": "2021-07-10T19:31:09+00:00",
    "endDate": "2021-07-10T21:49:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F383%2Ffacility-use-slots%2F3826?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 254.654831ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3826#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 9.22,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT7H59M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-05T08:09:10+00:00",
    "endDate": "2021-07-05T13:17:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/454bc679-2914-415b-a73c-0d1bdf90a3c4
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/335/events/3349"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/376/events/3752"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/70/facility-use-slots/697#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/70/facility-use-slots/697"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3826#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3826"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 715.829113ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/454bc679-2914-415b-a73c-0d1bdf90a3c4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:58+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/454bc679-2914-415b-a73c-0d1bdf90a3c4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alfredo64@hotmail.com",
    "telephone": "265.631.2903",
    "givenName": "Tillman",
    "familyName": "Natasha",
    "identifier": "acf20cf9-6f33-423a-8add-1b8cadfbc493"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 556.310185ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/454bc679-2914-415b-a73c-0d1bdf90a3c4
...
---
Response status code: 201 Created. Responded in 573.050776ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/454bc679-2914-415b-a73c-0d1bdf90a3c4",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/454bc679-2914-415b-a73c-0d1bdf90a3c4#/orderedItems/1320",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/335#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/454bc679-2914-415b-a73c-0d1bdf90a3c4#/orderedItems/1321",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/335#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/454bc679-2914-415b-a73c-0d1bdf90a3c4#/orderedItems/1322",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/376#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/454bc679-2914-415b-a73c-0d1bdf90a3c4#/orderedItems/1323",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/70/facility-use-slots/697#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/454bc679-2914-415b-a73c-0d1bdf90a3c4#/orderedItems/1324",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/70/facility-use-slots/697#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/454bc679-2914-415b-a73c-0d1bdf90a3c4#/orderedItems/1325",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3826#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/bda19def-32cc-49bd-89dc-45f173d2b2c0
...
---
Response status code: 500 Internal Server Error. Responded in 16.717789ms.
```json
{
  "@context": "https://openactive.io/",
