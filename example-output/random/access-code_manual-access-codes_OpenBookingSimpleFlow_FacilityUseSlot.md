...
---
Response status code: 200 OK. Responded in 422.583075ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/773/facility-use-slots/7721"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F773%2Ffacility-use-slots%2F7721?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 349.848261ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/773/facility-use-slots/7721#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT1H22M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-03T00:21:10+00:00",
    "endDate": "2021-07-03T04:38:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c8d03cf7-8a1c-4c9f-89d9-a1c0241397bc
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/773/facility-use-slots/7721#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/773/facility-use-slots/7721"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 827.745295ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c8d03cf7-8a1c-4c9f-89d9-a1c0241397bc",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c8d03cf7-8a1c-4c9f-89d9-a1c0241397bc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cloyd87@yahoo.com",
    "telephone": "(701) 799-2032",
    "givenName": "Toy",
    "familyName": "Tyshawn",
    "identifier": "e1b84a68-91aa-43ec-9181-f9a14a786bec"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 153.504993ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c8d03cf7-8a1c-4c9f-89d9-a1c0241397bc
...
---
Response status code: 201 Created. Responded in 165.98028ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c8d03cf7-8a1c-4c9f-89d9-a1c0241397bc",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c8d03cf7-8a1c-4c9f-89d9-a1c0241397bc#/orderedItems/1062",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/773/facility-use-slots/7721#/offers/0",
        "allowCustomerCancellationFullRefund": true,
