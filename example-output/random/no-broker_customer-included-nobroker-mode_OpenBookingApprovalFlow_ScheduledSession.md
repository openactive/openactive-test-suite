[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:48:39 GMT+0000 (Coordinated Universal Time)

# no-broker >> customer-included-nobroker-mode (OpenBookingApprovalFlow >> ScheduledSession)
...
⚠️ 9 passed with 0 failures, 96 warnings and 32 suggestions 
...
---
Response status code: 200 OK. Responded in 58.479656ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1422/events/14216"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1422%2Fevents%2F14216?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 89.747527ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1422/events/14216",
    "startDate": "2021-07-03T03:13:09+00:00",
    "endDate": "2021-07-03T08:41:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1422",
      "name": "Soft Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1422#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT5H19M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fcddfb1e-a742-4e11-acb4-4ad189986a01
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1422#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1422/events/14216"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 484.020584ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fcddfb1e-a742-4e11-acb4-4ad189986a01",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:01+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1422"
        },
        "maximumAttendeeCapacity": 30,
        "remainingAttendeeCapacity": 30
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fcddfb1e-a742-4e11-acb4-4ad189986a01
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Connie42@yahoo.com",
    "telephone": "(548) 965-1590 x42467",
    "givenName": "Abbott",
    "familyName": "Houston",
    "identifier": "4c442b41-e4f4-4102-b555-4e6b0adad9a5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1798.972413ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:03+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/fcddfb1e-a742-4e11-acb4-4ad189986a01
...
---
Response status code: 201 Created. Responded in 338.984006ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/fcddfb1e-a742-4e11-acb4-4ad189986a01",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fcddfb1e-a742-4e11-acb4-4ad189986a01#/orderedItems/2269",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1422#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/fcddfb1e-a742-4e11-acb4-4ad189986a01/versions/3ea4f8f5-91dd-4130-acc9-8dfd318482a0",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;fcddfb1e-a742-4e11-acb4-4ad189986a01&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/fcddfb1e-a742-4e11-acb4-4ad189986a01


---
Response status code: 200 OK. Responded in 180.627661ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'fcddfb1e-a742-4e11-acb4-4ad189986a01' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 537.675083ms.
### Specs
...
### Orders (order-proposals) Feed collect for &#x27;fcddfb1e-a742-4e11-acb4-4ad189986a01&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/fcddfb1e-a742-4e11-acb4-4ad189986a01


---
Response status code: 200 OK. Responded in 2034.732315ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "fcddfb1e-a742-4e11-acb4-4ad189986a01",
  "modified": 637607621443763500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/fcddfb1e-a742-4e11-acb4-4ad189986a01",
    "identifier": "fcddfb1e-a742-4e11-acb4-4ad189986a01",
...
---
Response status code: 200 OK. Responded in 143.979379ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621438921314&afterId=092c8923-9691-44ac-a821-b948e184d5c0",
  "message": "Listening for UUID: 'fcddfb1e-a742-4e11-acb4-4ad189986a01' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/fcddfb1e-a742-4e11-acb4-4ad189986a01
...
---
Response status code: 201 Created. Responded in 1452.896836ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/fcddfb1e-a742-4e11-acb4-4ad189986a01",
  "identifier": "fcddfb1e-a742-4e11-acb4-4ad189986a01",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 638.102325ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "fcddfb1e-a742-4e11-acb4-4ad189986a01",
  "modified": 637607621471655300
}
```
### Specs
* ✅ should return 200 on success
