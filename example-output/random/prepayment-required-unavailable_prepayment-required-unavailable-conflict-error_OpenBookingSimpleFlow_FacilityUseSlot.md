[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:39:25 GMT+0000 (Coordinated Universal Time)

# prepayment-required-unavailable >> prepayment-required-unavailable-conflict-error (OpenBookingSimpleFlow >> FacilityUseSlot)
...
⚠️ 13 passed with 0 failures, 101 warnings and 12 suggestions 
...
---
Response status code: 200 OK. Responded in 247.997885ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4779"
}
```
...
---
Response status code: 200 OK. Responded in 247.691556ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/757/facility-use-slots/7568"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F478%2Ffacility-use-slots%2F4779?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 355.474708ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4779#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 14.05,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT11H47M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-03T21:59:10+00:00",
    "endDate": "2021-07-04T02:57:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F757%2Ffacility-use-slots%2F7568?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 354.864249ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/757",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/757/facility-use-slots/7568#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0.86,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT16H31M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-02T11:36:10+00:00",
    "endDate": "2021-07-02T12:56:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/52ecddf3-82ca-4faf-99c9-2edfc90c4ea3
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4779#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4779"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/757/facility-use-slots/7568#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/757/facility-use-slots/7568"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 66.597133ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/52ecddf3-82ca-4faf-99c9-2edfc90c4ea3",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/757"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-02T11:36:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/52ecddf3-82ca-4faf-99c9-2edfc90c4ea3
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "369.794.1475",
    "givenName": "Wisozk",
    "familyName": "Isabell",
    "identifier": "1e8f50ee-3d04-4ea0-91db-9747727784b5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 101.041909ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/52ecddf3-82ca-4faf-99c9-2edfc90c4ea3
...
---
Response status code: 409 Conflict. Responded in 148.855556ms.
```json
{
  "@context": "https://openactive.io/",
