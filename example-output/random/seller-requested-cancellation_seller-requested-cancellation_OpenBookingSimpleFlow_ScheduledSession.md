...
---
Response status code: 200 OK. Responded in 533.544911ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/308/events/3077"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F308%2Fevents%2F3077?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 405.539444ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/308/events/3077",
    "startDate": "2021-07-03T20:05:09+00:00",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7d5ed1c8-d497-4d90-acd0-4301cc0ef37a
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/308/events/3077"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 285.415427ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7d5ed1c8-d497-4d90-acd0-4301cc0ef37a",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7d5ed1c8-d497-4d90-acd0-4301cc0ef37a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cora98@yahoo.com",
    "telephone": "(261) 860-2870 x17377",
    "givenName": "Kulas",
    "familyName": "Tressie",
    "identifier": "03a97583-429a-4efa-9c6b-bc035e4d2abc"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 124.759058ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7d5ed1c8-d497-4d90-acd0-4301cc0ef37a
...
---
Response status code: 201 Created. Responded in 219.804791ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/7d5ed1c8-d497-4d90-acd0-4301cc0ef37a",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7d5ed1c8-d497-4d90-acd0-4301cc0ef37a#/orderedItems/665",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/308#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Orders (orders) Feed listen for &#x27;7d5ed1c8-d497-4d90-acd0-4301cc0ef37a&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/7d5ed1c8-d497-4d90-acd0-4301cc0ef37a


---
Response status code: 200 OK. Responded in 621.267049ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607616340208707&afterId=38096117-528a-403d-b311-6e2eed1dcf20",
  "message": "Listening for UUID: '7d5ed1c8-d497-4d90-acd0-4301cc0ef37a' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 49.022059ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation)

### Orders (orders) Feed collect for &#x27;7d5ed1c8-d497-4d90-acd0-4301cc0ef37a&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/7d5ed1c8-d497-4d90-acd0-4301cc0ef37a


---
Response status code: 200 OK. Responded in 3256.566541ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "7d5ed1c8-d497-4d90-acd0-4301cc0ef37a",
  "modified": 637607616454683300,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/7d5ed1c8-d497-4d90-acd0-4301cc0ef37a",
    "identifier": "7d5ed1c8-d497-4d90-acd0-4301cc0ef37a",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/7d5ed1c8-d497-4d90-acd0-4301cc0ef37a#/orderedItems/665",
