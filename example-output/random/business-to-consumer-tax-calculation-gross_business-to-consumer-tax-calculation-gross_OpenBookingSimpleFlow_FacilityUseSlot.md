...
---
Response status code: 200 OK. Responded in 21.730568ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/653/facility-use-slots/6525"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F653%2Ffacility-use-slots%2F6525?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.181025ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/653",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/653/facility-use-slots/6525#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 14.99,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT20H57M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-06T05:26:10+00:00",
    "endDate": "2021-07-06T09:01:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cc7d24f8-a962-4f2a-a7c4-ae0b30631c5f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/653/facility-use-slots/6525#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/653/facility-use-slots/6525"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 431.867001ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cc7d24f8-a962-4f2a-a7c4-ae0b30631c5f",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/653"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-06T05:26:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cc7d24f8-a962-4f2a-a7c4-ae0b30631c5f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Stephon_Hoppe@gmail.com",
    "telephone": "568-425-4616",
    "givenName": "Littel",
    "familyName": "Lelia",
    "identifier": "130142d2-4964-4177-b1a4-8dc390e81767"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 356.446923ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/cc7d24f8-a962-4f2a-a7c4-ae0b30631c5f
...
---
Response status code: 201 Created. Responded in 869.118115ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/cc7d24f8-a962-4f2a-a7c4-ae0b30631c5f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/cc7d24f8-a962-4f2a-a7c4-ae0b30631c5f#/orderedItems/2991",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/653/facility-use-slots/6525#/offers/0",
        "allowCustomerCancellationFullRefund": false,
