...
---
Response status code: 200 OK. Responded in 281.338648ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/525/facility-use-slots/5246"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F525%2Ffacility-use-slots%2F5246?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 266.405829ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/525",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/525/facility-use-slots/5246#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 18.05,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT5H24M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-08T08:11:10+00:00",
    "endDate": "2021-07-08T13:11:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a31d3e92-2992-41bf-b021-b28add2cc682
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/525/facility-use-slots/5246#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/525/facility-use-slots/5246"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 203.211521ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a31d3e92-2992-41bf-b021-b28add2cc682",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/525"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-08T08:11:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a31d3e92-2992-41bf-b021-b28add2cc682
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Golda.Hayes@gmail.com",
    "telephone": "244-560-0555",
    "givenName": "Rolfson",
    "familyName": "Ignacio",
    "identifier": "bfcf1375-8b9e-4ff2-a99f-631b7fcbac5b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 335.739321ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:00+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a31d3e92-2992-41bf-b021-b28add2cc682
...
---
Response status code: 201 Created. Responded in 344.703874ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a31d3e92-2992-41bf-b021-b28add2cc682",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a31d3e92-2992-41bf-b021-b28add2cc682#/orderedItems/1545",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/525/facility-use-slots/5246#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/a31d3e92-2992-41bf-b021-b28add2cc682
...
---
Response status code: 400 Bad Request. Responded in 36.510071ms.
```json
{
  "@context": "https://openactive.io/",
