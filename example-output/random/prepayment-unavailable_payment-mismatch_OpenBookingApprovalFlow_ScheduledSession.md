...
---
Response status code: 200 OK. Responded in 14.851707ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1622/events/16218"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1622%2Fevents%2F16218?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.284438ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1622/events/16218",
    "startDate": "2021-07-08T20:59:09+00:00",
    "endDate": "2021-07-09T00:58:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1622",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1622#/offers/0",
          ...
          "price": 19.86,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT10H14M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3987283b-7014-4647-8f2d-22669b1c1e1d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1622#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1622/events/16218"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1742.731535ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3987283b-7014-4647-8f2d-22669b1c1e1d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:09+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1622"
        },
        "maximumAttendeeCapacity": 8,
        "remainingAttendeeCapacity": 8
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3987283b-7014-4647-8f2d-22669b1c1e1d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Eloise.Emmerich@yahoo.com",
    "telephone": "238.423.1664",
    "givenName": "Adams",
    "familyName": "Mervin",
    "identifier": "81a57044-c422-4a42-8fc5-1a45196d23d5"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 652.62134ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/3987283b-7014-4647-8f2d-22669b1c1e1d
...
---
Response status code: 400 Bad Request. Responded in 86.164843ms.
```json
{
  "@context": "https://openactive.io/",
