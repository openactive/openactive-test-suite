[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:46:41 GMT+0000 (Coordinated Universal Time)

# named-leasing >> lease-response (OpenBookingApprovalFlow >> Multiple)
...
---
Response status code: 200 OK. Responded in 243.576736ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1237/events/12362"
}
```
...
---
Response status code: 200 OK. Responded in 243.320712ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1483/events/14823"
}
```
...
---
Response status code: 200 OK. Responded in 242.289814ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1654/facility-use-slots/16534"
}
```
...
---
Response status code: 200 OK. Responded in 248.711024ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1515/facility-use-slots/15150"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1237%2Fevents%2F12362?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 241.927679ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1237/events/12362",
    "startDate": "2021-07-09T16:18:09+00:00",
    "endDate": "2021-07-09T21:31:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1237",
      "name": "Concrete Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1237#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1483%2Fevents%2F14823?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 241.755963ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1483/events/14823",
    "startDate": "2021-07-07T21:32:09+00:00",
    "endDate": "2021-07-08T02:07:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1483",
      "name": "Soft Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1483#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval",
          ...
          "price": 2.19,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT16H27M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1654%2Ffacility-use-slots%2F16534?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 242.195305ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1654",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1654/facility-use-slots/16534#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT21H41M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-10T17:01:10+00:00",
    "endDate": "2021-07-10T22:29:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1515%2Ffacility-use-slots%2F15150?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 242.590042ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1515",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1515/facility-use-slots/15150#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT21H46M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-06T21:02:10+00:00",
    "endDate": "2021-07-06T23:39:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/980122bf-3557-4ab2-b97c-6b1d05c04f40
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1237#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1237/events/12362"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1483#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1483/events/14823"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1654/facility-use-slots/16534#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1654/facility-use-slots/16534"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1515/facility-use-slots/15150#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1515/facility-use-slots/15150"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1000.319115ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/980122bf-3557-4ab2-b97c-6b1d05c04f40",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:58+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1237"
        },
        "maximumAttendeeCapacity": 25,
        "remainingAttendeeCapacity": 25
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1483"
        },
        "maximumAttendeeCapacity": 23,
        "remainingAttendeeCapacity": 23
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1654"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-10T17:01:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1515"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-06T21:02:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/980122bf-3557-4ab2-b97c-6b1d05c04f40
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Rashad_Mills32@gmail.com",
    "telephone": "502.333.7207 x858",
    "givenName": "Boyle",
    "familyName": "Maxime",
    "identifier": "fd2e3469-2094-4561-af0f-7cf5ad56dc51"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 722.440921ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:52:00+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
