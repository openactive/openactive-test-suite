...
---
Response status code: 200 OK. Responded in 297.492783ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/767/facility-use-slots/7663"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F767%2Ffacility-use-slots%2F7663?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 358.45658ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/767",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/767/facility-use-slots/7663#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 14.52,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT1H43M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-04T10:28:10+00:00",
    "endDate": "2021-07-04T14:59:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c3e1934a-d93c-4eff-8936-e5017cee8118
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/767/facility-use-slots/7663#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/767/facility-use-slots/7663"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 519.795219ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c3e1934a-d93c-4eff-8936-e5017cee8118",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/767"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-04T10:28:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c3e1934a-d93c-4eff-8936-e5017cee8118
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "telephone": "1-958-482-4588 x041",
    "givenName": "Fadel",
    "familyName": "Geo",
    "identifier": "14fd99a9-5b0e-4288-bf8c-f6fec1926dde"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 39.396045ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 136.383666ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/65/facility-use-slots/643"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F65%2Ffacility-use-slots%2F643?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 272.459303ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/65",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/65/facility-use-slots/643#/offers/0",
    ...
    "remainingUses": 6,
    "startDate": "2021-07-10T20:16:09+00:00",
    "endDate": "2021-07-10T22:08:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2ed0724b-fc22-44bd-b131-bc27b505bd84
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/65/facility-use-slots/643#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/65/facility-use-slots/643"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 153.161062ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2ed0724b-fc22-44bd-b131-bc27b505bd84",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2ed0724b-fc22-44bd-b131-bc27b505bd84
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Fanny.Howell32@yahoo.com",
    "telephone": "(345) 415-8643",
    "givenName": "Emard",
    "familyName": "Delilah",
    "identifier": "921ad254-061b-4cc6-97e2-e78d2f1a8017"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 130.63162ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2ed0724b-fc22-44bd-b131-bc27b505bd84
...
---
Response status code: 400 Bad Request. Responded in 60.561258ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteCustomerDetailsError",
