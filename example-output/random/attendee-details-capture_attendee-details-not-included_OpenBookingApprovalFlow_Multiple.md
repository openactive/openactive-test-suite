...
---
Response status code: 200 OK. Responded in 319.547206ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1219/events/12181"
}
```
...
---
Response status code: 200 OK. Responded in 320.825827ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1598/events/15977"
}
```
...
---
Response status code: 200 OK. Responded in 319.458597ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1492/facility-use-slots/14918"
}
```
...
---
Response status code: 200 OK. Responded in 330.194119ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1120/facility-use-slots/11193"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1219%2Fevents%2F12181?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 472.81479ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1219/events/12181",
    "startDate": "2021-07-01T20:48:09+00:00",
    "endDate": "2021-07-02T01:56:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1219",
      "name": "Rubber Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1219#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1598%2Fevents%2F15977?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 473.098316ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1598/events/15977",
    "startDate": "2021-07-09T07:48:09+00:00",
    "endDate": "2021-07-09T10:19:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1492%2Ffacility-use-slots%2F14918?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 473.181025ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1492",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1492/facility-use-slots/14918#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT20H31M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-07T16:59:10+00:00",
    "endDate": "2021-07-07T20:02:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1120%2Ffacility-use-slots%2F11193?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 473.332039ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1120/facility-use-slots/11193#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 2,
    "startDate": "2021-07-04T06:48:10+00:00",
    "endDate": "2021-07-04T09:07:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4e882d9a-2448-4fe5-bdcb-f38694737275
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1219#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1219/events/12181"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1598/events/15977"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1492/facility-use-slots/14918#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1492/facility-use-slots/14918"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1120/facility-use-slots/11193#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1120/facility-use-slots/11193"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 507.029645ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4e882d9a-2448-4fe5-bdcb-f38694737275",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1219"
        },
        "maximumAttendeeCapacity": 24,
        "remainingAttendeeCapacity": 24
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1492"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-07T16:59:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4e882d9a-2448-4fe5-bdcb-f38694737275
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Zola13@yahoo.com",
    "telephone": "1-699-313-4530",
    "givenName": "Abshire",
    "familyName": "Allan",
    "identifier": "5fe67423-f14b-4fcd-b8f5-a4362c410f0e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 396.609138ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:55+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/4e882d9a-2448-4fe5-bdcb-f38694737275
...
---
Response status code: 409 Conflict. Responded in 183.540465ms.
```json
{
  "@context": "https://openactive.io/",
