...
---
Response status code: 200 OK. Responded in 406.436266ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/186/facility-use-slots/1854"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F186%2Ffacility-use-slots%2F1854?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 369.341543ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/186",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/186/facility-use-slots/1854#/offers/0",
    ...
    "remainingUses": 6,
    "startDate": "2021-07-04T03:42:10+00:00",
    "endDate": "2021-07-04T08:53:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7ba5bc30-8b46-4f19-8de0-8ba06d8e74c1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/186/facility-use-slots/1854#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/186/facility-use-slots/1854"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 139.695992ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7ba5bc30-8b46-4f19-8de0-8ba06d8e74c1",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/186"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-04T03:42:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7ba5bc30-8b46-4f19-8de0-8ba06d8e74c1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dennis_Reichel@gmail.com",
    "telephone": "(663) 281-4482 x7440",
    "givenName": "Predovic",
    "familyName": "Marian",
    "identifier": "23117cb3-7dfe-4858-ad14-768d22d65201"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 534.910597ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7ba5bc30-8b46-4f19-8de0-8ba06d8e74c1
...
---
Response status code: 201 Created. Responded in 291.589945ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/7ba5bc30-8b46-4f19-8de0-8ba06d8e74c1",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/7ba5bc30-8b46-4f19-8de0-8ba06d8e74c1#/orderedItems/1498",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/186/facility-use-slots/1854#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/7ba5bc30-8b46-4f19-8de0-8ba06d8e74c1
...
---
Response status code: 400 Bad Request. Responded in 30.838034ms.
```json
{
  "@context": "https://openactive.io/",
