...
# additional-details-capture >> additional-details-required-and-supplied (OpenBookingApprovalFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 59.001345ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1209/facility-use-slots/12082"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1209%2Ffacility-use-slots%2F12082?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.233528ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1209",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1209/facility-use-slots/12082#/offers/0",
    ...
    "remainingUses": 6,
    "startDate": "2021-07-03T15:35:10+00:00",
    "endDate": "2021-07-03T20:00:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6377cb59-e4bd-4fc0-8558-233fda80e3f4
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1209/facility-use-slots/12082#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1209/facility-use-slots/12082"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1683.56857ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6377cb59-e4bd-4fc0-8558-233fda80e3f4",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:18+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1209"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-03T15:35:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6377cb59-e4bd-4fc0-8558-233fda80e3f4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Telly58@hotmail.com",
    "telephone": "447.465.6658 x187",
    "givenName": "Labadie",
    "familyName": "Carolina",
    "identifier": "81fdf911-6b15-42fe-82c2-817cf61c617e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2137.368125ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:21+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/6377cb59-e4bd-4fc0-8558-233fda80e3f4
...
---
Response status code: 201 Created. Responded in 1124.455388ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/6377cb59-e4bd-4fc0-8558-233fda80e3f4",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6377cb59-e4bd-4fc0-8558-233fda80e3f4#/orderedItems/2893",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1209/facility-use-slots/12082#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/6377cb59-e4bd-4fc0-8558-233fda80e3f4/versions/50bba4cb-6026-41de-aff4-c557372cfd15",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;6377cb59-e4bd-4fc0-8558-233fda80e3f4&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/6377cb59-e4bd-4fc0-8558-233fda80e3f4


---
Response status code: 200 OK. Responded in 12.262564ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607623993203979&afterId=a632d955-f0f1-4574-9237-7b0de4d49f0c",
  "message": "Listening for UUID: '6377cb59-e4bd-4fc0-8558-233fda80e3f4' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 2286.444438ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;6377cb59-e4bd-4fc0-8558-233fda80e3f4&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/6377cb59-e4bd-4fc0-8558-233fda80e3f4


---
Response status code: 200 OK. Responded in 184.899243ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "6377cb59-e4bd-4fc0-8558-233fda80e3f4",
  "modified": 637607624032482300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/6377cb59-e4bd-4fc0-8558-233fda80e3f4",
    "identifier": "6377cb59-e4bd-4fc0-8558-233fda80e3f4",
...
---
Response status code: 200 OK. Responded in 15.476169ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607624032482338&afterId=6377cb59-e4bd-4fc0-8558-233fda80e3f4",
  "message": "Listening for UUID: '6377cb59-e4bd-4fc0-8558-233fda80e3f4' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/6377cb59-e4bd-4fc0-8558-233fda80e3f4
...
---
Response status code: 201 Created. Responded in 1307.01821ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6377cb59-e4bd-4fc0-8558-233fda80e3f4",
  "identifier": "6377cb59-e4bd-4fc0-8558-233fda80e3f4",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 31.685026ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "6377cb59-e4bd-4fc0-8558-233fda80e3f4",
  "modified": 637607624059434200
}
```
### Specs
* ✅ should return 200 on success
