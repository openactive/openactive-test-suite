...
# common-error-conditions >> opportunity-in-past (OpenBookingSimpleFlow >> FacilityUseSlot)
...
⚠️ 9 passed with 0 failures, 55 warnings and 6 suggestions 
...
---
Response status code: 200 OK. Responded in 503.188557ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/673/facility-use-slots/6727"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F673%2Ffacility-use-slots%2F6727?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 356.733627ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/673",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/673/facility-use-slots/6727#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT13H13M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-06-30T06:40:10+00:00",
    "endDate": "2021-06-30T09:32:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7a599bed-0fcd-471f-8d2b-b994e362136f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/673/facility-use-slots/6727#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/673/facility-use-slots/6727"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 76.043333ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7a599bed-0fcd-471f-8d2b-b994e362136f",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/673"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-06-30T06:40:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7a599bed-0fcd-471f-8d2b-b994e362136f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bernadine_Dicki@hotmail.com",
    "telephone": "392.723.2377",
    "givenName": "Pacocha",
    "familyName": "Marquis",
    "identifier": "cf2d48aa-507b-40fb-a033-2d950ceb7780"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 101.239329ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7a599bed-0fcd-471f-8d2b-b994e362136f
...
---
Response status code: 409 Conflict. Responded in 73.614502ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 409,
  "description": "The 'orderedItem' and 'acceptedOffer' combination specified are not \"bookable\", as defined in the Open Booking API specification.: Opportunities in the past are not bookable"
}
```
### Specs
