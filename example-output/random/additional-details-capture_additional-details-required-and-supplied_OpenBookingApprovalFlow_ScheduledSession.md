...
# additional-details-capture >> additional-details-required-and-supplied (OpenBookingApprovalFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 36.068847ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/999/events/9983"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F999%2Fevents%2F9983?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 24.242317ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/999/events/9983",
    "startDate": "2021-07-09T02:28:09+00:00",
    "endDate": "2021-07-09T04:45:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/999",
      "name": "Wooden Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/999#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b15f8f0f-79ee-4d7f-98b1-559c466fa4d8
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/999#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/999/events/9983"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 597.867242ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b15f8f0f-79ee-4d7f-98b1-559c466fa4d8",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/999"
        },
        "maximumAttendeeCapacity": 49,
        "remainingAttendeeCapacity": 49
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b15f8f0f-79ee-4d7f-98b1-559c466fa4d8
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ottilie_Ward@yahoo.com",
    "telephone": "(310) 672-7677 x96124",
    "givenName": "Schmitt",
    "familyName": "Emory",
    "identifier": "2405d2b1-2e72-4be6-9874-e76bdf130691"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 5472.52041ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:06+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b15f8f0f-79ee-4d7f-98b1-559c466fa4d8
...
---
Response status code: 201 Created. Responded in 2186.35527ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/b15f8f0f-79ee-4d7f-98b1-559c466fa4d8",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b15f8f0f-79ee-4d7f-98b1-559c466fa4d8#/orderedItems/2866",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/999#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/b15f8f0f-79ee-4d7f-98b1-559c466fa4d8/versions/7cf89815-e685-4fea-a49f-d3f6033b9cdc",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;b15f8f0f-79ee-4d7f-98b1-559c466fa4d8&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/b15f8f0f-79ee-4d7f-98b1-559c466fa4d8


---
Response status code: 200 OK. Responded in 19.964192ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607623872515138&afterId=783b740d-561e-4f40-a51a-e1746a44351e",
  "message": "Listening for UUID: 'b15f8f0f-79ee-4d7f-98b1-559c466fa4d8' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 434.506672ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;b15f8f0f-79ee-4d7f-98b1-559c466fa4d8&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/b15f8f0f-79ee-4d7f-98b1-559c466fa4d8


---
Response status code: 200 OK. Responded in 1798.362885ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b15f8f0f-79ee-4d7f-98b1-559c466fa4d8",
  "modified": 637607623901349900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/b15f8f0f-79ee-4d7f-98b1-559c466fa4d8",
    "identifier": "b15f8f0f-79ee-4d7f-98b1-559c466fa4d8",
...
---
Response status code: 200 OK. Responded in 27.774458ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607623901349870&afterId=b15f8f0f-79ee-4d7f-98b1-559c466fa4d8",
  "message": "Listening for UUID: 'b15f8f0f-79ee-4d7f-98b1-559c466fa4d8' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/b15f8f0f-79ee-4d7f-98b1-559c466fa4d8
...
---
Response status code: 201 Created. Responded in 2817.016309ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b15f8f0f-79ee-4d7f-98b1-559c466fa4d8",
  "identifier": "b15f8f0f-79ee-4d7f-98b1-559c466fa4d8",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1131.136418ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "b15f8f0f-79ee-4d7f-98b1-559c466fa4d8",
  "modified": 637607623948764800
}
```
### Specs
* ✅ should return 200 on success
