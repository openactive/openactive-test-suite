...
# customer-details-capture-identifier >> customer-identifier-capture (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 17 passed with 0 failures, 376 warnings and 102 suggestions 
...
---
Response status code: 200 OK. Responded in 220.849536ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/239/events/2388"
}
```
...
---
Response status code: 200 OK. Responded in 221.172067ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/484/events/4836"
}
```
...
---
Response status code: 200 OK. Responded in 221.465895ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5506"
}
```
...
---
Response status code: 200 OK. Responded in 218.321797ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/106/facility-use-slots/1053"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F239%2Fevents%2F2388?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 136.237815ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/239/events/2388",
    "startDate": "2021-07-04T22:35:09+00:00",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F484%2Fevents%2F4836?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 136.632052ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/484/events/4836",
    "startDate": "2021-07-04T19:49:09+00:00",
    "endDate": "2021-07-04T20:59:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/484",
      "name": "Cotton Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/484#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingPrepayment": "https://openactive.io/Required",
          "price": 16.11,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT3H41M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F551%2Ffacility-use-slots%2F5506?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 136.81227ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/551",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5506#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT22H46M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-05T23:17:10+00:00",
    "endDate": "2021-07-06T00:43:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F106%2Ffacility-use-slots%2F1053?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 137.044292ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/106/facility-use-slots/1053#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "endDate": "2021-07-03T08:35:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e7eee088-f54d-44b2-9a86-d2b1edb2af53
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/239/events/2388"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/484#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/484/events/4836"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5506#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5506"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/106/facility-use-slots/1053#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/106/facility-use-slots/1053"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 700.839641ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e7eee088-f54d-44b2-9a86-d2b1edb2af53",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:03+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/484"
        },
        "maximumAttendeeCapacity": 43,
        "remainingAttendeeCapacity": 43
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/551"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-05T23:17:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e7eee088-f54d-44b2-9a86-d2b1edb2af53
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Anthony_Stamm41@gmail.com",
    "telephone": "(337) 629-3850 x148",
    "givenName": "Rohan",
    "familyName": "Steve",
    "identifier": "6201b2d5-9be9-45cd-94b1-03da6aa645f3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 621.779245ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/e7eee088-f54d-44b2-9a86-d2b1edb2af53
...
---
Response status code: 201 Created. Responded in 770.167413ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/e7eee088-f54d-44b2-9a86-d2b1edb2af53",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7eee088-f54d-44b2-9a86-d2b1edb2af53#/orderedItems/1774",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/239#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7eee088-f54d-44b2-9a86-d2b1edb2af53#/orderedItems/1775",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/239#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7eee088-f54d-44b2-9a86-d2b1edb2af53#/orderedItems/1776",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/484#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7eee088-f54d-44b2-9a86-d2b1edb2af53#/orderedItems/1777",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5506#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7eee088-f54d-44b2-9a86-d2b1edb2af53#/orderedItems/1778",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/551/facility-use-slots/5506#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/e7eee088-f54d-44b2-9a86-d2b1edb2af53#/orderedItems/1779",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/106/facility-use-slots/1053#/offers/0",
        "allowCustomerCancellationFullRefund": true,
