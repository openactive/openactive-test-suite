[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:51:18 GMT+0000 (Coordinated Universal Time)

# prepayment-required >> opportunity-paid-no-payment-error (OpenBookingApprovalFlow >> Multiple)
...
**Test:**  Unsuccessful booking without payment property
...
```bash
npm start -- --runInBand test/features/payment/prepayment-required/implemented/opportunity-paid-no-payment-error-test.js
```
...
## Missing payment property at B >> Fetch Opportunities
...
---
Response status code: 200 OK. Responded in 159.920067ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1071/events/10701"
}
```
...
---
Response status code: 200 OK. Responded in 148.43237ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1473/facility-use-slots/14729"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1071%2Fevents%2F10701?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 178.881676ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1071/events/10701",
    "startDate": "2021-07-09T16:52:09+00:00",
    "endDate": "2021-07-09T17:28:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1473%2Ffacility-use-slots%2F14729?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 178.656155ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1473",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1473/facility-use-slots/14729#/offers/0",
        ...
        "price": 14.03,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT11H43M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-09T01:22:10+00:00",
    "endDate": "2021-07-09T03:25:10+00:00"
  }
}
```
### Specs
...
## Missing payment property at B >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 0
### Specs
...
## Missing payment property at B >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookableNonFreePrepaymentRequired' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5c72c348-ed1a-4c2c-a5a9-67eaf93d91b1
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1071#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1071/events/10701"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1473/facility-use-slots/14729#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1473/facility-use-slots/14729"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 941.959021ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5c72c348-ed1a-4c2c-a5a9-67eaf93d91b1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:56:39+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5c72c348-ed1a-4c2c-a5a9-67eaf93d91b1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Percival1@yahoo.com",
    "telephone": "651-585-1043",
    "givenName": "Ferry",
    "familyName": "Kenna",
    "identifier": "c2bbead7-57f3-404a-bf3e-7c82dd05ef9e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 810.220645ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
## Missing payment property at B >> P

### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/5c72c348-ed1a-4c2c-a5a9-67eaf93d91b1
...
---
Response status code: 400 Bad Request. Responded in 371.797392ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 400,
  "description": "Orders with prepayment must have nonzero price."
}
```
### Specs
* ✅ should return a response containing `"@type": "MissingPaymentDetailsError"` with status code `400`

## Missing payment property at B >> P >> validation of P
### Specs
* ✅ passes validation checks
