...
⚠️ 42 passed with 0 failures, 623 warnings and 168 suggestions 
...
---
Response status code: 200 OK. Responded in 357.010355ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/170/events/1697"
}
```
...
---
Response status code: 200 OK. Responded in 360.663202ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/769/events/7682"
}
```
...
---
Response status code: 200 OK. Responded in 361.108944ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/371/facility-use-slots/3709"
}
```
...
---
Response status code: 200 OK. Responded in 353.551626ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/185/facility-use-slots/1850"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F170%2Fevents%2F1697?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 279.519585ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/170/events/1697",
    "startDate": "2021-07-06T03:14:09+00:00",
    "endDate": "2021-07-06T05:26:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/170",
      "name": "Metal Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/170#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F769%2Fevents%2F7682?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 280.133643ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/769/events/7682",
    "startDate": "2021-07-02T06:44:09+00:00",
    "endDate": "2021-07-02T08:05:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F371%2Ffacility-use-slots%2F3709?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 280.622589ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/371",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/371/facility-use-slots/3709#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 5.34,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT19H12M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-05T09:03:10+00:00",
    "endDate": "2021-07-05T10:44:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F185%2Ffacility-use-slots%2F1850?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 281.216446ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/185/facility-use-slots/1850#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 6,
    "startDate": "2021-07-07T09:06:10+00:00",
    "endDate": "2021-07-07T13:11:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6f2b1b12-2746-4c02-a874-b4a7e1f5b033
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/170#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/170/events/1697"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/769/events/7682"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/371/facility-use-slots/3709#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/371/facility-use-slots/3709"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/185/facility-use-slots/1850#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/185/facility-use-slots/1850"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 400 Bad Request. Responded in 69.570912ms.
```json
{
  "@context": "https://openactive.io/",
...
---
Response status code: 200 OK. Responded in 483.055112ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/379/events/3782"
}
```
...
---
Response status code: 200 OK. Responded in 483.860989ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/556/events/5552"
}
```
...
---
Response status code: 200 OK. Responded in 482.030215ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/152/facility-use-slots/1512"
}
```
...
---
Response status code: 200 OK. Responded in 483.947197ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/550/facility-use-slots/5500"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F379%2Fevents%2F3782?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 308.500422ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/379/events/3782",
    "startDate": "2021-07-11T01:24:09+00:00",
    "endDate": "2021-07-11T02:25:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F556%2Fevents%2F5552?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 309.293097ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/556/events/5552",
    "startDate": "2021-07-03T20:32:09+00:00",
    "endDate": "2021-07-04T00:14:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F152%2Ffacility-use-slots%2F1512?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 314.515293ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/152",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/152/facility-use-slots/1512#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 3,
    "startDate": "2021-07-03T00:28:10+00:00",
    "endDate": "2021-07-03T05:02:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F550%2Ffacility-use-slots%2F5500?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 315.156054ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/550/facility-use-slots/5500#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT22H21M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-02T21:59:10+00:00",
    "endDate": "2021-07-03T02:47:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1568cace-ebdb-4ded-9e1a-4dd6f2e462d1
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/379/events/3782"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/556/events/5552"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/152/facility-use-slots/1512#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/152/facility-use-slots/1512"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/550/facility-use-slots/5500#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/550/facility-use-slots/5500"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 808.534048ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1568cace-ebdb-4ded-9e1a-4dd6f2e462d1",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:02+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/152"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-03T00:28:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1568cace-ebdb-4ded-9e1a-4dd6f2e462d1
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lucio_Steuber44@hotmail.com",
    "telephone": "(334) 708-1176 x2723",
    "givenName": "Champlin",
    "familyName": "Joaquin",
    "identifier": "294a6146-dd84-4bbc-9f8b-ffd7628a094c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 400 Bad Request. Responded in 32.845721ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
...
---
Response status code: 200 OK. Responded in 354.385783ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/352/events/3516"
}
```
...
---
Response status code: 200 OK. Responded in 356.193354ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/437/events/4368"
}
```
...
---
Response status code: 200 OK. Responded in 337.014732ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/457/facility-use-slots/4569"
}
```
...
---
Response status code: 200 OK. Responded in 337.952121ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/334/facility-use-slots/3336"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F352%2Fevents%2F3516?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 269.639628ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/352/events/3516",
    "startDate": "2021-07-07T11:04:09+00:00",
    "endDate": "2021-07-07T15:27:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/352",
      "name": "Soft Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/352#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 8.72,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT1H41M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F437%2Fevents%2F4368?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 270.259887ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/437/events/4368",
    "startDate": "2021-07-05T11:04:09+00:00",
    "endDate": "2021-07-05T13:24:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F457%2Ffacility-use-slots%2F4569?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 276.131045ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/457",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/457/facility-use-slots/4569#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 19.88,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT7H34M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-06T21:13:10+00:00",
    "endDate": "2021-07-07T02:04:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F334%2Ffacility-use-slots%2F3336?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 283.466642ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/334",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/334/facility-use-slots/3336#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 10.69,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT13H55M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-02T02:20:10+00:00",
    "endDate": "2021-07-02T07:09:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b2976937-f03b-4027-9caf-5266876ac11c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/352#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/352/events/3516"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/437/events/4368"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/457/facility-use-slots/4569#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/457/facility-use-slots/4569"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/334/facility-use-slots/3336#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/334/facility-use-slots/3336"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 721.058934ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b2976937-f03b-4027-9caf-5266876ac11c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:06+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/352"
        },
        "maximumAttendeeCapacity": 24,
        "remainingAttendeeCapacity": 24
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b2976937-f03b-4027-9caf-5266876ac11c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Hardy98@yahoo.com",
    "telephone": "(263) 729-0501",
    "givenName": "Rempel",
    "familyName": "Lorenz",
    "identifier": "eddccbfc-99a5-47a3-b5b4-c654244b9dd3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 449.917671ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:07+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b2976937-f03b-4027-9caf-5266876ac11c
...
---
Response status code: 400 Bad Request. Responded in 26.587528ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "IncompleteBrokerDetailsError",
