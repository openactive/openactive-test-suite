[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:40:57 GMT+0000 (Coordinated Universal Time)
...
⚠️ 21 passed with 0 failures, 493 warnings and 132 suggestions 
...
---
Response status code: 200 OK. Responded in 326.962081ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1584/events/15836"
}
```
...
---
Response status code: 200 OK. Responded in 327.468429ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1433/events/14321"
}
```
...
---
Response status code: 200 OK. Responded in 320.125631ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1144/facility-use-slots/11432"
}
```
...
---
Response status code: 200 OK. Responded in 325.189912ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1575/facility-use-slots/15745"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1584%2Fevents%2F15836?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 297.847814ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1584/events/15836",
    "startDate": "2021-07-08T05:57:09+00:00",
    "endDate": "2021-07-08T07:58:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1584",
      "name": "Steel Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1584#/offers/0",
          ...
          "price": 3.78,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT2H5M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1433%2Fevents%2F14321?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 298.766201ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1433/events/14321",
    "startDate": "2021-07-06T11:28:09+00:00",
    "endDate": "2021-07-06T14:05:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1433",
      "name": "Steel Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1433#/offers/0",
          ...
          "price": 10.5,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT5H31M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1144%2Ffacility-use-slots%2F11432?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 299.484468ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1144",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1144/facility-use-slots/11432#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 4,
    "startDate": "2021-07-06T12:26:10+00:00",
    "endDate": "2021-07-06T16:16:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1575%2Ffacility-use-slots%2F15745?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 300.412157ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1575",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1575/facility-use-slots/15745#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ...
        "price": 11.47,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT11H"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-02T03:37:10+00:00",
    "endDate": "2021-07-02T05:39:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5397fac5-0041-4398-ade7-c3d0a9b9ca65
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1584#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1584/events/15836"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1433#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1433/events/14321"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1144/facility-use-slots/11432#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1144/facility-use-slots/11432"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1575/facility-use-slots/15745#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1575/facility-use-slots/15745"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 413.655322ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5397fac5-0041-4398-ade7-c3d0a9b9ca65",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:34+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1584"
        },
        "maximumAttendeeCapacity": 40,
        "remainingAttendeeCapacity": 40
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1433"
        },
        "maximumAttendeeCapacity": 29,
        "remainingAttendeeCapacity": 29
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1144"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-06T12:26:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1575"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-02T03:37:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5397fac5-0041-4398-ade7-c3d0a9b9ca65
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Romaine.Harber@hotmail.com",
    "telephone": "746.795.3928",
    "givenName": "Towne",
    "familyName": "Sallie",
    "identifier": "343f94df-7dff-4607-9c97-cc87dcd2245a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 250.607023ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:35+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### Specs
* ✅ should return 200 on success
* ✅ should include expected customer details
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/5397fac5-0041-4398-ade7-c3d0a9b9ca65
...
---
Response status code: 201 Created. Responded in 389.807954ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/5397fac5-0041-4398-ade7-c3d0a9b9ca65",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5397fac5-0041-4398-ade7-c3d0a9b9ca65#/orderedItems/846",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1584#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5397fac5-0041-4398-ade7-c3d0a9b9ca65#/orderedItems/847",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1584#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5397fac5-0041-4398-ade7-c3d0a9b9ca65#/orderedItems/848",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1433#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5397fac5-0041-4398-ade7-c3d0a9b9ca65#/orderedItems/849",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1144/facility-use-slots/11432#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5397fac5-0041-4398-ade7-c3d0a9b9ca65#/orderedItems/850",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1144/facility-use-slots/11432#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5397fac5-0041-4398-ade7-c3d0a9b9ca65#/orderedItems/851",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1575/facility-use-slots/15745#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/5397fac5-0041-4398-ade7-c3d0a9b9ca65/versions/e0d55f65-82d1-48cf-82f1-31ae1319fe13",
  "payment": {
    "@type": "Payment",
    "identifier": "M7PHvDyD-",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;5397fac5-0041-4398-ade7-c3d0a9b9ca65&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/5397fac5-0041-4398-ade7-c3d0a9b9ca65


---
Response status code: 200 OK. Responded in 241.613868ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607616917617956&afterId=e2f57c8d-9725-4462-85bf-fac87a63a5ef",
  "message": "Listening for UUID: '5397fac5-0041-4398-ade7-c3d0a9b9ca65' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 20.998096ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;5397fac5-0041-4398-ade7-c3d0a9b9ca65&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/5397fac5-0041-4398-ade7-c3d0a9b9ca65


---
Response status code: 200 OK. Responded in 2326.88649ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "5397fac5-0041-4398-ade7-c3d0a9b9ca65",
  "modified": 637607616972811500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/5397fac5-0041-4398-ade7-c3d0a9b9ca65",
    "identifier": "5397fac5-0041-4398-ade7-c3d0a9b9ca65",
...
---
Response status code: 200 OK. Responded in 352.94395ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607616947271957&afterId=e2f57c8d-9725-4462-85bf-fac87a63a5ef",
  "message": "Listening for UUID: '5397fac5-0041-4398-ade7-c3d0a9b9ca65' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/5397fac5-0041-4398-ade7-c3d0a9b9ca65
...
---
Response status code: 201 Created. Responded in 283.696067ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5397fac5-0041-4398-ade7-c3d0a9b9ca65",
  "identifier": "5397fac5-0041-4398-ade7-c3d0a9b9ca65",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 267.09617ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "5397fac5-0041-4398-ade7-c3d0a9b9ca65",
  "modified": 637607617001248300
}
```
### Specs
* ✅ should return 200 on success
