...
---
Response status code: 200 OK. Responded in 372.163299ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1118/events/11179"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1118%2Fevents%2F11179?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 310.122697ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1118/events/11179",
    "startDate": "2021-07-10T06:09:09+00:00",
    "endDate": "2021-07-10T09:48:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1118",
      "name": "Frozen Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1118#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/948cf9ba-8791-4731-91c1-c37647e9b22c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1118#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1118/events/11179"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 277.121059ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/948cf9ba-8791-4731-91c1-c37647e9b22c",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1118"
        },
        "maximumAttendeeCapacity": 14,
        "remainingAttendeeCapacity": 14
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/948cf9ba-8791-4731-91c1-c37647e9b22c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shawna92@yahoo.com",
    "telephone": "(430) 737-5639 x4684",
    "givenName": "Moore",
    "familyName": "Flavio",
    "identifier": "1ab8b779-707e-49b2-85da-0c15828c5abf"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 86.890665ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/948cf9ba-8791-4731-91c1-c37647e9b22c
...
---
Response status code: 409 Conflict. Responded in 112.126465ms.
```json
{
  "@context": "https://openactive.io/",
