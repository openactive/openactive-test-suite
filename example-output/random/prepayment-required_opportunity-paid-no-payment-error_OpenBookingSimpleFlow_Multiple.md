...
---
Response status code: 200 OK. Responded in 110.77834ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/330/events/3296"
}
```
...
---
Response status code: 200 OK. Responded in 110.343298ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/387/facility-use-slots/3866"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F330%2Fevents%2F3296?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 128.95727ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/330/events/3296",
    "startDate": "2021-07-04T12:55:09+00:00",
    "endDate": "2021-07-04T17:28:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F387%2Ffacility-use-slots%2F3866?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 130.298797ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/387",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/387/facility-use-slots/3866#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 12.29,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT2H43M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-10T15:22:10+00:00",
    "endDate": "2021-07-10T19:10:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cba381dd-e39d-450d-875d-fd040eb9e95d
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/330/events/3296"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/387/facility-use-slots/3866#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/387/facility-use-slots/3866"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1398.415554ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cba381dd-e39d-450d-875d-fd040eb9e95d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:56:26+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cba381dd-e39d-450d-875d-fd040eb9e95d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Dorian7@gmail.com",
    "telephone": "326-872-6255 x004",
    "givenName": "Glover",
    "familyName": "Kirstin",
    "identifier": "13a26704-7b66-4097-b944-3f0e7add65d0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 4051.818662ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/cba381dd-e39d-450d-875d-fd040eb9e95d
...
---
Response status code: 400 Bad Request. Responded in 86.340342ms.
```json
{
  "@context": "https://openactive.io/",
