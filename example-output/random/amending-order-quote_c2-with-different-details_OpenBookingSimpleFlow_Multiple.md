...
# amending-order-quote >> c2-with-different-details (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 41 passed with 0 failures, 499 warnings and 136 suggestions 
...
---
Response status code: 200 OK. Responded in 446.791411ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/12/events/117"
}
```
...
---
Response status code: 200 OK. Responded in 447.387368ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/335/events/3350"
}
```
...
---
Response status code: 200 OK. Responded in 447.987825ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/506/facility-use-slots/5060"
}
```
...
---
Response status code: 200 OK. Responded in 448.537977ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/600/facility-use-slots/5993"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F12%2Fevents%2F117?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 360.924541ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/12/events/117",
    "startDate": "2021-07-08T04:42:09+00:00",
    "endDate": "2021-07-08T09:03:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F335%2Fevents%2F3350?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 361.273774ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/335/events/3350",
    "startDate": "2021-07-10T09:35:09+00:00",
    "endDate": "2021-07-10T12:14:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/335",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/335#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F506%2Ffacility-use-slots%2F5060?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 362.055349ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/506/facility-use-slots/5060#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 4.96,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT32M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-04T00:00:10+00:00",
    "endDate": "2021-07-04T01:54:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F600%2Ffacility-use-slots%2F5993?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 362.49359ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/600",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/600/facility-use-slots/5993#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT5H17M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-03T17:50:10+00:00",
    "endDate": "2021-07-03T21:10:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a382e12f-62bd-4060-8123-ff7d6d2b892f
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/12/events/117"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/335#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/335/events/3350"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/506/facility-use-slots/5060#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/506/facility-use-slots/5060"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/600/facility-use-slots/5993#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/600/facility-use-slots/5993"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 194.688424ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a382e12f-62bd-4060-8123-ff7d6d2b892f",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:19+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/335"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/600"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-03T17:50:10+00:00",
...
---
Response status code: 200 OK. Responded in 390.360942ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/797/events/7965"
}
```
...
---
Response status code: 200 OK. Responded in 389.415152ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/521/events/5207"
}
```
...
---
Response status code: 200 OK. Responded in 376.686741ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/80/facility-use-slots/793"
}
```
...
---
Response status code: 200 OK. Responded in 376.47092ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5755"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F797%2Fevents%2F7965?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 405.318965ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/797/events/7965",
    "startDate": "2021-07-02T01:46:09+00:00",
    "endDate": "2021-07-02T04:06:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F521%2Fevents%2F5207?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 410.923999ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/521/events/5207",
    "startDate": "2021-07-04T01:46:09+00:00",
    "endDate": "2021-07-04T06:31:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/521",
      "name": "Cotton Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/521#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT5H16M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F80%2Ffacility-use-slots%2F793?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 413.021498ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/80",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/80/facility-use-slots/793#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 14.3,
        "priceCurrency": "GBP"
      }
    ...
    "endDate": "2021-07-10T07:31:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F576%2Ffacility-use-slots%2F5755?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 413.501444ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5755#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT7H21M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-08T05:44:10+00:00",
    "endDate": "2021-07-08T07:26:10+00:00"
  }
}
```
### Specs
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a382e12f-62bd-4060-8123-ff7d6d2b892f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Aubrey14@yahoo.com",
    "telephone": "493.434.8976 x0074",
    "givenName": "Mann",
    "familyName": "Hailee",
    "identifier": "32c1cb6f-54e1-47e7-8312-e09a26b8a1ba"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/797/events/7965"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/521#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/521/events/5207"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/80/facility-use-slots/793#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/80/facility-use-slots/793"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5755#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5755"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 305.742308ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:23+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/521"
        },
        "maximumAttendeeCapacity": 46,
        "remainingAttendeeCapacity": 46
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/80"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-10T01:54:09+00:00",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a382e12f-62bd-4060-8123-ff7d6d2b892f
...
---
Response status code: 201 Created. Responded in 333.098003ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a382e12f-62bd-4060-8123-ff7d6d2b892f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a382e12f-62bd-4060-8123-ff7d6d2b892f#/orderedItems/250",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/797#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a382e12f-62bd-4060-8123-ff7d6d2b892f#/orderedItems/251",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/797#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a382e12f-62bd-4060-8123-ff7d6d2b892f#/orderedItems/252",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/521#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a382e12f-62bd-4060-8123-ff7d6d2b892f#/orderedItems/253",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/80/facility-use-slots/793#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a382e12f-62bd-4060-8123-ff7d6d2b892f#/orderedItems/254",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/80/facility-use-slots/793#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a382e12f-62bd-4060-8123-ff7d6d2b892f#/orderedItems/255",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/576/facility-use-slots/5755#/offers/0",
        "allowCustomerCancellationFullRefund": false,
