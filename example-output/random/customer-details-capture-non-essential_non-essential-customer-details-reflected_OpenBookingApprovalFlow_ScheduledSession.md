...
⚠️ 11 passed with 0 failures, 99 warnings and 34 suggestions 
...
---
Response status code: 200 OK. Responded in 496.713441ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1307/events/13062"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1307%2Fevents%2F13062?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 438.504005ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1307/events/13062",
    "startDate": "2021-07-10T01:59:09+00:00",
    "endDate": "2021-07-10T03:46:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c606e19e-48e7-4e4b-abb0-6ac2b90b68ba
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1307/events/13062"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 95.859517ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c606e19e-48e7-4e4b-abb0-6ac2b90b68ba",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:16+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c606e19e-48e7-4e4b-abb0-6ac2b90b68ba
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Toby.Sauer@hotmail.com",
    "telephone": "(823) 894-3208 x31591",
    "givenName": "O'Keefe",
    "familyName": "Golden",
    "identifier": "aa4cab66-f40b-4e82-81c1-9d60989384c3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 141.045714ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/c606e19e-48e7-4e4b-abb0-6ac2b90b68ba
...
---
Response status code: 201 Created. Responded in 133.146163ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/c606e19e-48e7-4e4b-abb0-6ac2b90b68ba",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c606e19e-48e7-4e4b-abb0-6ac2b90b68ba#/orderedItems/800",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1307#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/c606e19e-48e7-4e4b-abb0-6ac2b90b68ba/versions/a19d10c5-e473-4efb-9a97-af941df5b26d",
  "payment": {
    "@type": "Payment",
    "identifier": "Y8dwaV27h",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;c606e19e-48e7-4e4b-abb0-6ac2b90b68ba&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/c606e19e-48e7-4e4b-abb0-6ac2b90b68ba


---
Response status code: 200 OK. Responded in 232.815743ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: 'c606e19e-48e7-4e4b-abb0-6ac2b90b68ba' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 17.341849ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;c606e19e-48e7-4e4b-abb0-6ac2b90b68ba&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/c606e19e-48e7-4e4b-abb0-6ac2b90b68ba


---
Response status code: 200 OK. Responded in 2852.704513ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c606e19e-48e7-4e4b-abb0-6ac2b90b68ba",
  "modified": 637607616777120600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/c606e19e-48e7-4e4b-abb0-6ac2b90b68ba",
    "identifier": "c606e19e-48e7-4e4b-abb0-6ac2b90b68ba",
...
---
Response status code: 200 OK. Responded in 350.451509ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607616768022233&afterId=5d423ffb-81ab-4d52-9999-3c42747b0a6c",
  "message": "Listening for UUID: 'c606e19e-48e7-4e4b-abb0-6ac2b90b68ba' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/c606e19e-48e7-4e4b-abb0-6ac2b90b68ba
...
---
Response status code: 201 Created. Responded in 167.620431ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c606e19e-48e7-4e4b-abb0-6ac2b90b68ba",
  "identifier": "c606e19e-48e7-4e4b-abb0-6ac2b90b68ba",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1508.063033ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "c606e19e-48e7-4e4b-abb0-6ac2b90b68ba",
  "modified": 637607616810307200
}
```
### Specs
* ✅ should return 200 on success
