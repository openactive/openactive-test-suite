...
---
Response status code: 200 OK. Responded in 381.271334ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1598/facility-use-slots/15979"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1598%2Ffacility-use-slots%2F15979?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 298.929909ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1598",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1598/facility-use-slots/15979#/offers/0",
        ...
        "price": 11.76,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT10H2M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-03T22:17:10+00:00",
    "endDate": "2021-07-04T02:49:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5bff3939-b882-42fc-b5eb-1e67bf8a233d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1598/facility-use-slots/15979#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1598/facility-use-slots/15979"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 384.386162ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5bff3939-b882-42fc-b5eb-1e67bf8a233d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:51+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5bff3939-b882-42fc-b5eb-1e67bf8a233d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Shakira.Johnson@gmail.com",
    "telephone": "671.749.9749 x968",
    "givenName": "Grady",
    "familyName": "Tyson",
    "identifier": "b9fe2b4e-fc08-41aa-a4a8-658ec10f6123"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 74.30527ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/5bff3939-b882-42fc-b5eb-1e67bf8a233d
...
---
Response status code: 409 Conflict. Responded in 84.618951ms.
```json
{
  "@context": "https://openactive.io/",
