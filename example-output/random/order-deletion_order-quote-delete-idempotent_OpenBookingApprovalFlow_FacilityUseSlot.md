...
---
Response status code: 200 OK. Responded in 283.856189ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1145/facility-use-slots/11441"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1145%2Ffacility-use-slots%2F11441?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 360.215549ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1145",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1145/facility-use-slots/11441#/offers/0",
    ...
    "remainingUses": 6,
    "startDate": "2021-07-11T05:57:10+00:00",
    "endDate": "2021-07-11T10:00:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/361396a2-dd5f-4d29-aa0f-a4587837c727
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1145/facility-use-slots/11441#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1145/facility-use-slots/11441"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 190.637225ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/361396a2-dd5f-4d29-aa0f-a4587837c727",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1145"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-11T05:57:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/361396a2-dd5f-4d29-aa0f-a4587837c727
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cynthia78@gmail.com",
    "telephone": "580-995-1410 x72593",
    "givenName": "Hayes",
    "familyName": "Brooklyn",
    "identifier": "a3cd8258-714d-4a12-acfa-fbb0c9f5ca36"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 136.777305ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
DELETE https://localhost:5001/api/openbooking/order-quotes/361396a2-dd5f-4d29-aa0f-a4587837c727
...
---
Response status code: 204 No Content. Responded in 115.203253ms.
...
---
Response status code: 204 No Content. Responded in 15.837706ms.
### Specs
