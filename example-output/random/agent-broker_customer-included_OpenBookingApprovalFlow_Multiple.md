...
⚠️ 19 passed with 0 failures, 492 warnings and 130 suggestions 
...
---
Response status code: 200 OK. Responded in 135.702654ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1562/events/15611"
}
```
...
---
Response status code: 200 OK. Responded in 142.350489ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1528/events/15272"
}
```
...
---
Response status code: 200 OK. Responded in 145.205262ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1010/facility-use-slots/10091"
}
```
...
---
Response status code: 200 OK. Responded in 144.400885ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1035/facility-use-slots/10345"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1562%2Fevents%2F15611?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 124.060443ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1562/events/15611",
    "startDate": "2021-07-08T08:31:09+00:00",
    "endDate": "2021-07-08T09:18:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1528%2Fevents%2F15272?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 123.527292ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1528/events/15272",
    "startDate": "2021-07-07T06:45:09+00:00",
    "endDate": "2021-07-07T09:09:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1528",
      "name": "Frozen Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1528#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          ...
          "price": 0.83,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT14H24M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1010%2Ffacility-use-slots%2F10091?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 123.223863ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1010/facility-use-slots/10091#/offers/0",
    ...
    "remainingUses": 5,
    "startDate": "2021-07-08T08:03:10+00:00",
    "endDate": "2021-07-08T09:36:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1035%2Ffacility-use-slots%2F10345?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 122.88283ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1035",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1035/facility-use-slots/10345#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 8,
    "startDate": "2021-07-05T12:26:10+00:00",
    "endDate": "2021-07-05T15:07:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1562/events/15611"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1528#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1528/events/15272"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1010/facility-use-slots/10091#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1010/facility-use-slots/10091"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1035/facility-use-slots/10345#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1035/facility-use-slots/10345"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2075.001861ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1528"
        },
        "maximumAttendeeCapacity": 7,
        "remainingAttendeeCapacity": 7
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1010"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-08T08:03:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1035"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-05T12:26:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Meta_Stehr@yahoo.com",
    "telephone": "(728) 222-2782 x97096",
    "givenName": "Leannon",
    "familyName": "Magali",
    "identifier": "20d08f6c-2219-46ab-a739-340e612856b4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2229.534597ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b
...
---
Response status code: 201 Created. Responded in 3959.686928ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b#/orderedItems/2717",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1562#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b#/orderedItems/2718",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1562#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b#/orderedItems/2719",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1528#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b#/orderedItems/2720",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1010/facility-use-slots/10091#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b#/orderedItems/2721",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1010/facility-use-slots/10091#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b#/orderedItems/2722",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1035/facility-use-slots/10345#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b/versions/fb48b3a3-7dc5-4d7f-8065-b0e32b5f07e4",
  "payment": {
    "@type": "Payment",
    "identifier": "NtzlZgaih",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;07ee95d6-0d67-4f5b-b2db-babbd1e3a87b&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b


---
Response status code: 200 OK. Responded in 46.582329ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607623024204230&afterId=5211fe38-e782-45a3-b527-b8fca03da9b1",
  "message": "Listening for UUID: '07ee95d6-0d67-4f5b-b2db-babbd1e3a87b' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 256.92483ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;07ee95d6-0d67-4f5b-b2db-babbd1e3a87b&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b


---
Response status code: 200 OK. Responded in 2307.163179ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "07ee95d6-0d67-4f5b-b2db-babbd1e3a87b",
  "modified": 637607623137192300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b",
    "identifier": "07ee95d6-0d67-4f5b-b2db-babbd1e3a87b",
...
---
Response status code: 200 OK. Responded in 20.280129ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607623113457072&afterId=068c9aa8-39f1-46a1-998a-35b4aac819f6",
  "message": "Listening for UUID: '07ee95d6-0d67-4f5b-b2db-babbd1e3a87b' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b
...
---
Response status code: 201 Created. Responded in 6878.618908ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/07ee95d6-0d67-4f5b-b2db-babbd1e3a87b",
  "identifier": "07ee95d6-0d67-4f5b-b2db-babbd1e3a87b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 83.960528ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "07ee95d6-0d67-4f5b-b2db-babbd1e3a87b",
  "modified": 637607623169118100
}
```
### Specs
* ✅ should return 200 on success
