...
# free-opportunities >> opportunity-free-unnecessary-payment-error (OpenBookingSimpleFlow >> Multiple)
...
**Test:**  Fail free bookings which include erroneous payment property

C1, C2 and B with payment property: payment property is provided but not expected in the request, so an UnnecessaryPaymentDetailsError must be returned.

### Running only this test

```bash
npm start -- --runInBand test/features/payment/free-opportunities/implemented/opportunity-free-unnecessary-payment-error-test.js
```

---

⚠️ 9 passed with 0 failures, 102 warnings and 26 suggestions 
...
---
Response status code: 200 OK. Responded in 125.068287ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/422/events/4218"
}
```
...
---
Response status code: 200 OK. Responded in 125.294809ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2862"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F422%2Fevents%2F4218?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 188.276995ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/422/events/4218",
    "startDate": "2021-07-08T10:43:09+00:00",
    "endDate": "2021-07-08T12:33:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F287%2Ffacility-use-slots%2F2862?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 188.598025ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/287",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2862#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 8,
    "startDate": "2021-07-08T14:06:10+00:00",
    "endDate": "2021-07-08T17:58:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5baebddd-8e8b-4e86-a0de-8be5d3e2b36e
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/422/events/4218"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2862#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/287/facility-use-slots/2862"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 866.072816ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5baebddd-8e8b-4e86-a0de-8be5d3e2b36e",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:16+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/287"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-08T14:06:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5baebddd-8e8b-4e86-a0de-8be5d3e2b36e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Elinor91@hotmail.com",
    "telephone": "381-639-2656 x42713",
    "givenName": "Denesik",
    "familyName": "Idella",
    "identifier": "60bdbb6d-d2c1-4620-bd6c-74cc52dfb227"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 592.480612ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/5baebddd-8e8b-4e86-a0de-8be5d3e2b36e
...
---
Response status code: 400 Bad Request. Responded in 111.390787ms.
```json
{
  "@context": "https://openactive.io/",
