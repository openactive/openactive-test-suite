...
⚠️ 29 passed with 0 failures, 299 warnings and 80 suggestions 
...
---
Response status code: 200 OK. Responded in 370.318419ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/184/events/1833"
}
```
...
---
Response status code: 200 OK. Responded in 370.64655ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/579/events/5790"
}
```
...
---
Response status code: 200 OK. Responded in 370.632449ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/363/events/3627"
}
```
...
---
Response status code: 200 OK. Responded in 346.528356ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/90/facility-use-slots/899"
}
```
...
---
Response status code: 200 OK. Responded in 343.343053ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/236/facility-use-slots/2354"
}
```
...
---
Response status code: 200 OK. Responded in 343.51887ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/233/facility-use-slots/2322"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F184%2Fevents%2F1833?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 275.281481ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/184/events/1833",
    "startDate": "2021-07-11T06:45:09+00:00",
    "endDate": "2021-07-11T07:24:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/184",
      "name": "Cotton Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/184#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F579%2Fevents%2F5790?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 275.4818ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/579/events/5790",
    "startDate": "2021-07-08T03:53:09+00:00",
    "endDate": "2021-07-08T04:31:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/579",
      "name": "Metal Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/579#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 10.39,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT20H54M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F363%2Fevents%2F3627?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 275.794929ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/363/events/3627",
    "startDate": "2021-07-10T19:06:09+00:00",
    "endDate": "2021-07-10T19:36:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/363",
      "name": "Wooden Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/363#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F90%2Ffacility-use-slots%2F899?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 275.928542ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/90/facility-use-slots/899#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    "remainingUses": 7,
    "startDate": "2021-07-07T10:08:09+00:00",
    "endDate": "2021-07-07T11:03:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 4 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F236%2Ffacility-use-slots%2F2354?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 276.338581ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/236",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/236/facility-use-slots/2354#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 14.69,
    ...
    "remainingUses": 2,
    "startDate": "2021-07-06T03:16:10+00:00",
    "endDate": "2021-07-06T06:50:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F233%2Ffacility-use-slots%2F2322?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 276.899435ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/233",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/233/facility-use-slots/2322#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 7,
    "startDate": "2021-07-04T04:18:10+00:00",
    "endDate": "2021-07-04T10:16:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/80a8fe2d-84bd-4f4a-bce8-a1b0a8750b70
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/184#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/184/events/1833"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/579#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/579/events/5790"
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/363#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/363/events/3627"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/90/facility-use-slots/899#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/90/facility-use-slots/899"
    },
    {
      "@type": "OrderItem",
      "position": 4,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/236/facility-use-slots/2354#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/236/facility-use-slots/2354"
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/233/facility-use-slots/2322#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/233/facility-use-slots/2322"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 233.619118ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/80a8fe2d-84bd-4f4a-bce8-a1b0a8750b70",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/184"
        },
        "maximumAttendeeCapacity": 33,
        "remainingAttendeeCapacity": 33
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/363"
        },
        "maximumAttendeeCapacity": 11,
        "remainingAttendeeCapacity": 11
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/233"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-04T04:18:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/80a8fe2d-84bd-4f4a-bce8-a1b0a8750b70
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Deondre_Collins@yahoo.com",
    "telephone": "(228) 710-3384",
    "givenName": "Stamm",
    "familyName": "Halie",
    "identifier": "62d146a9-411f-4eaa-9318-ff16f91c233f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 231.644928ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/80a8fe2d-84bd-4f4a-bce8-a1b0a8750b70
...
---
Response status code: 409 Conflict. Responded in 99.326545ms.
```json
{
  "@context": "https://openactive.io/",
