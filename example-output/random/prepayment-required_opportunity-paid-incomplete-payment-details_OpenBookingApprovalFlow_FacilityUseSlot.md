...
---
Response status code: 200 OK. Responded in 135.127267ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1013/facility-use-slots/10127"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1013%2Ffacility-use-slots%2F10127?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 23.803066ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1013",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1013/facility-use-slots/10127#/offers/0",
    ...
    "remainingUses": 5,
    "startDate": "2021-07-09T21:40:10+00:00",
    "endDate": "2021-07-10T01:19:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/cd3085d4-13eb-4f8a-84ee-a0236b53095d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1013/facility-use-slots/10127#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1013/facility-use-slots/10127"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1477.28897ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/cd3085d4-13eb-4f8a-84ee-a0236b53095d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:55:50+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/cd3085d4-13eb-4f8a-84ee-a0236b53095d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cristian_Padberg91@hotmail.com",
    "telephone": "1-416-889-3889",
    "givenName": "Conn",
    "familyName": "Josephine",
    "identifier": "1718b035-254c-40f3-8dfa-f6903f5411ec"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 675.931863ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/cd3085d4-13eb-4f8a-84ee-a0236b53095d
...
---
Response status code: 400 Bad Request. Responded in 107.999884ms.
```json
{
  "@context": "https://openactive.io/",
