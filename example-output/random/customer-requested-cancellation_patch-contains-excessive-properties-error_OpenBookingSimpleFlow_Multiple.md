...
---
Response status code: 200 OK. Responded in 289.182716ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/516/events/5153"
}
```
...
---
Response status code: 200 OK. Responded in 287.312838ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3044"
}
```
...
---
Response status code: 200 OK. Responded in 287.808385ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4209"
}
```
...
---
Response status code: 200 OK. Responded in 280.541794ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/350/facility-use-slots/3497"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F516%2Fevents%2F5153?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 325.000924ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/516/events/5153",
    "startDate": "2021-07-05T10:15:09+00:00",
    "endDate": "2021-07-05T16:10:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F305%2Fevents%2F3044?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 325.174241ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3044",
    "startDate": "2021-07-07T21:26:09+00:00",
    "endDate": "2021-07-07T23:37:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/305",
      "name": "Frozen Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/305#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F421%2Ffacility-use-slots%2F4209?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 333.287413ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4209#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 13.79,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT4H34M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-10T16:22:10+00:00",
    "endDate": "2021-07-10T22:06:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F350%2Ffacility-use-slots%2F3497?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 340.200471ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/350/facility-use-slots/3497#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0.77,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT1H53M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-11T06:11:10+00:00",
    "endDate": "2021-07-11T11:07:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/88dc9d9b-d0bd-475c-9f43-c36bb585d290
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/516/events/5153"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/305#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3044"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4209#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4209"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/350/facility-use-slots/3497#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/350/facility-use-slots/3497"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1473.390495ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/88dc9d9b-d0bd-475c-9f43-c36bb585d290",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/305"
        },
        "maximumAttendeeCapacity": 25,
        "remainingAttendeeCapacity": 25
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/88dc9d9b-d0bd-475c-9f43-c36bb585d290
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tressa_Adams@yahoo.com",
    "telephone": "674-367-8754 x93754",
    "givenName": "Wintheiser",
    "familyName": "Emmett",
    "identifier": "77d62846-f6ac-474d-b3fc-9ca406a77483"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1129.568502ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/88dc9d9b-d0bd-475c-9f43-c36bb585d290
...
---
Response status code: 201 Created. Responded in 614.823855ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/88dc9d9b-d0bd-475c-9f43-c36bb585d290",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/88dc9d9b-d0bd-475c-9f43-c36bb585d290#/orderedItems/1535",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/516#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/88dc9d9b-d0bd-475c-9f43-c36bb585d290#/orderedItems/1536",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/516#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/88dc9d9b-d0bd-475c-9f43-c36bb585d290#/orderedItems/1537",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/305#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/88dc9d9b-d0bd-475c-9f43-c36bb585d290#/orderedItems/1538",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4209#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/88dc9d9b-d0bd-475c-9f43-c36bb585d290#/orderedItems/1539",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4209#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/88dc9d9b-d0bd-475c-9f43-c36bb585d290#/orderedItems/1540",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/350/facility-use-slots/3497#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/88dc9d9b-d0bd-475c-9f43-c36bb585d290
...
---
Response status code: 400 Bad Request. Responded in 28.677227ms.
```json
{
  "@context": "https://openactive.io/",
