...
---
Response status code: 200 OK. Responded in 602.662099ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/149/events/1485"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F149%2Fevents%2F1485?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 376.091058ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/149/events/1485",
    "startDate": "2021-07-07T15:52:09+00:00",
    "endDate": "2021-07-07T17:48:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/149",
      "name": "Rubber Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/149#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/adbd4396-e217-4c3f-8082-106e8dc1f9aa
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/149#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/149/events/1485"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1080.346718ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/adbd4396-e217-4c3f-8082-106e8dc1f9aa",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/149"
        },
        "maximumAttendeeCapacity": 15,
        "remainingAttendeeCapacity": 15
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/adbd4396-e217-4c3f-8082-106e8dc1f9aa
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Marquis.Barrows67@gmail.com",
    "telephone": "649.664.7291 x0559",
    "givenName": "Graham",
    "familyName": "Sallie",
    "identifier": "4d2d690a-9c5c-44c3-b617-34dfbeba3c79"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 104.174505ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/adbd4396-e217-4c3f-8082-106e8dc1f9aa
...
---
Response status code: 409 Conflict. Responded in 61.564653ms.
```json
{
  "@context": "https://openactive.io/",
