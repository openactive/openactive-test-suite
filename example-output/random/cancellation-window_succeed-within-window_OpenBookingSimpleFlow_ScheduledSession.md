...
# cancellation-window >> succeed-within-window (OpenBookingSimpleFlow >> ScheduledSession)
...
⚠️ 6 passed with 0 failures, 76 warnings and 26 suggestions 
...
---
Response status code: 200 OK. Responded in 233.16684ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/204/events/2031"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F204%2Fevents%2F2031?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 105.587826ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/204/events/2031",
    "startDate": "2021-07-06T11:36:09+00:00",
    "endDate": "2021-07-06T13:18:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/f0c8bd49-f88a-44a9-88f3-ab6ccfa05df5
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/204/events/2031"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 398.767464ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/f0c8bd49-f88a-44a9-88f3-ab6ccfa05df5",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:18+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/f0c8bd49-f88a-44a9-88f3-ab6ccfa05df5
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Casper.Swift59@yahoo.com",
    "telephone": "753-420-4810 x2005",
    "givenName": "Gorczany",
    "familyName": "Ambrose",
    "identifier": "f2e685bc-354b-4c14-af10-bedbd68c7342"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 175.841396ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/f0c8bd49-f88a-44a9-88f3-ab6ccfa05df5
...
---
Response status code: 201 Created. Responded in 289.208261ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/f0c8bd49-f88a-44a9-88f3-ab6ccfa05df5",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/f0c8bd49-f88a-44a9-88f3-ab6ccfa05df5#/orderedItems/2131",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/204#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/f0c8bd49-f88a-44a9-88f3-ab6ccfa05df5
...
---
Response status code: 204 No Content. Responded in 118.068911ms.
### Specs
