...
# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-incorrect-details (OpenBookingApprovalFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 13.071543ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1658/facility-use-slots/16573"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1658%2Ffacility-use-slots%2F16573?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.5117ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1658/facility-use-slots/16573#/offers/0",
        ...
        "price": 1.89,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT16H8M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-05T20:11:10+00:00",
    "endDate": "2021-07-06T00:10:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/66cca887-16a5-40a9-ad96-89791eec002c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1658/facility-use-slots/16573#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1658/facility-use-slots/16573"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-P9GLnRvvhp",
    "accountId": "invalid-pbAwh9nbk",
    "paymentProviderId": "invalid-mb19ez74iH"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 167.995181ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/66cca887-16a5-40a9-ad96-89791eec002c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Laisha55@hotmail.com",
    "telephone": "1-698-370-2544",
    "givenName": "Kunde",
    "familyName": "Nathanial",
    "identifier": "05ca1344-7a9b-40b3-a8f8-94478a499fe6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-Jm_hQaAYg1",
    "accountId": "invalid-SV1pwqLRz5",
    "paymentProviderId": "invalid-QILSZF_pys"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 38.962206ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
