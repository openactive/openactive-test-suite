...
⚠️ 11 passed with 0 failures, 96 warnings and 34 suggestions 
...
---
Response status code: 200 OK. Responded in 512.881142ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/254/events/2533"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F254%2Fevents%2F2533?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 415.538072ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/254/events/2533",
    "startDate": "2021-07-04T23:54:09+00:00",
    "endDate": "2021-07-05T00:35:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d818eeff-8b85-4f5c-bfb9-0a8403fd5b35
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/254#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/254/events/2533"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 89.959767ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d818eeff-8b85-4f5c-bfb9-0a8403fd5b35",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:10+00:00"
  },
...
---
Response status code: 200 OK. Responded in 400.435534ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/478/events/4771"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F478%2Fevents%2F4771?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 436.238543ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/478/events/4771",
    "startDate": "2021-07-02T03:04:09+00:00",
    "endDate": "2021-07-02T04:01:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d818eeff-8b85-4f5c-bfb9-0a8403fd5b35
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Tomas.Wuckert@yahoo.com",
    "telephone": "1-795-335-7537 x623",
    "givenName": "Quitzon",
    "familyName": "Morton",
    "identifier": "fd720047-4473-44c1-9cbe-39b5d254b5ba"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/478/events/4771"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 206.304946ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:11+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/d818eeff-8b85-4f5c-bfb9-0a8403fd5b35
...
---
Response status code: 201 Created. Responded in 154.278992ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/d818eeff-8b85-4f5c-bfb9-0a8403fd5b35",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/d818eeff-8b85-4f5c-bfb9-0a8403fd5b35#/orderedItems/198",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/478#/offers/0",
        "allowCustomerCancellationFullRefund": false,
