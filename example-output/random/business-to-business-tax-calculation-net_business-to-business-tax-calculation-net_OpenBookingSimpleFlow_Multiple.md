...
# business-to-business-tax-calculation-net >> business-to-business-tax-calculation-net (OpenBookingSimpleFlow >> Multiple)
...
---
Response status code: 200 OK. Responded in 206.126383ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/552/events/5513"
}
```
...
---
Response status code: 200 OK. Responded in 206.670535ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/289/events/2889"
}
```
...
---
Response status code: 200 OK. Responded in 206.959563ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/451/facility-use-slots/4503"
}
```
...
---
Response status code: 200 OK. Responded in 196.41276ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/270/facility-use-slots/2692"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F552%2Fevents%2F5513?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 134.898817ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/552/events/5513",
    "startDate": "2021-07-02T05:28:09+00:00",
    "endDate": "2021-07-02T09:20:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/552",
      "name": "Steel Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/552#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Required",
          "price": 3.46,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT19H48M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F289%2Fevents%2F2889?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 138.057016ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/289/events/2889",
    "startDate": "2021-07-08T10:07:09+00:00",
    "endDate": "2021-07-08T12:38:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/289",
      "name": "Rubber Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/289#/offers/0",
          "allowCustomerCancellationFullRefund": true,
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F451%2Ffacility-use-slots%2F4503?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 139.298534ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/451",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/451/facility-use-slots/4503#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 4.73,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT22H19M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-06T18:12:10+00:00",
    "endDate": "2021-07-06T20:32:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F270%2Ffacility-use-slots%2F2692?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 144.055186ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/270",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/270/facility-use-slots/2692#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 16.78,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 8,
    "startDate": "2021-07-06T20:47:10+00:00",
    "endDate": "2021-07-07T00:23:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bd9abb9d-4bbd-4971-b8d2-6018863cb210
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/552#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/552/events/5513"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/289#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/289/events/2889"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/451/facility-use-slots/4503#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/451/facility-use-slots/4503"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/270/facility-use-slots/2692#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/270/facility-use-slots/2692"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 998.770991ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bd9abb9d-4bbd-4971-b8d2-6018863cb210",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/289"
        },
        "maximumAttendeeCapacity": 6,
        "remainingAttendeeCapacity": 6
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bd9abb9d-4bbd-4971-b8d2-6018863cb210
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "ac8a9444-8d9e-4bd7-bd7c-5f2967fff720",
...
---
Response status code: 200 OK. Responded in 899.221133ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:05+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/bd9abb9d-4bbd-4971-b8d2-6018863cb210
...
---
Response status code: 201 Created. Responded in 1343.532846ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/bd9abb9d-4bbd-4971-b8d2-6018863cb210",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bd9abb9d-4bbd-4971-b8d2-6018863cb210#/orderedItems/2286",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/552#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bd9abb9d-4bbd-4971-b8d2-6018863cb210#/orderedItems/2287",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/552#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bd9abb9d-4bbd-4971-b8d2-6018863cb210#/orderedItems/2288",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/289#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bd9abb9d-4bbd-4971-b8d2-6018863cb210#/orderedItems/2289",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/451/facility-use-slots/4503#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bd9abb9d-4bbd-4971-b8d2-6018863cb210#/orderedItems/2290",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/451/facility-use-slots/4503#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/bd9abb9d-4bbd-4971-b8d2-6018863cb210#/orderedItems/2291",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/270/facility-use-slots/2692#/offers/0",
        "allowCustomerCancellationFullRefund": true,
