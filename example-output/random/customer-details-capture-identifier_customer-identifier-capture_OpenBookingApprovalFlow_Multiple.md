[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:45:50 GMT+0000 (Coordinated Universal Time)

# customer-details-capture-identifier >> customer-identifier-capture (OpenBookingApprovalFlow >> Multiple)

**Booking Flow:** OpenBookingApprovalFlow

**Opportunity Type:** Multiple

**Feature:** Details Capture / Customer Details identifier capture (Implemented) 

**Test:**  Customer identifier is reflected back at C2 and B

Identifier from the Customer supplied by Broker should be reflected back by booking system.

### Running only this test

```bash
npm start -- --runInBand test/features/details-capture/customer-details-capture-identifier/implemented/customer-identifier-capture-test.js
```

---

⚠️ 21 passed with 0 failures, 497 warnings and 132 suggestions 
...
---
Response status code: 200 OK. Responded in 113.537377ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1210/events/12092"
}
```
...
---
Response status code: 200 OK. Responded in 114.164837ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1741/events/17409"
}
```
...
---
Response status code: 200 OK. Responded in 120.283018ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13852"
}
```
...
---
Response status code: 200 OK. Responded in 117.093614ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1218/facility-use-slots/12174"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1210%2Fevents%2F12092?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 167.337484ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1210/events/12092",
    "startDate": "2021-07-10T23:00:09+00:00",
    "endDate": "2021-07-11T00:22:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1210",
      "name": "Frozen Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1210#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1741%2Fevents%2F17409?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 166.989451ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1741/events/17409",
    "startDate": "2021-07-02T07:47:09+00:00",
    "endDate": "2021-07-02T10:12:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1741",
      "name": "Soft Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1741#/offers/0",
          ...
          "price": 6.54,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P1DT6H10M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1386%2Ffacility-use-slots%2F13852?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 166.829636ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13852#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT15H37M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-08T12:15:10+00:00",
    "endDate": "2021-07-08T13:32:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1218%2Ffacility-use-slots%2F12174?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 166.98235ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1218",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1218/facility-use-slots/12174#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 4,
    "startDate": "2021-07-03T19:31:10+00:00",
    "endDate": "2021-07-04T00:02:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/138b1a84-799e-4a40-8cc2-1714f1cf6bd6
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1210#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1210/events/12092"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1741#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1741/events/17409"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13852#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13852"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1218/facility-use-slots/12174#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1218/facility-use-slots/12174"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 612.458634ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/138b1a84-799e-4a40-8cc2-1714f1cf6bd6",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:27+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1210"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1741"
        },
        "maximumAttendeeCapacity": 19,
        "remainingAttendeeCapacity": 19
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1218"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-03T19:31:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/138b1a84-799e-4a40-8cc2-1714f1cf6bd6
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Hayden.Blick10@yahoo.com",
    "telephone": "(233) 892-5790 x20600",
    "givenName": "Halvorson",
    "familyName": "Kaylah",
    "identifier": "44097f3d-e626-4db8-9f50-6f8a844d96df"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 539.316992ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:28+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### Specs
* ✅ should return 200 on success
* ✅ should include expected Customer identifier
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/138b1a84-799e-4a40-8cc2-1714f1cf6bd6
...
---
Response status code: 201 Created. Responded in 608.566465ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/138b1a84-799e-4a40-8cc2-1714f1cf6bd6",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/138b1a84-799e-4a40-8cc2-1714f1cf6bd6#/orderedItems/1831",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1210#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/138b1a84-799e-4a40-8cc2-1714f1cf6bd6#/orderedItems/1832",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1210#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/138b1a84-799e-4a40-8cc2-1714f1cf6bd6#/orderedItems/1833",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1741#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/138b1a84-799e-4a40-8cc2-1714f1cf6bd6#/orderedItems/1834",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13852#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/138b1a84-799e-4a40-8cc2-1714f1cf6bd6#/orderedItems/1835",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13852#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/138b1a84-799e-4a40-8cc2-1714f1cf6bd6#/orderedItems/1836",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1218/facility-use-slots/12174#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/138b1a84-799e-4a40-8cc2-1714f1cf6bd6/versions/dae43d42-b36f-464d-9eb9-4e589dd4c846",
  "payment": {
    "@type": "Payment",
    "identifier": "1pFKtvbnY",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;138b1a84-799e-4a40-8cc2-1714f1cf6bd6&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/138b1a84-799e-4a40-8cc2-1714f1cf6bd6


---
Response status code: 200 OK. Responded in 278.923276ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619852343172&afterId=d0b78479-6209-41d3-8d57-df1315a826fc",
  "message": "Listening for UUID: '138b1a84-799e-4a40-8cc2-1714f1cf6bd6' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 32.598294ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;138b1a84-799e-4a40-8cc2-1714f1cf6bd6&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/138b1a84-799e-4a40-8cc2-1714f1cf6bd6


---
Response status code: 200 OK. Responded in 2698.443676ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "138b1a84-799e-4a40-8cc2-1714f1cf6bd6",
  "modified": 637607619912563200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/138b1a84-799e-4a40-8cc2-1714f1cf6bd6",
    "identifier": "138b1a84-799e-4a40-8cc2-1714f1cf6bd6",
...
---
Response status code: 200 OK. Responded in 205.287205ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/138b1a84-799e-4a40-8cc2-1714f1cf6bd6
...
---
Response status code: 201 Created. Responded in 1512.555109ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/138b1a84-799e-4a40-8cc2-1714f1cf6bd6",
  "identifier": "138b1a84-799e-4a40-8cc2-1714f1cf6bd6",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 190.494499ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "138b1a84-799e-4a40-8cc2-1714f1cf6bd6",
  "modified": 637607619953005300
}
```
### Specs
* ✅ should return 200 on success
