...
---
Response status code: 200 OK. Responded in 129.230479ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/397/facility-use-slots/3970"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F397%2Ffacility-use-slots%2F3970?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 84.120424ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/397/facility-use-slots/3970#/offers/0",
    ...
    "remainingUses": 6,
    "startDate": "2021-07-10T12:10:10+00:00",
    "endDate": "2021-07-10T17:23:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bd07dc36-5f9e-40ef-a9a7-9b67f0fe9711
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/397/facility-use-slots/3970#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/397/facility-use-slots/3970"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2214.417426ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/bd07dc36-5f9e-40ef-a9a7-9b67f0fe9711",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bd07dc36-5f9e-40ef-a9a7-9b67f0fe9711
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Amir.Mertz@hotmail.com",
    "telephone": "407-902-4534 x507",
    "givenName": "Heller",
    "familyName": "Karlee",
    "identifier": "3363adea-27a5-4b9c-b01a-4fe67b10633d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 569.289632ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:56:53+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/bd07dc36-5f9e-40ef-a9a7-9b67f0fe9711
...
---
Response status code: 400 Bad Request. Responded in 93.138856ms.
```json
{
  "@context": "https://openactive.io/",
