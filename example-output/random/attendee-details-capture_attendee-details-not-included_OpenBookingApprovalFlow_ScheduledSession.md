...
⚠️ 5 passed with 0 failures, 60 warnings and 20 suggestions 
...
---
Response status code: 200 OK. Responded in 302.94499ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1113/events/11128"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1113%2Fevents%2F11128?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 404.316625ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1113/events/11128",
    "startDate": "2021-07-03T08:09:09+00:00",
    "endDate": "2021-07-03T10:13:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1113",
      "name": "Fresh Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1113#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/015b8373-b52b-4fc6-a34a-cd1e690ccad0
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1113#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1113/events/11128"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 182.833576ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/015b8373-b52b-4fc6-a34a-cd1e690ccad0",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:49+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1113"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/015b8373-b52b-4fc6-a34a-cd1e690ccad0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Clementina.Denesik47@yahoo.com",
    "telephone": "1-948-395-3851 x740",
    "givenName": "Mertz",
    "familyName": "Cary",
    "identifier": "202778b3-a55c-40b2-bfdf-fd049f91d4d4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 77.708585ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/015b8373-b52b-4fc6-a34a-cd1e690ccad0
...
---
Response status code: 409 Conflict. Responded in 38.51756ms.
```json
{
  "@context": "https://openactive.io/",
