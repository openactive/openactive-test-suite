...
# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-incorrect-details-no-payment-required (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 12.950534ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/495/facility-use-slots/4941"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F495%2Ffacility-use-slots%2F4941?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 17.577775ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/495",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/495/facility-use-slots/4941#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT4H5M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-07T17:10:10+00:00",
    "endDate": "2021-07-07T22:01:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/db3abcca-970c-4fe9-8e91-c327df78cec4
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/495/facility-use-slots/4941#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/495/facility-use-slots/4941"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-tmz0NcpLhA",
    "accountId": "invalid-5UuqT_0G9d",
    "paymentProviderId": "invalid-wt71RefIBk"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 411.5313ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/db3abcca-970c-4fe9-8e91-c327df78cec4
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Neal_McGlynn55@yahoo.com",
    "telephone": "789-806-9306",
    "givenName": "Fritsch",
    "familyName": "Noe",
    "identifier": "4d7742d8-65f7-4878-90f5-5c23d03fc669"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-ak1r4baFP_",
    "accountId": "invalid-0Z13mDlB2V",
    "paymentProviderId": "invalid-jkg4FjL0R_"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 55.44078ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
