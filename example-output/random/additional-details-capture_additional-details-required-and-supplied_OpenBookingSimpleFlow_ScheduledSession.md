...
# additional-details-capture >> additional-details-required-and-supplied (OpenBookingSimpleFlow >> ScheduledSession)
...
⚠️ 5 passed with 0 failures, 81 warnings and 28 suggestions 
...
---
Response status code: 200 OK. Responded in 164.670622ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/259/events/2584"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F259%2Fevents%2F2584?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 51.977962ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/259/events/2584",
    "startDate": "2021-07-06T02:40:09+00:00",
    "endDate": "2021-07-06T06:27:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/259",
      "name": "Soft Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/259#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4c48fc2d-eed2-46cf-bea5-3bfb70d6e7ee
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/259#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/259/events/2584"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1265.618635ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4c48fc2d-eed2-46cf-bea5-3bfb70d6e7ee",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:21+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/259"
        },
        "maximumAttendeeCapacity": 15,
        "remainingAttendeeCapacity": 15
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/4c48fc2d-eed2-46cf-bea5-3bfb70d6e7ee
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lelia.Hansen65@hotmail.com",
    "telephone": "740-753-6888 x2344",
    "givenName": "Waelchi",
    "familyName": "Reagan",
    "identifier": "1088b930-f728-4486-8586-4204b78c0df7"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 750.733176ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:23+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/4c48fc2d-eed2-46cf-bea5-3bfb70d6e7ee
...
---
Response status code: 201 Created. Responded in 1232.708289ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/4c48fc2d-eed2-46cf-bea5-3bfb70d6e7ee",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/4c48fc2d-eed2-46cf-bea5-3bfb70d6e7ee#/orderedItems/2773",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/259#/offers/0",
        "allowCustomerCancellationFullRefund": false,
