...
# customer-requested-cancellation >> patch-not-allowed-on-property-error (OpenBookingApprovalFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 116.714391ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1202/events/12018"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1202%2Fevents%2F12018?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 94.744404ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1202/events/12018",
    "startDate": "2021-07-03T05:39:09+00:00",
    "endDate": "2021-07-03T10:27:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1202",
      "name": "Cotton Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1202#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/0e235888-5eb9-420c-87bb-bb8b1a5de514
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1202#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1202/events/12018"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 208.509614ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/0e235888-5eb9-420c-87bb-bb8b1a5de514",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1202"
        },
        "maximumAttendeeCapacity": 30,
        "remainingAttendeeCapacity": 30
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/0e235888-5eb9-420c-87bb-bb8b1a5de514
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Carolyn.Luettgen20@gmail.com",
    "telephone": "(356) 406-5082",
    "givenName": "Cartwright",
    "familyName": "Bo",
    "identifier": "976162b5-e725-4a9b-8f37-2588db1f02d1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 717.038537ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/0e235888-5eb9-420c-87bb-bb8b1a5de514
...
---
Response status code: 201 Created. Responded in 389.398503ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/0e235888-5eb9-420c-87bb-bb8b1a5de514",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/0e235888-5eb9-420c-87bb-bb8b1a5de514#/orderedItems/1598",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1202#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/0e235888-5eb9-420c-87bb-bb8b1a5de514/versions/05bdeeb9-5ec0-4375-a7cc-696f42f15f76",
  "payment": {
    "@type": "Payment",
    "identifier": "4Wv-v4wiU",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;0e235888-5eb9-420c-87bb-bb8b1a5de514&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/0e235888-5eb9-420c-87bb-bb8b1a5de514


---
Response status code: 200 OK. Responded in 359.574968ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619094760532&afterId=1aae9bf6-ed10-4bff-b6eb-717b3fd488ec",
  "message": "Listening for UUID: '0e235888-5eb9-420c-87bb-bb8b1a5de514' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 484.872075ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;0e235888-5eb9-420c-87bb-bb8b1a5de514&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/0e235888-5eb9-420c-87bb-bb8b1a5de514


---
Response status code: 200 OK. Responded in 2037.359101ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "0e235888-5eb9-420c-87bb-bb8b1a5de514",
  "modified": 637607619143975600,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/0e235888-5eb9-420c-87bb-bb8b1a5de514",
    "identifier": "0e235888-5eb9-420c-87bb-bb8b1a5de514",
...
---
Response status code: 200 OK. Responded in 152.630304ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/0e235888-5eb9-420c-87bb-bb8b1a5de514
...
---
Response status code: 201 Created. Responded in 178.823593ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/0e235888-5eb9-420c-87bb-bb8b1a5de514",
  "identifier": "0e235888-5eb9-420c-87bb-bb8b1a5de514",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1534.257968ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "0e235888-5eb9-420c-87bb-bb8b1a5de514",
  "modified": 637607619171481500
}
```
### Specs
* ✅ should return 200 on success
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/0e235888-5eb9-420c-87bb-bb8b1a5de514
...
---
Response status code: 400 Bad Request. Responded in 43.366713ms.
```json
{
  "@context": "https://openactive.io/",
