[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:49:56 GMT+0000 (Coordinated Universal Time)
...
⚠️ 9 passed with 0 failures, 108 warnings and 28 suggestions 
...
---
Response status code: 200 OK. Responded in 182.614951ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/488/events/4880"
}
```
...
---
Response status code: 200 OK. Responded in 183.017489ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/466/facility-use-slots/4653"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F488%2Fevents%2F4880?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 136.62108ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/488/events/4880",
    "startDate": "2021-07-05T19:47:09+00:00",
    "endDate": "2021-07-05T20:27:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/488",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/488#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "price": 7.43,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT9H38M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F466%2Ffacility-use-slots%2F4653?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 136.8162ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/466",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/466/facility-use-slots/4653#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 15.16,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT14H21M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-04T19:53:10+00:00",
    "endDate": "2021-07-04T22:06:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a6977fef-50c3-4a70-bb9c-7b31637484a2
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/488#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/488/events/4880"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/466/facility-use-slots/4653#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/466/facility-use-slots/4653"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1500.96481ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a6977fef-50c3-4a70-bb9c-7b31637484a2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:55:04+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/488"
        },
        "maximumAttendeeCapacity": 13,
        "remainingAttendeeCapacity": 13
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a6977fef-50c3-4a70-bb9c-7b31637484a2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Letitia_Miller39@gmail.com",
    "telephone": "1-611-465-8143 x9194",
    "givenName": "O'Conner",
    "familyName": "Sibyl",
    "identifier": "3ac599f4-79be-4ec1-b00d-0536ecb1118c"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1115.461383ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a6977fef-50c3-4a70-bb9c-7b31637484a2
...
---
Response status code: 400 Bad Request. Responded in 78.699477ms.
```json
{
  "@context": "https://openactive.io/",
