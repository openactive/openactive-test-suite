...
# amending-order-quote >> amend-c1-and-c2 (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 36 passed with 0 failures, 671 warnings and 184 suggestions 
...
---
Response status code: 200 OK. Responded in 366.26848ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/554/events/5538"
}
```
...
---
Response status code: 200 OK. Responded in 367.730719ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/402/events/4017"
}
```
...
---
Response status code: 200 OK. Responded in 374.543268ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/457/facility-use-slots/4562"
}
```
...
---
Response status code: 200 OK. Responded in 375.266037ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/552/facility-use-slots/5517"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F554%2Fevents%2F5538?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 453.918127ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/554/events/5538",
    "startDate": "2021-07-09T16:34:09+00:00",
    "endDate": "2021-07-09T20:11:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F402%2Fevents%2F4017?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 454.719703ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/402/events/4017",
    "startDate": "2021-07-10T08:09:09+00:00",
    "endDate": "2021-07-10T10:45:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/402",
      "name": "Granite Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/402#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 11.84,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT12H50M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F457%2Ffacility-use-slots%2F4562?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 455.802906ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/457/facility-use-slots/4562#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT22H14M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-05T01:27:10+00:00",
    "endDate": "2021-07-05T04:00:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F552%2Ffacility-use-slots%2F5517?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 456.388362ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/552",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/552/facility-use-slots/5517#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 17.32,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT21H7M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-03T05:06:10+00:00",
    "endDate": "2021-07-03T08:55:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b4b3fb60-92c2-4061-a206-2d67b41fab44
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/554/events/5538"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/402#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/402/events/4017"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/457/facility-use-slots/4562#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/457/facility-use-slots/4562"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/552/facility-use-slots/5517#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/552/facility-use-slots/5517"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1205.267978ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b4b3fb60-92c2-4061-a206-2d67b41fab44",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:14+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/402"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/552"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-03T05:06:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b4b3fb60-92c2-4061-a206-2d67b41fab44
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Luna.Block95@gmail.com",
    "telephone": "1-708-757-9782",
    "givenName": "Mayert",
    "familyName": "Mafalda",
    "identifier": "606e5fc7-14a4-4758-babb-e4750bc4cc5b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 277.903242ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
---
Response status code: 200 OK. Responded in 326.242842ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/282/events/2813"
}
```
...
---
Response status code: 200 OK. Responded in 326.724987ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/475/events/4747"
}
```
...
---
Response status code: 200 OK. Responded in 327.219334ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/640/facility-use-slots/6400"
}
```
...
---
Response status code: 200 OK. Responded in 327.567467ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/640/facility-use-slots/6397"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F282%2Fevents%2F2813?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 401.513003ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/282/events/2813",
    "startDate": "2021-07-08T22:38:09+00:00",
    "endDate": "2021-07-09T03:05:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/282",
      "name": "Fresh Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/282#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 4.76,
          "priceCurrency": "GBP"
        }
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F475%2Fevents%2F4747?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 401.16627ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/475/events/4747",
    "startDate": "2021-07-08T20:49:09+00:00",
    "endDate": "2021-07-08T21:57:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/475",
      "name": "Rubber Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/475#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT23H8M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F640%2Ffacility-use-slots%2F6400?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 400.871042ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/640",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/640/facility-use-slots/6400#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 13.97,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT17H43M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-04T02:33:10+00:00",
    "endDate": "2021-07-04T05:47:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F640%2Ffacility-use-slots%2F6397?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 418.757044ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/640/facility-use-slots/6397#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT17H7M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-09T18:28:10+00:00",
    "endDate": "2021-07-09T21:56:10+00:00"
  }
}
```
### Specs
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/282#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/282/events/2813"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/475#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/475/events/4747"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/640/facility-use-slots/6400#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/640/facility-use-slots/6400"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/640/facility-use-slots/6397#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/640/facility-use-slots/6397"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 371.492346ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/282"
        },
        "maximumAttendeeCapacity": 23,
        "remainingAttendeeCapacity": 23
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/475"
        },
        "maximumAttendeeCapacity": 30,
        "remainingAttendeeCapacity": 30
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/640"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-04T02:33:10+00:00",
...
---
Response status code: 200 OK. Responded in 284.530873ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:20+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b4b3fb60-92c2-4061-a206-2d67b41fab44
...
---
Response status code: 201 Created. Responded in 287.005208ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b4b3fb60-92c2-4061-a206-2d67b41fab44",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b4b3fb60-92c2-4061-a206-2d67b41fab44#/orderedItems/238",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/282#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b4b3fb60-92c2-4061-a206-2d67b41fab44#/orderedItems/239",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/282#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b4b3fb60-92c2-4061-a206-2d67b41fab44#/orderedItems/240",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/475#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b4b3fb60-92c2-4061-a206-2d67b41fab44#/orderedItems/241",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/640/facility-use-slots/6400#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b4b3fb60-92c2-4061-a206-2d67b41fab44#/orderedItems/242",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/640/facility-use-slots/6400#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b4b3fb60-92c2-4061-a206-2d67b41fab44#/orderedItems/243",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/640/facility-use-slots/6397#/offers/0",
        "allowCustomerCancellationFullRefund": true,
