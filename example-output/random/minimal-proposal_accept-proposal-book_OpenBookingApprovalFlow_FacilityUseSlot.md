[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:38:14 GMT+0000 (Coordinated Universal Time)

# minimal-proposal >> accept-proposal-book (OpenBookingApprovalFlow >> FacilityUseSlot)
...
**Test:**  Successful booking using the Booking Flow with Approval

A successful end to end booking, via Booking Flow with Approval, of an opportunity.

### Running only this test

```bash
npm start -- --runInBand test/features/approval/minimal-proposal/implemented/accept-proposal-book-test.js
```

---

⚠️ 15 passed with 0 failures, 92 warnings and 10 suggestions 
...
---
Response status code: 200 OK. Responded in 476.62262ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1555/facility-use-slots/15549"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1555%2Ffacility-use-slots%2F15549?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 512.856958ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1555",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1555/facility-use-slots/15549#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT8H43M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-08T17:52:10+00:00",
    "endDate": "2021-07-08T22:54:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/29e03169-b5a8-4dbf-b1ce-4d214f47e66c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1555/facility-use-slots/15549#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1555/facility-use-slots/15549"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 106.76793ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/29e03169-b5a8-4dbf-b1ce-4d214f47e66c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:25+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1555"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-08T17:52:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/29e03169-b5a8-4dbf-b1ce-4d214f47e66c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Terrell_Terry67@yahoo.com",
    "telephone": "(705) 326-4150",
    "givenName": "Jaskolski",
    "familyName": "Claud",
    "identifier": "76db961d-f5f6-4607-9c46-0bc1d7bc6145"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 108.851227ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:43:26+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/29e03169-b5a8-4dbf-b1ce-4d214f47e66c
...
---
Response status code: 201 Created. Responded in 133.264444ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/29e03169-b5a8-4dbf-b1ce-4d214f47e66c",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/29e03169-b5a8-4dbf-b1ce-4d214f47e66c#/orderedItems/264",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1555/facility-use-slots/15549#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/29e03169-b5a8-4dbf-b1ce-4d214f47e66c/versions/2c2bf3c7-c966-49cd-aa3f-a617fd69f823",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;29e03169-b5a8-4dbf-b1ce-4d214f47e66c&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/29e03169-b5a8-4dbf-b1ce-4d214f47e66c


---
Response status code: 200 OK. Responded in 334.746159ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607615011915659&afterId=5d525fab-d260-44b8-8b8a-e8d3c7a8428d",
  "message": "Listening for UUID: '29e03169-b5a8-4dbf-b1ce-4d214f47e66c' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 26.614125ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;29e03169-b5a8-4dbf-b1ce-4d214f47e66c&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/29e03169-b5a8-4dbf-b1ce-4d214f47e66c


---
Response status code: 200 OK. Responded in 2356.406867ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "29e03169-b5a8-4dbf-b1ce-4d214f47e66c",
  "modified": 637607615070980900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/29e03169-b5a8-4dbf-b1ce-4d214f47e66c",
    "identifier": "29e03169-b5a8-4dbf-b1ce-4d214f47e66c",
...
---
Response status code: 200 OK. Responded in 375.398017ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/29e03169-b5a8-4dbf-b1ce-4d214f47e66c
...
---
Response status code: 201 Created. Responded in 109.030845ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/29e03169-b5a8-4dbf-b1ce-4d214f47e66c",
  "identifier": "29e03169-b5a8-4dbf-b1ce-4d214f47e66c",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1314.5237339999999ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "29e03169-b5a8-4dbf-b1ce-4d214f47e66c",
  "modified": 637607615098944600
}
```
### Specs
* ✅ should return 200 on success
...
* ✅ should have deleted the OrderProposal after B
