[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:52:24 GMT+0000 (Coordinated Universal Time)

# booking-window >> opportunity-in-range-c1-c2 (OpenBookingApprovalFlow >> Multiple)
...
**Test:**  Running C1 and C2 for opportunity in range should succeed

Booking an opportunity within the specified booking window

### Running only this test

```bash
npm start -- --runInBand test/features/restrictions/booking-window/implemented/opportunity-in-range-c1-c2-test.js
```

---

⚠️ 14 passed with 0 failures, 281 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 31.166479ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1793/events/17927"
}
```
...
---
Response status code: 200 OK. Responded in 38.167047ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1127/events/11265"
}
```
...
---
Response status code: 200 OK. Responded in 38.671596ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1342/facility-use-slots/13414"
}
```
...
---
Response status code: 200 OK. Responded in 39.289855ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1141/facility-use-slots/11407"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1793%2Fevents%2F17927?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 36.142855ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1793/events/17927",
    "startDate": "2021-07-02T12:19:09+00:00",
    "endDate": "2021-07-02T18:17:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1793",
      "name": "Frozen Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1793#/offers/0",
          ...
          "price": 2.87,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P1DT6H34M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1127%2Fevents%2F11265?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 35.505293ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1127/events/11265",
    "startDate": "2021-07-07T23:38:09+00:00",
    "endDate": "2021-07-08T01:08:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1342%2Ffacility-use-slots%2F13414?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 34.993044ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1342/facility-use-slots/13414#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        ...
        "price": 19.76,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT1H16M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-08T19:25:10+00:00",
    "endDate": "2021-07-08T21:51:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1141%2Ffacility-use-slots%2F11407?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 41.53697ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1141/facility-use-slots/11407#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
    ...
    "remainingUses": 3,
    "startDate": "2021-07-08T14:42:10+00:00",
    "endDate": "2021-07-08T19:28:10+00:00"
  }
}
```
### Specs
...
* ✅ matches the criteria 'TestOpportunityBookableWithinValidFromBeforeStartDate' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ff10ef67-8ae3-4a45-96f4-ddeef9e9d19d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1793#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1793/events/17927"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1127/events/11265"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1342/facility-use-slots/13414#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1342/facility-use-slots/13414"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1141/facility-use-slots/11407#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1141/facility-use-slots/11407"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1883.756623ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ff10ef67-8ae3-4a45-96f4-ddeef9e9d19d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:03+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1793"
        },
        "maximumAttendeeCapacity": 42,
        "remainingAttendeeCapacity": 42
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ff10ef67-8ae3-4a45-96f4-ddeef9e9d19d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Melany.Huel71@yahoo.com",
    "telephone": "919.345.2315 x3717",
    "givenName": "Stehr",
    "familyName": "Torrance",
    "identifier": "e7797b54-824a-4aff-be06-2db90a51e066"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 3423.626109ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:07+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
