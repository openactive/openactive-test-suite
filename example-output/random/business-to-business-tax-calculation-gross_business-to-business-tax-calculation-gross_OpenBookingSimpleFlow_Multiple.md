[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:54:27 GMT+0000 (Coordinated Universal Time)

# business-to-business-tax-calculation-gross >> business-to-business-tax-calculation-gross (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 18 passed with 0 failures, 384 warnings and 106 suggestions 
...
---
Response status code: 200 OK. Responded in 42.413608ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/520/events/5195"
}
```
...
---
Response status code: 200 OK. Responded in 55.190216ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/436/events/4354"
}
```
...
---
Response status code: 200 OK. Responded in 54.019906ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/374/facility-use-slots/3731"
}
```
...
---
Response status code: 200 OK. Responded in 36.727672ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/744/facility-use-slots/7439"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F520%2Fevents%2F5195?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 44.502906ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/520/events/5195",
    "startDate": "2021-07-03T14:40:09+00:00",
    "endDate": "2021-07-03T19:04:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/520",
      "name": "Fresh Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/520#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingPrepayment": "https://openactive.io/Optional",
          "price": 9.76,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT12H49M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F436%2Fevents%2F4354?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 43.821342ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/436/events/4354",
    "startDate": "2021-07-04T23:10:09+00:00",
    "endDate": "2021-07-05T00:10:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/436",
      "name": "Soft Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/436#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 6.65,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT22H15M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F374%2Ffacility-use-slots%2F3731?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 42.752141ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/374",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/374/facility-use-slots/3731#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 2.88,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT14H18M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-09T11:06:10+00:00",
    "endDate": "2021-07-09T15:40:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F744%2Ffacility-use-slots%2F7439?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 34.528463ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/744",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/744/facility-use-slots/7439#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 14.88,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT8H15M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-03T03:48:10+00:00",
    "endDate": "2021-07-03T05:58:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/114901ec-cb50-48b4-93b4-986d6dd4b99d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/520#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/520/events/5195"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/436#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/436/events/4354"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/374/facility-use-slots/3731#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/374/facility-use-slots/3731"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/744/facility-use-slots/7439#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/744/facility-use-slots/7439"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1972.834658ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/114901ec-cb50-48b4-93b4-986d6dd4b99d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:42+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/436"
        },
        "maximumAttendeeCapacity": 38,
        "remainingAttendeeCapacity": 38
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/374"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-09T11:06:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/744"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-03T03:48:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/114901ec-cb50-48b4-93b4-986d6dd4b99d
...
```json
{
  ...
  "customer": {
    ...
    "identifier": "0068b281-152d-4689-9510-ee02578aeb25",
...
---
Response status code: 200 OK. Responded in 2006.60425ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:45+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/114901ec-cb50-48b4-93b4-986d6dd4b99d
...
---
Response status code: 201 Created. Responded in 2427.205227ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/114901ec-cb50-48b4-93b4-986d6dd4b99d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/114901ec-cb50-48b4-93b4-986d6dd4b99d#/orderedItems/3115",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/520#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/114901ec-cb50-48b4-93b4-986d6dd4b99d#/orderedItems/3116",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/520#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/114901ec-cb50-48b4-93b4-986d6dd4b99d#/orderedItems/3117",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/436#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/114901ec-cb50-48b4-93b4-986d6dd4b99d#/orderedItems/3118",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/374/facility-use-slots/3731#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/114901ec-cb50-48b4-93b4-986d6dd4b99d#/orderedItems/3119",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/374/facility-use-slots/3731#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/114901ec-cb50-48b4-93b4-986d6dd4b99d#/orderedItems/3120",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/744/facility-use-slots/7439#/offers/0",
        "allowCustomerCancellationFullRefund": true,
