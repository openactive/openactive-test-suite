...
---
Response status code: 200 OK. Responded in 222.921579ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1141/events/11406"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1141%2Fevents%2F11406?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 214.166247ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1141/events/11406",
    "startDate": "2021-07-03T16:36:09+00:00",
    "endDate": "2021-07-03T17:58:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1141/events/11406"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 749.515609ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:38+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Oliver80@gmail.com",
    "telephone": "1-605-465-1997 x88182",
    "givenName": "Conn",
    "familyName": "Willis",
    "identifier": "a0f775c7-969f-48bf-8fc5-460891fae533"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 479.137621ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb
...
---
Response status code: 201 Created. Responded in 385.842141ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb#/orderedItems/2203",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1141#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb/versions/97a3edb4-c007-4cd9-b739-a70f6a652d6f",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb


---
Response status code: 200 OK. Responded in 94.182043ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 24.692044ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb


---
Response status code: 200 OK. Responded in 2148.280006ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb",
  "modified": 637607621204424800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb",
    "identifier": "3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb",
...
---
Response status code: 200 OK. Responded in 227.054762ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621194893490&afterId=5ff7bb6a-de8d-43a6-ac2f-ca883adb5e6c",
  "message": "Listening for UUID: '3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb
...
---
Response status code: 201 Created. Responded in 359.633352ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb",
  "identifier": "3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1469.2362229999999ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb",
  "modified": 637607621230067600
}
```
### Specs
* ✅ should return 200 on success
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/3f613529-f4a8-4f6a-b4d2-b8fcdd3981cb
...
---
Response status code: 204 No Content. Responded in 193.02233ms.
### Specs
* ✅ should return 204 on success
