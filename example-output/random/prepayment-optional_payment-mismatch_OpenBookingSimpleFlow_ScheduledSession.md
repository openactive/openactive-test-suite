...
---
Response status code: 200 OK. Responded in 244.997758ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/262/events/2618"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F262%2Fevents%2F2618?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 262.999097ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/262/events/2618",
    "startDate": "2021-07-04T00:13:09+00:00",
    "endDate": "2021-07-04T01:01:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/196bcf4c-91fb-4aef-97f4-77f578802b8f
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/262/events/2618"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 853.533622ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/196bcf4c-91fb-4aef-97f4-77f578802b8f",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:56:48+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/196bcf4c-91fb-4aef-97f4-77f578802b8f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Glen74@yahoo.com",
    "telephone": "1-729-649-7822",
    "givenName": "Nienow",
    "familyName": "Brendon",
    "identifier": "946eb12a-fc56-4a13-9fcc-185df1795406"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1033.134365ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:56:49+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/196bcf4c-91fb-4aef-97f4-77f578802b8f
...
---
Response status code: 400 Bad Request. Responded in 68.858949ms.
```json
{
  "@context": "https://openactive.io/",
