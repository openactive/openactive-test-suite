[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:45:00 GMT+0000 (Coordinated Universal Time)
...
⚠️ 20 passed with 0 failures, 497 warnings and 132 suggestions 
...
---
Response status code: 200 OK. Responded in 221.095504ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1457/events/14568"
}
```
...
---
Response status code: 200 OK. Responded in 222.141503ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1511/events/15108"
}
```
...
---
Response status code: 200 OK. Responded in 224.050885ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1218/facility-use-slots/12180"
}
```
...
---
Response status code: 200 OK. Responded in 214.834009ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1537/facility-use-slots/15363"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1457%2Fevents%2F14568?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 141.477441ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1457/events/14568",
    "startDate": "2021-07-10T15:45:09+00:00",
    "endDate": "2021-07-10T18:41:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1457",
      "name": "Cotton Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1457#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT5H4M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1511%2Fevents%2F15108?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 141.124307ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1511/events/15108",
    "startDate": "2021-07-07T11:45:09+00:00",
    "endDate": "2021-07-07T17:18:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1511",
      "name": "Granite Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1511#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
          "price": 15.05,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT5H58M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1218%2Ffacility-use-slots%2F12180?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 141.834874ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1218/facility-use-slots/12180#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 5,
    "startDate": "2021-07-01T23:32:10+00:00",
    "endDate": "2021-07-02T02:33:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1537%2Ffacility-use-slots%2F15363?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 141.931584ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1537",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1537/facility-use-slots/15363#/offers/0",
        ...
        "price": 16.86,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT11H26M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-06T11:31:10+00:00",
    "endDate": "2021-07-06T16:57:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/75436a3d-99c8-4f94-9115-b61bfb1e4d55
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1457#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1457/events/14568"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1511#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1511/events/15108"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1218/facility-use-slots/12180#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1218/facility-use-slots/12180"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1537/facility-use-slots/15363#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1537/facility-use-slots/15363"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 937.399009ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/75436a3d-99c8-4f94-9115-b61bfb1e4d55",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:35+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1457"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1511"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1537"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-06T11:31:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/75436a3d-99c8-4f94-9115-b61bfb1e4d55
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jules.Hahn83@hotmail.com",
    "telephone": "887-366-4813",
    "givenName": "Quigley",
    "familyName": "Arvel",
    "identifier": "a6abede3-dac6-4217-a45a-40e39560d098"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 778.193192ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:50:36+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/75436a3d-99c8-4f94-9115-b61bfb1e4d55
...
---
Response status code: 201 Created. Responded in 920.924845ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/75436a3d-99c8-4f94-9115-b61bfb1e4d55",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/75436a3d-99c8-4f94-9115-b61bfb1e4d55#/orderedItems/1684",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1457#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/75436a3d-99c8-4f94-9115-b61bfb1e4d55#/orderedItems/1685",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1457#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/75436a3d-99c8-4f94-9115-b61bfb1e4d55#/orderedItems/1686",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1511#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/75436a3d-99c8-4f94-9115-b61bfb1e4d55#/orderedItems/1687",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1218/facility-use-slots/12180#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/75436a3d-99c8-4f94-9115-b61bfb1e4d55#/orderedItems/1688",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1218/facility-use-slots/12180#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/75436a3d-99c8-4f94-9115-b61bfb1e4d55#/orderedItems/1689",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1537/facility-use-slots/15363#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/75436a3d-99c8-4f94-9115-b61bfb1e4d55/versions/c4448528-fb67-4b6b-8186-05705f9255f4",
  "payment": {
    "@type": "Payment",
    "identifier": "ymi9sl_ar",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;75436a3d-99c8-4f94-9115-b61bfb1e4d55&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/75436a3d-99c8-4f94-9115-b61bfb1e4d55


---
Response status code: 200 OK. Responded in 213.856006ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619348580103&afterId=a90bf237-648f-4c43-a953-de0ce5f8b3eb",
  "message": "Listening for UUID: '75436a3d-99c8-4f94-9115-b61bfb1e4d55' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 62.955978ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;75436a3d-99c8-4f94-9115-b61bfb1e4d55&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/75436a3d-99c8-4f94-9115-b61bfb1e4d55


---
Response status code: 200 OK. Responded in 2960.909744ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "75436a3d-99c8-4f94-9115-b61bfb1e4d55",
  "modified": 637607619403481200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/75436a3d-99c8-4f94-9115-b61bfb1e4d55",
    "identifier": "75436a3d-99c8-4f94-9115-b61bfb1e4d55",
...
---
Response status code: 200 OK. Responded in 126.451189ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/75436a3d-99c8-4f94-9115-b61bfb1e4d55
...
---
Response status code: 201 Created. Responded in 2128.3618930000002ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/75436a3d-99c8-4f94-9115-b61bfb1e4d55",
  "identifier": "75436a3d-99c8-4f94-9115-b61bfb1e4d55",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 41.756759ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "75436a3d-99c8-4f94-9115-b61bfb1e4d55",
  "modified": 637607619436544400
}
```
### Specs
* ✅ should return 200 on success
...
### U Request
PATCH https://localhost:5001/api/openbooking/orders/75436a3d-99c8-4f94-9115-b61bfb1e4d55
...
```json
{
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/75436a3d-99c8-4f94-9115-b61bfb1e4d55#/orderedItems/1684-0-",
...
---
Response status code: 500 Internal Server Error. Responded in 32.059839ms.
```json
{
  "@context": "https://openactive.io/",
...
```
### Specs
* ✅ should return a response containing `"@type": "OrderItemIdInvalidError"` with status code `500`
