...
⚠️ 21 passed with 0 failures, 415 warnings and 108 suggestions 
...
---
Response status code: 200 OK. Responded in 252.860131ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/388/events/3874"
}
```
...
---
Response status code: 200 OK. Responded in 251.772328ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/361/events/3602"
}
```
...
---
Response status code: 200 OK. Responded in 250.834139ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/362/facility-use-slots/3618"
}
```
...
---
Response status code: 200 OK. Responded in 254.42478ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3914"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F388%2Fevents%2F3874?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 405.041895ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/388/events/3874",
    "startDate": "2021-07-02T07:58:09+00:00",
    "endDate": "2021-07-02T10:49:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/388",
      "name": "Wooden Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/388#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT13H13M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F361%2Fevents%2F3602?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 404.88048ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/361/events/3602",
    "startDate": "2021-07-05T23:08:09+00:00",
    "endDate": "2021-07-06T04:54:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/361",
      "name": "Fresh Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/361#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingPrepayment": "https://openactive.io/Optional",
          "price": 2.11,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT6H1M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F362%2Ffacility-use-slots%2F3618?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 408.270802ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/362",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/362/facility-use-slots/3618#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT6H30M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-05T04:44:10+00:00",
    "endDate": "2021-07-05T08:19:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F392%2Ffacility-use-slots%2F3914?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 410.308595ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3914#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT12H11M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-02T13:53:10+00:00",
    "endDate": "2021-07-02T17:53:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/007deb75-95b2-4fb5-bc28-0d8745d1dd62
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/388#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/388/events/3874"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/361#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/361/events/3602"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/362/facility-use-slots/3618#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/362/facility-use-slots/3618"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3914#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3914"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 248.066592ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/007deb75-95b2-4fb5-bc28-0d8745d1dd62",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:44:27+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/388"
        },
        "maximumAttendeeCapacity": 5,
        "remainingAttendeeCapacity": 5
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/361"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/392"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-02T13:53:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/007deb75-95b2-4fb5-bc28-0d8745d1dd62
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jannie41@yahoo.com",
    "telephone": "488-679-4566",
    "givenName": "Schneider",
    "familyName": "Robin",
    "identifier": "16a89afd-0602-44dd-9cfe-1a3dfd872407"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 418.958445ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:44:28+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/007deb75-95b2-4fb5-bc28-0d8745d1dd62
...
---
Response status code: 201 Created. Responded in 328.247817ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/007deb75-95b2-4fb5-bc28-0d8745d1dd62",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/007deb75-95b2-4fb5-bc28-0d8745d1dd62#/orderedItems/467",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/388#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/007deb75-95b2-4fb5-bc28-0d8745d1dd62#/orderedItems/468",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/388#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/007deb75-95b2-4fb5-bc28-0d8745d1dd62#/orderedItems/469",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/361#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/007deb75-95b2-4fb5-bc28-0d8745d1dd62#/orderedItems/470",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/362/facility-use-slots/3618#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/007deb75-95b2-4fb5-bc28-0d8745d1dd62#/orderedItems/471",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/362/facility-use-slots/3618#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/007deb75-95b2-4fb5-bc28-0d8745d1dd62#/orderedItems/472",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/392/facility-use-slots/3914#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Orders (orders) Feed listen for &#x27;007deb75-95b2-4fb5-bc28-0d8745d1dd62&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/007deb75-95b2-4fb5-bc28-0d8745d1dd62


---
Response status code: 200 OK. Responded in 393.598133ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607615664298554&afterId=b6d869bb-4a64-4735-ac6f-e74cc0330ef8",
  "message": "Listening for UUID: '007deb75-95b2-4fb5-bc28-0d8745d1dd62' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 128.008574ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation)

### Orders (orders) Feed collect for &#x27;007deb75-95b2-4fb5-bc28-0d8745d1dd62&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/007deb75-95b2-4fb5-bc28-0d8745d1dd62


---
Response status code: 200 OK. Responded in 3437.998541ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "007deb75-95b2-4fb5-bc28-0d8745d1dd62",
  "modified": 637607615733448600,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/007deb75-95b2-4fb5-bc28-0d8745d1dd62",
    "identifier": "007deb75-95b2-4fb5-bc28-0d8745d1dd62",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/007deb75-95b2-4fb5-bc28-0d8745d1dd62#/orderedItems/470",
...
---
Response status code: 200 OK. Responded in 273.054865ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607615733448534&afterId=007deb75-95b2-4fb5-bc28-0d8745d1dd62",
  "message": "Listening for UUID: '007deb75-95b2-4fb5-bc28-0d8745d1dd62' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```

### delete-order Request
DELETE https://localhost:5001/api/openbooking/orders/007deb75-95b2-4fb5-bc28-0d8745d1dd62
...
---
Response status code: 204 No Content. Responded in 174.836325ms.
### Specs
* ✅ should return 204 on success
...
---
Response status code: 200 OK. Responded in 2562.461136ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "007deb75-95b2-4fb5-bc28-0d8745d1dd62",
  "modified": 637607615804024400
}
```
### Specs
* ✅ should return 200 on success
