...
⚠️ 9 passed with 0 failures, 29 warnings and 10 suggestions 
...
---
Response status code: 200 OK. Responded in 319.915311ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1557/events/15566"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1557%2Fevents%2F15566?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 279.477668ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1557/events/15566",
    "startDate": "2021-07-11T15:55:09+00:00",
    "endDate": "2021-07-11T17:51:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b4fff7e9-8cd1-40e2-a1a5-cd51e4c26e8d
...
---
Response status code: 409 Conflict. Responded in 40.445145ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b4fff7e9-8cd1-40e2-a1a5-cd51e4c26e8d",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b4fff7e9-8cd1-40e2-a1a5-cd51e4c26e8d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Quinten4@yahoo.com",
    "telephone": "1-825-566-3128",
    "givenName": "Flatley",
    "familyName": "Verda",
    "identifier": "4ac16596-542f-4036-a92d-cca28517d367"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 23.801363ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/b4fff7e9-8cd1-40e2-a1a5-cd51e4c26e8d
...
---
Response status code: 409 Conflict. Responded in 17.175533ms.
```json
{
  "@context": "https://openactive.io/",
