...
---
Response status code: 200 OK. Responded in 264.158319ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1642/facility-use-slots/16419"
}
```
...
---
Response status code: 200 OK. Responded in 263.924597ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1245/facility-use-slots/12444"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1642%2Ffacility-use-slots%2F16419?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 402.941816ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1642/facility-use-slots/16419#/offers/0",
        ...
        "price": 14.68,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT13H3M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-03T08:17:10+00:00",
    "endDate": "2021-07-03T09:30:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 1 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1245%2Ffacility-use-slots%2F12444?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 405.003212ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1245",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1245/facility-use-slots/12444#/offers/0",
    ...
    "remainingUses": 7,
    "startDate": "2021-07-01T21:58:10+00:00",
    "endDate": "2021-07-02T01:57:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/e89a5332-3295-4992-9f8f-f12867e62d37
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1642/facility-use-slots/16419#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1642/facility-use-slots/16419"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1245/facility-use-slots/12444#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1245/facility-use-slots/12444"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 76.834006ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/e89a5332-3295-4992-9f8f-f12867e62d37",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1245"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-01T21:58:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/e89a5332-3295-4992-9f8f-f12867e62d37
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lucy.Macejkovic98@hotmail.com",
    "telephone": "241-271-0955 x028",
    "givenName": "Schroeder",
    "familyName": "Norwood",
    "identifier": "b5084226-084d-4f52-8277-58151c0a67dd"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 72.410686ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/e89a5332-3295-4992-9f8f-f12867e62d37
...
---
Response status code: 409 Conflict. Responded in 57.072727ms.
```json
{
  "@context": "https://openactive.io/",
