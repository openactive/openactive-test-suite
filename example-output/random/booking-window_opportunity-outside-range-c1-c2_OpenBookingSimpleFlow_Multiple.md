[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:42:14 GMT+0000 (Coordinated Universal Time)
...
⚠️ 28 passed with 0 failures, 295 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 479.797311ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/733/events/7322"
}
```
...
---
Response status code: 200 OK. Responded in 479.747906ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/74/events/735"
}
```
...
---
Response status code: 200 OK. Responded in 480.327862ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/843/facility-use-slots/8422"
}
```
...
---
Response status code: 200 OK. Responded in 476.924338ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/471/facility-use-slots/4710"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F733%2Fevents%2F7322?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 252.603213ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/733/events/7322",
    "startDate": "2021-07-06T20:08:09+00:00",
    "endDate": "2021-07-07T00:11:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/733",
      "name": "Cotton Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/733#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P3DT10H42M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F74%2Fevents%2F735?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 257.93842ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/74/events/735",
    "startDate": "2021-07-02T00:09:09+00:00",
    "endDate": "2021-07-02T05:22:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/74",
      "name": "Metal Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/74#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F843%2Ffacility-use-slots%2F8422?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 258.56358ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/843",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/843/facility-use-slots/8422#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT6H32M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-07T10:59:10+00:00",
    "endDate": "2021-07-07T14:07:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F471%2Ffacility-use-slots%2F4710?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 259.348555ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/471",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/471/facility-use-slots/4710#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 19.8,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT21H45M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-03T00:25:10+00:00",
    "endDate": "2021-07-03T05:10:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/808c73be-34f4-4b77-949e-cb0e0267158d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/733#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/733/events/7322"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/74#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/74/events/735"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/843/facility-use-slots/8422#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/843/facility-use-slots/8422"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/471/facility-use-slots/4710#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/471/facility-use-slots/4710"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 252.617214ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/808c73be-34f4-4b77-949e-cb0e0267158d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:22+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/733"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/843"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-07T10:59:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/471"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-03T00:25:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/808c73be-34f4-4b77-949e-cb0e0267158d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bernard_Macejkovic53@gmail.com",
    "telephone": "(590) 574-8209",
    "givenName": "Hoeger",
    "familyName": "Kristin",
    "identifier": "da758d82-16d5-4bf6-90df-2f3a49554f13"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 384.673445ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:23+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
