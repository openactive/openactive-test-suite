[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:37:10 GMT+0000 (Coordinated Universal Time)

# amending-order-quote >> amend-c2 (OpenBookingSimpleFlow >> Multiple)
...
**Test:**  Amend, at C2, an existing OrderQuote

Run C1,C2 with X opportunities, then - with the same Order UUID - run C2 with Y opportunities and different customer details, then runs B. The resulting Order should include confirmed bookings for only Y opportunities

### Running only this test

```bash
npm start -- --runInBand test/features/core/amending-order-quote/implemented/amend-c2-test.js
```

---

⚠️ 44 passed with 0 failures, 575 warnings and 156 suggestions 
...
---
Response status code: 200 OK. Responded in 371.335636ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/814/events/8139"
}
```
...
---
Response status code: 200 OK. Responded in 371.934293ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2743"
}
```
...
---
Response status code: 200 OK. Responded in 372.496146ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/175/facility-use-slots/1749"
}
```
...
---
Response status code: 200 OK. Responded in 373.637154ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/617/facility-use-slots/6170"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F814%2Fevents%2F8139?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 316.297229ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/814/events/8139",
    "startDate": "2021-07-02T09:53:09+00:00",
    "endDate": "2021-07-02T11:26:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/814",
      "name": "Fresh Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/814#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P2DT12H53M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F275%2Fevents%2F2743?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 317.032298ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2743",
    "startDate": "2021-07-09T07:20:09+00:00",
    "endDate": "2021-07-09T13:02:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/275",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/275#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F175%2Ffacility-use-slots%2F1749?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 317.58325ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/175",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/175/facility-use-slots/1749#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 0,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 7,
    "startDate": "2021-07-07T22:45:10+00:00",
    "endDate": "2021-07-07T23:49:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F617%2Ffacility-use-slots%2F6170?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 318.252014ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/617",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/617/facility-use-slots/6170#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT6H30M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-07T00:05:10+00:00",
    "endDate": "2021-07-07T02:03:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/159a06a9-fe84-43c2-8595-90a04a9b8a35
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/814#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/814/events/8139"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/275#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2743"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/175/facility-use-slots/1749#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/175/facility-use-slots/1749"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/617/facility-use-slots/6170#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/617/facility-use-slots/6170"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 284.510621ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/159a06a9-fe84-43c2-8595-90a04a9b8a35",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:42:23+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/814"
        },
        "maximumAttendeeCapacity": 9,
        "remainingAttendeeCapacity": 9
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/275"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/175"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-07T22:45:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/159a06a9-fe84-43c2-8595-90a04a9b8a35
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Samir_Gusikowski@hotmail.com",
    "telephone": "921.674.4838 x34307",
    "givenName": "Parker",
    "familyName": "Erin",
    "identifier": "c567d783-5b27-4c19-93a2-5fc37bf3f36e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 325.940641ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:42:24+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
---
Response status code: 200 OK. Responded in 651.209019ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/445/events/4444"
}
```
...
---
Response status code: 200 OK. Responded in 592.787491ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/109/events/1085"
}
```
...
---
Response status code: 200 OK. Responded in 569.931628ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/594/facility-use-slots/5932"
}
```
...
---
Response status code: 200 OK. Responded in 560.65175ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5073"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F445%2Fevents%2F4444?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 454.047825ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/445/events/4444",
    "startDate": "2021-07-06T23:34:09+00:00",
    "endDate": "2021-07-07T00:10:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/445",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/445#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "price": 11.48,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT18H33M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F109%2Fevents%2F1085?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 455.158131ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/109/events/1085",
    "startDate": "2021-07-02T14:32:09+00:00",
    "endDate": "2021-07-02T17:21:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/109",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/109#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F594%2Ffacility-use-slots%2F5932?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 455.931605ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/594",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/594/facility-use-slots/5932#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "price": 0,
        "priceCurrency": "GBP",
    ...
    "remainingUses": 4,
    "startDate": "2021-07-02T19:34:10+00:00",
    "endDate": "2021-07-02T20:14:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F508%2Ffacility-use-slots%2F5073?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 456.670375ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5073#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 2.42,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT4H37M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-04T15:07:10+00:00",
    "endDate": "2021-07-04T18:12:10+00:00"
  }
}
```
### Specs
...
## Second Attempt - C2 -> B >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 1
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Second Attempt - C2 -> B >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 2
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Second Attempt - C2 -> B >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 3
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Second Attempt - C2 -> B >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 4
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
## Second Attempt - C2 -> B >> Fetch Opportunities >> validation of Opportunity Feed extract for OrderItem 5
### Specs
* ✅ passes validation checks
* ✅ matches the criteria 'TestOpportunityBookable' required for this test
...
```json
{
  ...
  "customer": {
    ...
    "telephone": "(293) 261-6071",
    "givenName": "Romaguera",
    "familyName": "Loy",
    "identifier": "ac3b468c-a484-4d2b-9125-9826a0cd5353"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/445#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/445/events/4444"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/109#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/109/events/1085"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/594/facility-use-slots/5932#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/594/facility-use-slots/5932"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5073#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5073"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 342.112686ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:42:29+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/109"
        },
        "maximumAttendeeCapacity": 25,
        "remainingAttendeeCapacity": 25
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/594"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-02T19:34:10+00:00",
...
* ✅ should include expected email address
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/159a06a9-fe84-43c2-8595-90a04a9b8a35
...
---
Response status code: 201 Created. Responded in 164.305002ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/159a06a9-fe84-43c2-8595-90a04a9b8a35",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/159a06a9-fe84-43c2-8595-90a04a9b8a35#/orderedItems/75",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/445#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/159a06a9-fe84-43c2-8595-90a04a9b8a35#/orderedItems/76",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/445#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/159a06a9-fe84-43c2-8595-90a04a9b8a35#/orderedItems/77",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/109#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/159a06a9-fe84-43c2-8595-90a04a9b8a35#/orderedItems/78",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/594/facility-use-slots/5932#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/159a06a9-fe84-43c2-8595-90a04a9b8a35#/orderedItems/79",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/594/facility-use-slots/5932#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/159a06a9-fe84-43c2-8595-90a04a9b8a35#/orderedItems/80",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/508/facility-use-slots/5073#/offers/0",
        "allowCustomerCancellationFullRefund": true,
