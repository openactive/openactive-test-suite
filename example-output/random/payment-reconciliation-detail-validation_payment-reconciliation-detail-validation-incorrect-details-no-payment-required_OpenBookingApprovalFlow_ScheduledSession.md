...
# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-incorrect-details-no-payment-required (OpenBookingApprovalFlow >> ScheduledSession)
...
⚠️ 4 passed with 0 failures, 32 warnings and 10 suggestions 
...
---
Response status code: 200 OK. Responded in 14.38087ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1447/events/14461"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1447%2Fevents%2F14461?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 4.300309ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1447/events/14461",
    "startDate": "2021-07-03T15:36:09+00:00",
    "endDate": "2021-07-03T16:59:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1447",
      "name": "Cotton Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1447#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT6H55M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/70ba8960-e2fe-4e44-8ebe-99e4250973df
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1447#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1447/events/14461"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-q07zfNB8ZJ",
    "accountId": "invalid-vPPSGVMEr",
    "paymentProviderId": "invalid-oKyGGcV6TS"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 95.689215ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/70ba8960-e2fe-4e44-8ebe-99e4250973df
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Charlie.Bruen@hotmail.com",
    "telephone": "1-954-282-1887 x3348",
    "givenName": "Greenfelder",
    "familyName": "Yasmeen",
    "identifier": "c927778c-c539-45de-b963-f09748152918"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-umsIT7R7l5",
    "accountId": "invalid-6RUszPEKdM",
    "paymentProviderId": "invalid-GBGUP-ooJh"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 56.702401ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
