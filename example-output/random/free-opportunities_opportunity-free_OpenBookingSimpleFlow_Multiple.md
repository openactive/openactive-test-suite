...
# free-opportunities >> opportunity-free (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 10 passed with 0 failures, 140 warnings and 36 suggestions 
...
---
Response status code: 200 OK. Responded in 94.520156ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/40/events/394"
}
```
...
---
Response status code: 200 OK. Responded in 99.094495ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/744/facility-use-slots/7435"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F40%2Fevents%2F394?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 56.590822ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/40/events/394",
    "startDate": "2021-07-07T13:21:09+00:00",
    "endDate": "2021-07-07T16:33:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F744%2Ffacility-use-slots%2F7435?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 60.052554ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/744/facility-use-slots/7435#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P2DT5H14M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-03T07:33:10+00:00",
    "endDate": "2021-07-03T09:04:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9ddc5632-b8e5-4c60-abb1-0f33a0b4a030
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/40/events/394"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/744/facility-use-slots/7435#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/744/facility-use-slots/7435"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 4046.795115ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9ddc5632-b8e5-4c60-abb1-0f33a0b4a030",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9ddc5632-b8e5-4c60-abb1-0f33a0b4a030
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Scarlett31@yahoo.com",
    "telephone": "491-555-2131 x5466",
    "givenName": "Konopelski",
    "familyName": "Ibrahim",
    "identifier": "2c5406fb-54d4-4526-83ea-985244901a69"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 3247.003449ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9ddc5632-b8e5-4c60-abb1-0f33a0b4a030
...
---
Response status code: 201 Created. Responded in 5478.64973ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9ddc5632-b8e5-4c60-abb1-0f33a0b4a030",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9ddc5632-b8e5-4c60-abb1-0f33a0b4a030#/orderedItems/2821",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/40#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9ddc5632-b8e5-4c60-abb1-0f33a0b4a030#/orderedItems/2822",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/744/facility-use-slots/7435#/offers/0",
        "allowCustomerCancellationFullRefund": true,
