...
# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation-incorrect-details (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 14 passed with 0 failures, 113 warnings and 30 suggestions 
...
---
Response status code: 200 OK. Responded in 43.272116ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1293/events/12929"
}
```
...
---
Response status code: 200 OK. Responded in 42.016297ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1004/events/10037"
}
```
...
---
Response status code: 200 OK. Responded in 40.865688ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1488/facility-use-slots/14872"
}
```
...
---
Response status code: 200 OK. Responded in 42.946786ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1208/facility-use-slots/12080"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1293%2Fevents%2F12929?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 32.69281ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1293/events/12929",
    "startDate": "2021-07-02T07:59:09+00:00",
    "endDate": "2021-07-02T09:43:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1293",
      "name": "Soft Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1293#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1004%2Fevents%2F10037?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 31.968241ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1004/events/10037",
    "startDate": "2021-07-10T03:33:09+00:00",
    "endDate": "2021-07-10T07:40:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1488%2Ffacility-use-slots%2F14872?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 31.304978ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1488",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1488/facility-use-slots/14872#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 1.58,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT8H31M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-04T04:08:10+00:00",
    "endDate": "2021-07-04T04:39:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1208%2Ffacility-use-slots%2F12080?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 30.805131ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1208",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1208/facility-use-slots/12080#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
    ...
    "remainingUses": 7,
    "startDate": "2021-07-09T07:01:10+00:00",
    "endDate": "2021-07-09T12:09:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/09e1b329-a481-40c0-a770-f79349982c17
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1293#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1293/events/12929"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1004/events/10037"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1488/facility-use-slots/14872#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1488/facility-use-slots/14872"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1208/facility-use-slots/12080#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1208/facility-use-slots/12080"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-C1E6fS-yfU",
    "accountId": "invalid-qE7wCZcIi",
    "paymentProviderId": "invalid-vs8LbtEASj"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 1102.195149ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/09e1b329-a481-40c0-a770-f79349982c17
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Fern_Corkery37@hotmail.com",
    "telephone": "(395) 472-1945 x06221",
    "givenName": "Welch",
    "familyName": "Pamela",
    "identifier": "72b69f1a-2f97-4817-a6f5-26d6a880d133"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-8nFsX3-4ip",
    "accountId": "invalid-0OEuvvdtF",
    "paymentProviderId": "invalid-7W2YlcqWbE"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 303.397061ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
