[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:55:16 GMT+0000 (Coordinated Universal Time)

# payment-reconciliation-detail-validation >> payment-reconciliation-detail-validation (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 19 passed with 0 failures, 380 warnings and 104 suggestions 
...
---
Response status code: 200 OK. Responded in 20.023712ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/26/events/254"
}
```
...
---
Response status code: 200 OK. Responded in 27.164794ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/46/events/451"
}
```
...
---
Response status code: 200 OK. Responded in 19.68498ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/5/facility-use-slots/43"
}
```
...
---
Response status code: 200 OK. Responded in 26.307712ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/297/facility-use-slots/2969"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F26%2Fevents%2F254?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.151165ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/26/events/254",
    "startDate": "2021-07-08T11:42:09+00:00",
    "endDate": "2021-07-08T15:37:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/26",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/26#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F46%2Fevents%2F451?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.996345ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/46/events/451",
    "startDate": "2021-07-10T09:23:09+00:00",
    "endDate": "2021-07-10T12:18:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/46",
      "name": "Cotton Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/46#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F5%2Ffacility-use-slots%2F43?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.62301ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/5",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/5/facility-use-slots/43#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0.9,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 5,
    "startDate": "2021-07-07T02:24:09+00:00",
    "endDate": "2021-07-07T06:49:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F297%2Ffacility-use-slots%2F2969?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 11.254975ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/297",
      "name": "Plastic Swimming Pool Hall",
      "activity": [
        {
          "@type": "Concept",
          "@id": "https://openactive.io/activity-list#c07d63a0-8eb9-4602-8bcc-23be6deb8f83",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/297/facility-use-slots/2969#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 8,
    "startDate": "2021-07-10T02:04:10+00:00",
    "endDate": "2021-07-10T06:08:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b4c0cd8e-7c7a-4d25-988c-71e2c86aeb5d
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/26#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/26/events/254"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/46#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/46/events/451"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/5/facility-use-slots/43#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/5/facility-use-slots/43"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/297/facility-use-slots/2969#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/297/facility-use-slots/2969"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1575.9967000000001ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b4c0cd8e-7c7a-4d25-988c-71e2c86aeb5d",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:00:29+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/46"
        },
        "maximumAttendeeCapacity": 28,
        "remainingAttendeeCapacity": 28
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/297"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-10T02:04:10+00:00",
...
* ✅ should return correct reconciliation details
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b4c0cd8e-7c7a-4d25-988c-71e2c86aeb5d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Perry50@gmail.com",
    "telephone": "1-609-533-0647 x6809",
    "givenName": "Senger",
    "familyName": "Ernestina",
    "identifier": "61d38c86-e8ff-45c1-a3d4-3a5cee5e24bb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 3201.00838ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T19:00:33+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b4c0cd8e-7c7a-4d25-988c-71e2c86aeb5d
...
---
Response status code: 201 Created. Responded in 4038.567464ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b4c0cd8e-7c7a-4d25-988c-71e2c86aeb5d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b4c0cd8e-7c7a-4d25-988c-71e2c86aeb5d#/orderedItems/3251",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/26#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b4c0cd8e-7c7a-4d25-988c-71e2c86aeb5d#/orderedItems/3252",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/26#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b4c0cd8e-7c7a-4d25-988c-71e2c86aeb5d#/orderedItems/3253",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/46#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b4c0cd8e-7c7a-4d25-988c-71e2c86aeb5d#/orderedItems/3254",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/5/facility-use-slots/43#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b4c0cd8e-7c7a-4d25-988c-71e2c86aeb5d#/orderedItems/3255",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/5/facility-use-slots/43#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b4c0cd8e-7c7a-4d25-988c-71e2c86aeb5d#/orderedItems/3256",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/297/facility-use-slots/2969#/offers/0",
        "allowCustomerCancellationFullRefund": true,
