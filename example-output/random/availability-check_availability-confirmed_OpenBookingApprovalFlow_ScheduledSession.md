...
# availability-check >> availability-confirmed (OpenBookingApprovalFlow >> ScheduledSession)
...
---
Response status code: 200 OK. Responded in 181.636956ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1493/events/14928"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1493%2Fevents%2F14928?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 296.742591ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1493/events/14928",
    "startDate": "2021-07-08T08:09:09+00:00",
    "endDate": "2021-07-08T09:58:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 2.52,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT6H55M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/81bd62bc-6389-471e-b67b-f6abb9996e81
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1493/events/14928"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 248.676325ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/81bd62bc-6389-471e-b67b-f6abb9996e81",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/81bd62bc-6389-471e-b67b-f6abb9996e81
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Fletcher_Monahan@yahoo.com",
    "telephone": "1-656-802-6074 x23558",
    "givenName": "Davis",
    "familyName": "Milan",
    "identifier": "0d5a7e4f-2b24-4767-96f0-8561fb0b048a"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 143.840966ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
