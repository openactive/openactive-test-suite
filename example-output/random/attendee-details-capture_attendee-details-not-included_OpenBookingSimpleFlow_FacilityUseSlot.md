...
# attendee-details-capture >> attendee-details-not-included (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 407.87358ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/271/facility-use-slots/2706"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F271%2Ffacility-use-slots%2F2706?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 358.838718ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/271",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/271/facility-use-slots/2706#/offers/0",
    ...
    "remainingUses": 6,
    "startDate": "2021-07-08T00:23:10+00:00",
    "endDate": "2021-07-08T04:21:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/00a25afe-5a5d-40a8-8bf9-f68b6611b32a
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/271/facility-use-slots/2706#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/271/facility-use-slots/2706"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 180.887299ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/00a25afe-5a5d-40a8-8bf9-f68b6611b32a",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/271"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-08T00:23:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/00a25afe-5a5d-40a8-8bf9-f68b6611b32a
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Riley.Schroeder71@yahoo.com",
    "telephone": "1-404-482-5918",
    "givenName": "Stracke",
    "familyName": "Evie",
    "identifier": "31827d46-0f7d-4928-b55c-95d746a2c474"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 512.462124ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:42+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/00a25afe-5a5d-40a8-8bf9-f68b6611b32a
...
---
Response status code: 409 Conflict. Responded in 102.23052ms.
```json
{
  "@context": "https://openactive.io/",
