...
# common-error-conditions >> incomplete-order-item-no-opportunity (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 29 passed with 0 failures, 118 warnings and 30 suggestions 
...
---
Response status code: 200 OK. Responded in 330.681135ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/379/events/3785"
}
```
...
---
Response status code: 200 OK. Responded in 333.446998ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/768"
}
```
...
---
Response status code: 200 OK. Responded in 341.442158ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/23/facility-use-slots/229"
}
```
...
---
Response status code: 200 OK. Responded in 343.921494ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/411/facility-use-slots/4101"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F379%2Fevents%2F3785?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 376.136157ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/379/events/3785",
    "startDate": "2021-07-10T01:54:09+00:00",
    "endDate": "2021-07-10T02:48:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/379",
      "name": "Cotton Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/379#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P11DT13H5M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F77%2Fevents%2F768?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 381.21884ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/768",
    "startDate": "2021-07-02T13:59:09+00:00",
    "endDate": "2021-07-02T17:22:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/77",
      "name": "Steel Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/77#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "price": 0,
          "priceCurrency": "GBP"
        }
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F23%2Ffacility-use-slots%2F229?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 381.697085ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/23",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/23/facility-use-slots/229#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 4,
    "startDate": "2021-07-06T19:01:09+00:00",
    "endDate": "2021-07-06T19:46:09+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F411%2Ffacility-use-slots%2F4101?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 381.916306ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/411",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/411/facility-use-slots/4101#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 13.28,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT13H20M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-02T10:45:10+00:00",
    "endDate": "2021-07-02T14:07:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c2cef411-e136-4b62-b6ac-c602a10e7d26
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/379#/offers/0"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/77#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/77/events/768"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/23/facility-use-slots/229#/offers/0"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/411/facility-use-slots/4101#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/411/facility-use-slots/4101"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 235.488186ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c2cef411-e136-4b62-b6ac-c602a10e7d26",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/77"
        },
        "maximumAttendeeCapacity": 25,
        "remainingAttendeeCapacity": 25
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/411"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-02T10:45:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c2cef411-e136-4b62-b6ac-c602a10e7d26
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cordell_Hane@gmail.com",
    "telephone": "554.806.5411 x4014",
    "givenName": "Schumm",
    "familyName": "Marvin",
    "identifier": "569fa7e0-731e-471b-af38-f2dab4d63959"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 229.475114ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c2cef411-e136-4b62-b6ac-c602a10e7d26
...
---
Response status code: 409 Conflict. Responded in 51.460592ms.
```json
{
  "@context": "https://openactive.io/",
