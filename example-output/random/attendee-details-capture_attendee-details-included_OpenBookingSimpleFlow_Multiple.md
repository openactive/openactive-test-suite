...
# attendee-details-capture >> attendee-details-included (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 15 passed with 0 failures, 380 warnings and 104 suggestions 
...
---
Response status code: 200 OK. Responded in 253.024542ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/83/events/826"
}
```
...
---
Response status code: 200 OK. Responded in 253.509188ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/122/events/1220"
}
```
...
---
Response status code: 200 OK. Responded in 241.838979ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/306/facility-use-slots/3052"
}
```
...
---
Response status code: 200 OK. Responded in 243.62925ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3609"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F83%2Fevents%2F826?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 193.879022ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/83/events/826",
    "startDate": "2021-07-02T18:32:09+00:00",
    "endDate": "2021-07-02T20:03:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F122%2Fevents%2F1220?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 192.615002ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/122/events/1220",
    "startDate": "2021-07-09T18:14:09+00:00",
    "endDate": "2021-07-09T23:03:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F306%2Ffacility-use-slots%2F3052?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 178.105524ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/306/facility-use-slots/3052#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingAttendeeDetails"
    ...
    "remainingUses": 5,
    "startDate": "2021-07-10T03:44:10+00:00",
    "endDate": "2021-07-10T07:07:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F361%2Ffacility-use-slots%2F3609?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 174.685898ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3609#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 1.83,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT23H54M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-06T21:58:10+00:00",
    "endDate": "2021-07-07T01:34:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/696fbc92-68b4-47cf-bb12-069d402ac6b3
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/83/events/826",
      "attendee": {
        "@type": "Person",
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/122/events/1220",
      "attendee": {
        "@type": "Person",
        "telephone": "07712345678",
        "givenName": "Fred",
    ...
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/306/facility-use-slots/3052#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/306/facility-use-slots/3052",
      "attendee": {
        "@type": "Person",
        "telephone": "07712345678",
        "givenName": "Fred",
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3609#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3609",
      "attendee": {
        "@type": "Person",
        "telephone": "07712345678",
        "givenName": "Fred",
...
---
Response status code: 200 OK. Responded in 1359.767133ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/696fbc92-68b4-47cf-bb12-069d402ac6b3",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/696fbc92-68b4-47cf-bb12-069d402ac6b3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Torrance_McCullough6@hotmail.com",
    "telephone": "1-808-511-6024 x79870",
    "givenName": "Bernier",
    "familyName": "Michale",
    "identifier": "b3c9d10a-7237-4490-ad67-1c9ab3ac639e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1535.556845ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:53+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/696fbc92-68b4-47cf-bb12-069d402ac6b3
...
---
Response status code: 201 Created. Responded in 1640.687944ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/696fbc92-68b4-47cf-bb12-069d402ac6b3",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/696fbc92-68b4-47cf-bb12-069d402ac6b3#/orderedItems/2421",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/83#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/696fbc92-68b4-47cf-bb12-069d402ac6b3#/orderedItems/2422",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/83#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/696fbc92-68b4-47cf-bb12-069d402ac6b3#/orderedItems/2423",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/122#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/696fbc92-68b4-47cf-bb12-069d402ac6b3#/orderedItems/2424",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/306/facility-use-slots/3052#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/696fbc92-68b4-47cf-bb12-069d402ac6b3#/orderedItems/2425",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/306/facility-use-slots/3052#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/696fbc92-68b4-47cf-bb12-069d402ac6b3#/orderedItems/2426",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/361/facility-use-slots/3609#/offers/0",
        "allowCustomerCancellationFullRefund": false,
