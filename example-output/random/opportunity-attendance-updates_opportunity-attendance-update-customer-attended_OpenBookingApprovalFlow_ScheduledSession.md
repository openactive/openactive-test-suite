[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:45:34 GMT+0000 (Coordinated Universal Time)

# opportunity-attendance-updates >> opportunity-attendance-update-customer-attended (OpenBookingApprovalFlow >> ScheduledSession)
...
⚠️ 12 passed with 0 failures, 102 warnings and 34 suggestions 
...
---
Response status code: 200 OK. Responded in 113.08312ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1285/events/12843"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1285%2Fevents%2F12843?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 67.426792ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1285/events/12843",
    "startDate": "2021-07-08T12:33:09+00:00",
    "endDate": "2021-07-08T16:41:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1285",
      "name": "Cotton Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1285#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1285#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1285/events/12843"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 233.424428ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:06+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ola.Metz62@gmail.com",
    "telephone": "589.950.2320 x8807",
    "givenName": "Yost",
    "familyName": "Armani",
    "identifier": "62366cb3-c664-4ea5-895f-f01e2ba5d57f"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 137.620878ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:51:07+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa
...
---
Response status code: 201 Created. Responded in 348.292596ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa#/orderedItems/1783",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1285#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa/versions/11500b42-f82d-4b4c-8a0c-f721995c11fe",
  "payment": {
    "@type": "Payment",
    "identifier": "14Ool7fYW",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa


---
Response status code: 200 OK. Responded in 230.923844ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607619603976781&afterId=37ad0186-ade1-4114-9267-e667d51fd1df",
  "message": "Listening for UUID: 'c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 121.860779ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa


---
Response status code: 200 OK. Responded in 2783.731224ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa",
  "modified": 637607619686142500,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa",
    "identifier": "c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa",
...
---
Response status code: 200 OK. Responded in 298.941007ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa
...
---
Response status code: 201 Created. Responded in 353.875627ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa",
  "identifier": "c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1113.129075ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa",
  "modified": 637607619720123100
}
```
### Specs
* ✅ should return 200 on success
...
### Orders (orders) Feed listen for &#x27;c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa


---
Response status code: 200 OK. Responded in 133.140552ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607619643919309&afterId=19c6745c-7813-4a9c-b310-ec7111bb54bf",
  "message": "Listening for UUID: 'c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 30.688716ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AttendeeAttendedSimulateAction)

### Orders (orders) Feed collect for &#x27;c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa


---
Response status code: 200 OK. Responded in 2569.001016ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "c8701c89-08fe-4d4e-9ee2-4a4bd68f14aa",
  "modified": 637607619742864400,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
