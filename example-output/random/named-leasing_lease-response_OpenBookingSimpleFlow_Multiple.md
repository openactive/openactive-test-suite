...
⚠️ 15 passed with 0 failures, 283 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 337.390118ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/68/events/675"
}
```
...
---
Response status code: 200 OK. Responded in 337.399319ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/335/events/3342"
}
```
...
---
Response status code: 200 OK. Responded in 332.768779ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/662/facility-use-slots/6619"
}
```
...
---
Response status code: 200 OK. Responded in 330.188335ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/577/facility-use-slots/5769"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F68%2Fevents%2F675?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 135.338043ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/68/events/675",
    "startDate": "2021-07-02T03:18:09+00:00",
    "endDate": "2021-07-02T09:15:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F335%2Fevents%2F3342?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 135.562665ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/335/events/3342",
    "startDate": "2021-07-03T23:06:09+00:00",
    "endDate": "2021-07-04T05:02:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F662%2Ffacility-use-slots%2F6619?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 135.686777ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/662",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/662/facility-use-slots/6619#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 15.94,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT11H51M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-06T07:33:10+00:00",
    "endDate": "2021-07-06T08:30:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F577%2Ffacility-use-slots%2F5769?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 135.905397ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/577",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/577/facility-use-slots/5769#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT19H29M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-04T21:57:10+00:00",
    "endDate": "2021-07-05T00:39:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/656283ba-e4bb-4e34-830b-95ccec527414
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/68/events/675"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/335/events/3342"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/662/facility-use-slots/6619#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/662/facility-use-slots/6619"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/577/facility-use-slots/5769#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/577/facility-use-slots/5769"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 852.56001ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/656283ba-e4bb-4e34-830b-95ccec527414",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/577"
        },
        "maximumUses": 5,
        "remainingUses": 5,
        "startDate": "2021-07-04T21:57:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/656283ba-e4bb-4e34-830b-95ccec527414
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Morton69@yahoo.com",
    "telephone": "(493) 536-1984 x547",
    "givenName": "Cronin",
    "familyName": "Candida",
    "identifier": "67039b30-a3f9-4cb4-9a0c-9ca909f069a1"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 603.301431ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
