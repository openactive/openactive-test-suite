...
# amending-order-quote >> c2-with-different-details (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 45 passed with 0 failures, 591 warnings and 156 suggestions 
...
---
Response status code: 200 OK. Responded in 385.900417ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1310/events/13094"
}
```
...
---
Response status code: 200 OK. Responded in 388.734186ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1516/events/15159"
}
```
...
---
Response status code: 200 OK. Responded in 393.026394ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1208/facility-use-slots/12078"
}
```
...
---
Response status code: 200 OK. Responded in 394.357521ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1317/facility-use-slots/13167"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1310%2Fevents%2F13094?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 369.890593ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1310/events/13094",
    "startDate": "2021-07-10T09:21:09+00:00",
    "endDate": "2021-07-10T14:20:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1516%2Fevents%2F15159?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 370.680868ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1516/events/15159",
    "startDate": "2021-07-08T16:41:09+00:00",
    "endDate": "2021-07-08T20:49:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1516",
      "name": "Granite Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1516#/offers/0",
          ...
          "price": 10.69,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT8H30M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1208%2Ffacility-use-slots%2F12078?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 371.193517ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1208/facility-use-slots/12078#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 6,
    "startDate": "2021-07-02T16:49:10+00:00",
    "endDate": "2021-07-02T20:27:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1317%2Ffacility-use-slots%2F13167?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 374.593441ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1317/facility-use-slots/13167#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 2,
    "startDate": "2021-07-02T13:51:10+00:00",
    "endDate": "2021-07-02T14:55:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a8b0d962-c7b9-4466-a1df-d8292185f495
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1310/events/13094"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1516#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1516/events/15159"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1208/facility-use-slots/12078#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1208/facility-use-slots/12078"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1317/facility-use-slots/13167#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1317/facility-use-slots/13167"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 241.958521ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a8b0d962-c7b9-4466-a1df-d8292185f495",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1516"
        },
        "maximumAttendeeCapacity": 11,
        "remainingAttendeeCapacity": 11
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1208"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-02T16:49:10+00:00",
...
---
Response status code: 200 OK. Responded in 647.579715ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12554"
}
```
...
---
Response status code: 200 OK. Responded in 648.493201ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1384/events/13831"
}
```
...
---
Response status code: 200 OK. Responded in 648.837634ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11837"
}
```
...
---
Response status code: 200 OK. Responded in 649.380385ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1264/facility-use-slots/12634"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1256%2Fevents%2F12554?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 414.079698ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12554",
    "startDate": "2021-07-06T12:58:09+00:00",
    "endDate": "2021-07-06T18:20:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1256",
      "name": "Metal Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1256#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1384%2Fevents%2F13831?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 414.758662ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1384/events/13831",
    "startDate": "2021-07-04T19:58:09+00:00",
    "endDate": "2021-07-04T21:15:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1384",
      "name": "Metal Walking",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1384#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval",
          ...
          "price": 5.12,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT4H42M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1184%2Ffacility-use-slots%2F11837?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 415.653047ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1184",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11837#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 4,
    "startDate": "2021-07-04T06:37:10+00:00",
    "endDate": "2021-07-04T11:13:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1264%2Ffacility-use-slots%2F12634?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 421.746427ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1264/facility-use-slots/12634#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 4,
    "startDate": "2021-07-10T06:01:10+00:00",
    "endDate": "2021-07-10T10:54:10+00:00"
  }
}
```
### Specs
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a8b0d962-c7b9-4466-a1df-d8292185f495
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Daphney68@yahoo.com",
    "telephone": "831-866-8249 x7244",
    "givenName": "Cremin",
    "familyName": "Jamarcus",
    "identifier": "31f1ecca-3687-42c2-abe2-cee66d9370e8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1256#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1256/events/12554"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1384#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1384/events/13831"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11837#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11837"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1264/facility-use-slots/12634#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1264/facility-use-slots/12634"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 356.501519ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1256"
        },
        "maximumAttendeeCapacity": 48,
        "remainingAttendeeCapacity": 48
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1384"
        },
        "maximumAttendeeCapacity": 30,
        "remainingAttendeeCapacity": 30
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1184"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-04T06:37:10+00:00",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/a8b0d962-c7b9-4466-a1df-d8292185f495
...
---
Response status code: 201 Created. Responded in 467.471665ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/a8b0d962-c7b9-4466-a1df-d8292185f495",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a8b0d962-c7b9-4466-a1df-d8292185f495#/orderedItems/377",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1256#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a8b0d962-c7b9-4466-a1df-d8292185f495#/orderedItems/378",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1256#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a8b0d962-c7b9-4466-a1df-d8292185f495#/orderedItems/379",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1384#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a8b0d962-c7b9-4466-a1df-d8292185f495#/orderedItems/380",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11837#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a8b0d962-c7b9-4466-a1df-d8292185f495#/orderedItems/381",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1184/facility-use-slots/11837#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/a8b0d962-c7b9-4466-a1df-d8292185f495#/orderedItems/382",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1264/facility-use-slots/12634#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/a8b0d962-c7b9-4466-a1df-d8292185f495/versions/83ac5a19-b79b-409b-8725-7aac5a47c7ab",
  "payment": {
    "@type": "Payment",
    "identifier": "PUDsOjwOn",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;a8b0d962-c7b9-4466-a1df-d8292185f495&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/a8b0d962-c7b9-4466-a1df-d8292185f495


---
Response status code: 200 OK. Responded in 119.096027ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607615248426289&afterId=05e47c67-39c3-4426-b73e-5a38621e0b6a",
  "message": "Listening for UUID: 'a8b0d962-c7b9-4466-a1df-d8292185f495' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 32.023846ms.
### Specs
* ✅ should return 204 on success

## Second Attempt - C2 -> B >> OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;a8b0d962-c7b9-4466-a1df-d8292185f495&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/a8b0d962-c7b9-4466-a1df-d8292185f495


---
Response status code: 200 OK. Responded in 2370.444659ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "a8b0d962-c7b9-4466-a1df-d8292185f495",
  "modified": 637607615365250200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/a8b0d962-c7b9-4466-a1df-d8292185f495",
    "identifier": "a8b0d962-c7b9-4466-a1df-d8292185f495",
...
---
Response status code: 200 OK. Responded in 351.127297ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/a8b0d962-c7b9-4466-a1df-d8292185f495
...
---
Response status code: 201 Created. Responded in 348.509448ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/a8b0d962-c7b9-4466-a1df-d8292185f495",
  "identifier": "a8b0d962-c7b9-4466-a1df-d8292185f495",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 465.270659ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "a8b0d962-c7b9-4466-a1df-d8292185f495",
  "modified": 637607615394317300
}
```
### Specs
* ✅ should return 200 on success
