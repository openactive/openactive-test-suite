[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:48:16 GMT+0000 (Coordinated Universal Time)

# cancellation-window >> succeed-within-window (OpenBookingApprovalFlow >> Multiple)
...
**Test:**  Successful booking and cancellation within window.

A successful end to end booking including cancellation within the cancellation window.

### Running only this test

```bash
npm start -- --runInBand test/features/cancellation/cancellation-window/implemented/succeed-within-window-test.js
```

---

⚠️ 20 passed with 0 failures, 478 warnings and 126 suggestions 
...
```json
{
  ...
  "test:testOpportunityCriteria": "https://openactive.io/test-interface#TestOpportunityBookableCancellableWithinWindow",
...
---
Response status code: 200 OK. Responded in 149.236684ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1004/events/10036"
}
```
...
---
Response status code: 200 OK. Responded in 150.523506ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1282/events/12815"
}
```
...
---
Response status code: 200 OK. Responded in 151.732721ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1186/facility-use-slots/11858"
}
```
...
---
Response status code: 200 OK. Responded in 141.950191ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1230/facility-use-slots/12293"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1004%2Fevents%2F10036?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 159.016912ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1004/events/10036",
    "startDate": "2021-07-04T00:41:09+00:00",
    "endDate": "2021-07-04T02:56:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1004",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1004#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1282%2Fevents%2F12815?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 159.932099ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1282/events/12815",
    "startDate": "2021-07-03T10:56:09+00:00",
    "endDate": "2021-07-03T16:51:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1282",
      "name": "Wooden Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1282#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1186%2Ffacility-use-slots%2F11858?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 160.759777ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1186",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1186/facility-use-slots/11858#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 2,
    "startDate": "2021-07-03T03:09:10+00:00",
    "endDate": "2021-07-03T07:07:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1230%2Ffacility-use-slots%2F12293?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 161.531751ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1230",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1230/facility-use-slots/12293#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
    ...
    "remainingUses": 4,
    "startDate": "2021-07-11T06:16:10+00:00",
    "endDate": "2021-07-11T08:29:10+00:00"
  }
}
```
### Specs
...
* ✅ matches the criteria 'TestOpportunityBookableCancellableWithinWindow' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/092c8923-9691-44ac-a821-b948e184d5c0
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1004#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1004/events/10036"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1282#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1282/events/12815"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1186/facility-use-slots/11858#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1186/facility-use-slots/11858"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1230/facility-use-slots/12293#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1230/facility-use-slots/12293"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1368.145282ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/092c8923-9691-44ac-a821-b948e184d5c0",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:57+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1282"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1186"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-03T03:09:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1230"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-11T06:16:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/092c8923-9691-44ac-a821-b948e184d5c0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Arielle_Bode@gmail.com",
    "telephone": "707-694-5045",
    "givenName": "Hermiston",
    "familyName": "Aubree",
    "identifier": "acefa63e-57e7-4385-bf5f-9558498227d4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1573.4580879999999ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:59+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/092c8923-9691-44ac-a821-b948e184d5c0
...
---
Response status code: 201 Created. Responded in 1417.372859ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/092c8923-9691-44ac-a821-b948e184d5c0",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/092c8923-9691-44ac-a821-b948e184d5c0#/orderedItems/2261",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1004#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/092c8923-9691-44ac-a821-b948e184d5c0#/orderedItems/2262",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1004#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/092c8923-9691-44ac-a821-b948e184d5c0#/orderedItems/2263",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1282#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/092c8923-9691-44ac-a821-b948e184d5c0#/orderedItems/2264",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1186/facility-use-slots/11858#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/092c8923-9691-44ac-a821-b948e184d5c0#/orderedItems/2265",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1186/facility-use-slots/11858#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/092c8923-9691-44ac-a821-b948e184d5c0#/orderedItems/2266",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1230/facility-use-slots/12293#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/092c8923-9691-44ac-a821-b948e184d5c0/versions/fe7c524e-8054-4e77-8f8e-653f9a45fe4a",
  "payment": {
    "@type": "Payment",
    "identifier": "6jxh4ewFP",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;092c8923-9691-44ac-a821-b948e184d5c0&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/092c8923-9691-44ac-a821-b948e184d5c0


---
Response status code: 200 OK. Responded in 201.430137ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607621315909657&afterId=039f5387-725e-4380-bb5c-c86f3c7908ce",
  "message": "Listening for UUID: '092c8923-9691-44ac-a821-b948e184d5c0' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 42.869873ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;092c8923-9691-44ac-a821-b948e184d5c0&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/092c8923-9691-44ac-a821-b948e184d5c0


---
Response status code: 200 OK. Responded in 2373.331184ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "092c8923-9691-44ac-a821-b948e184d5c0",
  "modified": 637607621438921300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/092c8923-9691-44ac-a821-b948e184d5c0",
    "identifier": "092c8923-9691-44ac-a821-b948e184d5c0",
...
---
Response status code: 200 OK. Responded in 252.648503ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/092c8923-9691-44ac-a821-b948e184d5c0
...
---
Response status code: 201 Created. Responded in 2357.477879ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/092c8923-9691-44ac-a821-b948e184d5c0",
  "identifier": "092c8923-9691-44ac-a821-b948e184d5c0",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 173.229764ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "092c8923-9691-44ac-a821-b948e184d5c0",
  "modified": 637607621471560100
}
```
### Specs
* ✅ should return 200 on success
...
## Cancel OrderItem at Position 0

### U Request
PATCH https://localhost:5001/api/openbooking/orders/092c8923-9691-44ac-a821-b948e184d5c0
...
---
Response status code: 204 No Content. Responded in 200.377145ms.
### Specs
* ✅ should return 204 on success
