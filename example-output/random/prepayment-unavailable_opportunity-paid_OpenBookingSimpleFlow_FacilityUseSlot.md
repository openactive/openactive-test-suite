...
---
Response status code: 200 OK. Responded in 36.173319ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4201"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F421%2Ffacility-use-slots%2F4201?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 6.065873ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/421",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4201#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 7.66,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT9H41M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-03T14:10:10+00:00",
    "endDate": "2021-07-03T18:44:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ca9c4aa0-a3bf-4b8b-bfe7-283b85f39de3
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4201#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4201"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 615.440367ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ca9c4aa0-a3bf-4b8b-bfe7-283b85f39de3",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:59:41+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/421"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-03T14:10:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ca9c4aa0-a3bf-4b8b-bfe7-283b85f39de3
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Billy.Lubowitz@hotmail.com",
    "telephone": "693-251-3870 x860",
    "givenName": "Lueilwitz",
    "familyName": "Olaf",
    "identifier": "09643f84-03b3-4e00-8dfd-626db96a3534"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 483.469794ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ca9c4aa0-a3bf-4b8b-bfe7-283b85f39de3
...
---
Response status code: 201 Created. Responded in 2303.580018ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ca9c4aa0-a3bf-4b8b-bfe7-283b85f39de3",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ca9c4aa0-a3bf-4b8b-bfe7-283b85f39de3#/orderedItems/3106",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/421/facility-use-slots/4201#/offers/0",
        "allowCustomerCancellationFullRefund": false,
