...
---
Response status code: 200 OK. Responded in 470.269897ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/328/events/3277"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F328%2Fevents%2F3277?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 523.686674ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/328/events/3277",
    "startDate": "2021-07-03T12:52:09+00:00",
    "endDate": "2021-07-03T15:43:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/328",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/328#/offers/0",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/c9f528ee-6c9d-45f5-8660-86fde12ea84c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/328#/offers/0"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 48.576017ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/c9f528ee-6c9d-45f5-8660-86fde12ea84c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:08+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/c9f528ee-6c9d-45f5-8660-86fde12ea84c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Kaylee8@hotmail.com",
    "telephone": "493.649.3809",
    "givenName": "Kertzmann",
    "familyName": "Jensen",
    "identifier": "3b865a86-d3d5-41e8-a807-c3d2377a7542"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 38.243535ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/c9f528ee-6c9d-45f5-8660-86fde12ea84c
...
---
Response status code: 409 Conflict. Responded in 37.863299ms.
```json
{
  "@context": "https://openactive.io/",
