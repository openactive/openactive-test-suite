...
---
Response status code: 200 OK. Responded in 308.518978ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/385/facility-use-slots/3843"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F385%2Ffacility-use-slots%2F3843?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 144.700479ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/385",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/385/facility-use-slots/3843#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 19.13,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT4H32M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-10T10:49:10+00:00",
    "endDate": "2021-07-10T16:43:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/b198e203-2570-4381-84c1-b26bd5a6a300
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/385/facility-use-slots/3843#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/385/facility-use-slots/3843"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 108.328715ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/b198e203-2570-4381-84c1-b26bd5a6a300",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:44:56+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/385"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-10T10:49:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/b198e203-2570-4381-84c1-b26bd5a6a300
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Grant59@yahoo.com",
    "telephone": "344.847.4315",
    "givenName": "Gaylord",
    "familyName": "Pearline",
    "identifier": "aeae96fc-231c-4f09-831d-91a7454ce6a4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 80.844999ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/b198e203-2570-4381-84c1-b26bd5a6a300
...
---
Response status code: 201 Created. Responded in 84.515048ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/b198e203-2570-4381-84c1-b26bd5a6a300",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/b198e203-2570-4381-84c1-b26bd5a6a300#/orderedItems/545",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/385/facility-use-slots/3843#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Orders (orders) Feed listen for &#x27;b198e203-2570-4381-84c1-b26bd5a6a300&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/b198e203-2570-4381-84c1-b26bd5a6a300


---
Response status code: 200 OK. Responded in 359.615344ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607615925516181&afterId=992a19d8-295a-4b39-adef-829139e8abd9",
  "message": "Listening for UUID: 'b198e203-2570-4381-84c1-b26bd5a6a300' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 50.008262ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after Simulate Seller Cancellation)

### Orders (orders) Feed collect for &#x27;b198e203-2570-4381-84c1-b26bd5a6a300&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/b198e203-2570-4381-84c1-b26bd5a6a300


---
Response status code: 200 OK. Responded in 2746.824063ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "b198e203-2570-4381-84c1-b26bd5a6a300",
  "modified": 637607615982977900,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/b198e203-2570-4381-84c1-b26bd5a6a300",
    "identifier": "b198e203-2570-4381-84c1-b26bd5a6a300",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/b198e203-2570-4381-84c1-b26bd5a6a300#/orderedItems/545",
