...
# order-deletion >> order-delete-idempotent (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 17 passed with 0 failures, 380 warnings and 104 suggestions 
...
---
Response status code: 200 OK. Responded in 99.224304ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2747"
}
```
...
---
Response status code: 200 OK. Responded in 100.107788ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/383/events/3830"
}
```
...
---
Response status code: 200 OK. Responded in 95.013607ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/487/facility-use-slots/4869"
}
```
...
---
Response status code: 200 OK. Responded in 95.786181ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/277/facility-use-slots/2765"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F275%2Fevents%2F2747?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 202.08358ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2747",
    "startDate": "2021-07-10T23:09:09+00:00",
    "endDate": "2021-07-10T23:45:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F383%2Fevents%2F3830?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 202.490218ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/383/events/3830",
    "startDate": "2021-07-03T03:22:09+00:00",
    "endDate": "2021-07-03T09:14:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/383",
      "name": "Metal Running",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/383#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingPrepayment": "https://openactive.io/Optional",
          "price": 15.02,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT19H29M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F487%2Ffacility-use-slots%2F4869?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 203.116778ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/487",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/487/facility-use-slots/4869#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 4.37,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT16H43M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-01T23:27:10+00:00",
    "endDate": "2021-07-02T01:55:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F277%2Ffacility-use-slots%2F2765?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 203.78044ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/277",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/277/facility-use-slots/2765#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 8.82,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 4,
    "startDate": "2021-07-04T19:38:10+00:00",
    "endDate": "2021-07-04T21:39:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1519fd43-6c93-41a0-b9d4-d28693231dee
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2747"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/383#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/383/events/3830"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/487/facility-use-slots/4869#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/487/facility-use-slots/4869"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/277/facility-use-slots/2765#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/277/facility-use-slots/2765"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2191.459384ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1519fd43-6c93-41a0-b9d4-d28693231dee",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:03+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/383"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/487"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-01T23:27:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/277"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-04T19:38:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1519fd43-6c93-41a0-b9d4-d28693231dee
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Cordell_Hyatt1@hotmail.com",
    "telephone": "845-763-2526 x94977",
    "givenName": "Welch",
    "familyName": "Rosetta",
    "identifier": "598ee486-0138-4d9d-968a-bbeda309f39b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1528.324648ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:05+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1519fd43-6c93-41a0-b9d4-d28693231dee
...
---
Response status code: 201 Created. Responded in 1526.8643299999999ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1519fd43-6c93-41a0-b9d4-d28693231dee",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1519fd43-6c93-41a0-b9d4-d28693231dee#/orderedItems/2112",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/275#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1519fd43-6c93-41a0-b9d4-d28693231dee#/orderedItems/2113",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/275#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1519fd43-6c93-41a0-b9d4-d28693231dee#/orderedItems/2114",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/383#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1519fd43-6c93-41a0-b9d4-d28693231dee#/orderedItems/2115",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/487/facility-use-slots/4869#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1519fd43-6c93-41a0-b9d4-d28693231dee#/orderedItems/2116",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/487/facility-use-slots/4869#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1519fd43-6c93-41a0-b9d4-d28693231dee#/orderedItems/2117",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/277/facility-use-slots/2765#/offers/0",
        "allowCustomerCancellationFullRefund": false,
...
DELETE https://localhost:5001/api/openbooking/orders/1519fd43-6c93-41a0-b9d4-d28693231dee
...
---
Response status code: 204 No Content. Responded in 567.117978ms.
...
---
Response status code: 204 No Content. Responded in 30.434291ms.
### Specs
