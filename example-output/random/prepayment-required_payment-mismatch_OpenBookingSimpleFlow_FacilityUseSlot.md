...
---
Response status code: 200 OK. Responded in 194.518883ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/715/facility-use-slots/7146"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F715%2Ffacility-use-slots%2F7146?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 137.744088ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/715",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/715/facility-use-slots/7146#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 7.73,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT9H54M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-02T16:20:10+00:00",
    "endDate": "2021-07-02T18:53:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/de3ff564-3d78-4938-8697-53a0dc79fd7f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/715/facility-use-slots/7146#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/715/facility-use-slots/7146"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 500.264831ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/de3ff564-3d78-4938-8697-53a0dc79fd7f",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/de3ff564-3d78-4938-8697-53a0dc79fd7f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Eldridge.Skiles@yahoo.com",
    "telephone": "(396) 697-7631 x12645",
    "givenName": "Schowalter",
    "familyName": "Marjolaine",
    "identifier": "48ba0737-ac99-477d-b6b8-742ecc3298a3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 609.49921ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/de3ff564-3d78-4938-8697-53a0dc79fd7f
...
---
Response status code: 400 Bad Request. Responded in 55.815103ms.
```json
{
  "@context": "https://openactive.io/",
