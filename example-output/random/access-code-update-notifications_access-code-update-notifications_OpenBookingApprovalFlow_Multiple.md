...
⚠️ 22 passed with 0 failures, 504 warnings and 126 suggestions 
...
---
Response status code: 200 OK. Responded in 412.358298ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1011/events/10106"
}
```
...
---
Response status code: 200 OK. Responded in 414.003155ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1200/events/11999"
}
```
...
---
Response status code: 200 OK. Responded in 416.277871ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1289/facility-use-slots/12886"
}
```
...
---
Response status code: 200 OK. Responded in 416.868127ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1450/facility-use-slots/14496"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1011%2Fevents%2F10106?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 279.499168ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1011/events/10106",
    "startDate": "2021-07-07T10:17:09+00:00",
    "endDate": "2021-07-07T10:52:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1011",
      "name": "Concrete Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1011#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1200%2Fevents%2F11999?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 279.50797ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1200/events/11999",
    "startDate": "2021-07-02T09:10:09+00:00",
    "endDate": "2021-07-02T14:35:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1200",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1200#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1289%2Ffacility-use-slots%2F12886?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 279.113732ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1289",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1289/facility-use-slots/12886#/offers/0",
    ...
    "remainingUses": 8,
    "startDate": "2021-07-05T16:06:10+00:00",
    "endDate": "2021-07-05T21:14:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1450%2Ffacility-use-slots%2F14496?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 279.459065ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1450/facility-use-slots/14496#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 3.38,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT4H32M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-09T04:05:10+00:00",
    "endDate": "2021-07-09T09:12:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/fa4d5293-1600-42e6-a173-5807dde4a3f2
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1011#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1011/events/10106"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1200#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1200/events/11999"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1289/facility-use-slots/12886#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1289/facility-use-slots/12886"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1450/facility-use-slots/14496#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1450/facility-use-slots/14496"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 282.546138ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/fa4d5293-1600-42e6-a173-5807dde4a3f2",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:44+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1011"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1200"
        },
        "maximumAttendeeCapacity": 35,
        "remainingAttendeeCapacity": 35
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1289"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-05T16:06:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/fa4d5293-1600-42e6-a173-5807dde4a3f2
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lenore.Wyman7@gmail.com",
    "telephone": "777.983.8253 x89926",
    "givenName": "Witting",
    "familyName": "Callie",
    "identifier": "32df6dc8-9eb5-4b69-8082-7463349f4813"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 680.875274ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:46+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/fa4d5293-1600-42e6-a173-5807dde4a3f2
...
---
Response status code: 201 Created. Responded in 509.521397ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/fa4d5293-1600-42e6-a173-5807dde4a3f2",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa4d5293-1600-42e6-a173-5807dde4a3f2#/orderedItems/885",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1011#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa4d5293-1600-42e6-a173-5807dde4a3f2#/orderedItems/886",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1011#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa4d5293-1600-42e6-a173-5807dde4a3f2#/orderedItems/887",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1200#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa4d5293-1600-42e6-a173-5807dde4a3f2#/orderedItems/888",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1289/facility-use-slots/12886#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa4d5293-1600-42e6-a173-5807dde4a3f2#/orderedItems/889",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1289/facility-use-slots/12886#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/fa4d5293-1600-42e6-a173-5807dde4a3f2#/orderedItems/890",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1450/facility-use-slots/14496#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/fa4d5293-1600-42e6-a173-5807dde4a3f2/versions/b587de4b-9623-4dc6-a22f-220355de5f8d",
  "payment": {
    "@type": "Payment",
    "identifier": "GRt78LOPi",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;fa4d5293-1600-42e6-a173-5807dde4a3f2&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/fa4d5293-1600-42e6-a173-5807dde4a3f2


---
Response status code: 200 OK. Responded in 217.988106ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607617031109129&afterId=d9d810aa-45d0-4330-882a-d7f6ad6db6e2",
  "message": "Listening for UUID: 'fa4d5293-1600-42e6-a173-5807dde4a3f2' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 15.184342ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;fa4d5293-1600-42e6-a173-5807dde4a3f2&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/fa4d5293-1600-42e6-a173-5807dde4a3f2


---
Response status code: 200 OK. Responded in 2871.679369ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "fa4d5293-1600-42e6-a173-5807dde4a3f2",
  "modified": 637607617089572900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/fa4d5293-1600-42e6-a173-5807dde4a3f2",
    "identifier": "fa4d5293-1600-42e6-a173-5807dde4a3f2",
...
---
Response status code: 200 OK. Responded in 213.564312ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607617069462650&afterId=d9d810aa-45d0-4330-882a-d7f6ad6db6e2",
  "message": "Listening for UUID: 'fa4d5293-1600-42e6-a173-5807dde4a3f2' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/fa4d5293-1600-42e6-a173-5807dde4a3f2
...
---
Response status code: 201 Created. Responded in 376.533812ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/fa4d5293-1600-42e6-a173-5807dde4a3f2",
  "identifier": "fa4d5293-1600-42e6-a173-5807dde4a3f2",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 369.393732ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "fa4d5293-1600-42e6-a173-5807dde4a3f2",
  "modified": 637607617122287000
}
```
### Specs
* ✅ should return 200 on success
...
### Orders (orders) Feed listen for &#x27;fa4d5293-1600-42e6-a173-5807dde4a3f2&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/fa4d5293-1600-42e6-a173-5807dde4a3f2


---
Response status code: 200 OK. Responded in 291.998372ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607617122056274&afterId=728530d8-d20c-40fc-800e-e7b20da01339",
  "message": "Listening for UUID: 'fa4d5293-1600-42e6-a173-5807dde4a3f2' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 28.758635ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AccessCodeUpdateSimulateAction)

### Orders (orders) Feed collect for &#x27;fa4d5293-1600-42e6-a173-5807dde4a3f2&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/fa4d5293-1600-42e6-a173-5807dde4a3f2


---
Response status code: 200 OK. Responded in 2842.965461ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "fa4d5293-1600-42e6-a173-5807dde4a3f2",
  "modified": 637607617166341800,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
