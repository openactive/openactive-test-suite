[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:52:19 GMT+0000 (Coordinated Universal Time)

# additional-details-capture >> additional-details-required-and-supplied (OpenBookingSimpleFlow >> Multiple)
...
---
Response status code: 200 OK. Responded in 83.828932ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/63/events/623"
}
```
...
---
Response status code: 200 OK. Responded in 90.563377ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/6/events/55"
}
```
...
---
Response status code: 200 OK. Responded in 77.760351ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/337/facility-use-slots/3366"
}
```
...
---
Response status code: 200 OK. Responded in 65.070034ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/587/facility-use-slots/5863"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F63%2Fevents%2F623?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 52.058587ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/63/events/623",
    "startDate": "2021-07-08T05:04:09+00:00",
    "endDate": "2021-07-08T08:14:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/63",
      "name": "Steel Jumping",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/63#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F6%2Fevents%2F55?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 52.1896ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/6/events/55",
    "startDate": "2021-07-04T08:26:09+00:00",
    "endDate": "2021-07-04T10:26:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F337%2Ffacility-use-slots%2F3366?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 52.905269ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/337",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/337/facility-use-slots/3366#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingIntakeForm"
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT19H38M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-10T19:03:10+00:00",
    "endDate": "2021-07-10T20:53:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F587%2Ffacility-use-slots%2F5863?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 53.368013ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/587/facility-use-slots/5863#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT2H12M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-03T22:46:10+00:00",
    "endDate": "2021-07-04T01:33:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ffa023eb-a76f-453b-8e5a-31762090c0cd
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/63#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/63/events/623"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/6/events/55"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/337/facility-use-slots/3366#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/337/facility-use-slots/3366"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/587/facility-use-slots/5863#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/587/facility-use-slots/5863"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 3544.281333ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ffa023eb-a76f-453b-8e5a-31762090c0cd",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:42+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/63"
        },
        "maximumAttendeeCapacity": 33,
        "remainingAttendeeCapacity": 33
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/337"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-10T19:03:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ffa023eb-a76f-453b-8e5a-31762090c0cd
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Brant_Rodriguez@yahoo.com",
    "telephone": "952-561-4731 x912",
    "givenName": "Lebsack",
    "familyName": "Alyce",
    "identifier": "2b600942-1712-4ec5-adbc-d3b5984dc90d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 4950.8353640000005ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:48+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/ffa023eb-a76f-453b-8e5a-31762090c0cd
...
---
Response status code: 201 Created. Responded in 3280.205246ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/ffa023eb-a76f-453b-8e5a-31762090c0cd",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ffa023eb-a76f-453b-8e5a-31762090c0cd#/orderedItems/2826",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/63#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ffa023eb-a76f-453b-8e5a-31762090c0cd#/orderedItems/2827",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/63#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ffa023eb-a76f-453b-8e5a-31762090c0cd#/orderedItems/2828",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/6#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ffa023eb-a76f-453b-8e5a-31762090c0cd#/orderedItems/2829",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/337/facility-use-slots/3366#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ffa023eb-a76f-453b-8e5a-31762090c0cd#/orderedItems/2830",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/337/facility-use-slots/3366#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/ffa023eb-a76f-453b-8e5a-31762090c0cd#/orderedItems/2831",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/587/facility-use-slots/5863#/offers/0",
        "allowCustomerCancellationFullRefund": false,
