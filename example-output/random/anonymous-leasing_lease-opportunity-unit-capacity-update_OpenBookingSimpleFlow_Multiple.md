[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:47:56 GMT+0000 (Coordinated Universal Time)

# anonymous-leasing >> lease-opportunity-unit-capacity-update (OpenBookingSimpleFlow >> Multiple)
...
**Test:**  Single anonymous leased spaces are unavailable for purchase by other users
...
```bash
npm start -- --runInBand test/features/leasing/anonymous-leasing/implemented/lease-opportunity-unit-capacity-update-test.js
```

---

⚠️ 13 passed with 0 failures, 110 warnings and 28 suggestions 
...
---
Response status code: 200 OK. Responded in 241.048277ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/456/events/4556"
}
```
...
---
Response status code: 200 OK. Responded in 255.532152ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/310/facility-use-slots/3093"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F456%2Fevents%2F4556?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 208.161156ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/456/events/4556",
    "startDate": "2021-07-05T03:48:09+00:00",
    "endDate": "2021-07-05T04:34:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/456",
      "name": "Wooden Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/456#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Optional",
          "price": 6.15,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT11H48M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F310%2Ffacility-use-slots%2F3093?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 207.674809ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/310",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/310/facility-use-slots/3093#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    "remainingUses": 1,
    "startDate": "2021-07-07T21:32:10+00:00",
    "endDate": "2021-07-08T01:00:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/10085a8e-2f57-4db5-a5c7-0eb1890353f9
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/456#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/456/events/4556"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/310/facility-use-slots/3093#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/310/facility-use-slots/3093"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 745.121717ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/10085a8e-2f57-4db5-a5c7-0eb1890353f9",
  "lease": {
    "@type": "Lease",
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/456"
        },
        "maximumAttendeeCapacity": 1,
        "remainingAttendeeCapacity": 1
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/310"
        },
        "maximumUses": 1,
        "remainingUses": 1,
        "startDate": "2021-07-07T21:32:10+00:00",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/4c45f1d4-95b5-4d1f-a755-9206216b9059
...
---
Response status code: 409 Conflict. Responded in 3798.14649ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/4c45f1d4-95b5-4d1f-a755-9206216b9059",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:53:07+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
