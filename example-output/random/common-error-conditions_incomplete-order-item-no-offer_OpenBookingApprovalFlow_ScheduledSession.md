...
⚠️ 9 passed with 0 failures, 31 warnings and 10 suggestions 
...
---
Response status code: 200 OK. Responded in 376.264762ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1269/events/12684"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1269%2Fevents%2F12684?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 388.660841ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1269/events/12684",
    "startDate": "2021-07-06T21:54:09+00:00",
    "endDate": "2021-07-07T01:32:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/8a702339-ab09-4dd4-b9c6-a08f8b86ac7f
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1269/events/12684"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 57.11883ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/8a702339-ab09-4dd4-b9c6-a08f8b86ac7f",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/8a702339-ab09-4dd4-b9c6-a08f8b86ac7f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Maxwell.Cole15@gmail.com",
    "telephone": "583-753-2400",
    "givenName": "Konopelski",
    "familyName": "Jewell",
    "identifier": "9a14e249-15f1-4b29-99f3-41fab361dd01"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 37.172634ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/8a702339-ab09-4dd4-b9c6-a08f8b86ac7f
...
---
Response status code: 409 Conflict. Responded in 23.141ms.
```json
{
  "@context": "https://openactive.io/",
