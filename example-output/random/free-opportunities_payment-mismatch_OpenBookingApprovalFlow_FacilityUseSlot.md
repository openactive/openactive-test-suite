...
# free-opportunities >> payment-mismatch (OpenBookingApprovalFlow >> FacilityUseSlot)
...
⚠️ 7 passed with 0 failures, 54 warnings and 6 suggestions 
...
---
Response status code: 200 OK. Responded in 125.407015ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1625/facility-use-slots/16242"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1625%2Ffacility-use-slots%2F16242?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 86.241493ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1625",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1625/facility-use-slots/16242#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT11H16M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-03T10:49:10+00:00",
    "endDate": "2021-07-03T11:24:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/94cf5090-cc0f-4de3-8a42-df422f85f0e0
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1625/facility-use-slots/16242#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1625/facility-use-slots/16242"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 671.146063ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/94cf5090-cc0f-4de3-8a42-df422f85f0e0",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:00+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1625"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-03T10:49:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/94cf5090-cc0f-4de3-8a42-df422f85f0e0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Brendan_Bauch@gmail.com",
    "telephone": "1-761-877-3560",
    "givenName": "Jenkins",
    "familyName": "Daren",
    "identifier": "9481e0cb-297b-48bc-bf4a-70c7f8b81e86"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1786.5646339999998ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:02+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/94cf5090-cc0f-4de3-8a42-df422f85f0e0
...
---
Response status code: 400 Bad Request. Responded in 58.032014ms.
```json
{
  "@context": "https://openactive.io/",
