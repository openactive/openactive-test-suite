...
# amending-order-quote >> amend-c1 (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 35 passed with 0 failures, 577 warnings and 156 suggestions 
...
---
Response status code: 200 OK. Responded in 251.135865ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2744"
}
```
...
---
Response status code: 200 OK. Responded in 251.470497ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/451/events/4503"
}
```
...
---
Response status code: 200 OK. Responded in 251.867934ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/618/facility-use-slots/6179"
}
```
...
---
Response status code: 200 OK. Responded in 252.015349ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3821"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F275%2Fevents%2F2744?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 209.087586ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2744",
    "startDate": "2021-07-05T01:48:09+00:00",
    "endDate": "2021-07-05T02:22:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F451%2Fevents%2F4503?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 210.005573ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/451/events/4503",
    "startDate": "2021-07-10T20:36:09+00:00",
    "endDate": "2021-07-10T23:36:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/451",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/451#/offers/0",
          "allowCustomerCancellationFullRefund": true,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "price": 8.92,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT1H20M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F618%2Ffacility-use-slots%2F6179?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 210.771546ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/618/facility-use-slots/6179#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT13H21M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-02T10:16:10+00:00",
    "endDate": "2021-07-02T13:54:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F383%2Ffacility-use-slots%2F3821?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 211.607525ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/383",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3821#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Required",
        "price": 8.23,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT10H36M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-02T15:02:10+00:00",
    "endDate": "2021-07-02T17:50:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1732c305-b2e6-43e4-9027-5f8f6e5eb86b
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/275/events/2744"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/451#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/451/events/4503"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/618/facility-use-slots/6179#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/618/facility-use-slots/6179"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3821#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/383/facility-use-slots/3821"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 209.251702ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1732c305-b2e6-43e4-9027-5f8f6e5eb86b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:42:49+00:00"
  },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/451"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
...
---
Response status code: 200 OK. Responded in 344.264778ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/98/events/977"
}
```
...
---
Response status code: 200 OK. Responded in 345.942637ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/158/events/1575"
}
```
...
---
Response status code: 200 OK. Responded in 346.128055ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/613/facility-use-slots/6126"
}
```
...
---
Response status code: 200 OK. Responded in 335.027604ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/504/facility-use-slots/5033"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F98%2Fevents%2F977?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 419.206927ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/98/events/977",
    "startDate": "2021-07-06T08:07:09+00:00",
    "endDate": "2021-07-06T08:49:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 2 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F158%2Fevents%2F1575?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 428.133786ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/158/events/1575",
    "startDate": "2021-07-04T15:52:09+00:00",
    "endDate": "2021-07-04T19:08:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### Opportunity Feed extract for OrderItem 3 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F613%2Ffacility-use-slots%2F6126?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 428.206793ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/613",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/613/facility-use-slots/6126#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT4H34M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-06T18:59:10+00:00",
    "endDate": "2021-07-06T20:49:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F504%2Ffacility-use-slots%2F5033?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 428.190093ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/504",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/504/facility-use-slots/5033#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT18H22M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-04T23:45:10+00:00",
    "endDate": "2021-07-05T03:04:10+00:00"
  }
}
```
### Specs
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/98/events/977"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/158/events/1575"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/613/facility-use-slots/6126#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/613/facility-use-slots/6126"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/504/facility-use-slots/5033#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/504/facility-use-slots/5033"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 266.43109ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:42:53+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/613"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-06T18:59:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/504"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-04T23:45:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1732c305-b2e6-43e4-9027-5f8f6e5eb86b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Telly.Hintz70@gmail.com",
    "telephone": "872.675.4063 x5581",
    "givenName": "Jaskolski",
    "familyName": "Zane",
    "identifier": "1a313ce0-29dd-4245-80ef-79b87f298880"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 404.724373ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:42:54+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1732c305-b2e6-43e4-9027-5f8f6e5eb86b
...
---
Response status code: 201 Created. Responded in 513.39191ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1732c305-b2e6-43e4-9027-5f8f6e5eb86b",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1732c305-b2e6-43e4-9027-5f8f6e5eb86b#/orderedItems/151",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/98#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1732c305-b2e6-43e4-9027-5f8f6e5eb86b#/orderedItems/152",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/98#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1732c305-b2e6-43e4-9027-5f8f6e5eb86b#/orderedItems/153",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/158#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1732c305-b2e6-43e4-9027-5f8f6e5eb86b#/orderedItems/154",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/613/facility-use-slots/6126#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1732c305-b2e6-43e4-9027-5f8f6e5eb86b#/orderedItems/155",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/613/facility-use-slots/6126#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1732c305-b2e6-43e4-9027-5f8f6e5eb86b#/orderedItems/156",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/504/facility-use-slots/5033#/offers/0",
        "allowCustomerCancellationFullRefund": false,
