...
---
Response status code: 200 OK. Responded in 295.530213ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/466/facility-use-slots/4656"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F466%2Ffacility-use-slots%2F4656?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 363.50598ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/466/facility-use-slots/4656#/offers/0",
        ...
        "price": 19.77,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT2H33M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-10T10:12:10+00:00",
    "endDate": "2021-07-10T14:40:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/2f22ad45-046d-4fed-999b-3cff75311933
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/466/facility-use-slots/4656#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/466/facility-use-slots/4656"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 281.93032ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/2f22ad45-046d-4fed-999b-3cff75311933",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:15+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/2f22ad45-046d-4fed-999b-3cff75311933
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Violet_Runte@gmail.com",
    "telephone": "208.264.6623 x46264",
    "givenName": "Hoppe",
    "familyName": "Ena",
    "identifier": "60f90e73-af0a-4da1-a14a-cfc89cf56b63"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 88.908158ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/2f22ad45-046d-4fed-999b-3cff75311933
...
---
Response status code: 409 Conflict. Responded in 46.547428ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 409,
  "description": "The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.: Value provided is not a boolean, The 'orderItemIntakeFormResponse' contains invalid fields that do not match those specified by the 'orderItemIntakeForm'.: Value provided is not a string"
}
```
### Specs
