...
---
Response status code: 200 OK. Responded in 95.38545ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/338/events/3376"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F338%2Fevents%2F3376?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 10.716616ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/338/events/3376",
    "startDate": "2021-07-11T01:52:09+00:00",
    "endDate": "2021-07-11T06:03:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/338",
      "name": "Steel Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/338#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
          "openBookingPrepayment": "https://openactive.io/Unavailable",
          "price": 2.63,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P10DT19H13M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9a94d5bc-659f-4b72-a2ea-1d04bea3a78b
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/338#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/338/events/3376"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 676.430579ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9a94d5bc-659f-4b72-a2ea-1d04bea3a78b",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:24+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/338"
        },
        "maximumAttendeeCapacity": 47,
        "remainingAttendeeCapacity": 47
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9a94d5bc-659f-4b72-a2ea-1d04bea3a78b
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Leif.Yundt@hotmail.com",
    "telephone": "595.916.6901 x85304",
    "givenName": "O'Connell",
    "familyName": "Alena",
    "identifier": "bae5893d-1064-4316-ae94-6ec3d5fa0f46"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 558.08115ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/9a94d5bc-659f-4b72-a2ea-1d04bea3a78b
...
---
Response status code: 400 Bad Request. Responded in 83.192493ms.
```json
{
  "@context": "https://openactive.io/",
