...
⚠️ 12 passed with 0 failures, 222 warnings and 80 suggestions 
...
---
Response status code: 200 OK. Responded in 243.355973ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3041"
}
```
...
---
Response status code: 200 OK. Responded in 245.528881ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/353/events/3523"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F305%2Fevents%2F3041?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 307.843815ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3041",
    "startDate": "2021-07-02T19:14:09+00:00",
    "endDate": "2021-07-02T23:46:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F353%2Fevents%2F3523?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 308.934418ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/353/events/3523",
    "startDate": "2021-07-02T14:06:09+00:00",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6fff4dac-b3d5-49fa-9eca-ec883712380f
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/305/events/3041"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/353/events/3523"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 165.523162ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6fff4dac-b3d5-49fa-9eca-ec883712380f",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:44:55+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6fff4dac-b3d5-49fa-9eca-ec883712380f
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alison_Torp@gmail.com",
    "telephone": "(888) 906-6578 x995",
    "givenName": "Lebsack",
    "familyName": "Paxton",
    "identifier": "16a93d1e-fc6a-4de7-9a99-9dcd4215e90d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 123.090921ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6fff4dac-b3d5-49fa-9eca-ec883712380f
...
---
Response status code: 201 Created. Responded in 147.219719ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/6fff4dac-b3d5-49fa-9eca-ec883712380f",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6fff4dac-b3d5-49fa-9eca-ec883712380f#/orderedItems/542",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/305#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6fff4dac-b3d5-49fa-9eca-ec883712380f#/orderedItems/543",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/305#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/6fff4dac-b3d5-49fa-9eca-ec883712380f#/orderedItems/544",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/353#/offers/0",
        "allowCustomerCancellationFullRefund": true,
...
### Orders (orders) Feed listen for &#x27;6fff4dac-b3d5-49fa-9eca-ec883712380f&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/6fff4dac-b3d5-49fa-9eca-ec883712380f


---
Response status code: 200 OK. Responded in 182.397668ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '6fff4dac-b3d5-49fa-9eca-ec883712380f' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 43.877975ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AccessChannelUpdateSimulateAction)

### Orders (orders) Feed collect for &#x27;6fff4dac-b3d5-49fa-9eca-ec883712380f&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/6fff4dac-b3d5-49fa-9eca-ec883712380f


---
Response status code: 200 OK. Responded in 2192.62459ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "6fff4dac-b3d5-49fa-9eca-ec883712380f",
  "modified": 637607615988931200,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
    ...
    "@type": "Order",
    "@id": "https://localhost:5001/api/openbooking/orders/6fff4dac-b3d5-49fa-9eca-ec883712380f",
    "identifier": "6fff4dac-b3d5-49fa-9eca-ec883712380f",
    "orderedItem": [
      {
        "@type": "OrderItem",
        "@id": "https://localhost:5001/api/openbooking/orders/6fff4dac-b3d5-49fa-9eca-ec883712380f#/orderedItems/542",
