[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:41:03 GMT+0000 (Coordinated Universal Time)

# access-pass-update-notifications >> access-pass-update-notifications (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 22 passed with 0 failures, 508 warnings and 128 suggestions 
...
---
Response status code: 200 OK. Responded in 310.557936ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1190/events/11895"
}
```
...
---
Response status code: 200 OK. Responded in 293.481913ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1307/events/13065"
}
```
...
---
Response status code: 200 OK. Responded in 294.766034ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1543/facility-use-slots/15426"
}
```
...
---
Response status code: 200 OK. Responded in 295.76493ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1534/facility-use-slots/15332"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1190%2Fevents%2F11895?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 264.843889ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1190/events/11895",
    "startDate": "2021-07-03T20:35:09+00:00",
    "endDate": "2021-07-03T21:42:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1190",
      "name": "Concrete Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1190#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1307%2Fevents%2F13065?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 267.976187ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1307/events/13065",
    "startDate": "2021-07-09T01:18:09+00:00",
    "endDate": "2021-07-09T03:07:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1307",
      "name": "Concrete Jumping",
      "activity": [
        {
          "@type": "Concept",
          "@id": "https://openactive.io/activity-list#c07d63a0-8eb9-4602-8bcc-23be6deb8f83",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1307#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1DT16H",
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1543%2Ffacility-use-slots%2F15426?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 277.900231ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1543",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1543/facility-use-slots/15426#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P12DT2H19M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-03T01:52:10+00:00",
    "endDate": "2021-07-03T02:52:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1534%2Ffacility-use-slots%2F15332?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 278.538392ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1534/facility-use-slots/15332#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        ...
        "price": 17.07,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT7H30M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-09T15:58:10+00:00",
    "endDate": "2021-07-09T19:11:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/acad6cce-c7e5-43cb-b737-1c4585fbf465
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1190#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1190/events/11895"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1307#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1307/events/13065"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1543/facility-use-slots/15426#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1543/facility-use-slots/15426"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1534/facility-use-slots/15332#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1534/facility-use-slots/15332"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 702.380302ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/acad6cce-c7e5-43cb-b737-1c4585fbf465",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:58+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1190"
        },
        "maximumAttendeeCapacity": 11,
        "remainingAttendeeCapacity": 11
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1307"
        },
        "maximumAttendeeCapacity": 19,
        "remainingAttendeeCapacity": 19
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1543"
        },
        "maximumUses": 7,
        "remainingUses": 7,
        "startDate": "2021-07-03T01:52:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1534"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-09T15:58:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/acad6cce-c7e5-43cb-b737-1c4585fbf465
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Amely45@gmail.com",
    "telephone": "969.987.7693",
    "givenName": "Botsford",
    "familyName": "Dayana",
    "identifier": "ca72b5b1-9ab4-44f7-9b55-fad5414ebc17"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 374.091855ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:46:59+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/acad6cce-c7e5-43cb-b737-1c4585fbf465
...
---
Response status code: 201 Created. Responded in 530.738644ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/acad6cce-c7e5-43cb-b737-1c4585fbf465",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/acad6cce-c7e5-43cb-b737-1c4585fbf465#/orderedItems/909",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1190#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/acad6cce-c7e5-43cb-b737-1c4585fbf465#/orderedItems/910",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1190#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/acad6cce-c7e5-43cb-b737-1c4585fbf465#/orderedItems/911",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1307#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/acad6cce-c7e5-43cb-b737-1c4585fbf465#/orderedItems/912",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1543/facility-use-slots/15426#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/acad6cce-c7e5-43cb-b737-1c4585fbf465#/orderedItems/913",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1543/facility-use-slots/15426#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/acad6cce-c7e5-43cb-b737-1c4585fbf465#/orderedItems/914",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1534/facility-use-slots/15332#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/acad6cce-c7e5-43cb-b737-1c4585fbf465/versions/9a3807de-befa-4d5b-a97f-8d84b266dc00",
  "payment": {
    "@type": "Payment",
    "identifier": "5F9wK_-wy",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;acad6cce-c7e5-43cb-b737-1c4585fbf465&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/acad6cce-c7e5-43cb-b737-1c4585fbf465


---
Response status code: 200 OK. Responded in 530.334406ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607617122286991&afterId=fa4d5293-1600-42e6-a173-5807dde4a3f2",
  "message": "Listening for UUID: 'acad6cce-c7e5-43cb-b737-1c4585fbf465' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 19.388843ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;acad6cce-c7e5-43cb-b737-1c4585fbf465&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/acad6cce-c7e5-43cb-b737-1c4585fbf465


---
Response status code: 200 OK. Responded in 2800.270352ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "acad6cce-c7e5-43cb-b737-1c4585fbf465",
  "modified": 637607617230165800,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/acad6cce-c7e5-43cb-b737-1c4585fbf465",
    "identifier": "acad6cce-c7e5-43cb-b737-1c4585fbf465",
...
---
Response status code: 200 OK. Responded in 507.808265ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/acad6cce-c7e5-43cb-b737-1c4585fbf465
...
---
Response status code: 201 Created. Responded in 460.539072ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/acad6cce-c7e5-43cb-b737-1c4585fbf465",
  "identifier": "acad6cce-c7e5-43cb-b737-1c4585fbf465",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 216.991328ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "acad6cce-c7e5-43cb-b737-1c4585fbf465",
  "modified": 637607617267132400
}
```
### Specs
* ✅ should return 200 on success
...
### Orders (orders) Feed listen for &#x27;acad6cce-c7e5-43cb-b737-1c4585fbf465&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/orders/primary/acad6cce-c7e5-43cb-b737-1c4585fbf465


---
Response status code: 200 OK. Responded in 316.801115ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/orders-rpde?afterTimestamp=637607617166341724&afterId=fa4d5293-1600-42e6-a173-5807dde4a3f2",
  "message": "Listening for UUID: 'acad6cce-c7e5-43cb-b737-1c4585fbf465' in feed: orders, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 127.186091ms.
### Specs
* ✅ should return 204 on success

## Orders Feed (after test:AccessPassUpdateSimulateAction)

### Orders (orders) Feed collect for &#x27;acad6cce-c7e5-43cb-b737-1c4585fbf465&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/orders/primary/acad6cce-c7e5-43cb-b737-1c4585fbf465


---
Response status code: 200 OK. Responded in 2530.215628ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "acad6cce-c7e5-43cb-b737-1c4585fbf465",
  "modified": 637607617321404400,
  "data": {
    "@context": [
      "https://openactive.io/",
      "https://openactive.io/ns-beta"
