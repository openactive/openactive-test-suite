...
⚠️ 7 passed with 0 failures, 64 warnings and 22 suggestions 
...
---
Response status code: 200 OK. Responded in 71.329753ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1361/events/13604"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1361%2Fevents%2F13604?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 22.038913ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1361/events/13604",
    "startDate": "2021-07-02T02:46:09+00:00",
    "endDate": "2021-07-02T08:43:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1361",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1361#/offers/0",
          ...
          "price": 0.47,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P13DT10H43M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1ece74f0-b90f-4094-b546-8585b47e0638
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1361#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1361/events/13604"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2105.604758ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1ece74f0-b90f-4094-b546-8585b47e0638",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:02+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1ece74f0-b90f-4094-b546-8585b47e0638
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mayra_Hoppe@gmail.com",
    "telephone": "1-734-998-6537 x3099",
    "givenName": "Halvorson",
    "familyName": "Floyd",
    "identifier": "5e45a14e-c9d9-42e1-a724-2076c6469b09"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 1109.169728ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:03+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/1ece74f0-b90f-4094-b546-8585b47e0638
...
---
Response status code: 400 Bad Request. Responded in 350.359707ms.
```json
{
  "@context": "https://openactive.io/",
