...
---
Response status code: 200 OK. Responded in 578.38508ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/445/events/4441"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F445%2Fevents%2F4441?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 379.195045ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/445/events/4441",
    "startDate": "2021-07-02T14:41:09+00:00",
    "endDate": "2021-07-02T16:15:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/1d4df1bc-29e4-49b9-b53c-0a00fd7ff5ce
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/445/events/4441"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 150.845939ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/1d4df1bc-29e4-49b9-b53c-0a00fd7ff5ce",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/1d4df1bc-29e4-49b9-b53c-0a00fd7ff5ce
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Declan.Mohr@hotmail.com",
    "telephone": "739-283-9480 x920",
    "givenName": "Skiles",
    "familyName": "Fern",
    "identifier": "8864fabe-e4c5-4d44-a420-411eba1a56c8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 193.577101ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/1d4df1bc-29e4-49b9-b53c-0a00fd7ff5ce
...
---
Response status code: 201 Created. Responded in 166.910966ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/1d4df1bc-29e4-49b9-b53c-0a00fd7ff5ce",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
    "termsOfService": [
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/1d4df1bc-29e4-49b9-b53c-0a00fd7ff5ce#/orderedItems/749",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/445#/offers/0",
        "allowCustomerCancellationFullRefund": false,
