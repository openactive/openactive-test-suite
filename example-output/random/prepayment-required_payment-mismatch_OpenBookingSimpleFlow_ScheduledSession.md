...
---
Response status code: 200 OK. Responded in 217.272864ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/436/events/4355"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F436%2Fevents%2F4355?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 236.389183ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/436/events/4355",
    "startDate": "2021-07-11T06:38:09+00:00",
    "endDate": "2021-07-11T12:24:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/6a3697a6-0b70-4701-a47b-b4da687f8e9e
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/436/events/4355"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 793.566875ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/6a3697a6-0b70-4701-a47b-b4da687f8e9e",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:54:58+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/6a3697a6-0b70-4701-a47b-b4da687f8e9e
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Opal.Tromp@yahoo.com",
    "telephone": "1-420-422-5153 x0860",
    "givenName": "Torphy",
    "familyName": "Kaya",
    "identifier": "185c8303-cc77-4eba-a350-a7003d767a6b"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 384.066028ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/6a3697a6-0b70-4701-a47b-b4da687f8e9e
...
---
Response status code: 400 Bad Request. Responded in 45.100989ms.
```json
{
  "@context": "https://openactive.io/",
