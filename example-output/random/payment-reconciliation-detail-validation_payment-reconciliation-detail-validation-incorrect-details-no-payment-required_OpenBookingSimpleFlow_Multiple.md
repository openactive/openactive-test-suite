[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:54:16 GMT+0000 (Coordinated Universal Time)
...
---
Response status code: 200 OK. Responded in 18.8959ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/362/events/3615"
}
```
...
---
Response status code: 200 OK. Responded in 17.652981ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/36/events/357"
}
```
...
---
Response status code: 200 OK. Responded in 16.604382ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/192/facility-use-slots/1913"
}
```
...
---
Response status code: 200 OK. Responded in 23.985585ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/563/facility-use-slots/5627"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F362%2Fevents%2F3615?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.979303ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/362/events/3615",
    "startDate": "2021-07-01T21:38:09+00:00",
    "endDate": "2021-07-02T02:10:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      ...
      "offers": [
        {
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P14DT57M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F36%2Fevents%2F357?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.505258ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/36/events/357",
    "startDate": "2021-07-08T17:37:09+00:00",
    "endDate": "2021-07-08T20:13:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/36",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/36#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "latestCancellationBeforeStartDate": "P1D",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F192%2Ffacility-use-slots%2F1913?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 19.127622ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/192",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/192/facility-use-slots/1913#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 0,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 8,
    "startDate": "2021-07-07T18:30:10+00:00",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F563%2Ffacility-use-slots%2F5627?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.79109ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/563/facility-use-slots/5627#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT2H19M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-08T16:31:10+00:00",
    "endDate": "2021-07-08T20:07:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/bcdc6f0e-500c-4d19-b114-1b00acfd5360
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/362/events/3615"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/36#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/36/events/357"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/192/facility-use-slots/1913#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/192/facility-use-slots/1913"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/563/facility-use-slots/5627#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/563/facility-use-slots/5627"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-wcP7ntaKrH",
    "accountId": "invalid-AtLohnCW1",
    "paymentProviderId": "invalid-9D66LIsIAP"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 215.130592ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/bcdc6f0e-500c-4d19-b114-1b00acfd5360
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Gregorio.Miller71@gmail.com",
    "telephone": "753-543-8505 x285",
    "givenName": "Cummerata",
    "familyName": "Joshua",
    "identifier": "30f7de05-65b4-4abf-bfc8-891872b501f3"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid--WheksIgBp",
    "accountId": "invalid-1ftv3eZhoA",
    "paymentProviderId": "invalid-aQXcGeDvf1"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 122.441163ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
