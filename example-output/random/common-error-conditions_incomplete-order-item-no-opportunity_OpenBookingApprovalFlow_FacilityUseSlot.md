...
# common-error-conditions >> incomplete-order-item-no-opportunity (OpenBookingApprovalFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 419.29976ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1568/facility-use-slots/15680"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1568%2Ffacility-use-slots%2F15680?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 431.588127ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1568/facility-use-slots/15680#/offers/0",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P14DT22H4M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-05T07:41:10+00:00",
    "endDate": "2021-07-05T08:27:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/188eed86-1645-4da5-a541-a05df335ef55
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1568/facility-use-slots/15680#/offers/0"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 183.527646ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/188eed86-1645-4da5-a541-a05df335ef55",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:14+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/188eed86-1645-4da5-a541-a05df335ef55
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Mortimer.Hilll@gmail.com",
    "telephone": "316-401-3845",
    "givenName": "Donnelly",
    "familyName": "Hilda",
    "identifier": "c5b86769-7d47-4cf8-8be0-df5d2706581d"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 37.476863ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/188eed86-1645-4da5-a541-a05df335ef55
...
---
Response status code: 409 Conflict. Responded in 43.66065ms.
```json
{
  "@context": "https://openactive.io/",
