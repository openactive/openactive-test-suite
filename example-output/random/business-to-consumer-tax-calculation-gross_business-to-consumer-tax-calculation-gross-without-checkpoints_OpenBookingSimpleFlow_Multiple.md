...
⚠️ 13 passed with 0 failures, 220 warnings and 60 suggestions 
...
---
Response status code: 200 OK. Responded in 223.263801ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/282/events/2816"
}
```
...
---
Response status code: 200 OK. Responded in 223.851956ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/575/events/5744"
}
```
...
---
Response status code: 200 OK. Responded in 224.263895ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/447/facility-use-slots/4462"
}
```
...
---
Response status code: 200 OK. Responded in 224.613228ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/522/facility-use-slots/5216"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F282%2Fevents%2F2816?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 170.716811ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/282/events/2816",
    "startDate": "2021-07-08T10:55:09+00:00",
    "endDate": "2021-07-08T12:52:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F575%2Fevents%2F5744?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 171.122449ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/575/events/5744",
    "startDate": "2021-07-05T05:39:09+00:00",
    "endDate": "2021-07-05T08:25:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F447%2Ffacility-use-slots%2F4462?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 175.467961ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/447",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/447/facility-use-slots/4462#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 15.03,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT5H51M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-09T11:29:10+00:00",
    "endDate": "2021-07-09T12:57:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F522%2Ffacility-use-slots%2F5216?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 175.76189ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/522/facility-use-slots/5216#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingPrepayment": "https://openactive.io/Optional",
        "price": 17.57,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT20H53M"
      }
    ],
    "remainingUses": 5,
    "startDate": "2021-07-08T13:57:10+00:00",
    "endDate": "2021-07-08T17:20:10+00:00"
  }
}
```
### Specs
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/68b73ed5-494b-4f1a-8d3c-c4fd04702127
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Katlynn.Dickinson@hotmail.com",
    "telephone": "836.906.8675 x4210",
    "givenName": "Fadel",
    "familyName": "Polly",
    "identifier": "ca3d65dc-89cc-41f4-b64b-2f08eeb184f0"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/282/events/2816"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/575/events/5744"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/447/facility-use-slots/4462#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/447/facility-use-slots/4462"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/522/facility-use-slots/5216#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/522/facility-use-slots/5216"
    }
  ],
  "totalPaymentDue": {
...
---
Response status code: 201 Created. Responded in 1027.51943ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/68b73ed5-494b-4f1a-8d3c-c4fd04702127",
  "bookingService": {
    "@type": "BookingService",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/68b73ed5-494b-4f1a-8d3c-c4fd04702127#/orderedItems/1958",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/282#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/68b73ed5-494b-4f1a-8d3c-c4fd04702127#/orderedItems/1959",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/282#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/68b73ed5-494b-4f1a-8d3c-c4fd04702127#/orderedItems/1960",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/575#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/68b73ed5-494b-4f1a-8d3c-c4fd04702127#/orderedItems/1961",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/447/facility-use-slots/4462#/offers/0",
        "allowCustomerCancellationFullRefund": true,
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/447"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-09T11:29:10+00:00",
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/68b73ed5-494b-4f1a-8d3c-c4fd04702127#/orderedItems/1962",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/447/facility-use-slots/4462#/offers/0",
        "allowCustomerCancellationFullRefund": true,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/68b73ed5-494b-4f1a-8d3c-c4fd04702127#/orderedItems/1963",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/522/facility-use-slots/5216#/offers/0",
        "allowCustomerCancellationFullRefund": true,
