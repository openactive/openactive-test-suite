[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:50:59 GMT+0000 (Coordinated Universal Time)

# non-free-opportunities >> opportunity-paid (OpenBookingApprovalFlow >> Multiple)

**Booking Flow:** OpenBookingApprovalFlow

**Opportunity Type:** Multiple

**Feature:** Payment / Opportunities with a non-zero price (Implemented) 

**Test:**  Successful booking with payment property

A successful end to end booking of a non-free opportunity with the `payment` property included if required.

### Running only this test

```bash
npm start -- --runInBand test/features/payment/non-free-opportunities/implemented/opportunity-paid-test.js
```

---

⚠️ 19 passed with 0 failures, 479 warnings and 126 suggestions 
...
```json
{
  ...
  "test:testOpportunityCriteria": "https://openactive.io/test-interface#TestOpportunityBookableNonFree",
...
---
Response status code: 200 OK. Responded in 103.989588ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1484/events/14839"
}
```
...
---
Response status code: 200 OK. Responded in 112.969242ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1421/events/14205"
}
```
...
---
Response status code: 200 OK. Responded in 113.463589ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13854"
}
```
...
---
Response status code: 200 OK. Responded in 114.131452ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1376/facility-use-slots/13758"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1484%2Fevents%2F14839?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 81.169818ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1484/events/14839",
    "startDate": "2021-07-10T03:36:09+00:00",
    "endDate": "2021-07-10T09:01:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1484",
      "name": "Steel Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1484#/offers/0",
          ...
          "price": 8.09,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT6H23M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1421%2Fevents%2F14205?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 81.578157ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1421/events/14205",
    "startDate": "2021-07-02T00:21:09+00:00",
    "endDate": "2021-07-02T05:04:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1421",
      "name": "Rubber Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1421#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "openBookingFlowRequirement": [
            "https://openactive.io/OpenBookingApproval"
          ],
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT4H32M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1386%2Ffacility-use-slots%2F13854?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 81.871685ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1386",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13854#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        ...
        "price": 12,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT6H34M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-02T07:31:10+00:00",
    "endDate": "2021-07-02T10:08:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1376%2Ffacility-use-slots%2F13758?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 82.229819ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1376",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1376/facility-use-slots/13758#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 7.62,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT6H47M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-10T13:32:10+00:00",
    "endDate": "2021-07-10T18:55:10+00:00"
  }
}
```
### Specs
...
* ✅ matches the criteria 'TestOpportunityBookableNonFree' required for this test
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/9633a950-ab52-4f99-849e-f82e6ad1ebdc
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1484#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1484/events/14839"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1421#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1421/events/14205"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13854#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13854"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1376/facility-use-slots/13758#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1376/facility-use-slots/13758"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 2239.37282ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/9633a950-ab52-4f99-849e-f82e6ad1ebdc",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:00+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1484"
        },
        "maximumAttendeeCapacity": 48,
        "remainingAttendeeCapacity": 48
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1421"
        },
        "maximumAttendeeCapacity": 35,
        "remainingAttendeeCapacity": 35
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1386"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-02T07:31:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1376"
        },
        "maximumUses": 2,
        "remainingUses": 2,
        "startDate": "2021-07-10T13:32:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/9633a950-ab52-4f99-849e-f82e6ad1ebdc
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Walter35@hotmail.com",
    "telephone": "755.452.8425",
    "givenName": "Reinger",
    "familyName": "Deja",
    "identifier": "81b4e971-bf44-4fff-8fbe-b08d7ff1e352"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 3888.0493930000002ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:57:04+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/9633a950-ab52-4f99-849e-f82e6ad1ebdc
...
---
Response status code: 201 Created. Responded in 2431.717821ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/9633a950-ab52-4f99-849e-f82e6ad1ebdc",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9633a950-ab52-4f99-849e-f82e6ad1ebdc#/orderedItems/2751",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1484#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9633a950-ab52-4f99-849e-f82e6ad1ebdc#/orderedItems/2752",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1484#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9633a950-ab52-4f99-849e-f82e6ad1ebdc#/orderedItems/2753",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1421#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9633a950-ab52-4f99-849e-f82e6ad1ebdc#/orderedItems/2754",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13854#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9633a950-ab52-4f99-849e-f82e6ad1ebdc#/orderedItems/2755",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1386/facility-use-slots/13854#/offers/0",
        "allowCustomerCancellationFullRefund": false,
    ...
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/9633a950-ab52-4f99-849e-f82e6ad1ebdc#/orderedItems/2756",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1376/facility-use-slots/13758#/offers/0",
        "allowCustomerCancellationFullRefund": false,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/9633a950-ab52-4f99-849e-f82e6ad1ebdc/versions/d7fc6b39-a38c-4ded-85da-54e26bde2165",
  "payment": {
    "@type": "Payment",
    "identifier": "DKmKyoor1",
    "name": "AcmeBroker Points",
...
### Orders (order-proposals) Feed listen for &#x27;9633a950-ab52-4f99-849e-f82e6ad1ebdc&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/9633a950-ab52-4f99-849e-f82e6ad1ebdc


---
Response status code: 200 OK. Responded in 9.740132ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607623169118114&afterId=07ee95d6-0d67-4f5b-b2db-babbd1e3a87b",
  "message": "Listening for UUID: '9633a950-ab52-4f99-849e-f82e6ad1ebdc' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 66.223632ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;9633a950-ab52-4f99-849e-f82e6ad1ebdc&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/9633a950-ab52-4f99-849e-f82e6ad1ebdc


---
Response status code: 200 OK. Responded in 2622.124703ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "9633a950-ab52-4f99-849e-f82e6ad1ebdc",
  "modified": 637607623315458300,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/9633a950-ab52-4f99-849e-f82e6ad1ebdc",
    "identifier": "9633a950-ab52-4f99-849e-f82e6ad1ebdc",
...
---
Response status code: 200 OK. Responded in 115.924684ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607623315458243&afterId=9633a950-ab52-4f99-849e-f82e6ad1ebdc",
  "message": "Listening for UUID: '9633a950-ab52-4f99-849e-f82e6ad1ebdc' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/9633a950-ab52-4f99-849e-f82e6ad1ebdc
...
---
Response status code: 201 Created. Responded in 2145.685133ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/9633a950-ab52-4f99-849e-f82e6ad1ebdc",
  "identifier": "9633a950-ab52-4f99-849e-f82e6ad1ebdc",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 116.965667ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "9633a950-ab52-4f99-849e-f82e6ad1ebdc",
  "modified": 637607623345193500
}
```
### Specs
* ✅ should return 200 on success
