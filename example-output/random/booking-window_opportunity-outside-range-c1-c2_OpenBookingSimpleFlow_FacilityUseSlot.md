...
# booking-window >> opportunity-outside-range-c1-c2 (OpenBookingSimpleFlow >> FacilityUseSlot)
...
---
Response status code: 200 OK. Responded in 322.506859ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/896/facility-use-slots/8956"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F896%2Ffacility-use-slots%2F8956?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 307.813062ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/896",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/896/facility-use-slots/8956#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT9H53M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-11T14:18:10+00:00",
    "endDate": "2021-07-11T19:59:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/ff509e79-ff18-43f4-a1cc-017e1c2e129c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/896/facility-use-slots/8956#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/896/facility-use-slots/8956"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 79.425451ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/ff509e79-ff18-43f4-a1cc-017e1c2e129c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:18+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/896"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-11T14:18:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/ff509e79-ff18-43f4-a1cc-017e1c2e129c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Morgan.Thiel68@yahoo.com",
    "telephone": "1-622-865-4134",
    "givenName": "McClure",
    "familyName": "Erik",
    "identifier": "d9cc76ba-0155-4d15-bd68-eb459675cff8"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 219.717487ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
