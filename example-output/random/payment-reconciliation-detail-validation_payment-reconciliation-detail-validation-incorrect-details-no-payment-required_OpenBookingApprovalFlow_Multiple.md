...
⚠️ 14 passed with 0 failures, 133 warnings and 34 suggestions 
...
---
Response status code: 200 OK. Responded in 21.034503ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1023/events/10224"
}
```
...
---
Response status code: 200 OK. Responded in 21.874483ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1261/events/12609"
}
```
...
---
Response status code: 200 OK. Responded in 22.001896ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1114/facility-use-slots/11132"
}
```
...
---
Response status code: 200 OK. Responded in 28.536419ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1744/facility-use-slots/17435"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1023%2Fevents%2F10224?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 26.207496ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1023/events/10224",
    "startDate": "2021-07-02T07:26:09+00:00",
    "endDate": "2021-07-02T11:43:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1023",
      "name": "Cotton Cycling",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1023#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1261%2Fevents%2F12609?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 25.620441ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1261/events/12609",
    "startDate": "2021-07-04T16:07:09+00:00",
    "endDate": "2021-07-04T17:27:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1114%2Ffacility-use-slots%2F11132?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 28.000167ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1114",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1114/facility-use-slots/11132#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
    ...
    "remainingUses": 7,
    "startDate": "2021-07-10T11:06:10+00:00",
    "endDate": "2021-07-10T15:44:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1744%2Ffacility-use-slots%2F17435?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 27.576827ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1744",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1744/facility-use-slots/17435#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval"
        ],
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT6H27M"
      }
    ],
    "remainingUses": 8,
    "startDate": "2021-07-02T10:44:10+00:00",
    "endDate": "2021-07-02T14:21:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/601c831a-cbb7-478f-ba99-5bb9f7b34ab5
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1023#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1023/events/10224"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1261/events/12609"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1114/facility-use-slots/11132#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1114/facility-use-slots/11132"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1744/facility-use-slots/17435#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1744/facility-use-slots/17435"
    }
  ],
  "payment": {
    "@type": "Payment",
    "name": "invalid-BZr8dmCkHQ",
    "accountId": "invalid-XbJV12_ke",
    "paymentProviderId": "invalid-O4THFaBVvU"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 194.616138ms.
```json
{
  "@context": "https://openactive.io/",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/601c831a-cbb7-478f-ba99-5bb9f7b34ab5
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Bryce95@gmail.com",
    "telephone": "(947) 656-9474 x602",
    "givenName": "Cartwright",
    "familyName": "Pablo",
    "identifier": "d64cacfa-d0d3-498c-853a-4105421b4da6"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
  ...
  "payment": {
    "@type": "Payment",
    "name": "invalid-SHADIXTXSb",
    "accountId": "invalid-JUn3YWOVtR",
    "paymentProviderId": "invalid-kxQo3K6VUn"
  }
}
```

---
Response status code: 400 Bad Request. Responded in 155.109038ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "InvalidPaymentDetailsError",
