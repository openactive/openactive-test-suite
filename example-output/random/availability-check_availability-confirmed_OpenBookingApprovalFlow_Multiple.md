[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:42:19 GMT+0000 (Coordinated Universal Time)

# availability-check >> availability-confirmed (OpenBookingApprovalFlow >> Multiple)
...
⚠️ 28 passed with 0 failures, 301 warnings and 82 suggestions 
...
---
Response status code: 200 OK. Responded in 593.180715ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1269/events/12687"
}
```
...
---
Response status code: 200 OK. Responded in 592.618462ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1064/events/10631"
}
```
...
---
Response status code: 200 OK. Responded in 589.377754ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1466/facility-use-slots/14651"
}
```
...
---
Response status code: 200 OK. Responded in 593.627857ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1601/facility-use-slots/16008"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1269%2Fevents%2F12687?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 438.945747ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1269/events/12687",
    "startDate": "2021-07-04T10:22:09+00:00",
    "endDate": "2021-07-04T13:53:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1269",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1269#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1064%2Fevents%2F10631?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 439.078059ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1064/events/10631",
    "startDate": "2021-07-02T00:25:09+00:00",
    "endDate": "2021-07-02T01:27:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/1064",
      "name": "Wooden Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/1064#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1466%2Ffacility-use-slots%2F14651?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 441.887826ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1466",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1466/facility-use-slots/14651#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 19.44,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT11H8M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-01T21:26:10+00:00",
    "endDate": "2021-07-02T02:34:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1601%2Ffacility-use-slots%2F16008?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 439.744323ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1601",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1601/facility-use-slots/16008#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT17H47M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-08T12:13:10+00:00",
    "endDate": "2021-07-08T14:58:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/d9a55804-ad34-4607-880c-c4d130519c1c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1269#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1269/events/12687"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/1064#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1064/events/10631"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1466/facility-use-slots/14651#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1466/facility-use-slots/14651"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1601/facility-use-slots/16008#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1601/facility-use-slots/16008"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 549.597771ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/d9a55804-ad34-4607-880c-c4d130519c1c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:35+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1269"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1064"
        },
        "maximumAttendeeCapacity": 30,
        "remainingAttendeeCapacity": 30
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1466"
        },
        "maximumUses": 4,
        "remainingUses": 4,
        "startDate": "2021-07-01T21:26:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1601"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-08T12:13:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/d9a55804-ad34-4607-880c-c4d130519c1c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Garnett_Johns@yahoo.com",
    "telephone": "898.412.2571",
    "givenName": "Daugherty",
    "familyName": "Arvilla",
    "identifier": "1a0b7fcb-e84b-4862-a8a3-b717fb956cec"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 427.84569ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:47:37+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
