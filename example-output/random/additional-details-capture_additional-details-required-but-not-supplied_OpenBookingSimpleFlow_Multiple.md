...
⚠️ 15 passed with 0 failures, 295 warnings and 80 suggestions 
...
---
Response status code: 200 OK. Responded in 359.74974ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4472"
}
```
...
---
Response status code: 200 OK. Responded in 360.516213ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/141/events/1405"
}
```
...
---
Response status code: 200 OK. Responded in 361.445702ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/619/facility-use-slots/6186"
}
```
...
---
Response status code: 200 OK. Responded in 359.794144ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/79/facility-use-slots/789"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F448%2Fevents%2F4472?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 392.33615ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4472",
    "startDate": "2021-07-11T10:51:09+00:00",
    "endDate": "2021-07-11T15:49:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/448",
      "name": "Plastic Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/448#/offers/0",
          ...
          "price": 0,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P12DT20H2M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F141%2Fevents%2F1405?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 394.800585ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/141/events/1405",
    "startDate": "2021-07-05T23:10:09+00:00",
    "endDate": "2021-07-06T03:07:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/141",
      "name": "Plastic Yoga",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/141#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F619%2Ffacility-use-slots%2F6186?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 397.072502ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/619",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/619/facility-use-slots/6186#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingIntakeForm"
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT18H8M"
      }
    ],
    "remainingUses": 6,
    "startDate": "2021-07-11T10:18:10+00:00",
    "endDate": "2021-07-11T13:27:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F79%2Ffacility-use-slots%2F789?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 397.970689ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/79",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/79/facility-use-slots/789#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "price": 6.1,
        "priceCurrency": "GBP"
      }
    ...
    "remainingUses": 2,
    "startDate": "2021-07-02T18:30:09+00:00",
    "endDate": "2021-07-02T20:49:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/01da1779-c1f8-414d-99f2-7c26a3bb7a39
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/448#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/448/events/4472"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 2,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/141#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/141/events/1405"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/619/facility-use-slots/6186#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/619/facility-use-slots/6186"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/79/facility-use-slots/789#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/79/facility-use-slots/789"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 639.15161ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/01da1779-c1f8-414d-99f2-7c26a3bb7a39",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:37+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/448"
        },
        "maximumAttendeeCapacity": 2,
        "remainingAttendeeCapacity": 2
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/141"
        },
        "maximumAttendeeCapacity": 42,
        "remainingAttendeeCapacity": 42
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/619"
        },
        "maximumUses": 6,
        "remainingUses": 6,
        "startDate": "2021-07-11T10:18:10+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/01da1779-c1f8-414d-99f2-7c26a3bb7a39
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Eddie_Kiehn@hotmail.com",
    "telephone": "906.633.1904 x8978",
    "givenName": "Crona",
    "familyName": "Adelle",
    "identifier": "b62dbc80-d149-4c81-9a0a-1a982d69d207"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 482.095855ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:39+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/01da1779-c1f8-414d-99f2-7c26a3bb7a39
...
---
Response status code: 409 Conflict. Responded in 198.652095ms.
```json
{
  "@context": "https://openactive.io/",
