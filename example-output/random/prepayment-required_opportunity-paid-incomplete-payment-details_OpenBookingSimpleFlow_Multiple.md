...
---
Response status code: 200 OK. Responded in 192.864327ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/138/events/1377"
}
```
...
---
Response status code: 200 OK. Responded in 192.537697ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/141/facility-use-slots/1408"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F138%2Fevents%2F1377?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 230.78023ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/138/events/1377",
    "startDate": "2021-07-07T20:22:09+00:00",
    "endDate": "2021-07-08T00:21:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F141%2Ffacility-use-slots%2F1408?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 231.545403ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/141/facility-use-slots/1408#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2021-07-02T23:24:10+00:00",
    "endDate": "2021-07-03T03:39:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/070fe685-cec3-4181-9a73-94f715194ff0
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/138/events/1377"
    },
    {
      "@type": "OrderItem",
      "position": 1,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/141/facility-use-slots/1408#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/141/facility-use-slots/1408"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 1094.265484ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/070fe685-cec3-4181-9a73-94f715194ff0",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/070fe685-cec3-4181-9a73-94f715194ff0
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Adriel_Schneider@yahoo.com",
    "telephone": "(996) 968-1222",
    "givenName": "Nikolaus",
    "familyName": "Damien",
    "identifier": "eced5148-91c8-4be8-bc74-a5f8f6e55820"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 629.877155ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/070fe685-cec3-4181-9a73-94f715194ff0
...
---
Response status code: 400 Bad Request. Responded in 109.312888ms.
```json
{
  "@context": "https://openactive.io/",
