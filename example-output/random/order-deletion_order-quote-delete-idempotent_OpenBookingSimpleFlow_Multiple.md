...
⚠️ 16 passed with 0 failures, 290 warnings and 80 suggestions 
...
---
Response status code: 200 OK. Responded in 281.199736ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/829/events/8290"
}
```
...
---
Response status code: 200 OK. Responded in 280.854003ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/145/events/1448"
}
```
...
---
Response status code: 200 OK. Responded in 283.557761ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4773"
}
```
...
---
Response status code: 200 OK. Responded in 283.846087ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/496/facility-use-slots/4953"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F829%2Fevents%2F8290?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 223.551955ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/829/events/8290",
    "startDate": "2021-07-02T20:03:09+00:00",
    "endDate": "2021-07-03T01:13:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/829",
      "name": "Granite Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/829#/offers/0",
          "allowCustomerCancellationFullRefund": false,
          "price": 2.54,
          "priceCurrency": "GBP",
          "validFromBeforeStartDate": "P3DT21H18M"
        }
      ],
      "organizer": {
        "@type": "Organization",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F145%2Fevents%2F1448?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 223.159818ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/145/events/1448",
    "startDate": "2021-07-11T05:12:09+00:00",
    "endDate": "2021-07-11T10:59:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F478%2Ffacility-use-slots%2F4773?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 222.790682ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4773#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1DT16H",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT17H16M"
      }
    ],
    "remainingUses": 7,
    "startDate": "2021-07-04T22:32:10+00:00",
    "endDate": "2021-07-04T23:51:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F496%2Ffacility-use-slots%2F4953?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 222.993402ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/496/facility-use-slots/4953#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingPrepayment": "https://openactive.io/Unavailable",
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P10DT3H51M"
      }
    ],
    "remainingUses": 4,
    "startDate": "2021-07-02T11:44:10+00:00",
    "endDate": "2021-07-02T15:11:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/a54f44ac-9bdf-40cf-9351-be1e1a60165c
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/829#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/829/events/8290"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/145/events/1448"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4773#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/478/facility-use-slots/4773"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/496/facility-use-slots/4953#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/496/facility-use-slots/4953"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 338.444179ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/a54f44ac-9bdf-40cf-9351-be1e1a60165c",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:09+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/829"
        },
        "maximumAttendeeCapacity": 45,
        "remainingAttendeeCapacity": 45
      },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/a54f44ac-9bdf-40cf-9351-be1e1a60165c
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Jarvis.Ward@hotmail.com",
    "telephone": "435.405.1725 x622",
    "givenName": "Stehr",
    "familyName": "Sanford",
    "identifier": "8e7ce053-30a4-48ad-9acc-e7e1646e38eb"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 493.938663ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:49:10+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
DELETE https://localhost:5001/api/openbooking/order-quotes/a54f44ac-9bdf-40cf-9351-be1e1a60165c
...
---
Response status code: 204 No Content. Responded in 279.685392ms.
...
---
Response status code: 204 No Content. Responded in 12.012442ms.
### Specs
