...
# minimal-proposal >> accept-proposal-book (OpenBookingApprovalFlow >> ScheduledSession)
...
⚠️ 15 passed with 0 failures, 101 warnings and 34 suggestions 
...
---
Response status code: 200 OK. Responded in 196.5415ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1401/events/14008"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1401%2Fevents%2F14008?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 349.636967ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1401/events/14008",
    "startDate": "2021-07-05T11:34:09+00:00",
    "endDate": "2021-07-05T14:52:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/5d525fab-d260-44b8-8b8a-e8d3c7a8428d
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1401/events/14008"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 45.311712ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/5d525fab-d260-44b8-8b8a-e8d3c7a8428d",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/5d525fab-d260-44b8-8b8a-e8d3c7a8428d
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Americo.Huel47@gmail.com",
    "telephone": "(330) 362-3005 x4474",
    "givenName": "Schulist",
    "familyName": "Holly",
    "identifier": "c6cd1d82-0164-4ea0-8494-a1f5f6cd3f5e"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 118.602984ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/5d525fab-d260-44b8-8b8a-e8d3c7a8428d
...
---
Response status code: 201 Created. Responded in 92.449497ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/5d525fab-d260-44b8-8b8a-e8d3c7a8428d",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/5d525fab-d260-44b8-8b8a-e8d3c7a8428d#/orderedItems/219",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/session-series/1401#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/5d525fab-d260-44b8-8b8a-e8d3c7a8428d/versions/f9d258c0-6654-4485-8566-b3dad981f22e",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;5d525fab-d260-44b8-8b8a-e8d3c7a8428d&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/5d525fab-d260-44b8-8b8a-e8d3c7a8428d


---
Response status code: 200 OK. Responded in 355.954268ms.
```json
{
  "headers": {
  ...
  "message": "Listening for UUID: '5d525fab-d260-44b8-8b8a-e8d3c7a8428d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 100.632475ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;5d525fab-d260-44b8-8b8a-e8d3c7a8428d&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/5d525fab-d260-44b8-8b8a-e8d3c7a8428d


---
Response status code: 200 OK. Responded in 2869.617938ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "5d525fab-d260-44b8-8b8a-e8d3c7a8428d",
  "modified": 637607614978578200,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/5d525fab-d260-44b8-8b8a-e8d3c7a8428d",
    "identifier": "5d525fab-d260-44b8-8b8a-e8d3c7a8428d",
...
---
Response status code: 200 OK. Responded in 333.418124ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607614950043869&afterId=938d3628-d28c-4a6c-b8af-deae8ab00680",
  "message": "Listening for UUID: '5d525fab-d260-44b8-8b8a-e8d3c7a8428d' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/5d525fab-d260-44b8-8b8a-e8d3c7a8428d
...
---
Response status code: 201 Created. Responded in 103.553053ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/5d525fab-d260-44b8-8b8a-e8d3c7a8428d",
  "identifier": "5d525fab-d260-44b8-8b8a-e8d3c7a8428d",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 1099.090177ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "5d525fab-d260-44b8-8b8a-e8d3c7a8428d",
  "modified": 637607615011915600
}
```
### Specs
* ✅ should return 200 on success
