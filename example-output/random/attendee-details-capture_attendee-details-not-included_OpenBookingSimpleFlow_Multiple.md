[< Return to Summary](summary.md) | File Generated: Thu Jul 01 2021 18:43:35 GMT+0000 (Coordinated Universal Time)

# attendee-details-capture >> attendee-details-not-included (OpenBookingSimpleFlow >> Multiple)
...
⚠️ 15 passed with 0 failures, 290 warnings and 78 suggestions 
...
---
Response status code: 200 OK. Responded in 413.403406ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/83/events/827"
}
```
...
---
Response status code: 200 OK. Responded in 414.533713ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3188"
}
```
...
---
Response status code: 200 OK. Responded in 422.423063ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/406/facility-use-slots/4058"
}
```
...
---
Response status code: 200 OK. Responded in 425.142222ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/135/facility-use-slots/1349"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F83%2Fevents%2F827?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 481.717986ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/83/events/827",
    "startDate": "2021-07-10T22:58:09+00:00",
    "endDate": "2021-07-11T02:15:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
      "@id": "https://localhost:5001/api/identifiers/session-series/83",
      "name": "Soft Zumba",
      "activity": [
        {
          "@type": "Concept",
      ...
      "offers": [
        {
          "@type": "Offer",
          "@id": "https://localhost:5001/api/identifiers/session-series/83#/offers/0",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F319%2Fevents%2F3188?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 482.385949ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3188",
    "startDate": "2021-07-06T21:53:09+00:00",
    "endDate": "2021-07-06T23:26:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F406%2Ffacility-use-slots%2F4058?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 485.640559ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/406/facility-use-slots/4058#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingAttendeeDetails"
        ...
        "price": 4.3,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P11DT19H23M"
      }
    ],
    "remainingUses": 2,
    "startDate": "2021-07-06T10:00:10+00:00",
    "endDate": "2021-07-06T12:27:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F135%2Ffacility-use-slots%2F1349?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 491.109578ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/135",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/135/facility-use-slots/1349#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "latestCancellationBeforeStartDate": "P1D",
        "price": 18.48,
        "priceCurrency": "GBP"
    ...
    "remainingUses": 8,
    "startDate": "2021-07-02T22:07:09+00:00",
    "endDate": "2021-07-02T23:11:09+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7e6335dd-2d8b-4556-a292-3195b0a64376
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/83#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/83/events/827"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/319/events/3188"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/406/facility-use-slots/4058#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/406/facility-use-slots/4058"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/135/facility-use-slots/1349#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/135/facility-use-slots/1349"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 792.802844ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7e6335dd-2d8b-4556-a292-3195b0a64376",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:45+00:00"
  },
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/83"
        },
        "maximumAttendeeCapacity": 42,
        "remainingAttendeeCapacity": 42
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/135"
        },
        "maximumUses": 8,
        "remainingUses": 8,
        "startDate": "2021-07-02T22:07:09+00:00",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7e6335dd-2d8b-4556-a292-3195b0a64376
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Ellsworth_Welch91@hotmail.com",
    "telephone": "210-428-7685 x66437",
    "givenName": "Rowe",
    "familyName": "Brandt",
    "identifier": "e5df71b0-2c1a-4c7b-9c7d-f344663fda95"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 399.64648ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:48:46+00:00"
  },
  "orderRequiresApproval": false,
  "bookingService": {
    "@type": "BookingService",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7e6335dd-2d8b-4556-a292-3195b0a64376
...
---
Response status code: 409 Conflict. Responded in 162.765568ms.
```json
{
  "@context": "https://openactive.io/",
  ...
  "statusCode": 409,
  "description": "The 'attendeeDetailsRequired' properties of the 'attendee' are not supplied within a 'Person' object., The 'attendeeDetailsRequired' properties of the 'attendee' are not supplied within a 'Person' object., The 'attendeeDetailsRequired' properties of the 'attendee' are not supplied within a 'Person' object., The 'attendeeDetailsRequired' properties of the 'attendee' are not supplied within a 'Person' object."
}
```
### Specs
