...
---
Response status code: 200 OK. Responded in 218.364951ms.
```json
{
...
---
Response status code: 200 OK. Responded in 110.28578ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/138/events/1379",
    "startDate": "2021-07-04T07:29:09+00:00",
    "endDate": "2021-07-04T10:27:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/7c3772b8-eba4-447a-9057-b0956affcee8
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/session-series/138#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/138/events/1379"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 709.208679ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/7c3772b8-eba4-447a-9057-b0956affcee8",
  "lease": {
    "@type": "Lease",
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/7c3772b8-eba4-447a-9057-b0956affcee8
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Alec55@yahoo.com",
    "telephone": "1-682-896-7637 x351",
    "givenName": "Schimmel",
    "familyName": "Charlotte",
    "identifier": "114b970f-ef6b-442d-a09a-c2ea91493ba4"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 570.412373ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
...
### B Request
PUT https://localhost:5001/api/openbooking/orders/7c3772b8-eba4-447a-9057-b0956affcee8
...
---
Response status code: 400 Bad Request. Responded in 130.799345ms.
```json
{
  "@context": "https://openactive.io/",
