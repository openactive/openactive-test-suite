...
⚠️ 28 passed with 0 failures, 308 warnings and 80 suggestions 
...
---
Response status code: 200 OK. Responded in 336.81121ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1495/events/14945"
}
```
...
---
Response status code: 200 OK. Responded in 340.247737ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "ScheduledSession",
  "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1201/events/12005"
}
```
...
---
Response status code: 200 OK. Responded in 346.773557ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1922/facility-use-slots/19218"
}
```
...
---
Response status code: 200 OK. Responded in 347.096488ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1442/facility-use-slots/14412"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1495%2Fevents%2F14945?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 233.022246ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1495/events/14945",
    "startDate": "2021-07-09T07:52:09+00:00",
    "endDate": "2021-07-09T08:43:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Fscheduled-sessions%2F1201%2Fevents%2F12005?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 234.980033ms.
```json
{
  "data": {
    "@context": [
    ...
    "@type": "ScheduledSession",
    "@id": "https://localhost:5001/api/identifiers/scheduled-sessions/1201/events/12005",
    "startDate": "2021-07-04T06:30:09+00:00",
    "endDate": "2021-07-04T10:25:09+00:00",
    "superEvent": {
      "@type": "SessionSeries",
...
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1922%2Ffacility-use-slots%2F19218?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 235.460078ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1922",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1922/facility-use-slots/19218#/offers/0",
        "allowCustomerCancellationFullRefund": false,
        "latestCancellationBeforeStartDate": "P1D",
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
        ...
        "price": 0,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P3DT16H16M"
      }
    ],
    "remainingUses": 0,
    "startDate": "2021-07-07T16:20:10+00:00",
    "endDate": "2021-07-07T17:10:10+00:00"
  }
}
```

### Opportunity Feed extract for OrderItem 5 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1442%2Ffacility-use-slots%2F14412?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 235.683299ms.
```json
{
  "data": {
    "@context": [
    ...
    "facilityUse": {
      "@type": "FacilityUse",
      "@id": "https://localhost:5001/api/identifiers/facility-uses/1442",
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1442/facility-use-slots/14412#/offers/0",
        "allowCustomerCancellationFullRefund": true,
        "openBookingFlowRequirement": [
          "https://openactive.io/OpenBookingApproval",
          "https://openactive.io/OpenBookingNegotiation"
        ...
        "price": 3.71,
        "priceCurrency": "GBP",
        "validFromBeforeStartDate": "P13DT4H22M"
      }
    ],
    "remainingUses": 3,
    "startDate": "2021-07-06T03:21:10+00:00",
    "endDate": "2021-07-06T06:03:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/34335fc1-b5b7-4d2b-82c5-e56a41ced548
  ...
  "orderedItem": [
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1495/events/14945"
    },
    {
      "@type": "OrderItem",
      "position": 1,
    ...
    },
    {
      ...
      "orderedItem": "https://localhost:5001/api/identifiers/scheduled-sessions/1201/events/12005"
    },
    {
      "@type": "OrderItem",
      "position": 3,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1922/facility-use-slots/19218#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1922/facility-use-slots/19218"
    },
    {
      "@type": "OrderItem",
      "position": 4,
    ...
    },
    {
      "@type": "OrderItem",
      "position": 5,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1442/facility-use-slots/14412#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1442/facility-use-slots/14412"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 409 Conflict. Responded in 147.940161ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/34335fc1-b5b7-4d2b-82c5-e56a41ced548",
  "lease": {
    "@type": "Lease",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "superEvent": {
          ...
          "url": "https://example.com/events/1201"
        },
        "maximumAttendeeCapacity": 3,
        "remainingAttendeeCapacity": 3
      },
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1922"
        },
        "maximumUses": 0,
        "remainingUses": 0,
        "startDate": "2021-07-07T16:20:10+00:00",
    ...
    },
    {
      ...
      "orderedItem": {
        ...
        "facilityUse": {
          ...
          "url": "https://example.com/events/1442"
        },
        "maximumUses": 3,
        "remainingUses": 3,
        "startDate": "2021-07-06T03:21:10+00:00",
 ...
 * ⚠️ $.orderedItem[3].error[1].description: Recommended property `description` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[3].error[1].instance: Recommended property `instance` is missing from `OpportunityIsFullError`.
 ...
 * ⚠️ $.orderedItem[4].error[1].description: Recommended property `description` is missing from `OpportunityIsFullError`.
 * ⚠️ $.orderedItem[4].error[1].instance: Recommended property `instance` is missing from `OpportunityIsFullError`.
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/34335fc1-b5b7-4d2b-82c5-e56a41ced548
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Hilton.Cormier38@gmail.com",
    "telephone": "597-828-3411 x08217",
    "givenName": "Wolff",
    "familyName": "Cristina",
    "identifier": "6fa89fdd-e7c1-4562-a41b-b03555c2e805"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 409 Conflict. Responded in 117.626979ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:44:22+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
