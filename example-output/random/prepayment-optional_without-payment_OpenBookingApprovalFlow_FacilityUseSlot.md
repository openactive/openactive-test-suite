...
---
Response status code: 200 OK. Responded in 12.52109ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "Slot",
  "@id": "https://localhost:5001/api/identifiers/facility-uses/1297/facility-use-slots/12964"
}
```

### Opportunity Feed extract for OrderItem 0 Request
GET http://localhost:3000/opportunity/https%3A%2F%2Flocalhost%3A5001%2Fapi%2Fidentifiers%2Ffacility-uses%2F1297%2Ffacility-use-slots%2F12964?useCacheIfAvailable=true


---
Response status code: 200 OK. Responded in 18.239533ms.
```json
{
  "data": {
    "@context": [
    ...
    "offers": [
      {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1297/facility-use-slots/12964#/offers/0",
    ...
    "remainingUses": 3,
    "startDate": "2021-07-07T17:19:10+00:00",
    "endDate": "2021-07-07T22:42:10+00:00"
  }
}
```
### Specs
...
### C1 Request
PUT https://localhost:5001/api/openbooking/order-quote-templates/40a64f34-4f1e-429f-aed4-c55e4ad7e0ac
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "position": 0,
      "acceptedOffer": "https://localhost:5001/api/identifiers/facility-uses/1297/facility-use-slots/12964#/offers/0",
      "orderedItem": "https://localhost:5001/api/identifiers/facility-uses/1297/facility-use-slots/12964"
    }
  ],
  "payment": {
    "@type": "Payment",
...
---
Response status code: 200 OK. Responded in 467.965153ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  "@id": "https://localhost:5001/api/openbooking/order-quotes/40a64f34-4f1e-429f-aed4-c55e4ad7e0ac",
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:44+00:00"
  },
...
### C2 Request
PUT https://localhost:5001/api/openbooking/order-quotes/40a64f34-4f1e-429f-aed4-c55e4ad7e0ac
...
```json
{
  ...
  "customer": {
    "@type": "Person",
    "email": "Lilly.Murphy@yahoo.com",
    "telephone": "858-750-0338 x38463",
    "givenName": "Spinka",
    "familyName": "Fletcher",
    "identifier": "13808e07-85b5-4573-a1eb-982ab6473382"
  },
  "orderedItem": [
    {
      "@type": "OrderItem",
...
---
Response status code: 200 OK. Responded in 2357.364332ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderQuote",
  ...
  "lease": {
    "@type": "Lease",
    "leaseExpires": "2021-07-01T18:58:47+00:00"
  },
  "orderRequiresApproval": true,
  "bookingService": {
    "@type": "BookingService",
...
### P Request
PUT https://localhost:5001/api/openbooking/order-proposals/40a64f34-4f1e-429f-aed4-c55e4ad7e0ac
...
---
Response status code: 201 Created. Responded in 2490.714699ms.
```json
{
  "@context": "https://openactive.io/",
  "@type": "OrderProposal",
  "@id": "https://localhost:5001/api/openbooking/order-proposals/40a64f34-4f1e-429f-aed4-c55e4ad7e0ac",
  ...
  "orderedItem": [
    {
      "@type": "OrderItem",
      "@id": "https://localhost:5001/api/openbooking/orders/40a64f34-4f1e-429f-aed4-c55e4ad7e0ac#/orderedItems/2972",
      "acceptedOffer": {
        "@type": "Offer",
        "@id": "https://localhost:5001/api/identifiers/facility-uses/1297/facility-use-slots/12964#/offers/0",
        "allowCustomerCancellationFullRefund": true,
  ...
  "orderProposalVersion": "https://localhost:5001/api/openbooking/order-proposals/40a64f34-4f1e-429f-aed4-c55e4ad7e0ac/versions/60485b68-c39b-48b0-b512-fc6a68b587c8",
  "seller": {
    "@type": "Organization",
    "@id": "https://localhost:5001/api/identifiers/sellers/1",
    "name": "Acme Fitness Ltd",
...
### Orders (order-proposals) Feed listen for &#x27;40a64f34-4f1e-429f-aed4-c55e4ad7e0ac&#x27; change (auth: primary) Request
POST http://localhost:3000/order-listeners/order-proposals/primary/40a64f34-4f1e-429f-aed4-c55e4ad7e0ac


---
Response status code: 200 OK. Responded in 23.58214ms.
```json
{
  "headers": {
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607624223311337&afterId=42938947-51dd-490e-b7ab-f34ecfe0a128",
  "message": "Listening for UUID: '40a64f34-4f1e-429f-aed4-c55e4ad7e0ac' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```
...
---
Response status code: 204 No Content. Responded in 1017.774181ms.
### Specs
* ✅ should return 204 on success

## OrderProposal Feed Update (after Simulate Seller Approval)

### Orders (order-proposals) Feed collect for &#x27;40a64f34-4f1e-429f-aed4-c55e4ad7e0ac&#x27; change (auth: primary) Request
GET http://localhost:3000/order-listeners/order-proposals/primary/40a64f34-4f1e-429f-aed4-c55e4ad7e0ac


---
Response status code: 200 OK. Responded in 1494.018446ms.
```json
{
  "state": "updated",
  "kind": "Order",
  "id": "40a64f34-4f1e-429f-aed4-c55e4ad7e0ac",
  "modified": 637607624306219900,
  "data": {
    "@context": "https://openactive.io/",
    "@type": "OrderProposal",
    "@id": "https://localhost:5001/api/openbooking/order-proposals/40a64f34-4f1e-429f-aed4-c55e4ad7e0ac",
    "identifier": "40a64f34-4f1e-429f-aed4-c55e4ad7e0ac",
...
---
Response status code: 200 OK. Responded in 72.176669ms.
```json
{
  "headers": {
    "Accept": "application/json, application/vnd.openactive.booking+json; version=1",
  ...
  "startingFeedPage": "https://localhost:5001/api/openbooking/order-proposals-rpde?afterTimestamp=637607624306219854&afterId=40a64f34-4f1e-429f-aed4-c55e4ad7e0ac",
  "message": "Listening for UUID: '40a64f34-4f1e-429f-aed4-c55e4ad7e0ac' in feed: order-proposals, for Booking Partner: primary from startingFeedPage using headers"
}
```

### B Request
PUT https://localhost:5001/api/openbooking/orders/40a64f34-4f1e-429f-aed4-c55e4ad7e0ac
...
---
Response status code: 201 Created. Responded in 1762.705858ms.
```json
{
  "@context": [
    "https://openactive.io/",
  ...
  "@type": "Order",
  "@id": "https://localhost:5001/api/openbooking/orders/40a64f34-4f1e-429f-aed4-c55e4ad7e0ac",
  "identifier": "40a64f34-4f1e-429f-aed4-c55e4ad7e0ac",
  "bookingService": {
    "@type": "BookingService",
    "name": "Acme booking system",
...
---
Response status code: 200 OK. Responded in 2113.801872ms.
```json
{
  "state": "deleted",
  "kind": "Order",
  "id": "40a64f34-4f1e-429f-aed4-c55e4ad7e0ac",
  "modified": 637607624348442800
}
```
### Specs
* ✅ should return 200 on success
